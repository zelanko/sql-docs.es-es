---
title: 'Caso práctico: Creación de un ecosistema empresarial utilizando Microsoft Dynamics ERP y replicación de SQL Server 2014 for Scalability and Performance | Documentos de Microsoft'
ms.custom: ''
ms.date: 03/06/2017
...
# Caso práctico: creación de un ecosistema empresarial utilizando la replicación de SQL Server 2014 y Microsoft Dynamics ERP para aumentar la escalabilidad y el rendimiento
  **Resumen:** este documento abarca los siguientes escenarios:  
