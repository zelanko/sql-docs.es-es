...
##  <a name="locking-in-the-database-engine"></a><a name="Lock_Engine"></a>Bloqueo en el Motor de base de datos  
...
|------|---------------------------|------|------|------|------|------|  
|**Modo solicitado**|**ENCUENTRA**|**S**|**U**|**IX**|**SEIS**|**X**|  
...
|Detección de conflictos de actualizaciones.|Ninguna.|Compatibilidad integrada. No se puede deshabilitar.|  
