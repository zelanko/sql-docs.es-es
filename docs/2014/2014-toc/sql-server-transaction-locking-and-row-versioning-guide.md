...
|---------------------|----------------|------------------------|-------------|  
|**Lectura no confirmada**|Sí|Sí|Yes|  
|**Lectura confirmada**|No|Sí|Yes|  
...
|**Intención compartida (IS)**|Yes|Yes|Yes|Yes|Sí|No|  
|**Compartido (S)**|Yes|Yes|Sí|No|No|No|  
...
|**Compartido (S)**|Yes|Sí|No|Sí|Yes|Sí|No|  
|**Actualizar (U)**|Sí|No|No|Sí|No|Sí|No|  
|**Exclusivo (X)**|No|No|No|No|No|Sí|No|  
|**RangeS-S**|Yes|Sí|No|Sí|Sí|No|No|  
|**RangeS-U**|Sí|No|No|Sí|No|No|No|  
|**RangeI-N**|Yes|Yes|Sí|No|No|Sí|No|  
...
### <a name="customizing-transaction-isolation-level"></a>Personalizar el nivel de aislamiento de transacción  
 ...
 READ COMMITTED es el nivel de aislamiento predeterminado para [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[ssDEnoversion](../includes/ssdenoversion-md.md)] . Cuando es necesario utilizar una aplicación en un nivel de aislamiento distinto, se pueden utilizar los métodos que se indican a continuación para configurar el nivel de aislamiento:  
...
|----------------------|-----------------------|  
|Nivel de página|Bloqueos de fila y tabla|  
