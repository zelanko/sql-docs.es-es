---
title: Cambios de comportamiento en Analysis Services características de SQL Server 2014 | Documentos de Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
##  <a name="bkmk_sql2014"></a> Cambios de comportamiento en [!INCLUDE[ssSQL14](../includes/sssql14-md.md)]  
 No hay ningún cambio de comportamiento nuevo anunciado para la minería de datos tabulares, multidimensionales o [!INCLUDE[ssGeminiShort](../includes/ssgeminishort-md.md)] características de esta versión.  Sin embargo, dado que [!INCLUDE[ssASCurrent](../includes/ssascurrent-md.md)] es tan similar a la [!INCLUDE[ssSQL11](../includes/sssql11-md.md)] y [!INCLUDE[ssSQL11SP1](../includes/sssql11sp1-md.md)] versiones, cambios de comportamiento de ambas versiones anteriores se proporcionan aquí por comodidad en caso de que está actualizando desde [!INCLUDE[ssKatmai](../includes/sskatmai-md.md)].  
  
##  <a name="bkmk_sql2012sp1"></a> Cambios de comportamiento en [!INCLUDE[ssSQL11SP1](../includes/sssql11sp1-md.md)]  
 Esta sección documentan los cambios de comportamiento notificados para [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] características de [!INCLUDE[ssSQL11SP1](../includes/sssql11sp1-md.md)]. Estos cambios también se aplican a [!INCLUDE[ssSQL14](../includes/sssql14-md.md)].  
...
|Cambio de comportamiento en DAX [función ALL](https://msdn.microsoft.com/library/ee634802(v=sql.120).aspx).|Anterior a [!INCLUDE[ssSQL11SP1](../includes/sssql11sp1-md.md)], si especifica una columna [Date] en Marcar como tabla de fechas, para su uso en inteligencia de tiempo y que la columna [Date] se pasa como argumento a la función ALL, a su vez, pasada como un filtro a una función CALCULATE, todos los filtros de todas las columnas de la tabla se omiten, independientemente de cualquier segmentación en la columna de fecha.<br /><br /> Por ejemplo,<br /><br /> `= CALCULATE (<expression>, ALL (DateTable[Date]))`<br /><br /> Anterior a [!INCLUDE[ssSQL11SP1](../includes/sssql11sp1-md.md)], se omiten todos los filtros de todas las columnas de DateTable, independientemente de la columna [Date] pasada como argumento a ALL.<br /><br /> En [!INCLUDE[ssSQL11SP1](../includes/sssql11sp1-md.md)] y en PowerPivot in Excel 2013, el comportamiento omitirá los filtros solo para la columna especificada pasada como argumento a ALL.<br /><br /> Para evitar el nuevo comportamiento, y en efecto omitir todas las columnas como un filtro para la tabla entera, puede excluir la columna [Date] del argumento, por ejemplo,<br /><br /> `=CALCULATE (<expression>, ALL(DateTable))`<br /><br /> Esto dará el mismo resultado que el comportamiento anterior a [!INCLUDE[ssSQL11SP1](../includes/sssql11sp1-md.md)].|  
  
##  <a name="bkmk_sql2012"></a> Cambios de comportamiento en [!INCLUDE[ssSQL11](../includes/sssql11-md.md)]  
 Esta sección documentan los cambios de comportamiento notificados para [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] características de [!INCLUDE[ssSQL11](../includes/sssql11-md.md)]. Estos cambios también se aplican a [!INCLUDE[ssSQL14](../includes/sssql14-md.md)].  
 ...
 **Cómo aumentar los permisos para leer el nivel de permiso para libros individuales**  
...
## <a name="see-also"></a>Vea también  
 ...
 [Principales cambios en Analysis Services características de SQL Server 2014](breaking-changes-to-analysis-services-features-in-sql-server-2014.md)  
