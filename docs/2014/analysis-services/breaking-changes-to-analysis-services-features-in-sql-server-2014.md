---
title: Principales cambios en Analysis Services características de SQL Server 2014 | Documentos de Microsoft
ms.custom: ''
ms.date: 06/13/2017
 ...
 **Esta característica de identificadores de objeto**  
...
##  <a name="bkmk_sql11"></a> Cambios recientes en [!INCLUDE[ssSQL11](../includes/sssql11-md.md)]  
 Esta sección documentan los cambios importantes notificados para [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] características de [!INCLUDE[ssSQL11](../includes/sssql11-md.md)].  
