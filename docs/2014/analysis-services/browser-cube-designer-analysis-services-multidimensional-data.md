---
title: Explorador (Diseñador de cubos) (Analysis Services - datos multidimensionales) | Documentos de Microsoft
ms.custom: ''
ms.date: 06/13/2017
 ...
 **Examinar y consultar mediante el modo de diseño gráfico**  
 ...
 Mientras se trabaja en modo de diseño gráfico, si la **ejecución automática** (![ejecutar la consulta automáticamente](media/rsqdicon-autoexecute.gif "ejecutar la consulta automáticamente")) se selecciona el botón de alternancia en la barra de herramientas, el **Explorador** se ejecuta una consulta cada vez que coloque un objeto de metadatos en el panel de datos. También puede ejecutar manualmente la consulta con la **Ejecutar consulta** (![ejecutar la consulta](media/rsqdicon-run.gif "ejecutar la consulta")) en la barra de herramientas.  
