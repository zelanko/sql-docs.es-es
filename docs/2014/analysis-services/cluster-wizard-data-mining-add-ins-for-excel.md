---
title: Asistente (complementos de minería de datos para Excel de datos) del clúster | Documentos de Microsoft
ms.custom: ''
ms.date: 12/29/2017
...
ms.locfileid: "36107319"
---
# <a name="cluster-wizard-data-mining-add-ins-for-excel"></a>Asistente para clúster (Complementos de minería de datos para Excel)
  ![Asistente para clúster de la cinta de opciones de minería de datos](media/dmc-cluster.gif "Asistente para clúster de la cinta de opciones de minería de datos")  
...
1.  En la cinta de opciones de minería de datos, haga clic en **clúster**y, a continuación, haga clic en **siguiente**.  
...
3.  En el **clústeres** página, puede personalizar la manera en que se basa el modelo.  
    ...
    -   Revise la lista de columnas de la **columnas de entrada** lista y anule la selección de las columnas que no son útiles para crear modelos. Las columnas que debe excluir son los números de identificación, los nombres de cliente, etcétera.  
...
## <a name="more-about-clustering-models"></a>Más información acerca de los modelos de clústeres  
 Puede cambiar el algoritmo de clústeres utilizado por este asistente, haga clic en **avanzadas** y el uso de la **parámetros de algoritmo** cuadro de diálogo.  
