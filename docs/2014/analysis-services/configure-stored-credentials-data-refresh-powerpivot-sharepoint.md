---
title: Configurar credenciales almacenadas para la actualización de datos PowerPivot (PowerPivot para SharePoint) | Documentos de Microsoft
ms.custom: ''
ms.date: 03/06/2017
 ...
 **[!INCLUDE[applies](../includes/applies-md.md)]**  SharePoint 2010  
 ...
 Si tiene problemas para configurar o utilizar la actualización de datos, consulte el [Troubleshooting PowerPivot Data Refresh](http://go.microsoft.com/fwlink/?LinkID=223279) página en la wiki de TechNet para obtener posibles soluciones.  
...
10. En el **especificar los campos de credenciales para la aplicación de destino de almacenamiento seguro** , acepte los valores predeterminados. Tipos y nombres de campo deben ser el nombre de usuario de Windows y la contraseña de Windows.  
...
###  <a name="bkmk_verify"></a> Paso 4: Comprobar la disponibilidad de la cuenta en datos de las páginas de configuración de la actualización  
...
2.  Compruebe que la **conectar con las credenciales guardadas en el servicio de almacenamiento seguro (SSS) para iniciar sesión en el origen de datos** opción está habilitada en la página de configuración de actualización de datos y, a continuación, escriba el nombre de la aplicación de destino.  
