 ...
 **[!INCLUDE[applies](../includes/applies-md.md)]**  SharePoint 2010  
 ...
 [Paso 5: Comprobar la disponibilidad de la cuenta en los datos de las páginas de configuración de actualización](#bkmk_verify)  
...
5.  En actualización de datos, en la cuenta desatendida de PowerPivot Data Refresh, escriba el identificador de aplicación de destino que creó en el paso anterior: **PowerPivotDataRefresh**.  
  
6.  Haga clic en **Aceptar**.  
  
###  <a name="bkmk_grant"></a> Paso 3: Conceder permisos de contribución a la cuenta  
...
###  <a name="bkmk_verify"></a> Paso 5: Comprobar la disponibilidad de la cuenta en los datos de las páginas de configuración de actualización  
