---
title: Conectarse a un servidor de minería de datos | Documentos de Microsoft
ms.custom: ''
ms.date: 12/29/2017
 ...
 **¿Por qué se necesita para conectarse a un servidor?**  
 ...
 **Aparece un mensaje que dice "Se encontró ninguna conexión."**  
  
 Si el texto que aparece en la parte inferior del botón es **sin conexión**, significa que no ha creado una conexión a un [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] base de datos o que la conexión ha fallado. Es posible seguir trabajando en Excel con datos de Access u otros orígenes, pero, para crear un modelo de minería de datos o ejecutar una consulta de predicción, es necesario disponer de una conexión activa.  
  
 **¿Suponga que no tengo permiso para usar el servidor?**  
  
 Si no dispone de los permisos necesarios para almacenar los modelos de minería de datos en el servidor, o si desea probar la minería de datos sin guardar el trabajo, puede utilizar las Herramientas de análisis de tabla, que crean estructuras de datos y modelos temporales. Todavía necesita poder almacenar modelos temporales en el servidor. Pregunte al administrador para habilitar el uso de *modelos de minería de datos de sesión* en el servidor.  
 ...
 **He perdido mi conexión; ¿perdí todo mi trabajo?**  
 ...
 **No se puede conectar al modelo mediante las herramientas de Visio**  
 ...
 **¿Cómo puedo supervisar el uso de la conexión?**  
 ...
 Para habilitar la supervisión de modelos de sesión, seleccione la **usar modelos de sesión** opción en el **seguimiento** cuadro de diálogo.  
 ...
 **¿Qué es un modelo temporal? ¿Cómo puedo guardar un modelo temporal?**  
 ...
 También puede crear explícitamente un modelo o estructura temporal mediante el uso de la **Editor minería de datos avanzada consulta** y seleccionando una de las plantillas DMX. Agregue la cláusula `USE SESSION MODELS` para especificar que los objetos deben ser temporales.   
...
### <a name="creating-backups-of-mining-models-and-structures"></a>Crear copias de seguridad de modelos y estructuras de minería de datos  
 Para crear una copia de seguridad de un modelo o estructura, puede exportarlo mediante [administrar modelos &#40;complementos de minería de datos de SQL Server&#41;](manage-models-sql-server-data-mining-add-ins.md), en el cliente de minería de datos para Excel.  
  
 Si creó un modelo de minería de datos temporal, este normalmente tendrá un nombre que resulta difícil de entender, por ejemplo Table5_593679_TS_62446. Sin embargo, puede usar el [seguimiento &#40;cliente de minería de datos para Excel&#41; ](trace-data-mining-client-for-excel.md) herramienta para descubrir los nombres de las estructuras temporales y los modelos que se crearon con las herramientas de análisis de tabla y, a continuación, haga copias de seguridad mediante  **Administrar modelos**.  
...
3.  Cuando haya encontrado el nombre del modelo temporal y la estructura, abrir **Administrar modelo** y seleccione el modelo.  
