...
###  <a name="bkmk_Query4"></a> Consulta de ejemplo 4: Recuperando lista de conjuntos de elementos y productos  
...
###  <a name="bkmk_Query5"></a> Consulta de ejemplo 5: Devuelve los primeros 10 conjuntos de elementos  
