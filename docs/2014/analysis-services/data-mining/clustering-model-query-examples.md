 ...
 **Consultas de contenido**  
 ...
 [Recuperar metadatos del modelo del conjunto de filas de esquema](#bkmk_Query2)  
  
 [Devolver un clúster o una lista de clústeres](#bkmk_Query3)  
  
 [Devolver atributos para un clúster](#bkmk_Query4)  
  
 [Devolver un perfil de clúster mediante procedimientos almacenados del sistema](#bkmk_Query5)  
  
 [Búsqueda de factores de discriminación para un clúster](#bkmk_Query6)  
  
 [Devolver los casos que pertenecen a un clúster](#bkmk_Query7)  
  
 **Consultas de predicción**  
  
 [Predecir los resultados de un modelo de agrupación en clústeres](#bkmk_Query8)  
...
###  <a name="bkmk_Query2"></a>Consulta de ejemplo 2: recuperar metadatos del modelo del conjunto de filas de esquema  
...
###  <a name="bkmk_Query5"></a>Consulta de ejemplo 5: devolver un perfil de clúster mediante procedimientos almacenados del sistema  
...
###  <a name="bkmk_Query8"></a>Consulta de ejemplo 8: predecir los resultados de un modelo de agrupación en clústeres  
...
|[&#41;de &#40;DMX de clúster](/sql/dmx/cluster-dmx)|Devuelve el clúster que tiene la mayor probabilidad de contener el caso de entrada.|  
...
|[&#41;PredictVariance &#40;DMX](/sql/dmx/predictvariance-dmx)|Devuelve la varianza de una columna especificada.|  
 ...
 Para obtener más información sobre la sintaxis de funciones específicas, vea [Referencia de funciones de Extensiones de minería de datos &#40;DMX&#41;](/sql/dmx/data-mining-extensions-dmx-function-reference).  
