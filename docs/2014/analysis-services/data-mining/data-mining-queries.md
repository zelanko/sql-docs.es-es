...
-   [Consultas de definición de datos &#40;&#41;de minería de datos](data-definition-queries-data-mining.md)  
...
-   **Funciones de predicción personalizadas:** Cada tipo de modelo proporciona un conjunto de funciones de predicción diseñadas para trabajar con los patrones creados por ese algoritmo.  
...
-   **Estadísticas generales:** Hay una serie de funciones que se pueden utilizar con casi cualquier tipo de modelo, que devuelven un conjunto estándar de estadísticas descriptivas, como la desviación estándar.  
...
-   **Estadísticas personalizadas:** Se proporcionan funciones de soporte adicionales para cada tipo de modelo, para generar estadísticas que son relevantes para la tarea de análisis específica.  
