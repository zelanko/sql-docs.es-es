...
### <a name="predicting-discrete-columns"></a>Predecir columnas discretas  
 ...
 ![Nodo de árbol de decisión](../media/dt-tree.gif "nodo de árbol de decisión")  
...
### <a name="predicting-continuous-columns"></a>Predecir columnas continuas  
 ...
 ![Regresión de varias líneas que muestra no linealidad](../media/regression-tree1.gif "regresión varias líneas que muestra no linealidad")  
