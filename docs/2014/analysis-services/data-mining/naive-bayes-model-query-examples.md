 ...
 **Consultas de contenido**  
 ...
 [Buscar más información sobre los atributos](#bkmk_Query3)  
  
 [Usar procedimientos almacenados del sistema](#bkmk_Query4)  
  
 **Consultas de predicción**  
  
 [Predecir resultados mediante una consulta singleton](#bkmk_Query5)  
...
###  <a name="bkmk_Query3"></a>Consulta de ejemplo 3: buscar más información sobre los atributos  
...
###  <a name="bkmk_Query5"></a>Consulta de ejemplo 5: predecir resultados mediante una consulta singleton  
