...
##  <a name="bkmk_PredQuery"></a>Diseño de consulta de predicción básica  
...
-   *La ampliación de los casos del modelo* significa que se agregan los nuevos datos a la serie de datos existente en el modelo de serie temporal. De ahora en adelante, las predicciones se basarán en la nueva serie combinada. Esta opción es adecuada si solamente desea agregar algunos puntos de datos a un modelo existente.  
