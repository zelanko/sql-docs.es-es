...
|**Content**|El tipo de contenido de la columna.|  
...
|**SESIÓN**|Muestra el identificador de la columna.<br /><br /> Si cambia el valor de la propiedad Name de la columna, no afecta al valor de la propiedad ID.|  
