...
|Recupera información sobre los casos de los conjuntos de entrenamiento y de prueba.|[Conjuntos de filas de esquema de minería de datos](../../relational-databases/native-client-ole-db-rowsets/rowsets.md)<br /><br /> [Consultar los conjuntos de filas de esquema de minería de datos &#40;Analysis Services de minería de datos&#41;](data-mining-schema-rowsets-ssas.md)|  
