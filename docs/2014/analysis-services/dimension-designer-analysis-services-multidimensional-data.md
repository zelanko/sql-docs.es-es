 ...
 **Para mostrar el Diseñador de dimensiones**  
  
-   En [!INCLUDE[ssBIDevStudioFull](../includes/ssbidevstudiofull-md.md)], en el **Explorador de soluciones**, use uno de los procedimientos siguientes:  
...
## <a name="pages"></a>Páginas  
 El Diseñador de dimensiones contiene las páginas siguientes:  
  
 [Estructura de dimensión](dimension-structure-dimension-designer-analysis-services-multidimensional-data.md)  
 Use esta página para ver y modificar los atributos, las jerarquías y los niveles de la dimensión.  
