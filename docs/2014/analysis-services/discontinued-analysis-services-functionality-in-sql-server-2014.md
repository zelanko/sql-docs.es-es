...
|Instrucción MDX|Instrucción Create Action|Esta instrucción se incluye por compatibilidad con versiones anteriores. Se reemplaza por el objeto Action. Para obtener más información sobre cómo crear acciones en las versiones recientes [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)]de, vea [acciones &#40;Analysis Services-&#41;de datos multidimensionales ](multidimensional-models/actions-analysis-services-multidimensional-data.md).|  
