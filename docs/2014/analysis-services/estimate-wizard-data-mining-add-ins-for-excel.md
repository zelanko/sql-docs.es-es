---
title: Calcular el Asistente (datos de complementos de minería de datos para Excel) | Documentos de Microsoft
ms.custom: ''
ms.date: 12/29/2017
...
# <a name="estimate-wizard-data-mining-add-ins-for-excel"></a>Asistente para estimación (Complementos de minería de datos para Excel)
  ![Asistente para la estimación de la cinta de opciones de minería de datos](media/dmc-estimate.gif "Asistente para la estimación de la cinta de opciones de minería de datos")  
...
2.  En el **seleccionar datos de origen** cuadro de diálogo, seleccione los datos de origen que desea usar. Puede usar datos de un Excel **tabla**, un Excel **rango de datos**, o desde un **origen de datos externo**.  
...
3.  En el **estimación** cuadro de diálogo, seleccione la **columna que desea analizar**.  
...
6.  Si los datos son numéricos y puede utilizar el método de regresión lineal de Microsoft, puede comprobar la **regresor** cuadro para cualquier columna numérica que sepa (o sospeche) que está correlacionada con el valor de predicción.  
  
     El algoritmo comprobará entonces los valores de esa columna para determinar si afectan a los resultados. Si no está seguro, haga clic en **sugerir** y el algoritmo se pruebe todas las columnas y se detectan automáticamente los valores recomendados para usar como regresores.  
...
7.  En el **dividir los datos en conjuntos de prueba y entrenamiento** página, especifique si desea crear un pequeño subconjunto de los datos de prueba.  
  
8.  En el **finalizar** página, proporcione nombres para la nueva estructura de minería de datos y el modo de minería de datos o acepte los nombres predeterminados que se proporcionan.  
  
9. Establezca las opciones para usar el modelo.  
  
    -   Seleccione **examinar** para abrir inmediatamente el modelo en el Visor.  
...
## <a name="more-about-estimation-models"></a>Más información sobre los modelos de estimación  
 El **estimación** asistente admite el uso de cualquiera de los siguientes algoritmos:  
...
-   Algoritmo de red de Microsoft Neural  
  
 En el **parámetros de algoritmo** cuadro de diálogo, puede establecer opciones avanzadas adicionales, según el algoritmo elegido. Para obtener información sobre las opciones de cada algoritmo, vea estos temas en los Libros en pantalla de SQL Server:  
