...
|**Mensaje**|Si se produjo un error en la importación de la tabla o vista, muestra un vínculo a más información. Esta información se muestra en la ventana Detalles.<br /><br /> Para intentar importar la tabla o vista de nuevo, salga del asistente y ejecútelo de nuevo.|  
