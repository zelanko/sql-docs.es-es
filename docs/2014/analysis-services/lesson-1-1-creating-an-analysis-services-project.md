...
1.  Haga clic en **Inicio**, seleccione **Todos los programas**, **Microsoft SQL Server 2012**y, a continuación, haga clic en **Herramientas de datos de SQL Server**.  
     ...
     Se [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[vsprvs](../includes/vsprvs-md.md)] abre el entorno de desarrollo.  
...
4.  Cambie el nombre del proyecto `Analysis Services Tutorial`a, que también cambia el cuadro Nombre de la **solución** y, a continuación, haga clic en **Aceptar**.  
  
 Ha creado correctamente el `Analysis Services Tutorial` proyecto, basado en el Analysis Services plantilla de **proyecto multidimensional y de minería de datos** , dentro de una nueva solución que también `Analysis Services Tutorial`se denomina.  
