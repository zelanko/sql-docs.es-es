...
3.  Compruebe el **el modo de consulta** propiedad está establecida en **en memoria**.  
  
    > [!NOTE]  
    >  El modelo creado mediante este tutorial no admite el modo DirectQuery.  
  
4.  En el **base de datos** propiedad, escriba `Adventure Works Internet Sales Model`.  
...
## <a name="see-also"></a>Vea también  
 ...
 [Configurar las propiedades de implementación y predeterminadas de modelado de datos &#40;SSAS Tabular&#41;](tabular-models/configure-default-data-modeling-and-deployment-properties-ssas-tabular.md)   
 [Las bases de datos de modelo tabular &#40;SSAS Tabular&#41;](tabular-models/tabular-model-databases-ssas-tabular.md)  
