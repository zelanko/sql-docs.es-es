---
title: Administrar modelos (complementos de minería de datos de servidor SQL) | Documentos de Microsoft
ms.custom: ''
ms.date: 12/29/2017
...
> [!NOTE]  
>  En este cuadro de diálogo no se pueden crear consultas o modelos. Para crear una nueva estructura de minería de datos, use uno de los asistentes incluidos en el cliente de minería de datos para Excel o use la **Editor de consultas avanzadas de minería de datos**.  
