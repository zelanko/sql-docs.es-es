---
title: Modificar asignación (gráfico de precisión de minería de datos) del cuadro de diálogo | Documentos de Microsoft
ms.custom: ''
ms.date: 06/13/2017
