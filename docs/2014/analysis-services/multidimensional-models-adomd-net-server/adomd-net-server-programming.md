...
## <a name="see-also"></a>Consulte también  
 [Programación de cliente de ADOMD.NET](https://docs.microsoft.com/bi-reference/adomd/multidimensional-models-adomd-net-client/adomd-net-client-programming)   
