...
# <a name="cube-cells-analysis-services---multidimensional-data"></a>Celdas de cubos (Analysis Services - Datos multidimensionales)
 ...
 ![Diagrama de cubo en el que se identifica una sola celda](https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/as-cubeintro5.gif "Diagrama de cubo en el que se identifica una sola celda")  
...
-   El miembro Packages.  
 ...
 ![Celdas 3rd quarter y 4th quarter para el miembro 2nd half](https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/as-cubeintro6.gif "Celdas 3rd quarter y 4th quarter para el miembro 2nd half")  
...
## <a name="empty-cells"></a>Celdas vacías  
 ...
 ![Diagrama de cubo en el que se identifican celdas vacías](https://docs.microsoft.com/analysis-services/analysis-services/dev-guide/media/as-cubeintro7.gif "Diagrama de cubo en el que se identifican celdas vacías")  
