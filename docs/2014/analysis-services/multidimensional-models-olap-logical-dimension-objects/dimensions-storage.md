...
ms.locfileid: "62728499"
---
# <a name="dimension-storage"></a>Almacenamiento de dimensiones
  Las dimensiones [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] de admiten dos modos de almacenamiento:  
