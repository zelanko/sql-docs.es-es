...
> [!IMPORTANT]  
>  Solo los administradores de bases de datos o los administradores de servidor `Unlock` pueden emitir explícitamente un comando.  
