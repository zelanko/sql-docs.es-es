...
# <a name="grant-database-permissions-analysis-services"></a>Otorgar permisos de base de datos (Analysis Services)
 ...
 ![Crear función de los permisos de base de datos de cuadro de diálogo que muestra](../media/ssas-permsdbrole.png "crear rol permisos de base de datos de cuadro de diálogo que muestra")  
