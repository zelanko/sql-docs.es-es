...
>  Para obtener más información sobre el impacto que tienen los pasos de cálculo, vea [Descripción de orden de paso y orden de resolución &#40;MDX&#41;](mdx-data-manipulation-understanding-pass-order-and-solve-order.md).  
 ...
 Para controlar el paso de cálculo, el ámbito y el contexto de un script MDX, se pueden usar específicamente la instrucción CACULATE, la `This` función y la instrucción SCOPE.  
...
## <a name="using-the-this-function"></a>Usar la función This  
 La función `This` permite recuperar el subcubo actual en un script MDX. Puede usar el `This` función para configurar rápidamente el valor de las celdas del subcubo actual en una expresión MDX. A menudo utilizará el `This` función junto con la instrucción SCOPE para cambiar el contenido de un subcubo específico durante un paso de cálculo determinado.  
...
### <a name="this-function-example"></a>Ejemplo de la función This  
 El siguiente ejemplo de comando de script MDX utiliza el `This` función para aumentar el valor de la medida cantidad, en el grupo de medida Finance de la [!INCLUDE[ssAWDWsp](../../../includes/ssawdwsp-md.md)] cubo de ejemplo en un 10% para los elementos secundarios del miembro Redmond de la dimensión Customer:  
...
```  
 ...
 Para obtener más información sobre la sintaxis de la `This` función, vea [esto &#40;MDX&#41;](/sql/mdx/this-mdx).  
