...
|Tema|Descripción|  
|-----------|-----------------|  
|[Consulta MDX básica &#40;MDX&#41;](mdx-query-the-basic-query.md)|Proporciona información sobre la sintaxis básica para la instrucción MDX SELECT.|  
...
|[Crear y usar valores de propiedad &#40;&#41;MDX](../../creating-and-using-property-values-mdx.md)|Detalla el proceso de creación y uso de las propiedades de dimensión, nivel, miembro y celda.|  
