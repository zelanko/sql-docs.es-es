...
## <a name="see-also"></a>Vea también  
 [Conectarse en modo con conexión a una base de datos de Analysis Services](connect-in-online-mode-to-an-analysis-services-database.md)   
