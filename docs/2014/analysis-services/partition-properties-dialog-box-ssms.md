...
# <a name="partition-properties-dialog-box-ssms"></a>Propiedades de la partición (cuadro de diálogo, SSMS)
 ...
 Para abrir el cuadro de diálogo **Propiedades de la partición** , en el **Explorador de objetos**, haga clic con el botón derecho en una partición y, después, haga clic en **Propiedades**.  
  
 El cuadro de diálogo **Propiedades de la partición** contiene las siguientes páginas:  
