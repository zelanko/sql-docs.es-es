...
##  <a name="AllocationScheme"></a> Equilibrio de carga  
 Una de las funciones que el servicio PowerPivot realiza es determinar dónde se cargarán los datos de Analysis Services entre las instancias de servicio PowerPivot disponibles. El `AllocationMethod` especifica los criterios con los que se selecciona una instancia de servicio.  
