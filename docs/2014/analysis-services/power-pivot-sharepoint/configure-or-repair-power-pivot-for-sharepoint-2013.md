...
> [!NOTE]
>  En [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] el caso de para SharePoint 2013, los proveedores de datos se instalan al ejecutar el instalador [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] de **spPowerPivot. msi** y la herramienta de configuración de SharePoint 2013. Para obtener más información, vea [instalar o desinstalar el complemento de PowerPivot para SharePoint &#40;&#41;de SharePoint 2013 ](../instances/install-windows/install-or-uninstall-the-power-pivot-for-sharepoint-add-in-sharepoint-2013.md).
