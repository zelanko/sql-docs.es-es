...
### <a name="delete-powerpivot-gallery-sharepoint-2013"></a>Eliminar galería de PowerPivot para SharePoint 2013  
  
1.  Haga clic en configuración ![configuración de SharePoint](../media/as-sharepoint2013-settings-gear.gif "configuración de SharePoint"), a continuación, haga clic en **configuración del sitio**.  
