---
title: Disponibilidad de PowerPivot y recuperación ante desastres (SQL Server 2014) | Documentos de Microsoft
ms.custom: ''
ms.date: 03/07/2017
...
-   [Ejemplo de topología de SharePoint 2013 para lograr alta disponibilidad de PowerPivot](#bkmk_sharepoint2013)  
...
##  <a name="bkmk_sharepoint2013"></a> Ejemplo de topología de SharePoint 2013 para lograr alta disponibilidad de PowerPivot  
...
-   **(1)** Los servidores front-end web. Use el complemento [!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)] 2013 para instalar los proveedores de datos en cada servidor. Para obtener más información, consulte [instalar o desinstalar PowerPivot para SharePoint Add- &#40;SharePoint 2013&#41;](../instances/install-windows/install-or-uninstall-the-power-pivot-for-sharepoint-add-in-sharepoint-2013.md).  
...
## <a name="verification"></a>Comprobación  
 Para obtener instrucciones y scripts necesarios para ayudarle a comprobar un [!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)] implementación antes y después de un ciclo de recuperación ante desastres, consulte [lista de comprobación: usar PowerShell para comprobar PowerPivot para SharePoint](../instances/install-windows/checklist-use-powershell-to-verify-power-pivot-for-sharepoint.md).  
...
-   [Secuencia de comandos de copia de seguridad de la base de datos SQL Server](http://megaupl0ad.net/free/backup%20database%20sql%20server%20script)  
