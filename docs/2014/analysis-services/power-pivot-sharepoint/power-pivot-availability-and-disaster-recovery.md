...
-   [Base de datos de aplicación de servicio PowerPivot y SQL Server tecnologías de disponibilidad y recuperación](#bkmk_sql_server_technologies)  
  
-   [Vínculos a más información](#bkmk_more_resources)  
  
##  <a name="bkmk_sharepoint2013"></a>Ejemplo de topología de SharePoint 2013 para la alta disponibilidad de PowerPivot  
...
-   **(2)** los dos [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] servicios compartidos y **(4)** el servicio de Windows **SQL Server Analysis Services (POWERPIVOT)** se instalan en los servidores de aplicaciones de SharePoint.  
...
-   **(5)** las bases de datos de SQL Server que se usan para las bases de datos de contenido, configuración y aplicación. Esto incluye la base de datos de la aplicación de servicio [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] . El plan de recuperación ante desastres debe incluir la capa de base de datos.  
  
-   **(6)** alguna forma de copia de seguridad o redundancia de la base de datos de SQL Server.  
  
##  <a name="bkmk_sql_server_technologies"></a>Base de datos de aplicación de servicio PowerPivot y SQL Server tecnologías de disponibilidad y recuperación  
...
-   [Compatibilidad con alta disponibilidad y opciones de recuperación ante desastres para bases de datos de SharePoint (SharePoint 2013)](https://technet.microsoft.com/library/jj841106.aspx)  
  
-   [Planear la recuperación ante desastres (SharePoint Server 2010)](https://technet.microsoft.com/library/ff628971\(v=office.14\).aspx)  
