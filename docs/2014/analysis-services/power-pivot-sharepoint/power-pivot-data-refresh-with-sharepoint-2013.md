...
ms.locfileid: "66071231"
---
# <a name="powerpivot-data-refresh-with-sharepoint-2013"></a>Actualización de datos PowerPivot con SharePoint 2013
  El diseño de la actualización [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] de modelos de datos en SharePoint 2013 usa Excel Services como componente principal para cargar y actualizar modelos de datos en una instancia [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] de que se ejecuta en modo de SharePoint. El servidor de [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] ejecuta fuera de la granja de servidores de SharePoint.  
...
|Guardar el libro y el modelo de datos en la base de datos de contenido|**Interactivo:** N/A<br /><br /> **Programado:** Servicios de Excel de SharePoint 2013|SharePoint 2013 Excel Services|  
...
-   **Error de actualización de datos externos:** Se produjo un error mientras se trabajaba en el modelo de datos del libro. Inténtelo de nuevo. No se pueden actualizar una o más conexiones de datos del libro.  
  
 Según el proveedor de datos que esté usando, verá mensajes similares a los siguientes en el registro de ULS.  
  
 **Con el SQL Native Client:**  
 ...
 **Con el proveedor de OLE DB de Microsoft para SQL Server:**  
 ...
 **Resumen de los pasos de configuración** Para configurar **Act como parte del privilegio del sistema operativo** en el servidor local:  
...
-   **Credenciales:** Utiliza credenciales almacenadas. No usa la identidad del usuario actual.  
...
##  <a name="bkmk_refresh_architecture"></a>Arquitectura de actualización de datos programada en SharePoint 2013  
...
||Descripción||  
|-|-----------------|-|  
|**dimensional**|Motor de Analysis Services|Un servidor de [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)][!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] que se ejecuta en modo de SharePoint. El servidor se ejecuta fuera de la granja de servidores de SharePoint.|  
 ...
 **Datos de uso:** Puede ver los datos de uso de la actualización de datos en el panel de administración de PowerPivot. Para ver los datos de uso:  
...
##  <a name="datarefresh_additional_authentication"></a>Consideraciones de autenticación adicionales  
...
-   **Usar una cuenta almacenada**: presupone un identificador de aplicación de servicio de almacenamiento seguro de SharePoint, que Excel Services usa para recuperar el nombre de usuario y la contraseña para autenticar la autenticación de la actualización de datos.  
  
-   **Ninguno**: se usa la **cuenta de servicio desatendida** de Excel Services. La cuenta de servicio se asocia a un proxy de almacenamiento seguro. Configure los valores de la página **Configuración de la aplicación de Excel Services** , en la sección **Datos externos** .  
...
##  <a name="bkmk_moreinformation"></a> Más información  
 [Solucionar problemas de actualización de datos PowerPivot](https://social.technet.microsoft.com/wiki/contents/articles/3870.troubleshooting-powerpivot-data-refresh.aspx).  
