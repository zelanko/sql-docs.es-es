...
##  <a name="bkmk_connect"></a>Conectarse desde Excel  
...
5.  En la última página, puede proporcionar un nombre descriptivo y una descripción. Haga clic en **Finalizar**y en **Aceptar** en el cuadro de diálogo Importar datos para importar los datos.  
 ...
 Para confirmar que MSOLAP.5.dll es la versión actual, examine `HKEY_CLASSES_ROOT\MSOLAP` en el Registro. 
  `CurVer` se debe establecer en MSOLAP.5.  
