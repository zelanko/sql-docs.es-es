---
title: Particiones remotas - cuadro de diálogo de configuración (Analysis Services - datos multidimensionales) avanzadas | Documentos de Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
|**Archivo de copia de seguridad**|Muestra el nombre del archivo de copia de seguridad remoto que contiene los datos que se restaurarán para las particiones remotas de la lista.<br /><br /> Nota: Se mostrará ningún archivo de copia de seguridad si se especificó un archivo de copia de seguridad remoto en el **archivo de copia de seguridad** columna en el **particiones** página de la **Restore Database** cuadro de diálogo.|  
