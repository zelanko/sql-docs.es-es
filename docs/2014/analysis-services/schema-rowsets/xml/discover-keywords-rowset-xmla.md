...
## <a name="rowset-columns"></a>Columnas del conjunto de filas  
 El `DISCOVER_KEYWORDS` filas contiene las columnas siguientes.  
...
## <a name="restriction-columns"></a>Columnas de restricción  
 El `DISCOVER_KEYWORDS` se puede restringir el conjunto de filas en las columnas enumeradas en la tabla siguiente.  
