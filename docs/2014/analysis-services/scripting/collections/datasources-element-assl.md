...
ms.locfileid: "36104135"
---
# <a name="datasources-element-assl"></a>Elemento DataSources (ASSL)
  Contiene la colección de [DataSource](../objects/datasource-element-assl.md) elementos asociados a un [base de datos](../objects/database-element-assl.md) elemento.  
