...
ms.locfileid: "36199999"
---
# <a name="miningmodels-element-assl"></a>Elemento MiningModels (ASSL)
  Contiene la colección de [MiningModel](../objects/miningmodel-element-assl.md) elementos asociados a un [MiningStructure](../objects/miningstructure-element-assl.md).  
