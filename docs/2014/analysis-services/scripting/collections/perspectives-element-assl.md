...
ms.locfileid: "48171485"
---
# <a name="perspectives-element-assl"></a>Elemento Perspectives (ASSL)
  Contiene la colección de [perspectiva](../objects/perspective-element-assl.md) elementos asociados con un [cubo](../objects/cube-element-assl.md) elemento.  
...
|Elementos secundarios|[Perspectiva](../objects/perspective-element-assl.md)|  
