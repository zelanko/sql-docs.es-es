...
## <a name="remarks"></a>Notas  
 Para obtener información adicional sobre la `Binding` tipo, incluidas las tablas de objetos de Analysis Services Scripting Language (ASSL) de la `Binding` tipo y la jerarquía de herencia de `Binding` tipos, consulte [enlace](binding-data-type-assl.md) elemento.  
