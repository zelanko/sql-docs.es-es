...
## <a name="remarks"></a>Notas  
 `UserDefinedGroupBinding` se trata automáticamente como un [AttributeBinding](attributebinding-data-type-assl.md), cuyo [tipo](../properties/type-element-binding-assl.md) elemento está establecido en *todos los*.  
