...
|[Elemento aggregation &#40;ASSL&#41;](aggregation-element-assl.md)|Define una agregación única para una [partición](partition-element-assl.md) elemento.|  
...
|[Elemento AlgorithmParameter &#40;ASSL&#41;](algorithmparameter-element-assl.md)|Define un parámetro para el algoritmo usado por un [MiningModel](miningmodel-element-assl.md) elemento.|  
...
|[Elemento de anotación &#40;ASSL&#41;](annotation-element-assl.md)|Contiene elementos que se utilizan para extender el esquema ASSL.|  
|[Assembly (elemento) &#40;ASSL&#41;](assembly-element-assl.md)|Representa un [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)] ensamblado o una biblioteca de vínculos dinámicos de COM (DLL) asociada con un [Server](server-element-assl.md) elemento o un [base de datos](database-element-assl.md) elemento.|  
...
|[Elemento Calculation &#40;ASSL&#41;](calculation-element-assl.md)|Asocia un cálculo con un [perspectiva](perspective-element-assl.md) elemento.|  
...
|[Elemento CellPermission &#40;ASSL&#41;](cellpermission-element-assl.md)|Se describen los permisos que los miembros de un [rol](role-element-assl.md) elemento tienen en celdas individuales dentro de un [cubo](cube-element-assl.md) elemento.|  
|[Elemento de columna &#40;ASSL&#41;](column-element-assl.md)|Describe una columna en la colección de columnas asociada al elemento principal.|  
...
|[Elemento CubePermission &#40;ASSL&#41;](cubepermission-element-assl.md)|Define los permisos de los miembros de una determinada [rol](role-element-assl.md) elemento en un determinado [cubo](cube-element-assl.md) elemento.|  
