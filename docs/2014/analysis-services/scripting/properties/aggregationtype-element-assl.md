...
ms.locfileid: "36111657"
---
# <a name="aggregationtype-element-assl"></a>Elemento AggregationType (ASSL)
  Define el tipo de agregación almacenado por la [partición](../objects/partition-element-assl.md) elemento.  
...
|Relación|Elemento|  
|------------------|-------------|  
|Elemento primario|[AggregationInstance](../objects/aggregationinstance-element-assl.md)|  
