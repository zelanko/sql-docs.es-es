...
ms.locfileid: "48174365"
---
# <a name="calendarstartdate-element-assl"></a>Elemento CalendarStartDate (ASSL)
  Define la fecha de inicio del período del calendario para el [TimeBinding](../data-type/binding-data-type-assl.md) elemento.  
...
## <a name="remarks"></a>Comentarios  
 ...
 El elemento que se corresponde con el elemento primario de `CalendarStartDate` en el objeto de Analysis Management Objects (AMO) es el modelo <xref:Microsoft.AnalysisServices.TimeBinding>.  
