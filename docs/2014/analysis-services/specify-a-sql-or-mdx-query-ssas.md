---
title: Especifique una consulta SQL o MDX (SSAS) | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
|**Validar**|Determine si la instrucción SQL es válida.|  
|**Design**|Diseñe una instrucción SQL utilizando el cuadro de diálogo de diseñador de consultas. Para más información, vea [Diseñador de consultas relacionales &#40;SSAS&#41;](relational-query-designer-ssas.md).|  
