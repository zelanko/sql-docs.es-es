...
-   [Para crear una medida mediante una fórmula de agregación estándar](#bkmk_create_stand)  
  
-   [Para crear una medida mediante una fórmula personalizada](#bkmk_create_custom)  
  
-   [Para editar las propiedades de la medida](#bkmk_edit)  
...
###  <a name="bkmk_create_stand"></a>Para crear una medida mediante una fórmula de agregación estándar  
...
###  <a name="bkmk_create_custom"></a>Para crear una medida mediante una fórmula personalizada  
...
###  <a name="bkmk_edit"></a>Para editar las propiedades de la medida  
