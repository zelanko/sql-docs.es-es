...
|[Importar desde Analysis Services &#40;Tabular de SSAS&#41;](import-from-analysis-services-ssas-tabular.md)|En este tema se describe cómo crear un proyecto de modelos tabulares basado en un modelo ya existente en Analysis Services. Se extraen los metadatos del modelo existente y se usan para crear el modelo.|  
