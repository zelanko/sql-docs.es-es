...
##  <a name="bkmk_ws_prop"></a>Propiedades de la base de datos  
...
|Tema|Descripción|  
|-----------|-----------------|  
|[Propiedades del modelo &#40;&#41;tabular de SSAS](model-properties-ssas-tabular.md)|Proporciona descripciones y pasos de configuración para las propiedades de base de datos del área de trabajo de un modelo.|  
