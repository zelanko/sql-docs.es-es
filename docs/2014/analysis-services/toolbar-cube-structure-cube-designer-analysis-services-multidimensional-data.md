...
|**Ocultar tabla**|Haga clic para ocultar la tabla seleccionada en el panel **Vista del origen de datos** .<br /><br /> Nota: Esta opción está deshabilitada si no se selecciona una tabla en la **vista del origen de datos** panel.|  
