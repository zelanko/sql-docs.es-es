...
|**Eliminar traducción**|Haga clic para mostrar el cuadro de diálogo **Eliminar objetos** y eliminar la traducción seleccionada.<br /><br /> Nota: Esta opción está habilitada sólo si se ha seleccionado una traducción en el **detalles de traducción** panel.|  
