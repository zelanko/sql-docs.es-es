...
ms.locfileid: "36201013"
---
# <a name="sources-element-xmla"></a>Elemento Sources (XMLA)
  Contiene una colección de [origen](source-element-xmla.md) elementos para el elemento primario [MergePartitions](../xml-elements-commands/mergepartitions-element-xmla.md) elemento.  
