---
title: Tiempo (XMLA) del elemento | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
...
ms.locfileid: "37151486"
---
# <a name="time-element-xmla"></a>Elemento Time (XMLA)
  Especifica el límite de tiempo utilizado por el comando [DesignAggregations](../xml-elements-commands/designaggregations-element-xmla.md) para diseñar las agregaciones.  
