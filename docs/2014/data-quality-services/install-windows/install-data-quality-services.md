...
-   [Tareas posteriores a la instalación](#PostInstallationTasks): Realice estas tareas después de finalizar el programa de instalación de SQL Server para finalizar la instalación de DQS.  
  
> [!NOTE]  
>  Este tema no incluye instrucciones para ejecutar el programa de instalación desde la línea de comandos. Para obtener información acerca de las opciones de la [!INCLUDE[ssDQSServer](../../includes/ssdqsserver-md.md)] línea de comandos para la instalación y el cliente, vea [parámetros de características](../../database-engine/install-windows/install-sql-server-from-the-command-prompt.md#Feature) en [install SQL Server 2014 desde el símbolo del sistema](../../database-engine/install-windows/install-sql-server-from-the-command-prompt.md).  
  
##  <a name="PreInstallationTasks"></a>Tareas previas a la instalación  
...
|-------------------|---------------------------------|  
|[!INCLUDE[ssDQSServer](../../includes/ssdqsserver-md.md)]|Memoria (RAM):<br />-Mínimo: 2 GB<br />-Recomendado: 4 GB o más<br /><br /> [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]Motor de base de datos. Para obtener más información, consulte [acerca del motor de base de datos de SQL Server](../../database-engine/sql-server-database-engine-overview.md).|  
...
> -   Aunque Microsoft Excel no es un requisito previo para instalar Data Quality Client, Microsoft Excel 2003 o posterior debe estar instalado en el equipo Data Quality Client para realizar diversas operaciones en la aplicación cliente como es importar los valores de dominio de un archivo de Excel o asignar los datos de origen en un archivo de Excel para actividades como la detección, la limpieza o la correspondencia.  
 ...
 Para obtener información detallada acerca de los requisitos mínimos del [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]sistema para la instalación de, consulte [requisitos de hardware y software para la instalación de SQL Server 2014](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server.md).  
...
## <a name="see-also"></a>Consulte también  
 ...
 [Solucionar problemas de instalación y configuración en DQS](https://social.technet.microsoft.com/wiki/contents/articles/3776.aspx)  
