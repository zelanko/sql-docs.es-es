...
4.  En el menú contextual, puede hacer lo siguiente:  
    ...
    1.  **Abra**: Haga clic para abrir la base de conocimiento de la actividad seleccionada en el **seleccione la actividad** panel.  
    ...
    4.  **Cambiar el nombre de**: Haga clic aquí para editar el campo Base de conocimiento de la tabla de la base de conocimiento en la que hizo clic con el botón secundario. Cambie el nombre y, a continuación, haga clic en esa base de conocimiento y haga clic de nuevo en el campo para aceptar el cambio de nombre.  
