---
title: Conectarse a la página de réplicas secundarias existentes (Asistente para agregar réplica y agregar bases de datos) | Documentos de Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "36107487"
---
# <a name="connect-to-existing-secondary-replicas-page-add-replica-wizard-and-add-databases-wizard"></a>Conectarse a la página de réplicas secundarias existentes (Asistente para agregar réplica y agregar bases de datos)
