...
-   **Blogs:**  
     ...
     [Supervisar el estado de AlwaysOn con PowerShell, parte 2: Uso avanzado de cmdlets](https://blogs.msdn.com/b/sqlalwayson/archive/2012/02/13/monitoring-alwayson-health-with-powershell-part-2.aspx)  
  
     [Supervisar el estado de AlwaysOn con PowerShell, parte 3: Una sencilla aplicación de supervisión](https://blogs.msdn.com/b/sqlalwayson/archive/2012/02/15/monitoring-alwayson-health-with-powershell-part-3.aspx)  
  
     [Supervisar el estado de AlwaysOn con PowerShell, parte 4: Integration with SQL Server Agent](https://blogs.msdn.com/b/sqlalwayson/archive/2012/02/15/the-always-on-health-model-part-4.aspx) (Supervisión del mantenimiento de Always On con PowerShell, parte 4: integración con el Agente SQL Server)  
