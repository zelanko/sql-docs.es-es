---
title: Especifique la dirección URL del extremo al agregar o modificar una réplica de disponibilidad (SQL Server) | Documentos de Microsoft
ms.custom: ''
ms.date: 06/13/2017
