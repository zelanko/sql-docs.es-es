...
##  <a name="CreateEndpoint"></a>CREAR PUNTO DE CONEXIÓN  
...
##  <a name="CreateAG"></a>CREAR GRUPO DE DISPONIBILIDAD  
 [Crear grupo de disponibilidad](/sql/t-sql/statements/create-availability-group-transact-sql) crea un nuevo grupo de disponibilidad y, opcionalmente, un agente de escucha del grupo de disponibilidad. Como mínimo, debe especificar la instancia del servidor local, que se convertirá en la réplica principal inicial. Opcionalmente, puede especificar también hasta cuatro réplicas secundarias.  
...
##  <a name="AlterAG"></a>ALTER AVAILABILITY GROUP  
 [ALTER Availability Group](/sql/t-sql/statements/alter-availability-group-transact-sql) admite el cambio de un grupo de disponibilidad existente o un agente de escucha de grupo de disponibilidad y la conmutación por error de un grupo de disponibilidad.  
...
##  <a name="AlterDb"></a>ALTER DATABASE... ESTABLECER HADR...  
...
##  <a name="DropAG"></a>QUITAR GRUPO DE DISPONIBILIDAD  
...
##  <a name="Restrictions"></a>Restricciones en las instrucciones de Transact-SQL de grupo de disponibilidad  
