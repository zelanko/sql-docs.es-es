---
title: Las transacciones entre bases de datos no compatibles para la creación de reflejo de base de datos o AlwaysOn grupos de disponibilidad (SQL Server) | Documentos de Microsoft
ms.custom: ''
ms.date: 03/06/2017
