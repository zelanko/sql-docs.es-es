...
4.  En la página **Conectar con réplicas secundarias existentes** , conéctese a cada réplica secundaria del grupo de disponibilidad. Para obtener más información, consulte [conectar a la página de réplicas secundarias existentes &#40;Asistente para agregar réplica y el Asistente para agregar bases de datos&#41;](connect-to-existing-secondary-replicas-page.md).  
