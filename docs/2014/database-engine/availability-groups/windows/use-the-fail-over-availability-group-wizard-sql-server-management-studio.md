...
###  <a name="prerequisites-for-using-the-failover-availability-group-wizard"></a><a name="Prerequisites"></a>Requisitos previos para usar el Asistente para conmutación por error del grupo de disponibilidad  
...
###  <a name="select-new-primary-replica-page"></a><a name="SelectNewPrimaryReplica"></a>Página seleccionar nueva réplica principal  
...
###  <a name="confirm-potential-data-loss-page"></a><a name="ConfirmPotentialDataLoss"></a>Página confirmar la posible pérdida de datos  
...
###  <a name="connect-to-replica-page"></a><a name="ConnectToReplica"></a>Página conectar a la réplica  
