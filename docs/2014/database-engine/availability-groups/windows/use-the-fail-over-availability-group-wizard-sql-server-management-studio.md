...
-   **[!INCLUDE[ssAoFoAgWiz](../../../includes/ssaofoagwiz-md.md)]páginas**  
     ...
     [Página seleccionar nueva réplica principal](#SelectNewPrimaryReplica) (más adelante en este tema)  
...
###  <a name="Prerequisites"></a>Requisitos previos para usar el Asistente para conmutación por error del grupo de disponibilidad  
...
###  <a name="SelectNewPrimaryReplica"></a>Página seleccionar nueva réplica principal  
...
|**Cuórum forzado**|El clúster se ha iniciado con quórum forzado.|  
|**Cuórum desconocido**|El estado de quórum del clúster no está disponible.|  
|**No aplicable**|El nodo que hospeda la réplica de disponibilidad no tiene quórum.|  
  
 Para obtener más información, vea [modos de cuórum de WSFC y configuración de votación &#40;SQL Server&#41;](../../../sql-server/failover-clusters/windows/wsfc-quorum-modes-and-voting-configuration-sql-server.md).  
...
|Value|Descripción|  
|-----------|-----------------|  
|**Sin pérdida de datos**|Esta réplica secundaria actualmente admite la conmutación por error planeada. Este valor solo aparece cuando una réplica secundaria en modo de confirmación sincrónica está sincronizada con la réplica principal.|  
...
###  <a name="ConfirmPotentialDataLoss"></a>Página confirmar la posible pérdida de datos  
...
###  <a name="ConnectToReplica"></a>Página conectar a la réplica  
