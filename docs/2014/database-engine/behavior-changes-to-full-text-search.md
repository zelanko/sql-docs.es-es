---
title: Cambios de comportamiento en búsqueda de texto completo | Documentos de Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
1.  Existen nuevos separadores de palabras para inglés. Si tiene que conservar el comportamiento anterior, vea [cambiar el separador de palabras utilizadas para inglés de Estados Unidos y el inglés del Reino Unido](../relational-databases/search/change-the-word-breaker-used-for-us-english-and-uk-english.md).  
...
|**Término**|**Resultados con los anteriores separadores de palabras y lematizadores**|**Resultados con los separadores de palabras y lematizadores**|  
|--------------|--------------------------------------------------------|---------------------------------------------------|  
...
|v-z *(donde v y z son palabras irrelevantes)*|*(ningún resultado)*|v-z|  
...
## <a name="behavior-changes-in-full-text-search-in-sql-server-2008"></a>Cambios de comportamiento en la búsqueda de texto completo de SQL Server 2008  
...
-   Administración y almacenamiento integrados: búsqueda de texto completo se integra directamente con las características de almacenamiento y administración inherentes de [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)], y el servicio MSFTESQL ya no existe.  
...
-   [!INCLUDE[ssKatmai](../includes/sskatmai-md.md)] y versiones posteriores incluyen nuevos separadores de palabras para muchos de los idiomas de [!INCLUDE[ssVersion2005](../includes/ssversion2005-md.md)]. Los únicos separadores de palabras que siguen siendo iguales son los de inglés, coreano, tailandés y chino (tradicional y simplificado). Para otros idiomas, si se importó un catálogo de texto completo cuando una [!INCLUDE[ssVersion2005](../includes/ssversion2005-md.md)] base de datos se actualizó a [!INCLUDE[ssKatmai](../includes/sskatmai-md.md)] o una versión posterior, uno o varios de los idiomas usados por los índices de texto completo en el catálogo de texto completo podrían estar ahora asociados a nuevos separadores de palabras que comportamiento puede variar ligeramente diferente de los separadores de palabras importados. Para obtener más información acerca de cómo garantizar la coherencia entre las consultas y el contenido del índice de texto completo, vea [actualizar la búsqueda de texto completo](../relational-databases/search/upgrade-full-text-search.md).  
  
-   Se ha agregado un nuevo servicio del iniciador del FDHOST (MSSQLFDLauncher). Para obtener más información, consulte [empezar a trabajar con búsqueda de texto completo](../relational-databases/search/get-started-with-full-text-search.md).  
