---
title: Cambios substanciales en búsqueda de texto completo | Documentos de Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
|Catálogo **ItemCount**|Columna Blob con una extensión NULL.|Se contabiliza en **ItemCount** de catálogo|No se contabiliza en **ItemCount** del catálogo.|  
...
|**Precompute rank** opción de nivel de servidor|Optimización de rendimiento de las consultas FREETEXTTABLE.|Cuando la opción se establece en 1, las consultas FREETEXTTABLE especificadas con *top_n_by_rank* usar datos de rangos precalculados almacenados en los catálogos de texto completo.|No se admite.|  
...
|Palabras irrelevantes específicas de la configuración regional|Consulta específica de inlocale variantes de un idioma principal, como francés belga y francés canadiense.|Tipos Variant de inlocale específicos de las consultas se procesa mediante los componentes (separadores de palabras, lematizadores y palabras irrelevantes) del idioma principal. Por ejemplo, los componentes de francés (Francia) se utilizan para analizar el francés (Bélgica).|Debe agregar explícitamente las palabras irrelevantes para cada identificador de configuración regional (LCID). Por ejemplo, necesitaría especificar un LCID para Bélgica, Canadá y Francia.|  
...
## <a name="see-also"></a>Vea también  
 [Cambios de comportamiento en búsqueda de texto completo](../relational-databases/search/full-text-search.md)   
