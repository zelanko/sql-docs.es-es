...
-   **Seguimiento:**  [Después de configurar la opción index create memory](#FollowUp)  
...
##  <a name="FollowUp"></a> Sigue: Después de configurar la opción de memoria para creación de índices  
