...
-   **Seguimiento:**  [Después de configurar la opción scan for startup procs](#FollowUp)  
...
##  <a name="FollowUp"></a> Sigue: Después de configurar la opción de buscar procedimientos de inicio  
