...
-   **Seguimiento:**  [Después de configurar la opción de configuración de opciones de usuario](#FollowUp)  
...
##  <a name="FollowUp"></a> Seguimiento: Después de configurar la opción de configuración de opciones de usuario  
