...
-   [Permisos de servicio](#Serv_Perm)  
    ...
    -   [Configuración y Access Control del servicio](#Serv_SID)  
    ...
    -   [Permisos del sistema de archivos relacionados con ubicaciones de disco inusuales](#Unusual_Locations)  
  
    -   [Revisar consideraciones adicionales](#Review_additional_considerations)  
...
-   [Aprovisionamiento](#Provisioning)  
    ...
    -   [Aprovisionamiento de Motor de base de datos](#DE_Prov)  
  
        -   [Entidades de seguridad de Windows](#Win_Principals)  
  
        -   [Cuenta SA](#sa)  
  
        -   [Inicio de sesión y privilegios de SID por servicio de SQL Server](#Logins)  
  
        -   [Inicio de sesión y privilegios de Agente SQL Server](#Agent)  
  
        -   [Instancia y privilegios de clúster de conmutación por error de HADRON y SQL](#Hadron)  
  
        -   [Escritor SQL y privilegios](#Writer)  
...
-   [Apéndice](#Appendix)  
    ...
    -   [Identificar servicios que reconocen instancias y que no reconocen instancias](#Identify_instance_aware_and_unaware)  
  
    -   [Nombres de servicio localizados](#Localized_service_names)  
...
-   Servicios de base de datos: servicio [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] para [!INCLUDE[ssDE](../../includes/ssde-md.md)]el relacional. ** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ** El archivo ejecutable es \<MSSQLPATH>\MSSQL\Binn\sqlservr.exe.  
  
-   Agente: ejecuta trabajos, supervisa [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], activa alertas y habilita la automatización de algunas tareas administrativas. ** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ** El servicio del Agente [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] está presente pero deshabilitado en las instancias de [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)]. El archivo ejecutable es \<MSSQLPATH>\MSSQL\Binn\sqlagent.exe.  
...
-   **[!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]**: Proporciona compatibilidad de administración [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] para el almacenamiento y la ejecución de paquetes. La ruta de acceso del \<archivo ejecutable es MSSQLPATH> \120\dts\binn\msdtssrvr.exe  
  
-   Explorador: servicio de resolución de nombres que [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] proporciona información de conexión para los equipos cliente. ** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] ** La ruta de acceso ejecutable es c:\Archivos de programa (x86)\Microsoft SQL Server\90\Shared\sqlbrowser.exe  
  
-   **Búsqueda de texto completo** : crea rápidamente índices de texto completo en el contenido y las propiedades de datos estructurados y semiestructurados para proporcionar filtrado de documentos y separación [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]de palabras para.  
  
-   **Escritor SQL** : permite que las aplicaciones de copia de seguridad y restauración funcionen en el marco de servicio de instantáneas de volumen (VSS).  
  
-   Controlador de Distributed Replay: proporciona la orquestación de la reproducción de seguimiento en varios equipos cliente de Distributed Replay. ** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] **  
  
-   Distributed Replay cliente: uno o varios equipos cliente de Distributed Replay que funcionan conjuntamente con un controlador de Distributed Replay para simular cargas de trabajo simultáneas en una [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]instancia de. ** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] **  
  
##  <a name="Serv_Prop"></a>Propiedades y configuración del servicio  
...
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Directivas|[SERVICIO DE RED](#Network_Service)|[Cuenta virtual](#VA_Desc)<sup>*</sup>|  
...
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Controlador de Distributed Replay|[SERVICIO DE RED](#Network_Service)|[Cuenta virtual](#VA_Desc)<sup>*</sup>|  
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Cliente de Distributed Replay|[SERVICIO DE RED](#Network_Service)|[Cuenta virtual](#VA_Desc)<sup>*</sup>|  
|Selector de FD (búsqueda de texto completo)|[SERVICIO LOCAL](#Local_Service)|[Cuenta virtual](#VA_Desc)|  
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Explorador|[SERVICIO LOCAL](#Local_Service)|[SERVICIO LOCAL](#Local_Service)|  
|
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] VSS Writer|[SISTEMA LOCAL](#Local_System)|[SISTEMA LOCAL](#Local_System)|  
  
 <sup>*</sup>Cuando se necesitan recursos externos [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] al equipo, [!INCLUDE[msCoName](../../includes/msconame-md.md)] recomienda el uso de una cuenta de servicio administrada (MSA), configurada con los privilegios mínimos necesarios.  
  
 **SQL Server instancia de clúster de conmutación por error**  
...
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Directivas|Ninguno. Proporcione una cuenta de [usuario de dominio](#Domain_User) .|Proporcione una cuenta de [usuario de dominio](#Domain_User) .|  
...
####  <a name="Changing_Accounts"></a>Cambiar las propiedades de la cuenta  
...
###  <a name="New_Accounts"></a>Nuevos tipos de cuenta disponibles con Windows 7 y Windows Server 2008 R2  
...
-   <a name="VA_Desc"></a>**Cuentas virtuales**  
    ...
    |-------------|--------------------------|  
    |Instancia predeterminada del servicio del [!INCLUDE[ssDE](../../includes/ssde-md.md)] .|**SERVICE\MSSQLSERVER NT**|  
    |Instancia con nombre de un servicio de [!INCLUDE[ssDE](../../includes/ssde-md.md)] denominado **PAYROLL**|**NT SERVICE\MSSQL $ PAYROLL**|  
    |
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] en la instancia predeterminada de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|**SERVICE\SQLSERVERAGENT NT**|  
    |[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Servicio del agente en una instancia [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] de denominada **PAYROLL**|**NT SERVICE\SQLAGENT $ PAYROLL**|  
...
-   **Deshabilitado** El servicio está instalado pero no se está ejecutando actualmente.  
  
-   **Manual** El servicio está instalado, pero solo se iniciará cuando otro servicio o aplicación necesite su funcionalidad.  
  
-   **Automática** El sistema operativo inicia automáticamente el servicio.  
...
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Cliente de Distributed Replay|DRU_CLT, CLTSVCACCOUNT, CLTSVCPASSWORD, CLTSTARTUPTYPE, CLTCTLRNAME, CLTWORKINGDIR, CLTRESULTDIR|  
 ...
 <sup>2</sup> El [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] servicio del agente está deshabilitado [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] en [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] las instancias de y con Advanced Services.  
...
-   [Permisos del sistema de archivos concedidos a SQL Server SID por servicio o a SQL Server grupos locales de Windows](#Reviewing_ACLs)  
...
###  <a name="Serv_SID"></a>Configuración y Access Control del servicio  
 
  [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] habilita un SID por servicio por cada uno de sus servicios para permitir el aislamiento del servicio y proporcionar una defensa optimizada. El SID por servicio se deriva del nombre del servicio y es único para ese servicio. Por ejemplo, un nombre de SID de servicio [!INCLUDE[ssDE](../../includes/ssde-md.md)] para el servicio podría ser **NT Service\MSSQL $**_\<InstanceName>_. El aislamiento del servicio permite obtener acceso a objetos concretos sin necesidad de ejecutar una cuenta con un alto nivel de privilegios ni debilitar la protección de seguridad del objeto. Mediante el uso de una entrada de control de acceso que contenga un SID por servicio, un servicio de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] puede restringir el acceso a sus recursos.  
...
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Servicio|Permisos concedidos por el programa de instalación de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|  
|---------------------------------------|------------------------------------------------------------|  
|**[!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]:**<br /><br /> (Todos los derechos se conceden al SID por servicio. Instancia predeterminada: **NT SERVICE\MSSQLSERVER**. Instancia con nombre: **NT SERVICE\MSSQL$** InstanceName).|**Iniciar sesión como servicio** (SeServiceLogonRight)<br /><br /> **Reemplazar un token de nivel de proceso** (SeAssignPrimaryTokenPrivilege)<br /><br /> **Omitir comprobación de recorrido** (SeChangeNotifyPrivilege)<br /><br /> **Ajustar las cuotas de memoria de un proceso** (SeIncreaseQuotaPrivilege)<br /><br /> Permiso para iniciar el objeto de escritura de SQL<br /><br /> Permiso para leer el servicio Registro de eventos<br /><br /> Permiso para leer el servicio Llamada a procedimiento remoto|  
|Agente: <sup>1</sup> ** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] **<br /><br /> (Todos los derechos se conceden al SID por servicio. Instancia predeterminada: **NT Service\SQLSERVERAGENT**. Instancia con nombre: **NT Service\SQLAGENT$**_InstanceName_).|**Iniciar sesión como servicio** (SeServiceLogonRight)<br /><br /> **Reemplazar un token de nivel de proceso** (SeAssignPrimaryTokenPrivilege)<br /><br /> **Omitir comprobación de recorrido** (SeChangeNotifyPrivilege)<br /><br /> **Ajustar las cuotas de memoria de un proceso** (SeIncreaseQuotaPrivilege)|  
|**[!INCLUDE[ssAS](../../includes/ssas-md.md)]:**<br /><br /> (Todos los derechos se conceden a un grupo local de Windows. Instancia predeterminada: ** SQLServerMSASUser$**_nombreDeEquipo_**$MSSQLSERVER**. Instancia con nombre: **SQLServerMSASUser $**_NombreDeEquipo_**$**_nombreDeInstancia_. [!INCLUDE[ssGeminiShort](../../includes/ssgeminishort-md.md)]instancia: **SQLServerMSASUser $**_NombreDeEquipo_**$**_PowerPivot_).|**Iniciar sesión como servicio** (SeServiceLogonRight)<br /><br /> Solo para modo tabular:<br /><br /> **Aumentar un espacio de trabajo del proceso** (SeIncreaseWorkingSetPrivilege)<br /><br /> **Ajustar las cuotas de memoria de un proceso** (SeIncreaseQuotaSizePrivilege)<br /><br /> **Bloquear páginas en la memoria** (SeLockMemoryPrivilege): solo es necesario cuando la paginación está desactivada por completo.<br /><br /> Solo para la instalación de clústeres de conmutación por error:<br /><br /> **Aumentar prioridad de programación** (SeIncreaseBasePriorityPrivilege)|  
...
|**[!INCLUDE[ssIS](../../includes/ssis-md.md)]:**<br /><br /> (Todos los derechos se conceden al SID por servicio. Instancia predeterminada e instancia con nombre: **NT SERVICE\MsDtsServer120**. 
  [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] no tiene un proceso independiente para una instancia con nombre).|**Iniciar sesión como servicio** (SeServiceLogonRight)<br /><br /> Permiso para escribir en el registro de eventos de la aplicación<br /><br /> **Omitir comprobación de recorrido** (SeChangeNotifyPrivilege)<br /><br /> **Suplantar a un cliente después de la autenticación** (SeImpersonatePrivilege)|  
|**Búsqueda de texto completo:**<br /><br /> (Todos los derechos se conceden al SID por servicio. Instancia predeterminada: **NT Service\MSSQLFDLauncher**. Instancia con nombre: **NT Service\ MSSQLFDLauncher$**_InstanceName_).|**Iniciar sesión como servicio** (SeServiceLogonRight)<br /><br /> **Ajustar las cuotas de memoria de un proceso** (SeIncreaseQuotaPrivilege)<br /><br /> **Omitir comprobación de recorrido** (SeChangeNotifyPrivilege)|  
|**[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Explorador:**<br /><br /> (Todos los derechos se conceden a un grupo local de Windows. Instancia predeterminada o con nombre: **SQLServer2005SQLBrowserUser**_$nombreDeEquipo_. 
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Browser no tiene un proceso independiente para una instancia con nombre).|**Iniciar sesión como servicio** (SeServiceLogonRight)|  
|**[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]VSS Writer:**<br /><br /> (Todos los derechos se conceden al SID por servicio. Instancia predeterminada o con nombre: **NT Service\SQLWriter**. 
...
|**[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Controlador de Distributed Replay:**|**Iniciar sesión como servicio** (SeServiceLogonRight)|  
|**[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Cliente de Distributed Replay:**|**Iniciar sesión como servicio** (SeServiceLogonRight)|  
  
 <sup>1</sup> El [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] servicio del agente está deshabilitado [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)]en las instancias de.  
  
###  <a name="Reviewing_ACLs"></a>Permisos del sistema de archivos concedidos a SQL Server SID por servicio o grupos locales de Windows  
...
||120\shared|Lectura, Ejecución|  
||120\shared\Errordumps|Lectura, Escritura|  
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Explorador|120\shared\ASConfig|Lectura|  
||120\shared|Lectura, Ejecución|  
||120\shared\Errordumps|Lectura, Escritura|  
...
||\<ToolsDir> \DReplayController\\{All dll}|Lectura, Ejecución, Mostrar el contenido de la carpeta|  
||
...
|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Cliente de Distributed Replay|
  \<ToolsDir>\DReplayClient\Log\|Lectura, Ejecución, Mostrar el contenido de la carpeta|  
...
||
 ...
 <sup>1</sup> El [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] servicio del agente está deshabilitado [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] en [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] las instancias de y con Advanced Services.  
...
||Users|\tools\binn\schemas\sqlserver\2004\07\showplan|Lectura, Ejecución|  
|[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]|Cuenta de servicio de Windows del servidor de informes|instalar>\Reporting Services\LogFiles * \< *|Delete<br /><br /> READ_CONTROL<br /><br /> SYNCHRONIZE<br /><br /> FILE_GENERIC_READ<br /><br /> FILE_GENERIC_WRITE<br /><br /> FILE_READ_DATA<br /><br /> FILE_WRITE_DATA<br /><br /> FILE_APPEND_DATA<br /><br /> FILE_READ_EA<br /><br /> FILE_WRITE_EA<br /><br /> FILE_READ_ATTRIBUTES<br /><br /> FILE_WRITE_ATTRIBUTES|  
||Cuenta de servicio de Windows del servidor de informes, todos|Instale>\Reporting Services\ReportManager, * \<Instale>* \Reporting Services\ReportManager\Pages\\\*. * \< * \*\\\* *, \<Instale>* \Reporting Services\ReportManager\Styles. \* *, \<Instale>* \Reporting services\reportmanager\ webctrl_client \ 1_0\\*.\*|Lectura, Ejecución|  
||Cuenta de servicio de Windows del servidor de informes|instalar>\Reporting Services\ReportServer * \< *|Lectura|  
||Cuenta de servicio de Windows del servidor de informes|instalar>\Reporting Services\ReportServer\global.asax * \< *|Completo|  
...
###  <a name="Unusual_Locations"></a>Permisos del sistema de archivos relacionados con ubicaciones de disco inusuales  
...
> [!NOTE]  
>  Las cuentas virtuales no se pueden autenticar en una ubicación remota. Todas las cuentas virtuales usan el permiso de la cuenta del equipo. Aprovisione la cuenta de la máquina en el formato _<domain_name>_ **\\** _<computer_name _ **$**>.  
  
###  <a name="Review_additional_considerations"></a>Revisar consideraciones adicionales  
...
-   Permiso **Create DDL Event Notification** en el servidor.  
  
-   Permiso **Create Trace Event Notification** en el [!INCLUDE[ssDE](../../includes/ssde-md.md)].  
  
-   **Permite ver cualquier** permiso de nivel de servidor de base de datos.  
...
###  <a name="DE_Prov"></a>Aprovisionamiento de Motor de base de datos  
...
####  <a name="Logins"></a>Inicio de sesión y privilegios de SID por servicio de SQL Server  
...
####  <a name="Agent"></a>Inicio de sesión y privilegios de Agente SQL Server  
...
####  <a name="Hadron"></a>[!INCLUDE[ssHADRc](../../includes/sshadrc-md.md)] y privilegios y instancia de clúster de conmutación por error de SQL  
...
####  <a name="Writer"></a>Escritor SQL y privilegios  
...
####  <a name="SQLWMI"></a>WMI y privilegios de SQL  
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]El programa de instalación aprovisiona la cuenta **NT SERVICE\Winmgmt** como un [!INCLUDE[ssDE](../../includes/ssde-md.md)] inicio de sesión de y la agrega al rol fijo de servidor **sysadmin** .  
...
##  <a name="Upgrade"></a>Actualizar desde versiones anteriores  
...
###  <a name="Identify_instance_aware_and_unaware"></a>Identificar servicios que reconocen instancias y que no reconocen instancias  
...
###  <a name="Localized_service_names"></a>Nombres de servicio localizados  
