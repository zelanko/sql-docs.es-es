---
title: Crear o eliminar un Alias de servidor para su uso por un cliente (Administrador de configuración de SQL Server) | Documentos de Microsoft
ms.custom: ''
ms.date: 06/13/2017
