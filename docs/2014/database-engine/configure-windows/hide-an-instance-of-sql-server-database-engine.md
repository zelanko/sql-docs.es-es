...
# <a name="hide-an-instance-of-sql-server-database-engine"></a>Ocultar una instancia del motor de base de datos de SQL Server
  En este tema se describe cómo ocultar una instancia del [!INCLUDE[ssDE](../../includes/ssde-md.md)] en [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] utilizando el Administrador de configuración de SQL Server. 
...
**ID. de evento: 1001: nombre del evento: interbloqueo de recursos de clústeres de conmutación por error.**  
  
## <a name="see-also"></a>Consulte también  
 [Configuración de red de servidor](server-network-configuration.md)   
 [Descripción de las conexiones de cliente de SQL Server](https://support.microsoft.com/kb/273673)   
 [Cómo asignar un puerto estático a un SQL Server instancia con nombre-y evitar un problema común](https://blogs.msdn.com/b/arvindsh/archive/2012/09/08/how-to-assign-a-static-port-to-a-sql-server-named-instance-and-avoid-a-common-pitfall.aspx)  
