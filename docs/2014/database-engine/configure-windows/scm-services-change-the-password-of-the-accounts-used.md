---
title: Cambiar la contraseña de las cuentas utilizadas por SQL Server (Administrador de configuración de SQL Server) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/07/2016
