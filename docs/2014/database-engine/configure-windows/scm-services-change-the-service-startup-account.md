...
4.  En el cuadro de diálogo ** \<***instancename***> propiedades de SQL Server** , haga clic en la pestaña **iniciar sesión** y seleccione un tipo **de cuenta iniciar sesión como** .  
