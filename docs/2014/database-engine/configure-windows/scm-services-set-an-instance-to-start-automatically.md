---
title: Configurar una instancia de SQL Server para que se inicie automáticamente (Administrador de configuración de SQL Server) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/07/2016
