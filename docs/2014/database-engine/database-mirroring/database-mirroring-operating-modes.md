...
###  <a name="when-is-high-performance-mode-appropriate"></a><a name="WhenUseHighPerf"></a>¿Cuándo es adecuado el modo de alto rendimiento?  
...
##  <a name="synchronous-database-mirroring-high-safety-mode"></a><a name="Sync"></a>Creación de reflejo de la base de datos sincrónica (modo de alta seguridad)  
...
###  <a name="high-safety-mode-with-automatic-failover"></a><a name="HighSafetyWithAutoFailover"></a>Modo de alta seguridad con conmutación automática por error  
 ...
 Cuando se establece un testigo, la sesión requiere *cuórum*, una relación entre al menos dos instancias de servidor que permita que la base de datos esté disponible. Para obtener más información, vea [Testigo de creación de reflejo de la base de datos](database-mirroring-witness.md) y [Cuórum: cómo un testigo afecta a la disponibilidad de la base de datos &#40;reflejo de la base de datos&#41;](quorum-how-a-witness-affects-database-availability-database-mirroring.md).  
...
####  <a name="transaction-safety"></a><a name="TxnSafety"></a>Seguridad de las transacciones  
...
###  <a name="viewing-the-safety-setting-and-state-of-the-witness"></a><a name="ViewWitness"></a>Visualización de la configuración de seguridad y el estado del testigo  
...
###  <a name="factors-affecting-behavior-on-loss-of-the-principal-server"></a><a name="FactorsOnLossOfPrincipal"></a>Factores que afectan al comportamiento en la pérdida del servidor principal  
