---
title: Permitir un punto de conexión para usar certificados para las conexiones salientes (Transact-SQL) de creación de reflejo de la base de datos | Documentos de Microsoft
ms.custom: ''
ms.date: 06/13/2017
