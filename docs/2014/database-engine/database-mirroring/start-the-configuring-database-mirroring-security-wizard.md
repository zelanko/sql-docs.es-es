---
title: Iniciar Asistente de seguridad (SQL Server Management Studio) de creación de reflejo de base de datos de configuración | Documentos de Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
3.  Haga clic con el botón derecho en la base de datos, seleccione **Tareas**y, luego, haga clic en **Reflejado**. Así se abre la [página Creación de reflejo](../../relational-databases/databases/database-properties-mirroring-page.md) del cuadro de diálogo **Propiedades de la base de datos** .  
