---
title: Características de SQL Server 2014 herramientas de administración en desuso | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
|-------------|-----------------------|  
|[!INCLUDE[ssVersion2005](../includes/ssversion2005-md.md)] API de servidores registrados|Anuncio|  
