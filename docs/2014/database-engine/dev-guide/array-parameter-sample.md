...
6.  Busque la línea adecuada en el archivo Program (alrededor de la línea 24) y reemplace `XXX` con el nombre de la instancia de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
