---
title: Capturar datos BLOB mediante IRow | Documentos de Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
ms.locfileid: "36114102"
---
# <a name="fetching-blob-data-using-irow"></a>Capturar datos BLOB mediante IRow
  Una columna BLOB en un objeto de fila se puede recuperar mediante el uso de **IRow:: GetColumns**, o **IRow:: Open** y **ISequentialStream**.  
