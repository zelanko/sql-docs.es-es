---
title: Tratar objetos grandes con CLR | Documentos de Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
```  
 ...
 El siguiente [!INCLUDE[tsql](../../includes/tsql-md.md)] (`test.sql`) prueba el ejemplo ejecutando los procedimientos almacenados.  
