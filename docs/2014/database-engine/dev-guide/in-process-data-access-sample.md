...
```  
 ...
 En el siguiente [!INCLUDE[tsql](../../includes/tsql-md.md)] (`test.sql`) se prueba el ejemplo mediante el ejercicio de los procedimientos almacenados y la función que se definen en este ejemplo.  
