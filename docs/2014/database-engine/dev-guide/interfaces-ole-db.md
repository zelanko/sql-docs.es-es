---
title: Interfaces (OLE DB) | Documentos de Microsoft
ms.custom: ''
ms.date: 03/08/2017
...
ms.locfileid: "36105676"
---
# <a name="interfaces-ole-db"></a>Interfaces (OLE DB)
  Además de las interfaces de OLE DB básicas proporcionadas por Microsoft Data Access Components (MDAC), el [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] proveedor OLE DB de Native Client implementa las interfaces de OLE DB adicionales siguientes:  
