...
|Método|Descripción|  
|------------|-----------------|  
|[ISQLServerErrorInfo:: GetErrorInfo &#40;OLE DB&#41;](../../relational-databases/native-client-ole-db-interfaces/isqlservererrorinfo-geterrorinfo-ole-db.md)|Devuelve un puntero a un [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] proveedor Native Client OLE DB estructura SSERRORINFO que contiene la [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] detalles del error.|  
