...
|respond_to_memory_pressure|Los valores pueden ser los siguientes:<br /><br /> 0 = No responder.<br /><br /> 1 = Dejar de agregar nuevos elementos huérfanos a la lista en caso de que exista presión de memoria.|La respuesta del destino a los eventos de memoria. Si se estable en 1 y la memoria del servidor es insuficiente, se quitará la información no emparejada.|  
