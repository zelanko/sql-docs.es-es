...
-   Las tablas optimizadas para memoria no admiten *restricciones check* en el servidor sq 2014. La integridad del dominio se valida junto con la integridad referencial mediante este script:  
