---
title: Propiedades de la lista de palabras irrelevantes de texto completo | Documentos de Microsoft
ms.custom: ''
ms.date: 06/13/2017
 ...
 **Usar SQL Server Management Studio para cambiar las propiedades de la lista de palabras irrelevantes**  
