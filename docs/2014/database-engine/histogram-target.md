---
title: Destino del histograma | Documentos de Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
```  
 ...
 Para obtener más información, consulte [buscar los objetos que han obtenido más bloqueos en ellos](../relational-databases/extended-events/find-the-objects-that-have-the-most-locks-taken-on-them.md), y [Monitor de sistema actividad mediante eventos extendidos](../relational-databases/extended-events/monitor-system-activity-using-extended-events.md).  
