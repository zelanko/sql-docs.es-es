---
title: Pares de archivos de supervisión y solución de problemas de replicación de mezcla en datos y Delta | Documentos de Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
-   Mire el espacio utilizado en los archivos de datos y delta mediante [sys.dm_db_xtp_checkpoint_files &#40;Transact-SQL&#41; ](/sql/relational-databases/system-dynamic-management-views/sys-dm-db-xtp-checkpoint-files-transact-sql) para ver si mezcla no se va a desencadenar cuando debería.  
...
```  
 ...
 Suponga que encontró tres archivos de datos que no se ha combinado. Con el valor `lower_bound_tsn` del primer archivo de datos y `upper_bound_tsn` del último, puede emitir el comando siguiente:  
...
```  
 ...
 El blog de [transición de estado de archivos punto de comprobación en bases de datos con tablas con optimización para memoria](http://blogs.technet.com/b/dataplatforminsider/archive/2014/01/23/state-transition-of-checkpoint-files-in-databases-with-memory-optimized-tables.aspx) describe la transición de estado de datos y delta pares de archivos desde el comienzo a la recolección.  
