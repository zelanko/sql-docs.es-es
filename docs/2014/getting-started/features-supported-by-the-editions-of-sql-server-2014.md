...
> **Nota:** Para ver las características admitidas por las ediciones Evaluation y Developer, vea el [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] conjunto de características de Enterprise.  
 ...
 [Modelo semántico de BI (tabular)](#BISemModel_tabular)  
...
|[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]Archivos de datos en Azure|Sí|Sí|Sí|Sí|Sí|Sí|Sí|  
 ...
 <sup>2</sup> [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] se pueden [!INCLUDE[ssExpress](../includes/ssexpress-md.md)]crear [!INCLUDE[ssExpress](../includes/ssexpress-md.md)] perfiles de Web, [!INCLUDE[ssExpress](../includes/ssexpress-md.md)] , con herramientas y con Advanced Services mediante [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] las ediciones Standard [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] y Enterprise.  
  
 <sup>3</sup> la optimización se habilita solo en las características de la edición Standard.  
  
##  <a name="RDBMS_mgmt"></a>Capacidad de administración de RDBMS  
...
##  <a name="Dev_tools"></a>Herramientas de desarrollo  
  
|Nombre de la característica|Enterprise|Inteligencia empresarial|Estándar|Web|Express con Advanced Services|Express con herramientas|Express|  
|------------------|----------------|---------------------------|--------------|---------|------------------------------------|------------------------|-------------|  
|[!INCLUDE[msCoName](../includes/msconame-md.md)]Integración de Visual Studio|Sí|Sí|Sí|Sí|Sí|Sí|Sí|  
...
|[!INCLUDE[tsql](../includes/tsql-md.md)]extremos|Sí|Sí|Sí|Sí||||  
...
|[!INCLUDE[ssCrescent](../includes/sscrescent-md.md)]<sup>2</sup>|Sí|Sí||||||  
 ...
 <sup>1</sup> Para obtener más información sobre los orígenes de datos admitidos en, vea orígenes de [!INCLUDE[ssRSCurrent](../includes/ssrscurrent-md.md)] [datos compatibles con Reporting Services &#40;SSRS&#41;](../reporting-services/create-deploy-and-manage-mobile-and-paginated-reports.md).  
...
##  <a name="Spatial"></a>Servicios espaciales y de ubicación  
