...
# <a name="getting-started-sql-server-2014"></a>Introducción (SQL Server 2014)
 ...
 [Instalación del tutorial de SQL Server 2014](quick-start-installation-of-sql-server-2014.md)  
  
 [Introducción a la documentación del producto para SQL Server](../2014-toc/index.yml)  
  
 [Obtención de ayuda &#40;SQL Server 2014&#41;](getting-assistance-sql-server-2014.md)  
