...
###  <a name="planning-a-ssnoversion-installation"></a><a name="BKMK_BeforeYouInstall"></a>Planeación [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] de una instalación  
