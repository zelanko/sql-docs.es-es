...
|DataType|Integer (enumeración)|Tipo de datos [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] de la columna. Para más información, consulte [Integration Services Data Types](data-flow/integration-services-data-types.md).|  
