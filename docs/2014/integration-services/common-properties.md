...
|Version|Entero|Versión de un componente.|  
...
|DataType|Integer (enumeración)|Tipo de datos [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] de la columna. Para obtener más información, vea [Integration Services tipos de datos](data-flow/integration-services-data-types.md).|  
