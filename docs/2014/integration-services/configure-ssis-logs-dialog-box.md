...
3.  [Configurar las opciones de la pestaña proveedores y registros](#provider)  
  
4.  [Configurar las opciones de la pestaña detalles](#detail)  
...
##  <a name="provider"></a>Configurar las opciones de la pestaña proveedores y registros  
...
##  <a name="detail"></a>Configurar las opciones de la pestaña detalles  
...
|**Operator**|El nombre de usuario de la persona que ha iniciado el paquete.|  
...
|**DataBytes**|Reservado para su uso en el futuro:|  
