...
ms.locfileid: "36203457"
---
# <a name="azure-storage-connection-manager"></a>Administrador de conexiones de Almacenamiento de Azure
  El Administrador de conexiones de almacenamiento de Azure permite que un paquete SSIS para conectarse a una cuenta de almacenamiento de Azure mediante el uso de los valores especificados para las propiedades: nombre de la cuenta de almacenamiento y clave de cuenta.  
