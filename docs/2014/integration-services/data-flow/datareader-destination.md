...
# <a name="datareader-destination"></a>DataReader, destino
  El destino de DataReader expone los datos en un flujo de datos mediante la interfaz ADO.NET `DataReader`. En ese momento los datos pueden ser usados por otras aplicaciones. Por ejemplo, puede configurar el origen de datos de un [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] informe para utilizar el resultado de la ejecución [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] de un paquete. Para ello, se crea un flujo de datos que implementa el destino de DataReader.  
