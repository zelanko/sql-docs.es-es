...
## <a name="related-tasks"></a>Related Tasks  
 Para obtener instrucciones sobre cómo agregar un destino y un administrador de conexiones mediante el Asistente de orígenes, vea [Add a Destination using Destination Assistant](../add-a-destination-using-destination-assistant.md).  
