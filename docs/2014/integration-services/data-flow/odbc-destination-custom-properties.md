...
|DefaultCodePage|Integer|Página de códigos que se usará para las columnas de cadena.<br /><br /> **Tenga en cuenta**: Esta propiedad no está disponible en el **Editor de destino ODBC**, pero se puede definir con el **Editor avanzado**.|  
