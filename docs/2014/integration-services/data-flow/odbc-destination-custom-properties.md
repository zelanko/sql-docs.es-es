...
|DefaultCodePage|Integer|Página de códigos que se usará para las columnas de cadena.<br /><br /> **Nota**: Esta propiedad no está disponible en el **Editor de destino de ODBC**, pero se puede establecer utilizando la **Editor avanzado**.|  
