...
|DefaultCodePage|Integer|Página de códigos que se usará para las columnas de salida.<br /><br /> **Nota**: Esta propiedad no está disponible en el **Editor de orígenes ODBC**, pero se puede establecer utilizando la **Editor avanzado**.|  
