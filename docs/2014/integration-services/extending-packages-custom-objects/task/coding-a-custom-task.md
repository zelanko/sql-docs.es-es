...
ms.locfileid: "85469300"
---
# <a name="coding-a-custom-task"></a>Codificar una tarea personalizada
  Después de crear una clase que herede de la clase base [Microsoft. SqlServer. DTS. Runtime. Task](/dotnet/api/microsoft.sqlserver.dts.runtime.task) y de aplicar el <xref:Microsoft.SqlServer.Dts.Runtime.DtsTaskAttribute> atributo a la clase, debe invalidar la implementación de las propiedades y los métodos de la clase base para proporcionar la funcionalidad personalizada.
