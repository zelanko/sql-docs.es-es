...
### <a name="understanding-the-auto-generated-code"></a>Descripción del código generado automáticamente  
 ...
 En tiempo de ejecución, el motor de flujo de datos llama el método PrimeOutput la `UserComponent` de la clase, lo que invalida el <xref:Microsoft.SqlServer.Dts.Pipeline.ScriptComponentHost.PrimeOutput%2A> método de la <xref:Microsoft.SqlServer.Dts.Pipeline.ScriptComponent> clase primaria. A su vez, el método PrimeOutput llama al método CreateNewOutputRows.  
