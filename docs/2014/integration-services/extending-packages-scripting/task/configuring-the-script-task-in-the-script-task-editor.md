...
>  Los nombres de variables distinguen entre mayúsculas y minúsculas.  
 ...
 Para seleccionar las variables, haga clic en el botón de puntos suspensivos (**…**) situado junto al campo de propiedades. Para más información, consulte [Página Seleccionar variables](../../control-flow/select-variables-page.md).  
