...
# <a name="for-loop-editor"></a>Editor de bucles For
 ...
 Para obtener información acerca del contenedor de bucles For y cómo utilizarlo en paquetes, vea [For Loop Container](control-flow/for-loop-container.md).  
