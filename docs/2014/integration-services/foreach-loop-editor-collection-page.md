...
>   
>  Puede usar una expresión para especificar los archivos que quiere incluir en una colección. Para ello, expanda **Expresiones** en la página **Colección** , seleccione la propiedad **FileSpec** y, después, haga clic en el botón de puntos suspensivos (…) para agregar la expresión de propiedad. Para obtener más información acerca de cómo se seleccionan dinámicamente archivos concretos, vea [SSIS-Establecer dinámicamente la máscara de archivo: FileSpec](http://go.microsoft.com/fwlink/?LinkId=238154)  
...
-   Entrada de blog [SSIS-Establecer dinámicamente la máscara de archivo: FileSpec](http://go.microsoft.com/fwlink/?LinkId=238154), en beyondrelational.com.  
