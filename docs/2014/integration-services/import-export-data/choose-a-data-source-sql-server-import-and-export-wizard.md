 ...
 **Contraseña**  
 ...
 Las opciones adicionales que aparecen al seleccionar este proveedor no son necesarias para establecer conexión correctamente con la base de datos de origen de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]. Para obtener una descripción de estas opciones adicionales, consulte la documentación para el [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] proveedor de datos para [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] en el [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] Kit de desarrollo de Software.  
