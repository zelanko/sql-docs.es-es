...
1.  En la página **revisar problemas de tipos** de datos [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] del Asistente para importación y exportación de, en la lista **tabla** , seleccione una tabla.  
