...
# <a name="preview-data-dialog-box-sql-server-import-and-export-wizard"></a>Cuadro de diálogo Vista previa de los datos (Asistente para importación y exportación de SQL Server)
  Utilice el cuadro de diálogo **vista previa** de los datos para ver [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] la consulta que el Asistente para importación y exportación de enviará al origen de datos. También puede usar este cuadro de diálogo para obtener una vista previa de hasta 200 filas de datos de ejemplo.  
  
 Para obtener más información sobre [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] el Asistente para importación y exportación de, vea [SQL Server Asistente para importación y exportación](import-and-export-data-with-the-sql-server-import-and-export-wizard.md)de. Para obtener información sobre las opciones para iniciar el asistente y sobre los permisos necesarios para ejecutar el asistente correctamente, vea [ejecutar el Asistente para importación y exportación de SQL Server](start-the-sql-server-import-and-export-wizard.md).  
 ...
 **Cuadrícula de datos de ejemplo**  
