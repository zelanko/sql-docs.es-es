...
ms.locfileid: "62767777"
---
# <a name="welcome-to-sql-server-import-and-export-wizard"></a>Asistente para importación y exportación de SQL Server
  Use el **Asistente para importación y exportación de SQL Server** para copiar y transformar datos entre orígenes y destinos de datos compatibles.  
