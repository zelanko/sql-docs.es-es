...
1.  Fase de origen de comando: El símbolo del sistema lee la lista de opciones y argumentos que se han especificado. Todas las fases siguientes se omiten si se encuentra una opción **/?** o **/HELP** .  
...
-   **/M[axConcurrent]** _ejecutables_simultáneos_:  
...
-   **/Proj[ect]** _archivo_de_proyecto_:  
...
-   **/VerifyP[ackageID]** _id_de_paquete_:  
