---
title: Referencia de interfaz de usuario de paquetes (DtExecUI) de la utilidad de ejecución | Documentos de Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
-   En una ventana de símbolo del sistema, ejecute `dtexecui`.  
