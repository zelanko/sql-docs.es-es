---
title: Ejecución de proyectos y paquetes | Documentos de Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
# <a name="execution-of-projects-and-packages"></a>Ejecución de proyectos y paquetes
 ...
 Para almacenar un paquete en el almacén de paquetes SSIS, la base de datos msdb o en el sistema de archivos, utilice el modelo de implementación de paquetes. Para obtener más información, consulte [implementación de paquetes &#40;SSIS&#41;](legacy-package-deployment-ssis.md).  
