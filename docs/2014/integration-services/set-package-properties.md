...
> [!NOTE]  
>  La opción `/CheckPointing on` de dtexec es equivalente a establecer la propiedad `SaveCheckpoints` del paquete en True y la propiedad `CheckpointUsage` en Always. Para obtener más información, vea [DTExec Utility](packages/dtexec-utility.md).  
  
###  <a name="Execution"></a>Remota  
...
|**Disable**|Indica si el paquete está deshabilitado. El valor predeterminado de esta propiedad es `False`.|  
...
###  <a name="Identification"></a>Identificado  
...
###  <a name="Transactions"></a>Realizadas  
