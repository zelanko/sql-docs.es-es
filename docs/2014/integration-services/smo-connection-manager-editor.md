...
# <a name="smo-connection-manager-editor"></a>administrador de conexiones SMO, editor del
 ...
 Para obtener más información acerca del administrador de conexiones SMO, vea [SMO Connection Manager](connection-manager/smo-connection-manager.md).  
