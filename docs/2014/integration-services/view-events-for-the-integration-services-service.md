---
title: Ver los eventos para el servicio Integration Services | Documentos de Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="see-also"></a>Vea también  
 ...
 [Agregar un registro de contadores de rendimiento de flujo de datos](performance/performance-counters.md)  
