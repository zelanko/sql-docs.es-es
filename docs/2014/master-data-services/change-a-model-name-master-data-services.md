---
title: Cambiar un nombre de modelo (Master Data Services) | Documentos de Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "36104068"
---
# <a name="change-a-model-name-master-data-services"></a>Cambiar un nombre de modelo (Master Data Services)
...
3.  En el **mantenimiento de modelos** página, en la cuadrícula, haga clic en la fila correspondiente al modelo con el nombre que desea cambiar.  
  
    > [!NOTE]  
    >  El nombre del modelo Metadatos no se puede cambiar.  
  
4.  Haga clic en **modelo seleccionado editar**.  
  
5.  En el **nombre del modelo** , escriba el nombre actualizado del modelo.  
