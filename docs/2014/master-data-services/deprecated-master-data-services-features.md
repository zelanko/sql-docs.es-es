---
title: Características desusadas Master Data Services en SQL Server 2014 | Documentos de Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
## <a name="metadata"></a>Metadatos  
 Aunque el modelo metadatos se sigue mostrando en la aplicación web [!INCLUDE[ssMDSmdm](../includes/ssmdsmdm-md.md)], no debe usarse. Se quitará en una versión futura. Los usuarios también pueden ver ya metadatos en la **Explorer** área funcional y ya no se puede crear versiones del modelo de metadatos.  
