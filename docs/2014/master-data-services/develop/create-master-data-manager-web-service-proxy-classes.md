...
2.  Busque la `mdsWsHttpBehavior` sección en ** \<serviceBehaviors>**. Para el ** \<elemento>serviceMetadata** , establezca `httpGetEnabled` en `true`.  
