---
title: No incluye características de Master Data Services en SQL Server 2014 | Documentos de Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
-   Los permisos de jerarquía derivada se basan ahora en el modelo. Por ejemplo, si desea que un usuario tenga permiso para una jerarquía derivada, debe asignar **actualización** para el objeto de modelo. A continuación, puede asignar **Deny** acceso a las entidades que no desea que el usuario debe tener acceso.  
  
-   Los permisos de jerarquía explícita se basan ahora en la entidad. Por ejemplo, si el usuario tiene **actualización** permisos a una entidad de cuenta, a continuación, todas las jerarquías explícitas para la entidad será actualizables.  
  
-   Ya no se pueden asignar permisos de grupo de atributos en el **permisos de usuario y grupo** área funcional. En su lugar, en la **administración del sistema** se pueden dar el área funcional que se crean los grupos de atributos, los usuarios y grupos **actualización** permisos a grupos de atributos. **Sólo lectura** permisos a grupos de atributos ya no está disponible.  
...
### <a name="bulk-updates-and-exporting"></a>Actualizaciones y exportación masivas  
 ...
 En la aplicación web [!INCLUDE[ssMDSmdm](../includes/ssmdsmdm-md.md)], ya no se pueden exportar miembros a Excel. Para trabajar con los miembros en Excel, use la [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)] [!INCLUDE[ssMDSXLS](../includes/ssmdsxls-md.md)].  
  
### <a name="transactions"></a>Transactions  
 En el **Explorer** área funcional, los usuarios ya no se pueden revertir sus propias transacciones. Anteriormente, los usuarios podían revertir los cambios realizados a los datos en **Explorer**. Los administradores pueden seguir invirtiendo transacciones para todos los usuarios en el **administración de versiones** área funcional.  
...
## <a name="see-also"></a>Vea también  
 [Características en desuso de Master Data Services en SQL Server 2014](deprecated-master-data-services-features.md)  
