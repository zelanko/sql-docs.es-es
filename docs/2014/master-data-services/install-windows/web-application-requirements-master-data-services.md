...
||  
|-|  
|Características de .NET Framework 3.0<br /><br /> Activación WCF<br /><br /> Activación HTTP<br /><br /> Activación no HTTP<br /><br /> Servicio WAS (Windows Process Activation Service)<br /><br /> Modelo de proceso<br /><br /> Entorno .NET<br /><br /> API de configuración|  
