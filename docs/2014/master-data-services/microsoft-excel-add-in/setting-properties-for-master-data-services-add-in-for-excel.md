...
|Configuración: Registro|Activar el registro detallado|Habilitar el registro para el proceso de cargar los datos maestros desde MDS en el complemento de Excel, por ejemplo, que el se registra el resultado de todos los comandos en el servicio.|  
