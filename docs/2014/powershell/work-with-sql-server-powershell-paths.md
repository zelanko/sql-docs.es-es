...
```  
 ...
 Este ejemplo utiliza SMO **Script** método para generar un script que contiene la `CREATE VIEW` las instrucciones que debe tener para volver a crear las vistas en AdventureWorks2012:  
