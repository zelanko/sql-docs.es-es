...
> [!NOTE]  
>  Cuando se especifica una tarea [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)]de restauración mediante, puede generar el script [restore](/sql/t-sql/statements/restore-statements-transact-sql) correspondiente [!INCLUDE[tsql](../../includes/tsql-md.md)]si hace clic en **script** y, a continuación, selecciona un destino para el script.  
