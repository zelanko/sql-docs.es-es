---
title: Especificar si una operación de restauración o copia de seguridad continúa o se detiene después de encontrar un Error (SQL Server) | Documentos de Microsoft
ms.custom: ''
ms.date: 06/13/2017
