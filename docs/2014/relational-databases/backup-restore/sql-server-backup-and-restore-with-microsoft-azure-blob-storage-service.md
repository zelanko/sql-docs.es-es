...
## <a name="benefits-of-using-the-azure-blob-service-for-ssnoversion-backups"></a>Ventajas de usar el servicio BLOB de Azure [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] para copias de seguridad  
