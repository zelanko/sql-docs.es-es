...
###  <a name="firewall"></a> Cómo: Habilitar FILESTREAM a través del Firewall  
...
###  <a name="HowToDirectory"></a> Cómo: Especificar un directorio para FileTables en el nivel de base de datos  
