...
## <a name="see-also"></a>Vea también  
 [La asignación de datos de parámetro CLR](../clr-integration-database-objects-types-net-framework/mapping-clr-parameter-data.md)   
