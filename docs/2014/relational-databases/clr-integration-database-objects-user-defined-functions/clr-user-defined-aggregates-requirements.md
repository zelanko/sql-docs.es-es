...
## <a name="see-also"></a>Vea también  
 ...
 [Invocar funciones de agregado definidas por el usuario CLR](clr-user-defined-aggregate-invoking-functions.md)  
