...
-   Tipos definidos por el usuario. Para obtener más información, consulte [Defined Types](../native-client/features/using-user-defined-types.md).  
