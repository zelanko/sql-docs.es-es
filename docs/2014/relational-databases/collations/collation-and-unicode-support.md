...
-   **Clientes no Unicode** que utilizan DB-Library y ODBC versión 3,6 o una versión anterior.  
...
##  <a name="Complex_script"></a>Compatibilidad con scripts complejos  
...
##  <a name="Related_Content"></a> Contenido relacionado  
 ...
 ["SQL Server procedimientos recomendados para la migración a Unicode"](https://go.microsoft.com/fwlink/?LinkId=113890)  
