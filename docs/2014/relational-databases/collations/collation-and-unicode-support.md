...
##  <a name="supplementary-characters"></a><a name="Supplementary_Characters"></a> Caracteres complementarios  
...
## <a name="see-also"></a>Consulte también  
 [Intercalaciones de base de datos independiente](../databases/contained-database-collations.md)   
