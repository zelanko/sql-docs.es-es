---
title: Crear un conjunto de recopilación personalizado que utiliza el tipo de recopilador de consultas T-SQL genérico (Transact-SQL) | Documentos de Microsoft
ms.custom: ''
ms.date: 06/13/2017
