...
-   Usa el formato de almacenamiento de longitud variable para tipos numéricos (por ejemplo `integer`, `decimal`, y `float`) y los tipos que se basan en numérico (por ejemplo `datetime` y `money`).  
