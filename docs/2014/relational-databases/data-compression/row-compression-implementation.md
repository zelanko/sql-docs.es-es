...
|`varchar`|Sin|Ningún efecto.|  
|`text`|Sin|Ningún efecto.|  
...
|`nvarchar`|Sin|Ningún efecto.|  
|`ntext`|No|Ningún efecto.|  
|`binary`|Sí|Se quitan los ceros finales.|  
|`varbinary`|Sin|Ningún efecto.|  
|`image`|Sin|Ningún efecto.|  
...
|`uniqueidentifier`|Sin|Ningún efecto.|  
|`table`|No|Ningún efecto.|  
|`xml`|Sin|Ningún efecto.|  
|Tipos definidos por el usuario|Sin|Se representa internamente como `varbinary`.|  
|FILESTREAM|Sin|Se representa internamente como `varbinary`.|  
