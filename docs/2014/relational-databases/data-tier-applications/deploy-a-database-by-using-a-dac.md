...
6.  Use la `Import` método de la `Microsoft.SqlServer.Management.Dac.DacStore` tipo que desea importar el archivo BACPAC. Especifique el archivo BACPAC creado por la exportación.  
