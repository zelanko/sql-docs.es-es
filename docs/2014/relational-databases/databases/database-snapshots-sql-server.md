...
-   [Información general sobre características](#FeatureOverview)  
...
##  <a name="FeatureOverview"></a>Información general sobre características  
...
-   [Limitaciones en la base de datos de origen](#LimitsOnSourceDb)  
...
###  <a name="LimitsOnSourceDb"></a>Limitaciones en la base de datos de origen  
...
## <a name="see-also"></a>Consulte también  
 [Creación de reflejo de base de datos e instantáneas de base de datos &#40;SQL Server&#41;](database-snapshots-sql-server.md)  
