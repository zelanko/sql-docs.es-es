---
title: Archivos de datos de SQL Server en Windows Azure | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
# <a name="sql-server-data-files-in-windows-azure"></a>Archivos de datos de SQL Server en Windows Azure
 ...
 Para experimentar de manera práctica cómo usar esta nueva característica, consulte el [Tutorial: SQL Server archivos de datos en el servicio](../tutorial-use-azure-blob-storage-service-with-sql-server-2016.md)Azure Storage de Windows.  
 ...
 ![Integración de SQL Server con Windows Azure Storage](../../database-engine/media/sql-server-dbfiles-stored-as-blobs.gif "Integración de SQL Server con Windows Azure Storage")  
...
-   **Ventajas económicas y de espacio de almacenamiento ilimitado:** Esta característica permite tener un almacenamiento fuera de la ubicación ilimitado en Windows Azure al tiempo que se aprovechan los recursos de proceso locales. Si usa Windows Azure como ubicación de almacenamiento, puede centrarse tranquilamente en la lógica de la aplicación sin la sobrecarga de administración de hardware. Si pierde un nodo de proceso local, puede configurar uno nuevo sin tener que mover datos.  
  
-   **Ventajas de la alta disponibilidad y recuperación ante desastres:** El uso de SQL Server los archivos de datos en la característica de Windows Azure puede simplificar las soluciones de alta disponibilidad y recuperación ante desastres. Por ejemplo, si se bloquea una máquina virtual en Windows Azure o una instancia de SQL Server, puede volver a crear las bases de datos en un equipo nuevo simplemente restableciendo vínculos en blobs de Windows Azure.  
...
-   SQL Server que se ejecuta en una máquina virtual de Windows Azure: Si va a instalar SQL Server en una máquina virtual de Windows Azure, instale SQL Server 2014 o actualice la instancia existente. Del mismo modo, también puede crear una nueva máquina virtual de Windows Azure mediante una imagen de plataforma de SQL Server 2014. Para obtener información sobre cómo descargar SQL Server 2014, vea [SQL Server 2014](https://www.microsoft.com/sqlserver/sql-server-2014.aspx).  
...
##  <a name="bkmk_Troubleshooting"></a>Solucionar problemas de archivos de datos de SQL Server en Windows Azure  
...
-   *No se ha creado correctamente la firma de acceso compartido en el contenedor.*    
     Solución: asegúrese de haber creado correctamente una firma de acceso compartido en el contenedor. Consulte las instrucciones de la lección 2 del [Tutorial: SQL Server archivos de datos en el servicio](../tutorial-use-azure-blob-storage-service-with-sql-server-2016.md)Azure Storage de Windows.  
  
-   *La credencial de SQL Server no se ha creado correctamente.*    
    Solución: asegúrese de que ha usado "Firma de acceso compartido" en el campo **Identidad** y que ha creado un secreto correctamente. Consulte las instrucciones de la lección 3 del [Tutorial: SQL Server archivos de datos en el servicio](../tutorial-use-azure-blob-storage-service-with-sql-server-2016.md)Azure Storage de Windows.  
...
1.  *Errores al crear una base de datos*   
    Solución: Consulte las instrucciones de la lección 4 del [Tutorial: SQL Server archivos de datos en el servicio](../tutorial-use-azure-blob-storage-service-with-sql-server-2016.md)Azure Storage de Windows.  
  
2.  *Errores al ejecutar la instrucción Alter*   
    Solución: asegúrese de ejecutar la instrucción ALTER DATABASE cuando la base de datos esté en línea. Cuando copie archivos de datos en Azure Storage, cree siempre un blob en páginas y no un blob en bloques. De lo contrario, ALTER DATABASE no se ejecutará correctamente. Consulte las instrucciones de la lección 7 del [Tutorial: SQL Server archivos de datos en el servicio](../tutorial-use-azure-blob-storage-service-with-sql-server-2016.md)Azure Storage de Windows.  
...
## <a name="see-also"></a>Vea también  
 [Tutorial: Archivos de datos de SQL Server en el servicio Azure Storage de Windows](../tutorial-use-azure-blob-storage-service-with-sql-server-2016.md)  
