...
# <a name="audit-add-member-to-db-role-event-class"></a>Audit Add Member to DB Role [clase de eventos]
  La clase de eventos **Audit Add Member to dB role** tiene lugar cuando se agrega o se quita un inicio de sesión de un rol de base de datos. Esta clase de eventos se usa con los procedimientos almacenados **sp_addrolemember**, **sp_changegroup**y **sp_droprolemember** .  
