...
ms.locfileid: "62867349"
---
# <a name="audit-add-role-event-class"></a>Audit Add Role, clase de eventos
  La clase de eventos **Audit Add role** se produce cuando se agrega o se quita un rol de base de datos de una base de datos. Los procedimientos almacenados **sp_addrole** y **sp_droprole** usan esta clase de eventos.  
  
 Esta clase de eventos se puede quitar de una versión futura [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]de. En su lugar, se recomienda usar la clase de eventos **Audit Database Principal Management** .  
...
## <a name="see-also"></a>Consulte también  
 ...
 [sp_addrole &#40;&#41;de Transact-SQL](/sql/relational-databases/system-stored-procedures/sp-addrole-transact-sql)   
 [sp_droprole &#40;&#41;de Transact-SQL](/sql/relational-databases/system-stored-procedures/sp-droprole-transact-sql)   
