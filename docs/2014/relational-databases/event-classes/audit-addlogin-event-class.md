...
|**TargetLoginSid**|**impresión**|Número de identificación de seguridad (SID) del inicio de sesión de destino (si se pasa como un parámetro).|43|Sí|  
...
## <a name="see-also"></a>Consulte también  
 ...
 [sp_droplogin &#40;&#41;de Transact-SQL](/sql/relational-databases/system-stored-procedures/sp-droplogin-transact-sql)   
