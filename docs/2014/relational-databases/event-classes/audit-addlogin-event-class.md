...
|**TargetLoginSid**|**imagen**|Número de identificación de seguridad (SID) del inicio de sesión de destino (si se pasa como un parámetro).|43|Sí|  
