...
|**TargetLoginSid**|**impresión**|Para las sesiones que se dirigen a un inicio de sesión, número de identificación de seguridad (SID) del inicio de sesión de destino.|43|Sí|  
