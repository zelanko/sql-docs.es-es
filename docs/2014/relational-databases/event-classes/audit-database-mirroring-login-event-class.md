...
|**EventClass**|**int**|Tipo de clase de eventos capturado. Siempre **154** para **Audit Database Mirroring Login**.|27|Sin|  
...
|**ObjectName**|**nvarchar**|Cadena de conexión utilizada para esta conexión.|34|Sin|  
...
|**ProviderName**|**nvarchar**|Método de autenticación utilizado para esta conexión.|46|Sin|  
|**RoleName**|**nvarchar**|Rol de la conexión. Es **initiator** o **target**.|38|Sin|  
