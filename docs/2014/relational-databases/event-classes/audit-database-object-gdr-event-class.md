...
ms.locfileid: "62698917"
---
# <a name="audit-database-object-gdr-event-class"></a>Audit Database Object GDR, clase de eventos
  La clase de eventos **Audit Database Object GDR** se produce cuando se ha emitido una instrucción Grant, REVOKE o Deny para objetos de base de datos, como ensamblados y esquemas.  
