...
ms.locfileid: "62698975"
---
# <a name="audit-database-object-take-ownership-event-class"></a>Audit Database Object Take Ownership, clase de eventos
  La clase de eventos **Audit Database Object Take Ownership** se produce cuando se produce un cambio de propietario para objetos en el ámbito de la base de datos.  
