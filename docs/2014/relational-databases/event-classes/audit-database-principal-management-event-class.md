...
ms.locfileid: "62961132"
---
# <a name="audit-database-principal-management-event-class"></a>Audit Database Principal Management, clase de eventos
  La clase de eventos **Audit Database principal Management** se produce cuando se crean, modifican o quitan entidades de seguridad, como usuarios, en una base de datos.  
