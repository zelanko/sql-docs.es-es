...
ms.locfileid: "62938895"
---
# <a name="audit-dbcc-event-class"></a>Audit DBCC, clase de eventos
  La clase de eventos **Audit DBCC** se produce siempre que se emite un comando DBCC.  
...
|**Permisos**|**int**|Indicador de configuración de un permiso de columna. Analice el texto de la instrucción para determinar exactamente los permisos que se aplicaron a las columnas.|44|Sí|  
