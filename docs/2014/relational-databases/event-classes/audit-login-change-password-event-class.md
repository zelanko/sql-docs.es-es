...
ms.locfileid: "62938885"
---
# <a name="audit-login-change-password-event-class"></a>Audit Login Change Password [clase de eventos]
  La clase de eventos **Audit login Change Password** se produce siempre que un [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] usuario cambia la contraseña de inicio de sesión.  
