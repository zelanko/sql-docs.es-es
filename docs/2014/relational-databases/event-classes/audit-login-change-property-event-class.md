...
ms.locfileid: "62991260"
---
# <a name="audit-login-change-property-event-class"></a>Audit Login Change Property, clase de eventos
  La clase de eventos **Audit login Change Property** se produce al utilizar el **sp_defaultdb** procedimiento almacenado, el **sp_defaultlanguage** procedimiento almacenado o la instrucción ALTER login para modificar una propiedad de un inicio de sesión.  
...
## <a name="see-also"></a>Consulte también  
 ...
 [sp_defaultdb &#40;&#41;de Transact-SQL](/sql/relational-databases/system-stored-procedures/sp-defaultdb-transact-sql)   
 [sp_defaultlanguage &#40;&#41;de Transact-SQL](/sql/relational-databases/system-stored-procedures/sp-defaultlanguage-transact-sql)  
