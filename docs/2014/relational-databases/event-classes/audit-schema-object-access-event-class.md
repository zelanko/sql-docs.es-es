...
ms.locfileid: "63017156"
---
# <a name="audit-schema-object-access-event-class"></a>Audit Schema Object Access, clase de eventos
  La clase de eventos **Audit Schema Object Access** se produce cuando se utiliza un permiso de objeto (como Select).  
...
|**Permisos**|**int**|Indica si se estableció un permiso de columna. Analice el texto de la instrucción para determinar los permisos que se aplicaron. 1=Sí, 0=No.|44|Sí|  
...
|**Nombrepropietario**|**nvarchar**|Nombre de usuario de la base de datos del propietario del objeto de destino.|37|Sí|  
