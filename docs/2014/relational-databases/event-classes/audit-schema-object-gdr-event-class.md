...
ms.locfileid: "63012190"
---
# <a name="audit-schema-object-gdr-event-class"></a>Audit Schema Object GDR [clase de eventos]
  La clase de eventos **Audit Schema Object GDR** tiene lugar cuando un usuario emite una instrucción GRANT, REVOKE o DENY para un permiso de objeto de esquema en [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
...
|**Permisos**|**int**|Indicador de configuración de un permiso de columna. Analice el texto de la instrucción para determinar exactamente los permisos que se aplicaron a las columnas. 1=Sí, 0=No.|44|Sí|  
...
|**Nombrepropietario**|**nvarchar**|Nombre de usuario de la base de datos del propietario del objeto que es el destino de los permisos conceder, revocar o denegar.|37|Sí|  
