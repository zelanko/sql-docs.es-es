...
# <a name="audit-schema-object-take-ownership-event-class"></a>Audit Schema Object Take Ownership, clase de eventos
  La clase de eventos **Audit Schema Object Take Ownership** se produce cuando se comprueban los permisos para cambiar el propietario del objeto de esquema (como una tabla, un procedimiento o una función). Esto sucede cuando se utiliza la instrucción ALTER AUTHORIZATION para asignar un propietario a un objeto.  
