...
ms.locfileid: "63012512"
---
# <a name="audit-server-alter-trace-event-class"></a>Audit Server Alter Trace [clase de eventos]
  La clase de eventos **Audit Server Alter Trace** se produce para todas las instrucciones que comprueban el permiso ALTER Trace. Las instrucciones que buscan ALTER TRACE incluyen las utilizadas para crear o configurar un seguimiento, o bien para establecer un filtro en un seguimiento.  
