...
# <a name="audit-server-object-gdr-event-class"></a>Audit Server Object GDR, clase de eventos
  La clase de eventos **Audit Server Object GDR** se produce cuando un usuario de Microsoft SQL Server emite una instrucción Grant, REVOKE o Deny para un permiso de objeto de servidor.  
