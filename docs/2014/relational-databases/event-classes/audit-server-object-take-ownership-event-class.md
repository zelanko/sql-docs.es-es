...
ms.locfileid: "63012481"
---
# <a name="audit-server-object-take-ownership-event-class"></a>Audit Server Object Take Ownership, clase de eventos
  La clase de eventos **Audit Server Object Take Ownership** se produce cuando se cambia el propietario de los objetos en el ámbito del servidor.  
