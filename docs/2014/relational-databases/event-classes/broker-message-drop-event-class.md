...
|**VOLUMEN**|`uniqueidentifier`|El Id. de la conversación a la que pertenece el mensaje no apto para entrega. Este identificador se transmite como parte del mensaje y lo comparten ambas partes de la conversación.|54|No|  
