...
|**HonorBrokerPriority**|**Int**|El valor actual de la opción HONOR_BROKER_PRIORITY de la base de datos: 0 = DESACTIVADA, 1 = ON.|32|Sí|  
...
|**StarvationElevation**|**int**|Se envió el mensaje con una prioridad mayor que la prioridad que se configuró para la conversación: 0 = false, 1 = true.|33|Sí|  
