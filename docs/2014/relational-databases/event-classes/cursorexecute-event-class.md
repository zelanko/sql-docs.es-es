...
# <a name="cursorexecute-event-class"></a>CursorExecute [clase de eventos]
  La clase de eventos **CursorExecute** describe los eventos de ejecución de cursor que se producen en los cursores de la interfaz de programación de aplicaciones (API). Los eventos de ejecución de [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssDE](../../includes/ssde-md.md)] cursor se producen cuando crea y rellena un cursor desde el plan de ejecución creado por un evento de preparación de cursor.  
...
|**Asa**|**int**|Valor entero utilizado por ODBC, OLE DB o DB-Library para coordinar la ejecución con el servidor.|33|Sí|  
...
|**RequestID**|**int**|Identificación de la solicitud que ha ejecutado el cursor.|49|Sí|  
