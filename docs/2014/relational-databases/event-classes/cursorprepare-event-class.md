...
# <a name="cursorprepare-event-class"></a>CursorPrepare [clase de eventos]
  La clase de eventos **CursorPrepare** describe los eventos de preparación de cursores que se producen en los cursores de la interfaz de programación de aplicaciones (API). Los eventos de preparación de cursores se producen cuando el [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssDE](../../includes/ssde-md.md)] compila una instrucción SELECT asociada a un cursor en un plan de ejecución pero no crea el cursor.  
...
|**Asa**|**int**|Identificador de la clase de evento.|33|Sí|  
...
|**RequestID**|**int**|Identificación de la solicitud que preparó el cursor.|49|Sí|  
