...
# <a name="cursorunprepare-event-class"></a>CursorUnprepare, clase de eventos
  La clase de eventos **CursorUnprepare** proporciona información sobre los eventos de despreparación de cursores que se producen en los cursores de la interfaz de programación de aplicaciones (API). Los eventos de despreparación de cursor [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssDE](../../includes/ssde-md.md)] se producen cuando el descarta un plan de ejecución.  
...
|**Asa**|**Inter**|Identifica el identificador preparado cuya preparación se ha cancelado.|33|Sí|  
...
|**RequestID**|**int**|Identificación de la solicitud que canceló la preparación del cursor.|49|Sí|  
