...
|**Extensión**|**nvarchar**|Nombre lógico del archivo que se va a reducir.|36|Sí|  
|**Host**|**nvarchar**|Nombre del equipo en el que se está ejecutando el cliente. Esta columna de datos se llena si el cliente proporciona el nombre del host. Para determinar el nombre del host, utilice la función HOST_NAME.|8|Sí|  
