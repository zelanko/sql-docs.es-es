...
|**Error**|`int`|Número de Id. del mensaje en **sys.messages** para el texto del evento. Si este evento informa de un error, éste es el número de error de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .|31|Sin|  
|**EventClass**|`int`|Tipo de clase de eventos capturado. Siempre es **151** para **Database Mirroring Connection**.|27|Sin|  
...
|**GUID**|`uniqueidentifier`|Id. de extremo de esta conexión.|54|Sin|  
