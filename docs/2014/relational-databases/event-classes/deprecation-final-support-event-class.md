...
|ObjectName|`nvarchar`|Nombre de la característica desusada.|34|Yes|  
...
## <a name="see-also"></a>Consulte también  
 ...
 [Desuso Announcement (clase de eventos)](deprecation-announcement-event-class.md)   
