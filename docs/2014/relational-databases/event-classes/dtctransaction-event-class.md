...
|**BinaryData**|`image`|Representación binaria del Id. de unidad de trabajo (UOW) que identifica de forma exclusiva a esta transacción en DTC.|2|Yes|  
...
|**IntegerData**|`int`|Nivel de aislamiento de la transacción.|25|Yes|  
...
|**TextData**|`ntext`|Representación textual del UOW que identifica de forma exclusiva a esta transacción en DTC.|1|Yes|  
