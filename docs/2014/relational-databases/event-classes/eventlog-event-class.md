...
|Error|`int`|Número de error de un evento específico (si está disponible).|31|Yes|  
...
|TextData|`ntext`|Texto del mensaje de error, si lo hay.|1|Yes|  
