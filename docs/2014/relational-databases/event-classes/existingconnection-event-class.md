...
|DatabaseID|`int`|El Id. de la base de datos actual de la conexión de usuario. IDENTIFICADOR de la base de datos especificada por la instrucción USE *Database* o la base de datos predeterminada si no se ha emitido ninguna instrucción use *Database* para una instancia determinada. Determina el valor de una base de datos mediante la función DB_ID.|3|Sí|  
