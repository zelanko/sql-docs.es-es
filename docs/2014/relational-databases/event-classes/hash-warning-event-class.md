...
|LoginName|`nvarchar`|Nombre del inicio de sesión del usuario (inicio [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] de sesión de seguridad de o credenciales de inicio de sesión de Windows con el formato * \<dominio>\\<nombre de\>usuario*).|11|Sí|  
