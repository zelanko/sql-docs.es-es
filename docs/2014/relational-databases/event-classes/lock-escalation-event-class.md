...
|**EventSubClass**|`int`|Causa de la ampliación del bloqueo:<br /><br /> **0: LOCK_THRESHOLD** indica que la instrucción superó el umbral de bloqueo.<br /><br /> **1-MEMORY_THRESHOLD** indica que la instrucción superó el umbral de memoria.|21|Sí|  
