...
|LoginName|`nvarchar`|Nombre del inicio de sesión del usuario (inicio [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] de sesión de seguridad [!INCLUDE[msCoName](../../includes/msconame-md.md)] de o credenciales de inicio de sesión\\de Windows con el formato dominio*nombreDeUsuario*).|11|Sí|  
...
|TextData|`ntext`|*nombre del dispositivo físico* [( *nombre del dispositivo lógico* )]. El nombre de dispositivo lógico se muestra solo si se ha definido en la vista de catálogo sys.backup_devices.|1|Sí|  
