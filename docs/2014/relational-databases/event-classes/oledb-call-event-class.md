...
|Error|`int`|Número de error de un evento dado. Con frecuencia, es el número de error almacenado en la vista de catálogo sys.messages.|31|Yes|  
...
|LinkedServerName|`nvarchar`|Nombre del servidor vinculado.|45|Yes|  
