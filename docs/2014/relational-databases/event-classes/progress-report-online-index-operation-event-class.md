...
|BigintData1|`bigint`|Número de filas insertadas.|52|Yes|  
|BigintData2|`bigint`|0 = plan serie; de lo contrario, identificador de subproceso durante la ejecución en paralelo.|53|Yes|  
...
|IndexID|`int`|Id. del índice del objeto afectado por el evento.|24|Yes|  
...
|PartitionId|`bigint`|Identificador de la partición que se está generando.|65|Yes|  
|PartitionNumber|`int`|Número normal de la partición que se está generando.|25|Yes|  
