...
|EventSubClass|`nvarchar`|Tipo de subclase de evento que proporciona más información acerca de cada clase de evento. Esta columna puede incluir los valores siguientes:<br /><br /> Registra la suscripción: Indica que la suscripción a notificación de consulta se ha registrado correctamente en la base de datos.<br /><br /> Rebobina la suscripción: Indica que [!INCLUDE[ssDE](../../includes/ssde-md.md)] ha recibido una solicitud de suscripción que coincide exactamente con una suscripción existente. En este caso, [!INCLUDE[ssDE](../../includes/ssde-md.md)] establece el valor del tiempo de espera de la suscripción existente en el especificado en la nueva solicitud de suscripción.<br /><br /> Suscripción se desencadenó: Indica que una suscripción de notificación genera un mensaje de notificación.<br /><br /> Activación de error de broker: Indica que un mensaje de notificación genera un error debido a un error de [!INCLUDE[ssSB](../../includes/sssb-md.md)].<br /><br /> No se pudo activación sin error de broker: Indica que un mensaje de notificación genera un error, pero no debido a un error de [!INCLUDE[ssSB](../../includes/sssb-md.md)].<br /><br /> Error de Broker interceptado: Indica que [!INCLUDE[ssSB](../../includes/sssb-md.md)] ha emitido un error en la conversación que usa la notificación de consulta.<br /><br /> Intento de eliminación de suscripción: Indica que [!INCLUDE[ssDE](../../includes/ssde-md.md)] ha intentado eliminar una suscripción expirada para liberar recursos.<br /><br /> Error de eliminación de suscripción: Indica que el intento de eliminar una suscripción expirada ha producido un error. [!INCLUDE[ssDE](../../includes/ssde-md.md)] volverá a programar automáticamente la eliminación de la suscripción para liberar recursos.<br /><br /> Destruye la suscripción: Indica que [!INCLUDE[ssDE](../../includes/ssde-md.md)] ha eliminado correctamente una suscripción expirada.|21|Sí|  
