...
|EndTime|`datetime`|Hora a la que finalizó la llamada a procedimiento remoto.|15|Yes|  
...
|RowCounts|`bigint`|Número de filas del lote RPC.|48|Yes|  
...
|TextData|`ntext`|Texto de la llamada a procedimiento remoto.|1|Yes|  
