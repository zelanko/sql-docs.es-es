...
|ObjectName|`nvarchar`|Nombre del parámetro al que se hace referencia.|34|Yes|  
...
|TextData|`ntext`|Valores del parámetro de salida de RPC.|1|Yes|  
