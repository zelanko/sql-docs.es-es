...
# <a name="showplan-text-event-class"></a>Showplan Text, clase de eventos
  La clase de eventos SHOWPLAN Text se [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] produce cuando ejecuta una instrucción SQL. La información contenida es un subconjunto de la información disponible en las clases de eventos Showplan All, Showplan XML Statistics Profile o Showplan XML.  
