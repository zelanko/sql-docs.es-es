...
ms.locfileid: "62650408"
---
# <a name="showplan-xml-for-query-compile-event-class"></a>Showplan XML For Query Compile, clase de eventos
  La clase de eventos SHOWPLAN XML for Query compile se [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] produce cuando compila una instrucción SQL. Incluya la clase esta para identificar los operadores de [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]SHOWPLAN en.  
