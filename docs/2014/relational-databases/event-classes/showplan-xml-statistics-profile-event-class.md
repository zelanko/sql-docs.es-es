...
ms.locfileid: "63053082"
---
# <a name="showplan-xml-statistics-profile-event-class"></a>Showplan XML Statistics Profile, clase de eventos
  La clase de eventos SHOWPLAN XML Statistics Profile [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] se produce cuando ejecuta una instrucción SQL. Incluya la clase de eventos SHOWPLAN XML Statistics Profile Profile para identificar los operadores de [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]SHOWPLAN en.  
