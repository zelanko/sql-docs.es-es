...
|ObjectName|`nvarchar`|Nombre del objeto que ha desencadenado la recompilación.|34|Yes|  
...
|SqlHandle|`varbinary`|Hash de 64 bits basado en el texto de una consulta ad hoc o en el Id. de base de datos y de objeto de un objeto SQL. Este valor puede pasarse a sys.dm_exec_sql_text para recuperar el texto SQL asociado.|63|Yes|  
|StartTime|`datetime`|Hora a la que se inició el evento, si está disponible.|14|Sí|  
|TextData|`ntext`|Texto de la instrucción Transact-SQL que causó la recompilación de nivel de instrucción.|1|Yes|  
