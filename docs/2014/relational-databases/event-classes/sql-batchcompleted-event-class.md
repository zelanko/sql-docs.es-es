...
|Lecturas|`bigint`|Número de operaciones de E/S de lectura de páginas causadas por el proceso por lotes.|16|Yes|  
...
|TextData|`ntext`|Texto del proceso por lotes.|1|Yes|  
