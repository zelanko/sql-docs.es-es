...
|EventClass|`int`|Tipo de evento = 12.|27|Sin|  
...
|Reads|`bigint`|Número de operaciones de E/S de lectura de páginas causadas por el proceso por lotes.|16|Sí|  
