...
|NestLevel|`int`|Nivel de anidamiento del procedimiento almacenado si la instrucción SQL se ha ejecutado en un procedimiento almacenado.|29|Yes|  
...
|TextData|`ntext`|Texto de la instrucción que se va a ejecutar.|1|Yes|  
