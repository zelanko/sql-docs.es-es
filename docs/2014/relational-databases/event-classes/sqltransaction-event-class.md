...
|EventSubClass|`int`|Tipo de la subclase de eventos.<br /><br /> 0=Principio<br /><br /> 1=Confirmar<br /><br /> 2=Revertir<br /><br /> 3=Punto de retorno|21|Yes|  
...
|IntegerData|`int`|0 = Transacción de sistema.<br /><br /> 1 = Transacción de usuario.|25|Yes|  
