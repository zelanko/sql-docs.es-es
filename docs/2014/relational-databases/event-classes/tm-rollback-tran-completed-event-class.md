...
|Error|`int`|Número de error de un evento dado. Con frecuencia, es el número de error almacenado en la tabla sys.messages.|31|Yes|  
|EventClass|`int`|Tipo de evento = 188.|27|No|  
|EventSequence|`int`|Secuencia de un evento determinado dentro de la solicitud.|51|No|  
|EventSubClass|`int`|Tipo de la subclase de eventos.<br /><br /> 1=Revertir<br /><br /> 2=Revertir y comenzar|21|Yes|  
