---
title: 'TM: Save Tran Completed, clase de evento | Microsoft Docs'
ms.custom: ''
ms.date: 06/13/2017
...
---
# <a name="tm-save-tran-completed-event-class"></a>TM: Save Tran Completed, clase de evento
  TM: Save Tran Completed, clase de evento indica que se ha completado una solicitud SAVE TRANSACTION. La solicitud fue enviada desde el cliente mediante la interfaz de administración de transacciones.  
  
## <a name="tm-save-tran-completed-event-class-data-columns"></a>TM: Guardar Tran completado columnas de datos de clase de eventos  
