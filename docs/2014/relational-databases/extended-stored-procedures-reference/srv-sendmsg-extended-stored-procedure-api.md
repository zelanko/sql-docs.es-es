...
## <a name="remarks"></a>Observaciones  
 ...
 Para obtener más información [, vea datos Unicode y páginas de códigos de servidor](../extended-stored-procedures-programming/unicode-data-and-server-code-pages.md).  
