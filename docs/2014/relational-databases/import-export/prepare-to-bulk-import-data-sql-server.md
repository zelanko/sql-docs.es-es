...
>  No se admite la importación masiva de datos en una tabla remota.  
 ...
 Utilice las siguientes directrices al importar datos de forma masiva desde un archivo de datos a una [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]instancia de:  
...
## <a name="see-also"></a>Consulte también  
 ...
 [Formatos de datos para importación o exportación masivas &#40;SQL Server&#41;](data-formats-for-bulk-import-or-bulk-export-sql-server.md)   
