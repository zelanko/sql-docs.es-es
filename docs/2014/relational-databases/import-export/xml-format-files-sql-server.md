...
|Atributo de FIELD|Descripción|Opcional /<br /><br /> Requerido|  
|---------------------|-----------------|------------------------------|  
...
###  <a name="d-mapping-field-xsitype-to-column-xsitype"></a><a name="MapXSItype"></a> D. Asignar el xsi:type \<FIELD> al xsi:type \<COLUMN>  
