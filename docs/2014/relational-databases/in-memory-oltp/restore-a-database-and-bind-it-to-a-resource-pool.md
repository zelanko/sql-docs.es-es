...
1.  [Restaure con NORECOVERY.](restore-a-database-and-bind-it-to-a-resource-pool.md#bkmk_norecovery)  
  
2.  [Crear el grupo de recursos de servidor](restore-a-database-and-bind-it-to-a-resource-pool.md#bkmk_createpool)  
  
3.  [Enlazar la base de datos y el grupo de recursos de servidor](restore-a-database-and-bind-it-to-a-resource-pool.md#bkmk_bind)  
  
4.  [Restaurar con RECOVERY](restore-a-database-and-bind-it-to-a-resource-pool.md#bkmk_recovery)  
  
5.  [Supervisar el rendimiento del grupo de recursos de servidor](restore-a-database-and-bind-it-to-a-resource-pool.md#bkmk_monitor)  
