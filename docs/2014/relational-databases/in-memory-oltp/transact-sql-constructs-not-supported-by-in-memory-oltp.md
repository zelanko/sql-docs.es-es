...
|Característica|INSERCIÓN de varias filas... Instrucciones de valores|En un procedimiento almacenado compilado de forma nativa no se pueden insertar varias filas usando la misma instrucción `INSERT`. Cree instrucciones `INSERT` para cada fila.|  
