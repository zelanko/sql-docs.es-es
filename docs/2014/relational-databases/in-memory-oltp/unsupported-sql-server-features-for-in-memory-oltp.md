---
title: Admite características de SQL Server | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
-   Copia de seguridad y restauración de una base de datos que contiene un grupo de archivos de datos optimizado para memoria. Para obtener más información, consulte [Back Up and Restore of SQL Server Databases](../backup-restore/back-up-and-restore-of-sql-server-databases.md).  
...
-   Trasvase de registros: [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] El trasvase de registros permite enviar automáticamente copias de seguridad de registro de transacciones desde una base de datos principal en una instancia del servidor principal a uno o más bases de datos secundarias en instancias independientes del servidor secundario. Para más información, vea [Acerca del trasvase de registros &#40;SQL Server&#41;](../../database-engine/log-shipping/about-log-shipping-sql-server.md).  
...
-   Regulador de recursos: [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] El regulador de recursos es una característica que puede usar para administrar [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] consumo de recursos del sistema y la carga de trabajo. El regulador de recursos permite especificar los límites en cuanto a la cantidad de CPU, E/S física y memoria que pueden usar las solicitudes entrantes procedentes de las aplicaciones. Para obtener más información, consulte [Managing Memory for In-Memory OLTP](../../database-engine/managing-memory-for-in-memory-oltp.md) y [Resource Governor](../resource-governor/resource-governor.md).  
...
|Contención de la base de datos|La contención de la base de datos no se admite en las bases de datos con procedimientos almacenados compilados de forma nativa y tablas optimizadas para memoria. Para obtener más información, consulte [Contained Databases](../databases/contained-databases.md).|  
...
|Notificaciones de eventos|No se admiten las notificaciones de eventos. Para obtener más información, consulte [Event Notifications](../service-broker/event-notifications.md).|  
