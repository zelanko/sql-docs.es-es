 ...
 **Para crear una tarea de copia de seguridad de base de datos**  
 ...
 **Todas las bases de datos del sistema (Master, msdb, Model)**  
 ...
 **El conjunto de copia de seguridad expirará**  
 ...
 **Si existen archivos de copia de seguridad**  
 ...
 **Extensión de archivo de copia de seguridad**  
 ...
 **Establecer compresión de copia de seguridad**  
...
|||  
|-|-|  
|**Usar la configuración de servidor predeterminada**|Haga clic para utilizar el valor predeterminado de nivel de servidor.<br /><br /> La opción de la configuración del servidor **Compresión de copia de seguridad predeterminada** establece este valor predeterminado. Para obtener información sobre cómo ver la configuración actual de esta opción, vea [ver o establecer la opción de configuración del servidor compresión de copia de seguridad predeterminada](../../database-engine/configure-windows/view-or-configure-the-backup-compression-default-server-configuration-option.md).|  
