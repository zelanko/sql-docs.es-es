 ...
 **Nota:** Los planes de mantenimiento solo se ejecutan en las bases de datos establecidas en el nivel de compatibilidad 80 o superior. Las bases de datos con un nivel de compatibilidad de 70 o inferior no se muestran.  
