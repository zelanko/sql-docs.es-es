...
-   Frecuencia de carga del conjunto de recopilación: Cada 15 minutos.  
 ...
 Es posible configurar el directorio del UMDW: \<Unidad del sistema >: \Program Files\Microsoft SQL Server\MSSQL10_50. < UCP_Name > \MSSQL\Data\\, donde \<unidadDelSistema > es normalmente la unidad C:\. El archivo de registro, Sysutility_mdw_\<GUID>_LOG, se encuentra en el mismo directorio.  
