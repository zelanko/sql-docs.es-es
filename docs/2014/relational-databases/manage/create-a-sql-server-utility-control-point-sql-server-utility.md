...
# <a name="create-a-sql-server-utility-control-point-sql-server-utility"></a>Crear un punto de control de la utilidad de SQL Server (utilidad de SQL Server)
 ...
 El UCP recopila información de configuración y rendimiento de las instancias administradas de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] cada 15 minutos. Esta información se almacena en el almacén de administración de datos de la utilidad (UMDW) en el UCP; el nombre del archivo UMDW es sysutility_mdw. 
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] se comparan con directivas para ayudar a identificar cuellos de botella en el uso de recursos y oportunidades de consolidación.  
...
-   [Especificar instancia](#Instance_name)  
  
-   [Cuadro de diálogo de conexión](#Connection_dialog)  
  
-   [Cuenta del conjunto de recopilación de la utilidad](#Agent_configuration)  
  
-   [Reglas de validación](#Validation_rules)  
  
-   [Resumen](#Summary)  
  
-   [Crear el punto de control de la utilidad](#Creating_UCP)  
...
##  <a name="Instance_name"></a>Especificar instancia  
 Especifique la siguiente información sobre el UCP que está creando:  
  
-   **Nombre de instancia** : para seleccionar una instancia [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] de en el cuadro de diálogo de conexión, haga clic en **conectar..**.. Proporcione el nombre del equipo y [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] el nombre de la instancia con el formato nombredeequipo\nombredeinstancia.  
  
-   **Nombre** de la utilidad: especifique un nombre que se utilizará para [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] identificar la utilidad en la red.  
...
##  <a name="Agent_configuration"></a>Cuenta del conjunto de recopilación de la utilidad  
...
##  <a name="Creating_UCP"></a>Crear el punto de control de la utilidad  
...
##  <a name="PowerShell_create_UCP"></a>Crear un nuevo punto de control de la utilidad con PowerShell  
