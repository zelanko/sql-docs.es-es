...
|DRIVER|N/D|No|¿Microsoft?? [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]El nombre del controlador ODBC de Native[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Client es {Native Client 11}. No se puede utilizar la palabra clave DRIVER si se utiliza la palabra clave DSN.|  
