...
ms.locfileid: "36110700"
---
# <a name="set-cursor-options-odbc"></a>Establecer las opciones del cursor (ODBC)
  Para establecer opciones de cursor, llame a [SQLSetStmtAttr](../../native-client-odbc-api/sqlsetstmtattr.md) para establecer o [SQLGetStmtAttr](../../native-client-odbc-api/sqlgetstmtattr.md) para obtener las opciones de instrucción que controlan el comportamiento del cursor.  
