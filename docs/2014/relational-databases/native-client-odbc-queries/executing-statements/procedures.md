...
# <a name="procedures"></a>Procedimientos
 ...
 Para obtener más información, consulte [ejecutan procedimientos almacenados](../../native-client-odbc-stored-procedures/running-stored-procedures.md).  
