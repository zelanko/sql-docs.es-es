...
# <a name="processing-results-odbc"></a>Procesar los resultados (ODBC)
 ...
 Cada instrucción INSERT, UPDATE y DELETE devuelve un conjunto de resultados que contiene solamente el número de filas afectado por la modificación. Este recuento se realiza llamadas disponibles cuando la aplicación [SQLRowCount](../native-client-odbc-api/sqlrowcount.md). ODBC 3. *x* aplicaciones deben llamar a **SQLRowCount** recuperar el resultado establecido o [SQLMoreResults](../native-client-odbc-api/sqlmoreresults.md) para cancelarla. Cuando una aplicación ejecuta un lote o procedimiento almacenado que contiene varias instrucciones INSERT, UPDATE o DELETE, el conjunto de resultados de cada instrucción de modificación deben procesarse utilizando **SQLRowCount** o cancelarse utilizando **SQLMoreResults**. Estos recuentos se pueden cancelar incluyendo una instrucción SET NOCOUNT ON en el lote o procedimiento almacenado.  
