...
# <a name="data-type-mapping-in-itabledefinition"></a>Asignación de tipos de datos en ITableDefinition
 ...
 Al especificar los nuevos tipos de datos de columna con OLE DB tipos de datos que ** usan el miembro wType [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] de la estructura DBCOLUMNDESC, el proveedor de OLE DB de Native Client asigna OLE DB tipos de datos de la siguiente manera.  
...
|DBTYPE_I2|**smallint**||  
|DBTYPE_I4|**int**||  
|DBTYPE_NUMERIC|**alfanumérico**|El [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] proveedor de OLE DB de Native Client inspecciona los miembros miembros *bPrecision* y *bScale* para determinar la precisión y la escala de la columna **numérica** .|  
|DBTYPE_R4|**impuestos**||  
|DBTYPE_R8|**float**||  
