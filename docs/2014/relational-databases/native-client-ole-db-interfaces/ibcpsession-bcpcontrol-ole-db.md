...
## <a name="remarks"></a>Observaciones  
 ...
 Este método se utiliza también para especificar la instrucción SELECT que se utiliza en la copia masiva de datos desde [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]. Puede establecer el argumento `eOption` en BCP_OPTION_HINTS y `iValue` en el argumento para que tenga un puntero a una cadena de caracteres anchos que contenga la instrucción SELECT.  
