...
## <a name="return-code-values"></a>Valores de código de retorno  
 ...
 E_UNEXPECTED  
 No se esperaba la llamada al método. Por ejemplo, el [ibcpsession:: BCPInit](ibcpsession-bcpinit-ole-db.md) no se llamó al método antes de llamar a esta función.  
