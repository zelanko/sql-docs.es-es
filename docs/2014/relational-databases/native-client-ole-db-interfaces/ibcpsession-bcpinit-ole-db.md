...
> [!NOTE]  
>  Para cambiar los valores de formato de datos especificados para un archivo de datos, use la [ibcpsession:: BCPColumns](ibcpsession-bcpcolumns-ole-db.md) y [ibcpsession:: BCPColFmt](ibcpsession-bcpcolfmt-ole-db.md) métodos.  
