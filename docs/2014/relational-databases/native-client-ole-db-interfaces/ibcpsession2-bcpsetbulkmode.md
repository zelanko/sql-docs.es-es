...
|`E_UNEXPECTED`|No se esperaba la llamada al método. Por ejemplo, no `IBCPSession2::BCPInit` se llamó al método antes de llamar a IBCPSession2:: BCPSetBulkMode.|  
...
|BCP_OUT_WIDE_CHARACTER_MODE|Especifica el modo de salida de Unicode.<br /><br /> Corresponde a la opción-w en BCP. EXE y IBCPSession:: BCPColFmt con la propiedad *eUserDataType* establecida `BCP_TYPE_SQLNCHAR`en.|  
