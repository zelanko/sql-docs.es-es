...
## <a name="return-code-values"></a>Valores de código de retorno  
 ...
 E_UNEXPECTED  
 Se llamó al método en un conjunto de filas de copia masiva previamente invalidado por el [IRowsetFastLoad:: Commit](irowsetfastload-commit-ole-db.md) método.  
