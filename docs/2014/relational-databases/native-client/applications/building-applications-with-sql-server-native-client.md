...
## <a name="in-this-section"></a>En esta sección  
 ...
 [Conectarse a una base de datos SQL Azure con SQL Server Native Client](connecting-to-a-windows-azure-sql-database-using-sql-server-native-client.md)  
