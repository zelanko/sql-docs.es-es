...
|Validación de parámetros SQL_C_TYPE_TIMESTAMP y DBTYPE_DBTIMESTAMP más estricta.|Antes de [!INCLUDE[ssKatmai](../../../includes/sskatmai-md.md)] Native Client, `datetime` los valores se redondean para ajustarse `datetime` a `smalldatetime` la escala [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]de columnas y por. 
