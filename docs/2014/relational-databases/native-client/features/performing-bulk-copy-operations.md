---
title: Realizar operaciones de copia masiva | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
# <a name="performing-bulk-copy-operations"></a>Realizar operaciones de copia masiva
 ...
 Para una aplicación de ejemplo que muestra esta característica, consulte [masiva copia datos masiva con IRowsetFastLoad &#40;OLE DB&#41;](../../native-client-ole-db-interfaces/irowsetfastload-ole-db.md).  
...
## <a name="sql-server-native-client-ole-db-provider"></a>Proveedor OLE DB de SQL Server Native Client  
 El [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] proveedor OLE DB de Native Client implementa dos métodos para realizar operaciones de copia masiva con un [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] base de datos. El primer método implica el uso de la [IRowsetFastLoad](../../native-client-ole-db-interfaces/irowsetfastload-ole-db.md) interfaz para las operaciones de copia masiva basadas en memoria; y el segundo consiste en usar el [IBCPSession](../../native-client-ole-db-interfaces/ibcpsession-ole-db.md) interfaz para operaciones de copia masiva basados en archivos.  
  
### <a name="using-memory-based-bulk-copy-operations"></a>Usar operaciones de copia masiva basadas en memoria  
 El [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] proveedor OLE DB de Native Client implementa el **IRowsetFastLoad** interfaz para exponer la compatibilidad con [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] operaciones de copia masiva basadas en memoria. El **IRowsetFastLoad** interfaz implementa la [IRowsetFastLoad:: Commit](../../native-client-ole-db-interfaces/irowsetfastload-commit-ole-db.md) y [IRowsetFastLoad:: insertRow](../../native-client-ole-db-interfaces/irowsetfastload-insertrow-ole-db.md) métodos.  
...
> [!NOTE]  
>  Si el **IDataInitialize** interfaz se usa para inicializar el origen de datos, lo que es necesario establecer la propiedad SSPROP_IRowsetFastLoad el *rgPropertySets* parámetro de la  **IOpenRowset:: OpenRowset** método; de lo contrario, la llamada a la **OpenRowset** método devolverá E_NOINTERFACE.  
