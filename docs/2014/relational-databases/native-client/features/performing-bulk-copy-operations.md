...
# <a name="performing-bulk-copy-operations"></a>Realizar operaciones de copia masiva
 ...
 Para una aplicación de ejemplo que muestra esta característica, consulte [datos masiva copia masiva con IRowsetFastLoad &#40;OLE DB&#41;](../../native-client-ole-db-interfaces/irowsetfastload-ole-db.md).  
