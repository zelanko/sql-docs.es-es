...
# <a name="sparse-columns-support-in-sql-server-native-client"></a>Compatibilidad con columnas dispersas en SQL Server Native Client
  ...
  [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client admite las columnas dispersas. Para obtener más información sobre las columnas [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]dispersas en, vea [usar columnas dispersas](../../tables/use-sparse-columns.md) y [usar conjuntos de columnas](../../tables/use-column-sets.md).  
