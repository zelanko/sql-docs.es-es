...
# <a name="finding-more-sql-server-native-client-information"></a>Buscar más información sobre SQL Server Native Client
 ...
 Información adicional sobre [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client puede encontrarlo buscando el [Microsoft Knowledge Base](https://go.microsoft.com/fwlink?linkid=5757).  
