...
|**Búsquedas de páginas de nodo local/s**|Indica el número de solicitudes de búsqueda de este nodo que se satisfacen desde este mismo nodo.|  
|**Búsquedas de páginas de notas remotas/s**|Indica el número de solicitudes de búsqueda de este nodo que se satisfacen desde otros nodos.|  
