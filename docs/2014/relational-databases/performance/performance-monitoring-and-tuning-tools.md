...
ms.locfileid: "63150841"
---
# <a name="performance-monitoring-and-tuning-tools"></a>Herramientas de supervisión y optimización del rendimiento
  [!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] proporciona un conjunto completo de herramientas para supervisar los eventos [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] de y para optimizar el diseño físico de la base de datos. La elección de la herramienta depende del tipo de supervisión u optimización que se realice y de los eventos particulares que se supervisen.  
...
|Uso en aplicaciones personalizadas|Sí <sup>1</sup>||||Sí||  
 ...
 <sup>1</sup> uso [!INCLUDE[ssSqlProfiler](../../../includes/sssqlprofiler-md.md)] de procedimientos almacenados del sistema.  
