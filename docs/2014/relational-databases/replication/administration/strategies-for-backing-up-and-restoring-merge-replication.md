...
### <a name="reinitializing-all-subscriptions"></a>Reinicializar todas las suscripciones  
 ...
 Para reinicializar una suscripción, vea [Reinicializar una suscripción](../reinitialize-a-subscription.md).  
  
 Para crear y aplicar una instantánea, vea [Crear y aplicar la instantánea inicial](../create-and-apply-the-initial-snapshot.md) y [Crear una instantánea para una publicación de mezcla con filtros con parámetros](../create-a-snapshot-for-a-merge-publication-with-parameterized-filters.md).  
