...
2.  [!INCLUDE[clickOK](../../../includes/clickok-md.md)]  
 ...
 Para obtener más información acerca de cómo tener acceso al cuadro de diálogo **Propiedades de la suscripción - \<Publicador>: \<BaseDatosPublicación >** , vea [Ver y modificar las propiedades de una suscripción de extracción](../view-and-modify-pull-subscription-properties.md).  
