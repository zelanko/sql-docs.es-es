---
title: Ver y modificar los parámetros de línea de comandos del agente de replicación (SQL Server Management Studio) | Documentos de Microsoft
ms.custom: ''
ms.date: 03/08/2017
