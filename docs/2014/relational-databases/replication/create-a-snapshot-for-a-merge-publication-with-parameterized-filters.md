...
5.  Busque el valor de `true` para el <xref:Microsoft.SqlServer.Replication.MergePublication.SnapshotAvailable%2A> propiedad para determinar cuándo está lista para usarse la instantánea inicial.  
