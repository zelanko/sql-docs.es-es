---
title: Información del distribuidor, supervisión de suscripciones (publicación transaccional, SQL Server 2005 y versiones posterior) de lista | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
ms.locfileid: "48128525"
---
# <a name="distributor-information-subscription-watch-list-transactional-publication-sql-server-2005-and-later"></a>Información del distribuidor, Lista de supervisión de suscripciones (Publicación transaccional, SQL Server 2005 y versiones posteriores)
