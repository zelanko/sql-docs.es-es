...
6.  En la página suscriptores, seleccione el nombre de instancia de servidor del suscriptor y en **base de datos de suscripción**, seleccione  **\<nueva base de datos >** en la lista.  
