...
## <a name="download-only-articles"></a>artículos de solo descarga  
 ...
 Para especificar que un artículo es de solo descarga, vea [Specify That a Merge Table Article is Download-Only](../publish/specify-that-a-merge-table-article-is-download-only.md).  
