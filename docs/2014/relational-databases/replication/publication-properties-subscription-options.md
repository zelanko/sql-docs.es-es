...
# <a name="publication-properties-subscription-options"></a>Propiedades de la publicación, Opciones de suscripción
  La página **Opciones de suscripción** del cuadro de diálogo Propiedades de la **publicación** permite ver y establecer las propiedades de nivel de publicación asociadas a las suscripciones. Las propiedades se agrupan en las siguientes categorías:  
 ...
 **Permitir suscripciones anónimas**  
 Determina si se permiten suscripciones de extracción anónimas. Las suscripciones anónimas son [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssEWEd2005](../../includes/ssewed2005-md.md)]compatibles [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssMobileEd2005](../../includes/ssmobileed2005-md.md)]con, [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] y para Windows CE. Para utilizar esta opción en publicaciones transaccionales y de instantáneas, la opción **Instantánea siempre visible** debe establecerse en **True**.  
 ...
 **Replicación de cambios de esquema**  
 Solo para [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] y versiones posteriores. Determina si se replican cambios de esquema (como agregar una columna a una tabla o cambiar el tipo de datos de una columna) en objetos publicados. Para obtener más información, vea [Make Schema Changes on Publication Databases](publish/make-schema-changes-on-publication-databases.md) (Realizar cambios de esquema en bases de datos de publicaciones).  
  
## <a name="options-for-snapshot-and-transactional-publications"></a>Opciones de publicaciones transaccionales y de instantáneas  
  
### <a name="creation-and-synchronization"></a>Creación y sincronización  
 **Agente de distribución independientes**  
 ...
 **Instantánea siempre disponible**  
 ...
 **Permitir detección de conflictos punto a punto**  
 Se aplica solamente a [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] y versiones posteriores. Especifica si la detección de conflictos está habilitada para esta publicación. Para utilizar la detección de conflictos, todos los nodos deben estar ejecutando [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] o una versión posterior, y debe haberse habilitado la detección para todos los nodos. Para usar la detección de conflictos, también debe especificar un valor para ID. de **originador del mismo nivel**. Para obtener más información, vea [detección de conflictos en la replicación punto a punto](transactional/peer-to-peer-conflict-detection-in-peer-to-peer-replication.md).  
  
 **Identificador de originador del mismo nivel**  
 ...
 **Notificar conflictos de forma centralizada**  
