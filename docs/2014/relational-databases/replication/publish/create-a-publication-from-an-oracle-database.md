...
10. En la página **Acciones** del Asistente, puede crear un script para la publicación. Para obtener más información, consulte [Scripting Replication](../scripting-replication.md).  
