...
3.  En la página **publicadores** del cuadro de diálogo **propiedades del distribuidor: \<Distributor> ** , haga clic en **Agregar**y, a continuación, haga clic en **Agregar publicador de Oracle**.  
...
7.  Haga clic en **Conectar**para crear una conexión al publicador de Oracle y configurarla para la replicación. Se cerrará el cuadro de diálogo **conectar al servidor** y volverá al cuadro **de diálogo Propiedades \<Distributor> del distribuidor:** .  
