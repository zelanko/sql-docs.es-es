...
|Agente de lectura de cola|**[\<Distribuidor>]. \<entero>**|  
 ...
 <sup>1</sup> para suscripciones de extracción a publicaciones de Oracle, el nombre del trabajo es ** \<Publisher>-\<Publisher**> en lugar de ** \<Publisher>-\<basededatosdepublicación>**.  
  
 <sup>2</sup> para suscripciones de extracción a publicaciones de Oracle, el nombre del trabajo es ** \<Publisher>\<-basededatosdedistribución**> en lugar de ** \<Publisher>-\<basededatosdepublicación>**.  
