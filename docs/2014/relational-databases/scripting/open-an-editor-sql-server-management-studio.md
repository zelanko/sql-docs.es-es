...
-   **Consulta con conexión actual** : abre una nueva ventana del editor del tipo asociado a la conexión actual en [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)]. La ventana del editor usa la misma información de autenticación que la conexión actual. [!INCLUDE[ssDE](../../includes/ssde-md.md)] Por ejemplo, si selecciona una instancia de en explorador de objetos y, a continuación, usa **consulta con conexión actual**, [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] abre un [!INCLUDE[ssDE](../../includes/ssde-md.md)] editor de consultas conectado a la misma instancia con la misma información de autenticación.  
  
-   **Motor de base de datos consulta** : abre un nuevo [!INCLUDE[ssDE](../../includes/ssde-md.md)] editor de consultas y un cuadro de diálogo para obtener la información necesaria para conectarse a una [!INCLUDE[ssDE](../../includes/ssde-md.md)]instancia de.  
  
-   **Analysis Services consulta MDX** : abre un nuevo [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] editor de consultas MDX y un cuadro de diálogo para obtener la información necesaria para conectarse a [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]una instancia de.  
  
-   **Consulta dmx Analysis Services** : abre un nuevo [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] editor de consultas DMX y un cuadro de diálogo para obtener la información necesaria para conectarse a [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]una instancia de.  
  
-   **Analysis Services consulta XML/a** : abre un nuevo [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] editor de consultas XML/a y un cuadro de diálogo para obtener la información necesaria para conectarse a [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]una instancia de.  
  
### <a name="using-the-fileopen-menu"></a>Usar el menú Archivo/Abrir  
 En el menú **Archivo** , haga clic en **Abrir**y, a continuación, navegue a un archivo y ábralo. 
  [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] abre el tipo de editor adecuado correspondiente a la extensión de archivo, copia el contenido del archivo en la ventana del editor y también abre un cuadro de diálogo de conexión si es necesario. Por ejemplo, si abre un archivo con la extensión .sql, [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] abre una ventana del editor de consultas de [!INCLUDE[ssDE](../../includes/ssde-md.md)] , copia el contenido del archivo .sql, y abre un cuadro de diálogo de conexión. Si abre un archivo con una extensión no asociada a un editor determinado, [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] abre una ventana y copia el editor de texto de contenido del archivo.  
