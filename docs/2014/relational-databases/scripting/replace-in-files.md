...
ms.locfileid: "75243680"
---
# <a name="replace-in-files"></a>Reemplazar en archivos
  La pestaña **reemplazar en archivos** de la ventana Buscar y reemplazar permite buscar en el código de un conjunto especificado de archivos una cadena o expresión y cambiar algunas o todas las coincidencias encontradas. Las coincidencias que se encuentran y las acciones que se toman aparecen en la ventana Resultados de la búsqueda seleccionada en **Opciones de resultados**.  
...
## <a name="look-in"></a>Buscar en  
 La opción elegida en la lista desplegable **Buscar en** determina si **Reemplazar en archivos** busca solo en los archivos actualmente activos o busca en todos los archivos almacenados en algunas carpetas. Seleccione un ámbito de búsqueda de la lista, escriba una ruta de acceso a la carpeta o haga clic en el botón **examinar** para mostrar el cuadro de diálogo **conjunto de directorios personalizado** y elija un conjunto de carpetas para realizar la búsqueda.  
