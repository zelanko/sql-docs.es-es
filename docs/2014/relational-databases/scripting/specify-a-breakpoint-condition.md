...
## <a name="specifying-conditions"></a>Especificar condiciones  
 La expresión especificada debe ser una expresión válida de Transact-SQL que se evalúe como un valor booleano. Para obtener más información, vea [expresiones &#40;&#41;de Transact-SQL ](/sql/t-sql/language-elements/expressions-transact-sql).  
