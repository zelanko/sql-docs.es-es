...
-   Proceso de host de demonio de filtro (fdhost.exe).  
 ...
 ![arquitectura de búsqueda de texto completo](../../database-engine/media/ifts-arch.gif "arquitectura de búsqueda de texto completo")  
...
##  <a name="components"></a> Componentes lingüísticos y compatibilidad con idiomas en búsqueda de texto completo  
