...
-   [Creación de un inicio de sesión de SQL Server](authentication-access/create-a-login.md)  
  
-   [Administrar bases de datos e inicios de sesión en Azure SQL Database](https://msdn.microsoft.com/library/ee336235.aspx)  
...
-   [Usuarios de bases de datos independientes: creación de una base de datos portátil](contained-database-users-making-your-database-portable.md)  
...
-   [Cifrado NTFS (nivel de carpeta)](https://msdn.microsoft.com/library/dd163562.aspx)  
...
-   [Claves almacenadas en el Azure Key Vault](encryption/extensible-key-management-using-azure-key-vault-sql-server.md)  
  
 **Cifrado de columna, datos y claves**  
  
-   [Cifrar por certificado](/sql/t-sql/functions/encryptbycert-transact-sql)  
...
-   [Cifrar mediante frase de contraseña](/sql/t-sql/functions/encryptbypassphrase-transact-sql)  
...
-   [Configuración del firewall del servicio de Azure](/sql/relational-databases/system-stored-procedures/sp-set-firewall-rule-azure-sql-database)  
  
 **Cifrado de datos en tránsito**  
  
-   [Capa de sockets seguros para la Motor de base de datos](../../database-engine/configure-windows/enable-encrypted-connections-to-the-database-engine.md)  
  
-   [Capa de sockets seguros para SQL Database](https://msdn.microsoft.com/library/azure/ff394108.aspx)  
