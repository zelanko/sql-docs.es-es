 ...
 **Nota:** Los <xref:Microsoft.SqlServer.Management.Smo.UserDefinedType>tipos <xref:Microsoft.SqlServer.Management.Smo.UserDefinedDataType>de XML, y requieren un valor de nombre para identificar el objeto.  
