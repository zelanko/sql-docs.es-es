...
-   SQL Server Native Client (SQLNCLI11)  
     ...
     Expone la funcionalidad de SQLXML 4.0 a través de una nueva tecnología de acceso a datos que extiende y complementa las versiones actuales de Microsoft Data Access Components (MDAC). SQLNCLI11 proporciona total compatibilidad con las características introducidas en [!INCLUDE[ssVersion2005](../../../includes/ssversion2005-md.md)]. Para obtener más información, vea [Programación de SQL Server Native Client](../../native-client/sql-server-native-client-programming.md).  
