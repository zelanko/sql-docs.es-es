...
2.  Implemente e instale SQLXML 4.0 y [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client  
     ...
     Para obtener más información, consulte en [conceptos de programación en SQLXML 4.0](../../sqlxml/sqlxml-4-0-programming-concepts.md) y [instalar SQL Server Native Client](../../native-client/applications/installing-sql-server-native-client.md).  
