...
```  
 ...
 Puede omitir el  **\<después >** etiqueta si el diagrama de actualización está realizando una operación de eliminación. Si no se especifica la parte opcional `mapping-schema` atributo, el  **\<ElementName >** especificado en el diagrama de actualización se asigna a una tabla de base de datos y la asignación de elementos o atributos secundarios a las columnas de la tabla.  
...
1.  Complete el ejemplo B ("insertar varios registros utilizando un diagrama de actualización") en [insertar datos utilizando XML los diagramas de actualización &#40;SQLXML 4.0&#41;](inserting-data-using-xml-updategrams-sqlxml-4-0.md).  
  
2.  Copie el diagrama de actualización anterior en el Bloc de notas y guárdelo como Updategram-RemoveShifts.xml en la misma carpeta que se utilizó para completar ("insertar varios registros utilizando un diagrama de actualización") en [insertar datos utilizando XML los diagramas de actualización &#40;SQLXML 4.0&#41; ](inserting-data-using-xml-updategrams-sqlxml-4-0.md).  
