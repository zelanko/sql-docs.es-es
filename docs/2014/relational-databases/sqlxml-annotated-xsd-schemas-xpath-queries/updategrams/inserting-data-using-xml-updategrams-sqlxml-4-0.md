...
## <a name="before-block"></a>\<antes de > bloque  
 El  **\<antes >** bloque puede omitirse en una operación de inserción. Si la parte opcional `mapping-schema` atributo no se especifica, el  **\<ElementName >** que se especifica en el diagrama de actualización se asigna a una tabla de base de datos y los elementos secundarios o atributos se asignan a columnas de la tabla.  
