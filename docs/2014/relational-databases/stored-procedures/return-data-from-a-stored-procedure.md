...
### <a name="examples-of-cursor-output-parameters"></a>Ejemplos de parámetros de salida de cursor  
 En el ejemplo siguiente, se crea un procedimiento que especifica un parámetro de salida `@currency`,`cursor` _ con `cursor` el tipo de datos. A continuación, se llama al procedimiento desde un lote.  
