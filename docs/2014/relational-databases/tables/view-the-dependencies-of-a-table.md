...
3.  En el cuadro de diálogo **Dependencias del objeto**_\<nombre del objeto>_, seleccione **Objetos que dependen de** *\<nombre del objeto>* u **Objetos de los que depende**_\<nombre del objeto>_**depende**.  
