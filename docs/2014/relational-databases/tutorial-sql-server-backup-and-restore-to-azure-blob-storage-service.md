...
## <a name="what-you-will-learn"></a>Aprendizaje  
 ...
 [Lección 4: Realizar una restauración a partir de una copia de seguridad completa de la base de datos](../tutorials/lesson-4-perform-a-restore-from-a-full-database-backup.md)  
...
-   Una instancia de [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] y la base de datos AdventureWorks2012 instalada.  
     ...
     La instancia de SQL Server puede ser local o en una máquina virtual de Azure.  
...
1.  [SQL Server copias de seguridad y restauración con Azure Blob Storage servicio](backup-restore/sql-server-backup-and-restore-with-microsoft-azure-blob-storage-service.md)  
