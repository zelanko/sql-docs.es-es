...
# <a name="propertytype-property-clientnetworkprotocolproperty-class"></a>Propiedad PropertyType (clase ClientNetworkProtocolProperty)
  Obtiene el tipo de propiedad al que hace referencia el valor de la [propiedad PropertyIdx (clase ClientNetworkProtocolProperty)](clientnetworkprotocolproperty-class.md) .  
