...
---
# <a name="sample-creating-a-sql-server-agent-alert-by-using-the-wmi-provider-for-server-events"></a>Ejemplo: Creación de una alerta del Agente SQL Server con el proveedor WMI para eventos de servidor
