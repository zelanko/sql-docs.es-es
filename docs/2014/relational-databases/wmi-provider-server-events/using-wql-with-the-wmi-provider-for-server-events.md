...
```  
 ...
 Las notificaciones de eventos con ámbito de servidor se crean en el **maestro** la base de datos y se puede consultar para los metadatos mediante el uso de la [sys.server_event_notifications](/sql/relational-databases/system-catalog-views/sys-server-event-notifications-transact-sql) vista de catálogo.  
