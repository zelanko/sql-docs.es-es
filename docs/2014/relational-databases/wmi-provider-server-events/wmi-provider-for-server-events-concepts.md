...
## <a name="in-this-section"></a>En esta sección  
 ...
 [Ejemplo: crear una alerta del Agente SQL Server con el proveedor WMI para eventos de servidor](sample-creating-a-sql-server-agent-alert-with-the-wmi-provider.md)  
 ...
 [Ejemplo: Usar el proveedor de eventos WMI con .NET Framework](sample-using-the-wmi-event-provider-with-the-net-framework.md)  
