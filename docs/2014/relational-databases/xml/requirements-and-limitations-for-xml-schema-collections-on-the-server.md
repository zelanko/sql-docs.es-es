...
|**\<xsd:choice>**|[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]rechaza los esquemas que tienen una **\<xsd:choice>** partícula sin elementos secundarios, a menos que la partícula se defina con un valor de atributo **minOccurs** igual a cero.|  
|**\<xsd:include>**|Actualmente, [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] no admite este elemento. El servidor rechaza los esquemas XML que incluyen este elemento.<br /><br /> Como solución, los esquemas XML que incluyen la **\<xsd:include>** Directiva se pueden preprocesar para copiar y combinar el contenido de los esquemas incluidos en un solo esquema para cargarlo en el servidor. Para obtener más información, vea [Preprocesar un esquema para combinar esquemas incluidos](preprocess-a-schema-to-merge-included-schemas.md).|  
...
|[Elemento &#60;xsd:redefine&#62;](the-xsd-redefine-element.md)|Explica la limitación de utilizar el \<xsd:redefine> elemento y describe una solución alternativa.|  
|[The xs:QName Type](the-xs-qname-type.md)|Describe la limitación relacionada con el tipo xs:QName.|  
|[Valores de las declaraciones de &#60;xsd:simpleType&#62;](values-for-xsd-simpletype-declarations.md)|Describe las restricciones que se aplican a las \<xsd:simpleType> declaraciones.|  
|[facetas de enumeración](enumeration-facets.md)|Describe la limitación relacionada con las facetas de enumeración.|  
|[Contenido simple y de tipo mixto](mixed-type-and-simple-content.md)|Describe la limitación que se produce al restringir un tipo mixto a un contenido simple.|  
...
## <a name="see-also"></a>Consulte también  
 [&#40;de datos XML SQL Server&#41;](xml-data-sql-server.md)   
 ...
 [Restricción de atribución de partículas únicas](unique-particle-attribution-constraint.md)   
