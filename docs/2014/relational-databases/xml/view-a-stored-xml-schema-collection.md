...
```  
 ...
 Si desea ver sólo un esquema de la colección de esquemas XML, puede especificar XQuery en el `xml` tipo de resultado devuelto por `xml_schema_namespace`.  
