...
|**Internet Explorer 9**|Incompatible|32 bits, 64 bits|Incompatible|32 bits, 64 bits|32 bits, 64 bits|Incompatible|  
|**Internet Explorer 8**|Incompatible|32 bits, 64 bits|Incompatible|32 bits, 64 bits|32 bits, 64 bits|Incompatible|  
|**Mozilla Firefox (la última versión publicada)**|32 bits|32 bits|32 bits|32 bits|32 bits|Incompatible|  
...
|**Apple Safari (versión más reciente publicada)**|No compatible|No compatible|No compatible|No compatible|No compatible|32 bits, 64 bits|  
|**Google Chrome (la última versión publicada)**|32 bits **(\*)** para tiempo limitado|32 bits **(\*)** para tiempo limitado|32 bits **(\*)** para tiempo limitado|32 bits **(\*)** para tiempo limitado|32 bits **(\*)** para tiempo limitado|Incompatible|  
...
|**Internet Explorer 9**|Incompatible|32 bits, 64 bits|Incompatible|32 bits, 64 bits|32 bits, 64 bits|No compatible|No compatible|  
|**Internet Explorer 8**|Incompatible|32 bits, 64 bits|Incompatible|32 bits, 64 bits|32 bits, 64 bits|No compatible|No compatible|  
...
|**Tipo de explorador**|**Admite**|**Configuración predeterminada del explorador**|**Configuración predeterminada del servidor**|  
|----------------------|------------------|-------------------------|------------------------|  
...
|**Internet Explorer 9**|Incompatible|Sí|Incompatible|Sí|Sí|Sí|Internet Explorer admite el conjunto completo de características de ReportViewer.|  
|**Internet Explorer 8.0**|Incompatible|Sí|Incompatible|Sí|Sí<sup>1</sup>|Incompatible|Internet Explorer admite el conjunto completo de características de ReportViewer. <sup>1</sup>|  
|**Internet Explorer 7.0**|Incompatible|Sí|Incompatible|Sí|Sí<sup>1</sup>|Incompatible|Internet Explorer admite el conjunto completo de características de ReportViewer. <sup>1</sup>|  
|**Firefox (la última versión publicada)**|Sí|Sí|Sí|Sí|Sí|Incompatible|Imprimir y ampliar y reducir no se admiten.|  
...
|**Chrome (última versión publicada)**|Sí|Sí|Sí|Sí|Sí|Incompatible|Imprimir y ampliar y reducir no se admiten.|  
