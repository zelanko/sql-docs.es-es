---
title: Elegir herramientas de análisis e informes de Microsoft | Documentos de Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
|Realizar análisis predictivos de autoservicio||||||[Datos a los complementos de minería de datos para Excel](http://msdn.microsoft.com/library/dn282385\(v=sql.120\).aspx)|  
...
|Crear modelos corporativos multidimensionales/tabulares||||||[Analysis Services](http://msdn.microsoft.com/library/bb522607\(v=sql.120\).aspx)|  
|Crear visualizaciones de datos ad-hoc|||[Power View para SharePoint](http://go.microsoft.com/fwlink/p/?LinkId=391858)||||  
|Crear paneles|||[Paneles de SharePoint](http://go.microsoft.com/fwlink/p/?LinkId=391859)<br /><br /> [PerformancePoint Services](http://technet.microsoft.com/library/ee424392.aspx)||||  
|Crear informes operativos||||||<sup>1</sup> [reporting Services](http://msdn.microsoft.com/library/ms159106\(v=sql.120\).aspx)|  
|Crear informes personalizados e incrustados||||||<sup>1</sup> [reporting Services](http://msdn.microsoft.com/library/ms159106\(v=sql.120\).aspx)|  
|**Análisis avanzado**|Científico de datos||||||  
|Realizar análisis predictivos de autoservicio||||||[Datos a los complementos de minería de datos para Excel](http://msdn.microsoft.com/library/dn282385\(v=sql.120\).aspx)|  
|Usar algoritmos de minería de datos||||||[Minería de datos en Analysis Services](http://technet.microsoft.com/library/bb510516\(v=sql.120\).aspx)|  
  
 <sup>1</sup> reporting Services cuenta con una serie de características que admite la entrega de informes de operaciones e informes personalizados, como suscripciones y alertas de datos.  
