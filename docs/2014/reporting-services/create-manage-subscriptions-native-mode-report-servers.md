...
## <a name="disabling-subscriptions"></a>Deshabilitar suscripciones  
 ...
 Para deshabilitar el procesamiento de suscripciones en un servidor de `ScheduleEventsAndReportDeliveryEnabled` informes, `False` puede establecer la propiedad en en la configuración de [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] **área expuesta para Reporting Services** faceta de la administración basada en directivas. Ello impedirá que se ejecuten todas las operaciones programadas. No puede desactivar únicamente el procesamiento de suscripciones en el servidor de informes.  
