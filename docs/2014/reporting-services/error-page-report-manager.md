...
-   Si va a examinar un servidor de informes local y ve errores similares al siguiente, vea: [configurar un servidor de informes de modo nativo para la administración Local &#40;SSRS&#41;](report-server/configure-a-native-mode-report-server-for-local-administration-ssrs.md)  
