...
```  
 ...
 En el ejemplo de código siguiente se muestra el comando que se [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[vbprvb](../../../includes/vbprvb-md.md)] utilizaría para los archivos con la extensión. VB.  
