---
title: Página de propiedades generales, recursos (Administrador de informes) | Documentos de Microsoft
ms.custom: ''
ms.date: 03/06/2017
 ...
 **Nombre**  
 Especifique un nombre para el recurso. El nombre debe incluir al menos un carácter alfanumérico. También puede incluir espacios y algunos símbolos. No use los caracteres ; ? : @ & = +, $ / * \< > | "o / para especificar un nombre.  
