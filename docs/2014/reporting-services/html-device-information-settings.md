...
|**Mapa**|Indica si mostrar u ocultar el mapa del documento de informe. El valor predeterminado para este parámetro es `true`.|  
...
|**Código**|Indica si JavaScript se admite en el informe representado. El valor predeterminado es `true`.|  
|`LinkTarget`|Destino para los hipervínculos en el informe. Puede establecer como destino una ventana o un marco proporcionando el nombre de la ventana, `LinkTarget` =como *window_name*, o bien puede establecer como destino una `LinkTarget`nueva ventana mediante = _blank. Otros nombres de destino válidos incluyen _self, _parent y _top.|  
...
|**Los**|Indica si mostrar u ocultar el área de parámetros de la barra de herramientas. Si establece este parámetro en el valor `true`, se muestra el área de parámetros de la barra de herramientas. El valor predeterminado para este parámetro es `true`.|  
