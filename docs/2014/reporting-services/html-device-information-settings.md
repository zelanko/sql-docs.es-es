...
|**DocMap**|Indica si mostrar u ocultar el mapa del documento de informe. El valor predeterminado para este parámetro es `true`.|  
...
|**Parámetros**|Indica si mostrar u ocultar el área de parámetros de la barra de herramientas. Si establece este parámetro en el valor `true`, se muestra el área de parámetros de la barra de herramientas. El valor predeterminado para este parámetro es `true`.|  
