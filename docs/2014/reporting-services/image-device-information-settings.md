...
|`DpiX`|Resolución horizontal de la imagen de salida. El valor predeterminado es **96**. Se aplica `BMP`a `GIF`los `PNG`formatos de `TIFF` salida,, y.|  
|`DpiY`|Resolución vertical de la imagen de salida. El valor predeterminado es **96**. Se aplica `BMP`a `GIF`los `PNG`formatos de `TIFF` salida,, y.|  
...
|**PrintDpiX**|Resolución horizontal de la imagen de salida. El valor predeterminado es `300`. Se aplica al formato de salida`EMF`de metarchivo mejorado ().|  
|**PrintDpiY**|Resolución vertical de la imagen de salida. El valor predeterminado es `300`. Se aplica al formato de salida`EMF`de metarchivo mejorado ().|  
