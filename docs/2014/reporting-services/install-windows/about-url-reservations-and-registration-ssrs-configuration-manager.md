...
##  <a name="URLPermissionsAccounts"></a>Autenticación e identidad de servicio para las direcciones URL de Reporting Services  
...
##  <a name="URLSharePoint"></a>Direcciones URL para el servidor de informes en el modo integrado de SharePoint  
