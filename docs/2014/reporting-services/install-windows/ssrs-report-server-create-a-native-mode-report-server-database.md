...
5.  Haga clic en **TCP/IP** y haga clic en **habilitado**.  
...
3.  Haga clic en **Crear una nueva base de datos del servidor de informes**y, a continuación, haga clic en **Siguiente**.  
