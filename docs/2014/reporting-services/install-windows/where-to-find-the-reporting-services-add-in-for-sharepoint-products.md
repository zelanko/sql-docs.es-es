...
# <a name="where-to-find-the-reporting-services-add-in-for-sharepoint-products"></a>Dónde encontrar el complemento Reporting Services para Productos de SharePoint
  El [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] complemento (SSRS) para SharePoint Products and Technologies (rsSharePoint.msi) es una descarga Web que proporciona características para integrar un servidor de informes con una implementación de SharePoint.  
...
-   En una instalación desde el símbolo del sistema, utilice la opción **RS_SHPWFE** para instalar el complemento. Para obtener más información sobre [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] las instalaciones del símbolo del sistema, consulte [símbolo instalación de Reporting Services SharePoint Mode y modo nativo](install-reporting-services-at-the-command-prompt.md).  
...
##  <a name="bkmk_sql2008sp2"></a> Complemento de SQL Server 2008 SP2 Reporting Services para tecnologías y productos de SharePoint 2007  
 ...
 La versión más actualizada de este archivo está disponible en el [!INCLUDE[msCoName](../../includes/msconame-md.md)] centro de descarga, [Microsoft SQL Server 2008 SP2 Reporting Services complemento para Microsoft SharePoint Technologies](http://go.microsoft.com/fwlink/?LinkID=204594).  
...
##  <a name="bkmk_sql2008"></a> Complemento de SQL Server 2008 Reporting Services para tecnologías y productos de SharePoint 2007  
 ...
 La versión más actualizada de este archivo está disponible en el [!INCLUDE[msCoName](../../includes/msconame-md.md)] centro de descarga, [Microsoft SQL Server 2008 Reporting Services complemento para Microsoft SharePoint Technologies](http://go.microsoft.com/fwlink/?LinkID=204813).  
