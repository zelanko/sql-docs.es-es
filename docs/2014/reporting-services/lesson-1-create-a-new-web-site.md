...
3.  En el **nuevo sitio Web** cuadro de diálogo el **plantillas instaladas** panel, seleccione **Visual C#** y, a continuación, elija **sitio web de ASP.NET**.  
  
4.  En el **ubicación** cuadro, especifique un directorio de proyecto y haga clic en **Aceptar**.  
