...
##  <a name="ReptPartGallery"></a> Galería de elementos de informe  
 La manera más fácil de crear un informe es encontrar un elemento de informe existente, como una tabla o un gráfico, en el servidor de informes o en un servidor de informes integrado en un sitio de SharePoint. Puede buscar elementos de informe en la galería de elementos de informe para agregarlos a un informe. Podrá filtrar los elementos de informe por el nombre completo o una parte de él, por el autor, por el autor de la última modificación, por la fecha en que se modificaron por última vez, por la ubicación donde están almacenadas o por el tipo de elemento de informe. Por ejemplo, podría buscar todos los gráficos creados la semana pasada por uno de sus colaboradores.  
  
> [!NOTE]  
>  Debe estar conectado a un servidor de informes para poder ver la galería de elementos de informe.  
  
 Puede ver los resultados de la búsqueda como miniaturas o como lista, y ordenar los resultados de la búsqueda por nombre, fechas de creación y modificación, y autor. Para más información, vea [Report Parts &#40;Report Builder and SSRS&#41;](../report-parts-report-builder-and-ssrs.md).  
