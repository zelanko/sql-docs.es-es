...
-   **Aplicación e interfaz de usuario** La aplicación Generador de informes que se usa para crear un origen de datos, agregar una referencia a un origen de datos compartido, agregar un conjunto de datos compartido o agregar un elemento de informe que incluya los orígenes de datos y los conjuntos de datos de los que depende.  

-   **Elementos de definición de informe** Los orígenes de datos y los conjuntos de datos forman parte de la definición de informe. Una vez publicado un informe en un servidor de informes, los orígenes de datos compartidos y los conjuntos de datos compartidos se administran con independencia desde la definición de informe.  

  -   **Origen de datos y origen de datos compartido** Parte de una definición de informe que incluye la información sobre el tipo de extensión de procesamiento de datos, la información de conexión y la autenticación.  

  -   **Conjunto de DataSet y colección de campos** Parte de una definición de informe que incluye la consulta, la colección de campos y los tipos de datos de campo.  

-   **Extensiones de datos de Reporting Services** Extensiones de datos integradas que se instalan con Generador de informes. Una extensión de datos proporciona una funcionalidad que controla los parámetros de autenticación, agregados de servidor y parámetros de varios valores.  

-   **Proveedor de datos** Software que administra la conexión y recuperación de datos del origen de datos externo. El proveedor de datos define la sintaxis de la cadena de conexión. La mayoría de las extensiones de datos se compilan sobre una capa del proveedor de datos.  

-   **Origen de datos externo** Dónde recuperar los datos del informe, por ejemplo, una base de datos, un archivo, un cubo o un servicio Web.  
...
|-----------|----------------------|  
|[Tipo de conexión SQL Server &#40;SSRS&#41;](sql-server-connection-type-ssrs.md)|[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|  
|[Analysis Services tipo de conexión para MDX &#40;SSRS&#41;](analysis-services-connection-type-for-mdx-ssrs.md)|[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]|  
...
|[SQL Server tipo de conexión de almacenamiento de datos paralelos &#40;SSRS&#41;](sql-server-parallel-data-warehouse-connection-type-ssrs.md)|[!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssDWfull](../../includes/ssdwfull-md.md)]|  
...
|[Información general de las extensiones](../extensions/data-processing/data-processing-extensions-overview.md) de [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)] procesamiento de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] datos en la documentación de en los [libros en pantalla](https://go.microsoft.com/fwlink/?linkid=121312)de.|Proporciona a los usuarios expertos información detallada sobre las extensiones de datos.|  
