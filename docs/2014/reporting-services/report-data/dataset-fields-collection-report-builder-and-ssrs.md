...
-   **Campos de conjunto de los campos.** Los metadatos que representa la colección de campos que se devolverán cuando la consulta del conjunto de datos se ejecuta en el origen de datos.  
  
-   **Campos calculados del conjunto de conjuntos.** Campos adicionales que crea para el conjunto de datos. Cada campo calculado se crea evaluando una expresión que se define.  
...
##  <a name="Fields"></a>Campos y consultas del conjunto de  
...
-   **Procesador de informes** Los tipos de datos se basan en la versión de CLR que se instala al [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]instalar.  
...
##  <a name="MissingFields"></a>Detectar campos que faltan en tiempo de ejecución  
