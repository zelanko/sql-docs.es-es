...
-   **Texto** de Admite texto [!INCLUDE[tsql](../../../includes/tsql-md.md)] de consulta estándar para orígenes de datos de bases de datos relacionales [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] , incluidas las extensiones de procesamiento de datos para y Oracle.  
  
-   **TableDirect** Selecciona todas las columnas de la tabla especificada. Por ejemplo, para una tabla denominada Customers, éste es el equivalente de la instrucción [!INCLUDE[tsql](../../../includes/tsql-md.md)] de `SELECT * FROM Customers`.  
  
-   **StoredProcedure** Admite llamadas a procedimientos almacenados en el origen de datos. Para usar esta opción, el administrador de la base de datos debe haberle concedido permiso de ejecución en el procedimiento almacenado para el origen de datos.  
...
|![Quitar filtro del campo seleccionado](../media/rsqdicon-removefilter.gif "Quitar filtro del campo seleccionado")|Quitar el filtro de la columna seleccionada en el panel Diagrama que está marcado como un filtro (![gráfico de filtro junto a la columna de filtro seleccionada](../media/rsqdicon-filter.gif "Gráfico de filtro junto a la columna de filtro seleccionada")).|  
...
## <a name="see-also"></a>Consulte también  
 ...
 [Tipo de conexión SQL Server &#40;SSRS&#41;](sql-server-connection-type-ssrs.md)   
