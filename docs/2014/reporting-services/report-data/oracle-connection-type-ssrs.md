...
-   [Usar el proveedor de datos de .NET Framework para Oracle](https://go.microsoft.com/fwlink/?LinkId=112314) en MSDN.Microsoft.com  
  
-   [Cómo usar Reporting Services para configurar y obtener acceso a un origen de datos de Oracle](https://support.microsoft.com/kb/834305)  
  
-   [Cómo agregar permisos para la entidad de seguridad del servicio de red](https://support.microsoft.com/kb/870668)  
