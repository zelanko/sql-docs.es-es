...
# <a name="sql-server-connection-type-ssrs"></a>Tipo de conexión de SQL Server (SSRS)
  Para incluir datos de una [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] base de datos en un informe, debe tener un conjunto de datos basado en un origen de datos de [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]informe de tipo. Este tipo de origen de datos integrado se basa en la [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] extensión de datos. Use este tipo de origen de datos para conectar y recuperar los datos de la versión actual y de las versiones anteriores de bases de datos de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .  
...
-   [Texto](#QueryText) de Escriba [!INCLUDE[tsql](../../includes/tsql-md.md)] comandos.  
