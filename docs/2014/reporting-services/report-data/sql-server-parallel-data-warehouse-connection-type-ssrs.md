...
# <a name="sql-server-parallel-data-warehouse-connection-type-ssrs"></a>Tipo de conexión Almacenamiento de datos paralelo de SQL Server (SSRS)
  [!INCLUDE[msCoName](../../../includes/msconame-md.md)][!INCLUDE[ssDWCurrentFull](../../../includes/ssdwcurrentfull-md.md)] es un dispositivo de almacenamiento de datos escalable que ofrece rendimiento y escalabilidad mediante un procesamiento paralelo masivo. 
  [!INCLUDE[ssDW](../../../includes/ssdw-md.md)] utiliza bases de datos de [!INCLUDE[ssCurrent](../../../includes/sscurrent-md.md)] para el procesamiento distribuido y el almacenamiento de datos.  
 ...
 Para incluir datos de [!INCLUDE[ssDW](../../../includes/ssdw-md.md)] en el informe, debe tener un conjunto de datos basado en un origen de datos de informe de [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] tipo almacenamiento de datos paralelos. Este tipo de origen de datos integrado se basa en la [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] extensión de datos de almacenamiento de datos paralelos. Utilice este tipo de origen de datos para conectarse y recuperar datos de [!INCLUDE[ssDW](../../../includes/ssdw-md.md)].  
