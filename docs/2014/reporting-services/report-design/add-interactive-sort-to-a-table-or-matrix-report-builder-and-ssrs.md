...
##  <a name="BackToTop"></a>En este artículo  
 ...
 [Ordenar un grupo de filas primarios de nivel superior para una tabla o matriz](#SortingTopLevelParent)  
...
##  <a name="SortingTopLevelParent"></a>Ordenar un grupo de filas primarios de nivel superior para una tabla o matriz  
...
4.  En **Elija lo que va a ordenar:**, haga clic en una de las siguientes opciones:  
    ...
    -   **Detalles** de Haga clic en **detalles** para ordenar las filas de detalles. En la lista desplegable, seleccione el campo por el que desea realizar la ordenación. Para esta opción, debe especificar el valor por el que desea ordenar.  
  
    -   **Grupos** de Haga clic en **grupos** para ordenar los valores del grupo secundario. Para esta opción, la expresión **Ordenar por** se rellena automáticamente a partir de la expresión de grupo.  
