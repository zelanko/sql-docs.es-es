...
##  <a name="ChoosingIndicatorTypes"></a>Elección del tipo de indicador que se va a usar  
...
##  <a name="SizingIndicatators"></a>Indicadores de ajuste de tamaño para maximizar el impacto visual  
...
##  <a name="IncludingIndicatorsInGauges"></a>Incluir indicadores y medidores en paneles de medidores  
...
-   [Especifique el tamaño de un indicador mediante una expresión &#40;Generador de informes y SSRS&#41;](specify-the-size-of-an-indicator-using-an-expression-report-builder-and-ssrs.md)  
