 ...
 *result_expression*  
 (`Variant`) Una expresión que se evalúa para la fila del conjunto de DataSet donde *source_expression* = *destination_expression*y que especifica el valor que se va a recuperar. Por ejemplo, `=Fields!PhoneNumber.Value`.  
