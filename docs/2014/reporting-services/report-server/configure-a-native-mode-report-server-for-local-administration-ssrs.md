...
1.  En la pantalla Inicio, escriba `sql server` y, a continuación, haga clic en **SQL Server Data Tools para Visual Studio**. Haga clic en **Ejecutar como administrador**  
