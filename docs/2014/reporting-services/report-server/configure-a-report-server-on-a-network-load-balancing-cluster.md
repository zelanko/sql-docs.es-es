...
##  <a name="SpecifyingVirtualServerName"></a> Cómo configurar Hostname y UrlRoot  
 ...
 Configurar la `Hostname` propiedad cuando utilizas reservas de direcciones URL comodín en el entorno de informes. Al especificar la propiedad `Hostname` como el nombre de servidor virtual del servidor NLB, el tráfico de red para el entorno de informe se dirige al servidor NLB. A continuación, el NLB distribuye las solicitudes entre los nodos del servidor de informes.  
