...
|Tema|Descripción|  
|-----------|-----------------|  
|[Funcionalidad de SQL Server Reporting Services no incluida en SQL Server 2014](discontinued-functionality-to-sql-server-reporting-services-in-sql-server.md)|Describe características que existían en versiones anteriores de [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] pero que se han quitado en versiones posteriores.|  
...
|[Cambios recientes de SQL Server Reporting Services en SQL Server 2014](breaking-changes-in-sql-server-reporting-services-in-sql-server-2016.md)|Describe los problemas que se pueden encontrar cuando se actualiza [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)].|  
