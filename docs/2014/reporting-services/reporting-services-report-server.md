...
|**Administrador de configuración**|Sí|** \* Importante \* \* ** No se puede usar Configuration Manager para administrar un servidor de informes en modo de SharePoint. En su lugar, utilice Administración central de SharePoint.|  
...
|**Copia de seguridad y recuperación de SharePoint**|No|Sí|  
