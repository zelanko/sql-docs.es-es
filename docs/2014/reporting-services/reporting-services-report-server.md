 ...
 **Azure**: para obtener información sobre [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] cómo usar con Azure virtual machines, consulte lo siguiente:
...
-   **Modo nativo**: incluido el modo nativo con SharePoint elementos Web, donde un servidor de informes se ejecuta como un servidor de aplicaciones que proporciona todas las capacidades [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] de procesamiento y administración exclusivamente a través de los componentes de. Para configurar un servidor de informes en modo nativo se usa el administrador de configuración de [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] y SQL Server Management Studio.
...
|**Extensiones de seguridad personalizadas**|Sí|
  [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] en el servidor de informes. El servidor de informes incluye una extensión de seguridad para fines especiales que se utiliza siempre que se configura un servidor de informes para que se ejecute en el modo integrado de SharePoint. Esta extensión de seguridad es un componente interno que se requiere para las operaciones integradas.|
|**Configuration Manager**|Sí|** \* Importante \* \* ** No se puede usar Configuration Manager para administrar un servidor de informes en modo de SharePoint. En su lugar, utilice Administración central de SharePoint.|
...
|**. Informes de RDLX**|No|Sí<br /><br /> Los informes .RDLX de Power View solo pueden ejecutarse en servidores de informes de [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] en modo de SharePoint.|
...
|**Copia de seguridad y recuperación de SharePoint**|Sin|Sí|
...
###  <a name="bkmk_nativewithwebparts"></a>Modo nativo con SharePoint elementos web
...
|**1,8**|
  [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] crean tres bases de datos para las características de alertas de datos, temporales y el servidor de informes. Las opciones de configuración que se aplican a todas las aplicaciones de servicio de SSRS se almacenan en el archivo **RSReportserver.config** .|

##  <a name="bkmk_reportprocessor"></a>Proceso de informes y proceso de entrega y programación
