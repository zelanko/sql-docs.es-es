...
ms.locfileid: "66102689"
---
# <a name="reporting-services-tutorials-ssrs"></a>Tutoriales de Reporting Services (SSRS)
  Esta sección contiene tutoriales para [!INCLUDE[ssSQL11](../includes/sssql11-md.md)] [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)].  
 ...
 Siga los pasos de este tutorial para aprender a usar la herramienta de definición de esquemas XML (XSD. exe) para generar clases que le permitan serializar y deserializar archivos de definición de informe (. RDL y [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)]. rdlc) con.  
