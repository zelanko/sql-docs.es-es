...
-   Haciendo clic en **iniciar** en el **depurar** menú.  
  
-   Haciendo clic en el **iniciar** situado en el [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] barra de herramientas estándar.  
  
-   Presionar la tecla F5.  
  
 Si usa una configuración de proyecto que genera el informe pero no lo implementa, el informe que se especifica en la `StartItem` propiedades de la configuración actual se abreen en una ventana de vista previa independiente. La ventana de vista previa muestra el informe de la misma manera y tiene la misma funcionalidad que el modo de vista previa.  
  
> [!NOTE]  
>  Antes de depurar un informe es preciso establecer un elemento de inicio. Para establecer un elemento de inicio, en el Explorador de soluciones, haga clic en el proyecto de informe, haga clic en **propiedades**y, a continuación, en `StartItem`, seleccione el nombre del informe que desea mostrar.  
