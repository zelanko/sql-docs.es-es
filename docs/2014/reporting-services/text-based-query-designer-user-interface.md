---
title: Interfaz de usuario del Diseñador de consultas basado en texto | Documentos de Microsoft
ms.custom: ''
ms.date: 03/08/2017
...
#### <a name="example"></a>Ejemplo  
 ...
 Cuando escriba el nombre de la tabla Sales.Customer, es equivalente a crear la [!INCLUDE[tsql](../includes/tsql-md.md)] instrucción `SELECT * FROM Sales.Customer;`.  
