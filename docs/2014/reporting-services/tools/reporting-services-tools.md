...
# <a name="reporting-services-tools"></a>Herramientas de Reporting Services
 ...
 Para buscar una herramienta inmediatamente, vea [Tutorial: Cómo buscar e iniciar Reporting Services herramientas &#40;SSRS&#41;](tutorial-how-to-locate-and-start-reporting-services-tools-ssrs.md).  
