...
> [!TIP]  
>  Para obtener información sobre cómo usar Windows PowerShell para crear [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)] servidores de informes en máquinas virtuales de Azure, consulte [uso de PowerShell para crear una máquina virtual de Azure con un servidor de informes en modo nativo](https://msdn.microsoft.com/library/dn449661.aspx).  
