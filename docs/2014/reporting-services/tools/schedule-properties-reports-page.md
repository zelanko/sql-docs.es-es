...
# <a name="schedule-properties-reports-page"></a>Propiedades de la programación (página Informes)
 ...
 Para abrir esta página, inicie [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)], conectarse a un servidor de informes, abra la **programaciones compartidas** carpeta, haga clic en una programación compartida, seleccione **propiedades**y, a continuación, haga clic en **informes** .  
