...
## <a name="administrators"></a>Administradores  
 ...
 Además, vea los temas siguientes en la [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] documentación de [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] en los [libros en pantalla](https://go.microsoft.com/fwlink/?linkid=121312)de:  
