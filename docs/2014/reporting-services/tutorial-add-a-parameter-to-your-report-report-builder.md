...
1.  En el panel datos de informe bajo el nodo **parámetros** , haga clic *@StoreID*con el botón secundario y, a continuación, haga clic en **propiedades de parámetro**.  
...
6.  Obtenga una vista previa del informe. El visor de informes muestra el mensaje *@StoreID*para.  
...
1.  En el panel datos de informe, haga clic con el *@StoreID*botón secundario en el parámetro y, a continuación, haga clic en **propiedades de parámetro**.  
...
2.  En el panel datos de informe, haga clic *@StoreID*con el botón secundario y, a continuación, haga clic en **propiedades de parámetro**.  
...
3.  En el panel datos de informe, arrastre el *@StoreID* parámetro al cuadro de texto. El cuadro de texto presenta `[@StoreID]`.  
...
8.  En la barra de herramientas del visor de informes, al lado de `True` **Mostrar selecciones**, haga clic en.  
