...
##  <a name="Table"></a>1. crear un informe de tabla y un conjunto de informes desde el Asistente para tablas o matrices  
...
##  <a name="BackgroundColors"></a>3. usar colores de fondo para mostrar un KPI  
