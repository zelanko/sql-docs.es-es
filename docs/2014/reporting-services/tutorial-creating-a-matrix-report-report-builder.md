...
##  <a name="CreateMatrix"></a>1. crear un informe de matriz y un conjunto de DataSet desde el Asistente para nueva tabla o matriz  
...
##  <a name="Groups"></a>2. organizar datos y elegir el diseño y el estilo desde el Asistente para nueva tabla o matriz  
...
##  <a name="FormatData"></a>3. dar formato a los datos  
...
##  <a name="Width"></a>5. cambiar el ancho de las columnas  
...
##  <a name="HeaderTitle"></a>7. agregar un encabezado de informe y un título de informe  
...
##  <a name="RotateTextBox"></a>9. (opcional) girar el cuadro de texto 270 grados  
