---
title: Propiedad VirtualDirectoryReportManager (WMI MSReportServer_ConfigurationSetting) | Documentos de Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="property-values"></a>Valores de propiedad  
 Un `string` que contiene el directorio virtual.  
