---
title: Propiedad WindowsServiceIdentityActual (MSReportServer_ConfigurationSetting WMI) | Documentos de Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="property-values"></a>Valores de propiedad  
 Un `String` objeto que contiene la identidad que se ejecuta el servicio de Windows servidor de informes.  
