...
##  <a name="TermsAndDefinitions"></a>Información general de las soluciones de alta disponibilidad de SQL Server  
 ...
 [!INCLUDE[ssHADR](../../includes/sshadr-md.md)]  
  ...
  [!INCLUDE[ssHADR](../../includes/sshadr-md.md)] es una solución de alta disponibilidad y recuperación ante desastres de nivel empresarial presentada en [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] que permite maximizar la disponibilidad para una o varias bases de datos de usuario. 
...
##  <a name="RecommendedSolutions"></a>Soluciones recomendadas para utilizar SQL Server con el fin de proteger los datos  
