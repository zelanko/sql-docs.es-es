...
>  El soporte extendido de SQL Server 2005 finaliza el 12 de abril de 2016. Si sigue ejecutando SQL Server 2005 después del 12 de abril de 2016, ya no recibirá actualizaciones de seguridad.  
 ...
 ![Hoja de datos sobre la actualización desde SQL Server 2005](../../../2014/sql-server/install/media/sqlserver2005eos.png "Hoja de datos sobre la actualización desde SQL Server 2005")  
...
-   Lea la siguiente serie de publicaciones de blog del equipo de SQL Server sobre cómo planear su actualización.  
    ...
    -   [Planeación de una actualización eficaz desde SQL Server 2005: Paso 1 de 3](http://blogs.technet.com/b/dataplatforminsider/archive/2015/12/10/planning-an-efficient-upgrade-from-sql-server-2005-step-1-of-3.aspx)  
  
    -   [Planeación de una actualización eficaz desde SQL Server 2005: Paso 2 de 3](http://blogs.technet.com/b/dataplatforminsider/archive/2015/12/15/planning-an-efficient-upgrade-from-sql-server-2005-step-2-of-3.aspx)  
  
    -   [Planeación de una actualización eficaz desde SQL Server 2005: Paso 3 de 3](http://blogs.technet.com/b/dataplatforminsider/archive/2015/12/17/planning-an-efficient-upgrade-from-sql-server-2005-step-3-of-3.aspx)  
