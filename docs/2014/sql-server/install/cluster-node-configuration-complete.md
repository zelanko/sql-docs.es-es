...
-   [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]nombre de instancia: seleccione el nombre de instancia [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] para el clúster de conmutación por error.  
  
-   Nombre de este nodo: este campo se rellena previamente con el nombre del equipo en el [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] que se ejecuta el programa de instalación.  
