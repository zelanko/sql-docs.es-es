---
title: La configuración de nodo (completo) del clúster | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
-   [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] nombre de instancia: seleccione el nombre de instancia para el [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] el clúster de conmutación por error.  
  
-   Nombre de este nodo: este campo se rellena previamente con el nombre del equipo donde el [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] se está ejecutando el programa de instalación.  
  
-   [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Nombre de red del clúster de conmutación por error: este campo no se rellena previamente. Especifique el nombre de red para la nueva instancia en clúster de conmutación por error de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] . Este es el nombre que identifica la instancia en clúster de conmutación por error en la red.  
