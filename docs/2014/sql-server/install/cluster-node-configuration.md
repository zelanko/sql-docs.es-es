---
title: La configuración de nodo del clúster | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
 ...
 **[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] :** use la lista desplegable para seleccionar la instancia en clúster de conmutación por error de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] que quiera modificar.  
