---
title: 'Lista de comprobación de implementación: Reporting Services, Power View y PowerPivot para SharePoint | Documentos de Microsoft'
ms.custom: ''
ms.date: 06/13/2017
...
|Compruebe que PowerPivot para SharePoint estaá operativo|[Verify a PowerPivot para SharePoint](../../analysis-services/instances/install-windows/verify-a-power-pivot-for-sharepoint-installation.md)<br /><br /> Esta tarea confirma el acceso a los datos PowerPivot mediante un libro de ejemplo que se carga.|  
