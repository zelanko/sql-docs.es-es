 ...
 **[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] modo de SharePoint** requiere sharepoint Server 2013 y emplea la arquitectura de aplicación de servicio de SharePoint.  
...
###  <a name="bkmk_bi_Sharepoint2013_3tier"></a>Implementación de PowerPivot para SharePoint 2013 y Reporting Services tres servidores  
 ...
 ![Implementación de servidor en modo de SharePoint de SSAS y SSRS 3](../../../2014/sql-server/install/media/as-and-rs-3server-deployment.gif "Implementación de servidor en modo de SharePoint de SSAS y SSRS 3")  
...
|**(6)**|[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] Server en modo de SharePoint. Configure el valor de **Configuración del modelo de datos** de la aplicación Excel Services para usar este servidor.|  
...
###  <a name="bkmk_powerpivot_sharepoint2013_1server"></a>PowerPivot para SharePoint 2013 de implementación en un solo servidor  
 ...
 ![PowerPivot para SharePoint implementación de un solo servidor](../../../2014/sql-server/install/media/as-powerpivot-mode-1server-deployment.gif "PowerPivot para SharePoint implementación de un solo servidor")  
...
###  <a name="bkmk_powerpivot_ssrs_sharepoint2013_2server"></a>PowerPivot para SharePoint 2013 y Reporting Services dos implementaciones de servidor  
 ...
 ![Implementación de servidor de SSAS y SSRS en modo de SharePoint 2](../../../2014/sql-server/install/media/as-and-rs-2server-deployment.gif "Implementación de servidor de SSAS y SSRS en modo de SharePoint 2")  
...
##  <a name="bkmk_sharepoint2010_scaleserver"></a>Implementación escalada de tres niveles  
 ...
 ![5-topología de servidor](../../../2014/sql-server/install/media/sql11bisetup-5server.gif "5-topología de servidor")  
