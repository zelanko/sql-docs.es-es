...
## <a name="installing-includessnoversionincludesssnoversion-mdmd-features"></a>Instalar características de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
 En el **selección de características** página, el [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] características se dividen en dos secciones principales: **Características de instancia** y **características compartidas**.  
...
> 3.  [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] no se admite en configuraciones en paralelo en la plataforma de 64 bits y en el subsistema de 32 bits (WOW64) de un servidor de 64 bits.  
