...
## <a name="shared-files-for-all-instances-of-includessnoversionincludesssnoversion-mdmd"></a>Archivos compartidos para todas las instancias de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
 Los archivos comunes que usan todas las instancias en un único equipo se instalan [!INCLUDE[ssInstallPathVar](../../includes/ssinstallpathvar-md.md)]en la \<carpeta, donde la *unidad*> es la letra de unidad donde se instalan los componentes. La unidad predeterminada es normalmente la C.  
...
>  
 ...
 El subárbol del registro se crea\\[!INCLUDE[msCoName](../../includes/msconame-md.md)]\\[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]\\<en HKLM\Software*Instance_ID*> para los componentes que reconocen las instancias. Por ejemplo,  
...
-   [\\[!INCLUDE[msCoName](../../includes/msconame-md.md)]\\[!INCLUDE[msCoName](../../includes/msconame-md.md)]HKEY_LOCAL_MACHINE \Software[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]\Instance Names\SQL] "NombreDeInstancia" = "MSSQL12"  
  
-   [\\[!INCLUDE[msCoName](../../includes/msconame-md.md)]\\[!INCLUDE[msCoName](../../includes/msconame-md.md)]HKEY_LOCAL_MACHINE \Software[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]\Instance Names\OLAP] "NombreDeInstancia" = "MSAS12"  
  
-   [\\[!INCLUDE[msCoName](../../includes/msconame-md.md)]\\[!INCLUDE[msCoName](../../includes/msconame-md.md)]HKEY_LOCAL_MACHINE \Software[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]\Instance Names\RS] "NombreDeInstancia" = "MSRS12"  
...
|---------------|---------------------------------|--------------------------------------------|  
|[!INCLUDE[ssDE](../../includes/ssde-md.md)]componentes de servidor|\Archivos de\\[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]programa \MSSQL12. \<InstanceID>\|configurable|  
|[!INCLUDE[ssDE](../../includes/ssde-md.md)]archivos de datos|\Archivos de\\[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]programa \MSSQL12. \<InstanceID>\|configurable|  
|[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]servidor|\Archivos de\\[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]programa \MSAS12. \<InstanceID>\|configurable|  
|[!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)]archivos de datos|\Archivos de\\[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]programa \MSAS12. \<InstanceID>\|configurable|  
|[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]servidor de informes|\Archivos de\\[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]programa \MSRS12. \<InstanceID> \Reporting Services\ReportServer\Bin\|configurable|  
|[!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)]Administrador de informes|\Archivos de\\[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]programa \MSRS12. \<InstanceID> \reporting Services\ReportManager\|ruta de acceso fija|  
|[!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]|\<Directorio de instalación>\|\120\dts configurable<sup>4</sup>|  
|Componentes cliente (excepto bcp.exe y sqlcmd.exe)|\<Directorio de instalación>\|\120\tools configurable<sup>4</sup>|  
...
|DLL que proporcionan compatibilidad con la conexión administrada para [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]|
  [!INCLUDE[ssInstallPathVar](../../includes/ssinstallpathvar-md.md)]DTS\Connections|Ruta de acceso fija|  
|DLL para cada tipo de enumeración que admita [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)]|
  [!INCLUDE[ssInstallPathVar](../../includes/ssinstallpathvar-md.md)]DTS\ForEachEnumerators|Ruta de acceso fija|  
|
...
|Componentes que se comparten entre todas las instancias de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|[!INCLUDE[ssInstallPathVar](../../includes/ssinstallpathvar-md.md)]Ruta\|de acceso fija compartida|  
 ...
 <sup>1</sup> Asegúrese de que la carpeta\\[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]\Archivos de programa \ está protegida con permisos limitados.  
...
> [!NOTE]
>  Los archivos de datos deberían encontrarse en un directorio secundario denominado Data. Por ejemplo, especifique c:\Archivos\\[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]de programa \MSSQL12. \<InstanceName> \ para especificar la ruta de acceso raíz al directorio de datos de las bases de datos del sistema durante la actualización cuando los archivos de\\[!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]datos se encuentran en c:\Archivos de programa \MSSQL12. \<NombreDeInstancia> \mssql\data.  
