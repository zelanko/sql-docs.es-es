...
2.  En el **filtrar por** lista, seleccione un tipo de problema que desea ver:  
    ...
    -   **Problemas de actualización previa**. Con esta opción se muestran todos los problemas que deben corregirse antes de actualizar a [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].  
