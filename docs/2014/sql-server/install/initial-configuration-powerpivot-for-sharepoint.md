...
##  <a name="bkmk_redist"></a> Paso 9: Instalar el SQL Server 2008 R2 versión del proveedor OLE DB en SQL Server 2012 PowerPivot para SharePoint instancia  
