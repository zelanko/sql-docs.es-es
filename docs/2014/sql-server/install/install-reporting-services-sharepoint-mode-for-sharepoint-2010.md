...
-   Compruebe que el servicio de **Administración de SharePoint 2010** se ha iniciado en Windows Administrador del servidor.  
 ...
 ![Componentes de SSRS en una instalación de un servidor 1](../../../2014/sql-server/install/media/rs-deployment-1-server.gif "componentes de SSRS en una instalación de 1 servidor")  
...
9. Seleccione lo siguiente en la página **Selección de características** :  
    ...
    -   **Reporting Services complemento para productos de SharePoint 2010**. ![Nota Nota](../../../2014/reporting-services/media/rs-fyinote.png ": la opción")del Asistente para la instalación para instalar el complemento es nueva con la versión @no__t 2.  
