---
title: Instalar las características de BI de SQL Server 2014 | Documentos de Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
# <a name="install-sql-server-2014-bi-features"></a>Instalar las características de SQL Server 2014 BI
 ...
 Si ya está familiarizado con los pasos de instalación para [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)], [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] o PowerPivot para SharePoint, puede ir directamente a las listas de comprobación para obtener información sobre cómo habilitar escenarios concretos. Para obtener más información, consulte [listas de comprobación para instalar características de BI con SharePoint](checklists-for-installing-bi-features-with-sharepoint.md).  
