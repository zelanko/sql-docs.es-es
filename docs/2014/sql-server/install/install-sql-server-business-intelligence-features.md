...
|[Comprobar o solucionar problemas de SQL Server de instalación de características de BI](../../../2014/sql-server/install/verify-or-troubleshoot-sql-server-bi-feature-installation-problems.md)|Esta sección incluye los pasos para comprobar una instalación. También proporciona vínculos a la información de resolución de problemas en Internet.|  
