...
## <a name="description"></a>Descripción  
 [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] no actualice ni instalar en SharePoint 2007. La actualización está bloqueada.  
...
## <a name="corrective-action"></a>Acción correctora  
 ...
 No es posible actualizar directamente de SharePoint 2007 a SharePoint 2013. pero puede hacer lo que se conoce como una operación de adjuntar base de datos de "salto doble" para actualizar Office SharePoint Server 2007 a SharePoint Server 2010 y, a continuación, de SharePoint Server 2010 a SharePoint Server 2013.  
