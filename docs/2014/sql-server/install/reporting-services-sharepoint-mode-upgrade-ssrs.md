---
title: Actualización del modo de SharePoint (SSRS) Reporting Services | Microsoft Docs
ms.custom: ''
ms.date: 06/13/2017
...
## <a name="see-also"></a>Vea también  
 [Ver y leer los archivos de registro de instalación de SQL Server](http://technet.microsoft.com/library/ms143702\(v=sql.110\).aspx)   
