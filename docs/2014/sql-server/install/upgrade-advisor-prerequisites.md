...
-   [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)], a partir de .NET Framework 4. El [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] está disponible en los medios del producto [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] y en el [SDK, el redistribuible y Service Pack sitio web de descarga](https://go.microsoft.com/fwlink/?LinkId=48882).  
...
-   El [!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)][!INCLUDE[tsql](../../includes/tsql-md.md)] ScriptDom es un requisito previo para instalar el asesor de actualizaciones de [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] y no se instala mediante el programa de instalación del Asesor de actualizaciones. El programa de instalación requiere que descargue e instale el [!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)][!INCLUDE[tsql](../../includes/tsql-md.md)] ScriptDom del Feature Pack de [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].  
