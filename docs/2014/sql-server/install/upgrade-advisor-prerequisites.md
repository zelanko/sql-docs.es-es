...
-   Windows Installer 4.5. Puede instalar Windows Installer desde la [sitio Web de Windows Installer](https://go.microsoft.com/fwlink/?LinkId=49112).  
  
-   [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)], a partir de .NET Framework 4. El [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] está disponible en el [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] CD del producto y desde el [sitio Web de descarga de SDK, los redistribuibles y service pack](https://go.microsoft.com/fwlink/?LinkId=48882).  
