---
title: Upgrade Advisor referencia de la interfaz de usuario | Documentos de Microsoft
ms.custom: ''
ms.date: 06/13/2017
...
|[Confirmar configuración del Asesor de actualizaciones](../../../2014/sql-server/install/confirm-upgrade-advisor-settings.md)|Revise las opciones y los parámetros antes de ejecutar el análisis de la actualización.|  
