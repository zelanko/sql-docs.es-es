...
|Longitud de una cadena que contiene instrucciones SQL (tamaño de lote)<br /><br /> Nota: Network Packet Size es el tamaño de los paquetes de flujo TDS TDS utilizados para la comunicación entre aplicaciones y relacionales [!INCLUDE[ssDE](../includes/ssde-md.md)]. El tamaño del paquete predeterminado es 4 KB y se controla mediante la opción de configuración Tamaño de paquete de red.|65.536 * Tamaño de paquete de red|65.536 * Tamaño de paquete de red|  
