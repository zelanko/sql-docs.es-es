...
|[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)][!INCLUDE[ssDE](../includes/ssde-md.md)] objeto de|Tamaños y números [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] máximos (32 bits)|Tamaños o cifras máximas [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] (64 bits)|  
|---------------------------------------------------------|------------------------------------------------------------------|------------------------------------------------------------------|  
|Tamaño de lote<br /><br /> Nota: el tamaño del paquete de red es el tamaño de los paquetes de flujo TDS usados para la comunicación entre las aplicaciones y el [!INCLUDE[ssDE](../includes/ssde-md.md)]relacional. El tamaño del paquete predeterminado es 4 KB y se controla mediante la opción de configuración Tamaño de paquete de red.|65.536 * Tamaño de paquete de red|65.536 * Tamaño de paquete de red|  
|Bytes por columna de cadenas cortas|8,000|8,000|  
|Bytes por GROUP BY y ORDER BY|8,060|8,060|  
|Bytes por clave de índice<br /><br /> Nota: el número máximo de bytes de cualquier clave de índice no puede superar [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]900 en. Puede definir una clave utilizando columnas de longitud variable cuyos tamaños máximos sumen hasta más de 900, siempre que ninguna fila se haya insertado con más de 900 bytes de datos en dichas columnas. En [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)], puede incluir columnas sin clave en un índice no clúster para evitar el tamaño máximo de clave de índice de 900 bytes.|900|900|  
...
|Columnas por clave de índice<br /><br /> Nota: Si la tabla contiene uno o más índices XML, la clave de agrupación en clústeres de la tabla de usuario está limitada a 15 columnas, ya que la columna XML se agrega a la clave de agrupación en clústeres del índice XML principal. En [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)], puede incluir columnas sin clave en un índice no clúster para evitar la limitación de un máximo de 16 columnas de clave. Para obtener más información, vea [crear índices con columnas incluidas](../relational-databases/indexes/create-indexes-with-included-columns.md).|16|16|  
...
|Grupos de archivo por base de datos para datos optimizados para memoria.|Incompatible|1|  
...
|Archivos de datos para datos optimizados para memoria por base de datos|Incompatible|4.096|  
|Archivo delta por archivo de datos para datos optimizados para memoria|Incompatible|1|  
...
|Instancias por equipo|50 instancias en un servidor independiente para todas las ediciones de [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)].<br /><br /> [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]admite 25 instancias en un clúster de conmutación por error cuando se usa un disco de clúster compartido como opción de [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] almacenamiento para la instalación de clústeres admite 50 instancias en un clúster de conmutación por error si elige recursos compartidos de archivos SMB como opción de almacenamiento para la instalación del clúster. para obtener más información, consulte [requisitos de hardware y Software para instalar SQL Server 2014](install/hardware-and-software-requirements-for-installing-sql-server.md).|50 instancias en un servidor independiente.<br /><br /> 25 instancias en un clúster de conmutación por error cuando se usa un disco de clúster compartido como opción de almacenamiento para la instalación del clúster; [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] admite 50 instancias en un clúster de conmutación por error si elige recursos compartidos de archivos SMB como opción de almacenamiento para la instalación del clúster.|  
|Índices por tabla optimizada para memoria|Incompatible|8|  
...
|Particiones por tabla o índice con particiones|1,000<br /><br /> ** \* Importante \* \* ** Es posible crear una tabla o un índice con más de 1.000 particiones en un sistema de 32 bits, pero no se admite.|15,000|  
...
##  <a name="ssnoversion-utility-objects"></a> Objetos de utilidad de <a name="Utility"></a> [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]  
...
|[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Objeto de utilidad|Tamaños y números [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] máximos (32 bits)|Tamaños o cifras máximas [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] (64 bits)|  
|----------------------------------------------|------------------------------------------------------------------|------------------------------------------------------------------|  
...
|[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] Objeto DAC|Tamaños y números [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] máximos (32 bits)|Tamaños o cifras máximas [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] (64 bits)|  
|------------------------------------------|------------------------------------------------------------------|------------------------------------------------------------------|  
