...
# <a name="maximum-capacity-specifications-for-sql-server"></a>Especificaciones de capacidad máxima para SQL Server
 ...
 [SQL Server Motor de base de datos objetos](#Engine)  
  
 [Objetos Utilidad de SQL Server](#Utility)  
  
 [SQL Server objetos de aplicación de capa de datos](#DAC)  
  
 [Objetos Replicación de SQL Server](#Replication)  
  
##  <a name="Engine"></a>[!INCLUDE[ssDE](../includes/ssde-md.md)] Objetos de  
...
|Particiones por tabla o índice con particiones|1000<br /><br /> ** \* Importante \* \* ** Es posible crear una tabla o un índice con más de 1.000 particiones en un sistema de 32 bits, pero no se admite.|15 000|  
...
|Número total de bases de datos de usuario por cada utilidad de [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]|1000|1000|  
...
|[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]Objeto Replication|Tamaño y cantidad máxima de SQL Server (32 bits)|Tamaño y número máximo SQL Server (64 bits)|  
|--------------------------------------------------|---------------------------------------------------|---------------------------------------------------|  
...
|Columnas de una tabla**(publicación de instantáneas o transaccional de[!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] )|1000|1000|  
