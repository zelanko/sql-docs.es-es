...
|Grupos de archivo por base de datos para datos optimizados para memoria.|No compatibles|1|  
...
|Archivos de datos para datos optimizados para memoria por base de datos|No compatibles|4.096|  
|Archivo delta por archivo de datos para datos optimizados para memoria|No compatibles|1|  
...
|Índices por tabla optimizada para memoria|No compatibles|8|  
