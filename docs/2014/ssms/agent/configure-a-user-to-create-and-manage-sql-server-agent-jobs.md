...
4.  En el **asignación de usuario** página de la **propiedades de inicio de sesión** cuadro de diálogo, seleccione la fila que contiene `msdb`.  
