...
ms.locfileid: "62653885"
---
# <a name="modify-a-sql-server-agent-master-job"></a>Modificar un trabajo maestro del Agente SQL Server
  En los temas siguientes se describe cómo modificar [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] un trabajo maestro del agente.  
 ...
 [Modificar el servidor de destino&#40;s&#41; asociados a un trabajo maestro de Agente SQL Server](modify-the-target-server-s-associated-with-a-sql-server-agent-master-job.md)  
