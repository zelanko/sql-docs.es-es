---
title: Establecer la conexión de SQL Server para el servicio del Agente SQL Server (SQL Server Management Studio) | Documentos de Microsoft
ms.custom: ''
ms.date: 03/06/2017
