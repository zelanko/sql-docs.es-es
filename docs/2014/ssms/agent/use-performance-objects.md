...
|-------------------|-----------------|  
|Valor predeterminado|**SQLAgent:** *Object*:*Counter*|  
...
|[SQLAgent: alertas](../../relational-databases/performance-monitor/sql-server-agent-alerts-object.md)|Información acerca del número de alertas y notificaciones|  
