---
title: 'Lección 2: Escribir Transact-SQL | Microsoft Docs'
ms.custom: ''
ms.date: 06/13/2017
...
> [!NOTE]  
>  Esta lección se centra en las características de la herramienta. Para ver un tutorial sobre cómo escribir [!INCLUDE[tsql](../../includes/tsql-md.md)] instrucciones, consulte [Tutorial: Escribir instrucciones Transact-SQL](../../t-sql/tutorial-writing-transact-sql-statements.md).  
