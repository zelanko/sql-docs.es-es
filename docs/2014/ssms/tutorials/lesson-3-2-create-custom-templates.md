...
11. Edite el script de la plantilla (el script del paso 7) y reemplace el nombre del producto hoja por `nvarchar(50)`el parámetro <strong> *<* PRODUCT_NAME</strong>,, <strong>nombre*>*</strong>, en cuatro lugares.  
