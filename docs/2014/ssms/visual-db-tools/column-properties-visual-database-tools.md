...
> [!NOTE]  
>  La longitud de un tipo de datos `varchar(max)` varía en cada fila. sp_help devuelve (-1) como longitud de `varchar(max)` la columna. [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] muestra -1 como tamaño de columna.  
