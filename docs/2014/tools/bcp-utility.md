 ...
 **-v**  
 Notifica el número de versión de la utilidad **BCP** y el copyright.  
 ...
 **100** =  100[!INCLUDE[ssKatmai](../includes/sskatmai-md.md)] y[!INCLUDE[ssKilimanjaro](../includes/sskilimanjaro-md.md)]  
