...
|[dtutil Utility](../integration-services/dtutil-utility.md)|Se usa para administrar paquetes SSIS.|[!INCLUDE[ssInstallPathVar](../includes/ssinstallpathvar-md.md)]DTS\Binn|  
...
|[sqlmaint (utilidad)](sqlmaint-utility.md)|Se usa para ejecutar los planes de mantenimiento de bases de datos creados en versiones anteriores de [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)].|\<unidad >: \Archivos de Programa\microsoft SQL Server\MSSQL12. MSSQLSERVER\MSSQL\Binn|  
...
|[sqlservr (aplicación)](sqlservr-application.md)|Se usa para iniciar y detener una instancia de [!INCLUDE[ssDE](../includes/ssde-md.md)] desde el símbolo del sistema para solucionar problemas.|\<unidad >: \Archivos de Programa\microsoft SQL Server\MSSQL12. MSSQLSERVER\MSSQL\Binn|  
