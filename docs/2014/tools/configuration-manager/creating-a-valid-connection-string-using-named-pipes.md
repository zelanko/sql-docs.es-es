...
> [!NOTE]  
>  Para especificar el protocolo de red como un **sqlcmd** parámetro, vea "Cómo: conectarse a la base de datos motor mediante sqlcmd.exe" en [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] libros en pantalla.  
