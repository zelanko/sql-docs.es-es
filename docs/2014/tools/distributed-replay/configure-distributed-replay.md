...
-   [Archivo de configuración de cliente](#DReplayClient)  
  
-   [Archivo de configuración de preprocesamiento](#PreprocessConfig)  
 ...
 **\<Ruta de instalación del controlador> \DReplayController.config**  
 ...
 **\<Ruta de instalación de cliente> \DReplayClient.config**  
...
##  <a name="PreprocessConfig"></a>Archivo de configuración de preprocesamiento: DReplay. exe. preprocess. config  
 ...
 **\<Ruta de instalación de la herramienta de administración> \DReplayAdmin\DReplay.exe.preprocess.config**  
...
|Tiempo de inactividad máximo|`<MaxIdleTime>`|Limita el tiempo de inactividad a un número absoluto (en segundos).|Un entero que es >=-1<br /><br /> 
  `-1` indica que no ha habido ningún cambio respecto del valor original en el archivo de seguimiento original.<br /><br /> 
  `0` indica que existe alguna actividad en algún momento.|No. De forma predeterminada, el valor es `-1`.|  
 ...
 **\<Ruta de instalación de la herramienta de administración> \DReplayAdmin\DReplay.exe.replay.config**  
