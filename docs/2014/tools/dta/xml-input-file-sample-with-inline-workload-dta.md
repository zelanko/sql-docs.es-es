...
## <a name="comments"></a>Comentarios  
 `USE database_name`las instrucciones se pueden especificar en la carga de trabajo insertada incluida en el elemento **EventString** .  
