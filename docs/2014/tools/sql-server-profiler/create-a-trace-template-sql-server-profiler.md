...
## <a name="see-also"></a>Vea también  
 [Especificar eventos y columnas de datos para un archivo de seguimiento &#40;analizador de SQL Server&#41;](specify-events-and-data-columns-for-a-trace-file-sql-server-profiler.md)   
