...
||||  
|-|-|-|  
|**Carga de trabajo característica \**|**Motor relacional**|**Analysis Services**|  
...
|**Reproducir seguimiento**|Distributed Replay|SQL Server Profiler|  
...
## <a name="benefits-of-sql-server-profiler"></a>Ventajas de SQL Server Profiler  
 El [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] de Microsoft es una interfaz gráfica de usuario de Seguimiento de SQL que se usa para supervisar una instancia de [!INCLUDE[ssDE](../../includes/ssde-md.md)] o de Analysis Services. Puede capturar y guardar datos acerca de cada evento en un archivo o en una tabla para analizarlos posteriormente. Por ejemplo, puede supervisar un entorno de producción para ver qué procedimientos almacenados afectan negativamente al rendimiento al ejecutarse demasiado lentamente. 
  [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] se usa para actividades como las siguientes:  
...
|Describe cómo ver la información de filtro.|[Ver información de filtro &#40;SQL Server Profiler&#41;](view-filter-information-sql-server-profiler.md)|  
...
|Describe cómo filtrar eventos basándose en la hora de inicio del evento.|[Filtre los eventos basándose en la hora de inicio del evento &#40;SQL Server Profiler&#41;](filter-events-based-on-the-event-start-time-sql-server-profiler.md)|  
...
|Describe cómo filtrar los identificadores de proceso de servidor (SPID) en un seguimiento.|[Filtrar los identificadores de proceso de servidor &#40;SPID&#41; en un &#40;de seguimiento SQL Server Profiler&#41;](filter-server-process-ids-spids-in-a-trace-sql-server-profiler.md)|  
...
|Describe cómo establecer valores predeterminados de definición de seguimiento.|[Establecer los valores predeterminados de definición de seguimiento &#40;SQL Server Profiler&#41;](set-trace-definition-defaults-sql-server-profiler.md)|  
...
|Describe cómo reproducir un solo evento cada vez.|[Reproducir un solo evento a la vez &#40;SQL Server Profiler&#41;](replay-a-single-event-at-a-time-sql-server-profiler.md)|  
...
|Describe cómo buscar un valor o una columna de datos durante una traza.|[Buscar un valor o una columna de datos durante el seguimiento de &#40;SQL Server Profiler&#41;](find-a-value-or-data-column-while-tracing-sql-server-profiler.md)|  
...
|Describe cómo crear un script Transact-SQL para ejecutar un seguimiento.|[Crear un script Transact-SQL para ejecutar un seguimiento &#40;SQL Server Profiler&#41;](create-a-transact-sql-script-for-running-a-trace-sql-server-profiler.md)|  
...
|Describe cómo extraer un script de un seguimiento.|[Extraer un script de un SQL Server Profiler de &#40;de seguimiento&#41;](extract-a-script-from-a-trace-sql-server-profiler.md)|  
|Describe cómo establecer correlaciones de un seguimiento con datos del registro de rendimiento de Windows.|[Correlacionar un seguimiento con los datos del registro de rendimiento de Windows &#40;SQL Server Profiler&#41;](../../database-engine/correlate-a-trace-with-windows-performance-log-data-sql-server-profiler.md)|  
|Describe cómo organizar las columnas mostradas en un seguimiento.|[Organizar las columnas mostradas en un SQL Server Profiler de seguimiento &#40;&#41;](organize-columns-displayed-in-a-trace-sql-server-profiler.md)|  
