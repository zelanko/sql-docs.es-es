...
> [!IMPORTANT]  
>  [!INCLUDE[ssNoteDepFutureAvoid](../includes/ssnotedepfutureavoid-md.md)] En su lugar, use el módulo `sqlps` de PowerShell. Para obtener más información sobre el módulo de `sqlps`, consulte [importar el módulo SQLPS](../database-engine/import-the-sqlps-module.md).  
 ...
 **-OutPutFormat** { **Text** | **XML** }  
 Especifica que se dé formato a la salida de la utilidad de `sqlps` como cadenas de texto (**Text**) o en un formato CLIXML serializado (**XML**).  
