...
7.  En el cuadro de diálogo **crear consulta con** nombre **Name**, en nombre `AllRegions`, escriba y para **Descripción**, escriba **suma y promedio de ventas para todos los modelos y regiones**.  
