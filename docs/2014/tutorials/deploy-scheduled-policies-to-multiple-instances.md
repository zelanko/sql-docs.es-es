---
title: Implementar directivas programadas en varias instancias | Documentos de Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
-   Los servidores donde desea implementar las directivas programadas deben registrarse en servidores registrados en la vista la **grupos de servidores locales** o **servidores de Administración Central** nodo. Para obtener más información, consulte los temas siguientes:  
...
1.  En el servidor donde configuró las directivas programadas en la tarea anterior, expanda **administración**, expanda **administración de directivas de**y, a continuación, haga clic en **directivas**.  
  
2.  En el menú **Ver** , haga clic en **Detalles del Explorador de objetos**.  
  
3.  En el **detalles del explorador de objetos** panel, seleccione todas las prácticas recomendadas programadas directivas que va a implementar en otros servidores mediante servidores registrados.  
...
5.  Si ha seleccionado varias directivas para exportar, en la **Buscar carpeta** cuadro de diálogo, seleccione una carpeta de destino o cree una nueva carpeta. En esta lección, cree una nueva carpeta con la ruta de acceso **C:\Scheduled_BP_Policies**y, a continuación, haga clic en **Aceptar**.  
  
     Si ha seleccionado solamente una directiva para exportar, en la **Exportar directiva** diálogo cuadro, cree una nueva carpeta con la ruta de acceso **C:\Scheduled_BP_Policies**, haga clic en **abiertos**y, a continuación, haga clic en **Guardar**.  
...
2.  Expanda **motor de base de datos**, expanda **grupos de servidores locales** o **servidores de Administración Central**, haga clic en el nodo que desea implementar las directivas y, a continuación, Haga clic en **importar directivas**.  
...
5.  Seleccione las directivas que desea importar a las instancias de destino y, a continuación, haga clic en **abiertos**.  
  
6.  En el **importación** cuadro de diálogo, en la **estado de la directiva** , seleccione el estado de directiva que desee. Puede elegir entre conservar el estado de directiva, habilitar, o deshabilitar las directivas al importar. Tenga en cuenta que las directivas deben estar habilitadas para ejecutarse según una programación.  
  
7.  Haga clic en **Aceptar** para importar las directivas a todas las instancias de destino.  
  
    > [!NOTE]  
    >  Si hay algún error, el **importación** cuadro de diálogo no desaparece. Haga clic en el **registro** página para revisar los mensajes. Haga clic en **cancelar** para cerrar el cuadro de diálogo.  
