---
title: Explorar el modelo de árbol de decisión (Tutorial de minería de datos básicos) | Documentos de Microsoft
ms.custom: ''
ms.date: 04/27/2017
...
1.  Haga clic en un nodo y seleccione **obtener detalles** , a continuación, **solo columnas de modelos**.  
...
2.  Haga clic en un nodo y seleccione **obtener detalles** , a continuación, **columnas de modelo y estructura**.  
...
###  <a name="Dependency_Network_Tab"></a> Pestaña red de dependencias  
 El **red de dependencias** pestaña muestra las relaciones entre los atributos que contribuyen a la capacidad de predicción del modelo de minería de datos. El visor Red de dependencias reafirma nuestra conclusión de que la edad y la región son factores importantes para predecir la compra de bicicletas.  
...
2.  Ajustar la **todos los vínculos** control deslizante para identificar el atributo más influyente.  
  
     Arrastrar hacia abajo el control deslizante, se quitan atributos que tienen sólo un efecto débil en la columna [Bike Buyer] en el gráfico. Ajustando el control deslizante, descubrirá que la edad y la región son los factores más importantes para predecir si alguien va a comprar una bicicleta.  
