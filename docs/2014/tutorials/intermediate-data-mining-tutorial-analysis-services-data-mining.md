...
-   Análisis de la cesta de la **compra:** Creará un *modelo de asociación*para analizar las agrupaciones de productos que se adquieren durante las [!INCLUDE[ssSampleDBCoFull](../includes/sssampledbcofull-md.md)] visitas al sitio de comercio electrónico. En función de este modelo de cesta de la compra, puede recomendar productos a los clientes.  
