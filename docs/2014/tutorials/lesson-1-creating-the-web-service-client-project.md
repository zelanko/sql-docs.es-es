...
6.  [!INCLUDE[clickOK](../includes/clickok-md.md)]En Explorador de soluciones se muestra una vista contraída del proyecto.  
     ...
     Expanda el nodo del proyecto en el Explorador de soluciones. Se ha agregado al proyecto un archivo con el nombre predeterminado Program.CS ( [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[vbprvb](../includes/vbprvb-md.md)]Module1. VB para).  
