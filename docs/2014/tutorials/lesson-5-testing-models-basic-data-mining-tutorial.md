...
# <a name="lesson-5-testing-models-basic-data-mining-tutorial"></a>Lección 5: Probar los modelos (Tutorial básico de minería de datos)
 ...
 Dado que los datos del conjunto de pruebas ya contienen valores conocidos para la compra de bicicletas, es fácil determinar si las predicciones del modelo son correctas. El Departamento de [!INCLUDE[ssSampleDBCoFull](../includes/sssampledbcofull-md.md)] marketing usará el modelo que mejor se adapte a los clientes de su campaña de distribución de correo directo.  
