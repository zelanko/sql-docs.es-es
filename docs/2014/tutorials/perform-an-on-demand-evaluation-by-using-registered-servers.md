---
title: Realizar una evaluación a petición mediante el uso de servidores registrados | Documentos de Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
2.  Expanda **motor de base de datos**y, a continuación, expanda **grupos de servidores locales**, o **servidores de Administración Central**, según su configuración.  
...
6.  Haga clic en **Evaluate** se evalúan las directivas.  
  
7.  En el caso de algunos errores de las directivas, la administración basada en directivas le permite aplicar inmediatamente el cumplimiento de las directivas en el destino. Con tales errores, una casilla aparecerá al lado de la directiva que ha generado el error. Si selecciona la casilla de verificación, o haga clic en la fila con la directiva del error, casillas de verificación aparecen en la **detalles del destino** panel junto a las instancias de destino que no se pudo la evaluación. Si se selecciona cualquiera de las casillas de verificación, el **aplicar** botón esté disponible. Al hacer clic en **aplicar**, la configuración incompatible se actualizará automáticamente en las instancias de destino que ha seleccionado.  
