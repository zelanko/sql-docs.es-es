---
title: 'Tarea 4 (opcional): combinar, búsqueda de coincidencias y publicar un nuevo conjunto de datos | Documentos de Microsoft'
ms.custom: ''
ms.date: 03/06/2017
...
1.  Inicie una nueva instancia de **Excel**. Haga clic en **iniciar**, seleccione **ejecutar**, tipo **Excel**y haga clic en **Aceptar**.  
  
2.  Cambie a la **datos maestros** ficha haciendo clic en **datos maestros** en la barra de menús.  
  
3.  Haga clic en **conectar** en la cinta de opciones en la **conectar y cargar** grupo para conectarse a la **servidor MDS**. Ha configurado esta conexión anteriormente en esta lección.  
...
4.  Debería ver el **Explorador de datos maestros** panel situado a la derecha. Si no ve el Explorador de datos maestros, haga clic en **Mostrar explorador** botón en la cinta de opciones.  
...
7.  Haga clic en **Hoja2** en la parte inferior para cambiar a la **Hoja2** ficha. Si no ve **Hoja2**, agregar una nueva hoja de cálculo.  
...
9. Vuelva a la **proveedor** hoja en el **libro 1 – Microsoft Excel** (no el **Cleansed and Matched Supplier List** Excel) que esté conectado a **MDS**.  
...
13. Ahora debe ver el cuadro de diálogo reducido. Ahora, haga clic en **Hoja2** para cambiar a la **Hoja2** ficha que tiene los nuevos datos de proveedor con 4 filas (incluida una fila de encabezado).  
...
16. Haga clic en el **botón** junto a la **cuadro de texto**. Ahora debe ver que el cuadro de diálogo se ha expandido. Debería ver todas las asignaciones entre las columnas de la **proveedor** MDS **entidad** a **Excel** columnas se rellenan automáticamente.  
...
17. Asegúrese de que **código** entidad como la columna se asigna a la **SupplierID** columna en la hoja de cálculo y **código postal** entidad como la columna se asigna a la **código postal** columna en la hoja de cálculo.  
...
21. En el **datos de coincidencia** cuadro de diálogo, seleccione **proveedores** para **DQS Knowledge Base**.  
  
     ![Excel - cuadro de diálogo de datos de coincidencia](../../2014/tutorials/media/et-combinematchandpublishnewsod-07.jpg "Excel - cuadro de diálogo de datos de coincidencia")  
...
23. Seleccione **requisitos previos** para el **código** asignación de columna.  
...
27. Seleccione el **fila duplicada (naranja)**, menú contextual y haga clic en **eliminar** para eliminar la fila.  
...
33. **Ordenar** la lista por **código** y buscar los registros con **S57** y **S66** como códigos. También puede usar el **filtro** botón en la barra de herramientas para buscar un registro específico en la lista.  
