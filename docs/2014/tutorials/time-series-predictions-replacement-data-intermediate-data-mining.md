---
title: Predicciones de serie utilizando los datos de reemplazo (Tutorial intermedio de datos minería) temporal | Documentos de Microsoft
ms.custom: ''
ms.date: 04/27/2017
...
## <a name="performing-cross-prediction-with-a-time-series-model"></a>Realizar una predicción cruzada con un modelo de serie temporal  
 ...
 En SQL Server Data Mining, realizar una predicción cruzada mediante el parámetro REPLACE_MODEL_CASES en los argumentos a la función [PredictTimeSeries &#40;DMX&#41;](/sql/dmx/predicttimeseries-dmx).  
...
2.  En el Asistente para minería de datos, realice las selecciones siguientes:  
    ...
    -   Use el origen de datos que creó anteriormente en esta lección avanzada como origen para el modelo. Vea [avanzada predicciones de serie temporal &#40;intermedio de Tutorial de minería de datos&#41;](../../2014/tutorials/advanced-time-series-predictions-intermediate-data-mining-tutorial.md).  
  
         Vista del origen de datos: `AllRegions`  
  
    -   Elija las columnas siguientes para la clave de serie y la clave temporal:  
  
         Tiempo de clave: ReportingDate  
...
5.  Haga clic en la línea de combinación entre el modelo de minería de datos y los datos de entrada y seleccione **modificar conexiones**. Asigne los datos de la vista del origen de datos al modelo de la manera siguiente:  
    ...
    1.  Compruebe que la columna ReportingDate en el modelo de minería de datos se asigna a la columna ReportingDate en los datos de entrada.  
  
    2.  En el **modificar asignación** cuadro de diálogo, en la fila de la columna del modelo correspondiente a AvgQty, haga clic en **columna de la tabla** y, a continuación, seleccione T1000 Pacific.Quantity. Haga clic en **Aceptar**.  
    ...
    3.  No se asignan la columna región en el modelo a ninguna columna de entrada.  
...
6.  Ahora creará la consulta de predicción.  
    ...
    1.  En la cuadrícula, haga clic en la primera fila vacía bajo **origen**y, a continuación, seleccione el modelo de minería de datos de AllRegions.  
...
8.  Ahora va a configurar la función de predicción cruzada.  
    ...
    5.  En el **criterios o argumento** columna, después del nombre de campo, escriba el texto siguiente: `,5, REPLACE_MODEL_CASES`  
         ...
         El texto completo de la **criterios o argumento** cuadro de texto debe ser como sigue: `[AllRegions].[AvgQty],5,REPLACE_MODEL_CASES`  
