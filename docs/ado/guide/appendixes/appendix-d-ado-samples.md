...
## <a name="see-also"></a>Consulte también
 Referencia de la [API de ADO](../../../ado/reference/ado-api/ado-api-reference.md) de [Microsoft objetos de datos ActiveX (ADO)](../../../ado/microsoft-activex-data-objects-ado.md) ADO: ejemplos de [código ADO](../../../ado/reference/ado-api/ado-code-examples.md) [en Visual Basic ejemplos de](../../../ado/reference/ado-api/ado-code-examples-in-visual-basic.md) [código ADO](../../../ado/reference/ado-api/ado-code-examples-vbscript.md) ejemplos de código ADO [en Visual C++](../../../ado/reference/ado-api/ado-code-examples-in-visual-c.md) [Apéndice A: proveedores](../../../ado/guide/appendixes/appendix-a-providers.md) [configurar](../../../ado/guide/remote-data-service/configuring-rds.md) el [Apéndice C de RDS: programar con](../../../ado/guide/appendixes/appendix-c-programming-with-ado.md) el [historial ADO ADO](../../../ado/guide/ado-history.md)
