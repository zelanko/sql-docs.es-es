---
title: Usar ADO con Microsoft Visual C++ | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "67926532"
---
# <a name="using-ado-with-microsoft-visual-c"></a>Usar ADO con Microsoft Visual C++
Para obtener información sobre el uso de ADO con Visual C++, vea las siguientes secciones:  
  
-   [Programación ADO en Visual C++](../../../ado/guide/appendixes/visual-c-ado-programming.md)  
  
-   [Extensiones de Visual C++ para ADO](../../../ado/guide/appendixes/visual-c-extensions-for-ado.md)  
...
## <a name="see-also"></a>Consulte también  
 ...
 [ADO para Visual C++ Índice de sintaxis para COM](../../../ado/reference/ado-api/ado-for-visual-c-syntax-index-for-com.md)   
