...
## <a name="other-events"></a>Otros eventos  
 Otros controladores de eventos: es decir, los eventos cuyos nombres no tienen el formato **le * Event*** o ***eventos * completar** -se invocan después de que se completa una operación. Estos eventos son **desconexión**, **EndOfRecordset**, y **InfoMessage**.  
