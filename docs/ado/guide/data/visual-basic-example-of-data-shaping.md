---
title: Ejemplo de Visual Basic de forma de datos | Documentos de Microsoft
ms.prod: sql
...
1.  Crear un proyecto de aplicación EXE estándar de Visual Basic  
  
2.  Seleccione **componentes** desde el **proyecto** menú en Visual Studio  
  
3.  Seleccione "Microsoft jerárquica FlexGrid Control 6.0 (OLEDB)" en la **componentes** ventana emergente y, a continuación, haga clic en **guardar**.  
  
4.  Haga doble clic en el FlexGrid Control desde el panel de cuadro de herramientas en el área de trabajo de Visual Basic. Cambie el nombre de esta instancia a MSHFLEXGRID.  
  
5.  Copie el código anterior y péguelo en el **código** página para reemplazar todo el código existente.  
