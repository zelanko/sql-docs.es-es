---
title: Actualizar - ADO para documentos de SQL Server | Documentos de Microsoft
description: Mostrar fragmentos de contenido actualizado para recientemente modificadas en documentación, de ActiveX Data Objects (ADO) para Microsoft SQL Server.
manager: craigg
author: MightyPen
ms.author: genemi
ms.topic: article
...
ms.locfileid: "32435486"
---
# <a name="new-and-recently-updated-activex-data-objects-ado-for-sql-server"></a>Nuevos y actualizados recientemente: objetos de datos ActiveX (ADO) para SQL Server
...
- *Área de asunto:* &nbsp; **ActiveX Data Objects (ADO) para SQL Server**.
