---
description: Ejemplo del método AddNew (VC ++)
title: Ejemplo del método AddNew (VC + +) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "88451547"
---
# <a name="addnew-method-example-vc"></a>Ejemplo del método AddNew (VC ++)
