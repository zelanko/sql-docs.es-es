...
-   [Ejemplo de métodos Execute, Requery y Clear](../../../ado/reference/ado-api/execute-requery-and-clear-methods-example-vbscript.md)  
  
-   [Ejemplo del método move](../../../ado/reference/ado-api/move-method-example-vbscript.md)  
  
-   [Ejemplo de los métodos MoveFirst, MoveLast, MoveNext y MovePrevious](../../../ado/reference/ado-api/movefirst-movelast-movenext-and-moveprevious-methods-example-vbscript.md)  
  
-   [Ejemplo de métodos Open y Close](../../../ado/reference/ado-api/open-and-close-methods-example-vbscript.md)  
