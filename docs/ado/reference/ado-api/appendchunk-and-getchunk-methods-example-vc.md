---
title: Ejemplo AppendChunk y GetChunk métodos (VC ++) | Documentos de Microsoft
ms.prod: sql
...
---
# <a name="appendchunk-and-getchunk-methods-example-vc"></a>Ejemplo AppendChunk y GetChunk métodos (VC ++)
