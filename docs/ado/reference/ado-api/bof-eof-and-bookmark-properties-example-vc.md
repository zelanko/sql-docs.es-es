---
description: Ejemplo de las propiedades BOF, EOF y Bookmark (VC + +)
title: Ejemplo de las propiedades BOF, EOF y Bookmark (VC + +) | Microsoft Docs
ms.prod: sql
