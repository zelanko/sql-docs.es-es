---
description: Conexión (ADO para la sintaxis Visual C++)
title: Conexión (ADO para la sintaxis de Visual C++) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "88444537"
---
# <a name="connection-ado-for-visual-c-syntax"></a>Conexión (ADO para la sintaxis Visual C++)
