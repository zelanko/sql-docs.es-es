...
## <a name="remarks"></a>Comentarios  
 Use la **dirección** propiedad para especificar cómo se pasa un parámetro a o desde un procedimiento. El **dirección** propiedad es de lectura/escritura; Esto le permite trabajar con proveedores que no proporcionen esta información o para definir esta información cuando no desee que ADO para realizar una llamada adicional al proveedor para recuperar información de parámetros.  
  
 No todos los proveedores pueden determinar la dirección de los parámetros de los procedimientos almacenados. En estos casos, debe establecer el **dirección** propiedad antes de ejecutar la consulta.  
