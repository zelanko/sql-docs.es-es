---
title: "Error (Visual C++ índice de sintaxis con #import) | Documentos de Microsoft"
...
---
# <a name="error-visual-c-syntax-index-with-import"></a>Error (Visual C++ índice de sintaxis con #import)
