---
title: Execute, Requery y Clear ejemplo de los métodos (VC ++) | Documentos de Microsoft
ms.prod: sql
...
ms.locfileid: "35278094"
---
# <a name="execute-requery-and-clear-methods-example-vc"></a>Execute, Requery y Clear ejemplo de los métodos (VC ++)
