...
## <a name="remarks"></a>Comentarios  
 ...
 Si desea restringir los campos que la **GetRows** devolución de llamada, puede pasar un nombre o número de campo único o una matriz de números y nombres de campo en el *campos* argumento.  
  
 Después de llamar a **GetRows**, el siguiente registro sin leer se convierte en el registro actual, o la [EOF](../../../ado/reference/ado-api/bof-eof-properties-ado.md) propiedad está establecida en **True** si no hay ningún registro más.  
