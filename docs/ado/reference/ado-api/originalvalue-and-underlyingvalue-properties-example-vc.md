---
description: Ejemplo de las propiedades OriginalValue y UnderlyingValue (VC + +)
title: Ejemplo de las propiedades OriginalValue y UnderlyingValue (VC + +) | Microsoft Docs
ms.prod: sql
