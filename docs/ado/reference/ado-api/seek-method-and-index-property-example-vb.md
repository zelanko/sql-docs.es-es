---
description: Ejemplo de la propiedad index y el método Seek (VB)
title: Ejemplo de la propiedad index y el método Seek (VB) | Microsoft Docs
ms.prod: sql
