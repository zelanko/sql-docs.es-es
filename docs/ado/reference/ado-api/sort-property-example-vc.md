---
title: Ordenar el ejemplo de la propiedad (VC ++) | Documentos de Microsoft
ms.prod: sql
...
ms.locfileid: "35281954"
---
# <a name="sort-property-example-vc"></a>Ejemplo de la propiedad de ordenación (VC ++)
