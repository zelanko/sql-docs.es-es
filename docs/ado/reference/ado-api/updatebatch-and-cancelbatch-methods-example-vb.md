---
description: Ejemplo de los métodos UpdateBatch y CancelBatch (VB)
title: Ejemplo de los métodos UpdateBatch y CancelBatch (VB) | Microsoft Docs
ms.prod: sql
