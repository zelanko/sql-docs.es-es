---
title: Ejemplo UpdateBatch y CancelBatch métodos (VC ++) | Documentos de Microsoft
ms.prod: sql
...
ms.locfileid: "35282864"
---
# <a name="updatebatch-and-cancelbatch-methods-example-vc"></a>Ejemplo UpdateBatch y CancelBatch métodos (VC ++)
