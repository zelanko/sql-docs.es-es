...
|[GetSchemaObject](../../../ado/reference/ado-md-api/getschemaobject-method-ado-md.md)|Recupera un objeto de esquema de ADO MD (dimensión, jerarquía, nivel o miembro) por un nombre único.|  
