...
|[Profundidad](../../../ado/reference/ado-md-api/depth-property-ado-md.md)|Indica el número de niveles entre el **nivel** y la raíz del nivel de la jerarquía.|  
...
|[FilterAxis](../../../ado/reference/ado-md-api/filteraxis-property-ado-md.md)|Indica la información de filtro del Cellset actual.|  
|[Elemento](../../../ado/reference/ado-md-api/item-property-ado-md-cellset.md)|Recupera una celda de un Cellset usando sus coordenadas.|  
|[Elemento](../../../ado/reference/ado-api/item-property-ado.md)|Devuelve un miembro específico de una colección por nombre o número ordinal.|  
...
|[LevelName](../../../ado/reference/ado-md-api/levelname-property-ado-md.md)|Indica el nombre del nivel de un miembro.|  
