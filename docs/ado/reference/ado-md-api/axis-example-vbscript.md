---
title: Ejemplo de Axis (VBScript) | Documentos de Microsoft
ms.prod: sql
...
ms.locfileid: "35283404"
---
# <a name="axis-example-vbscript"></a>Ejemplo de Axis (VBScript)
Esta página Active Server muestra los datos OLAP de una cadena de consulta MDX y escribe el conjunto de celdas resultante en una estructura de tabla HTML.  
