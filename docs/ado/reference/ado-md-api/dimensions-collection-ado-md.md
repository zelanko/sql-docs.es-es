---
title: Dimensiones de la colección (ADO MD) | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "66709455"
---
# <a name="dimensions-collection-ado-md"></a>Colección Dimensions (ADO MD)
Contiene el [dimensión](../../../ado/reference/ado-md-api/dimension-object-ado-md.md) objetos que componen un cubo.  
  
## <a name="remarks"></a>Comentarios  
 **Dimensiones** es una colección de ADO estándar. Con las propiedades y métodos de una colección, puede hacer lo siguiente:  
...
-   [Propiedades, métodos y eventos](../../../ado/reference/ado-md-api/dimensions-collection-properties-methods-and-events.md)  
