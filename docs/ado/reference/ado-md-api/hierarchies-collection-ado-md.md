---
title: "Colección Hierarchies (ADO MD) | Documentos de Microsoft"
...
Contiene el conjunto de [jerarquía](../../../ado/reference/ado-md-api/hierarchy-object-ado-md.md) objetos de una dimensión.  
  
## <a name="remarks"></a>Comentarios  
 **Jerarquías** es una colección de ADO estándar. Con las propiedades y métodos de una colección, puede hacer lo siguiente:  
...
-   [Propiedades, métodos y eventos](../../../ado/reference/ado-md-api/hierarchies-collection-properties-methods-and-events.md)  
