---
title: LevelName (propiedad, ADO MD) | Documentos de Microsoft
...
## <a name="remarks"></a>Comentarios  
 Use la **LevelName** propiedad que se va a recuperar el nombre del nivel al que pertenece un elemento. Esto corresponde a la [nombre](../../../ado/reference/ado-md-api/name-property-ado-md.md) propiedad de un [nivel](../../../ado/reference/ado-md-api/level-object-ado-md.md) objeto.  
