---
title: Tipo (propiedad, ADO MD) | Microsoft Docs
ms.prod: sql
...
## <a name="return-values"></a>Valores devueltos  
 Devuelve un [MemberTypeEnum](../../../ado/reference/ado-md-api/membertypeenum.md) de valor y es de solo lectura.  
