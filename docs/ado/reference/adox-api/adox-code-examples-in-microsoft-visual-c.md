...
-   [Las tablas y columnas anexar métodos, ejemplo de la propiedad de nombre (VC ++)](../../../ado/reference/adox-api/columns-and-tables-append-methods-name-property-example-vc.md)  
  
-   [Método de cierre de conexión, ejemplo de la propiedad de tipo de tabla (VC ++)](../../../ado/reference/adox-api/connection-close-method-table-type-property-example-vc.md)  
  
-   [Crear el ejemplo del método (VC ++)](../../../ado/reference/adox-api/create-method-example-vc.md)  
  
-   [Ejemplo GetObjectOwner y SetObjectOwner métodos (VC ++)](../../../ado/reference/adox-api/getobjectowner-and-setobjectowner-methods-example-vc.md)  
  
-   [Ejemplo GetPermissions y SetPermissions métodos (VC ++)](../../../ado/reference/adox-api/getpermissions-and-setpermissions-methods-example-vc.md)  
  
-   [Usuarios y grupos de anexar, ejemplo de los métodos ChangePassword (VC ++)](../../../ado/reference/adox-api/groups-and-users-append-changepassword-methods-example-vc.md)  
  
-   [Índices de ejemplo de método Append (VC ++)](../../../ado/reference/adox-api/indexes-append-method-example-vc.md)  
...
-   [Ejemplo de la propiedad de atributos (VC ++)](../../../ado/reference/adox-api/attributes-property-example-vc.md)  
  
-   [Ejemplo de la propiedad ActiveConnection de catálogo (VC ++)](../../../ado/reference/adox-api/catalog-activeconnection-property-example-vc.md)  
  
-   [Ejemplo de propiedad Clustered (VC ++)](../../../ado/reference/adox-api/clustered-property-example-vc.md)  
  
-   [Comando y ejemplo de las propiedades CommandText (VC ++)](../../../ado/reference/adox-api/command-and-commandtext-properties-example-vc.md)  
...
-   [Ejemplo DateCreated y DateModified propiedades (VC ++)](../../../ado/reference/adox-api/datecreated-and-datemodified-properties-example-vc.md)  
...
-   [NumericScale y ejemplo de las propiedades Precision (VC ++)](../../../ado/reference/adox-api/numericscale-and-precision-properties-of-the-column-object-example-vc.md)  
  
-   [Ejemplo de propiedad ParentCatalog (VC ++)](../../../ado/reference/adox-api/parentcatalog-property-example-vc.md)  
  
-   [PrimaryKey y ejemplo de propiedades únicas (VC ++)](../../../ado/reference/adox-api/primarykey-and-unique-properties-example-vc.md)  
...
-   [Colección de parámetros, ejemplo de la propiedad de comando (VC ++)](../../../ado/reference/adox-api/parameters-collection-command-property-example-vc.md)
