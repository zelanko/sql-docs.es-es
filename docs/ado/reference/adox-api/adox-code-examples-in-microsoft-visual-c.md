...
-   [Append de claves, método, tipo de clave, RelatedColumn, RelatedTable y UpdateRule ejemplo de propiedades (VC ++)](../../../ado/reference/adox-api/keys-append-method-key-type-relatedcolumn-relatedtable-example-vc.md)  
...
-   [Tipo de clave, RelatedColumn, RelatedTable, UpdateRule propiedades, claves de anexar el ejemplo del método (VC ++)](../../../ado/reference/adox-api/keys-append-method-key-type-relatedcolumn-relatedtable-example-vc.md)  
  
-   [Propiedad de nombre, columnas y tablas anexar métodos ejemplo (VC ++)](../../../ado/reference/adox-api/columns-and-tables-append-methods-name-property-example-vc.md)  
...
-   [Propiedad de tipo de tabla, la conexión a cerrar ejemplo del método (VC ++)](../../../ado/reference/adox-api/connection-close-method-table-type-property-example-vc.md)  
