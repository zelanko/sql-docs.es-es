...
-   [Ejemplo de las propiedades de método Append, tipo de clave, RelatedColumn, RelatedTable y UpdateRule (VC + +)](../../../ado/reference/adox-api/keys-append-method-key-type-relatedcolumn-relatedtable-example-vc.md)  
...
-   [Propiedad de comando, ejemplo de colección de parámetros (VC + +)](../../../ado/reference/adox-api/parameters-collection-command-property-example-vc.md)  
...
-   [Ejemplo de las propiedades type, RelatedColumn, RelatedTable, UpdateRule, Keys Append del método (VC + +)](../../../ado/reference/adox-api/keys-append-method-key-type-relatedcolumn-relatedtable-example-vc.md)  
  
-   [Ejemplo de la propiedad Name, Columns and tables Append Methods (VC + +)](../../../ado/reference/adox-api/columns-and-tables-append-methods-name-property-example-vc.md)  
...
-   [Propiedades de tipo de tabla, ejemplo de método de cierre de conexión (VC + +)](../../../ado/reference/adox-api/connection-close-method-table-type-property-example-vc.md)  
