...
|[Key](../../../ado/reference/adox-api/key-object-adox.md)|Representa un campo de clave externo, principal o único de una tabla de base de datos.|  
...
|[Vista](../../../ado/reference/adox-api/view-object-adox.md)|Representa un conjunto filtrado de registros o una tabla virtual.|  
 ...
 Cada objeto puede estar contenido en su colección correspondiente. Por ejemplo, un **tabla** objeto puede incluirse en un [tablas](../../../ado/reference/adox-api/tables-collection-adox.md) colección. Para obtener más información, consulte [colecciones ADOX](../../../ado/reference/adox-api/adox-collections.md) o un tema de la colección específica.  
