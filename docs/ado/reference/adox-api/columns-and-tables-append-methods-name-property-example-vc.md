---
title: Las tablas y columnas métodos Append, asigne el nombre de ejemplo de la propiedad (VC ++) | Documentos de Microsoft
ms.prod: sql
...
ms.locfileid: "35285314"
---
# <a name="columns-and-tables-append-methods-name-property-example-vc"></a>Las tablas y columnas anexar métodos, ejemplo de la propiedad de nombre (VC ++)
