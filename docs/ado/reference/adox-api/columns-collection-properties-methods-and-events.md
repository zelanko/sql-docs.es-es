---
title: Propiedades de la colección de columnas, métodos y eventos | Documentos de Microsoft
ms.prod: sql
...
## <a name="methods"></a>Métodos  
 [Append (método) (columnas)](../../../ado/reference/adox-api/append-method-adox-columns.md)  
