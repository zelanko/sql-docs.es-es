---
title: Índices de ejemplo de método Append (VC ++) | Documentos de Microsoft
ms.prod: sql
...
ms.locfileid: "35286074"
---
# <a name="indexes-append-method-example-vc"></a>Índices de ejemplo de método Append (VC ++)
