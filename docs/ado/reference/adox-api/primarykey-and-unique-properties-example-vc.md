---
title: Ejemplo de las propiedades únicas (VC ++) y PrimaryKey | Documentos de Microsoft
ms.prod: sql
...
ms.locfileid: "35286774"
---
# <a name="primarykey-and-unique-properties-example-vc"></a>PrimaryKey y ejemplo de propiedades únicas (VC ++)
