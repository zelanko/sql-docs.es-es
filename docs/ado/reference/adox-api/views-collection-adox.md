---
title: "Vistas de colección (ADOX) | Documentos de Microsoft"
...
Todos los contiene [vista](../../../ado/reference/adox-api/view-object-adox.md) objetos de un catálogo.  
  
## <a name="remarks"></a>Comentarios  
 El [anexado](../../../ado/reference/adox-api/append-method-adox-views.md) método para un **vistas** colección es única para ADOX. Puede hacer lo siguiente:  
  
-   Agregar una nueva vista a la colección con el **anexado** método.  
  
 Las propiedades y los métodos restantes son estándar para colecciones de ADO. Puede hacer lo siguiente:  
  
-   Obtener acceso a una vista de la colección con el [elemento](../../../ado/reference/ado-api/item-property-ado.md) propiedad.  
  
-   Devolver el número de vistas incluido en la colección con el [recuento](../../../ado/reference/ado-api/count-property-ado.md) propiedad.  
  
-   Quitar una vista de la colección con el [eliminar](../../../ado/reference/adox-api/delete-method-adox-collections.md) método.  
...
-   [Propiedades de la colección de vistas, métodos y eventos](../../../ado/reference/adox-api/views-collection-properties-methods-and-events.md)  
