---
title: "Reset (método) (RDS) | Documentos de Microsoft"
...
## <a name="remarks"></a>Comentarios  
 ...
 Si desea realizar más de un filtro en el conjunto de filas, puede utilizar la parte opcional *booleano* argumento con el **restablecer** método. En el ejemplo siguiente se muestra cómo hacerlo:  
