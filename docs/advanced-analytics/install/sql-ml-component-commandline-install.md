...
¿Necesita ayuda con la instalación o la actualización? Para obtener respuestas a preguntas comunes y problemas conocidos, consulte el siguiente artículo:
...
Pruebe estos informes personalizados para comprobar el estado de instalación de la instancia y corregir problemas habituales.
