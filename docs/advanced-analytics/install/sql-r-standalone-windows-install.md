...
En este artículo se describe cómo usar el programa de instalación de SQL Server 2016 para instalar la versión independiente de **R 2016 de SQL Server**. Si tiene una edición Enterprise o Software Assurance, instalar la R Server independiente en un servidor de producción es gratuito.
