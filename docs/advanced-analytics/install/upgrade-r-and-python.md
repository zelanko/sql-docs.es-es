...
Podría haber agregado otros paquetes de código abierto o de terceros a la biblioteca del paquete. Puesto que el enlace de reversión cambia la ubicación de la biblioteca de paquetes de forma predeterminada, debe volver a instalar los paquetes a la biblioteca que ahora usan R y Python. Para obtener más información, consulte [predeterminado paquetes](../package-management/default-packages.md), [instalar nuevos paquetes de R](../r/install-additional-r-packages-on-sql-server.md), y [instalar nuevos paquetes de Python](../python/install-additional-python-packages-on-sql-server.md).
