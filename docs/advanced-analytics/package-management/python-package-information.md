---
title: Obtener información de paquete de Python
...
ms.locfileid: "69641182"
---
# <a name="get-python-package-information"></a>Obtener información de paquete de Python
...
El `pip` módulo se instala de forma predeterminada y admite muchas operaciones para enumerar los paquetes instalados, además de los admitidos por Python estándar. Puede ejecutar `pip` desde un símbolo del sistema de Python, pero también puede llamar a algunas funciones de `sp_execute_external_script`PIP desde.
