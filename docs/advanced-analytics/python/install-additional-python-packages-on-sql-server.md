---
title: Instalar nuevos paquetes de Python en SQL Server Machine Learning | Microsoft Docs
...
> [!TIP]
> ¿Necesita ayuda para configurar las herramientas de Python? Consulte estos blogs:
> 
> [Introducción a servicios Web de Python mediante Machine Learning Server](https://blogs.msdn.microsoft.com/mlserver/2017/12/13/getting-started-with-python-web-services-using-machine-learning-server/)
> 
> [David Crook: Microsoft Cognitive Toolkit y el código de VS](https://dacrook.com/cntk-vs-code-awesome/)
...
Esta página contiene las descargas para varias plataformas y para varias versiones de Python: [configurar CNTK](https://docs.microsoft.com/cognitive-toolkit/Setup-CNTK-on-your-machine)
