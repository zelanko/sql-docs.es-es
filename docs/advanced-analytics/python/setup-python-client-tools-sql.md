---
title: Configurar las herramientas de cliente de Python para su uso con SQL Server | Documentos de Microsoft
ms.custom: ''
ms.date: 03/13/2018
...
---
# <a name="set-up-python-client-tools-for-use-with-sql-server"></a>Configurar Python herramientas de cliente para su uso con SQL Server 
