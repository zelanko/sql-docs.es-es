---
title: Introducción a revoscalepy paquete de Python en aprendizaje automático de SQL Server | Documentos de Microsoft
ms.prod: sql
...
ms.locfileid: "31203187"
---
# <a name="introducing-revoscalepy-in-sql-server-machine-learning"></a>Introducción a revoscalepy en el aprendizaje automático de SQL Server
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md-winonly](../../includes/appliesto-ss-xxxx-xxxx-xxx-md-winonly.md)]

**revoscalepy** es una nueva biblioteca de Python proporcionado por Microsoft para admitir la computación distribuida, de proceso remoto contextos y algoritmos de alto rendimiento para los desarrolladores de Python.
