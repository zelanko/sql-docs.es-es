---
title: "Crear modelos (An&#225;lisis detallado de ciencia de datos) | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
manager: "jhubbard"
---
# Crear modelos (An&#225;lisis detallado de ciencia de datos)
...
Ahora, creará un modelo de regresión logística que indica si un cliente determinado es un riesgo de fraude.  
  
Usará la función *rxLogit* (incluida en el paquete **RevoScaleR**), que admite el ajuste de modelos de regresión logística en contextos de cálculo remoto.  
...
## Paso siguiente  
[Puntuación de nuevos datos &#40;Análisis detallado de ciencia de datos&#41;](../../advanced-analytics/r-services/score-new-data-data-science-deep-dive.md)  
