---
title: "Step 2: Import Data to SQL Server using PowerShell (In-Database Advanced Analytics Tutorial) (Paso 2: Importar datos a SQL Server mediante PowerShell (Tutorial de an&#225;lisis avanzado de bases de datos)) | Microsoft Docs"
ms.custom: ""
ms.date: "08/05/2016"
...
---
# Step 2: Import Data to SQL Server using PowerShell (In-Database Advanced Analytics Tutorial) (Paso 2: Importar datos a SQL Server mediante PowerShell (Tutorial de an&#225;lisis avanzado de bases de datos))
...
## Ejecutar los scripts para crear objetos SQL  
Entre los archivos descargados, verá un script de PowerShell. Para preparar el entorno para el tutorial, deberá ejecutar este script.  
  
Las acciones realizadas por el script son las siguientes:  
...
1.  Abra un símbolo del sistema de PowerShell como administrador y ejecute el siguiente comando.  
    ...
    -   El nombre de usuario y la contraseña de una cuenta en la instancia. La cuenta que use debe tener la capacidad de crear bases de datos, crear tablas y procedimientos almacenados, y cargar datos en tablas.  
