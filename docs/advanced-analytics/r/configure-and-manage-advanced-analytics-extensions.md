---
title: Configuración avanzada de servicios de aprendizaje de máquina de SQL Server | Documentos de Microsoft
ms.prod: sql
...
ms.locfileid: "31203097"
---
# <a name="advanced-configuration-options-for-sql-server-machine-learning-services"></a>Opciones de configuración avanzada de servicios de aprendizaje de máquina de SQL Server
