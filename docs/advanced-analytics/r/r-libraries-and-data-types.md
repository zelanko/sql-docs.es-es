...
De las categorías de tipos de datos compatibles con el [sistema de tipos de SQL Server](https://msdn.microsoft.com/library/ms187752.aspx), es probable que los siguientes tipos planteen problemas al pasarlos a código de R:
