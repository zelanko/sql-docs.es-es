...
+ [Soft-NUMA automática: Simplemente ejecuta más rápido (Bob Ward)](https://blogs.msdn.microsoft.com/bobsql/2016/06/03/sql-2016-it-just-runs-faster-automatic-soft-numa/)

   Describe el historial, así como detalles de implementación, con el rendimiento en los servidores más recientes de varios núcleos.
