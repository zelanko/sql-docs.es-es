...
Para ver ejemplos de cómo compilar una consulta MDX o ejecutar una consulta MDX existente, vea [Cómo crear consultas MDX con R](../../advanced-analytics/r/how-to-create-mdx-queries-using-olapr.md).
