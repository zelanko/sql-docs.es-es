---
title: Utilizando el código de R generación de perfiles de funciones (aprendizaje automático de SQL Server) | Documentos de Microsoft
ms.prod: sql
...
ms.locfileid: "31202177"
---
# <a name="using-r-code-profiling-functions"></a>Mediante las funciones de generación de perfiles de código de R
