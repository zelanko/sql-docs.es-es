---
title: Configuración de cuenta del servicio de SQL Server Trusted Launchpad | Microsoft Docs
description: Cómo modificar la cuenta de servicio de SQL Server Trusted Launchpad usa para la ejecución de scripts externos en SQL Server.
ms.prod: sql
