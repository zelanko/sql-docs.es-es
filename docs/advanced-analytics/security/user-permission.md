...
Para obtener más información, vea la sección permisos de [Seguridad para el marco de extensibilidad](../../advanced-analytics/concepts/security.md#permissions).
