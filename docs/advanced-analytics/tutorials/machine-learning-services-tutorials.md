...
---
# <a name="sql-server-machine-learning-tutorials"></a>Tutoriales de aprendizaje automático de SQL Server

Este artículo proporciona una lista completa de los tutoriales, demostraciones y las aplicaciones de ejemplo que utilizan características de aprendizaje de máquina de SQL Server 2016 o 2017 de SQL Server. Empiece aquí para obtener información sobre cómo ejecutar R o Python de T-SQL, usar contextos de proceso remoto y local y optimizar el código R y Python para un entorno de producción de SQL.
...
+ [Soluciones](#bkmk_solutions) 
    ...
    Plantillas desde el equipo de ciencia de datos de Microsoft son personalizables, para que pueda empezar rápidamente con aprendizaje automático. Cada solución se adapta a una tarea específica o un problema de la industria; Además, la mayoría de las soluciones está diseñada para ejecutarse en SQL Server o en un entorno de nube, como el aprendizaje automático de Azure. Otra solución pueda ejecutarse en clústeres de Microsoft R Server o HDI Spark.
...
+ [Configurar SQL Server R Services](../r/set-up-sql-server-r-services-in-database.md)
+ [Configurar los servicios de Python de SQL Server](../python/setup-python-machine-learning-services.md)
...
3. Revise los permisos asociados a los inicios de sesión SQL y cuentas de usuario de Windows que se ejecutarán las secuencias de comandos de R o Python. Todos necesitan permiso para ejecutar scripts de R o Python y conectarse a la instancia. Según el ejemplo, también podría necesitar permisos para leer y escribir datos y para crear objetos de base de datos.
