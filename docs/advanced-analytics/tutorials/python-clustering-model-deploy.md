---
title: 'Tutorial: Implementación de un modelo en Python para clasificar a los clientes'
...
ms.locfileid: "70294380"
---
# <a name="tutorial-deploy-a-model-in-python-to-categorize-customers-with-sql-server-machine-learning-services"></a>Tutorial: Implementación de un modelo en Python para clasificar los clientes con SQL Server Machine Learning Services
...
En la tercera [parte](python-clustering-model-build.md), aprendió a crear y entrenar un modelo de agrupación en clústeres K-means en Python.

## <a name="prerequisites"></a>Requisitos previos

* En la cuarta parte de esta serie de tutoriales se supone que ha cumplido los requisitos previos de la [**parte uno**](python-clustering-model.md)y que ha completado los pasos de la [**segunda parte**](python-clustering-model-prepare-data.md) y la tercera [**parte**](python-clustering-model-build.md).
...
Supongamos que desea enviar un correo electrónico promocional a los clientes del clúster 0, el grupo que estaba inactivo (puede ver cómo se describen los cuatro clústeres en la tercera [parte](python-clustering-model-build.md#analyze-the-results) de este tutorial). El código siguiente selecciona las direcciones de correo electrónico de los clientes en el clúster 0.
