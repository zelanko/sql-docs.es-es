---
title: 'Tutorial: Preparar los datos para clasificar a los clientes en Python'
...
ms.locfileid: "70294350"
---
# <a name="tutorial-prepare-data-to-categorize-customers-in-python-with-sql-server-machine-learning-services"></a>Tutorial: Preparar los datos para categorizar a los clientes en Python con SQL Server Machine Learning Services

[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]

En la segunda parte de esta serie de tutoriales de cuatro partes, podrá restaurar y preparar los datos de SQL Database mediante python. Más adelante en esta serie, usará estos datos para entrenar e implementar un modelo de agrupación en clústeres en Python con SQL Server Machine Learning Services.
...
* En la segunda parte de este tutorial se supone que ha cumplido los requisitos previos de la [**parte uno**](python-clustering-model.md).
...
> [Tutorial: Creación de un modelo predictivo en Python con SQL Server Machine Learning Services](python-clustering-model-build.md)
