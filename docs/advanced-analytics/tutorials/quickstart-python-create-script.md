...
|CON CONJUNTOS DE RESULTADOS | la cláusula define el esquema de la tabla de datos devuelta para SQL Server, en este caso, se agrega "Hola mundo" como nombre de columna e **int** para el tipo de datos. |
