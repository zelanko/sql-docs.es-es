...
ms.locfileid: "68345941"
---
# <a name="sql-server-r-language-tutorials"></a>Tutoriales del lenguaje SQL Server R
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md-winonly](../../includes/appliesto-ss-xxxx-xxxx-xxx-md-winonly.md)]

En este artículo se describen los tutoriales del lenguaje R para el análisis en bases de datos en [SQL Server 2016 R Services](../install/sql-r-services-windows-install.md) o [SQL Server 2017 Machine Learning Services](../install/sql-machine-learning-services-windows-install.md).
