...
ms.locfileid: "51032542"
---
# <a name="lesson-4-run-predictions-using-r-embedded-in-a-stored-procedure"></a>Lección 4: Predicciones de ejecución mediante R incrustan en un procedimiento almacenado
