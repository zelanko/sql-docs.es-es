---
title: Paso 6 hacer operativo el modelo de Python con SQL Server | Microsoft Docs
ms.prod: sql
...
ms.locfileid: "43888961"
---
# <a name="step-6-operationalize-the-python-model-using-sql-server"></a>Paso 6: Hacer operativo el modelo de Python con SQL Server
