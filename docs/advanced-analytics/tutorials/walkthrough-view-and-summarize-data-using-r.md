...
> 
> Otra opción consiste en supervisar los trabajos de R que se ejecutan en SQL Server mediante estos [informes personalizados](../r/monitor-r-services-using-custom-reports-in-management-studio.md).
