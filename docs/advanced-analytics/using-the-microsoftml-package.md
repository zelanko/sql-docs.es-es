...
En SQL Server 2017 CTP 2.0, se agregó compatibilidad para el lenguaje Python. El **microsoftml** del paquete de Python contiene funciones equivalentes a las que en el paquete MicrosoftML para R. 
