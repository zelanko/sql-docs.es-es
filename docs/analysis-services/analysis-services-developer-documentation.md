...
[Programación de minería de datos](../analysis-services/data-mining/data-mining-programming.md) describe los métodos para compilar soluciones que incluyen objetos de minería de datos.
