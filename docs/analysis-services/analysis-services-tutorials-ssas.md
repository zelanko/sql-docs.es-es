...
Esta colección de tutoriales describe cómo crear soluciones de minería de datos mediante asistentes y visualizaciones integradas.  
  
  
## <a name="additional-resources"></a>Recursos adicionales  
[Bases de datos de ejemplo AdventureWorks en Codeplex](http://go.microsoft.com/fwlink/?linkID=335807)  
Este vínculo le lleva a la página de descarga de codeplex que tiene las bases de datos de ejemplo AdventureWorks.  
  
[Ejemplo de código AMO para crear modelos tabulares mediante programación](http://go.microsoft.com/fwlink/?linkID=221036)  
Este vínculo le lleva a una página de descarga de Codeplex que contiene el ejemplo AMO.  
