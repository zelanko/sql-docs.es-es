---
title: "Configurar las propiedades de notificaci&#243;n para informes de Power View | Microsoft Docs"
ms.custom: ""
ms.date: "02/27/2017"
...
manager: "erikre"
---
# Configurar las propiedades de notificaci&#243;n para informes de Power View
...
Para obtener información detallada sobre el conjunto de campos predeterminado, vea [Configurar un conjunto de campos predeterminado para informes de Power View &#40;SSAS tabular&#41;](../analysis-services/tabular-models/configure-default-field-set-for-power-view-reports-ssas-tabular.md) en los Libros en pantalla de SQL Server.  
...
Para obtener más información sobre las propiedades de comportamiento de una tabla, vea [Configurar las propiedades de comportamiento de las tablas para informes de Power View &#40;SSAS tabular&#41;](../analysis-services/tabular-models/configure-table-behavior-properties-for-power-view-reports-ssas-tabular.md) en los Libros en pantalla de SQL Server.  
...
4.  Repita estos pasos, estableciendo la columna siguiente y las propiedades de informes para cada tabla especificada. Deje las demás propiedades con su configuración predeterminada.  
    ...
    **Customer**  
    ...
    |----------|------------|---------|  
    |Id. de geografía|Oculto|True|  
    |Fecha de nacimiento|Formato de datos|Short Date|  
    ...
    **Product**  
    ...
    |Columna|Propiedad|Value|  
    |----------|------------|---------|  
    |Id. de producto|Oculto|True|  
    |Id. alternativo del producto|Etiqueta predeterminada|True|  
...
Dado que ha cambiado el modelo, debe volver a implementarlo. Básicamente, repetirá las tareas realizadas en [Lección 14: Implementar](../analysis-services/lesson-14-deploy.md).  
