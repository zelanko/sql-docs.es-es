...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]Si su estructura de minería de datos contiene una tabla anidada, puede aplicar un filtro a la tabla de casos, la tabla anidada o ambos.  
...
11. Seleccione un operador y escriba un valor tal como se describe en los pasos 7 y 8.  
     ...
     Por ejemplo, seleccione de nuevo **Income** como columna, seleccione el operador menor que (<) y, después, escriba **40000**.  
...
1.  Agregue más condiciones según convenga y combínelas seleccionando **Y** u **OR** en el cuadro **Y/OR** a la izquierda de la cuadrícula **Condiciones** . [!INCLUDE[clickOK](../../includes/clickok-md.md)]  
