...
ms.topic: "article"
helpviewer_keywords: 
  - "Predicción de modelo de minería de datos [Analysis Services], seleccionar modelos de minería de datos"
...
1.  Si no tiene un modelo de clústeres disponible para crear esta consulta de ejemplo, cree el modelo, [TM_Clustering], con el [Tutorial básico de minería de datos](../Topic/Basic%20Data%20Mining%20Tutorial.md).  
