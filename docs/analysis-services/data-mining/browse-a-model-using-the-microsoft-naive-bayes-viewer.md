...
helpviewer_keywords: 
  ...
  - "Visor Bayes naive [Analysis Services]"
  - "minería de datos [Analysis Services], modelado de predicción"
  - "Algoritmo Bayes naive de Microsoft"
  - "histogramas [Analysis Services]"
  - "modelos de minería de datos [Analysis Services], modelado de predicción"
