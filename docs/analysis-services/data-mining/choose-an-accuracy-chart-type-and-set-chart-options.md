...
ms.topic: "article"
helpviewer_keywords: 
  - "gráfico de precisión de minería de datos [Analysis Services]"
  - "modelos de minería de datos [Analysis Services], validar"
  - "exactitud de la clasificación [minería de datos]"
...
---
# Elegir un tipo de gr&#225;fico de precisi&#243;n y establecer las opciones del gr&#225;fico
...
## Tipos de gráficos de precisión  
