...
ms.topic: "article"
helpviewer_keywords: 
  - "portapapeles [minería de datos]"
  - "Visor de modelos de minería de datos [Analysis Services], Portapapeles"
  - "copiar modelos de minería de datos en el portapapeles"
...
### Para copiar el modelo completo en el portapapeles  
...
### Para copiar en el Portapapeles la parte visible del modelo  
...
### Para copiar el contenido del modelo de minería de datos en el Portapapeles  
