...
1.  **Seleccione el método de definición**: Aquí se selecciona datos de un tipo de origen y elija **desde el almacén de datos o base de datos relacional**.  
...
5.  **Especifique los datos de entrenamiento**: En esta página, se elige el *tabla de casos*, que es la tabla que contiene los datos más importantes para el análisis.  
...
6.  **Especificar el contenido de las columnas y tipos de datos**: Para cada columna que se utiliza en la estructura, debe elegir un *tipo de datos* y un *tipo de contenido*.  
...
7.  **Crear conjunto de pruebas**: En esta página, puede indicar que el asistente se debe establecer la cantidad de datos reservado para su uso en la prueba del modelo. Si los datos admiten varios modelos, es aconsejable crear un conjunto de exclusión, para poder probar todos los modelos en los mismos datos.  
...
8.  **Finalización del Asistente para**: En esta página, asigne un nombre a la nueva estructura de minería de datos y el modelo de minería de datos asociados y guarde la estructura y modelo.  
...
##  <a name="BKMK_ChooseRelData"></a> Elegir los datos relacionales  
 ...
 Si las tablas tienen relaciones de uno a varios: por ejemplo, dispone de varios registros de compra para cada cliente que desea analizar: puede agregar las dos tablas y, a continuación, utilizar una tabla como tabla de casos, la vinculación de datos en el lado "varios" de la relación como una tabla anidada.  
...
##  <a name="bkmk_ContentDataType"></a> Especificar el tipo de contenido y el tipo de datos  
 ...
 Sin embargo, los tipos de contenido son importantes para la minería de datos y afectan al resultado del análisis. El tipo de contenido indica al algoritmo lo que debería hacer con los datos: ¿deben tratarse los números en una escala continua o de datos discretos? ¿Cuántos valores posibles hay? ¿Es distinto cada valor? ¿Si el valor es una clave, qué tipo de clave es todo: indica un valor de fecha y hora, una secuencia o algún otro tipo de clave?  
