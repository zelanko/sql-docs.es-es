...
8.  **Especificar el contenido de las columnas y el tipo de datos**: En este punto, ha agregado todos los datos que se usará para el análisis y deben especificar el *tipo de datos* y *tipo de contenido* para cada atributo.  
     ...
     El *tipo de contenido* que elija para cada columna que use en el modelo indica al algoritmo cómo se deben procesar los datos. Para más información, vea [Tipos de contenido &#40;minería de datos&#41;](../../analysis-services/data-mining/content-types-data-mining.md).  
...
-   Para el segundo filtro, elija la dimensión Customer, seleccionaría el atributo Gender y seleccionaría "Female" en la lista de valores de atributo.  
 ...
 Después de crear la estructura de minería de datos, puede modificar la definición del cubo y los criterios de filtro. Para obtener más información, consulte [filtros para modelos de minería de datos de](~/analysis-services/data-mining/filters-for-mining-models-analysis-services-data-mining.md).  
