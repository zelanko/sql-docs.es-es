...
6.  [Implementar y actualizar los modelos](#DeployingandUpdatingModels)  
 ...
 ![Pasos clave del proceso de minería de datos](../../analysis-services/data-mining/media/data-mining-process.gif "Pasos clave del proceso de minería de datos")  
 ...
 Si quiere ver un ejemplo de cómo las herramientas de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] se pueden aplicar en un escenario empresarial, vea [Tutorial básico de minería de datos](../Topic/Basic%20Data%20Mining%20Tutorial.md).  
...
##  <a name="DefiningTheProblem"></a> Definir el problema  
 ...
 ![Primer paso de la minería de datos: definición del problema](../../analysis-services/data-mining/media/dmprocess-defining.gif "Primer paso de la minería de datos: definición del problema")  
...
##  <a name="PreparingData"></a> Preparar los datos  
 ...
 ![Segundo paso de la minería de datos: preparación de los datos](../../analysis-services/data-mining/media/dmprocess-preparing.gif "Segundo paso de la minería de datos: preparación de los datos")  
...
##  <a name="ExploringData"></a> Explorar los datos  
 ...
 ![Tercer paso de la minería de datos: exploración de los datos](../../analysis-services/data-mining/media/dmprocess-exploring.gif "Tercer paso de la minería de datos: exploración de los datos")  
...
##  <a name="BuildingModels"></a> Generar modelos  
 ...
 ![Cuarto paso de la minería de datos: creación de modelos de minería](../../analysis-services/data-mining/media/dmprocess-building.gif "Cuarto paso de la minería de datos: creación de modelos de minería")  
 ...
 Es importante recordar que siempre que los datos cambian, debe actualizar la estructura y el modelo de minería de datos. Al actualizar una estructura de minería de datos volviéndola a procesar, [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] recupera los datos del origen, incluido cualquier dato nuevo si el origen se actualiza dinámicamente, y vuelve a rellenar la estructura de minería de datos. Si tiene modelos que están basados en la estructura, puede elegir actualizar estos, lo que significa que se vuelven a entrenar con los nuevos datos, o puede dejar los modelos tal cual. Para obtener más información, vea [Requisitos y consideraciones de procesamiento &#40;minería de datos&#41;](../../analysis-services/data-mining/processing-requirements-and-considerations-data-mining.md).  
...
##  <a name="ValidatingModels"></a> Explorar y validar los modelos  
 ...
 ![Quinto paso de la minería de datos: validación de los modelos de minería](../../analysis-services/data-mining/media/dmprocess-validating.gif "Quinto paso de la minería de datos: validación de los modelos de minería")  
...
##  <a name="DeployingandUpdatingModels"></a> Implementar y actualizar los modelos  
 ...
 ![Sexto paso de la minería de datos: implementación de los modelos de minería](../../analysis-services/data-mining/media/dmprocess-deploying.gif "Sexto paso de la minería de datos: implementación de los modelos de minería")  
...
-   Use los modelos para crear predicciones que luego podrá usar para tomar decisiones comerciales. [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] pone a su disposición el lenguaje DMX, que podrá usar para crear consultas de predicción, y el Generador de consultas de predicción, que le ayudará a generar las consultas. Para obtener más información, vea [Referencia de Extensiones de minería de datos &#40;DMX&#41;](../../dmx/data-mining-extensions-dmx-reference.md).  
