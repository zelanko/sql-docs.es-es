...
helpviewer_keywords: 
  ...
  - "estructuras de minería de datos [Analysis Services], modificar"
  - "editor de minería de datos [Analysis Services]"
  - "Diseñador de minería de datos"
  - "minería de datos [Analysis Services], modificar"
...
## Pestaña Estructura de minería de datos  
...
## Pestaña Modelos de minería de datos  
...
## Pestaña Visor de modelos de minería de datos  
...
## Pestaña Gráfico de precisión de minería de datos  
...
## Pestaña Predicción de modelo de minería de datos  
