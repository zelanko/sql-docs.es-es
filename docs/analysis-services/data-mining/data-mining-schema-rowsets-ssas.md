---
title: "Conjuntos de filas de esquema de miner&#237;a de datos (SSAs) | Microsoft Docs"
ms.custom: ""
ms.date: "03/02/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "conjuntos de filas de esquema [Analysis Services], minería de datos"
  - "minería de datos [Analysis Services], consultas"
  - "contenido del modelo de minería de datos"
  - "minería de datos [Analysis Services], conjuntos de filas de esquema"
  - "conjuntos de filas de esquema [Analysis Services], recuperar"
  - "minería de datos [Analysis Services], solucionar problemas"
...
---
# Conjuntos de filas de esquema de miner&#237;a de datos (SSAs)
...
## Lista de conjuntos de filas de esquema de minería de datos  
...
### Ejemplo 1: lista de servicios de minería de datos  
...
### Ejemplo 2: lista de parámetros de modelo de minería  
...
### Ejemplo 3: lista de todos los conjuntos de filas  
