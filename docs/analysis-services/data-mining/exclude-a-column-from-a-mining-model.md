...
ms.topic: "article"
helpviewer_keywords: 
  - "excluir columnas de un modelo de minería de datos"
  - "modelos de minería de datos [Analysis Services], columnas"
  - "columnas [minería de datos], excluir"
...
---
# Excluir una columna de un modelo de miner&#237;a de datos
...
### Para excluir una columna de un modelo de minería de datos  
