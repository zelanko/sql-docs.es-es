...
ms.topic: "article"
helpviewer_keywords: 
  - "modelos de minería de datos [Analysis Services], selecciones de características"
  - "atributos [minería de datos]"
  - "algoritmos de selección de características [Analysis Services]"
  - "minería de datos [Analysis Services], selecciones de características"
...
## ¿Por qué usar la selección de características?  
...
## Funcionamiento de la selección de características en la minería de datos de SQL Server  
...
### Puntuaciones de selección de características  
...
### Métodos de selección de características por algoritmo  
