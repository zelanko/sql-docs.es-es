---
title: "Filtros para modelos de miner&#237;a (Analysis Services - Miner&#237;a de datos) | Microsoft Docs"
ms.custom: ""
ms.date: "03/20/2017"
...
helpviewer_keywords: 
  ...
  - "modelos [Analysis Services], filtrar"
  - "filtros [minería de datos]"
  - "filtrar datos [Analysis Services]"
...
### ¿Cómo puedo saber si se está usando un filtro?  
...
### ¿Por qué no veo ningún efecto del filtro?  
...
### ¿Por qué veo atributos filtrados en los resultados de una consulta de predicción?  
