...
|4|Equivalente Dirichlet bayesiano (BDE) con prioridad uniforme<br /><br /> (predeterminado).|  
 ...
 Para obtener una explicación de estos métodos de puntuación, vea [Feature Selection](../Topic/Feature%20Selection.md).  
