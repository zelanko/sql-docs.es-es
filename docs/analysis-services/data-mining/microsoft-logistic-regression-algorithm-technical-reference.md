...
## <a name="implementation-of-the-microsoft-logistic-regression-algorithm"></a>Implementación del algoritmo de regresión logística de Microsoft  
 ...
 ![Modelan de datos mediante el uso de regresión logística](../../analysis-services/data-mining/media/logistic-regression.gif "datos modelan mediante el uso de regresión logística")  
