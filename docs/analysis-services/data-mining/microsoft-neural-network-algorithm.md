...
helpviewer_keywords: 
  ...
  - "neuronas de salida [Analysis Services]"
  - "algoritmos [minería de datos]"
  - "algoritmos de red neuronal [Analysis Services]"
  - "neuronas [Analysis Services]"
  - "algoritmos de clasificación [Analysis Services]"
  - "redes neuronales"
  - "red perceptrón multicapa de neuronas [Analysis Services]"
  - "neuronas ocultas"
  - "regla delta de propagación hacia atrás, red de tipo"
  - "neuronas de entrada [Analysis Services]"
