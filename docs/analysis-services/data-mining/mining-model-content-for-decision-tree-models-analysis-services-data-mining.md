...
ms.topic: "article"
helpviewer_keywords: 
  - "contenido del modelo de minería de datos, modelos de árboles de decisión"
...
>  Si el modelo incluye varios árboles, solo podrá ver un árbol cada vez en el **Visor de árboles de Microsoft**. Sin embargo, en el **Visor de árbol de contenido genérico** se muestran de forma simultánea todos los árboles del mismo modelo.  
 ...
 ![estructura del contenido del modelo para el árbol de decisión](../../analysis-services/data-mining/media/modelcontentstructure-dt.gif "estructura del contenido del modelo para el árbol de decisión")  
...
###  <a name="NodeScore"></a> Puntuación del nodo  
 ...
 Hay muchas maneras de calcular una puntuación para una división, dependiendo del parámetro de algoritmo que se elija. La explicación de cómo se calculan las puntuaciones para cada uno de los métodos de puntuación queda fuera del ámbito de este tema. Para obtener más información, vea "[Descripción de las redes Bayesianas: combinación de conocimiento y datos estadísticos](http://go.microsoft.com/fwlink/?LinkId=45963)", en el sitio web de [!INCLUDE[msCoName](../../includes/msconame-md.md)] Research.  
