---
title: Contenido del modelo para los modelos de regresión lineal de minería de datos | Microsoft Docs
ms.date: 05/08/2018
ms.prod: sql
...
|Identificador del tipo de nodo|Type|Descripción|  
|------------------|----------|-----------------|  
