...
helpviewer_keywords: 
  ...
  - "objetos de Analysis Services, objetos de minería de datos"
...
# Estructuras de miner&#237;a de datos (Analysis Services - Miner&#237;a de datos)
 ...
 ![Procesamiento de datos: origen a estructura a modelo](../../analysis-services/data-mining/media/dmcon-modelarch.gif "Procesamiento de datos: origen a estructura a modelo")  
...
### Ver estructuras de minería de datos  
 ...
 La instrucción `SELECT * FROM <model>.CASES` devuelve las mismas columnas, pero solo para los casos de ese modelo concreto. Para obtener más información, vea [SELECT FROM &#60;estructura&#62;.CASES](../Topic/SELECT%20FROM%20%3Cstructure%3E.CASES.md) y [SELECT FROM &#60;model&#62;.CASES &#40;DMX&#41;](../Topic/SELECT%20FROM%20%3Cmodel%3E.CASES%20\(DMX\).md).  
...
|Trabajar con estructuras de minería de datos basadas en cubos OLAP|[Crear una estructura de minería de datos OLAP](../../analysis-services/data-mining/create-a-new-olap-mining-structure.md)<br /><br /> [Filtrar el cubo de origen para una estructura de minería de datos](../Topic/Filter%20the%20Source%20Cube%20for%20a%20Mining%20Structure.md)|  
