...
ms.topic: "article"
helpviewer_keywords: 
  - "minería de datos [Analysis Services], tablas anidadas"
  - "tablas [Analysis Services], anidadas"
  - "tablas anidadas"
...
---
# Tablas anidadas (Analysis Services - Miner&#237;a de datos)
 ...
 ![Dos tablas combinadas mediante una tabla anidada](../../analysis-services/data-mining/media/nested-tables.gif "Dos tablas combinadas mediante una tabla anidada")  
...
## Combinar tablas de casos y tablas anidadas  
...
## Usar columnas de tabla anidada en un modelo de minería de datos  
...
### Usar columnas anidadas sin clave desde una tabla anidada  
...
## Filtrar datos de tablas anidadas  
