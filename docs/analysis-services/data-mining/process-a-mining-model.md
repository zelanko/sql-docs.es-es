...
---
# Procesar un modelo de miner&#237;a de datos
...
### Procesar un modelo de minería de datos mediante las Herramientas de datos de SQL Server  
...
3.  En el cuadro de diálogo **Procesando Modelo de minería de datos - \<modelo>**, haga clic en **Ejecutar**.  
...
5.  Haga clic en **Cerrar** en el cuadro de diálogo **Procesando Modelo de minería de datos - \<modelo>**.  
  
 Solo se han procesado la estructura y el modelo de minería de datos seleccionado.  
  
### Procesar todos los modelos de minería de datos asociados a una estructura de minería de datos  
...
3.  En el cuadro de diálogo **Procesando Estructura de minería de datos - \<estructura>**, haga clic en **Ejecutar**.  
...
6.  Haga clic en **Cerrar** en el cuadro de diálogo **Procesando \<modelo>**.  
