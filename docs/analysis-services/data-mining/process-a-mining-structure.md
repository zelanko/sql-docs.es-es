...
---
# Procesar una estructura de miner&#237;a de datos
...
### Para procesar una estructura de minería de datos y todos los modelos asociados a las herramientas de datos de SQL Server  
...
2.  Haga clic en **Ejecutar** en el cuadro de diálogo **Procesando estructura de minería de datos - \<estructura>**.  
