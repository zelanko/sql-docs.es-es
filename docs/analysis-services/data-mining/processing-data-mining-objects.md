...
helpviewer_keywords: 
  ...
  - "estructuras de minería de datos [Analysis Services], procesar"
...
-   Creando una consulta DMX (Extensiones de minería de datos) en el modelo y obteniendo detalles sobre la estructura. Para más información, vea [SELECT FROM &#60;model&#62;.CASES &#40;DMX&#41;](../Topic/SELECT%20FROM%20%3Cmodel%3E.CASES%20\(DMX\).md).  
...
-   Creando una consulta DMX en los casos de la estructura. Para más información, vea [SELECT FROM &#60;estructura&#62;.CASES](../Topic/SELECT%20FROM%20%3Cstructure%3E.CASES.md).  
