---
title: Las propiedades de la estructura de minería de datos y las columnas de estructura | Microsoft Docs
ms.date: 05/08/2018
ms.prod: sql
...
|--------------|-----------------|  
|**CacheMode**|Especifica si los casos utilizados en entrenamiento deberían almacenarse en memoria caché o descartarse una vez completado el entrenamiento. **Nota:**  Esta propiedad debe establecerse en **KeepTrainingCases** para habilitar la obtención de detalles y la exclusión.|  
