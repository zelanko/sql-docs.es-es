...
## Interpretación de los resultados  
 ...
 ![ejemplo de gráfico de precisión para regresión lineal](../../analysis-services/data-mining/media/scatterplot-callctr.gif "ejemplo de gráfico de precisión para regresión lineal")  
