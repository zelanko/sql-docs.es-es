...
5.  Agregue la jerarquía definida por el usuario **Internet Sales Orders** de la dimensión **Internet Sales Order Details** al área de filas del panel de datos.  
    ...
    ![Dimensión de Internet Sales-Sales Amount](../analysis-services/media/l5-factrelationship-3.gif "Dimensión de Internet Sales-Sales Amount")  
  
## Siguiente tarea de la lección  
[Definir una relación de varios a varios](../analysis-services/defining-a-many-to-many-relationship.md)  
