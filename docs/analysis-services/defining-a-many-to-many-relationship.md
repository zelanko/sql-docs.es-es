...
10. En el panel **Tablas**, haga clic con el botón derecho en **InternetSalesReason (dbo.FactInternetSalesReason)** y seleccione **Explorar datos**.  
    ...
    ![Valor de clave para identificar la razón de venta para adquisiciones](../analysis-services/media/l5-many-to-many-1.png "Valor de clave para identificar la razón de venta para adquisiciones")  
...
6.  En la ventana Propiedades, cambie la propiedad **Visible** de la medida **Internet Sales Reason Count** a **False**.  
    ...
    ![Propiedades de la medida Internet Sales Reason Count](../analysis-services/media/l5-many-to-many-2.gif "Propiedades de la medida Internet Sales Reason Count")  
...
[Definir la granularidad de las dimensiones en un grupo de medida](../analysis-services/defining-dimension-granularity-within-a-measure-group.md)  
