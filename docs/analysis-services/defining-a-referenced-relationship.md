...
3.  Desde la dimensión **Geography** del panel de metadatos, arrastre la jerarquía definida por el usuario **Geographies** hasta el área **Coloque campos de fila aquí** del panel de datos.  
    ...
    ![Medida Reseller Sales-Sales Amount con dimensiones](../analysis-services/media/l5-referencedrelationship-1.gif "Medida Reseller Sales-Sales Amount con dimensiones")  
...
[Definir una relación de hechos](../analysis-services/defining-a-fact-relationship.md)  
