...
2.  En la barra de herramientas de la pestaña **Acciones**, haga clic en el botón **Nueva acción de obtención de detalles**.  
    ...
    ![Plantilla Acción en blanco en el panel de visualización](../analysis-services/media/l8-action2.gif "Plantilla Acción en blanco en el panel de visualización")  
