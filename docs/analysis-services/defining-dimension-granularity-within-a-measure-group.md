...
5.  Expanda la dimensión **Sales Territory** y arrastre la jerarquía definida por el usuario **Sales Territories** hasta las etiquetas de fila.  
    ...
    ![Dimensión del cubo Sales Territory](../analysis-services/media/l5-granularity-2.gif "Dimensión del cubo Sales Territory")  
...
7.  En la lista de campos de tabla dinámica, seleccione la jerarquía definida por el usuario **Sales Territories** y haga clic en la flecha hacia abajo de la derecha.  
    ...
    ![Jerarquía Sales Territories en la lista de campos](../analysis-services/media/l5-granularity-1a.png "Jerarquía Sales Territories en la lista de campos")  
  
8.  En el filtro, haga clic en la casilla Seleccionar todo para desactivar todas las casillas y elija solo **North America**.  
  
    ![Panel Filtro para seleccionar North America](../analysis-services/media/l5-granularity-1b.png "Panel Filtro para seleccionar North America")  
...
11. En la tabla dinámica, haga clic en la flecha hacia abajo que aparece junto a Etiquetas de fila. Desactive todos los años excepto **FY 2008**.  
    ...
    ![Valores de Sales Amount Quota](../analysis-services/media/l5-granularity-3.png "Valores de Sales Amount Quota")  
...
8.  Expanda sucesivamente **FY 2008**, **H1 FY 2008**y **Q1 FY 2008**.  
    ...
    ![Grupo de medida Sales Quota con dimensiones correctas](../analysis-services/media/l5-granularity-7.gif "Grupo de medida Sales Quota con dimensiones correctas")  
