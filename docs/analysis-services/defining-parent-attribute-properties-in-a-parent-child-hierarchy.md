...
Para obtener más información, consulte [Dimensiones de elementos primarios y secundarios](../analysis-services/multidimensional-models/parent-child-dimensions.md) y [Atributos en las jerarquías de elementos primarios y secundarios](../analysis-services/multidimensional-models/attributes-in-parent-child-hierarchies.md)  
...
10. ![Tabla dinámica que muestra la jerarquía Employees](../analysis-services/media/l4-employee-1.gif "Tabla dinámica que muestra la jerarquía Employees")  
...
4.  En la segunda fila, la fila **\***, escriba **Employee Level \*** en la columna **Nombre** y después haga clic en la tercera fila.  
    ...
    ![Cuadro de diálogo Plantilla de asignación de nombres de nivel](../analysis-services/media/l4-namingtemplate.gif "Cuadro de diálogo Plantilla de asignación de nombres de nivel")  
...
5.  Arrastre la jerarquía **Employees** hasta el área Etiquetas de fila.  
    ...
    ![Jerarquía Employees modificada](../analysis-services/media/l4-employee-2.png "Jerarquía Employees modificada")  
  
## Siguiente tarea de la lección  
[Agrupar miembros de atributo automáticamente](../analysis-services/automatically-grouping-attribute-members.md)  
  
## Vea también  
[Dimensiones de elementos primarios y secundarios](../analysis-services/multidimensional-models/parent-child-dimensions.md)  
[Atributos en las jerarquías de elementos primarios y secundarios](../analysis-services/multidimensional-models/attributes-in-parent-child-hierarchies.md)  
