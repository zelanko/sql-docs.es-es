...
4.  Haga clic en la consulta SELECT DISTINCT y, después, en **Ver detalles**.  
    ...
    ![Cláusula SELECT DISTINCT en la que se muestra la cláusula WHERE](../analysis-services/media/l4-productnametraceline-1.gif "Cláusula SELECT DISTINCT en la que se muestra la cláusula WHERE")  
...
4.  Expanda el miembro **Assembly Components** del nivel **Category** y luego expanda el miembro **Assembly Components** del nivel **Subcategory**.  
    ...
    ![Nivel Product Name en el que se muestran los componentes del ensamblado](../analysis-services/media/l4-assemblycomponents-1.gif "Nivel Product Name en el que se muestran los componentes del ensamblado")  
