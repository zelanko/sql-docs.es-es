...
ms.topic: "article"
helpviewer_keywords: 
  - "idiomas, compatibilidad con varios [Analysis Services]"
  - "idiomas [Analysis Services]"
  - "SSAS, consideraciones internacionales"
  - "consideraciones internacionales [Analysis Services]"
  - "consideraciones globales [Analysis Services]"
  - "SQL Server Analysis Services, consideraciones internacionales"
  - "Analysis Services, consideraciones internacionales"
