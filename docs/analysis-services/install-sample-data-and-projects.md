...
1.  Descargar un [AdventureWorkDW](https://github.com/Microsoft/sql-server-samples/releases/tag/adventureworks) copia de seguridad de base de datos de GitHub.  
  
2.  Copie el archivo de copia de seguridad en el directorio de datos de la instancia de motor de base de datos de SQL Server local.
