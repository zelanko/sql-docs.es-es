---
title: "Configurar las cuentas de servicio (Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "seguridad [Analysis Services], cuentas de inicio de sesión"
  - "cuentas de inicio de sesión [Analysis Services]"
  - "cuentas [Analysis Services]"
  - "cuentas de inicio de sesión [Analysis Services], acerca de las cuentas de inicio de sesión"
...
## Recomendaciones de la cuenta de inicio de sesión  
...
## Otorgar permisos a Analysis Services  
...
-   Ejecute compmgmt.msc | **Usuarios y grupos locales** | **Grupos** | **SQLServerMSASUser$**\<nombre-de-servidor >**$MSSQLSERVER** (para una instancia predeterminada).  
