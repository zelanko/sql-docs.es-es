---
title: Propiedades de la cadena de conexión (Analysis Services) | Documentos de Microsoft
ms.date: 05/02/2018
ms.prod: sql
...
|**DbpropMsmdRequestMemoryLimit**|Esta propiedad invalida la [Memory\QueryMemoryLimit](../server-properties/memory-properties.md) valor de la propiedad de servidor para una conexión. Se especifica en kilobytes. |
