...
---
# Proveedores de datos usados para conexiones de Analysis Services
...
#### Buscar los proveedores de datos en el sitio de descarga  
  
1.  Vaya al [Centro de descarga de Microsoft](http://go.microsoft.com/fwlink/p/?LinkID=296473).  
  
2.  Expanda **Instrucciones de instalación**. En la lista se incluyen ADOMD.NET, el proveedor OLE DB y AMO. Todas las bibliotecas están disponibles en versiones de 32 o de 64 bits. Los servidores y las estaciones de trabajo más modernas que ejecuten un sistema operativo de 64 bits necesitarán la versión de 64 bits.  
...
##  <a name="bkmk_ADOMD"></a> ADOMD.NET  
 ...
 Para obtener más información sobre la conexión mediante programación, vea [Establishing Connections in ADOMD.NET](../Topic/Establishing%20Connections%20in%20ADOMD.NET.md).  
