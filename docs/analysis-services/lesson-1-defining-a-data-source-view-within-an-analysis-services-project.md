...
En esta tarea, debe especificar el **AdventureWorksDW** base de datos como origen de datos para el [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] dimensiones y los cubos que definen en lecciones posteriores.  
  
[Definir una vista del origen de datos](../analysis-services/lesson-1-3-defining-a-data-source-view.md)  
En esta tarea, definir una única vista unificada de los metadatos de las tablas seleccionadas en el **AdventureWorksDW** base de datos.  
  
[Modificar los nombres de tabla predeterminados](../analysis-services/lesson-1-4-modifying-default-table-names.md)  
En esta tarea, modificar nombres de tabla en la vista del origen de datos, por lo que los nombres de los siguientes [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)] objetos que definen son más descriptivos.  
