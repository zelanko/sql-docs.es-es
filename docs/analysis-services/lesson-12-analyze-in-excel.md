...
Para completar esta lección, Excel debe instalarse en el mismo equipo que SSDT. Para obtener más información, consulte [Analizar en Excel](../analysis-services/tabular-models/analyze-in-excel-ssas-tabular.md).  
