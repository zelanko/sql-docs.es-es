...
## Requisitos previos  
Este tema es parte de un tutorial de creación de modelos tabulares, que se debe completar en orden. Antes de realizar las tareas de esta lección, debe haber completado la lección anterior: [Lección 2: Agregar datos](../analysis-services/lesson-2-add-data.md).  
...
2.  Haga doble clic en el nombre de columna **CustomerKey**, escriba **Id. de cliente** y pulse ENTRAR.  
...
## Paso siguiente  
Para continuar este tutorial, vaya a la lección siguiente: [Lección 4: Marcar como tabla de fechas](../analysis-services/lesson-4-mark-as-date-table.md).  
