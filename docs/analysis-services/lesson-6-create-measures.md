...
Vaya a la lección siguiente: [Lección 7: Creación de indicadores clave de rendimiento](../analysis-services/lesson-7-create-key-performance-indicators.md).  
