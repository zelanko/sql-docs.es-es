...
[Quitar un atributo de una dimensión](../analysis-services/multidimensional-models/remove-an-attribute-from-a-dimension.md)  
[Cambiar el nombre de un atributo](../analysis-services/multidimensional-models/rename-an-attribute.md)  
