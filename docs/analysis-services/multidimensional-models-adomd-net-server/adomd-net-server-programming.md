---
title: "Programación del servidor ADOMD.NET | Documentos de Microsoft"
ms.custom: 
ms.date: 03/14/2017
...
|Tema|Description|  
|-----------|-----------------|  
|[Funcionalidad del servidor ADOMD.NET](../../analysis-services/multidimensional-models-adomd-net-server/adomd-net-server-functionality.md)|Describe los usos de los objetos de servidor ADOMD.NET.|  
