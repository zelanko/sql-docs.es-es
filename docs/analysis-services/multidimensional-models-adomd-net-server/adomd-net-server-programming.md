...
|Tema|Description|  
|-----------|-----------------|  
|[Funcionalidad de servidor ADOMD.NET](../../analysis-services/multidimensional-models-adomd-net-server/adomd-net-server-functionality.md)|Describe los usos de los objetos de servidor ADOMD.NET.|  
