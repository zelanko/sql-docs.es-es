...
5.  Si se trata de una compilación de depuración de la biblioteca que se va a usar para depurar procedimientos almacenados, seleccione el **incluir información de depuración** casilla de verificación. Para obtener más información sobre cómo depurar procedimientos almacenados, vea [depurar procedimientos almacenados](../../analysis-services/multidimensional-models-extending-olap-stored-procedures/debugging-stored-procedures.md).  
