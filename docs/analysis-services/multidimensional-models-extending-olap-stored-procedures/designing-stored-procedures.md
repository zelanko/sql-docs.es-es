...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]Analysis Management Objects (AMO) y el modelo de orientado a objetos de cliente de los modelos de objeto administrativo [!INCLUDE[msCoName](../../includes/msconame-md.md)] ActiveX® Data Objects (Multidimensional) (ADO MD) están disponibles en los procedimientos almacenados.  
