...
3.  Agregar la acción a la colección de cubos y actualizar el cubo. La acción no es un objeto actualizable.  
 ...
 Para probar la acción se requiere una aplicación de programa diferente. Puede probar su acción en [!INCLUDE[ssBIDevStudioFull](../../../includes/ssbidevstudiofull-md.md)]. En primer lugar, debe instalar [!INCLUDE[ssRSnoversion](../../../includes/ssrsnoversion-md.md)] ejemplos, vea [procesar un modelo multidimensional &#40;Analysis Services&#41;](../../../analysis-services/multidimensional-models/processing-a-multidimensional-model-analysis-services.md).  
