---
title: "Examinar los datos y metadatos de un cubo | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Examinar los datos y metadatos de un cubo
...
-   En la columna **Dimensión** del panel **Filtro**, haga clic en **\<Seleccionar dimensión>** y seleccione una dimensión de la lista; después, haga clic en **\<Seleccionar jerarquía>** en la columna **Jerarquía** y seleccione una jerarquía de la lista.  
...
##### Explorar en profundidad un miembro  
...
##### Ver las propiedades de los miembros e información sobre las celdas del cubo  
 Para ver información sobre un objeto de dimensión o un valor de celda, mueva el puntero sobre la celda.  
  
##### Mostrar u ocultar las celdas vacías  
