---
title: "Configurar propiedades de relaci&#243;n de los atributos | Microsoft Docs"
ms.custom: ""
ms.date: "03/13/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "relaciones flexibles (Analysis Services)"
  - "atributos [Analysis Services], relaciones"
  - "relaciones [Analysis Services], atributos"
  - "propiedades [Analysis Services], relaciones de los atributos"
  - "relaciones rígidas (Analysis Services)"
...
manager: "erikre"
---
# Configurar propiedades de relaci&#243;n de los atributos
