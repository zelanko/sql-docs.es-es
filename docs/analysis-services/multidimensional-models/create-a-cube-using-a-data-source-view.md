---
title: "Crear un cubo usando una vista del origen de datos | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Crear un cubo usando una vista del origen de datos
...
## Seleccionar el método de generación  
...
## Seleccionar la vista del origen de datos  
...
## Identificar tablas de hechos y de dimensiones  
...
## Revisar las nuevas dimensiones  
...
>  Puede ampliar o maximizar la ventana del asistente para ver mejor el árbol.  
 ...
 Para cambiar el nombre de cualquier dimensión, atributo, jerarquía o nivel, haga clic en el nombre, o bien haga clic con el botón derecho en el nombre y, después, en el menú contextual, haga clic en **Cambiar nombre de \<objeto>**, donde **\<objeto>** es **Dimensión**, **Atributo** o **Nivel**.  
...
## Completar el Asistente para cubos  
