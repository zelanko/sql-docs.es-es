...
ms.topic: "article"
helpviewer_keywords: 
  - "dimensiones [Analysis Services], moneda"
...
manager: "erikre"
---
# Crear una dimensi&#243;n de tipo moneda
...
-   Un código de moneda ISO (International Standards Organization)  
 ...
 Para más información sobre tipos de atributo, vea [Configurar tipos de atributos](../../analysis-services/multidimensional-models/configure-attribute-types.md).  
  
## Definir la inteligencia de cuentas mediante el Asistente de Business Intelligence  
