...
helpviewer_keywords: 
  ...
  - "dimensiones [Analysis Services], tiempo"
  - "tiempo, períodos [Analysis Services]"
  - "dimensiones de tiempo basadas en intervalos [Analysis Services]"
  - "dimensiones de tiempo de servidor [Analysis Services]"
  - "calendarios [Analysis Services]"
  - "dimensiones de tiempo basadas en tablas [Analysis Services]"
...
## Vea también  
 ...
 [Crear una dimensión de tipo Date](../../analysis-services/multidimensional-models/create-a-date-type-dimension.md)   
