...
helpviewer_keywords: 
  ...
  - "cubos [Analysis Services], acerca de los cubos"
...
|Jerarquías|[Crear jerarquías definidas por el usuario](../../analysis-services/multidimensional-models/create-user-defined-hierarchies.md)|  
