...
ms.topic: "article"
helpviewer_keywords: 
  - "miembros [Analysis Services], personalizar"
  - "fórmulas de resumen personalizado [Analysis Services]"
  - "MDX [Analysis Services], fórmulas de resumen personalizado"
...
manager: "erikre"
---
# Definir f&#243;rmulas de miembro personalizado
...
## Evaluar fórmulas de miembro personalizado  
...
## Vea también  
 ...
 [Configurar fórmulas de miembro personalizado para los atributos de una dimensión](../../analysis-services/multidimensional-models/set-custom-member-formulas-for-attributes-in-a-dimension.md)  
