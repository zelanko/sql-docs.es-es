...
ms.topic: "article"
helpviewer_keywords: 
  - "crecimiento entre períodos [Analysis Services]"
  - "comparaciones de período paralelas [Analysis Services]"
  - "mejoras de Business Intelligence [Analysis Services], inteligencia de tiempo"
  - "tiempo, vistas [Analysis Services]"
  - "jerarquías [Analysis Services], tiempo"
  - "tiempo, períodos [Analysis Services]"
  - "media móvil"
  - "tiempo [Analysis Services]"
  - "períodos hasta la fecha [Analysis Services]"
  - "cálculos [Analysis Services], tiempo"
  - "tiempo, jerarquías [Analysis Services]"
  - "tiempo, inteligencia [Analysis Services]"
...
---
# Definir c&#225;lculos de inteligencia de tiempo mediante el Asistente de Business Intelligence
...
## Seleccionar una jerarquía de tiempo  
...
## Aplicar vistas de tiempo a los miembros  
...
## Ver la mejora de inteligencia de tiempo  
