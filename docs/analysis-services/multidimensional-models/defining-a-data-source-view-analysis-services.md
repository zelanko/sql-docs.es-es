...
helpviewer_keywords: 
  ...
  - "criterios de coincidencia de nombres [Analysis Services]"
  - "Asistente para vistas del origen de datos"
  - "vistas del origen de datos [Analysis Services], crear"
