...
ms.topic: "article"
helpviewer_keywords: 
  - "eliminar vistas del origen de datos"
  - "vistas del origen de datos [Analysis Services], eliminar"
  - "quitar vistas del origen de datos"
...
# Eliminar una vista del origen de datos (Analysis Services)
 ...
 ![Eliminar objetos, cuadro de diálogo](../../analysis-services/multidimensional-models/media/ssas-olapdsv-deleteobjects.gif "Eliminar objetos, cuadro de diálogo")  
