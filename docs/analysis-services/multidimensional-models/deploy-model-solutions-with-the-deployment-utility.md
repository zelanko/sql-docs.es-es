...
ms.topic: "article"
helpviewer_keywords: 
  - "implementación [Analysis Services], símbolo del sistema"
  - "Utilidades de símbolo del sistema [SQL Server], Microsoft.AnalysisServices.Deployment"
  - "Microsoft.AnalysisServices.Deployment, utilidad"
  - "Implementaciones de Analysis Services, símbolo del sistema"
