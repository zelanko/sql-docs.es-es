---
title: "Otorgar permisos de base de datos (Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "permisos [Analysis Services], control total"
  - "permisos de control total [Analysis Services]"
...
# Otorgar permisos de base de datos (Analysis Services)
 ...
 ![Cuadro de diálogo Crear rol donde se ven los permisos de base de datos](../../analysis-services/multidimensional-models/media/ssas-permsdbrole.png "Cuadro de diálogo Crear rol donde se ven los permisos de base de datos")  
