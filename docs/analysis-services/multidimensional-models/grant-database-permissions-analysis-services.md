...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]
 ...
 ![Crear función de los permisos de base de datos de cuadro de diálogo que muestra](../../analysis-services/multidimensional-models/media/ssas-permsdbrole.png "crear rol permisos de base de datos de cuadro de diálogo que muestra")  
