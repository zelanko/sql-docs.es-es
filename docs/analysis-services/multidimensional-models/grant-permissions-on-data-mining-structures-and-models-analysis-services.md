---
title: "Otorgar permisos para estructuras y modelos de miner&#237;a de datos (Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
helpviewer_keywords: 
  - "minería de datos [Analysis Services], seguridad"
  - "permisos [Analysis Services], modelos de minería de datos"
  - "modelos de minería de datos [Analysis Services], seguridad"
  - "estructuras de minería de datos [Analysis Services], seguridad"
  - "permisos [Analysis Services], estructuras de minería de datos"
  - "derechos de acceso de usuario [Analysis Services], estructuras de minería de datos"
  - "derechos de acceso de usuario [Analysis Services], modelos de minería de datos"
...
## Establecer permisos para obtener acceso a una estructura de minería datos  
...
## Establecer permisos para obtener acceso a un modelo de minería de datos  
