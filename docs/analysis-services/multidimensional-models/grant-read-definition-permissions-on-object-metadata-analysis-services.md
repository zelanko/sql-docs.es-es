...
helpviewer_keywords: 
  ...
  - "permisos [Analysis Services], leer metadatos"
  - "permisos de lectura de metadatos"
...
## Establecer permisos de Leer definición en una base de datos  
...
## Establecer permisos de Leer definición en objetos individuales  
