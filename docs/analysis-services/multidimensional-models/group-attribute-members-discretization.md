---
title: "Agrupar miembros de atributos (discretizaci&#243;n) | Microsoft Docs"
ms.custom: ""
ms.date: "03/13/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "NameColumn, propiedad"
  - "discretización [Analysis Services]"
  - "grupos de miembros [Analysis Services]"
  - "agrupar miembros"
  - "DiscretizationNumber, propiedad"
  - "criterios de ordenación [Analysis Services]"
  - "DiscretizationMethod, propiedad"
  - "agregar miembros a un grupo de miembros"
  - "grupos de miembros, número"
  - "miembros [Analysis Services], grupos"
  - "nombres [Analysis Services], grupos de miembros"
...
manager: "erikre"
---
# Agrupar miembros de atributos (discretizaci&#243;n)
