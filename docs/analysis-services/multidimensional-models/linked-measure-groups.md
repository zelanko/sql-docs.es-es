...
ms.topic: "article"
helpviewer_keywords: 
  - "grupos de medida vinculados [Analysis Services]"
  - "grupos de medida, hacer referencia a"
  - "Asistente para grupo de medida vinculado"
  - "grupos de medida [Analysis Services], vinculados"
...
## Crear o modificar una medida vinculada  
