...
ms.topic: "article"
helpviewer_keywords: 
  - "SSAS, interfaces de acceso a datos"
  - "objetos [Analysis Services], interfaces de acceso a datos"
  - "interfaces de acceso a datos de Analysis Services"
  - "recuperación de datos [Analysis Services]"
  - "recuperar datos"
  - "metadatos [Analysis Services]"
  - "interfaces de acceso a datos [Analysis Services]"
  - "manipular objetos [Analysis Services]"
  - "interfaces de acceso a datos de Analysis Services, acerca de las interfaces de acceso a datos"
...
### SQL Server Management Studio  
 Para los administradores de bases de datos, SQL Server Management Studio es un entorno integrado para administrar las instancias de SQL Server, por ejemplo instancias de Analysis Services y bases de datos multidimensionales. Para obtener más información, vea [SQL Server Management Studio](../Topic/SQL%20Server%20Management%20Studio.md) y [Conectar a Analysis Services](../../../analysis-services/instances/connect-to-analysis-services.md).  
