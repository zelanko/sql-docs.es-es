...
ms.topic: "article"
helpviewer_keywords: 
  - "propiedades de celda intrínsecas [MDX]"
  - "celdas [MDX]"
  - "propiedades de celda [MDX]"
  - "CELL PROPERTIES, palabra clave"
...
|**BACK_COLOR**|Color de fondo para mostrar las propiedades **VALUE** o **FORMATTED_VALUE**. Para obtener más información, vea [Contenido de FORE_COLOR y BACK_COLOR &#40;MDX&#41;](../../../analysis-services/multidimensional-models/mdx/fore-color-and-back-color-contents-mdx.md).|  
...
|**FORE_COLOR**|Color de primer plano para mostrar las propiedades **VALUE** o **FORMATTED_VALUE**. Para obtener más información, vea [Contenido de FORE_COLOR y BACK_COLOR &#40;MDX&#41;](../../../analysis-services/multidimensional-models/mdx/fore-color-and-back-color-contents-mdx.md).|  
|**FORMAT**|Equivalente a **FORMAT_STRING**.|  
|**FORMAT_STRING**|Cadena de formato usada para crear el valor de la propiedad **FORMATTED_VALUE**. Para obtener más información, vea [FORMAT_STRING, contenido &#40;MDX&#41;](../../../analysis-services/multidimensional-models/mdx/format-string-contents-mdx.md).|  
...
|**Valor**|Valor sin formato de la celda.|  
