...
ms.topic: "article"
helpviewer_keywords: 
  - "reescritura [Analysis Services], cubos"
  - "cubos [Analysis Services], modificar"
  - "modificar cubos"
  - "UPDATE CUBE, instrucción"
  - "cubos [Analysis Services], reescribir"
...
## Vea también  
 [Modificar datos &#40;MDX&#41;](../../../analysis-services/multidimensional-models/mdx/modifying-data-mdx.md)  
