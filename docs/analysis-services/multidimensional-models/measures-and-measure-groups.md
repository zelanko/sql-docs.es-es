...
##  <a name="bkmk_measure"></a> Measures  
 ...
 ![Tabla dinámica que muestra repetidas medir valores](../../analysis-services/multidimensional-models/media/ssas-unrelatedmeasure.PNG "valores de medida de tabla dinámica que muestra repetidas")  
