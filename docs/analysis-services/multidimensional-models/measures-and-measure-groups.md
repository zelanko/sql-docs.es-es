...
ms.topic: "article"
helpviewer_keywords: 
  - "grupos de medida [Analysis Services]"
  - "medidas [Analysis Services], acerca de las medidas"
  - "Objetos OLAP [Analysis Services], medidas"
  - "agregado, funciones [Analysis Services]"
  - "granularidad"
  - "grupos de medida [Analysis Services], acerca de los grupos de medida"
...
##  <a name="bkmk_measure"></a> medidas  
 ...
 ![PivotTable con medidas y dimensiones indicadas](../../analysis-services/multidimensional-models/media/ssas-keyconcepts-pivot1-measures-dimensions.png "PivotTable con medidas y dimensiones indicadas")  
