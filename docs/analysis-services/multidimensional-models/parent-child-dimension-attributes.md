...
## <a name="using-data-members"></a>Usar miembros de datos  
 ...
 ![Dimensión del volumen de ventas brutas con tres niveles](../../analysis-services/multidimensional-models/media/agdatamember1.gif "dimensión del volumen de ventas brutas con tres niveles")  
