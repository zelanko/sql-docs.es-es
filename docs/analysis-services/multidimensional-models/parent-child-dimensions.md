---
title: "Dimensiones de elementos primarios y secundarios | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "jerarquías [Analysis Services], principal-secundario"
  - "dimensiones [Analysis Services], principal-secundario"
  - "atributos primarios [Analysis Services]"
  - "miembros de datos [Analysis Services]"
  - "jerarquías [Analysis Services], varios niveles"
  - "autocombinaciones"
  - "relaciones que hacen referencia a sí mismas"
  - "miembros [Analysis Services], datos"
...
## Esquema de dimensiones  
 ...
 ![Combinación con referencia a sí misma en la tabla DimOrganization](../../analysis-services/multidimensional-models/media/dimorganization.png "Combinación con referencia a sí misma en la tabla DimOrganization")  
