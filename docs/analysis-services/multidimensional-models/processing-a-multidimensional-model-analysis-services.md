---
title: "Procesar un modelo multidimensional (Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "modo en línea [Analysis Services]"
  - "procesamiento de objetos [Analysis Services]"
  - "particiones [Analysis Services], procesar"
  - "trabajos [Analysis Services]"
  - "objetos [Analysis Services], procesar"
  - "objetos, volver a procesar"
  - "análisis de impacto [Analysis Services]"
  - "dimensiones [Analysis Services], procesar"
  - "modo de proyecto [Analysis Services]"
  - "objetos [Analysis Services], procesar"
