...
##  <a name="bkmk_DSVrefresh"></a> Actualizar una DSV en SQL Server Data Tools  
 ...
 ![Actualizar vista del origen de datos cuadro de diálogo](../../analysis-services/multidimensional-models/media/ssas-olapdsv-refresh.gif "cuadro de diálogo Actualizar vista del origen de datos")  
