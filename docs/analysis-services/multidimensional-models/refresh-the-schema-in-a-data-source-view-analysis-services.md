...
ms.topic: "article"
helpviewer_keywords: 
  - "vistas del origen de datos [Analysis Services], actualizaciones del esquema"
  - "actualizar vistas del origen de datos"
  - "vistas del origen de datos [Analysis Services], actualizar"
...
##  <a name="bkmk_DSVrefresh"></a> Actualizar una DSV en SQL Server Data Tools  
 ...
 ![Actualizar vista del origen de datos, cuadro de diálogo](../../analysis-services/multidimensional-models/media/ssas-olapdsv-refresh.gif "Actualizar vista del origen de datos, cuadro de diálogo")  
