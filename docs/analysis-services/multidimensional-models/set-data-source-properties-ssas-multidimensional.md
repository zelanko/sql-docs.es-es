...
helpviewer_keywords: 
  - "Propiedades del origen de datos, cuadro de diálogo"
...
## Establecer las propiedades del origen de datos en SQL Server Data Tools  
...
## Establecer las propiedades del origen de datos en Management Studio  
