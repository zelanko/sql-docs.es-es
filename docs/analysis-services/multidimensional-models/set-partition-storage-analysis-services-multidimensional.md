...
ms.topic: "article"
helpviewer_keywords: 
  - "MOLAP de latencia baja"
  - "almacenamiento estándar [Analysis Services]"
  - "OLAP híbrido"
  - "MOLAP automático"
  - "OLAP relacional"
  - "OLAP multidimensional"
  - "MOLAP programado [Analysis Services]"
  - "particiones [Analysis Services], almacenamiento"
  - "HOLAP"
  - "MOLAP"
...
---
# Establecer el almacenamiento de particiones (Analysis Services - Multidimensional)
