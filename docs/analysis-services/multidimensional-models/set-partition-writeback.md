...
ms.topic: "article"
helpviewer_keywords: 
  - "particiones habilitadas para escritura [Analysis Services]"
  - "particiones [Analysis Services], reescritura"
  - "particiones [Analysis Services], habilitadas para escritura"
  - "reescritura [Analysis Services], particiones"
...
---
# Establecer la reescritura de particiones
...
## Cómo habilitar una partición para escritura  
...
## Examinar los datos de reescritura en una partición  
...
## Eliminar datos de reescritura o deshabilitar la reescritura  
...
## Convertir datos de reescritura en una partición  
...
## Vea también  
 [Particiones habilitadas para escritura](../Topic/Write-Enabled%20Partitions.md)   
