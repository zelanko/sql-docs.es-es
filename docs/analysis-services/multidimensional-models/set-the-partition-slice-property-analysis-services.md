---
title: "Establecer la propiedad Slice de particiones (Analysis Services) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "particiones [Analysis Services], segmentos de datos"
  - "segmentos de datos [Analysis Services]"
...
> [!NOTE]  
>  Tenga en cuenta que las funciones MDX dinámicas (como [Generate &#40;MDX&#41;](../../mdx/generate-mdx.md) o [Except &#40;MDX&#41;](../Topic/Except%20\(MDX\).md)) no son compatibles con la propiedad Slice para particiones. Debe definir el segmento utilizando tuplas explícitas o referencias de miembro.  
>   
