...
ms.topic: "article"
helpviewer_keywords: 
  - "generación incremental [Analysis Services]"
  - "Asistente para generar esquemas, generación incremental"
  - "esquema relacional [Analysis Services], generación incremental"
