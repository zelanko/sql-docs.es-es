...
---
# Descripci&#243;n de Power View para modelos multidimensionales
 ...
 **Arquitectura de Power View para modelos multidimensionales**  
 ...
 ![Arquitectura de Power View para modelos multidimensionales](../../analysis-services/multidimensional-models/media/daxmd-architecture.gif "Arquitectura de Power View para modelos multidimensionales")  
 ...
 **Grupos de medida en la lista de campos de Power View**  
 ...
 ![Lista de campos de Power View](../../analysis-services/multidimensional-models/media/daxmd-powerviewfieldlist.gif "Lista de campos de Power View")  
 ...
 **Tipos geography de atributos de dimensión en SSDT y en la lista de campos de Power View**  
 ...
 ![Tipos de geografía de atributos de dimensión](../../analysis-services/multidimensional-models/media/daxmd-ssdt-attribute-geog-types.gif "Tipos de geografía de atributos de dimensión")  
...
## Filtros anclados de Power View  
 ...
 **Filtros anclados**  
 ...
 ![Filtro anclado](../../analysis-services/multidimensional-models/media/daxmd-pinnedfilterinpowerview.gif "Filtro anclado")  
...
## Ayuda de cliente en Office.com  
