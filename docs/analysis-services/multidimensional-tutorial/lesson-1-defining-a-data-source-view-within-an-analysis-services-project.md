...
En esta tarea, especificará la **AdventureWorksDW** base de datos como origen de datos para el [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] dimensiones y cubos que definirá en lecciones posteriores.  
  
[Definir una vista del origen de datos](lesson-1-3-defining-a-data-source-view.md)  
En esta tarea, definirá una única vista unificada de los metadatos de las tablas seleccionadas en el **AdventureWorksDW** base de datos.  
  
[Modificar los nombres de tabla predeterminados](lesson-1-4-modifying-default-table-names.md)  
En esta tarea, modificará los nombres de tabla en la vista del origen de datos, para que los nombres de los siguientes [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] son más fáciles de usar los objetos que definen.  
