...
Para obtener más información, consulte [Dimensiones de elementos primarios y secundarios](../multidimensional-models/parent-child-dimension.md) y [Atributos en las jerarquías de elementos primarios y secundarios](../multidimensional-models/parent-child-dimension-attributes.md)  
...
10. ![Tabla dinámica que muestra la jerarquía Employees](../media/l4-employee-1.gif "tabla dinámica que muestra la jerarquía Employees")  
...
4.  En la segunda fila, la fila **\*** , escriba **Employee Level \*** en la columna **Nombre** y después haga clic en la tercera fila.  
    ...
    ![Cuadro de diálogo plantilla de nomenclatura nivel](../media/l4-namingtemplate.gif "cuadro de diálogo plantilla de nivel de nomenclatura")  
...
5.  Arrastre la jerarquía **Employees** hasta el área Etiquetas de fila.  
    ...
    ![Puede modificar la jerarquía Employees](../media/l4-employee-2.png "jerarquía Employees modificado")  
  
## <a name="next-task-in-lesson"></a>Siguiente tarea de la lección  
[Agrupar miembros de atributo automáticamente](lesson-4-3-automatically-grouping-attribute-members.md)  
  
## <a name="see-also"></a>Vea también  
[Dimensiones de elementos primarios y secundarios](../multidimensional-models/parent-child-dimension.md)  
