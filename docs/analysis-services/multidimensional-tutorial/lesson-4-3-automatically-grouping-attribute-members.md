...
5.  En la ventana Propiedades, cambie el valor de la propiedad **DiscretizationMethod** por **Automática** y el valor de la propiedad **DiscretizationBucketCount** por **5**.  
    ...
    ![Las propiedades modificadas de Yearly Income](../media/l4-discretizationmethod-1.gif "propiedades modificadas de Yearly Income")  
...
9. En la lista de campos, expanda la dimensión **Employee** , expanda **Organization**y arrastre **Sick Leave Hours** hasta **Etiquetas de columna**.  
    ...
    ![Horas de baja Sales con dimensión por baja por enfermedad del empleado](../media/l4-discretizationmethod-2.gif "Sales con dimensión por baja por enfermedad del empleado deje horas")  
