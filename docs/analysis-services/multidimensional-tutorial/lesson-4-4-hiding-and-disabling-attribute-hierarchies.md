...
4.  En la ventana Propiedades, establezca el valor de la propiedad **AttributeHierarchyEnabled** en **False** para los atributos seleccionados.  
    ...
    ![Propiedad AttributeHierarchyEnabled establecida en False](../media/l4-hierarchyenabled-1.gif "propiedad AttributeHierarchyEnabled establecida en False")  
...
4.  En la ventana Propiedades, establezca el valor de la propiedad **AttributeHierarchyVisible** en **False** para los atributos seleccionados.  
    ...
    ![La propiedad AttributeHierarchyVisible establecida en False](../media/l4-hierarchyvisible-1.gif "propiedad AttributeHierarchyVisible establecida en False")  
