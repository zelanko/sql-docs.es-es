...
4.  Revise las propiedades de configuración de error de clave y clave NULL, pero no realice ningún cambio.  
    ...
    ![Colección de propiedades ErrorConfiguration](../media/l4-productdimensionerrorconfig-1.gif "colección de propiedades ErrorConfiguration")  
...
6.  Expanda **Components**y, después, expanda el miembro sin etiqueta del nivel **Model Name** .  
    ...
    ![Componentes del ensamblado usados para generar otros componentes](../media/l4-productdimensionerrorconfig-2.gif "componentes del ensamblado usados para generar otros componentes")  
...
4.  Haga clic en la consulta SELECT DISTINCT y, después, en **Ver detalles**.  
    ...
    ![Cláusula SELECT DISTINCT que muestra la cláusula WHERE](../media/l4-productnametraceline-1.gif "cláusula SELECT DISTINCT que muestra la cláusula WHERE")  
...
4.  Expanda el miembro **Assembly Components** del nivel **Category** y luego expanda el miembro **Assembly Components** del nivel **Subcategory** .  
    ...
    ![Nivel Product Name, que muestra los componentes de ensamblado](../media/l4-assemblycomponents-1.gif "nivel Product Name que muestra los componentes de ensamblado")  
