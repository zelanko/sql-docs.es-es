...
3.  Desde la dimensión **Geography** del panel de metadatos, arrastre la jerarquía definida por el usuario **Geographies** hasta el área **Coloque campos de fila aquí** del panel de datos.  
    ...
    ![Dimensionada medida Reseller Sales-Sales Amount](../media/l5-referencedrelationship-1.gif "medida con dimensión Reseller Sales-Sales Amount")  
...
8.  Haga clic en el botón de puntos suspensivos (**...** ) en el **nombre completo** celda en la intersección de la **cliente** dimensión y el **Internet Sales** grupo de medida.  
    ...
    ![Cuadro de diálogo Definir relación](../media/l5-referencedrelationship-4.gif "cuadro de diálogo Definir relación")  
...
3.  En el panel de metadatos, expanda **Reseller Geography**, haga clic con el botón secundario en **Geographies**y, después, haga clic en **Agregar a área de fila**.  
    ...
    ![Cuadro de diálogo Definir relación](../media/l5-referencedrelationship-5.gif "cuadro de diálogo Definir relación")  
