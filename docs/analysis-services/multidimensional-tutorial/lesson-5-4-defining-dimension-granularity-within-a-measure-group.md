...
5.  Expanda la dimensión **Sales Territory** y arrastre la jerarquía definida por el usuario **Sales Territories** hasta las etiquetas de fila.  
    ...
    ![Dimensión de cubo Sales Territory](../media/l5-granularity-2.gif "dimensión de cubo Sales Territory")  
...
7.  En la lista de campos de tabla dinámica, seleccione la jerarquía definida por el usuario **Sales Territories** y haga clic en la flecha hacia abajo de la derecha.  
    ...
    ![Jerarquía Sales Territories en la lista de campos](../media/l5-granularity-1a.png "jerarquía Sales Territories en la lista de campos")  
  
8.  En el filtro, haga clic en la casilla Seleccionar todo para desactivar todas las casillas y elija solo **North America**.  
  
    ![Panel de filtro para seleccionar North America](../media/l5-granularity-1b.png "panel Filtro para seleccionar North America")  
...
11. En la tabla dinámica, haga clic en la flecha hacia abajo que aparece junto a Etiquetas de fila. Desactive todos los años excepto **FY 2008**.  
    ...
    ![Los valores de Sales Amount, cuota](../media/l5-granularity-3.png "cuota de importe de los valores de ventas")  
...
8.  Expanda sucesivamente **FY 2008**, **H1 FY 2008**y **Q1 FY 2008**.  
    ...
    ![Grupo de medida Sales quota con dimensiones correctas](../media/l5-granularity-7.gif "grupo medida Sales Quota bien dimensionado")  
...
[Definir relaciones normales y propiedades de las relaciones normales](../multidimensional-models/define-a-regular-relationship-and-regular-relationship-properties.md)  
