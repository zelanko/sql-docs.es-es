...
ms.locfileid: "65403767"
---
# <a name="lesson-5-defining-relationships-between-dimensions-and-measure-groups"></a>Lección 5: Definición de relaciones entre dimensiones y grupos de medida
...
En esta tarea, aprenderá a vincular una dimensión a una tabla de hechos indirectamente a través de una dimensión que está vinculada directamente a través de una relación de clave externa para la clave principal.  
