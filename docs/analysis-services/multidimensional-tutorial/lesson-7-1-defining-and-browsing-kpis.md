...
1.  Abra el Diseñador de cubos para el cubo Tutorial de [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] y, después, haga clic en la pestaña **KPI**.  
    ...
    ![Pestaña KPI del Diseñador de cubos](../media/l7-kpi-1.gif "pestaña KPI del Diseñador de cubos")  
...
2.  En la barra de herramientas de la pestaña **KPI** , haga clic en el botón **Nuevo KPI** .  
    ...
    ![Plantilla KPI en blanco en el panel de información](../media/l7-kpi-2.gif "plantilla KPI en blanco en el panel de información")  
...
2.  En el cuadro **Nombre** , escriba **Product Gross Profit Margin**y, después, compruebe que aparece **<All>** en la lista **Grupo de medida asociado** .  
