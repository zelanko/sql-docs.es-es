...
1.  Cambie al Diseñador de cubos para el cubo Tutorial de [!INCLUDE[ssASnoversion](../../includes/ssasnoversion-md.md)] y, después, cambie a la pestaña **Traducciones**.  
    ...
    ![En la pestaña traducciones del idioma predeterminado](../media/l9-translations-5.gif "en la pestaña traducciones del idioma predeterminado")  
...
5.  En la barra de herramientas, seleccione **Español (España)** en la lista **Idioma** .  
    ...
    ![Panel de metadatos Repopulated](../media/l9-translations-6.gif "Repopulated el panel de metadatos")  
...
9. En el panel de metadatos, haga clic con el botón derecho en **Mes del año** y seleccione **Agregar a consulta**.  
    ...
    ![Nombres de los meses en español en el panel datos](../media/l9-translations-7.gif "nombres de los meses en español en el panel de datos")  
