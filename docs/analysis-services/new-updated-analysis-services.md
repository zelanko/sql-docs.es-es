...
1. [Compatibilidad con versiones anteriores de Analysis Services (SQL 2017)](analysis-services-backward-compatibility-sql2017.md)
2. [Seguridad de nivel de objeto](tabular-models/object-level-security.md)
