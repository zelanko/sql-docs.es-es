...
ms.topic: "article"
helpviewer_keywords: 
  - "actualización de datos desatendida [Analysis Services con SharePoint]"
  - "actualización de datos programada [Analysis Services con SharePoint]"
  - "actualizar datos [Analysis Services con SharePoint]"
...
-   [Configurar la cuenta de actualización de datos desatendida de PowerPivot (PowerPivot para SharePoint)](http://msdn.microsoft.com/es-es/81401eac-c619-4fad-ad3e-599e7a6f8493)  
  
-   [Configurar las credenciales almacenadas para la actualización de datos PowerPivot (PowerPivot para SharePoint)](http://msdn.microsoft.com/es-es/987eff0f-bcfe-4bbd-81e0-9aca993a2a75)  
  
-   [Programar una actualización de datos (Power Pivot para SharePoint)](http://msdn.microsoft.com/es-es/8571208f-6aae-4058-83c6-9f916f5e2f9b)  
