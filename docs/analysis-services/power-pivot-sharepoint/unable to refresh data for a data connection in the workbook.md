---
title: "No pueden actualizar los datos de una conexi&#243;n de datos del libro. Vuelva a intentarlo o p&#243;ngase en contacto con el administrador del sistema. No se pudieron actualizar las siguientes conexiones: datos Power Pivot | Microsoft Docs"
ms.custom: ""
ms.date: "03/13/2017"
...
manager: "erikre"
---
# No pueden actualizar los datos de una conexi&#243;n de datos del libro. Vuelva a intentarlo o p&#243;ngase en contacto con el administrador del sistema. No se pudieron actualizar las siguientes conexiones: datos Power Pivot
 ...
 **Escenario 2a: abrir un libro de la versión anterior en el servidor**  
 ...
 Si es así, aparecerá este mensaje en el registro de ULS: "Error al actualizar para 'datos de [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)]' en el libro '\<dirección URL al libro>'", seguido de "Unable to get a connection" (No se puede establecer una conexión).  
