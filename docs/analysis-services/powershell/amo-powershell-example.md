---
title: "Ejemplo de PowerShell AMO | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
---
# Ejemplo de PowerShell AMO
  El siguiente es un ejemplo de un script de PowerShell que llama a tipos de objetos de administración de Analysis Services (AMO) para crear una base de datos tabular (nivel de compatibilidad 1200) basada en una base de datos relacional SQL Server.  
  
 Este ejemplo tiene como único fin realizar una demostración. No se detiene en la definición de las relaciones de tabla y no incluye importación de datos.  Esto hace que el script sea más un fragmento de código que código listo para ejecución. Para que sea ejecutable, necesitaría otras funciones auxiliares y más comandos para rellenar los huecos.  
  
## Ejemplo de DatabaseGenerate.ps1  
...
## Vea también  
 ...
 [Referencia de Analysis Services PowerShell](../../analysis-services/powershell/analysis-services-powershell-reference.md)   
 [Objetos de administración de Analysis Services &#40;AMO&#41;](../Topic/Analysis%20Services%20Management%20Objects%20\(AMO\).md)   
