...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../includes/ssas-appliesto-sqlas-aas.md)]Permite que un administrador de base de datos ejecutar un script XMLA, expresiones multidimensionales (MDX), las instrucciones de extensiones de minería de datos (DMX) o secuencia de comandos de Tabular Model Scripting Language (TMSL).  
