...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../includes/ssas-appliesto-sqlas-aas.md)]Quitar a un miembro del rol especificado de una base de datos de Analysis Services.  
