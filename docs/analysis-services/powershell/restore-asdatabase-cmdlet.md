...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../includes/ssas-appliesto-sqlas-aas.md)]Restaura un archivo de copia de seguridad (.abf) de la base de datos Multidimensional o Tabular a una instancia de Analysis Services.  
