...
## Description  
 ...
 Para comprobar los cambios, ejecute el cmdlet siguiente: Get-PowerPivotServiceApplication -Identity \<GUID> | lista-de-formatos.  
...
### -AllowCustomWindowsCredentials [\<parámetroDeModificador>]  
...
### -HealthBasedAllocation \<modificador>  
...
### -RoundRobinAllocation \<modificador>  
