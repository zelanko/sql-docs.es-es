...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]Establece las propiedades globales del objeto PowerPivotSystemService en el nivel de granja de servidores.  
