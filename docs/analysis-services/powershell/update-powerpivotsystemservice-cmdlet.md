...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]Actualiza el objeto primario de la [!INCLUDE[ssGemini](../../includes/ssgemini-md.md)] servicio del sistema en la granja de servidores.  
