...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Devuelve las estadísticas DISCOVER_MEMORYUSAGE para diversos objetos asignados por el servidor.  
