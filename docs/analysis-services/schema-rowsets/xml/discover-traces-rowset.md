...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Proporciona información acerca de los seguimientos que están actualmente activas en el servidor.  
