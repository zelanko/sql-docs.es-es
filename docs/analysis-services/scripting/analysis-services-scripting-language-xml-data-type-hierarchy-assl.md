...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]En la tabla siguiente muestra la jerarquía de herencia de tipos de datos de Analysis Services Scripting Language (ASSL).  
