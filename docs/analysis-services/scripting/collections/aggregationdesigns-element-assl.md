...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Contiene la colección de diseños de agregaciones que se pueden compartir entre varias particiones en una base de datos.  
