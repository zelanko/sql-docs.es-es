---
title: Tipo de datos DataSourceViewBinding (ASSL) | Documentos de Microsoft
ms.custom: ''
ms.date: 03/03/2017
...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Define un tipo de datos derivado que representa un enlace entre una vista del origen de datos y el elemento primario.  
...
|Elementos secundarios|[DataSourceViewID](../../../analysis-services/scripting/properties/datasourceviewid-element-assl.md)|  
