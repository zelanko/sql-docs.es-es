...
# <a name="olapdatasource-data-type-assl"></a>Tipo de datos OlapDataSource (ASSL)
  Define un tipo de datos derivado que representa un multidimensionales [DataSource](../../../analysis-services/scripting/objects/datasource-element-assl.md) elemento.  
