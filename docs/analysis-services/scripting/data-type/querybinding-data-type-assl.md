...
# <a name="querybinding-data-type-assl"></a>Tipo de datos QueryBinding (ASSL)
  Define un tipo de datos derivado que representa la asociación de un [DataSource](../../../analysis-services/scripting/objects/datasource-element-assl.md) elemento con un [QueryDefinition](../../../analysis-services/scripting/properties/querydefinition-element-assl.md) elemento.  
