...
# <a name="relationaldatasource-data-type-assl"></a>Tipo de datos RelationalDataSource (ASSL)
  Define un tipo de datos derivado que representa un [DataSource](../../../analysis-services/scripting/objects/datasource-element-assl.md) elemento basado en un origen de datos relacional.  
