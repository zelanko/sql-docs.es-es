...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Especifica que un [seguimiento](../../../analysis-services/scripting/objects/trace-element-assl.md) elemento no puede quitar cualquier evento, aún cuando esto produce una reducción del rendimiento en el servidor.  
