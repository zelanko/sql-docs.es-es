...
ms.locfileid: "34030126"
---
# <a name="calendarenddate-element-assl"></a>Elemento CalendarEndDate (ASSL)
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]
  Define la fecha final del período del calendario para un [TimeBinding](../../../analysis-services/scripting/data-type/timebinding-data-type-assl.md) elemento.  
