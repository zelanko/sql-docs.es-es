...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Contiene un fragmento del documento XML que describe la [seguimiento](../../../analysis-services/scripting/objects/trace-element-assl.md) filtro.  
