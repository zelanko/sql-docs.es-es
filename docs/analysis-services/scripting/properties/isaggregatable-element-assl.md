...
# <a name="isaggregatable-element-assl"></a>Elemento IsAggregatable (ASSL)
  Especifica si los valores de la [DimensionAttribute](../../../analysis-services/scripting/data-type/dimensionattribute-data-type-assl.md) se puede agregar el elemento.  
