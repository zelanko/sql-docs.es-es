...
## <a name="remarks"></a>Notas  
 El **OrderByAttributeID** elemento es utiliza únicamente cuando el valor de la [OrderBy](../../../analysis-services/scripting/properties/orderby-element-assl.md) (elemento) para el **DimensionAttribute** está establecido en *AttributeKey* o *AttributeName*.  
