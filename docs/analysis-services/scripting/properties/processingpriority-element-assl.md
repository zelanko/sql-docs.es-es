...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Determina la prioridad de procesamiento del objeto primario durante operaciones en segundo plano, por ejemplo diferido de agregaciones, indización o la agrupación en clústeres.  
