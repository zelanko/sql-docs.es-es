...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Especifica el intervalo en el que se actualizan los datos enlazados asociados con el elemento primario.  
