...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Contiene el identificador (ID) del atributo de origen en el que el [nivel](../../../analysis-services/scripting/objects/level-element-assl.md) se basa el elemento.  
