...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Especifica la fecha y hora en que un [seguimiento](../../../analysis-services/scripting/objects/trace-element-assl.md) debe dejar de elemento.  
