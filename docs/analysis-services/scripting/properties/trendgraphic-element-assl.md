...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Contiene la representación gráfica recomendada de la tendencia de la [Kpi](../../../analysis-services/scripting/objects/kpi-element-assl.md) elemento.  
