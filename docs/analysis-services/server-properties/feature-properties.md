...
ms.topic: "reference"
helpviewer_keywords: 
  - "SQMSupportEnabled, propiedad"
  - "ComUdfEnabled, propiedad"
  - "LinkToOtherInstanceEnabled, propiedad"
  - "ManagedCodeEnabled, propiedad"
  - "ConnStringEncryptionEnabled, propiedad"
  - "LinkFromOtherInstanceEnabled, propiedad"
  - "LinkInsideInstanceEnabled, propiedad"
  - "UseCachedPageAllocators, propiedad"
