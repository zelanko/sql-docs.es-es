...
[!INCLUDE[ssas-appliesto-sqlas](../../../includes/ssas-appliesto-sqlas.md)]Una medida calculada es una expresión DAX con nombre que se evalúa cada vez que se utiliza.  
