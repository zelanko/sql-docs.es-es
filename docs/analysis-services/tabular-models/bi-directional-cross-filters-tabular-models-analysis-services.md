---
title: "Filtros cruzados bidireccionales para modelos tabulares en SQL Server 2016 Analysis Services | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/07/2017"
...
---
# Filtros cruzados bidireccionales para modelos tabulares en SQL Server 2016 Analysis Services
 ...
 En SSDT, la mecánica de configuración de un filtro cruzado se realiza a través de la opción Dirección de filtro del cuadro de diálogo de relaciones de tabla. Esta característica solo está disponible para los modelos tabulares creados en el nivel de compatibilidad 1200 en [SQL Server Data Tools para Visual Studio 2015 (SSDT)](http://go.microsoft.com/fwlink/p/?LinkID=627574).  
...
4.  Compruebe que el nivel de compatibilidad del modelo está establecido en **SQL Server 2016 RTM (1200)**.  
...
### Revisar las relaciones de tabla predeterminadas  
...
## Vea también  
 ...
 [A practical example of how to handle simple many-to-many relationships in Power Pivot and SSAS tabular models (Ejemplo práctico de cómo administrar relaciones de varios a varios sencillas en modelos tabulares de SSAS y Power Pivot)](http://social.technet.microsoft.com/wiki/contents/articles/22202.a-practical-example-of-how-to-handle-simple-many-to-many-relationships-in-power-pivotssas-tabular-models.aspx)   
