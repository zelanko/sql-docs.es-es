...
---
# Tipos de datos compatibles (SSAS tabular)
...
|BLANK AND BLANK|BLANK|Error|  
 ...
 Para obtener información detallada sobre cómo una determinada función u operador trata los valores en blanco, vea los temas de cada función DAX en la sección [Referencia de funciones DAX](http://msdn.microsoft.com/es-es/4dbb28a1-dd1a-4fca-bcd5-e90f74864a7b).  
