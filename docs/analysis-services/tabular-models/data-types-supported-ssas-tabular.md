---
title: Tipos de datos admitidos en los modelos tabulares de Analysis Services | Microsoft Docs
ms.date: 05/07/2018
ms.prod: sql
...
-   Si intenta concatenar dos números, se presentan como cadenas y luego se concatenan. La expresión siguiente devuelve  "1234": = 12 & 34  
