---
title: "Definici&#243;n de particiones en los modelos DirectQuery (SSAS Tabular) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/01/2017"
...
---
# Definici&#243;n de particiones en los modelos DirectQuery (SSAS Tabular)
...
## Cambio de una partición DirectQuery  
...
|DataView=Sample<br /><br /> Se aplica a los modelos Tabular 1200 mediante vistas de datos de ejemplo|Permitir procesar la partición|Si el modelo utiliza datos de ejemplo, puede procesar la tabla para que devuelva un conjunto de datos filtrado que proporciona indicaciones visuales durante el diseño del modelo.|  
