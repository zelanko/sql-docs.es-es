...
#### Para eliminar una columna de tabla de modelo  
...
#### Para eliminar una columna de tabla de modelo mediante el cuadro de diálogo Propiedades de tabla  
