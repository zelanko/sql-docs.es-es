...
## Aspectos que se deben tener en cuenta al eliminar relaciones  
...
#### Para eliminar una relación utilizando la Vista de diagrama  
...
#### Para eliminar una relación utilizando el cuadro de diálogo Administrar relaciones  
