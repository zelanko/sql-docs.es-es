---
title: Importar desde Analysis Services | Microsoft Docs
ms.date: 05/07/2018
ms.prod: sql
...
ms.locfileid: "68162824"
---
# <a name="import-from-analysis-services"></a>Importar desde Analysis Services 
[!INCLUDE[ssas-appliesto-sqlas-aas](../../includes/ssas-appliesto-sqlas-aas.md)]
  En este artículo se describe cómo crear un nuevo proyecto de modelos tabulares importando los metadatos de un modelo tabular existente mediante la importación de la plantilla de proyecto de servidor en [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)].  
