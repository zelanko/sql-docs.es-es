...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../includes/ssas-appliesto-sqlas-aas.md)]Después de haber agregado tablas y datos en un modelo mediante el Asistente para importación de tabla, puede empezar a trabajar con las tablas agregando nuevas columnas de datos, crear relaciones entre tablas, definiendo cálculos que amplían los datos y filtrando y ordenando datos en las tablas para facilitar su visualización.  
