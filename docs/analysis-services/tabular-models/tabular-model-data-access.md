...
### DAX  
 ...
 Para obtener ejemplos de consultas en un modelo tabular con DAX, vea [Referencia de la sintaxis de las consultas DAX](http://msdn.microsoft.com/es-es/4dd0cf0e-191d-411d-987c-f606813fc39e).  
...
-   Ejemplos de AdventureWorks en Codeplex  
 ...
 Puede utilizar PowerShell para administrar y supervisar las instancias de Analysis Services, así como para crear y supervisar la seguridad que se usa para el acceso al modelo tabular. Para más información, vea [PowerShell scripting in Analysis Services](../../analysis-services/instances/powershell-scripting-in-analysis-services.md) (Scripting de PowerShell en Analysis Services).  
...
-   [Conjunto de filas DISCOVER_XEVENT_TRACE_DEFINITION](../Topic/DISCOVER_XEVENT_TRACE_DEFINITION%20Rowset.md)  
