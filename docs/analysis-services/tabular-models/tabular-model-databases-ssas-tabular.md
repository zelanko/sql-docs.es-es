---
title: Bases de datos de modelo tabular de Analysis Services | Microsoft Docs
ms.date: 05/07/2018
ms.prod: sql
...
## <a name="in-this-section"></a>En esta sección  
 ...
 [Roles de modelos tabulares](../../analysis-services/tabular-models/tabular-model-roles-ssas-tabular.md)  
 ...
 [Restaurar desde Power Pivot](../../analysis-services/tabular-models/restore-from-power-pivot.md)  
