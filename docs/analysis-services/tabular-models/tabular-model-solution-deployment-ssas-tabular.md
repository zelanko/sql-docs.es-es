...
|------------|-----------------|----------|  
|**Implementar el comando en Herramientas de datos de SQL Server**|El comando Implementar proporciona un método sencillo e intuitivo para implementar un proyecto de modelos tabulares del entorno de creación de [!INCLUDE[ssBIDevStudio](../../includes/ssbidevstudio-md.md)] .<br /><br /> **\*\* Precaución \*\*** Este método no se debe usar para implementar servidores de producción. Con este método, puede sobrescribir ciertas propiedades de un modelo existente.|[Implementar con SQL Server Data Tools &#40;SSAS tabular&#41;](../../analysis-services/tabular-models/deploy-from-sql-server-data-tools-ssas-tabular.md)|  
