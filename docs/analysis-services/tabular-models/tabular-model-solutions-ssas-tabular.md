---
title: Soluciones de modelos tabulares (SSAS Tabular) | Documentos de Microsoft
ms.date: 05/22/2017
...
---
# <a name="creating-tabular-models"></a>Crear modelos tabulares
[!INCLUDE[ssas-appliesto-sqlas-aas](../../includes/ssas-appliesto-sqlas-aas.md)]Temas de esta sección proporcionan información acerca de cómo crear modelos tabulares mediante el Diseñador de modelos tabulares en [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)].  
