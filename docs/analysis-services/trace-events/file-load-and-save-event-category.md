...
[!INCLUDE[ssas-appliesto-sqlas](../../includes/ssas-appliesto-sqlas.md)]La categoría de eventos cargar y guardar archivos tiene las clases de eventos se describen en la tabla siguiente.  
