...
Este tema es parte de un tutorial de creación de modelos tabulares, que se debe completar en orden. Antes de realizar las tareas en esta lección, debe haber completado la lección anterior: [Lección 9: Crear jerarquías](lesson-9-create-hierarchies.md).  
...
Vaya a la lección siguiente: [Lección 11: Crear Roles](lesson-11-create-roles.md). 
