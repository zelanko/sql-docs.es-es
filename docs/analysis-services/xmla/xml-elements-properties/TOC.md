# [Propiedades de elementos XML](xml-elements-properties.md)
...
# [Elemento PropertyList: Propiedades XMLA compatibles](propertylist-element-supported-xmla-properties.md)
