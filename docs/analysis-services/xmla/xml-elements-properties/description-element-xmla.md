---
title: Elemento Description (XMLA) | Documentos de Microsoft
ms.custom: 
ms.date: 03/04/2017
...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]Contiene la descripción del elemento primario [Error](../../../analysis-services/xmla/xml-elements-properties/error-element-xmla.md) elemento.  
