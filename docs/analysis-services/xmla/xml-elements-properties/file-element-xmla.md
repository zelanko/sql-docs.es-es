---
title: Archivo de elemento (XMLA) | Microsoft Docs
ms.date: 05/08/2018
ms.prod: sql
...
## <a name="remarks"></a>Notas  
 ...
 Para **copia de seguridad** comandos, el **archivo** elemento determina el nombre del archivo de copia de seguridad creado por el **copia de seguridad** comando. Si no se especifica una ruta de acceso como parte del nombre de archivo, la ruta de acceso especificada en el **BackupDir** se utiliza la propiedad de configuración para la instancia de Analysis Services. Si el archivo especificado ya existe, se produce un error a menos que el **AllowOverwrite** elemento primario **copia de seguridad** comando se establece en **True**.  
  
 Para **restaurar** comandos, el **archivo** elemento determina el nombre del archivo de copia de seguridad para restaurar la **restaurar** comando.  
  
 Para **ubicación** elementos, el **archivo** elemento describe un archivo de copia de seguridad remoto para un [!INCLUDE[ssASnoversion](../../../includes/ssasnoversion-md.md)] instancia que contiene las particiones remotas. Para obtener más información acerca de la copia de seguridad y restaurar particiones remotas, consulte [realizar copias de seguridad, restaurar y sincronizar bases de datos &#40;XMLA&#41;](../../../analysis-services/multidimensional-models-scripting-language-assl-xmla/backing-up-restoring-and-synchronizing-databases-xmla.md).  
