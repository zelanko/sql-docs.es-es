---
title: Elemento Materialize (XMLA) | Documentos de Microsoft
ms.custom: 
ms.date: 03/06/2017
...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]Especifica si se deben materializar las agregaciones diseñadas por el [DesignAggregations](../../../analysis-services/xmla/xml-elements-commands/designaggregations-element-xmla.md) comando.  
