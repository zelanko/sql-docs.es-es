---
title: Elemento MeasureGroupID (XMLA) | Documentos de Microsoft
ms.custom: 
ms.date: 03/06/2017
...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]Identifica un grupo de medida dentro de un elemento primario que contiene una referencia de objeto.  
