...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]
  Contiene las columnas de restricción y datos utilizados por el [Discover](../../../analysis-services/xmla/xml-elements-methods-discover.md) método.  
...
## <a name="remarks"></a>Notas  
 El **restricciones** elemento representa las columnas de restricción y datos utilizados para restringir la información recuperada por el **Discover** método.  
