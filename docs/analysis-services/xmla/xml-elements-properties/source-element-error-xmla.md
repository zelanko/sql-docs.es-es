---
title: Origen de elemento (Error) (XMLA) | Documentos de Microsoft
ms.custom: ''
ms.date: 03/06/2017
...
[!INCLUDE[ssas-appliesto-sqlas-aas](../../../includes/ssas-appliesto-sqlas-aas.md)]Contiene el nombre del componente que generó el elemento primario [Error](../../../analysis-services/xmla/xml-elements-properties/error-element-xmla.md) elemento.  
