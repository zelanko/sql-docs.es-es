...
## <a name="remarks"></a>Notas  
 El **sincronizar** comando usa el **origen** elemento para establecer una conexión con e identificar una base de datos en una instancia de Analysis Services con la que se va a sincronizar la base de datos de destino.  
