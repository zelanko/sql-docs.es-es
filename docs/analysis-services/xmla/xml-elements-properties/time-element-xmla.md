...
# <a name="time-element-xmla"></a>Elemento Time (XMLA)
  Especifica el límite de tiempo utilizado por el comando [DesignAggregations](../../../analysis-services/xmla/xml-elements-commands/designaggregations-element-xmla.md) para diseñar las agregaciones.  
