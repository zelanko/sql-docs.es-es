---
title: XML for Analysis (XMLA) cumplimiento | Microsoft Docs
ms.date: 05/30/2018
ms.prod: sql
...
ms.locfileid: "38051593"
---
# <a name="xml-for-analysis-xmla-compliance"></a>XML for Analysis (XMLA) cumplimiento
[!INCLUDE[ssas-appliesto-sqlas-aas](../../includes/ssas-appliesto-sqlas-aas.md)]  

  La especificación XML for Analysis 1.1 describe un estándar abierto que admite el acceso a datos a orígenes de datos que residen en World Wide Web. En este tema se detalla el nivel de compatibilidad con la especificación de XML for Analysis 1.1 que sea compatible con Azure Analysis Services y SQL Server Analysis Services.  
  
## <a name="compliant-items"></a>Elementos compatibles  
Analysis Services cumple con todos los elementos obligatorios enumerados en la especificación de XML for Analysis 1.1. Además, Analysis Services implementa el elemento opcional siguiente descrito en la especificación de XML for Analysis 1.1.  
