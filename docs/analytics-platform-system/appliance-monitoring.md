...
|Realizar un seguimiento de las alertas de dispositivo.|[Seguimiento de las alertas de dispositivo &#40; Sistema de la plataforma de análisis &#41;](track-appliance-alerts.md)|  
|Determine cuánta capacidad se está usando.|[Ver la utilización de la capacidad &#40; Sistema de la plataforma de análisis &#41;](view-capacity-utilization.md)|  
...
|Cuando se produce un error de clúster, determinar qué clúster de nodo de error.|[Determinar que el nodo de clúster no pudo &#40; Sistema de la plataforma de análisis &#41;](determine-which-cluster-node-failed.md)|  
