...
## <a name="configure-sql-server-pdw-for-remote-table-copy-update-host-names-in-dns"></a><a name="HowToPDW"></a>Configurar PDW de SQL Server para la copia de tabla remota: actualizar nombres de host en DNS  
