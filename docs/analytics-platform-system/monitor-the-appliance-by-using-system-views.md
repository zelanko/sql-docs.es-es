---
title: Monitor con vistas del sistema - Analytics Platform System | Microsoft Docs
description: En este artículo se enumera las vistas del sistema que puede usar para supervisar el dispositivo de sistema de la plataforma de análisis.
author: mzaman1
manager: craigg
ms.prod: sql
...
En este artículo se enumera las vistas del sistema que puede usar para la supervisión de PDW de SQL Server.  
...
PDW de SQL Server incluye vistas del sistema completa que le permiten obtener información detallada sobre el estado del dispositivo, estado y rendimiento. Esta tabla proporciona vínculos a vistas del sistema que se pueden usar para cada capacidad de supervisión.  
