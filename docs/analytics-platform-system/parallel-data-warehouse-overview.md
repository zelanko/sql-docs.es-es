---
title: 'Componentes de almacenamiento de datos: Analytics Platform System en paralelo | Documentos de Microsoft'
description: En este artículo se explica el software del dispositivo y los componentes de software de dispositivo no es de sistema de la plataforma de análisis.
author: mzaman1
manager: craigg
ms.prod: sql
...
En este artículo se explica el software del dispositivo y los componentes de software de dispositivo no es de sistema de la plataforma de análisis.  
