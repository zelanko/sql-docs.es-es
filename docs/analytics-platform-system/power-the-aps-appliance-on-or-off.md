...
6.  Mediante el **Administrador de clústeres de conmutación por error** conectar con el ***appliance_domain *-WFOHST01** de clúster, si se conecta automáticamente y, a continuación, en el panel de navegación, haga clic en **Roles**. En el **Roles** panel:  
...
7.  Si hay una región de HDInsight:  
    ...
    1.  Conéctese al clúster de HDInsight. Para ello, haga doble clic en **Administrador de clústeres de conmutación por error**, seleccione **conectar al clúster**y especifique ***appliance_domain *-WFOHST02** para el nombre del clúster.  
...
8.  Si el dispositivo tiene una región de HDInsight, conéctese al clúster de HDInsight. (Para ello, haga doble clic en **Administrador de clústeres de conmutación por error**, seleccione **conectar al clúster**y especifique ***appliance_domain *-WFOHST01** para el nombre del clúster.)  
