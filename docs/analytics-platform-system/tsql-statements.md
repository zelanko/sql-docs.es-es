...
* [Uso de PIVOT y UNPIVOT](../t-sql/queries/from-using-pivot-and-unpivot.md)
...
* [Establecimiento de alias](../t-sql/queries/aliasing-azure-sql-data-warehouse-parallel-data-warehouse.md)
