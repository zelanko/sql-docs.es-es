---
title: Administración de cargas de trabajo en el sistema de la plataforma de análisis | Documentos de Microsoft
description: Administración de cargas de trabajo en el sistema de la plataforma de análisis.
author: mzaman1
manager: craigg
ms.prod: sql
