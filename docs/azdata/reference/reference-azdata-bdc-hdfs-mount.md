...
description: Use este artículo de referencia para entender los comandos SQL en la herramienta azdata, en particular los comandos bdc hdfs mount.
author: MikeRayMSFT
ms.author: mikeray
