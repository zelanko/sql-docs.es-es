...
---
# <a name="create-and-use-code-snippets-to-quickly-create-transact-sql-t-sql-scripts-in-name-sos"></a>Crear y usar fragmentos de código para crear rápidamente script de Transact-SQL (T-SQL) en [!INCLUDE[name-sos](../includes/name-sos-short.md)]
