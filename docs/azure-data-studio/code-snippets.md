---
title: Crear fragmentos de código en Azure Data Studio | Microsoft Docs
...
1. Abra el *paleta de comandos* (**Ctrl + Mayús + P**) y el tipo *recorte*y seleccione **preferencias: fragmentos de código abierto de usuario**:
