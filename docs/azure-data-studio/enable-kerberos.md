...
- Combinar su macOS con el controlador de dominio de Active Directory por [siguiendo estos pasos](https://support.apple.com/kb/PH26282?viewlocale=en_US&locale=en_US).
