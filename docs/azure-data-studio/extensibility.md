...
Puede registrar información mediante dashboard.insights. Esto es similar a [Tutorial: crear un widget de datos personalizados](https://docs.microsoft.com/en-us/sql/sql-operations-studio/tutorial-build-custom-insight-sql-server)
