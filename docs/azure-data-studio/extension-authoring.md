...
3. Presione **F5** o hacer clic en el icono de depuración y en **Iniciar**.
...
- [Tutorial de la extensión de distribución de teclado](extensions/keymap-extension.md)
- [Tutorial de la extensión de panel](extensions/dashboard-extension.md)
- [Tutorial de la extensión de Notebook](extensions/notebook-extension.md)
- [Tutorial de la extensión de libro de Jupyter](extensions/jupyter-book-extension.md)
- [Tutorial de la extensión de asistente](extensions/wizard-extension.md)