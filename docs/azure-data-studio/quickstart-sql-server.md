...
---
# <a name="quickstart-connect-and-query-sql-server-using-name-sos"></a>Inicio rápido: Conectarse y consultar SQL Server con [!INCLUDE[name-sos](../includes/name-sos-short.md)]
