---
title: Extensión de importación de datos de Azure Studio SQL Server | Microsoft Docs
description: Extensión de importación de SQL Server (versión preliminar) para Azure Data Studio
ms.custom: tools|sos
ms.date: 09/24/2018
