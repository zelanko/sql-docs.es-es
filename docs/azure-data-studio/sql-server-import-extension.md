...
description: Obtenga información sobre cómo instalar y usar la extensión de importación de SQL Server (versión preliminar) para Azure Data Studio, un asistente que convierte archivos .txt y .csv en una tabla SQL.
ms.custom: seodec18
ms.date: 09/24/2018
