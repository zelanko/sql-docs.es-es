...
---
# <a name="enable-or-disable-usage-data-collection-for-name-sos"></a>Habilitación o deshabilitación de la recopilación de datos de uso de [!INCLUDE[name-sos](../includes/name-sos-short.md)]
