...
Este artículo proporciona las últimas actualizaciones y problemas conocidos de la última versión de clústeres de macrodatos de SQL Server.

[!INCLUDE [Limited public preview note](../includes/big-data-cluster-preview-note.md)]

## <a name="ctp-20-october-2018"></a>En CTP 2.0 (octubre de 2018)
