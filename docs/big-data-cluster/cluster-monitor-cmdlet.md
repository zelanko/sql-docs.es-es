---
title: Supervisión del clúster con azdata y kubectl
titleSuffix: SQL Server Big Data Clusters
description: Supervisión de aplicaciones con azdata y kubectl en el clúster de macrodatos de SQL Server 2019.
author: cloudmelon
ms.author: melqin
ms.reviewer: mikeray
...
1. Especifique el nombre de usuario y la contraseña que configuró para el controlador (AZDATA_USERNAME y AZDATA_PASSWORD) durante la implementación.
