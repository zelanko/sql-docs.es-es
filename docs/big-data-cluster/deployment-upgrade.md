...
description: Obtenga información sobre cómo actualizar los [!INCLUDE[big-data-clusters-2019](../includes/ssbigdataclusters-ver15.md)] (versión preliminar) a una nueva versión.
author: MikeRayMSFT
ms.author: mikeray
