---
title: Referencia de azdata bdc control
titleSuffix: SQL Server big data clusters
description: Artículo de referencia para los comandos azdata bdc control.
author: MikeRayMSFT
ms.author: mikeray
...
|     |     |
| --- | --- |
[azdata bdc control status](reference-azdata-bdc-control-status.md) | Comandos de estado del servicio de control.
