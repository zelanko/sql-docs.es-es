...
description: Información sobre un archivo JSON en el que se documenta la estructura de un archivo de configuración de implementación de un clúster de macrodatos de SQL Server 2019.
