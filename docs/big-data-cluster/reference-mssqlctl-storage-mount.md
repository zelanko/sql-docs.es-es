...
|---|---|
| **--mount-path** | Ruta de acceso HDFS que tiene el montaje se cree (destino de montaje). Requerido. |
...
| Parámetros | Descripción |
|---|---|
| **--mount-path** | La ruta de acceso HDFS correspondiente para el montaje en la que se va a eliminar. Requerido. |
