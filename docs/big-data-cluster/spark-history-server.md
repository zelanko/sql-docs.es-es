...
* [Administración de recursos para un clúster Spark en HDInsight](https://docs.microsoft.com/en-us/azure/hdinsight/spark/apache-spark-resource-manager)
* [Configuración de Spark](https://docs.microsoft.com/en-us/azure/hdinsight/spark/apache-spark-settings)
