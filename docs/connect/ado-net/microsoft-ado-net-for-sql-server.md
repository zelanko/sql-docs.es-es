---
title: Microsoft ADO.NET para SQL Server | Documentos de Microsoft
ms.custom: ''
ms.date: 08/08/2017
ms.prod: sql
...
ms.locfileid: "34563913"
---
# <a name="microsoft-adonet-for-sql-server"></a>Microsoft ADO.NET para SQL Server

![Descarga-CTRL+MAYÚS+TAB-dentro de un círculo](../../ssdt/media/download.png)[descargar ADO.NET](../sql-connection-libraries.md#anchor-20-drivers-relational-access)
...
* [Introducción a .NET Core de macOS](https://www.microsoft.com/sql-server/developer-get-started/csharp/macos/)
