...
description: Infórmese sobre los inicios de sesión y la autenticación en SQL Server al usar ADO.NET y dónde encontrar recursos adicionales.
ms.date: 09/26/2019
dev_langs:
- csharp
