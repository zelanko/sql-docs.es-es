...
La conexión de contexto le permite ejecutar las instrucciones Transact-SQL en el mismo contexto que se invocó el código en primer lugar. Para obtener información más detallada, vea [la conexión de contexto](https://go.microsoft.com/fwlink/?LinkId=115395) desde libros en pantalla de SQL Server.
