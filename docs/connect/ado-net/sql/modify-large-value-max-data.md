...
Vea [Usar tipos de datos de valores grandes](/previous-versions/sql/sql-server-2008/ms178158(v=sql.100)) en Libros en pantalla de SQL Server más detalles sobre los tipos de datos de valores grandes.
