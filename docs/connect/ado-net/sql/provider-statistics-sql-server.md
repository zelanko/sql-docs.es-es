...
description: Describe la compatibilidad para obtener SQL Server estadísticas de tiempo de ejecución.
ms.date: 08/15/2019
dev_langs:
- csharp
...
> [!NOTE]
>  Se usa un diccionario para devolver las estadísticas del proveedor porque el número, los nombres y el orden de las estadísticas devueltas pueden cambiar en el futuro. Las aplicaciones no deben basarse en un valor específico que se encuentra en el diccionario, pero en su lugar deben comprobar si el valor está ahí y bifurcar en consecuencia.  
  
En la tabla siguiente se describen los valores estadísticos actuales disponibles. Tenga en cuenta que los nombres de clave para los valores individuales no se localizan en las versiones regionales de Microsoft .NET Framework y .NET Core.  
...
> [!NOTE]
>  En el siguiente ejemplo se usa la base de datos de ejemplo **AdventureWorks** que se incluye con SQL Server. La cadena de conexión proporcionada en el código de ejemplo supone que la base de datos está instalada y disponible en el equipo local. Modifique la cadena de conexión según sea necesario para su entorno.  
