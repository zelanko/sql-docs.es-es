...
1. Conéctese al servidor de origen y obtenga los datos que se van a copiar. Los datos también pueden provienen de otros orígenes, si se pueden recuperar de un objeto <xref:System.Data.IDataReader> o <xref:System.Data.DataTable>.  
...
7. Llame a <xref:Microsoft.Data.SqlClient.SqlBulkCopy.Close%2A> o ajuste las operaciones de copia masiva dentro de una instrucción de `Using`.  
...
## <a name="performing-a-bulk-copy-operation-using-transact-sql-and-the-command-class"></a>Realizar una operación de copia masiva mediante Transact-SQL y la clase Command  
