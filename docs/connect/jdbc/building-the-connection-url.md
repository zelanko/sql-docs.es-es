...
description: Obtenga información sobre el formato de la cadena de conexión que usa el controlador Microsoft JDBC Driver para SQL Server.
ms.custom: ''
ms.date: 01/29/2020
ms.prod: sql
