...
## <a name="example"></a>Ejemplo  
 ...
 Por último, el ejemplo actualiza los datos del conjunto de resultados y, a continuación, llama al método de displayRow personalizado nuevo para mostrarla.  
