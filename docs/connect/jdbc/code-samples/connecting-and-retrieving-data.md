...
|Tema|Descripción|  
|-----------|-----------------|  
|[Ejemplo de URL de conexión](../../../connect/jdbc/code-samples/connection-url-sample.md)|Describe cómo usar una URL de conexión para conectarse a [!INCLUDE[ssNoVersion](../../../includes/ssnoversion_md.md)] y usar una instrucción SQL para recuperar datos.|  
