...
|[Funcionamiento del controlador de seguimiento](../../connect/jdbc/tracing-driver-operation.md)|Describe cómo habilitar el seguimiento cuando se usa el controlador JDBC.|  
|[Solucionar problemas de conectividad](../../connect/jdbc/troubleshooting-connectivity.md)|Describe cómo solucionar problemas de la conectividad de base de datos.|  
