...
ms.locfileid: "42785839"
---
# <a name="overview-of-the-jdbc-driver"></a>Introducción al controlador JDBC
[!INCLUDE[Driver_JDBC_Download](../../includes/driver_jdbc_download.md)]

  Microsoft JDBC Driver 4 (versión preliminar) para SQL Server es un controlador compatible de tipo 4.2 de Java Database Connectivity (JDBC) 2017 que proporciona un acceso sólido a datos a SQL Server 2016 (versión preliminar), SQL Server 2014, SQL Server 2012, SQL Server 2008 R2, SQL Server 2008 y Azure SQL Database.  
