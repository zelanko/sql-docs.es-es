---
title: Método Close (SQLServerPooledConnection) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32828070"
---
# <a name="close-method-sqlserverpooledconnection"></a>Método close (SQLServerPooledConnection)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Cierra la conexión física que este [SQLServerPooledConnection](../../../connect/jdbc/reference/sqlserverpooledconnection-class.md) objeto representa.  
...
## <a name="remarks"></a>Comentarios  
 Este método de cierre especificado por el método de cierre en la interfaz javax.sql.PooledConnection.  
