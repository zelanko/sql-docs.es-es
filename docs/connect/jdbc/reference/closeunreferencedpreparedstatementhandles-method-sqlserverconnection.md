---
title: closeUnreferencedPreparedStatementHandles (método) (SQLServerConnection) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2018
ms.prod: sql
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
 ...
 Fuerza las Naciones Unidas-preparar las solicitudes para cualquier instrucción preparada descartados pendientes que se ejecute.
