---
title: Método getDatabaseMinorVersion (SQLServerDatabaseMetaData) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="return-value"></a>Valor devuelto  
 Un **int** que indica la versión secundaria de la base de datos.  
  
## <a name="exceptions"></a>Excepciones  
 [SQLServerException](../../../connect/jdbc/reference/sqlserverexception-class.md)  
  
## <a name="remarks"></a>Comentarios  
 Este método getDatabaseMinorVersion especificado por el método getDatabaseMinorVersion en la interfaz java.sql.DatabaseMetaData.  
