---
title: Método getDatabaseProductName (SQLServerDatabaseMetaData) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="return-value"></a>Valor devuelto  
 A **cadena** que contiene el nombre de producto de base de datos.  
  
## <a name="exceptions"></a>Excepciones  
 [SQLServerException](../../../connect/jdbc/reference/sqlserverexception-class.md)  
  
## <a name="remarks"></a>Comentarios  
 Este método getDatabaseProductName especificado por el método getDatabaseProductName en la interfaz java.sql.DatabaseMetaData.  
