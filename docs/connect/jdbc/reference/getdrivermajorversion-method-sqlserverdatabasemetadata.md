---
title: Método (SQLServerDatabaseMetaData) getDriverMajorVersion | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="return-value"></a>Valor devuelto  
 Un valor **int** que indica la versión primaria del controlador JDBC.  
