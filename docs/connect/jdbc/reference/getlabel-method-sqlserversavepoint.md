---
title: Método getLabel (SQLServerSavepoint) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="return-value"></a>Valor devuelto  
 A **cadena** que contiene el nombre de la etiqueta de punto de retorno.  
