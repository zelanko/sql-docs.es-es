---
title: Método getMajorVersion (SQLServerDriver) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  Devuelve el número de versión principal de la [!INCLUDE[jdbcNoVersion](../../../includes/jdbcnoversion_md.md)].  
...
## <a name="return-value"></a>Valor devuelto  
 Un **int** que contiene el número de versión principal del controlador JDBC.  
  
## <a name="remarks"></a>Comentarios  
 Este método getMajorVersion especificado por el método getMajorVersion en la interfaz java.sql.Driver.  
