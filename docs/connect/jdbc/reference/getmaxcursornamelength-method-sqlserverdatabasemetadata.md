---
title: Método getMaxCursorNameLength (SQLServerDatabaseMetaData) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Comentarios  
 Este método getMaxCursorNameLength especificado por el método getMaxCursorNameLength en la interfaz java.sql.DatabaseMetaData.  
