---
title: Método getMaxIndexLength (SQLServerDatabaseMetaData) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  Recupera el número máximo de bytes que esta base de datos permite para un índice, incluidos todos los elementos del índice.  
