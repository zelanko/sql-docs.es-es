...
## <a name="remarks"></a>Notas  
 Este método getMaxProcedureNameLength se especifica mediante el método getMaxProcedureNameLength en la interfaz java. SQL. DatabaseMetaData.  
