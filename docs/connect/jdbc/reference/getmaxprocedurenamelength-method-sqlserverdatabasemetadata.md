---
title: Método getMaxProcedureNameLength (SQLServerDatabaseMetaData) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="return-value"></a>Valor devuelto  
 Un **int** que indica el número máximo de caracteres permitidos.  
  
## <a name="exceptions"></a>Excepciones  
 [SQLServerException](../../../connect/jdbc/reference/sqlserverexception-class.md)  
  
## <a name="remarks"></a>Comentarios  
 Este método getMaxProcedureNameLength especificado por el método getMaxProcedureNameLength en la interfaz java.sql.DatabaseMetaData.  
