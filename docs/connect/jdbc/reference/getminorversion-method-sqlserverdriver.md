---
title: Método getMinorVersion (SQLServerDriver) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  Devuelve el número de versión secundaria del [!INCLUDE[jdbcNoVersion](../../../includes/jdbcnoversion_md.md)].  
