---
title: Método getPooledConnection (SQLServerConnectionPoolDataSource) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
|Nombre|Description|  
|----------|-----------------|  
|[(de getPooledConnection)](../../../connect/jdbc/reference/getpooledconnection-method.md)|Intenta establecer una conexión a bases de datos físicas que se pueda utilizar como una conexión agrupada.|  
