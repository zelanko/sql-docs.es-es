---
description: Método getReference (SQLServerXADataSource)
title: Método getReference (SQLServerXADataSource) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "88434817"
---
# <a name="getreference-method-sqlserverxadatasource"></a>Método getReference (SQLServerXADataSource)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Devuelve una referencia a este objeto [SQLServerXADataSource](../../../connect/jdbc/reference/sqlserverxadatasource-class.md).  
