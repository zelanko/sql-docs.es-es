---
title: Método getSavepointName (SQLServerSavepoint) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="return-value"></a>Valor devuelto  
 A **cadena** que contiene el nombre del punto de retorno.  
  
## <a name="exceptions"></a>Excepciones  
 [SQLServerException](../../../connect/jdbc/reference/sqlserverexception-class.md)  
  
## <a name="remarks"></a>Comentarios  
 Este método getSavepointName especificado por el método getSavepointName en la interfaz java.sql.Savepoint.  
