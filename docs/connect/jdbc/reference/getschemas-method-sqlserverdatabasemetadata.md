...
|Nombre|Description|  
|----------|-----------------|  
|[getSchemas (método)&#40;&#41;](../../../connect/jdbc/reference/getschemas-method.md)|Recupera los nombres de esquema que están disponibles en la base de datos actual.|  
