---
description: Método getSuperTypes (SQLServerDatabaseMetaData)
...
## <a name="remarks"></a>Observaciones  
 El método getSuperTypes especifica este método getSuperTypes en la interfaz java.sql.DatabaseMetaData.  
