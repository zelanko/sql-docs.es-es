---
title: getTime (método) (SQLServerCallableStatement) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.author: genemi
manager: craigg
ms.openlocfilehash: 4170d3d7f0c5da868d71fb6bc05dc10202218443
...
|[getTime (int, java.util.Calendar)](../../../connect/jdbc/reference/gettime-method-int-java-util-calendar.md)|Recupera el valor del parámetro designado como un objeto java.sql.Time en el Java según el índice del parámetro, el lenguaje de programación que se usa el objeto de calendario determinado.|  
...
|[getTime (java.lang.String, java.util.Calendar)](../../../connect/jdbc/reference/gettime-method-java-lang-string-java-util-calendar.md)|Recupera el valor del parámetro designado como un objeto java.sql.Time en el Java según el nombre del parámetro, el lenguaje de programación que se usa el objeto de calendario determinado.|  
