---
title: "Método getTimeDateFunctions (SQLServerDatabaseMetaData) | Documentos de Microsoft"
ms.custom: 
ms.date: 01/19/2017
...
## <a name="return-value"></a>Valor devuelto  
 A **cadena** que contiene una lista de las funciones de fecha y hora.  
  
## <a name="exceptions"></a>Excepciones  
 [SQLServerException](../../../connect/jdbc/reference/sqlserverexception-class.md)  
  
## <a name="remarks"></a>Comentarios  
 Este método getTimeDateFunctions especificado por el método getTimeDateFunctions en la interfaz java.sql.DatabaseMetaData.  
