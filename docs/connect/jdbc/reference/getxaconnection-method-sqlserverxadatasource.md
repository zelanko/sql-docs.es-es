---
title: "Método getXAConnection (SQLServerXADataSource) | Documentos de Microsoft"
ms.custom: 
ms.date: 01/19/2017
...
|Nombre|Description|  
|----------|-----------------|  
|[(de getXAConnection)](../../../connect/jdbc/reference/getxaconnection-method.md)|Intenta establecer una conexión a una base de datos física que se puede utilizar en una transacción distribuida.|  
