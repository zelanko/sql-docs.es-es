---
title: Método isReadOnly (SQLServerResultSetMetaData) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
 ...
 **True** si la columna es de solo lectura. De lo contrario, se devuelve el valor **False**.  
