---
title: Método nullsAreSortedHigh (SQLServerDatabaseMetaData) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
 ...
 **True** si los valores están ordenados en orden ascendente. De lo contrario, se devuelve el valor **False**.  
  
## <a name="exceptions"></a>Excepciones  
 [SQLServerException](../../../connect/jdbc/reference/sqlserverexception-class.md)  
  
## <a name="remarks"></a>Comentarios  
 Este método nullsAreSortedHigh especificado por el método nullsAreSortedHigh en la interfaz java.sql.DatabaseMetaData.  
