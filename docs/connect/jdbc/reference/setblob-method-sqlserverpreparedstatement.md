---
title: setBlob (método) (SQLServerPreparedStatement) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Comentarios  
 Este método setBlob especificado por el método setBlob en la interfaz java.sql.PreparedStatement.  
