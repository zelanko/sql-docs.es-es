---
title: Método setByte (SQLServerCallableStatement) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Comentarios  
 Este método setByte es especificado por el método setByte en la interfaz java.sql.CallableStatement.  
