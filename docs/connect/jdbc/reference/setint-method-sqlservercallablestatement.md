---
title: Método setInt (SQLServerCallableStatement) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Comentarios  
 Este método setInt especificado por el método setInt en la interfaz java.sql.CallableStatement.  
