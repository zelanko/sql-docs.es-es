---
title: setTime (método) (SQLServerPreparedStatement) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32844600"
---
# <a name="settime-method-sqlserverpreparedstatement"></a>setTime (método) (SQLServerPreparedStatement)
