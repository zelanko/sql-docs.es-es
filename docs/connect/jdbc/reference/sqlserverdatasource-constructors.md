...
ms.locfileid: "67971442"
---
# <a name="sqlserverdatasource-constructors"></a>Constructores SQLServerDataSource
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Para obtener más información sobre los constructores SQLServerDataSource, consulte [miembros de SQLServerDataSource](../../../connect/jdbc/reference/sqlserverdatasource-members.md).  
