---
title: Clase SQLServerDriver | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  Representa el [!INCLUDE[jdbcNoVersion](../../../includes/jdbcnoversion_md.md)]. Esta clase incluye métodos para conectarse a un [!INCLUDE[ssNoVersion](../../../includes/ssnoversion_md.md)] base de datos y para obtener información sobre el controlador JDBC.  
