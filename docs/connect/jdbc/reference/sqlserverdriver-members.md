...
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]
  ...
  Las siguientes tablas enumeran los miembros expuestos por el [SQLServerDriver](../../../connect/jdbc/reference/sqlserverdriver-class.md) clase.  
  
## <a name="constructors"></a>Constructores  
  
|Nombre|Description|  
|----------|-----------------|  
|[(De SQLServerDriver)](../../../connect/jdbc/reference/sqlserverdriver-constructor.md)|Inicializa una nueva instancia de la [SQLServerDriver](../../../connect/jdbc/reference/sqlserverdriver-class.md) clase.|  
