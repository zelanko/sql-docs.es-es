---
title: Los miembros de SQLServerResource | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32846460"
---
# <a name="sqlserverresource-members"></a>Miembros de SQLServerResource
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Las siguientes tablas enumeran los miembros expuestos por el [SQLServerResource](../../../connect/jdbc/reference/sqlserverresource-class.md) clase.  
  
## <a name="constructors"></a>Constructores  
  
|Nombre|Description|  
|----------|-----------------|  
|[(De SQLServerResource)](../../../connect/jdbc/reference/sqlserverresource-constructor.md)|Inicializa una nueva instancia de la [SQLServerResource](../../../connect/jdbc/reference/sqlserverresource-class.md) clase. Este constructor es únicamente para uso interno.|  
