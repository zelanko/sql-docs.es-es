...
## <a name="remarks"></a>Notas  
 Este método storesUpperCaseQuotedIdentifiers se especifica mediante el método storesUpperCaseQuotedIdentifiers en la interfaz java. SQL. DatabaseMetaData.  
