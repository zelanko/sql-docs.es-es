...
## <a name="remarks"></a>Notas  
 Este método supportsAlterTableWithDropColumn se especifica mediante el método supportsAlterTableWithDropColumn en la interfaz java. SQL. DatabaseMetaData.  
