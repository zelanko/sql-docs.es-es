---
title: Método supportsANSI92EntryLevelSQL (SQLServerDatabaseMetaData) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Comentarios  
 Este método supportsANSI92EntryLevelSQL especificado por el método supportsANSI92EntryLevelSQL en la interfaz java.sql.DatabaseMetaData.  
