---
title: Método supportsANSI92FullSQL (SQLServerDatabaseMetaData) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Comentarios  
 Este método supportsANSI92FullSQL especificado por el método supportsANSI92FullSQL en la interfaz java.sql.DatabaseMetaData.  
