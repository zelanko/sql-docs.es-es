---
title: Método supportsANSI92IntermediateSQL (SQLServerDatabaseMetaData) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Comentarios  
 Este método supportsANSI92IntermediateSQL especificado por el método supportsANSI92IntermediateSQL en la interfaz java.sql.DatabaseMetaData.  
