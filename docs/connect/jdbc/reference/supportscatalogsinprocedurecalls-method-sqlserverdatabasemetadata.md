...
## <a name="remarks"></a>Notas  
 Este método supportsCatalogsInProcedureCalls se especifica mediante el método supportsCatalogsInProcedureCalls en la interfaz java. SQL. DatabaseMetaData.  
