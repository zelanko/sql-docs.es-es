---
title: Método supportsColumnAliasing (SQLServerDatabaseMetaData) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Comentarios  
 Este método supportsColumnAliasing especificado por el método supportsColumnAliasing en la interfaz java.sql.DatabaseMetaData.  
