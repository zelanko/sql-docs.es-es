...
## <a name="remarks"></a>Notas  
 Este método supportsIntegrityEnhancementFacility se especifica mediante el método supportsIntegrityEnhancementFacility en la interfaz java. SQL. DatabaseMetaData.  
