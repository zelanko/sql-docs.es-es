...
## <a name="remarks"></a>Notas  
 Este método supportsOpenCursorsAcrossRollback se especifica mediante el método supportsOpenCursorsAcrossRollback en la interfaz java. SQL. DatabaseMetaData.  
