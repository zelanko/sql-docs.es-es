---
title: Método supportsPositionedDelete (SQLServerDatabaseMetaData) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Comentarios  
 Este método supportsPositionedDelete especificado por el método supportsPositionedDelete en la interfaz java.sql.DatabaseMetaData.  
