...
## <a name="remarks"></a>Notas  
 Este método supportsSchemasInDataManipulation se especifica mediante el método supportsSchemasInDataManipulation en la interfaz java. SQL. DatabaseMetaData.  
