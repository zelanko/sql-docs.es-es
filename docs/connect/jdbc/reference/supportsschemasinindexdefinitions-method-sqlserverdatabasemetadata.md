...
## <a name="remarks"></a>Notas  
 Este método supportsSchemasInIndexDefinitions se especifica mediante el método supportsSchemasInIndexDefinitions en la interfaz java. SQL. DatabaseMetaData.  
