---
title: Método supportsSelectForUpdate (SQLServerDatabaseMetaData) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Comentarios  
 Este método supportsSelectForUpdate especificado por el método supportsSelectForUpdate en la interfaz java.sql.DatabaseMetaData.  
