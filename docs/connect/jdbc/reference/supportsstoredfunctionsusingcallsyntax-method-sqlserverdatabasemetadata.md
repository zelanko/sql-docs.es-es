...
## <a name="remarks"></a>Notas  
 Este método supportsStoredFunctionsUsingCallSyntax se especifica mediante el método supportsStoredFunctionsUsingCallSyntax en la interfaz java. SQL. DatabaseMetaData.  
