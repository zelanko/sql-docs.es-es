---
description: Método supportsUnion (SQLServerDatabaseMetaData)
...
## <a name="remarks"></a>Observaciones  
 El método supportsUnion especifica este método supportsUnion en la interfaz java.sql.DatabaseMetaData.  
