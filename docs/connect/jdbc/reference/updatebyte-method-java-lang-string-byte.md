---
title: Método updateByte (java.lang.String, byte) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
## <a name="remarks"></a>Comentarios  
 Este método updateByte especificado por el método updateByte en la interfaz java.sql.ResultSet.  
