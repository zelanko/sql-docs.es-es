---
title: Método updateShort (int, short) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32850470"
---
# <a name="updateshort-method-int-short"></a>Método updateShort (int, short)
[!INCLUDE[Driver_JDBC_Download](../../../includes/driver_jdbc_download.md)]

  Actualiza la columna designada con un **corto** valor según el índice de columna.  
