---
description: Método updateShort (SQLServerResultSet)
title: Método updateShort (SQLServerResultSet) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
