---
title: Protección de cadenas de conexión
description: Aprenda a proteger la información de la cadena de conexión al usar el controlador JDBC para SQL Server.
ms.custom: ''
ms.date: 08/12/2019
ms.prod: sql
