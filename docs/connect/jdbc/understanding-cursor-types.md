...
## <a name="cursor-conversion"></a>Conversión de cursores  
 ...
 Con [!INCLUDE[ssVersion2000](../../includes/ssversion2000-md.md)], al actualizar los datos a través del conjunto de resultados ResultSet. TYPE_SCROLL_SENSITIVE y ResultSet. CONCUR_UPDATABLE, se produce una excepción con un mensaje que indica que el cursor es de solo lectura. Esta excepción se debe a que [!INCLUDE[ssVersion2000](../../includes/ssversion2000-md.md)] ha realizado una conversión implícita del cursor para ese conjunto de resultados y no devolvió el cursor actualizado que se ha solicitado.  
