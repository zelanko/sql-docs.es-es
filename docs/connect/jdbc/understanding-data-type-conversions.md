...
- **Convertido (y)**: conversiones desde tipos de servidores numéricos a tipos del lenguaje Java en las que la conversión es normal y sigue las reglas de conversión del lenguaje Java. Para estas conversiones, la precisión siempre se trunca, nunca se redondea, y el desbordamiento se trata como un módulo del tipo de destino, que es más pequeño. Por ejemplo, al llamar a **en una columna** subyacente que contiene "1.9999", por ejemplo, se devolverá "1" o si el valor **subyacente es "3000000000", el valor** se desborda a "-1294967296".
...
- **Convertido (y)**: conversiones desde tipos de servidores numéricos a tipos del lenguaje Java en las que la conversión es normal y sigue las reglas de conversión del lenguaje Java. Para estas conversiones, la precisión siempre se trunca (nunca se redondea) y el desbordamiento se trata como un módulo del tipo de destino (el más pequeño). Por ejemplo, al llamar a **en una columna** subyacente que contiene "1.9999", por ejemplo, se devolverá "1" o si el valor **subyacente es "3000000000", el valor** se desborda a "-1294967296".
...
Cuando el tipo de datos de columna de [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] es **XML**, el valor de los datos debe ser un tipo **XML** válido. Cuando se llama a los métodos ,  o , el valor de los datos debe ser la representación de la cadena decimal de los caracteres XML. Por ejemplo:
...
En el caso del tipo de datos **, si el valor supera la longitud de** , se asigna a **. De forma similar, **NVARCHAR** se asigna a **LONGNVARCHAR** si el valor supera la longitud admitida de **NVARCHAR**. Lo mismo sucede para **byte[]**. Los valores que superan **VARBINARY** se convierten en **LONGVARBINARY**.
...
[!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] realiza el grueso de las conversiones de establecimiento y devuelve errores a JDBC Driver cuando encuentra problemas. Las conversiones del lado cliente son la excepción y solamente se realizan en el caso de los valores **,** , **,**  y **.
