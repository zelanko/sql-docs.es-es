---
title: Descripción de las diferencias entre los tipos de datos
description: Obtenga información sobre las diferencias entre los tipos de datos del lenguaje de programación Java y los tipos de datos de SQL Server y cómo JDBC Driver para SQL Server ayuda con las conversiones.
ms.custom: ''
ms.date: 08/12/2019
ms.prod: sql
