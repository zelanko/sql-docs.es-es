...
```  
 ...
 Para utilizar el nuevo nivel de aislamiento de instantánea de [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)], puede utilizar una de las constantes SQLServerConnection, como se muestra a continuación:  
