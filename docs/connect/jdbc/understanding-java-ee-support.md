...
Para el controlador JDBC Driver 8.2, el controlador se encuentra en **mssql-jdbc-8.2.1.jre8.jar**, **mssql-jdbc-8.2.1.jre11.jar** o **mssql-jdbc-8.2.1.jre13.jar**.
