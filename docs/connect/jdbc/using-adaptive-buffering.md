---
title: Uso de almacenamiento en búfer adaptable | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
-   La aplicación puede establecer la propiedad de conexión **responseBuffering** en "ADAPTATIVE". Para obtener más información sobre cómo establecer las propiedades de conexión, consulte [estableciendo las propiedades de conexión](../../connect/jdbc/setting-the-connection-properties.md).  
...
-   Lea los valores binarios o texto grande como flujos mediante el uso de la getAsciiStream, el getBinaryStream o los métodos getCharacterStream en lugar de la getBlob o los métodos getClob. Desde la versión 1.2, la clase [SQLServerCallableStatement](../../connect/jdbc/reference/sqlservercallablestatement-class.md) proporciona métodos get\<Type>Stream nuevos para este propósito.  
