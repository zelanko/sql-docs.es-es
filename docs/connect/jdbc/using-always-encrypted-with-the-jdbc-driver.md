...
En los ejemplos de esta página, si ha creado una clave maestra de columna basada en Azure Key Vault y una clave de cifrado de columna mediante SQL Server Management Studio, el script T-SQL para volver a crearlos podría ser similar a este ejemplo con sus propias **KEY_PATH** y **ENCRYPTED_VALUE**específicos:
