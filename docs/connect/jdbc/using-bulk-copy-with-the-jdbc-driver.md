...
2.  Expanda las bases de datos, haga clic con el botón secundario en la base de datos de AdventureWorks, seleccione **Tareas** y **Exportar datos**...  
