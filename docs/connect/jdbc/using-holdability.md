...
[!INCLUDE[Driver_JDBC_Download](../../includes/driver_jdbc_download.md)]
 ...
 La capacidad de alojamiento de conjuntos de resultados se puede configurar con el método [setHoldability](../../connect/jdbc/reference/setholdability-method-sqlserverconnection.md) de la clase [SQLServerConnection](../../connect/jdbc/reference/sqlserverconnection-class.md). Al establecer la capacidad de alojamiento mediante el método setHoldability, el conjunto de resultados constantes de capacidad de alojamiento de ResultSet.HOLD_CURSORS_OVER_COMMIT o ResultSet.CLOSE_CURSORS_AT_COMMIT puede utilizarse.  
