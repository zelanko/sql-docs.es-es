...
> [!NOTE]  
> Antes de la 6.2.0 de versión del controlador JDBC, uso adecuado de cruce del dominio Kerberos, deberá establecer explícitamente el **serverSpn**.
>
> A partir de la 6.2.0 versión, el controlador será capaz de crear el **serverSpn** de forma predeterminada, incluso cuando se usa entre del dominio Kerberos. Aunque se pueden usar **serverSpn** explícitamente demasiado. 
