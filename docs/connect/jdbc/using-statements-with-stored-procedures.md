---
title: Empleo de instrucciones con procedimientos almacenados
description: Obtenga información sobre cómo ejecutar procedimientos almacenados con el controlador JDBC de Microsoft para SQL Server y cómo usar parámetros de entrada y salida para pasar datos a dichos procedimientos y desde ellos.
ms.custom: ''
ms.date: 08/12/2019
ms.prod: sql
