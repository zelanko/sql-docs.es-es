---
title: Trabajo con datos grandes
description: Obtenga información sobre cómo trabajar con tipos de datos de gran tamaño en el controlador JDBC para SQL Server en estas aplicaciones de ejemplo.
ms.custom: ''
ms.date: 08/12/2019
ms.prod: sql
...
| Tema                                                                                                   | Descripción                                                              |
| ------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
| [Lectura de ejemplo de datos grandes](reading-large-data-sample.md)                                               | Describe cómo usar una instrucción SQL para recuperar datos de valores grandes.       |
| [Lectura de datos grandes con un ejemplo de procedimientos almacenados](reading-large-data-with-stored-procedures-sample.md) | Describe cómo recuperar un valor de parámetro CallableStatement OUT grande. |
| [Actualización de ejemplo de datos grandes](updating-large-data-sample.md)                                             | Describe cómo actualizar datos de valor grande en una base de datos.                |
