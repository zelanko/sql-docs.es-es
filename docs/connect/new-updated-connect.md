...
1. [Página principal de programación para Microsoft SQL Server del cliente](homepage-sql-connection-programming.md)
2. [Conectarse mediante la autenticación de Azure Active Directory](php/azure-active-directory.md)
3. [Resistencia de conexión inactiva](php/connection-resiliency.md)
4. [Tutorial de instalación de controladores de Mac y Linux PHP](php/installation-tutorial-linux-mac.md)
5. [Módulos de conexión para bases de datos SQL de Microsoft](sql-connection-libraries.md)
