---
title: Descargar controlador ODBC para SQL Server | Microsoft Docs
ms.custom: ''
ms.date: 03/13/2018
ms.prod: sql
...
ms.locfileid: "47621973"
---
# <a name="download-odbc-driver-for-sql-server"></a>Descargar ODBC Driver para SQL Server
...
- [Los paquetes de Red Hat 7 .rpm (msodbcsql17-*)](https://packages.microsoft.com/rhel/7/prod/)
...
- [SuSE 11 .rpm paquetes (msodbcsql17-*)](https://packages.microsoft.com/sles/11/prod/)

#### <a name="ubuntu"></a>Ubuntu
- [Paquetes de Ubuntu 18.04 .deb](https://packages.microsoft.com/ubuntu/18.04/prod/pool/main/m/msodbcsql17/)
- [Con Ubuntu 17.10 .deb paquetes](https://packages.microsoft.com/ubuntu/17.10/prod/pool/main/m/msodbcsql17/)
...
- [OS X 10.11 y macOS 10.12, 10.13 fórmulas de Homebrew](https://github.com/Microsoft/homebrew-mssql-release)
...
#### <a name="redhat"></a>RedHat
- [Los paquetes de Red Hat 7 .rpm (msodbcsql-*)](https://packages.microsoft.com/rhel/7/prod/)
- [Los paquetes de Red Hat 6 .rpm (msodbcsql-*)](https://packages.microsoft.com/rhel/6.8/prod/)

#### <a name="suse"></a>Suse
- [SuSE 12 .rpm paquetes (msodbcsql-*)](https://packages.microsoft.com/sles/12/prod/)
- [SuSE 11 .rpm paquetes (msodbcsql-*)](https://packages.microsoft.com/sles/11/prod/)

#### <a name="ubuntu"></a>Ubuntu
- [Paquetes de Ubuntu 17.04 .deb](https://packages.microsoft.com/ubuntu/17.04/prod/pool/main/m/msodbcsql/)
- [Paquetes de Ubuntu 16.04 .deb](https://packages.microsoft.com/ubuntu/16.04/prod/pool/main/m/msodbcsql/)
- [Paquetes de Ubuntu 16.10 .deb](https://packages.microsoft.com/ubuntu/16.10/prod/pool/main/m/msodbcsql/)
- [Paquetes de Ubuntu 15.10 .deb](https://packages.microsoft.com/ubuntu/15.10/prod/pool/main/m/msodbcsql/)
- [Paquetes de Ubuntu 14.04 .deb](https://packages.microsoft.com/ubuntu/14.04/prod/pool/main/m/msodbcsql/) 
...
- **SUSE Linux Enterprise 11 Service Pack 2 (64 bits)** - [Descargar Microsoft ODBC Driver 11 Preview for SQL Server - SUSE Linux](http://go.microsoft.com/fwlink/?LinkId=264916)
