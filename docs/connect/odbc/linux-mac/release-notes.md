...
ODBC Driver 13.1 for [! INCLUDEssNoVersion] agrega compatibilidad con Always Encrypted y Azure Active Directory cuando se utiliza junto con Microsoft SQL Server 2016. 
