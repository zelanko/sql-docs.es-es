...
- [Creación de aplicaciones con SQL Server Native Client](/sql-docs/docs/relational-databases/native-client/applications/building-applications-with-sql-server-native-client)   
