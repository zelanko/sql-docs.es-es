...
Para descargar la versión más reciente del controlador OLE DB para SQL Server, vaya a Microsoft Download Center.
...
>  Toda la configuración del Registro adecuados para el controlador OLE DB para SQL Server se realiza como parte del proceso de instalación.  
 ...
 El controlador OLE DB para SQL Server encabezado y biblioteca de archivos (msoledbsql.h y msoledbsql.lib) se instalan en la siguiente ubicación:  
