...
description: Instalación y desinstalación de OLE DB Driver for SQL Server Para instalar OLE DB Driver for SQL Server necesita el instalador de msoledbsql.msi.
ms.custom: ''
ms.date: 02/12/2019
ms.prod: sql
