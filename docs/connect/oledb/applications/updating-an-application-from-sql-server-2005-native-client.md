...
description: Obtenga información sobre los cambios importantes en OLE DB Driver for SQL Server desde SQL Server Native Client en SQL Server 2005 (9.x).
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
