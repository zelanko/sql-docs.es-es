...
## <a name="examples"></a>Ejemplos  
 En las secciones siguientes se proporcionan ejemplos de cómo puede usar ADO con el controlador de OLE DB para SQL Server.  
