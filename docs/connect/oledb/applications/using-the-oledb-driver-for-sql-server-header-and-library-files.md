...
description: Obtenga información sobre cómo usar los archivos de biblioteca y de encabezado de OLE DB Driver for SQL Server en su entorno de desarrollo.
ms.custom: ''
ms.date: 02/12/2019
ms.prod: sql
