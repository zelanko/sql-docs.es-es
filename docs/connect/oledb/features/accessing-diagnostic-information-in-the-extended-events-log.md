...
description: Seguimiento de OLE DB controlador para SQL Server y obtener acceso a información de diagnóstico en el registro de eventos extendidos
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
...
## <a name="control-file"></a>Archivo de control  
 El contenido del controlador de OLE DB para SQL Server archivo de control (Ctrl. GUID) es:  
...
## <a name="mof-file"></a>Archivo MOF  
 El contenido del controlador de OLE DB para SQL Server archivo MOF es el siguiente:  
