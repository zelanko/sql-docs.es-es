...
description: Obtenga información sobre la compatibilidad de OLE DB Driver for SQL Server con los tipos de datos de fecha y hora que se agregaron en SQL Server 2008.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
