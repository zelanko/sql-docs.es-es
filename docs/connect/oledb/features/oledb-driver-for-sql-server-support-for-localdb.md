...
description: Obtenga información sobre cómo conectarse a una versión ligera de SQL Server, llamada LocalDB, mediante OLE DB Driver for SQL Server.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
