...
description: OLE DB Driver for SQL Server admite operaciones de bases de datos asincrónicas, lo que permite que los métodos devuelvan resultados sin bloquear el subproceso que hace la llamada.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
