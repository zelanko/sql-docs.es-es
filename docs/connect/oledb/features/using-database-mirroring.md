...
description: OLE DB Driver for SQL Server admite la creación de reflejo de la base de datos. No es necesario que los desarrolladores realicen ninguna otra acción una vez que se ha configurado la creación de reflejo para la base de datos.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
