...
description: Obtenga información sobre el cifrado sin validación para conexiones de SQL Server. OLE DB Driver for SQL Server admite el cifrado sin validación.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
