...
description: Obtenga información sobre cómo OLE DB Driver for SQL Server admite tipos de datos de valores grandes con los tipos varchar(max), varbinary(max) y nvarchar(max).
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
