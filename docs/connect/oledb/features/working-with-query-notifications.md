...
description: Obtenga información sobre cómo las notificaciones de consulta permiten que las aplicaciones reciban notificaciones cuando los datos cambian en OLE DB Driver for SQL Server.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
