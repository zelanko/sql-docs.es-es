...
description: Obtenga información sobre cómo las mejoras de OLE DB Driver for SQL Server usan el aislamiento de instantánea, lo que mejora la simultaneidad de las aplicaciones de procesamiento de transacciones en línea.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
