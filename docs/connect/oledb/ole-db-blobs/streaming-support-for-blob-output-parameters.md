---
title: Compatibilidad con la transmisión por secuencias de parámetros de salida BLOB (OLE DB Driver)
description: Obtenga información sobre la compatibilidad con la transmisión por secuencias en OLE DB Driver for SQL Server de parámetros de salida BLOB. En este ejemplo se enlazan los parámetros BLOB como ISequentialStreams.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
[!INCLUDE[Driver_OLEDB_Download](../../../includes/driver_oledb_download.md)]
  ...
  Este artículo contiene un ejemplo que muestra la compatibilidad con el streaming de parámetros de salida BLOB, que enlaza los parámetros de salida BLOB como ISequentialStreams.  
