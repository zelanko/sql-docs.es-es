...
description: Obtenga información sobre cómo los consumidores usan la interfaz IMultipleResults para procesar los resultados devueltos tras la ejecución de comandos de OLE DB Driver for SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
