...
description: Obtenga información sobre cómo OLE DB Driver for SQL Server interpreta las propiedades de sesión de OLE DB, incluido un conjunto de propiedades específico del proveedor.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
