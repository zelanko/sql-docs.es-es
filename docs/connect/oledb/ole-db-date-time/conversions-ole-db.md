...
description: Obtenga información sobre cómo OLE DB Driver for SQL Server hace una conversión entre los valores datetime y datetimeoffset. Hay varias reglas de conversión generales.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
