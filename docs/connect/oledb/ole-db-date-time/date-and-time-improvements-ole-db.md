...
description: En estos artículos se describe cómo OLE DB Driver for SQL Server admite nuevos tipos de datos de fecha y hora. Consulte información general y ejemplos.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
