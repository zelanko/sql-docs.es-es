...
description: En OLE DB Driver for SQL Server, los consumidores establecen valores de propiedades para solicitar el comportamiento de un objeto específico. Obtenga información sobre cómo establecer propiedades.
ms.custom: ''
ms.date: 05/20/2020
ms.prod: sql
ms.reviewer: ''
