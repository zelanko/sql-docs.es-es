---
title: Cambiar una contraseña de usuario de autenticación de SQL Server (OLE DB) | Documentos de Microsoft
description: Cambiar una contraseña de usuario de autenticación de SQL Server (OLE DB)
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
