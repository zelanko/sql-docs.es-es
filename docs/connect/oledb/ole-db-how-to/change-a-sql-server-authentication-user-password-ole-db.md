...
description: Obtenga información sobre cómo usar OLE DB para cambiar a contraseña de una cuenta de usuario en la autenticación de SQL Server con este ejemplo.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
