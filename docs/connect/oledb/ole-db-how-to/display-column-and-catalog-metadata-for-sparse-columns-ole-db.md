...
description: Obtenga información sobre cómo mostrar metadatos de columna y catálogo para las columnas dispersas en OLE DB Driver for SQL Server con este ejemplo.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
