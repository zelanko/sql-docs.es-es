...
description: Obtenga información sobre cómo los datos grandes se pueden enlazar o recuperar mediante la interfaz ISequentialStream en OLE DB Driver for SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
ms.locfileid: "88860606"
---
# <a name="fetch-columns-by-using-irowgetcolumns-or-irowopen-and-isequentialstream"></a>Capturar columnas mediante IRow::GetColumns (o IRow::Open) e ISequentialStream
