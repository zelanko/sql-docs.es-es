...
description: Obtenga información sobre cómo leer una columna FILESTREAM en un archivo mediante la interfaz IBCPSession en OLE DB Driver for SQL Server y escriba un archivo de formato con este ejemplo.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
[!INCLUDE[Driver_OLEDB_Download](../../../../includes/driver_oledb_download.md)]
 ...
 Para más información sobre la característica filestream, consulte [Compatibilidad con FILESTREAM](../../../oledb/features/filestream-support.md).  
