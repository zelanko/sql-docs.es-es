...
description: Obtenga información sobre cómo usar una interfaz ISequentialStream en una interfaz ICommandText interface para recuperar un registro de una columna FILESTREAM en OLE DB Driver for SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
