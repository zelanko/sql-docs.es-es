...
description: Obtenga información sobre cómo usar la interfaz IRowsetFastUpload para enviar entre 4 MB y 4 GB de datos a una columna FILESTREAM en OLE DB Driver for SQL Server con este ejemplo.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
