---
title: 'Enviar datos a FILESTREAM: ISequentialStream enlazado a ICommandText | Microsoft Docs'
description: Obtenga información sobre cómo usar la interfaz de ISequentialStream enlazada a un parámetro ICommandText para enviar de 4 MB a 4 GB de datos a una columna de secuencia de archivos con este ejemplo.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
