---
title: Obtención de un cursor FAST_FORWARD (controlador OLE DB)
description: Obtenga información sobre cómo establecer las propiedades del conjunto de filas para obtener un cursor FAST_FORWARD mediante OLE DB Driver for SQL Server con este ejemplo.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
