---
title: Obtener un Cursor FAST_FORWARD | Documentos de Microsoft
description: Obtener un cursor FAST_FORWARD mediante el controlador OLE DB para SQL Server
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
