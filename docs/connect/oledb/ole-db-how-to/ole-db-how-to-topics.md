---
title: Temas de procedimientos (controlador OLE DB)
description: Use estos artículos de procedimientos para comprender cómo OLE DB Driver for SQL Server se conecta a un servidor, ejecuta un comando y procesa los resultados.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
