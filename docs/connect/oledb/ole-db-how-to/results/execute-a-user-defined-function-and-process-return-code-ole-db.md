...
description: Descubra cómo ejecutar una función definida por el usuario e imprimir un código de devolución con OLE DB Driver for SQL Server. En este ejemplo se utiliza la base de datos de ejemplo AdventureWorks.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
