...
description: Obtenga información sobre cómo ejecutar procedimientos almacenados de SQL Server con RPC y procesar códigos de devolución y parámetros de salida en este ejemplo.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
