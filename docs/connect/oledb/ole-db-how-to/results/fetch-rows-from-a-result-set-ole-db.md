---
title: Recuperar filas de un conjunto de resultados (OLE DB) | Documentos de Microsoft
description: Recuperar filas de un conjunto de resultados mediante controlador OLE DB para SQL Server
ms.custom: ''
ms.date: 03/26/2018
ms.prod: sql
