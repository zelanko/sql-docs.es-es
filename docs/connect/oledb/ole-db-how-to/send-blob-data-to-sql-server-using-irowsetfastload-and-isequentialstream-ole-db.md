...
description: Obtenga información sobre cómo usar IRowsetFastLoad para transmitir datos BLOB de longitud variable por fila a SQL Server. En este ejemplo también se muestra ISequentialStream.
ms.custom: ''
ms.date: 05/25/2020
ms.prod: sql
