---
title: Establecimiento de datos de gran tamaño (controlador OLE DB)
description: Aprenda a establecer datos BLOB, crear una tabla, agregar un registro, capturar ese registro en el conjunto de filas y establecer el valor del campo BLOB en OLE DB Driver for SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
