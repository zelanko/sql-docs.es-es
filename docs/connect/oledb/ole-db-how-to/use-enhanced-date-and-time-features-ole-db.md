---
title: Utilizar las características mejoradas de fecha y hora (OLE DB Driver)
description: Obtenga información sobre cómo usar las características de fecha y hora date, time, datetime2 y datetimeoffset para ejecutar comandos y recuperar resultados del conjunto de filas en OLE DB Driver for SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
