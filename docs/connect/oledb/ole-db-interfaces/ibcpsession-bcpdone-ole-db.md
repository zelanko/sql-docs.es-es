---
title: IBCPSession::BCPDone (controlador OLE DB) | Microsoft Docs
description: Obtenga información sobre cómo el método IBCPSession::BCPDone confirma las filas restantes que se van a enviar a SQL Server en OLE DB Driver for SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
