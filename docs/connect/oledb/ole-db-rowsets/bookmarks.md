---
title: Marcadores de fila (controlador OLE DB) | Microsoft Docs
description: Obtenga información sobre cómo los marcadores vuelven rápidamente a una fila mediante el acceso aleatorio a filas en función del valor de marcador de OLE DB Driver for SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
