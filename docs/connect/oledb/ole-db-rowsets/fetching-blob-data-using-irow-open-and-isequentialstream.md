...
description: Obtenga información sobre cómo capturar datos BLOB con IRow::Open and ISequentialStream en OLE DB Driver for SQL Server con esta función de ejemplo.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
