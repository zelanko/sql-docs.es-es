---
title: Conjuntos de filas y cursores SQL Server | Documentos de Microsoft
description: Cursores de conjuntos de filas y SQL Server
ms.custom: ''
ms.date: 03/26/2018
ms.prod: sql
...
|DBPROP_REMOVEDELETED|VARIANT_TRUE|No puede actualizar los datos de [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] a través del conjunto de filas. El conjunto de filas solamente admite desplazamiento hacia delante. Se admite la posición de fila relativa. El texto de comando puede incluir una cláusula ORDER BY a menos que esté restringido por otra propiedad.|  
 ...
 Un controlador de OLE DB para el conjunto de filas de SQL Server compatible con un cursor de servidor pueden crearse fácilmente en un [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] tabla base o vista mediante el uso de la **IOpenRowset:: OpenRowset** método. Especificar la tabla o vista por su nombre, pasando el conjunto de filas requiere conjuntos de propiedades en el *rgPropertySets* parámetro.  
...
## <a name="sql-server-cursor-block-size"></a>Tamaño del bloque de cursor de SQL Server  
 Cuando un [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] cursor es compatible con un controlador de OLE DB para el conjunto de filas de SQL Server, el número de elementos de la fila controlar los parámetros de matriz de la **IRowset:: GetNextRows** o **IRowsetLocate:: GetRowsAt** métodos define el tamaño de bloque de cursor. Las filas indicadas por los identificadores de la matriz son los miembros del bloque de cursor.  
  
 Para compatibilidad con marcadores de conjuntos de filas, recuperan los identificadores de fila mediante la **IRowsetLocate:: Getrowsbybookmark** método definir los miembros del bloque de cursor.  
