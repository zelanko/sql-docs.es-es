---
title: Actualización de datos en cursores (controlador OLE DB)
description: Obtenga información sobre cómo funciona una aplicación de consumidor de OLE DB Driver for SQL Server con solicitudes en un conjunto de filas modificable mediante el uso de cursores de SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
[!INCLUDE[Driver_OLEDB_Download](../../../includes/driver_oledb_download.md)]
  ...
  Cuando se capturan y actualizan datos mediante cursores de [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)], las mismas consideraciones y restricciones que se aplican a cualquier otra aplicación cliente son válidas para una aplicación de consumidor de OLE DB Driver for SQL Server.  
