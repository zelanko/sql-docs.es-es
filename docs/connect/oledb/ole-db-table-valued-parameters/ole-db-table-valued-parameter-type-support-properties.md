...
description: Obtenga información sobre las propiedades de OLE DB y los conjuntos de propiedades asociados a los objetos de conjuntos de filas de parámetros con valores de tabla en OLE DB Driver for SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
