...
description: Obtenga información sobre los conjuntos de filas de esquemas que se han modificado o agregado para admitir parámetros con valores de tabla en OLE DB Driver for SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
