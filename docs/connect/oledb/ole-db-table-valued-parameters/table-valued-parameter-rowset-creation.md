---
title: Creación de conjuntos de filas de parámetros con valores de tabla (OLE DB Driver)
description: Obtenga información sobre el conjunto de filas de parámetros con valores de tabla, un objeto en memoria que OLE DB Driver for SQL Server permite crear a los consumidores.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
