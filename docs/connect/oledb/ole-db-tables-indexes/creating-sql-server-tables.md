---
title: Creación de tablas de SQL Server (controlador OLE DB) | Microsoft Docs
description: Obtenga información sobre cómo la función ITableDefinition::CreateTable de OLE DB Driver for SQL Server permite que los consumidores creen tablas de SQL Server.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
