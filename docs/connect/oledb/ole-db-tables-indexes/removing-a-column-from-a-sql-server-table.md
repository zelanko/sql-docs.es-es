...
description: Quitar una columna de una tabla de SQL Server con OLE DB controlador para SQL Server
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
...
[!INCLUDE[Driver_OLEDB_Download](../../../includes/driver_oledb_download.md)]
  ...
  El controlador de OLE DB para SQL Server expone la función **ITableDefinition::D ropcolumn** . Esto permite que los consumidores puedan quitar una columna de una tabla de [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)].  
