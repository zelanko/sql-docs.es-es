---
title: Compatibilidad con transacciones locales (OLE DB Driver)
description: Obtenga información sobre cómo OLE DB Driver for SQL Server admite las transacciones locales y cómo usar ITransactionLocal para lograr un control más preciso sobre el ámbito de transacción local.
ms.custom: ''
ms.date: 06/14/2018
ms.prod: sql
