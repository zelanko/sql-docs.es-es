...
description: Obtenga información sobre cómo llamar a un procedimiento almacenado en OLE DB Driver for SQL Server, incluido cómo pasar valores de parámetro.
ms.custom: ''
ms.date: 06/12/2018
ms.prod: sql
