...
## [Paso 3: prueba de concepto de la conexión a SQL Server con PHP](step-3-proof-of-concept-connecting-to-sql-using-php.md)
## [Paso 4: conectarse con resistencia a SQL Server con PHP](step-4-connect-resiliently-to-sql-with-php.md)
...
## [Descarga de controladores para PHP para SQL Server](download-drivers-php-sql-server.md)
## [Carga de los controladores](loading-the-php-sql-driver.md)
...
### [Compatibilidad con LocalDB](php-driver-for-sql-server-support-for-localdb.md)
### [Compatibilidad con alta disponibilidad y recuperación ante desastres](php-driver-for-sql-server-support-for-high-availability-disaster-recovery.md)
