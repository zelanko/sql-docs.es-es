---
title: "Ejemplos de código para el controlador SQL para PHP | Documentos de Microsoft"
ms.custom: 
ms.date: 01/19/2017
...
---
# <a name="code-samples-for-php-sql-driver"></a>Ejemplos de código para el controlador SQL para PHP
