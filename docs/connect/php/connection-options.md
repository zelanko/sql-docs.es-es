...
|LoginTimeout|Integer (controlador SQLSRV)<br /><br />Cadena (controlador PDO_SQLSRV)|Especifica el número de segundos que se espera antes de que se produzca un error en el intento de conexión.|Sin tiempo de espera.|  
