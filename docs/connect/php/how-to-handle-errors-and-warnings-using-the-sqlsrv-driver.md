---
title: 'Procedimientos: Control de errores y advertencias con el controlador SQLSRV'
description: Obtenga información acerca de cómo controlar errores y advertencias al usar el controlador SQLSRV de Microsoft para PHP en SQL Server.
ms.custom: ''
ms.date: 08/10/2020
ms.prod: sql
...
ms.locfileid: "88680650"
---
# <a name="how-to-handle-errors-and-warnings-using-the-sqlsrv-driver"></a>Procedimientos: Control de errores y advertencias con el controlador SQLSRV
...
[Procedimientos: Configuración del control de errores y advertencias con el controlador SQLSRV](../../connect/php/how-to-configure-error-and-warning-handling-using-the-sqlsrv-driver.md)
