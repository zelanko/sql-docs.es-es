---
title: 'Procedimientos: Realización de consultas con parámetros'
description: Obtenga información sobre cómo usar consultas con parámetros en unos pocos pasos con los controladores de PHP para SQL Server.
ms.custom: ''
ms.date: 03/26/2018
ms.prod: sql
