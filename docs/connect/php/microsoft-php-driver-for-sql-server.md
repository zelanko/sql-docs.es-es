...
* [Step 2: Create a database for PHP development (Paso 2: crear una base de datos para el desarrollo de PHP)](step-2-create-a-sql-database-for-php-development.md)  
* [Step 3: Proof of concept connecting to SQL using PHP (Paso 3: prueba de concepto de la conexión a SQL con PHP)](step-3-proof-of-concept-connecting-to-sql-using-php.md)  
...
* [Consideraciones relativas a la seguridad](security-considerations-for-php-sql-driver.md)
