---
title: Clase PDO | Documentos de Microsoft
ms.custom: ''
ms.date: 03/26/2018
ms.prod: sql
...
ms.locfileid: "35308174"
---
# <a name="pdo-class"></a>Clase PDO
[!INCLUDE[Driver_PHP_Download](../../includes/driver_php_download.md)]

La clase PDO contiene métodos que permiten a una aplicación PHP conectarse a una instancia de [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] .  
