...
*$conn*: (valor entero) el número de base cero de la columna cuyos metadatos se van a recuperar.  
...
|precision|Especifica la precisión numérica de esta columna.|  
