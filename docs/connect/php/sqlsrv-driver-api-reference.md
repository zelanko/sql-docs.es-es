---
title: Referencia de API del controlador SQLSRV
description: En la referencia de API para el controlador SQLSRV para PHP se describen las funciones disponibles, sus parámetros y los valores devueltos.
ms.custom: ''
ms.date: 03/26/2018
ms.prod: sql
