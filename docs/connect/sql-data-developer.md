...
* [Entity Framework](/ef/): use Entity Framework para obtener acceso con facilidad a las bases de datos mediante LINQ, con acceso directo a SQL Server y la opción de control de la asignación entre un modelo Entity Data Model (EDM) y estructuras relacionales sin formato. 
* [Windows Communication Foundation (WCF)](/dotnet/framework/wcf/): use Data Services para obtener una solución completa a fin de crear y consumir fácilmente servicios OData tanto en la Web como en la intranet.
* [Sync Framework](/previous-versions/sql/synchronization/mt490616(v=msdn.10)): use Sync Framework para permitir el acceso sin conexión a cualquier tipo de datos, cualquier almacén de datos, cualquier protocolo de transferencia y cualquier topología de red.
* [Extensiones reactivas](https://github.com/dotnet/reactive): use las extensiones reactivas (Rx) para realizar la programación de flujo de eventos y simplificar la programación asincrónica mediante secuencias observables y operadores de consulta del estilo de LINQ.  Use las extensiones reactivas para JavaScript (RxJS) a fin de simplificar la programación basada en devolución de llamada asincrónica y orientada a eventos en la Web mediante secuencias observables.
