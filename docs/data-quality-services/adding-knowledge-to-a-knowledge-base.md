...
-   [Administrar valores de datos en un dominio](#ManageDomain)  
...
-   [Usar la base de conocimiento de DQS predeterminada](#Default)  
...
##  <a name="ManageDomain"></a>Administrar valores de datos en un dominio  
...
##  <a name="Default"></a>Usar la base de conocimiento de DQS predeterminada  
