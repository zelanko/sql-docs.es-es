---
description: Agregar conocimiento a una base de conocimiento
...
-   Para obtener un vídeo que muestra cómo realizar la detección de conocimiento, haga clic [aquí](../sql-server/index.yml).  
