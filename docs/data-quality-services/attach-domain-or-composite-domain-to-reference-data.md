...
description: Describe cómo adjuntar dominios o dominios compuestos en una base de conocimiento de calidad de datos con Data Quality Services (DQS) en SQL Server.
