---
description: Configurar DQS para utilizar datos de referencia
title: Configurar DQS para utilizar datos de referencia
ms.date: 03/01/2017
ms.prod: sql
