 ...
 **Reference Data Services**  
 ...
 Para obtener más información acerca de la administración del conocimiento en DQS, vea [dominios y Bases de conocimiento de DQS](../data-quality-services/dqs-knowledge-bases-and-domains.md).  
...
-   **Limpieza asistida por PC**: DQS utiliza el conocimiento de la base de conocimiento seleccionada para el proyecto de limpieza para proponer correcciones o sugerencias para los valores de un origen de datos.  
  
-   **Limpieza interactiva**: el Administrador de datos puede realizar el proceso de limpieza interactiva para cambiar o aumentar las correcciones de datos que ha propuesto por el proceso de limpieza de datos asistida por PC. El administrador de datos lleva a cabo esta operación mediante niveles de confianza y estadísticas que se han identificado mediante el proceso de limpieza de datos o bien especificando sus propios cambios en el proyecto.  
 ...
 **Generación de perfiles y notificaciones**  
 ...
 Para obtener más información sobre los proyectos de calidad de datos en DQS, vea [proyectos de calidad de datos & #40; DQS & #41;](../data-quality-services/data-quality-projects-dqs.md).  
...
-   Configurar los valores de umbral para las actividades de limpieza y búsqueda de coincidencias. Para obtener más información, vea [Configure Threshold Values for Cleansing and Matching](../data-quality-services/configure-threshold-values-for-cleansing-and-matching.md).  
  
-   Habilitar o deshabilitar las notificaciones de generación de perfiles. Para obtener más información, consulte [Habilitar o deshabilitar las notificaciones de generación de perfiles en DQS](../data-quality-services/enable-or-disable-profiling-notifications-in-dqs.md).  
