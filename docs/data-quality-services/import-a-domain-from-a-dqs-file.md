...
---
# Importar un dominio desde un archivo .dqs
...
4.  En el **Importar desde el archivo de datos** cuadro de diálogo, desplácese a la carpeta que desea importar el archivo de, seleccione el archivo (del tipo archivo DQS) y, a continuación, haga clic en **Abrir**.  
