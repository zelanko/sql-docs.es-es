...
---
# Importar una base de conocimiento desde un archivo .dqs
  En este tema se describe cómo importar una base de conocimiento completa desde un archivo de datos .dqs en [!INCLUDE[ssDQSnoversion](../includes/ssdqsnoversion-md.md)] (DQS). Crear el archivo de datos mediante la exportación de una base de conocimiento existente desde el [!INCLUDE[ssDQSClient](../includes/ssdqsclient-md.md)] aplicación (consulte [exportar una Base de conocimiento a un archivo .dqs](../data-quality-services/export-a-knowledge-base-to-a-dqs-file.md)).  
