...
description: Obtenga información acerca de cómo ejecutar el DQSInstaller.exe para completar una instalación de SQL Server Data Quality Services (DQS).
