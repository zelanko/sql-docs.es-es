---
title: "Actualizar ensamblados de SQLCLR después de actualizar .NET Framework | Documentos de Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
## <a name="see-also"></a>Vea también  
 ...
 [Actualizar el esquema de bases de datos DQS tras instalar la actualización SQL Server](../../data-quality-services/install-windows/upgrade-dqs-databases-schema-after-installing-sql-server-update.md)  
