---
description: Establecer las propiedades de dominio
title: Establecer las propiedades de dominio
ms.date: 11/08/2011
ms.prod: sql
...
###  <a name="language"></a>Lenguaje <a name="Language"></a>  
