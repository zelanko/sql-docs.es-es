---
title: "Utilizar el corrector ortogr&#225;fico de DQS | Microsoft Docs"
ms.custom: ""
ms.date: "11/08/2011"
...
---
# Utilizar el corrector ortogr&#225;fico de DQS
...
-   La **los valores de dominio** página o **relaciones basadas en términos** página de la **Domain Management** actividad  
...
2.  Cuando el corrector ortográfico está habilitado en las propiedades del dominio, se habilita en el **administrar valores del dominio** página, la **los valores de dominio** página o **relaciones basadas en términos** página y el **administrar y ver resultados** página. Para deshabilitar el corrector ortográfico en estas páginas, haga clic en el **Habilitar o deshabilitar el corrector ortográfico** icono. Haga clic en el icono en cada una de estas páginas para cambiar el estado del corrector ortográfico en ella. Del mismo modo, si la **Habilitar corrector ortográfico** propiedad para el dominio está deshabilitada, haga clic en el **Habilitar o deshabilitar el corrector ortográfico** icono habilita el corrector ortográfico en la página. Si abandona la página y vuelve a ella a continuación, el estado del botón estará determinado nuevamente por la propiedad de dominio **Habilitar corrector ortográfico** .  
...
##  <a name="How"></a> Cómo funciona el corrector ortográfico  
 ...
 DQS proporcionará las sugerencias para los valores de las columnas **Valor** y **Corregir a** de la tabla **Valor** . Al seleccionar una sugerencia en la columna **Valor** , el tipo de valor se establece en **Error**y la sugerencia se copia en la columna **Corregir a** , como si se hubiera insertado manualmente. Si hubiera una corrección existente, se convertiría en una sugerencia. En la página **Administrar y ver resultados** de la actividad **Limpieza** , al seleccionar una sugerencia en la columna **Corregir a** , DQS reemplazará el valor seleccionado actualmente por la selección, y dicho valor se convertirá en una sugerencia. En el **administrar y ver resultados** página de la **limpieza** actividad, no se realizan sugerencias en el nivel de registro (la cuadrícula inferior).  
