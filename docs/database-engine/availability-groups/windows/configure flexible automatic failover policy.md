---
title: "Configurar la directiva de conmutaci&#243;n por error flexible para controlar las condiciones de la conmutaci&#243;n autom&#225;tica por error (grupos de disponibilidad AlwaysOn) | Microsoft Docs"
ms.custom: ""
ms.date: "03/29/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Grupos de disponibilidad [SQL Server], directiva de conmutación por error flexible"
  - "Grupos de disponibilidad [SQL Server], conmutación por error"
  - "conmutación por error [SQL Server], Grupos de disponibilidad AlwaysOn"
