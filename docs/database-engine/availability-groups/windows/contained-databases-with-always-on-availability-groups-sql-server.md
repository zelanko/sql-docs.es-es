...
helpviewer_keywords: 
  ...
  - "base de datos independiente, AlwaysOnAvailabilityGroups"
...
---
# Bases de datos independientes con grupos de disponibilidad AlwaysOn (SQL Server)
