---
title: Vistas de administración dinámica y vistas de catálogo del sistema (Grupos de disponibilidad Always On-SQL Server) | Microsoft Docs
ms.custom: ag-guide
ms.date: 06/13/2017
ms.prod: sql
ms.reviewer: ''
