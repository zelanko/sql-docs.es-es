...
3.  En el **Administrador de configuración de SQL Server**, haga clic en **Servicios de SQL Server**, haga clic con el botón derecho en SQL Server (**\<***nombre de la instancia***>)**, donde **\<***nombre de instancia***>** es el nombre de una instancia del servidor local para la que quiera habilitar los grupos de disponibilidad Always On, y haga clic en **Propiedades**.  
...
2.  Use el cmdlet **Disable-SqlAlwaysOn** para habilitar los grupos de disponibilidad AlwaysOn.  
    ...
    > [!IMPORTANT]  
    >  Para obtener información sobre cómo controlar si el cmdlet **Disable-SqlAlwaysOn** reinicia el servicio [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] , consulte [¿Cuándo reinicia un cmdlet el servicio SQL Server?](#WhenCmdletRestartsSQL), más adelante en este tema.  
