...
helpviewer_keywords: 
  ...
  - "directiva de conmutación por error flexible"
...
|Cinco|En cualquier condición de error apta. Especifica que se inicia una conmutación automática por error en el caso de condiciones de error aptas, incluidas las siguientes:<br /><br /> Se han agotado los subprocesos de trabajo del motor de SQL.<br /><br /> Detección de un interbloqueo irresoluble.<br /><br /> <br /><br /> Es el nivel más restrictivo.|5|**OnAnyQualifiedFailureConditions**|  
