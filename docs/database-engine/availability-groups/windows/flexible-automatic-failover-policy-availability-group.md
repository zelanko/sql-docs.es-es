...
description: 'Descripción de las diversas opciones disponibles al decidir el grado de flexibilidad que debe tener la directiva de conmutación por error de un grupo de disponibilidad Always On. '
ms.custom: seodec18
ms.date: 05/17/2016
ms.prod: sql
ms.reviewer: ''
