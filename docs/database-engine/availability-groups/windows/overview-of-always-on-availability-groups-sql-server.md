...
helpviewer_keywords: 
  ...
  - "Grupos de disponibilidad [SQL Server], movimiento de datos"
...
-   [Réplicas de disponibilidad](#AGsARsADBs)  
  
-   [Modos de disponibilidad](#AvailabilityModes)  
  
-   [Tipos de conmutación por error](#FormsOfFailover)  
  
-   [Conexiones de cliente](#ClientConnections)  
  
-   [Réplicas secundarias activas](#ActiveSecondaries)  
  
-   [Tiempo de espera de la sesión](#SessionTimeoutPerios)  
  
-   [Reparación de página automática](#APR)  
  
-   [Tareas relacionadas](#RelatedTasks)  
  
-   [Contenido relacionado](#RelatedContent)  
  
##  <a name="AvDbs"></a> Bases de datos de disponibilidad  
...
-   [Introducción a los grupos de disponibilidad de AlwaysOn &#40;SQL Server&#41;](../../../database-engine/availability-groups/windows/getting-started-with-always-on-availability-groups-sql-server.md)  
...
## Vea también  
 ...
 [Compatibilidad con alta disponibilidad para bases de datos OLTP en memoria](../../../relational-databases/in-memory-oltp/high-availability-support-for-in-memory-oltp-databases.md)   
