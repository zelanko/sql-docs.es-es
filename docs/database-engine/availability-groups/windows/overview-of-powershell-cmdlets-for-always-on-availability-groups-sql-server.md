...
ms.topic: "article"
helpviewer_keywords: 
  - "Grupos de disponibilidad [SQL Server], cmdlets de PowerShell"
...
##  <a name="BnRcmdlets"></a> Realizar copias de seguridad y restaurar bases de datos y registros de transacciones  
...
##  <a name="AGlisteners"></a> Crear y administrar un agente de escucha de un grupo de disponibilidad  
...
##  <a name="MonitorTblshtAGs"></a> Supervisar el estado de grupos de disponibilidad  
