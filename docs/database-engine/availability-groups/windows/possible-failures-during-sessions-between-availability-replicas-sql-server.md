...
ms.topic: "article"
helpviewer_keywords: 
  - "solución de problemas [SQL Server, "HADR"]"
...
---
# Posibles errores durante sesiones entre las r&#233;plicas de disponibilidad (SQL Server)
...
### El mecanismo de tiempo de espera de la sesión  
