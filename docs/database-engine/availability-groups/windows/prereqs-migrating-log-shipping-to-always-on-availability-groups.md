---
title: Requisitos previos para migrar desde el trasvase de registros a grupos de disponibilidad AlwaysOn | Microsoft Docs
ms.custom: ''
ms.date: 05/17/2016
ms.prod: sql
ms.reviewer: ''
...
ms.locfileid: "34770661"
---
# <a name="prereqs-migrating-log-shipping-to-always-on-availability-groups"></a>Requisitos previos para migrar desde el trasvase de registros a grupos de disponibilidad AlwaysOn
 ...
 **Para obtener más información:**  
 ...
 [Convertir una configuración de trasvase de registros en un grupo de disponibilidad](https://blogs.msdn.microsoft.com/sqlalwayson/2012/01/09/converting-a-logshipping-configuration-to-availability-group/) (blog de SQL Server)  
