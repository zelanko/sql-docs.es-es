...
ms.topic: "article"
helpviewer_keywords: 
  - "seguimiento de cambios [SQL Server], Grupos de disponibilidad AlwaysOn"
  - "cambiar captura de datos [SQL Server], Grupos de disponibilidad AlwaysOn"
...
manager: "jhubbard"
---
# Replicaci&#243;n, seguimiento de cambios, captura de datos modificados y Grupos de disponibilidad AlwaysOn (SQL Server)
...
-   [Información general de la replicación en Grupos de disponibilidad AlwaysOn](#Overview)  
  
    -   [Redirección del publicador](#PublisherRedirect)  
  
    -   [Cambios en los agentes de replicación para admitir Grupos de disponibilidad AlwaysOn](#Changes)  
  
    -   [Procedimientos almacenados que admiten AlwaysOn](#StoredProcs)  
  
    -   [Captura de datos modificados](#CDC)  
  
    -   [Seguimiento de los cambios](#CT)  
  
-   [Requisitos previos, restricciones y consideraciones para el uso de la replicación con Grupos de disponibilidad AlwaysOn](#Prereqs)  
...
###  <a name="PublisherRedirect"></a> Redirección del publicador  
 ...
 En un grupo de disponibilidad AlwaysOn una base de datos secundaria no puede ser un publicador. La acción de volver a publicar solo se admite cuando la replicación transaccional se combina con [!INCLUDE[ssHADR](../../../includes/sshadr-md.md)].  
