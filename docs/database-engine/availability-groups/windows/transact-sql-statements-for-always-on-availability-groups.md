...
helpviewer_keywords: 
  ...
  - "Grupos de disponibilidad [SQL Server], instrucciones Transact-SQL"
...
##  <a name="AlterDb"></a> ALTER DATABASE … SET HADR …  
 Las opciones de la cláusula [SET HADR](../Topic/ALTER%20DATABASE%20SET%20HADR%20\(Transact-SQL\).md) de la instrucción ALTER DATABASE permiten combinar una base de datos secundaria con el grupo de disponibilidad de la base de datos principal correspondiente, quitar una base de datos combinada y suspender la sincronización de datos en una base de datos combinada, y reanudar la sincronización de datos.  
