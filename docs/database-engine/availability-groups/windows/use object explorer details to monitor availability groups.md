...
manager: "jhubbard"
---
# Usar los detalles del Explorador de objetos para supervisar los grupos de disponibilidad (SQL Server Management Studio)
...
|Valor|Descripción|  
|-----------|-----------------|  
|**No sincronizada**|La base de datos no está sincronizada o no se ha unido todavía al grupo de disponibilidad.|  
