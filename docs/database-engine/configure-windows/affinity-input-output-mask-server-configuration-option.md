...
-   Para cubrir más de 32 CPU, configure una opción **affinity I/O mask** de cuatro bytes para las 32 primeras CPU y una opción **affinity64 I/O mask** de hasta 4 bytes para las CPU restantes.  
 ...
 Dado que establecer la opción **affinity I/O mask** de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] es una operación especializada, solo debería usarse en caso necesario. En la mayoría de los casos, la afinidad predeterminada de Windows 2000 o Windows Server 2003 proporciona el mejor rendimiento.  
