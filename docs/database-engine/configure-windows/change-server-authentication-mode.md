...
helpviewer_keywords: 
  - "cuenta SA"
  - "autenticación [SQL Server], cambiar modos"
  - "modo de autenticación del servidor [SQL Server]"
  - "modificar el modo de autenticación del servidor"
...
---
# Cambiar el modo de autenticaci&#243;n del servidor
