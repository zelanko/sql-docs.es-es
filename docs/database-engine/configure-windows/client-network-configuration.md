...
ms.topic: "article"
helpviewer_keywords: 
  - "configuración del cliente [SQL Server], conexiones"
  - "Motor de base de datos [SQL Server], configuraciones de red"
  - "conexiones [SQL Server], configuración de cliente"
  - "conexiones de cliente [SQL Server], acerca de las conexiones de red de cliente"
  - "equipos cliente [SQL Server]"
  - "conexiones de cliente [SQL Server]"
  - "conexiones de red [SQL Server], configuración de cliente"
