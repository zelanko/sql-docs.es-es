...
helpviewer_keywords: 
  ...
  - "cuenta de servicio [SQL Server], permisos de sistema de archivos"
  - "permisos [SQL Server], sistema de archivos"
...
6.  En el cuadro **Nombre de usuario o grupo**, seleccione el nombre del SID por servicio y, después, en el cuadro **Permisos para** \<nombre>, seleccione la casilla **Permitir** correspondiente a **Control total**.  
