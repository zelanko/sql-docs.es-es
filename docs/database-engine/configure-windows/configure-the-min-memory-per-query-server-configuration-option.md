...
description: Aprenda a usar la opción min memory per query a fin de especificar la concesión de memoria mínima o el número mínimo de kilobytes que SQL Server asigna para una consulta.
ms.custom: ''
ms.date: 11/24/2017
ms.prod: sql
