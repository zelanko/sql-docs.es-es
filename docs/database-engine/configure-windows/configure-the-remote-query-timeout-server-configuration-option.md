...
ms.topic: "article"
helpviewer_keywords: 
  - "límite de tiempo para consultas remotas [SQL Server]"
  - "tiempo de espera de consulta remota (opción)"
...
#### Para configurar la opción de tiempo de espera de consultas remotas  
