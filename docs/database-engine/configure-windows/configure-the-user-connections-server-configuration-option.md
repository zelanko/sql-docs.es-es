...
description: Obtenga información sobre la opción "Conexiones de usuario". Vea cómo puede ayudarle a evitar la sobrecarga de una instancia de SQL Server con demasiadas conexiones simultáneas.
ms.custom: ''
ms.date: 03/02/2017
ms.prod: sql
