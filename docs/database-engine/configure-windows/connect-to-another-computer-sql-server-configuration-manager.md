...
ms.topic: "article"
helpviewer_keywords: 
  - "conexiones [SQL Server], otros equipos"
...
manager: "jhubbard"
---
# Conectarse a otro equipo (Administrador de configuraci&#243;n de SQL Server)
...
#### Para conectarse a otro equipo con la Administración de equipos de Windows  
...
#### Para guardar un vínculo al Administrador de configuración de SQL Server para otro equipo  
...
9. Expanda **Administración de equipos(***\<nombreDeEquipo>***)** y, luego, **Servicios y Aplicaciones**.  
