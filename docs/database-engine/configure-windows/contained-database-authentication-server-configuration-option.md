...
ms.topic: "article"
helpviewer_keywords: 
  - "base de datos independiente, habilitación"
  - "opción AUTHENTICATION de la base de datos independiente"
...
> [!NOTE] Las bases de datos independientes siempre están habilitadas para [!INCLUDE[ssSDS_md](../../includes/sssds-md.md)] y [!INCLUDE[ssSDW_md](../../includes/sssdw-md.md)] no se pueden deshabilitar.
