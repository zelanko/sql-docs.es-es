...
ms.topic: "article"
helpviewer_keywords: 
  - "conexiones [SQL Server], cifradas"
  - "SSL [SQL Server]"
  - "Capa de sockets seguros (SSL)"
  - "cifrado [SQL Server], conexiones"
  - "criptografía [SQL Server], conexiones"
  - "certificados [SQL Server], instalar"
  - "conexiones cifradas, solicitar"
  - "certificados, instalar"
