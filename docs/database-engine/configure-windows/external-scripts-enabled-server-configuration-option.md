...
Para obtener más información, consulte [Set up SQL Server Machine Learning](../../machine-learning/install/sql-machine-learning-services-windows-install.md) (Configurar SQL Server Machine Learning).
