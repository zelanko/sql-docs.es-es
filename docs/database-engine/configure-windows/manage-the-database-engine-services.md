...
description: Familiarícese con los servicios que están disponibles en SQL Server. Vea cómo iniciar el Administrador de configuración de SQL Server, que se puede usar para administrar varios servicios.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
:::row:::
    :::column:::
        ...
        [Configurar permisos del sistema de archivos para el acceso al motor de base de datos](../../database-engine/configure-windows/configure-file-system-permissions-for-database-engine-access.md)
    ...
    :::column:::
        ...
        [Cambiar la contraseña de las cuentas que usa SQL Server &#40;Administrador de configuración de SQL Server&#41;](../../database-engine/configure-windows/scm-services-change-the-password-of-the-accounts-used.md)

        [Configurar registros de errores de SQL Server](../../database-engine/configure-windows/scm-services-configure-sql-server-error-logs.md)
    :::column-end:::
    :::column:::
        [Cambiar el modo de autenticación del servidor](../../database-engine/configure-windows/change-server-authentication-mode.md)

        [servicio del objeto de escritura de SQL](../../database-engine/configure-windows/sql-writer-service.md)

        [Difundir un mensaje de cierre del sistema &#40;símbolo del sistema&#41;](../../database-engine/configure-windows/broadcast-a-shutdown-message-command-prompt.md)
