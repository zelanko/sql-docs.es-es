...
description: Descubra cómo abrir el Administrador de orígenes de datos ODBC en varios sistemas operativos. Puede usar este componente de Windows para crear y administrar orígenes de datos ODBC.
ms.custom: ''
ms.date: 11/07/2016
ms.prod: sql
