...
ms.topic: "article"
helpviewer_keywords: 
  - "Servicios de SQL Server, cambiar la cuenta de inicio"
  - "cuentas de inicio [SQL Server]"
  - "cambiar las cuentas de inicio para los servicios"
...
---
# Cambiar la cuenta de inicio del servicio para SQL Server (Administrador de configuraci&#243;n de SQL Server)
...
#### Para cambiar la cuenta de inicio del servicio de SQL Server  
