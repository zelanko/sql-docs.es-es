...
helpviewer_keywords: 
  ...
  - "max server memory, opción"
  - "memoria virtual [SQL Server]"
  - "VMM"
  - "opciones de memoria del servidor [SQL Server]"
  - "servidores [SQL Server], memoria"
  - "grupos de búferes [SQL Server]"
  - "min server memory, opción"
  - "opciones de memoria manuales [SQL Server]"
  - "memoria [SQL Server], servidores"
...
## Cómo configurar las opciones de memoria utilizando SQL Server Management Studio  
