...
description: Familiarícese con la configuración de conexión en SQL Server. Obtenga información sobre las opciones que determinan la comprobación de restricciones diferidas, el control de valores NULL y otros comportamientos.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
## <a name="see-also"></a>Consulte también  
 [Options &#40;Query Execution: SQL Server: Advanced Page&#41;](https://docs.microsoft.com/sql/ssms/f1-help/database-engine-query-editor-sql-server-management-studio)  (Opciones [Ejecución de consultas: SQL Server: página Avanzado])  
