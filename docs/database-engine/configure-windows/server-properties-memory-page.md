...
description: Familiarícese con las opciones de memoria del servidor de SQL Server. Obtenga información sobre la memoria mínima y máxima del servidor, la memoria de creación de índices y otros valores.
ms.custom: ''
ms.date: 03/08/2016
ms.prod: sql
