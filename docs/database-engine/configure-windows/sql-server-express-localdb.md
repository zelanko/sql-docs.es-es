...
- ¿Tiene una cuenta de Azure? [Comience](https://azure.microsoft.com/services/virtual-machines/sql-server/) y ponga en marcha una máquina virtual con SQL Server ya instalado.
