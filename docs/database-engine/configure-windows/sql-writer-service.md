...
helpviewer_keywords: 
  - "VDI [SQL Server]"
  - "restaurar [SQL Server], Servicio del objeto de escritura de SQL"
  - "copias de seguridad [SQL Server], mientras se ejecuta SQL Server"
  - "Servicio de instantáneas de volumen"
  - "copias de seguridad de volumen mientras se ejecuta [SQL Server]"
  - "interfaz del dispositivo de copia de seguridad virtual [SQL Server]"
  - "servicio del objeto de escritura de SQL"
  - "servicios [SQL Server], objeto de escritura de SQL"
  - "objeto de escritura MSDE"
  - "VSS"
