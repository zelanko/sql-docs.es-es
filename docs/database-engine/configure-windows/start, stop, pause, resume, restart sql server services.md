---
title: "Iniciar, detener, pausar, reanudar y reiniciar el motor de base de datos, Agente SQL Server o el Servicio SQL Server Browser | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/13/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Administrador de configuración de SQL Server, iniciar y detener servicios"
  - "detener el Agente SQL Server"
  - "parámetros [SQL Server], opciones de inicio"
  - "SQL Server, opciones de inicio"
  - "Motor de base de datos [SQL Server], iniciar y detener servicios"
  - "pausar SQL Server"
  - "PowerShell [SQL Server], iniciar y detener servicios"
  - "modo de usuario único [SQL Server], a partir de"
  - "SQL Server Management Studio [SQL Server], iniciar o detener servicios"
  - "detener el servicio SQL Server Browser"
  - "iniciar el Agente SQL Server"
  - "instancias predeterminadas [SQL Server], iniciar y detener"
  - "Agente SQL Server, iniciar y detener"
  - "símbolo del sistema [SQL Server], iniciar y detener servicios de SQL Server"
  - "continuar SQL Server"
  - "iniciar Motor de base de datos de SQL Server"
  - "comandos net stop [SQL Server]"
  - "símbolo del sistema [SQL Server], servicio SQL Browser"
  - "Administrador de configuración, iniciar y detener servicios"
  - "reanudar SQL Server"
  - "opciones de inicio [SQL Server]"
  - "instancias con nombre [SQL Server], iniciar y detener"
  - "comandos net start [SQL Server]"
  - "SQL Server, iniciar y detener"
  - "detener SQL Server"
  - "iniciar el servicio SQL Server Browser"
  - "opciones de inicio de configuración de Motor de base de datos de SQL Server"
  - "administrar SQL Server, iniciar y detener servicios"
  - "Management Studio [SQL Server], iniciar o detener servicios"
...
#### Inicio del Administrador de configuración de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
#### Para iniciar, detener, pausar, reanudar o reiniciar una instancia de [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]  
  
1.  Inicie el Administrador de configuración de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] utilizando las instrucciones anteriores.  
...
> [!NOTE]  
>  Para iniciar una instancia de [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)] con opciones de inicio, vea [Configurar opciones de inicio del servidor &#40;Administrador de configuración de SQL Server&#41;](../../database-engine/configure-windows/configure-server-startup-options-sql-server-configuration-manager.md).  
  
#### Para iniciar, detener, pausar, reanudar o reiniciar [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Browser o una instancia de Agente [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
#### Para iniciar, detener o reiniciar una instancia del Agente [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
#### Para detener [!INCLUDE[ssDE](../../includes/ssde-md.md)] mediante [!INCLUDE[tsql](../../includes/tsql-md.md)]  
...
#### Para iniciar y detener servicios de [!INCLUDE[ssDE](../../includes/ssde-md.md)]  
...
## Vea también  
 [Información general de la documentación de instalación de SQL Server](../Topic/Overview%20of%20SQL%20Server%20Setup%20Documentation.md)   
