...
ms.topic: "article"
helpviewer_keywords: 
  - "iniciar SQL Server, modo de usuario único"
  - "modo de usuario único [SQL Server]"
...
5.  Conéctese a [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] usando ahora el comando siguiente y realice la operación necesaria: SQLCMD -E -S\<nombreDeServidor>.  
