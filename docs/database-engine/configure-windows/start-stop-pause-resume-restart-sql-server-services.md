---
title: Iniciar, detener, pausar, reanudar o reiniciar los servicios de SQL Server | Microsoft Docs
ms.custom: ''
ms.date: 02/26/2016
ms.prod: sql
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]
 > Para obtener contenido relativo a las versiones anteriores de SQL Server, vea [Iniciar, detener, pausar, reanudar y reiniciar el motor de base de datos, Agente SQL Server o el Servicio SQL Server Browser](https://msdn.microsoft.com/en-US/library/hh403394(SQL.120).aspx).
...
#### <a name="starting-includessnoversionincludesssnoversion-mdmd-configuration-manager"></a>Inicio del Administrador de configuración de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
#### <a name="to-start-stop-pause-resume-or-restart-an-instance-of-the-includessdenoversionincludesssdenoversion-mdmd"></a>Para iniciar, detener, pausar, reanudar o reiniciar una instancia de [!INCLUDE[ssDEnoversion](../../includes/ssdenoversion-md.md)]  
