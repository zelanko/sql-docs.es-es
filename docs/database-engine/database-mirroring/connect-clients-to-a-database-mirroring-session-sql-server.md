...
ms.topic: "article"
helpviewer_keywords: 
  - "asociados [SQL Server], conectar los clientes a"
  - "creación de reflejo de la base de datos [SQL Server], conectar los clientes a"
  - "conexiones de cliente [SQL Server], creación de reflejo de la base de datos"
  - "conexiones [SQL Server], creación de reflejo de la base de datos"
 ...
 **En este tema:**  
 ...
 [Establecer la conexión inicial en una sesión de creación de reflejo de la base de datos](#InitialConnection)  
 Presenta el nombre de asociado inicial y el nombre de asociado de conmutación por error, explica cómo los proveedores de acceso a datos realizan la conexión inicial a una base de datos reflejada y describe los atributos de la cadena de conexión para conectarse a una base de datos reflejada.  
  
 [Algoritmo de reintento de conexión (para conexiones TCP/IP)](#RetryAlgorithm)  
 Describe el algoritmo de reintento de conexión para conexiones TCP/IP.  
  
 [Volver a conectar una sesión de creación de reflejo de la base de datos](#Reconnecting)  
 Describe cómo volver a conectarse a una base de datos reflejada si, por alguna razón, una conexión establecida a una sesión de creación de reflejo de la base de datos produce un error, y el impacto de la redirección en una aplicación cliente.  
  
 [Impacto de un nombre de asociado de conmutación por error desusado](#StalePartnerName)  
 Describe el impacto del cambio, por un administrador de la base de datos, de uno de los asociados de creación de reflejo de la base de datos de una base de datos reflejada.  
