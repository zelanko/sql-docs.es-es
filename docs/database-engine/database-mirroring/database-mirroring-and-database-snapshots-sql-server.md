...
helpviewer_keywords: 
  ...
  - "instantáneas [instantáneas de base de datos de SQL Server], creación de reflejo de la base de datos"
  - "instantáneas de base de datos (SQL Server), creación de reflejo de la base de datos"
...
> [!NOTE]  
>  Para obtener más información sobre las instantáneas de base de datos, vea [Instantáneas de base de datos &#40;SQL Server&#41;](../../relational-databases/databases/database-snapshots-sql-server.md).  
