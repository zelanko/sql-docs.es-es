...
helpviewer_keywords: 
  ...
  - "trasvase de registros [SQL Server], creación de reflejo de la base de datos"
...
## Conmutación por error de la base de datos principal a la base de datos reflejada  
 ...
 ![Trasvase de registros y creación de reflejo de base de datos](../../database-engine/database-mirroring/media/logshipping-and-dbm-automatic-failover.gif "Trasvase de registros y creación de reflejo de base de datos")  
