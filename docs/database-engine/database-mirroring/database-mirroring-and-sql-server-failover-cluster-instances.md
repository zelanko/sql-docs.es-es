...
description: Obtenga información sobre cómo combinar la creación de reflejo de la base de datos con instancias de clúster de conmutación por error de SQL Server.
