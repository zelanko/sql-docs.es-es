---
title: "Estados de creacion de reflejo (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
helpviewer_keywords: 
  ...
  - "PENDING_FAILOVER [estado]"
  - "estados del reflejo de base de datos [SQL Server]"
  - "DISCONNECTED [estado]"
  - "SYNCHRONIZING [estado]"
  - "SYNCHRONIZED [estado]"
  - "SUSPENDED [estado]"
