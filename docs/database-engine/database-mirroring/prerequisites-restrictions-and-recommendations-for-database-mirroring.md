...
helpviewer_keywords: 
  ...
  - "crear reflejo de la base de datos [SQL Server], requisitos previos"
  - "crear reflejo de la base de datos [SQL Server], recomendaciones"
  - "crear reflejo de la base de datos [SQL Server], restricciones"
  - "crear reflejo de la base de datos [SQL Server], planificar"
...
-   [Compatibilidad con la creación de reflejo de la base de datos](#DbmSupport)  
  
-   [Requisitos previos](#Prerequisites)  
  
-   [Restricciones](#Restrictions)  
  
-   [Recomendaciones para configurar servidores asociados](#RecommendationsForPartners)  
  
-   [Recomendaciones para implementar la creación de reflejo de la base de datos](#RecommendationsForDeploying)  
  
##  <a name="DbmSupport"></a> Compatibilidad con la creación de reflejo de la base de datos  
 Para obtener información sobre la compatibilidad con la creación de reflejo de la base de datos en [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)], vea [Características compatibles con las ediciones de SQL Server 2016](../Topic/Features%20Supported%20by%20the%20Editions%20of%20SQL%20Server%202016.md).  
