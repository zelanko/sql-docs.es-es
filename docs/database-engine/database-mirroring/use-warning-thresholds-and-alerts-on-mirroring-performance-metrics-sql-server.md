...
helpviewer_keywords: 
  ...
  - "umbrales [SQL Server]"
  - "creación de reflejo de la base de datos [SQL Server], administrar en SQL"
  - "alertas [SQL Server], creación de reflejo de base de datos"
  - "creación de reflejo de la base de datos [SQL Server], supervisar"
  - "advertencia [creación de reflejo de la base de datos]"
