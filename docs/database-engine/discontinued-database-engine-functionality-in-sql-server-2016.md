...
-   [Funcionalidad del motor de base de datos no incluida en SQL Server 2012](discontinued-database-engine-functionality-in-sql-server-2016.md)  
  
-   [Funcionalidad del motor de base de datos no incluida en SQL Server 2008](discontinued-database-engine-functionality-in-sql-server-2016.md)  
