---
title: "Instalaci&#243;n de SQL Server 2016 en Server Core | Microsoft Docs"
ms.custom: ""
ms.date: "03/13/2017"
...
manager: "jhubbard"
---
# Instalaci&#243;n de SQL Server 2016 en Server Core
...
|Windows PowerShell|Incluido con la instalación Server Core de [!INCLUDE[winserver2008r2](../../includes/winserver2008r2-md.md)] SP1 y [!INCLUDE[win8srv](../../includes/win8srv-md.md)].|  
  
##  <a name="a-namebksupportedfeaturesa-supported-features"></a><a name="BK_SupportedFeatures"></a> Características admitidas  
 ...
 *La instalación de la versión de 32 bits de las ediciones de [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] no se admite en Server Core.  
...
2.  **Instalación mediante el archivo de configuración**  
    ...
    -   Instalación de [!INCLUDE[ssDE](../../includes/ssde-md.md)]. En el siguiente ejemplo se muestra cómo instalar una nueva instancia independiente que incluye el [!INCLUDE[ssDE](../../includes/ssde-md.md)] de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]:  
...
## <a name="configuring-remote-access-of-includessnoversiontokenssnoversionmdmd-running-on-server-core"></a>Configurar el acceso remoto de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] en ejecución en Server Core  
...
### <a name="enable-remote-connections-on-the-instance-of-includessnoversiontokenssnoversionmdmd"></a>Habilitar las conexiones remotas en la instancia de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
### <a name="enable-and-start-the-includessnoversiontokenssnoversionmdmd-browser-service"></a>Habilitar e iniciar el servicio [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Browser  
...
### <a name="enable-tcpip-on-the-instance-of-includessnoversiontokenssnoversionmdmd"></a>Habilitar TCP/IP en la instancia de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
