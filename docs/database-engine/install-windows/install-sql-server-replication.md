...
ms.topic: "article"
helpviewer_keywords: 
  - "componentes [replicación de SQL Server]"
  - "instalaciones de línea de comandos [replicación de SQL Server]"
  - "instalar replicación"
  - "replicación [SQL Server], instalar"
...
---
# Instalar la replicaci&#243;n de SQL Server
...
## Instalar la replicación mediante el programa de instalación  
...
## Instalar la replicación desde el símbolo del sistema  
 **Para instalar la replicación al instalar una nueva instancia de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]**  
  
-   Vea [Instalar SQL Server 2016 desde el símbolo del sistema](../../database-engine/install-windows/install-sql-server-2016-from-the-command-prompt.md).  
