...
# <a name="install-sql-server"></a>Instalar SQL Server
 ...
 > Para obtener contenido relacionado sobre las versiones anteriores de SQL Server, vea [Instalar SQL Server 2014](https://msdn.microsoft.com/en-US/library/bb500395(SQL.120).aspx).
...
- Encontrará **ediciones gratuitas** en las [descargas de SQL Server](http://www.microsoft.com/sql-server/sql-server-downloads).
