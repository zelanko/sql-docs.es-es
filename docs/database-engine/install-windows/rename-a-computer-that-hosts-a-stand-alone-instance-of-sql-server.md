...
ms.topic: "article"
helpviewer_keywords: 
  - "errores de inicio de sesión remoto [SQL Server]"
  - "nombres de equipos independientes [SQL Server]"
  - "nombres [SQL Server], instancias independientes de SQL Server"
  - "cambiar nombre de instancias independientes de SQL Server"
  - "tabla del sistema sysservers"
  - "quitar inicios de sesión remotos"
  - "eliminar inicios de sesión remotos"
  - "quitar inicios de sesión remotos"
...
-   Seleccione la información de @@SERVERNAME o de sys.servers. La función @@SERVERNAME devolverá el nombre nuevo y la tabla sys.servers lo mostrará. En el siguiente ejemplo se muestra el uso de la propiedad @@SERVERNAME.  
