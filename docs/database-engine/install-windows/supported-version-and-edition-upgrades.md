...
ms.topic: "article"
helpviewer_keywords: 
  - "componentes [SQL Server], agregar a las instalaciones existentes"
  - "versiones [SQL Server], actualizar"
  - "actualizar SQL Server, actualizaciones admitidas"
...
-   Para actualizar a [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)], debe ejecutar un sistema operativo admitido. Para obtener más información, vea [Requisitos de hardware y software para instalar SQL Server 2016](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server-2016.md).  
...
## Actualizaciones de versiones anteriores a [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
 
SQL Server 2016 admite la actualización de las siguientes versiones de SQL Server:
 
- SQL Server 2008 SP3 o posterior
...
>  Para actualizar bases de datos en [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] vea [Compatibilidad con la versión 2005](#SupportFor2005).  
 ...
 En la siguiente tabla se indican los escenarios de actualización de versiones anteriores de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] a [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] admitidos.  
...
|[!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] SP3 Developer|[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Desarrollador|  
...
|[!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)] SP2 Developer|[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Desarrollador|  
...
|[!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] SP2 Developer|[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Desarrollador <br/> <br/> [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Standard <br/> <br/> [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Web <br/> <br/> [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Enterprise <br/> |  
...
|[!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] Desarrollador|[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Developer <br/> <br/> [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Standard <br/> <br/> [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Web <br/> <br/> [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Enterprise <br/> |  
...
|[!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] versión candidata para lanzamiento* |[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Enterprise |  
|[!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] Desarrollador |[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Enterprise | 
...
###  <a name="SupportFor2005"></a> [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Compatibilidad con [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)]  
 En esta sección se explica la compatibilidad de [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] con [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)]. En [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)], podrá hacer lo siguiente:  
  
-   Adjuntar una base de datos de [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] (archivos mdf/ldf) a la instancia de [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] del motor de base de datos.  
  
-   Restaurar una base de datos de [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] a la instancia de [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] del motor de base de datos desde una copia de seguridad.  
  
-   Hacer copia de seguridad de un cubo de [!INCLUDE[ssASversion2005](../../includes/ssasversion2005-md.md)] y restaurarla en [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].  
  
 Cuando una base de datos de [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] se actualiza a [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)], el nivel de compatibilidad de la base de datos se cambia de 90 a 100. (En [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)], los valores válidos del nivel de compatibilidad de la base de datos son 100, 110, 120 y 130). En el tema [Nivel de compatibilidad de ALTER DATABASE &#40;Transact-SQL&#41;](../Topic/ALTER%20DATABASE%20Compatibility%20Level%20\(Transact-SQL\).md) se explica cómo el cambio del nivel de compatibilidad puede afectar a las aplicaciones de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
  
 Los escenarios no especificados en la lista anterior no se admiten, incluidos pero no limitados a lo siguiente:  
  
-   Instalar [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] y [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] en el mismo equipo (en paralelo).  
  
-   Usar una instancia de [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] como miembro de la topología de replicación que incluye una instancia de [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].  
  
-   Configurar la creación de reflejo de la base de datos entre instancias de [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] y [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] .  
  
-   Hacer copia de seguridad del registro de transacciones con trasvase de registros entre instancias de [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] y [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] .  
  
-   Configurar servidores vinculados entre instancias de [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] y [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] .  
  
-   Administrar una instancia de [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)] desde [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Management Studio.  
  
-   Adjuntar un cubo de [!INCLUDE[ssASversion2005](../../includes/ssasversion2005-md.md)] en [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Management Studio.  
  
-   Conectarse a [!INCLUDE[ssISversion2005](../../includes/ssisversion2005-md.md)] desde [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Management Studio.  
  
-   Administrar un servicio de [!INCLUDE[ssISversion2005](../../includes/ssisversion2005-md.md)] desde [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Management Studio.  
...
## [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Actualización de edición  
 En la tabla siguiente se enumeran los escenarios de actualización de edición de [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] admitidos.  
  
 Para obtener instrucciones paso a paso sobre cómo realizar una actualización de edición, vea [Actualizar a una edición diferente de SQL Server 2016 &#40;programa de instalación&#41;](../../database-engine/install-windows/upgrade-to-a-different-edition-of-sql-server-2016-setup.md).  
  
|Actualización de|Actualización a|  
|------------------|----------------|  
|[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Enterprise (Server+CAL y Core)**|[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Enterprise |  
|[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Evaluation Enterprise**|[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Enterprise (licencia Server+CAL o Core) <br/><br/> [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Standard <br/> <br/> [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Desarrollador <br/> <br/> [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Web <br/> <br/> La actualización de Evaluation (una edición gratuita) a cualquiera de las ediciones de pago se admite para las instalaciones independientes, pero no para las instalaciones en clúster.|  
|[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Standard**|[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Enterprise (licencia Server+CAL o Core)|  
|[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Developer**|[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Enterprise (licencia Server+CAL o Core) <br/><br/> [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Web <br/> <br/> [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Standard|  
|[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Web|[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Enterprise (licencia Server+CAL o Core) <br/><br/> [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Standard|  
|[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Express*|[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Enterprise (licencia Server+CAL o Core) <br/><br/> [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Desarrollador <br/> <br/> [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Standard <br/> <br/> [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Web|  
  
 Además, también puede realizar una actualización de edición entre [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Enterprise (licencia Server+CAL) y [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Enterprise (licencia Core):  
  
|Actualización de edición desde|Actualización de edición a|  
|--------------------------|------------------------|  
|[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Enterprise (licencia Server+CAL)**|[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Enterprise (licencia Core)|  
|[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Enterprise (licencia Core)|[!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Enterprise (licencia Server+CAL)|  
  
 \* También se aplica a [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Express with Tools y [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Express con Advanced Services.  
  
 ** El cambio de edición de un clúster de conmutación por error de [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] está limitado. Los escenarios siguientes no se admiten en los clústeres de conmutación por error de [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]:  
  
-   [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Enterprise a [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Developer, Standard o Evaluation.  
  
-   [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Developer a [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Standard o Evaluation.  
  
-   [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Standard a [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Evaluation.  
  
-   [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Evaluation a [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)] Standard.  
