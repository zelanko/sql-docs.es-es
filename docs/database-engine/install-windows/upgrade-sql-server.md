...
-   [¿Desea actualizar desde SQL Server 2005?](../../sql-server/end-of-support/sql-server-end-of-life-overview.md)  
...
## <a name="see-also"></a>Consulte también  
 ...
 [Compatibilidad con versiones anteriores](../discontinued-database-engine-functionality-in-sql-server.md)  
