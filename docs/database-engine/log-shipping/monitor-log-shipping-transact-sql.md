...
ms.topic: "article"
helpviewer_keywords: 
  - "trasvase de registros [SQL Server], estado"
  - "tablas de historial [SQL Server]"
  - "información histórica [SQL Server], trasvase de registros"
  - "trasvase de registros [SQL Server], supervisar"
  - "alertas [SQL Server], trasvase de registros"
  - "información de estado [SQL Server], trasvase de registros"
  - "supervisar trasvase de registros [SQL Server]"
