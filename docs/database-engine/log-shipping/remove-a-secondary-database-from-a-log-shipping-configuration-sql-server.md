...
ms.topic: "article"
helpviewer_keywords: 
  - "eliminar bases de datos secundarias"
  - "bases de datos secundarias [SQL Server], en trasvase de registros"
  - "quitar bases de datos secundarias"
  - "archivos de datos secundarios [SQL Server], quitar"
...
---
# Quitar una base de datos secundaria desde una configuraci&#243;n del trasvase de registros (SQL Server)
...
#### Para quitar una base de datos secundaria de trasvase de registros  
...
#### Para quitar una base de datos secundaria  
