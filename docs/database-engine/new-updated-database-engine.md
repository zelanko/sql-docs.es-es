...
1. [Propagación automática de las réplicas secundarias](availability-groups/windows/automatic-seeding-secondary-replicas.md)
2. [Configurar un grupo de disponibilidad para las transacciones distribuidas](availability-groups/windows/configure-availability-group-for-distributed-transactions.md)
3. [Configurar grupos de disponibilidad distribuidos](availability-groups/windows/configure-distributed-availability-groups.md)
4. [Grupos de disponibilidad distribuidos](availability-groups/windows/distributed-availability-groups.md)
5. [Grupos de disponibilidad independientes del dominio](availability-groups/windows/domain-independent-availability-groups.md)
6. [Características en desuso del motor de base de datos de SQL Server 2017](deprecated-database-engine-features-in-sql-server-2017.md)
