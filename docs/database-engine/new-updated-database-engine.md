...
1. [Guía de solución de problemas y supervisión de grupos de disponibilidad AlwaysOn](availability-groups/windows/always-on-availability-groups-troubleshooting-and-monitoring-guide.md)
2. [Eventos extendidos de grupos de disponibilidad Always On](availability-groups/windows/always-on-extended-events.md)
3. [Registro de diagnósticos del mantenimiento de grupos de disponibilidad Always On](availability-groups/windows/always-on-health-diagnostics-log.md)
4. [Directivas de grupos de disponibilidad Always On](availability-groups/windows/always-on-policies.md)
5. [Búferes de anillo de grupos de disponibilidad Always On](availability-groups/windows/always-on-ring-buffers.md)
6. [Tipos de espera de grupos de disponibilidad Always On](availability-groups/windows/always-on-wait-types.md)
7. [CLUSTER.LOG (Grupos de disponibilidad Always On)](availability-groups/windows/cluster-log-always-on-availability-groups.md)
8. [Vistas de administración dinámica y vistas de catálogo del sistema (Grupos de disponibilidad Always On)](availability-groups/windows/dynamic-management-views-and-system-catalog-views-always-on-availability-groups.md)
9. [Monitor performance for Always On Availability Groups](availability-groups/windows/monitor-performance-for-always-on-availability-groups.md) (Supervisar el rendimiento de los grupos de disponibilidad Always On)
10. [Registro de errores de SQL Server (Grupos de disponibilidad Always On)](availability-groups/windows/sql-server-error-log-always-on-availability-groups.md)
11. [Solución de problemas: el grupo de disponibilidad superó el RPO](availability-groups/windows/troubleshoot-availability-group-exceeded-rpo.md)
12. [Solución de problemas: el grupo de disponibilidad superó el RTO](availability-groups/windows/troubleshoot-availability-group-exceeded-rto.md)
13. [Solución de problemas: cambios en la réplica principal que no se reflejan en la réplica secundaria](availability-groups/windows/troubleshoot-primary-changes-not-reflected-on-secondary.md)
14. [Herramientas útiles para solucionar problemas](availability-groups/windows/useful-tools-for-troubleshooting.md)
