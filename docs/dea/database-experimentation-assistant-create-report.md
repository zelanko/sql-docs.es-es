...
- **Nombre del informe**: escriba un nombre para el informe. El nombre del informe se usa para las bases de datos A y B. Ejemplo: *A (o B)*  + *nombre de informe* + *identificador único*. 
...
Se genera un nuevo informe de análisis. La base de datos de análisis sigue el nombre del informe Analysis + *especificado por el usuario* + *identificador único*.

## <a name="frequently-asked-questions-about-analysis-reports"></a>Preguntas más frecuentes sobre los informes de análisis

### <a name="what-does-my-analysis-report-tell-me"></a>¿Qué me informa mi informe de análisis?
...
### <a name="can-i-create-a-new-analysis-report-while-another-report-is-being-generated"></a>¿Puedo crear un nuevo informe de análisis mientras se genera otro informe?
...
### <a name="i-upgraded-dea-to-version-20-can-i-still-view-and-use-my-old-reports"></a>He actualizado DEA a la versión 2,0. ¿Puedo seguir viendo y usando mis informes antiguos?
...
### <a name="can-i-generate-an-analysis-report-by-using-the-command-prompt"></a>¿Se puede generar un informe de análisis mediante el símbolo del sistema?
...
###  <a name="what-security-permissions-do-i-need-to-generate-and-view-an-analysis-report-on-my-server"></a>¿Qué permisos de seguridad necesito para generar y ver un informe de análisis en mi servidor?
