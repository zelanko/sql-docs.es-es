...
- Descargue e instale:
    - [Data Migration Assistant](https://www.microsoft.com/en-us/download/details.aspx?id=53595) v3.6 o superior.
    ...
    - [SSMS](https://docs.microsoft.com/en-us/sql/ssms/download-sql-server-management-studio-ssms) 17.0 o posterior.
...
2. Abra el [módulos de PowerShell](https://msdnshared.blob.core.windows.net/media/2018/03/PowerShell-Modules.zip)y, a continuación, guardarlos en la carpeta que creó.
      ...
      ![Módulos de PowerShell](../dma/media//dma-assesssqlonprem/dma-powershell-modules.png)

    Cada carpeta contiene el archivo. psm1 asociado, como se muestra en el gráfico siguiente:

   ![Archivos. psm1 de módulos de PowerShell](../dma/media//dma-assesssqlonprem/dma-powershell-modules-psm1-files.png)
   ...
   ![propiedades del archivo. psm1](../dma/media//dma-assesssqlonprem/dma-psm1-file-properties.png)
...
Cuando se usa un archivo csv para importar los datos, asegúrese de que hay solo dos columnas de datos – **nombre de instancia** y **nombre de base de datos**, y que las columnas no tienen filas de encabezado.
 ...
 ![contenido del archivo CSV](../dma/media//dma-assesssqlonprem/dma-csv-file-contents.png)
...
- AssessmentFlag
 ...
 ![Contenido de la tabla de SQL Server](../dma/media//dma-assesssqlonprem/dma-sql-server-table-contents.png)
...
Después de cargar los módulos de PowerShell en el directorio modules y crear un inventario, deberá ejecutar una evaluación de escalado, abra PowerShell y ejecute la función dmaDataCollector.
  ...
  ![anuncios de dmaDataCollector (función)](../dma/media//dma-assesssqlonprem/dma-dmaDataCollector-function-listing.png)
...
Si se produce un error inesperado, se terminará la ventana de comandos que se inicia por este proceso.  Revise el registro de errores para determinar por qué se produjo un error.
  ...
  ![Ubicación de registro de errores](../dma/media//dma-assesssqlonprem/dma-error-log-file-location.png)
...
Una vez finalizada la evaluación, ahora está listo para importar los datos en SQL Server para su análisis. Para consumir el archivo JSON de evaluación, abra PowerShell y ejecute la función dmaProcessor.
  ...
  ![anuncio de función dmaProcessor](../dma/media//dma-assesssqlonprem/dma-dmaProcessor-function-listing.png)
...
2. Cargar el almacenamiento de datos.
      ...
      ![LoadWarehouse contenido cargado](../dma/media//dma-assesssqlonprem/dma-LoadWarehouse-loaded.png)
...
También puede usar la secuencia de comandos LoadWarehouse para proporcionar las instrucciones de TSQL básicas para establecer los propietarios de base de datos.
  ...
  ![Propietarios de configuración LoadWarehouse](../dma/media//dma-assesssqlonprem/dma-LoadWarehouse-set-owners.png)
...
2. Escriba los detalles del servidor que señalan a su **DMAWarehouse** de base de datos y, a continuación, seleccione **carga**.
    ...
    > No presione ENTRAR para aceptar los valores.
      ...
      ![Carga plantilla de DMA informes Power BI](../dma/media//dma-assesssqlonprem/dma-reports-powerbi-template-loaded.png)
   ...
   ![Vista de informe DMAWarehouse](../dma/media//dma-assesssqlonprem/dma-DMAWarehouse-report.png)
...
- Evaluaciones de forma local
  ...
  ![Marcadores de informe DMA](../dma/media//dma-assesssqlonprem/dma-report-bookmarks.png)
...
### <a name="readiness-"></a>% De disponibilidad
  ...
  ![Porcentaje de preparación de DMA](../dma/media//dma-assesssqlonprem/dma-readiness-percentage.png)
...
### <a name="readiness-count"></a>Recuento de preparación
  ...
  ![Recuento de preparación de DMA](../dma/media//dma-assesssqlonprem/dma-readiness-count.png)
...
### <a name="readiness-bucket"></a>Depósito de preparación
  ...
  ![Depósito de preparación de DMA](../dma/media//dma-assesssqlonprem/dma-readiness-bucket.png)
...
### <a name="database-readiness"></a>Preparación de la base de datos
  ...
  ![Informe de preparación de la base de datos de DMA](../dma/media//dma-assesssqlonprem/dma-database-readiness-report.png)
...
- ImpactedObjectName
 ...
 ![Obtención de detalles de informe de preparación de la base de datos de DMA](../dma/media//dma-assesssqlonprem/dma-database-readiness-report-drilldown.png)
...
Esta tarea filtra el informe del plan de corrección para el nivel de jerarquía actual según el punto en el que deba seleccionar la opción de obtención de detalles.
  ...
  ![Preparación de la base de datos de DMA informes detallados filtrados](../dma/media//dma-assesssqlonprem/dma-database-readiness-report-drilldown-filtered.png)

  ![Informe del Plan de corrección de DMA](../dma/media//dma-assesssqlonprem/dma-remediation-plan-report.png)
...
También puede usar el informe del Plan de corrección en su propio para crear una solución personalizada plan mediante el uso de los filtros en la **visualizaciones filtros** hoja.
  ...
  ![Opciones de filtro de informe de Plan de corrección de DMA](../dma/media//dma-assesssqlonprem/dma-remediation-plan-report-filter-options.png)
