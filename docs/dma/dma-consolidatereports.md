...
2. Abra el [módulos de PowerShell](https://msdnshared.blob.core.windows.net/media/2019/02/PowerShell-Modules1.zip)y, a continuación, guardarlos en la carpeta que creó.
