...
## <a name="remarks"></a>Notas  
 ...
 En el **WITH** cláusula que se aplica a la tabla de casos, puede especificar opciones de filtrado y obtención de detalles:  
