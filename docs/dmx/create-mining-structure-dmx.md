...
### <a name="example-1-adding-a-structure-with-no-training-set"></a>Ejemplo 1: Agregar una estructura sin ningún conjunto de entrenamiento  
...
### <a name="example-2-specifying-holdout-percentage-and-seed"></a>Ejemplo 2: Especificar el porcentaje de exclusión y el inicialización  
...
### <a name="example-3-specifying-holdout-percentage-and-max-cases"></a>Ejemplo 3: Especificar el porcentaje de exclusión y el número máximo de casos  
