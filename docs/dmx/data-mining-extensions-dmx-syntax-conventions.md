---
title: "Convenciones de sintaxis de extensiones (DMX) de minería de datos | Documentos de Microsoft"
ms.custom: 
ms.date: 03/02/2016
...
|`[ ]`(paréntesis)|Contienen elementos de sintaxis opcionales. No escriba los corchetes.|  
