---
title: Actualizar - DMX para documentos de SQL Server | Documentos de Microsoft
description: Mostrar fragmentos de contenido actualizado para recientemente modificadas en documentación, para la minería de datos extensiones (DMX) para Microsoft SQL Server.
manager: craigg
author: MightyPen
ms.author: genemi
ms.topic: article
...
ms.locfileid: "35312754"
---
# <a name="new-and-recently-updated-data-mining-extensions-dmx-for-sql-server"></a>Nuevos y actualizados recientemente: extensiones de minería de datos (DMX) para SQL Server
...
- *Área de asunto:* &nbsp; **extensiones de minería de datos (DMX) para SQL Server**.
