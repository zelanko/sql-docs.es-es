...
## <a name="remarks"></a>Observaciones  
 Si la referencia de columna es discreta, **PredictStdev** devuelve 0 porque la desviación estándar no se puede calcular a partir de valores discretos.  
