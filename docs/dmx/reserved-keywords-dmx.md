---
title: (DMX) de palabras clave reservadas | Microsoft Docs
ms.date: 06/07/2018
ms.prod: sql
...
-   Todas las instrucciones de definición de datos que se enumeran en el tema, [instrucciones de definición de datos de DMX](../dmx/dmx-statements-data-definition.md).  
  
-   Todos los datos aparecen en el tema de funciones de consulta de minería de datos [referencia de funciones DMX](../dmx/data-mining-extensions-dmx-function-reference.md).  
  
-   Todos los operadores se enumeran en el tema [referencia de operadores DMX](../dmx/data-mining-extensions-dmx-operator-reference.md).  
