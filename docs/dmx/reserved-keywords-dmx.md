...
-   Todos los datos que aparecen en el tema de funciones de consulta de minería de datos [referencia de funciones DMX](../dmx/data-mining-extensions-dmx-function-reference.md).  
  
-   Todos los operadores incluidos en el tema [referencia de operadores DMX](../dmx/data-mining-extensions-dmx-operator-reference.md).  
