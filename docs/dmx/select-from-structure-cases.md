...
### <a name="example-1-drill-through-to-structure-cases"></a>Ejemplo 1: Obtención de detalles para casos de estructura  
...
### <a name="example-2-drillthrough-to-test-or-training-cases-only"></a>Ejemplo 2: Obtención de detalles de pruebas o solo los casos de entrenamiento  
