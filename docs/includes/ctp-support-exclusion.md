...
ms.locfileid: "68220727"
---
### <a name="enabled-deployment-scenarios"></a>Escenarios de implementación habilitados

CTP 3.1 habilita los escenarios siguientes:

- Instalación simultánea. Instale instancias de SQL Server 2019 CTP 3.1 con instancias de SQL Server 2012 a través de SQL Server 2017 u otras instancias de SQL Server 2019 CTP 3.0 o superior.
   >[!NOTE]
...
- Actualización local. Las instancias de SQL Server 2019 CTP 3.1 se actualizan desde instancias de SQL Server 2012 a SQL Server 2017 y SQL Server CTP 3.0. No se admite la actualización desde una instancia de SQL Server 2019 CTP inferior a la versión 3.0; se debe realizar una instalación nueva.
   >[!NOTE]
...
SQL Server 2019 CTP 3.1 es software en versión preliminar. No se admite públicamente para las operaciones. Los clientes que participen en el [programa de adopción temprana de SQL](http://aka.ms/sqleap) pueden tener soporte técnico para ejecutar SQL Server 2019 CTP 3.1 por un contrato especial, en colaboración con Microsoft.
