---
title: "Cómo administrar un servicio CDC desde la consola del diseñador CDC | Documentos de Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
4.  Puede realizar las siguientes tareas para un servicio CDC:  
    ...
    -   **Detener todas las instancias** (que estén incluidas en el servicio CDC seleccionado)  
     ...
     Para obtener información acerca de estas tareas, vea [Manage a CDC Service](../../integration-services/change-data-capture/manage-a-cdc-service.md).  
