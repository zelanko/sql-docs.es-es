...
ms.topic: "article"
helpviewer_keywords: 
  - "conexiones [Integration Services], ADO"
  - "administradores de conexiones [Integration Services], ADO"
  - "ADO, administrador de conexiones [Integration Services]"
...
## Solución de problemas del administrador de conexiones ADO  
...
## Configurar el Administrador de conexiones ADO  
