...
ms.topic: "article"
helpviewer_keywords: 
  - "administradores de conexión [Integration Services], ADO.NET"
  - "ADO.NET, administrador de conexiones [Integration Services]"
  - "conexiones [Integration Services], ADO.NET"
