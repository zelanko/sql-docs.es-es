...
ms.topic: "article"
helpviewer_keywords: 
  - "conexiones [Integration Services], Analysis Services"
  - "administrador de conexión [Integration Services], Analysis Services"
...
## Configuración del administrador de conexiones de Analysis Services  
