...
* Agregue la propiedad extendida IMEX a la cadena de conexión para invalidar el comportamiento predeterminado del controlador. Al agregar la propiedad extendida "; IMEX = 1" al final de la cadena de conexión, Excel trata todos los datos como texto. Vea el ejemplo siguiente:
