...
ms.topic: "article"
helpviewer_keywords: 
  - "FTP, administrador de conexiones"
  - "conexiones [Integration Services], FTP"
  - "administradores de conexión [Integration Services], FTP"
...
---
# Administrador de conexiones FTP
...
## Configuración del administrador de conexiones FTP  
