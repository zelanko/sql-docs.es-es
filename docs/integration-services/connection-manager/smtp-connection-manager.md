---
description: Administrador de conexiones SMTP
...
-   Especificar si la comunicación se cifrará mediante la Seguridad de la capa de transporte (TLS), anteriormente conocida como Capa de sockets seguros (SSL), al enviar mensajes de correo electrónico.  
 ...
 Para obtener más información sobre las propiedades que puede configurar en el Diseñador de [!INCLUDE[ssIS](../../includes/ssis-md.md)] , vea [Editor del administrador de conexiones SMTP]().  
