...
-   **Symbols** De forma predeterminada, la lista de **símbolos** contiene los siguientes caracteres: `,.;:-"'`~=&/@!?()<>[]{}|#*^%`. For example, if the symbols are "`()-`", el valor "(425) 123-4567" se ha tokenizado como ["(", "425", ")", "123", "-", "4567", ")"].  
