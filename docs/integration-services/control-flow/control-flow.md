...
ms.topic: "article"
helpviewer_keywords: 
  - "flujo de control [Integration Services], elementos"
  - "SSIS, elementos de flujo de control"
  - "SQL Server Integration Services, elementos de flujo de control"
...
# Flujo de control
 ...
 ![Flujo de control con seis tareas y un contenedor](../../integration-services/control-flow/media/ssis-controlflowelmt.gif "Flujo de control con seis tareas y un contenedor")  
...
## Implementación de flujo de control  
 ...
 ![Captura de pantalla del diseñador de flujo de control con paquete](../../integration-services/control-flow/media/samplecontrolflow.gif "Captura de pantalla del diseñador de flujo de control con paquete")  
