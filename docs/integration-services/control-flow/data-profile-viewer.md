---
title: Visor de perfil de datos | Documentos de Microsoft
ms.custom: 
ms.date: 03/01/2017
...
-   En la carpeta  *\<unidad >*: \Program archivos (x86) | Programa de programa\Microsoft SQL Server\110\DTS\Binn, ejecute DataProfileViewer.exe.  
