...
helpviewer_keywords: 
  - "tarea de generación de perfiles de datos [Integration Services], acerca de la tarea de generación de perfiles de datos"
...
|InclusionProfile|Columnas de tipo **integer** , **char** y **datetime**|  
 ...
 \*\* Los tipos **image**, **text**, **XML**, **udt** y **variant** solo se admiten para el perfil de proporción de columnas nulas.  
