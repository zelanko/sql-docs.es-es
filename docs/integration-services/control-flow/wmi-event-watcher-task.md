...
helpviewer_keywords: 
  ...
  - "Monitor de eventos WMI, tarea [Integration Services]"
...
## Configuración de la tarea Monitor de eventos WMI  
...
## Configuración mediante programación de la tarea Monitor de eventos WMI  
