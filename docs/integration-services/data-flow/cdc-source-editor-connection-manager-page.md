...
-   **Neto con máscara de actualización**: este modo es similar al modo Neto normal pero también agrega columnas booleanas con el patrón de nombre **__$\<column-name>\___Changed** que indica las columnas modificadas en la fila de cambio actual.  
