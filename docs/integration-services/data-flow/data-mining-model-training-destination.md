...
helpviewer_keywords: 
  - "destinos [Integration Services], entrenamiento del modelo de minería de datos"
  - "entrenamiento del modelo de minería de datos, destino"
  - "modelos de minería de datos [Analysis Services], entrenar"
...
## Configuración del destino de entrenamiento del modelo de minería de datos  
