...
## Consideraciones de uso  
 El Administrador de conexiones con Excel usa el Proveedor [!INCLUDE[msCoName](../../includes/msconame-md.md)] OLE DB para Jet 4.0 y el controlador ISAM (Método de acceso secuencial indexado) de Excel asociado para conectar con orígenes Excel de datos y leer y escribir datos en ellos.  
