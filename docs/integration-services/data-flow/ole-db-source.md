---
title: Origen de OLE DB | Documentos de Microsoft
ms.custom: 
ms.date: 03/14/2017
...
### <a name="open-the-ole-db-source-editor-connection-manager-page"></a>Abra el Editor de origen de OLE DB (página Administrador de conexiones)  
