---
title: "Editor de origen de archivos sin formato (página columnas) | Documentos de Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
# <a name="raw-file-source-editor-columns-page"></a>Editor de origen de archivos sin formato (página Columnas)
  El origen de archivo sin formato lee datos sin formato de un archivo. Como la representación de los datos es la nativa del origen, no es necesario traducir los datos y prácticamente no es necesario analizar el archivo. Para más información, consulte [Raw File Source](../../integration-services/data-flow/raw-file-source.md).  
