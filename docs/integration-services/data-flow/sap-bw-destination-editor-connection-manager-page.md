...
---
# Editor de destino de SAP BW (p&#225;gina Administrador de conexiones)
...
### Opciones InfoPackage/InfoSource  
 ...
 **Servicio de puerta de enlace**  
 Permite escribir el nombre del servicio de puerta de enlace, en formato **sapgwNN**, donde **NN** es el número del sistema.  
...
### Crear opciones de objetos de SAP BW  
