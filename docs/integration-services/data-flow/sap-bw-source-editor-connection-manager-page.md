...
---
# Editor de origen de SAP BW (p&#225;gina Administrador de conexiones)
...
## Opciones dinámicas del modo de ejecución  
  
> [!NOTE]  
>  Si no conoce todos los valores necesarios para configurar el origen, puede que tenga que ponerse en contacto con el administrador de SAP.  
  
### Modo de ejecución = P - Desencadenar cadena de procesos  
...
#### Opciones de la cadena de procesos  
...
### Modo de ejecución = W - Esperar notificación  
...
### Modo de ejecución = E - Extraer únicamente  
 **Id. de solicitud**  
