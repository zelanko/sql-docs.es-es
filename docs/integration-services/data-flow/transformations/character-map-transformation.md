---
description: Transformación Mapa de caracteres
 ...
 **Configurar la salida de errores**  
 Use el cuadro de diálogo [Configurar la salida de errores](../error-handling-in-data.md) para especificar las opciones de control de errores de esta transformación.  
