...
ms.topic: "article"
helpviewer_keywords: 
  - "transformaciones [Integration Services], enumeradas"
  - "transformaciones [Integration Services], tipos"
  - "transformaciones [Integration Services]"
  - "flujo de datos [Integration Services], transformaciones"
  - "Business Intelligence, transformaciones [Integration Services]"
  - "combinación, transformaciones"
  - "división, transformaciones [Integration Services]"
  - "transformaciones personalizadas [Integration Services]"
  - "fila, transformaciones [Integration Services]"
  - "conjunto de filas, transformaciones [Integration Services]"
