---
title: DTUtil (utilidad) | Documentos de Microsoft
ms.custom: 
ms.date: 03/14/2017
...
-   Abra una ventana de símbolo del sistema, cambie al directorio que contiene la versión de 64 bits de la utilidad *(\<unidad >*: \Program SQL Server\130\DTS\Binn), y, a continuación, ejecute la utilidad desde esa ubicación.  
  
-   En el símbolo del sistema, ejecute la utilidad escribiendo la ruta de acceso completa (*\<unidad >*: \Program SQL Server\130\DTS\Binn) a la versión de 64 bits de la utilidad.  
  
-   Cambie de forma permanente el orden de las rutas de acceso en la variable de entorno PATH colocando la ruta de acceso de 64 bits (*\<unidad >*: \Program SQL Server\130\DTS\Binn) antes de la ruta de acceso de 32 bits (*\<unidad >*: \ Programar archivos (x86) server\130\dts\binn) en la variable.  
