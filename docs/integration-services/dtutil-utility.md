---
title: "dtutil (utilidad) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "comprobar paquetes"
  - "mover paquetes"
  - "paquetes [Integration Services], opciones de la línea de comandos"
  - "símbolo del sistema [Integration Services]"
  - "paquetes de SQL Server Integration Services, opciones de la línea de comandos"
  - "copiar paquetes"
  - "comprobación de existencia [Integration Services]"
  - "paquetes de Integration Services, opciones de la línea de comandos"
  - "paquetes de SSIS, opciones de la línea de comandos"
  - "eliminar paquetes"
  - "dtutil, utilidad"
  - "quitar paquetes"
  - "reubicar paquetes"
...
-   En el símbolo del sistema, ejecute la utilidad escribiendo la ruta de acceso completa (*\<unidad>*:\Archivos de programa\Microsoft SQL Server\130\DTS\Binn) de la versión de 64 bits de la utilidad.  
  
-   Cambie de forma permanente el orden de las rutas de acceso en la variable de entorno PATH colocando la ruta de acceso de 64 bits (*\<unidad>*:\Archivos de programa\Microsoft SQL Server\130\DTS\Binn) en la variable antes de la ruta de acceso de 32 bits (*\<unidad>*:\Archivos de programa (x86)\Microsoft SQL Server\130\DTS\Binn).  
...
|/En[crypt] *{SQL &#124; FILE}; Path;ProtectionLevel[;password]*|(Opcional). Cifra el paquete cargado con la contraseña y el nivel de protección especificado y lo guarda en la ubicación especificada en *Path*. *ProtectionLevel* determina si hace falta una contraseña.<br /><br /> *SQL*: la ruta es el nombre del paquete de destino.<br /><br /> *FILE*: la ruta es la ruta de acceso completa y el nombre de archivo del paquete.<br /><br /> *DTS*: esta opción no se admite actualmente.<br /><br /> Opciones de*ProtectionLevel* :<br /><br /> Nivel 0: elimina la información confidencial.<br /><br /> Nivel 1: la información confidencial se cifra mediante credenciales de usuario locales.<br /><br /> Nivel 2: la información confidencial se cifra mediante la contraseña requerida.<br /><br /> Nivel 3: el paquete se cifra mediante la contraseña requerida.<br /><br /> Nivel 4: el paquete se cifra mediante credenciales de usuario locales.<br /><br /> Nivel 5: El paquete utiliza el cifrado de almacenamiento de [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] .|  
