...
-   **GUID** *expression1* y *expression2* deben devolver un tipo de datos DT_GUID.  
  
-   **Binario** *expression1* y *expression2* deben devolver un tipo de datos DT_BYTES.  
