...
### <a name="set-methods-to-use-with-data-types"></a>Establecer los métodos que se van a usar con los tipos de datos  
 En la tabla siguiente enumera el tipo de datos de la primera columna y, a continuación, muestra el correspondiente **establecer** y **obtener** métodos.  
...
|<xref:Microsoft.SqlServer.Dts.Runtime.Wrapper.DataType.DT_NULL>|<xref:Microsoft.SqlServer.Dts.Pipeline.PipelineBuffer.SetNull%2A>|No hay ningún **obtener** método que es aplicable a este tipo de datos.|  
...
## <a name="mapping-data-types-in-the-data-flow"></a>Asignar los tipos de datos en el flujo de datos  
 Al mover datos desde orígenes a través de transformaciones hasta los destinos, un componente de flujo de datos a veces, debe convertir los tipos de datos entre el [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] [!INCLUDE[ssISnoversion](../../../includes/ssisnoversion-md.md)] tipos definidos en el <xref:Microsoft.SqlServer.Dts.Runtime.Wrapper.DataType> enumeración y los tipos de datos administrados de la [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../../../includes/dnprdnshort-md.md)] definido en el **System** espacio de nombres. Además, un componente debe realizar a veces la conversión de un tipo de datos de [!INCLUDE[ssISnoversion](../../../includes/ssisnoversion-md.md)] en otro antes de que ese tipo se pueda convertir en un tipo administrado.  
