...
---
# Crear base de datos (Asistente para importaci&#243;n y exportaci&#243;n de SQL Server)
...
**Nombre**  
 Proporcione un nombre único para la base de datos de SQL Server de destino. Cuando asigne un nombre a la base de datos, asegúrese de respetar las convenciones de nomenclatura de SQL Server.  
...
> [!TIP] Debe proporcionar un nombre para la base de datos nueva en el campo **Nombre**, pero normalmente puede dejar el tamaño de archivo y el crecimiento de archivo en sus valores predeterminados.
>
