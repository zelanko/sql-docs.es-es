...
## <a name="screen-shot-of-the-review-data-type-mapping-page"></a>Captura de pantalla de la página Revisar asignación de tipo de datos
 En la captura de pantalla siguiente se muestra la página **Revisar asignación de tipos de datos** del asistente después de que el usuario haya especificado una asignación que puede que no se haya completado correctamente en el cuadro de diálogo **Asignaciones de columnas**.
 ...
 -   El icono de advertencia de la primera columna de la lista **Asignación de tipo de datos** indica que la asignación del tipo de datos **int** de la columna de origen al tipo de datos **smalldatetime** de la columna de destino podría causar la pérdida de una gran cantidad de datos.
...
## <a name="review-the-data-type-mappings-from-source-to-destination"></a>Revisar las asignaciones de tipos de datos de origen a destino  
 La sección central de la página **Revisar asignación de tipos de datos** es la lista **Asignación de tipo de datos**. Esta cuadrícula proporciona información de conversión detallada sobre las columnas de la tabla que está seleccionada en la lista **Tabla** .
