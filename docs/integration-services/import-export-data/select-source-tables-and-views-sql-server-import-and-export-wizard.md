---
description: Seleccionar tablas y vistas de origen (Asistente para importación y exportación de SQL Server)
...
En este ejemplo, la lista **Origen** contiene todas las tablas de la base de datos de ejemplo AdventureWorks. La fila seleccionada muestra que el usuario quiere copiar la tabla **Sales.Customer** del origen en la nueva tabla **Sales.CustomerNew** del destino. 
 ...
 ![Captura de pantalla en la que se muestra la página de selección de tablas del Asistente para importación y exportación si va a copiar las tablas.](../../integration-services/import-export-data/media/select-tables1.png "Seleccione la página de tablas del Asistente para importar y exportar")
...
En este ejemplo, el usuario quiere copiar los resultados de la consulta del origen en la tabla **Sales.CustomerNew** del destino.  
 ...
 ![Captura de pantalla en la que se muestra la página de selección de tablas del Asistente para importación y exportación si proporcionó una consulta.](../../integration-services/import-export-data/media/select-tables2.png "Seleccione la página de tablas del Asistente para importar y exportar")  
