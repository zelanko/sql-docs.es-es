...
ms.topic: "article"
helpviewer_keywords: 
  - "Integration Services, actualización"
  - "SSIS, actualización"
  - "SQL Server Integration Services, actualización"
...
>   
>  Para obtener información sobre otras características no incluidas, vea [Funcionalidad de Integration Services no incluida en SQL Server 2016](../Topic/Discontinued%20Integration%20Services%20Functionality%20in%20SQL%20Server%202016.md).  
...
## Actualizar tanto Integration Services como el Motor de base de datos a [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
...
## Actualizar solo el Motor de base de datos a [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]  
 En esta sección se describen los efectos de realizar una actualización que tenga los criterios siguientes:  
