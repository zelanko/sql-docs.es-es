...
ms.topic: "article"
helpviewer_keywords: 
  - "compatibilidad [Integration Services]"
  - "Servicios de transformación de datos, compatibilidad con"
  - "SQL Server Integration Services, compatibilidad con versiones anteriores"
  - "dtsrun, utilidad"
  - "Integration Services, compatibilidad con versiones anteriores"
  - "compatibilidad con versiones anteriores [Integration Services]"
...
---
# Compatibilidad con versiones anteriores de Integration Services
...
## Características desusadas de Integration Services en SQL Server 2016
...
## Funcionalidad de Integration Services no incluida en SQL Server 2016
...
## Últimos cambios en las características de Integration Services en SQL Server 2016

En esta sección se describen los principales cambios de [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)]. Estos cambios pueden provocar errores en las aplicaciones, en los scripts o en otros elementos basados en versiones anteriores de [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]. Podría encontrar estos problemas tras la actualización.  
  
 No se han realizado cambios de este tipo en las características de Integration Services en [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]. 

## Cambios del comportamiento en las características de Integration Services en SQL Server 2016.
