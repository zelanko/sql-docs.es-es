...
ms.topic: "article"
helpviewer_keywords: 
  - "Paquetes de SQL Server Integration Services, acerca de los paquetes"
  - "paquetes [Integration Services], acerca de los paquetes"
  - "paquetes SSIS, acerca de los paquetes"
  - "SSIS, paquetes"
  - "SQL Server Integration Services, paquetes"
  - "contenedores [Integration Services], paquetes"
  - "paquetes [Integration Services]"
  - "paquetes de Integration Services, acerca de los paquetes"
...
# paquetes de Integration Services (SSIS)
 ...
 ![Paquete con flujo de control y flujo de datos](../integration-services/media/ssis-package.gif "Paquete con flujo de control y flujo de datos")  
...
### Proteger paquetes  
 Un paquete puede firmarse con una firma digital y cifrarse con una contraseña o una clave de usuario. Una firma digital autentica el origen del paquete. Sin embargo, también se debe configurar [!INCLUDE[ssISnoversion](../includes/ssisnoversion-md.md)] para que compruebe la firma digital al cargar el paquete. Para obtener más información, vea [Identificar el origen de paquetes con firmas digitales](../integration-services/packages/identify-the-source-of-packages-with-digital-signatures.md) y [Control del acceso a la información confidencial en paquetes](../integration-services/packages/access-control-for-sensitive-data-in-packages.md).  
...
-   [Asistente para importación y exportación de SQL Server](SQL%20Server%20Import%20and%20Export%20Wizard.md)  
