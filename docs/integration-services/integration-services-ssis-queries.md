---
description: Consultas de Integration Services (SSIS)
...
-   Ver y modificar los resultados inmediatamente.  
 ...
 Para más información, consulte [Query Builder]().  
...
-   **Ver y editar resultados inmediatamente** Puede ejecutar la consulta y trabajar con un conjunto de registros en una cuadrícula que le permite desplazarse por los registros de la base de datos y editarlos.  
 ...
 Para obtener más información sobre el lenguaje Transact-SQL y su sintaxis, vea [Referencia de Transact-SQL &#40;motor de base de datos&#41;](../t-sql/language-reference.md).  
