...
ms.topic: "article"
helpviewer_keywords: 
  - "variables [Integration Services], pasar entre paquetes"
  - "variables definidas por el usuario [Integration Services]"
  - "ámbito [Integration Services]"
  - "variables del sistema [Integration Services]"
  - "variables [Integration Services]"
  - "variables [Integration Services], acerca de variables"
...
-   Especificar el valor y el tipo de datos de la variable.  
 ...
 Para obtener más información sobre escenarios de uso real para variables, vea [Usar variables en paquetes](../Topic/Use%20Variables%20in%20Packages.md).  
...
## Configurar variables  
 ...
 Para obtener más información sobre las propiedades que puede configurar en el Diseñador de [!INCLUDE[ssIS](../includes/ssis-md.md)], consulte [Ventana Variables](../integration-services/variables-window.md).  
  
 Para obtener más información sobre las propiedades de las variables y sobre la configuración mediante programación de estas propiedades, vea <xref:Microsoft.SqlServer.Dts.Runtime.Variable>.  
...
## Tareas relacionadas  
 ...
 [Establecer las propiedades de una variable definida por el usuario](../Topic/Set%20the%20Properties%20of%20a%20User-Defined%20Variable.md)  
  
 [Usar los valores de variables y parámetros en un paquete secundario](../integration-services/packages/use-the-values-of-variables-and-parameters-in-a-child-package.md)  
