...
Cree un paquete de SQL Server Integration Services (SSIS) para cargar datos de SQL Server en [Azure SQL Data Warehouse](/azure/sql-data-warehouse/index.md). Si quiere, puede reestructurar, transformar y limpiar los datos a medida que pasan a través del flujo de datos de SSIS.
