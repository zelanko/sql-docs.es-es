---
title: Microsoft Connector for SAP BW F1 Ayuda | Documentos de Microsoft
ms.custom: 
ms.date: 03/14/2017
...
-   [Editor del Administrador de conexiones de SAP BW](../integration-services/connection-manager/sap-bw-connection-manager-editor.md)  
