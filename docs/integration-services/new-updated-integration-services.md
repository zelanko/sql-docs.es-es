---
title: Actualizar - Integration Services para los documentos de SQL Server | Documentos de Microsoft
description: "Mostrar fragmentos de contenido actualizado para recientemente modificadas en documentación, Integration Services para Microsoft SQL Server."
services: na
documentationcenter: 
author: MightyPen
manager: jhubbard
...
---
# <a name="new-and-recently-updated-integration-services-for-sql-server"></a>Nuevos y actualizados recientemente: Integration Services para SQL Server
...
1. [Conectarse a la base de datos de catálogo de SSISDB en Azure](lift-shift/ssis-azure-connect-to-catalog-database.md)
2. [Conectarse a orígenes de datos locales con autenticación de Windows](lift-shift/ssis-azure-connect-with-windows-auth.md)
3. [Implementar, ejecutar y supervisar un paquete SSIS en Azure](lift-shift/ssis-azure-deploy-run-monitor-tutorial.md)
4. [Levantar y mover las cargas de trabajo de SQL Server Integration Services a la nube](lift-shift/ssis-azure-lift-shift-ssis-packages-overview.md)
5. [Programar la ejecución de un paquete SSIS en Azure](lift-shift/ssis-azure-schedule-packages.md)
6. [Implementar un proyecto de SSIS desde el símbolo del sistema con ISDeploymentWizard.exe](ssis-quickstart-deploy-cmdline.md)
7. [Implementar un proyecto de SSIS con código C# en una aplicación .NET](ssis-quickstart-deploy-dotnet.md)
8. [Implementar un proyecto de SSIS con PowerShell](ssis-quickstart-deploy-powershell.md)
9. [Implementar un proyecto de SSIS con SQL Server Management Studio (SSMS)](ssis-quickstart-deploy-ssms.md)
10. [Implementar un proyecto de SSIS de SSMS con Transact-SQL](ssis-quickstart-deploy-tsql-ssms.md)
11. [Implementar un proyecto de SSIS de código de Visual Studio con Transact-SQL](ssis-quickstart-deploy-tsql-vscode.md)
12. [Ejecutar un paquete SSIS desde el símbolo del sistema con DTExec.exe](ssis-quickstart-run-cmdline.md)
13. [Ejecutar un paquete SSIS con código C# en una aplicación .NET](ssis-quickstart-run-dotnet.md)
14. [Ejecutar un paquete SSIS con PowerShell](ssis-quickstart-run-powershell.md)
15. [Ejecutar un paquete SSIS con SQL Server Management Studio (SSMS)](ssis-quickstart-run-ssms.md)
16. [Ejecutar un paquete SSIS de SSMS con Transact-SQL](ssis-quickstart-run-tsql-ssms.md)
17. [Ejecutar un paquete SSIS desde código de Visual Studio con Transact-SQL](ssis-quickstart-run-tsql-vscode.md)
