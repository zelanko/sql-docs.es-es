...
helpviewer_keywords: 
  ...
  - "niveles de protección para paquetes [Integration Services]"
  - "archivos de configuración [Integration Services]"
  - "cifrado [Integration Services]"
  - "criptografía [Integration Services]"
...
---
# Control del acceso a la informaci&#243;n confidencial en paquetes
...
## Configuración del nivel de protección y el catálogo de SSISDB  
...
## Establecimiento del nivel de protección basado en el ciclo de vida de paquetes  
