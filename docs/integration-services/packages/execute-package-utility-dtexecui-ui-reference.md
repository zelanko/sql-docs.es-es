---
title: Ejecute la utilidad de paquetes (dtexecui) | Documentos de Microsoft
ms.custom: 
ms.date: 03/14/2017
...
---
# <a name="execute-package-utility-dtexecui"></a>Ejecute la utilidad de paquetes (dtexecui)
