...
helpviewer_keywords: 
  ...
  - "registros [Integration Services], contadores de flujo de datos"
...
---
# Agregar un registro para los contadores de rendimiento del flujo de datos
...
### Para agregar un registro de contadores de rendimiento  
