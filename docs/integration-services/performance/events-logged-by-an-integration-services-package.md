...
ms.topic: "article"
helpviewer_keywords: 
  - "paquete [Integration Services], eventos"
  - "eventos [Integration Services], paquete"
...
---
# Eventos registrados por un paquete de Integration Services
 ...
 Para información sobre cómo ejecutar paquetes de SSIS, consulte [Ejecución de proyectos y paquetes](https://msdn.microsoft.com/library/ms141708.aspx).  
...
## Mensajes sobre el estado del paquete  
...
## Mensajes asociados al registro de paquetes  
...
### Mensajes sobre las fases de ejecución del paquete  
...
### Mensajes sobre los eventos que se producen  
...
## Tareas relacionadas  
 Para obtener información sobre cómo ver las entradas de registro en tiempo real, vea [Ver entradas del registro en la ventana Registrar eventos](../../integration-services/performance/view-log-entries-in-the-log-events-window.md).  
  
## Vea también  
 [Eventos registrados por el servicio Integration Services](../../integration-services/service/events-logged-by-the-integration-services-service.md)  
