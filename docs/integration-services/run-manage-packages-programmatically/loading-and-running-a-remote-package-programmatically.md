---
description: Cargar y ejecutar mediante programación un paquete remoto
...
-   Vídeo: [Cómo automatizar la ejecución de paquetes SSIS usando el Agente SQL Server (vídeo de SQL Server)](/previous-versions/dn912438(v=msdn.10)), en technet.microsoft.com  
