...
### <a name="view-scale-out-master-status"></a>Ver el estado del Servicio principal de escalabilidad horizontal
El estado del Servicio principal de escalabilidad horizontal se muestra en la página **Panel**.
