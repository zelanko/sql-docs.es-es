---
title: Roles (servicio SSIS) de Integration Services | Documentos de Microsoft
ms.custom: 
ms.date: 03/14/2017
...
## <a name="roles_dialog"></a>Referencia de interfaz de usuario de cuadro de diálogo de Roles de paquete
