...
helpviewer_keywords: 
  ...
  - "Integration Services, seguridad"
  - "seguridad [Integration Services], acerca de la seguridad"
  - "contraseñas [Integration Services]"
  - "paquetes [Integration Services], seguridad"
  - "SQL Server Integration Services, seguridad"
  - "SSIS, seguridad"
 ...
 **Asegurarse de que solo se abren y se ejecutan paquetes de orígenes de confianza**.  
 ...
 Para asegurarse de que solamente se abren y se ejecutan paquetes de orígenes de confianza, primero debe identificar el origen de los paquetes. Para ello, firme los paquetes con certificados. De esta forma, al abrir o ejecutar los paquetes, [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] puede comprobar la presencia y la validez de las firmas digitales. Para más información, vea [Identificar el origen de paquetes con firmas digitales](../../integration-services/packages/identify-the-source-of-packages-with-digital-signatures.md).  
...
### Controlar el acceso al contenido de los paquetes  
 ...
 Para más información, consulte [Access Control for Sensitive Data in Packages](../../integration-services/packages/access-control-for-sensitive-data-in-packages.md).  
...
### Controlar el acceso a los archivos usados por los paquetes  
 ...
 Para más información, vea [Acceso a los archivos usados por los paquetes](../../integration-services/security/access-to-files-used-by-packages.md).  
...
### Controlar el acceso al servicio Integration Services  
 ...
 Para más información, vea [Acceso al servicio Integration Services](../../integration-services/security/access-to-the-integration-services-service.md).  
...
-   [Implementar una directiva de firma estableciendo un valor del Registro](../../integration-services/packages/implement-a-signing-policy-by-setting-a-registry-value.md)  
  
-   [Firmar un paquete mediante un certificado digital](../../integration-services/packages/sign-a-package-by-using-a-digital-certificate.md)  
  
-   [Establecer o cambiar el nivel de protección de los paquetes](../../integration-services/packages/set-or-change-the-protection-level-of-packages.md)  
