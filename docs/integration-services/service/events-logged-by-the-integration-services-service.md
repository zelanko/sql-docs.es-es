...
ms.topic: "article"
helpviewer_keywords: 
  - "servicio [Integration Services], eventos"
  - "eventos [Integration Services], servicio"
  - "servicio Integration Services, eventos"
...
---
# Eventos registrados por el servicio Integration Services
...
## Mensajes sobre el estado del servicio  
...
## Mensajes sobre el archivo de configuración  
 La configuración para el servicio [!INCLUDE[ssISnoversion](../../includes/ssisnoversion-md.md)] se almacena en un archivo XML que se puede modificar. Para más información, vea [Configurar el servicio Integration Services &#40;servicio SSIS&#41;](../../integration-services/service/configuring-the-integration-services-service-ssis-service.md).  
...
## Tareas relacionadas  
 Para obtener información sobre cómo ver las entradas de registro, vea [Ver entradas del registro en la ventana Registrar eventos](../../integration-services/performance/view-log-entries-in-the-log-events-window.md).  
