...
---
# Ver los eventos para el servicio Integration Services
...
### Para ver los eventos del servicio para Integration Services en SQL Server Management Studio  
...
### Para ver los registros de eventos para Integration Services en el Visor de eventos de Windows  
...
## Vea también  
 ...
 [Agregar un registro para los contadores de rendimiento del flujo de datos](../../integration-services/performance/add-a-log-for-data-flow-performance-counters.md)  
