---
title: SQL Server Integration Services | Documentos de Microsoft
ms.custom: 
ms.date: 03/14/2017
...
# <a name="sql-server-integration-services"></a>SQL Server Integration Services
 ...
 > Para el contenido relacionado con las versiones anteriores de SQL Server, vea [SQL Server Integration Services](https://msdn.microsoft.com/en-US/library/ms141026(SQL.120).aspx).
...
## <a name="try-sql-server-and-sql-server-integration-services"></a>Pruebe a SQL Server y SQL Server Integration Services
- [![Descargar desde el centro de evaluación](../includes/media/download2.png)](http://go.microsoft.com/fwlink/?LinkID=829477) [descargar SQL Server 2016 o 2017](https://www.microsoft.com/evalcenter/evaluate-sql-server)
...
- [Foro de MSDN para SSIS - formular preguntas](https://social.msdn.microsoft.com/Forums/en-us/home?forum=sqlintegrationservices)
- [Foro de MSDN de SSDT y SSMS - formular preguntas](https://social.msdn.microsoft.com/Forums/en-US/home?forum=sqltool)
- [Desbordamiento de pila (etiqueta *ssis*)-formular preguntas](http://stackoverflow.com/questions/tagged/ssis)
- [Microsoft Connect: informar sobre errores y solicitar características](https://connect.microsoft.com/SQLServer/Feedback)
- [Reddit - discusión general sobre SSIS](https://www.reddit.com/r/SQLServer/search?q=ssis&restrict_sr=on)
- [Opciones de soporte técnico de Microsoft para los usuarios empresariales](https://support.microsoft.com/gp/support-options-for-business)
- [Póngase en contacto con Microsoft, opciones de usuario empresarial](https://support.microsoft.com/gp/contactus81?Audience=Commercial)
