...
manager: "jhubbard"
---
# Paso 3: Probar los paquetes implementados
...
### Para conectar a Integration Services en SQL Server Management Studio  
...
### Para ejecutar los paquetes con la Utilidad de ejecución de paquetes  
...
### Para comprobar los resultados del paquete DataTransfer  
...
### Para comprobar los resultados del paquete LoadXMLData  
