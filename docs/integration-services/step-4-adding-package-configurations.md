...
manager: "jhubbard"
---
# Paso 4: Agregar configuraciones de paquetes
...
[Acceso a los archivos usados por los paquetes](../integration-services/security/access-to-files-used-by-packages.md)  
