---
title: Catalog.delete_environment (base de datos de SSISDB) | Documentos de Microsoft
ms.custom: 
ms.date: 03/04/2017
...
## <a name="arguments"></a>Argumentos  
 ...
 Nombre del entorno que se va a eliminar. El *environment_name* es **nvarchar (128)**.  
