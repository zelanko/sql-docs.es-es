---
title: Catalog.get_project (base de datos de SSISDB) | Documentos de Microsoft
ms.custom: 
ms.date: 03/04/2017
...
## <a name="arguments"></a>Argumentos  
 ...
 Nombre del proyecto. *Nombre_proyecto* es **nvarchar (128)**.  
  
## <a name="return-code-value"></a>Valor de código de retorno  
 0 (correcto)  
  
## <a name="result-sets"></a>Conjuntos de resultados  
 Se devuelve la secuencia binaria del proyecto como **varbinary (max)**. No se devuelve ningún resultado si no se encuentra la carpeta o el proyecto.  
...
## <a name="errors-and-warnings"></a>Errores y advertencias  
 En la lista siguiente se describe algunas condiciones que pueden hacer que el procedimiento get_project almacenado genere un error:  
