---
title: Catalog.set_customized_logging_level_description | Documentos de Microsoft
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[tsql-appliesto-ss2016-xxxx-xxxx-xxx_md](../../includes/tsql-appliesto-ss2016-xxxx-xxxx-xxx-md.md)]
  ...
  Cambia la descripción de un nivel de registro personalizado existente. Para obtener más información acerca de los niveles de registro personalizados, consulte [Integration Services &#40; SSIS &#41; Registro](../../integration-services/performance/integration-services-ssis-logging.md).  
...
## <a name="arguments"></a>Argumentos  
 ...
 [ @level_description =] *level_description*  
 Nivel de registro personalizado de la nueva descripción para el elemento especificado.  
