---
title: Catalog.stop_operation (base de datos de SSISDB) | Documentos de Microsoft
ms.custom: 
ms.date: 03/04/2017
...
## <a name="arguments"></a>Argumentos  
 ...
 Identificador único de la validación o la instancia de ejecución. El *operation_id* es **bigint**.  
