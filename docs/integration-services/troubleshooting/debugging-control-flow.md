...
ms.topic: "article"
helpviewer_keywords: 
  - "informe del progreso [Integration Services]"
  - "puntos de interrupción [Integration Services]"
  - "depurar [Integration Services], flujo de control"
  - "flujo de control [Integration Services], depurar"
  - "informe del progreso, códigos de color [Integration Services]"
...
-   [Depurar un paquete estableciendo puntos de interrupción en una tarea o un contenedor](../../integration-services/troubleshooting/debug-a-package-by-setting-breakpoints-on-a-task-or-a-container.md)  
