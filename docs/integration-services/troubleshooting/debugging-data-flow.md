...
helpviewer_keywords: 
  ...
  - "flujo de datos [Integration Services], depurar"
  - "depurar [Integration Services], flujo de datos"
  - "contar filas"
...
-   [agregar un visor de datos a un flujo de datos](../../integration-services/troubleshooting/add-a-data-viewer-to-a-data-flow.md)  
