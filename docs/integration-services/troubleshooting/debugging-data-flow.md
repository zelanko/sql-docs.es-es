---
description: Depurar el flujo de datos
...
## <a name="add-a-data-viewer-to-a-data-flow"></a><a name="add_viewer"></a> agregar un visor de datos a un flujo de datos
