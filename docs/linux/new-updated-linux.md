...
-   **Ejemplos de cadena de conexión**
    ...
    - **..! CLUIR-NotShown--ssmanstudiofull-md--... /includes/ssManStudioFull-MD.MD)]** ! [ SSMS conexión dialog--media/sql-server-linux-encrypted-connections/ssms-encrypt-connection.png "SSMS cuadro de diálogo conexión")
