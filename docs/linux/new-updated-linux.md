...
### <a name="2-nbsp-extract-transform-and-load-data-on-linux-with-ssissql-server-linux-migrate-ssismd"></a>2. &nbsp;[De extracción, transformación y carga datos en Linux con SSIS](sql-server-linux-migrate-ssis.md)
