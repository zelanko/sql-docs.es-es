...
En este inicio rápido, instalará SQL Server 2017 en Ubuntu 16.04. Después, se conectará con **sqlcmd** para crear la primera base de datos y ejecutar consultas.
...
Para instalar Ubuntu 16.04 en un equipo propio, vaya a <http://releases.ubuntu.com/xenial/>. También puede crear máquinas virtuales de Ubuntu en Azure. Consulte [Creación y administración de máquinas virtuales Linux con la CLI de Azure](https://docs.microsoft.com/azure/virtual-machines/linux/tutorial-manage-vm).
