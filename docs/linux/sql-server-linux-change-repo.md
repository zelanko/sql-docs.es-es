...
::: zone pivot="ld2-rhel"
En este artículo se describe cómo configurar el repositorio correcto para las actualizaciones e instalaciones de SQL Server 2017 y 2019 de SQL Server en Linux. En la parte superior, la selección actual es **Red tenía (RHEL)**.
::: zone-end
