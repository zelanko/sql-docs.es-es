...
## <a name="enable-sql-server-agent"></a><a id="enablesqlagent"></a> Habilitación del Agente SQL Server

Se habilita el Agente SQL Server y se inicia automáticamente con SQL Server
