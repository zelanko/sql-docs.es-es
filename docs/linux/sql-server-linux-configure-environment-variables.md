...
## <a name="example-initial-setup"></a>Ejemplo: instalación inicial
...
Este comando de docker de ejemplo usa las siguientes variables de entorno para crear un nuevo contenedor de SQL Server 2017:
