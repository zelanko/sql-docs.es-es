...
- Para empezar a trabajar con imágenes de contenedor de SQL Server 2017 en Docker, revise la [guía de inicio rápido](quickstart-install-connect-docker.md?view=sql-server-2017).
