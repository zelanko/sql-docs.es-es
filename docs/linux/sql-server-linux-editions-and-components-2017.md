---
title: Ediciones y características admitidas de SQL Server 2017 ~ Linux
ms.date: 09/14/2017
ms.prod: sql
ms.technology: linux
ms.topic: conceptual
...
|Grupos de disponibilidad Always On<sup>2</sup>|Sí|Sin|Sin|Sin|
|Grupos de disponibilidad básica <sup>3</sup>|Sin|Sí|No|Sin|
|Grupo de disponibilidad de confirmación de réplica mínima|Sí|Sí|No|Sin|
|Grupo de disponibilidad sin clúster|Sí|Sí|Sin|Sin|
|Restauración de archivos y páginas en línea|Sí|Sin|Sin|No|
|Índices en línea|Sí|Sin|Sin|Sin|
|Recompilaciones de índices en línea reanudables|Sí|Sin|Sin|Sin|
|Cambio de esquema en línea|Sí|Sin|Sin|No|
|Recuperación rápida|Sí|Sin|Sin|Sin|
|Copias de seguridad reflejadas|Sí|Sin|Sin|Sin|
|Agregar memoria y CPU sin interrupción|Sí|Sin|Sin|No|
|Copia de seguridad cifrada|Sí|Sí|No|Sin|
...
|Recompilación de índices de almacén de columnas no en clúster en línea|Sí|No|Sin|Sin|
...
|regulador de recursos|Sí|Sin|No|Sin|  
|Paralelismo de tabla con particiones|Sí|No|Sin|Sin|
|Asignación de memoria de página grande habilitada para NUMA y matriz de búferes|Sí|No|Sin|Sin|
|Regulación de recursos de E/S|Sí|Sin|Sin|Sin|  
|Perdurabilidad diferida|Sí|Sí|Sí|Sí|
|Ajuste automático|Sí|No|No|Sin|
|Combinaciones adaptables de modo de proceso por lotes|Sí|Sin|No|No|
|Comentarios de concesión de memoria de modo de proceso por lotes|Sí|No|No|Sin|
...
|Cifrado de base de datos transparente|Sí|Sin|Sin|No|   
...
|Recopilador de datos de rendimiento|Sí|Sí|Sí|Sin|Sin| 
|Informes de rendimiento estándar|Sí|Sí|Sí|Sin|Sin| 
|Guías del plan y congelación del plan para las guías del plan|Sí|Sí|Sí|Sin|Sin|   
|Consulta directa de vistas indexadas (mediante la sugerencia NOEXPAND)|Sí|Sí|Sí|Sí| 
|Mantenimiento automático de vistas indexadas|Sí|Sí|Sí|Sin|Sin| 
|Vistas distribuidas con particiones|Sí|No|Sin|No| 
|Operaciones indizadas en paralelo|Sí|No|Sin|Sin|  
|Uso automático de vistas indexadas por el optimizador de consultas|Sí|No|Sin|No| 
|Comprobación de coherencia en paralelo|Sí|Sin|Sin|Sin| 
|Punto de control de la utilidad de SQL Server|Sí|No|No|Sin|    
