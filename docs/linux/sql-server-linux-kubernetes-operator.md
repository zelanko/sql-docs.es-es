...
* `MSSQL_K8S_RETRY_PERIOD_SECONDS`
  * Opcional
  * **Descripción**: duración activo [maestro](https://kubernetes.io/docs/concepts/architecture/master-node-communication/) esperará antes de renovar la concesión líder. Debe ser menor que `MSSQL_K8S_LEASE_DURATION_SECONDS`.
