...
## <a name="build-sql-server-linux-container-image-with-machine-learning-services"></a>Compilación de la imagen de contenedor de SQL Server Linux con Machine Learning Services
...
1. Ejecute el script build.sh.
   ...
   > [!NOTE]
   > Para compilar la imagen de Docker, es necesario instalar paquetes de varios GB de tamaño. El script puede tardar hasta 20 minutos en completarse, en función del ancho de banda de red.

## <a name="run-sql-server-linux-container-image-with-machine-learning-services"></a>Ejecución de la imagen de contenedor de SQL Server Linux con Machine Learning Services
...
1. Ejecute el script run.sh.
   ...
   Este comando crea un contenedor de SQL Server con Machine Learning Services con la edición Developer (valor predeterminado). El puerto **1433** de SQL Server se expone en el host como puerto **1401**.
