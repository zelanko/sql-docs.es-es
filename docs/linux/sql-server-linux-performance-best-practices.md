...
ms.locfileid: "38057419"
---
# <a name="performance-best-practices-and-configuration-guidelines-for-sql-server-2017-on-linux"></a>Procedimientos recomendados e instrucciones de configuración de SQL Server 2017 en Linux
