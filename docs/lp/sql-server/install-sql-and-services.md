...
layout: HubPage
hide_bc: true
title: SQL Server - Instalación y actualización
...
<div id="main" class="v2">
    ...
    <div class="container">
        <h1>SQL Server: instalación o actualización</h1>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Instalar SQL Server</h3>
                                                    <p>Información general de las distintas opciones de instalación de que se dispone para instalar SQL Server.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Instalar SQL Server Analysis Services (SSAS)</h3>
                                                    <p>Un motor de datos analíticos que proporcionan modelos de datos semánticos de clase empresarial para informes empresariales y aplicaciones cliente como Power BI, Excel, Reporting Services y otros informes de visualización de datos. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Instalar SQL Server Integration Services (SSIS)</h3>
                                                    <p> Use Integration Services para resolver complejos problemas empresariales mediante la copia o descarga de archivos, la carga de almacenamientos de datos, la limpieza y minería de datos y la administración de datos y objetos de SQL Server. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Instalar SQL Server Reporting Services (SSRS)</h3>
                                                    <p>Una solución para crear, publicar y administrar informes y, luego, entregarlos a los usuarios adecuados de distintas formas: visualizándolos en el explorador web, en el dispositivo móvil, o bien como correo electrónico en su Bandeja de entrada. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Actualizar SQL Server Analysis Services (SSAS)</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Actualizar SQL Server Integration Services (SSIS)</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Actualizar SQL Server Reporting Services (SSRS)</h3>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
