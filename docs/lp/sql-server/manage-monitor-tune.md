...
<div id="main" class="v2">
    ...
    <div class="container">
        <h1>SQL Server: Administración, supervisión y optimización</h1>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Administración del ciclo de vida de la base de datos</h3>
                                                    <p>Un enfoque integral para administrar el esquema de la base de datos, los datos y los metadatos para una aplicación de base de datos</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Una característica de SQL Server que facilita la compresión de sus datos para que ocupe menos espacio en los discos. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Correo electrónico de base de datos</h3>
                                                    <p>Una solución empresarial para enviar mensajes de correo electrónico desde el motor de base de datos de SQL Server. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Administración basada en directivas</h3>
                                                    <p>Un sistema basado en directivas para administrar una o varias instancias de SQL Server.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Configure planes automatizados para administrar su SQL Server.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Agente SQL Server</h3>
                                                    <p>Una característica de SQL Server que ejecutaba tareas administrativas programadas. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Eventos extendidos</h3>
                                                    <p>Un sistema de control de eventos general para los sistemas de SQL Server.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SQLDiag</h3>
                                                    <p>Una utilidad de uso general que recoge registros y datos de SQL Server. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>SQL Profiler</h3>
                                                    <p>Cree, administre, analice y reemplace seguimientos tomados de la actividad de SQL Server. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Una nueva característica de SQL 2017 que detecta automáticamente posibles problemas de rendimiento. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Asistente para la optimización de bases de datos</h3>
                                                    <p>Ayuda a analizar cargas de trabajo y proporciona recomendaciones de mejora del rendimiento.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Estima cuántas filas devolverá una consulta y cuántas se usarán para la creación de planes de ejecución.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Índices</h3>
                                                    <p>Una estructura en disco asociada con una tabla o una vista que acelera la recuperación de datos.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>OLTP en memoria</h3>
                                                    <p>Una opción de optimización del rendimiento que deja todas las tablas en la memoria.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Particiones</h3>
                                                    <p>Permite que se distribuyan los datos entre las unidades, como los grupos de archivos. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Guías de plan</h3>
                                                    <p>Una característica de SQL Server que permite la entrada manual de un plan de ejecución para una consulta específica.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Regulador de recursos</h3>
                                                    <p>Especifica los límites de las cantidades de CPU, E/S y memoria que pueden usar las solicitudes de la aplicación. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Estadísticas</h3>
                                                    <p>Indica al motor de SQL Server cómo se distribuyen los datos y cómo se usan para la creación de planes de ejecución.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
