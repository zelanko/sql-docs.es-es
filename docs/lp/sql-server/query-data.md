...
layout: HubPage
hide_bc: true
title: 'SQL Server: consulta de datos'
description: Explore las características que facilitan la consulta de datos en su base de datos de SQL Server.
ms.topic: hub-page
ms.prod: sql
featureFlags:
- clicktale
...
<div id="main" class="v2">
    ...
    <div class="container">
        <h1>SQL Server: Datos de consultas</h1>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Búsqueda en texto completo</h3>
                                                    <p>Los índices de texto completo incluyen una o varias columnas basadas en caracteres en una tabla, mientras que la búsqueda de texto completo le permite consultarlas.</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Combinaciones</h3>
                                                    <p>Explora las diferentes operaciones de ordenación, intersección y unión realizadas por SQL Server al usar combinaciones. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Scripting</h3>
                                                    <p>Explora los diversos lenguajes de scripting admitidos por SQL Server, como PowerShell y xQuery. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Subconsultas</h3>
                                                    <p> Una subconsulta es una consulta anidada en una instrucción SELECT, INSERT, UPDATE o DELETE, o bien en otra subconsulta. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="cardSize">
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    <h3>Sinónimos</h3>
                                                    <p>Un objeto de base de datos que proporciona una capa de abstracción para proteger una aplicación cliente de cambios en el nombre o la ubicación de un objeto base. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="cardPadding">
                                            <div class="card">
                                                ...
                                                <div class="cardText">
                                                    ...
                                                    <p>Rutinas que aceptan parámetros, realizan una acción y devuelven el resultado de esa acción como valor. </p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
