...
Para saber más sobre la puntuación en SQL Server, vea [Cómo generar previsiones y predicciones mediante modelos de aprendizaje automático en SQL Server](how-to-do-realtime-scoring.md).
