...
+ [Análisis en base de datos para el desarrollador de SQL](../tutorials/r-taxi-classification-introduction.md) Muestra cómo ajustar el código de R en procedimientos almacenados para que sea más modular.
