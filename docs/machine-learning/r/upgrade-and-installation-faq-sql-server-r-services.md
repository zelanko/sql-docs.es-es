---
title: Preguntas más frecuentes de instalación y actualización
description: Respuestas a algunas preguntas comunes sobre la instalación o actualización de características de aprendizaje automático en SQL Server.
ms.prod: sql
...
ms.locfileid: "86300227"
---
# <a name="installation-and-upgrade-faq-for-sql-server-machine-learning-or-r-server"></a>Preguntas más frecuentes sobre instalación y actualización de SQL Server Machine Learning o R Server
 [!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]

En este artículo se ofrecen respuestas a algunas preguntas comunes sobre la instalación de características de aprendizaje automático en SQL Server. También se tratan algunas preguntas habituales sobre actualizaciones.
