...
2. Ahora, llame a la función [rxSummary](/r-server/r-reference/revoscaler/rxsummary) de RevoScaleR para obtener estadísticas más detalladas sobre las variables individuales.
