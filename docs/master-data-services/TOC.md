...
# [Instalación y configuración de Master Data Services](master-data-services-installation-and-configuration.md)
...
# [Tabla de ensayo de relaciones](relationship-staging-table-master-data-services.md)
...
# [Crear un administrador de modelo](create-a-model-administrator-master-data-services.md)
...
# [Creación de un índice](create-an-index-master-data-services.md)
# [Reversión del historial de revisiones de miembro](rollback-member-revision-history-master-data-services.md)
# [Cambiar el nombre y el tipo de datos de un atributo](change-an-attribute-name-and-data-type-master-data-services.md)
# [Administradores de](administrators-master-data-services.md)
# [Confirmación o envío de un conjunto de cambios](commit-or-submit-a-changeset-master-data-services.md)
...
# [Creación de un conjunto de cambios](create-a-changeset-master-data-services.md)
...
# [Administración de conjuntos de datos](manage-changesets-master-data-services.md)
...
# [Cuadro de diálogo Crear un perfil y una cuenta de Correo electrónico de base datos](create database mail profile and account dialog box.md)
...
# [Purga de miembros de versión](purge-version-members-master-data-services.md)
...
# [Tabla de ensayo de miembros hoja](leaf-member-staging-table-master-data-services.md)
...
# [Master Data Services y características de servicios de calidad de datos compatibles con las ediciones de SQL Server 2016](master data services and data quality services features support.md)
...
# [Ejemplos: paquetes de implementación de modelos (Master Data Services)](sql-server-samples-model-deployment-packages-mds.md)
# [Creación automática de código](automatic-code-creation-master-data-services.md)
# [Modificación y eliminación de una relación de sincronización de entidades](edit-and-delete-an-entity-sync-relationship-master-data-services.md)
...
# [Aplicación web Master Data Services](master-data-manager-web-application.md)
...
# [Visualización de relaciones varios a varios en jerarquías derivadas](show-many-to-many-relationships-in-derived-hierarchies-master-data-services.md)
# [Introducción a Master Data Services (MDS)](master-data-services-overview-mds.md)
...
# [Eliminar permisos de objeto de modelo](delete-model-object-permissions-master-data-services.md)
...
# [Cambio del tipo de registro de transacciones de entidad](change-the-entity-transaction-log-type-master-data-services.md)
...
# [Creación de un administrador de entidades (Master Data Services)](create-an-entity-administrator-master-data-services.md)
...
# [Edición de una entidad](edit-an-entity-master-data-services.md)
...
# [Seguimiento de cambios](change-tracking-master-data-services.md)
...
# [Aplicar inmediatamente los permisos de los miembros](immediately-apply-member-permissions-master-data-services.md)
...
# [Asigne permisos de objeto de modelo](assign-model-object-permissions-master-data-services.md)
# [Asistente Crear base de datos](create-database-wizard-master-data-services-configuration-manager.md)
# [Aprobación o rechazo de un conjunto de cambios](approve-or-reject-a-changeset-master-data-services.md)
...
# [Información general: importación de datos de tablas (Master Data Services)](overview-importing-data-from-tables-master-data-services.md)
...
# [Tabla de ensayo de miembros consolidados](consolidated-member-staging-table-master-data-services.md)
