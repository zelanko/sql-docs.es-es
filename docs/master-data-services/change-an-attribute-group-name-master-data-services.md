...
ms.topic: "article"
helpviewer_keywords: 
  - "grupos de atributos [Master Data Services], cambio de nombre"
...
---
# Cambiar el nombre de un grupo de atributos (Master Data Services)
...
### Para cambiar el nombre de un grupo de atributos  
