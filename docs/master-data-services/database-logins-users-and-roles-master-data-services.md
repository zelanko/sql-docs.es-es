...
ms.topic: "article"
helpviewer_keywords: 
  - "seguridad [Master Data Services], roles de base de datos"
  - "base de datos [Master Data Services], usuarios"
  - "seguridad [Master Data Services], usuarios de base de datos"
  - "base de datos [Master Data Services], roles"
  - "base de datos [Master Data Services], inicios de sesión"
  - "seguridad [Master Data Services], inicios de sesión de base de datos"
...
---
# Inicios de sesi&#243;n, usuarios y roles en bases de datos (Master Data Services)
...
## Usuarios de la base de datos de Master Data Services  
...
## Rol de la base de datos Master Data Services  
