...
ms.topic: "article"
helpviewer_keywords: 
  - "eliminar permisos de objeto de modelo [Master Data Services]"
  - "permisos [Master Data Services], eliminar permisos de objeto de modelo"
  - "modelos [Master Data Services], eliminar permisos de objeto"
...
### Eliminar permisos de objeto de modelo  
