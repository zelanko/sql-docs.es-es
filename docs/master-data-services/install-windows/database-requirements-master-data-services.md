---
title: Requisitos (Master Data Services) de la base de datos | Documentos de Microsoft
ms.custom: 
ms.date: 03/14/2017
...
## <a name="see-also"></a>Vea también  
 ...
 [Conectarse a un cuadro de diálogo de la base de datos de Master Data Services](../../master-data-services/connect-to-a-master-data-services-database-dialog-box.md)   
 [Crear Asistente para la base de datos &#40; Administrador de configuración de Master Data Services &#41;](../../master-data-services/create-database-wizard-master-data-services-configuration-manager.md)  
