---
title: Tareas de instalación
description: En este artículo se proporciona información general sobre la instalación de Master Data Services, incluidas las tareas de instalación y preinstalación y posteriores a la instalación.
ms.custom: ''
ms.date: 03/24/2017
ms.prod: sql
ms.prod_service: mds
