---
title: Hoja de la tabla de ensayo de miembros (Master Data Services) | Documentos de Microsoft
ms.custom: 
ms.date: 04/01/2016
...
# <a name="leaf-member-staging-table-master-data-services"></a>Tabla de ensayo de miembros hoja (Master Data Services)
  Use los miembros hoja (stg.name_Leaf) de la tabla de ensayo en el [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)] base de datos para crear, actualizar, desactivar y eliminar miembros hoja. También puede usarla para actualizar valores de atributos de miembros hoja.  
