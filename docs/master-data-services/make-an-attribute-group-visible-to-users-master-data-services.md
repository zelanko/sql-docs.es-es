...
---
# Hacer que un grupo de atributos sea visible para los usuarios (Master Data Services)
...
-   Por lo menos debe existir un grupo de atributos. Para obtener más información, consulte [Crear un grupo de atributos &#40;Master Data Services&#41;](../master-data-services/create-an-attribute-group-master-data-services.md).  
  
### Para hacer que un grupo de atributos sea visible para los usuarios  
