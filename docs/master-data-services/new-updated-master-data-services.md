---
title: Actualizar - Master Data Services para los documentos de SQL Server | Documentos de Microsoft
description: "Mostrar fragmentos de contenido actualizado para recientemente modificadas en documentación, para Master Data Services (MDS) para Microsoft SQL Server."
services: na
documentationcenter: 
author: MightyPen
manager: jhubbard
