---
title: "Actualizar el Asistente para la base de datos (Administrador de configuración de Master Data Services) | Documentos de Microsoft"
ms.custom: 
ms.date: 03/20/2017
...
|------------------|-----------------|  
|**Instancia de SQL Server**|El nombre del cliente actualmente [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] [!INCLUDE[ssDE](../includes/ssde-md.md)] instancia.|  
