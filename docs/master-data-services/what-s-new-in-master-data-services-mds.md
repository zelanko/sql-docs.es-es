---
title: "¿Qué &#39; s nuevos en Master Data Services (MDS) | Documentos de Microsoft"
ms.custom:
- SQL2016_New_Updated
ms.date: 07/08/2016
...
---
# <a name="what39s-new-in-master-data-services-mds"></a>¿Qué &#39; s nuevos en Master Data Services (MDS)
...
-   ¿Tiene una cuenta de Azure?  Si es así, vaya **[aquí](https://azure.microsoft.com/en-us/marketplace/partners/microsoft/sqlserver2016rtmenterprisewindowsserver2012r2/?wt.mc_id=sqL16_vm)** para poner en marcha una máquina virtual con [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] ya instalado.  
...
-   La característica IIS de compresión de contenido dinámico está habilitada de forma predeterminada. Esto disminuye considerablemente el tamaño de la respuesta xml y reduce la E/S de red, aunque el uso de CPU aumenta. Si dispone de una CPU enlazada al servidor, puede agregar la configuración siguiente al archivo Web.config de [!INCLUDE[ssMDSshort](../includes/ssmdsshort-md.md)] para desactivar la compresión de datos.  
    ...
    ```  
     ...
     Para obtener más información, consulte [URL Compression](http://www.iis.net/configreference/system.webserver/urlcompression)(Compresión de URL).  
...
-   Los siguientes trabajos nuevos del Agente SQL Server indexan y registran el mantenimiento.  
 ...
 Para obtener más información, consulte esta publicación en el blog de Master Data Services, [Performance and Scale Improvement in SQL Server 2016](http://go.microsoft.com/fwlink/p/?LinkId=615375)(Mejora del rendimiento y la escala en SQL Server 2016).  
