...
```  
 ...
 En el ejemplo siguiente se devuelve el `Measures.[Unit Price]` miembro, además de todos los miembros calculados de la dimensión **Measures** , del cubo **Adventure Works** .  
