...
## <a name="remarks"></a>Notas  
 ...
 Con la resolución automática de recursividad en [!INCLUDE[ssASnoversion](../includes/ssasnoversion-md.md)], esta función tiene muy poco uso práctico.  
