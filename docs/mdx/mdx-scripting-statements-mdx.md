...
|[Palabra clave existente &#40;&#41;MDX](https://docs.microsoft.com/analysis-services/multidimensional-models/mdx/mdx-query-existing-keyword)|Exige que un conjunto especificado se evalúe en el contexto actual.|  
|[Instrucción FREEZE &#40;MDX&#41;](../mdx/mdx-scripting-freeze.md)|Bloquea los valores de celda de un subcubo especificado a sus valores actuales.|  
|[Instrucción IF &#40;MDX&#41;](../mdx/mdx-scripting-if.md)|Ejecuta una instrucción si la condición es true.|  
