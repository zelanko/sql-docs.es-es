...
|Tema|Descripción|  
|-----------|-----------------|  
|[MDX (elementos &#40;de sintaxis MDX)&#41;](../mdx/mdx-syntax-elements-mdx.md)|Describe los diferentes elementos de sintaxis disponibles en el lenguaje MDX para expresiones, instrucciones y scripts MDX.|  
