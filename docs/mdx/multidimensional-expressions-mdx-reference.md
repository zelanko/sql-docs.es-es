...
|Tema|Descripción|  
|-----------|-----------------|  
|[Los elementos de sintaxis MDX &#40;MDX&#41;](../mdx/mdx-syntax-elements-mdx.md)|Describe los diferentes elementos de sintaxis disponibles en el lenguaje MDX para expresiones, instrucciones y scripts MDX.|  
...
## <a name="see-also"></a>Vea también  
 ...
 [Recuperación de datos de origen de datos analíticos](https://docs.microsoft.com/bi-reference/adomd/multidimensional-models-adomd-net-client/retrieving-data-from-an-analytical-data-source)   
