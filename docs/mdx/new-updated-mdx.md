---
title: 'Actualizado: MDX para documentos de SQL Server | Documentos de Microsoft'
description: Mostrar fragmentos de contenido actualizado para recientemente modificadas en documentación, para las expresiones multidimensionales (MDX) para Microsoft SQL Server.
manager: craigg
author: MightyPen
ms.author: genemi
ms.topic: article
...
ms.locfileid: "32555933"
---
# <a name="new-and-recently-updated-multidimensional-expressions-mdx-for-sql-server"></a>Nuevos y actualizados recientemente: expresiones multidimensionales (MDX) para SQL Server
...
- *Área de asunto:* &nbsp; **expresiones multidimensionales (MDX) para SQL Server**.
