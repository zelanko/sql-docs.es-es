...
```  
 ...
 Existen muchas funciones MDX que devuelven miembros. Para obtener una lista completa, consulte MDX de [ &#40;referencia&#41; de funciones](../mdx/mdx-function-reference-mdx.md) MDX  
