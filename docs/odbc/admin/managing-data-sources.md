---
description: Administrar orígenes de datos
...
>  Para administrar un origen de datos que se conecta a un controlador de 32 bits en una plataforma de 64 bits, utilice c:\windows\sysWOW64\odbcad32.exe. Para administrar un origen de datos que se conecta a un controlador de 64 bits, utilice c:\windows\system32\odbcad32.exe. En **herramientas administrativas** en un sistema operativo Windows 8 de 64 bits, existen iconos para el cuadro de diálogo **Administrador de orígenes de datos ODBC** de 32 bits y de 64 bits.  
 ...
 Si usa la odbcad32.exe de bits de 64 para configurar o quitar un DSN que se conecta a un controlador de 32 bits, por ejemplo, el **controlador realiza Microsoft Access ( \* . mdb)**, recibirá el mensaje de error siguiente:  
  
```  
The specified DSN contains an architecture mismatch between the Driver and Application  
```  
  
 Para resolver este error, use el odbcad32.exe de 32 bits para configurar o quitar el DSN.  
