---
title: Limitaciones de la función agregadas ? Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
Una función de agregado y una referencia de columna no agregada no se pueden utilizar como argumentos para una sola instrucción SQL.
