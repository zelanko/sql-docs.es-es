---
title: Eliminar un origen de datos de Visual FoxPro | Documentos de Microsoft
ms.custom: 
ms.date: 01/19/2017
...
3.  En la ficha DSN de usuario o DSN de sistema, seleccione el nombre del origen de datos que desea eliminar.  
