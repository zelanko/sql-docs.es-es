...
|---------------------|-------------------|  
|SQL_DIA_DYNAMIC_FUNCTION|Incompatible|  
...
|SQL_DIAG_CURSOR_ROW_COUNT|Incompatible|  
|SQL_DIAG_DYNAMIC_FUNCTION_CODE|Incompatible|  
...
|SQL_DIAG_SERVER_NAME|Incompatible|  
