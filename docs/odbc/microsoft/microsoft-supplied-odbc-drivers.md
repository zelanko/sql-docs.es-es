---
title: Los controladores ODBC proporcionados por Microsoft | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
-   [Uso de las aplicaciones de 16 bits y 32 bits con controladores de 32 bits](../../odbc/microsoft/using-16-bit-and-32-bit-applications-with-32-bit-drivers.md)  
  
-   [Controladores de escritorio de la base de datos ODBC de Microsoft](../../odbc/microsoft/microsoft-odbc-desktop-database-drivers.md)  
