...
-   [Controlador ODBC para la Guía de usuario de Oracle](../../odbc/microsoft/odbc-driver-for-oracle-user-s-guide.md)  
  
-   [Controlador ODBC para la referencia del programador de Oracle](../../odbc/microsoft/odbc-driver-for-oracle-programmer-s-reference.md)
