---
title: "Otros detalles de programación del controlador de archivo de texto | Documentos de Microsoft"
ms.custom: 
ms.date: 01/19/2017
...
> [!NOTE]  
>  Esta sección proporciona información de archivo de texto específicos del controlador sobre las funciones ODBC y otros detalles de programación. Para obtener información general acerca de una función, vea el tema correspondiente en [referencia de la API de ODBC](../../odbc/reference/syntax/odbc-api-reference.md).  
