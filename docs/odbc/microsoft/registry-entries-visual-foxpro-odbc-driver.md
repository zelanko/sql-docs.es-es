...
|Controlador|REG_SZ|Ruta de acceso del sistema al archivo vfpodbc. dll|  
|DriverODBCVer|REG_SZ|"02,50"|  
|FileExtns|REG_SZ|"*. DBF,\*. CDX,\*. FPT"|  
|FileUsage|REG_SZ|"1"|  
|Instalación|REG_SZ|Ruta de acceso del sistema al archivo vfpodbc. dll|  
|SQLLevel|REG_SZ|"0"|  
...
|Controlador||Ruta de acceso del sistema al archivo vfpodbc. dll|  
|Exclusivo||Sí o no|  
