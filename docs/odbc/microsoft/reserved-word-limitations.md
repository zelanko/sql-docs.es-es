...
- En el *Guía de referencia del programador de ODBC*, consulte [Apéndice C: Gramática de SQL](https://docs.microsoft.com/sql/odbc/reference/appendixes/appendix-c-sql-grammar).
