---
title: Funciones escalares ? Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "81306016"
---
# <a name="scalar-functions"></a>Funciones escalares
Los controladores de base de datos de escritorio ODBC de Microsoft admiten las siguientes funciones escalares:  
...
|DAYOFWEEK|MONTH||  
 ...
 Para obtener información acerca de los argumentos y valores devueltos de funciones escalares, vea Apéndice F de la *referencia del programador ODBC.*
