...
ms.locfileid: "81298625"
---
# <a name="sqlgetcursorname-desktop-database-drivers"></a>SQLGetCursorName (controladores de escritorio de la base de datos)
**SQLGetCursorName** se admite, pero solo se puede usar cuando se usa la biblioteca de cursores, porque las operaciones posicionadas no se admiten en el controlador.
