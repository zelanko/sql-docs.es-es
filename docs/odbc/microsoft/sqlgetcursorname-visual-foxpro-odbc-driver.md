---
description: SQLGetCursorName (controlador ODBC de Visual FoxPro)
title: SQLGetCursorName (controlador ODBC de Visual FoxPro) | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
