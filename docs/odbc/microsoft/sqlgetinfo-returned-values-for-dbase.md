---
title: VALORES devueltos de SQLGetInfo para dBASE ? Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
|SQL_IDENTIFIER_CASE|SQL_IC_UPPER (el calificador se devuelve en mayúsculas y minúsculas para que Windows NT pueda localizar el directorio.)|  
