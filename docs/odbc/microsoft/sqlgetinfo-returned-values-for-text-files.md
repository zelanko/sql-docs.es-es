---
title: Valores devueltos de SQLGetInfo para los archivos de texto de la clase de texto de la clase de texto de la clase de texto de la Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
