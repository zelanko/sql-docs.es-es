---
title: SQLSetConnectOption (Controlador de paradoja) Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
|SQL_AUTOCOMMIT|El controlador Paradox solo admite SQL_AUTOCOMMIT que se establece en ON (el estado predeterminado), porque no admiten transacciones.|  
