...
|*SzTableType*|"TABLE" es el único tipo de tabla admitido.<br /><br /> Cuando se usa el controlador de texto, la lista de los archivos devueltos por **SQLTables** viene determinada por las extensiones de archivo en el **lista de extensiones** cuadro el **el programa de instalación de ODBC texto** cuadro de diálogo.|
