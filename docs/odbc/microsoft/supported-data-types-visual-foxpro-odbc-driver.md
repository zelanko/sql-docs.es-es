...
La lista de tipos de datos admitidos por el controlador se presentan a través de la API ODBC y en Microsoft Query.  
  
## <a name="data-types-in-c-applications"></a>Tipos de datos en aplicaciones C  
 Puede obtener una lista de tipos de datos admitidos por el controlador ODBC de Visual FoxPro mediante la función [SQLGetTypeInfo](../../odbc/microsoft/sqlgettypeinfo-visual-foxpro-odbc-driver.md) en aplicaciones C o C++.  
