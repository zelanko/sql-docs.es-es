---
title: Admite funciones de la API de ODBC | Documentos de Microsoft
ms.custom: 
ms.date: 01/19/2017
...
El propósito de la redistribución es informar a la aplicación qué características están disponibles a él desde el controlador. Los controladores de base de datos de escritorio de Microsoft ODBC admiten todas las funciones de nivel 1 y los núcleos.  
 ...
 Para obtener más información acerca de los niveles de cumplimiento para las funciones y gramática, consulte [niveles](../../odbc/reference/develop-app/conformance-levels.md) en el *referencia del programador de ODBC*.  
  
 Compatibilidad de funciones de la API de ODBC puede ser dependiente en el controlador que se utiliza. En la tabla siguiente se resume la compatibilidad para las funciones. La columna izquierda proporciona un vínculo a la página de referencia general para cada función. Estas páginas de referencia se enumeran por orden alfabético en la [referencia de la API de ODBC](../../odbc/reference/syntax/odbc-api-reference.md) sección, en [referencia del programador de ODBC](../../odbc/reference/odbc-programmer-s-reference.md). Las columnas a los vínculos de proporcionar derecho a específicos del controlador notas acerca de cada función admitida. Estos temas específicos del controlador se enumeran en la sección "Detalles de programación otras" para cada controlador. O bien, si el mismo comentarios acerca de una función se aplican a todos los controladores ODBC para base de datos de escritorio, la columna situada más proporciona un vínculo a un tema que se resume la compatibilidad de los controladores de base de datos su escritorio para esa función. En estos temas se muestran al final de la sección actual ("ODBC API funciones admitidas").  
  
|ODBC, función|Notas de acceso específicos del controlador|notas de dBASE específicos del controlador|Notas de Paradox específicos del controlador|Notas de archivo específicos del controlador de texto|Notas de específicas del controlador de Excel|Notas pertinentes para todos los controladores|  
|-------------------|-----------------------------------|----------------------------------|------------------------------------|--------------------------------------|----------------------------------|-----------------------------------|  
