---
title: Opciones (controlador ODBC para Oracle) admitidas | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "62634556"
---
# <a name="supported-options-odbc-driver-for-oracle"></a>Opciones admitidas (controlador ODBC para Oracle)
> [!IMPORTANT]  
>  Esta característica se quitará en una versión futura de Windows. Evite utilizar esta característica en nuevos trabajos de desarrollo y tenga previsto modificar las aplicaciones que actualmente la utilizan. En su lugar, use el controlador ODBC proporcionado por Oracle.  
  
 El controlador ODBC para Oracle admite las siguientes opciones para la (de SQLGetConnectOption) y funciones de nivel 1 de SQLSetConnectOption ():  
  
-   SQL_ACCESS_MODE ([SQLGetConnectOption](../../odbc/microsoft/level-1-api-functions-odbc-driver-for-oracle.md)sólo ())  
...
-   [SQL_TXN_ISOLATION](../../odbc/microsoft/connect-options.md)  
 ...
 El controlador ODBC para Oracle admite las siguientes opciones para la (de SQLGetStmtOption) y funciones de nivel 1 de SQLSetStmtOption ():  
