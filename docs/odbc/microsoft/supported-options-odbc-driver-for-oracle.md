---
title: Opciones admitidas (controlador ODBC para Oracle) Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
>  Esta característica se eliminará en una versión futura de Windows. Evite utilizar esta característica en nuevos trabajos de desarrollo y tenga previsto modificar las aplicaciones que actualmente la utilizan. En su lugar, utilice el controlador ODBC proporcionado por Oracle.  
 ...
 El controlador ODBC para Oracle admite las siguientes opciones para las funciones SQLGetConnectOption( ) y SQLSetConnectOption( ) Nivel 1:  
  
-   SQL_ACCESS_MODE ([SQLGetConnectOption](../../odbc/microsoft/level-1-api-functions-odbc-driver-for-oracle.md)( ) ( )  
...
-   [SQL_TXN_ISOLATION](../../odbc/microsoft/connect-options.md)  
 ...
 El controlador ODBC para Oracle admite las siguientes opciones para las funciones SQLGetStmtOption( ) y SQLSetStmtOption( ) Nivel 1:  
