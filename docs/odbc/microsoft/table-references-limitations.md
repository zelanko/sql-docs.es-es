---
title: Limitaciones de referencias de tablas ? Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "81303106"
---
# <a name="table-references-limitations"></a>Tabla hace referencia a limitaciones
Se puede incluir un máximo de 16 referencias de tabla en cualquier instrucción de consulta.
