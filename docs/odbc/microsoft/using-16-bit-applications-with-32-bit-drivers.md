---
description: Uso de las aplicaciones de 16 bits con controladores de 32 bits
...
## <a name="administration"></a>Administración  
 ...
 En Windows en Windows (thunk de 16 bits a 32 bits), un archivo DLL de thunk adicional denominado Ds32gt.dll convierte los valores de argumento de 16 bits pasados a través de un archivo DLL de instalación de 32 bits de nuevo a 16 bits.  
