---
description: Utilizando SQLConfigDatasource con el controlador ODBC para Oracle
...
> [!NOTE]  
>  El controlador de Msorcl10.dll (versión 1,0) es compatible con todas las configuraciones, excepto **Server**. El controlador de Msorcl32.dll (versión 2,0 y posteriores) es compatible con todas las opciones de configuración.  
...
|Property|128|""|A/N|Cadena de conexión Método necesario para especificar el nombre del servidor con el controlador de Msorcl10.dll.|  
