---
description: Prueba de ODBC
title: Prueba de ODBC | Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "88466247"
---
# <a name="odbc-test"></a>Prueba de ODBC
Microsoft® ODBC test es una aplicación habilitada para ODBC que puede usar para probar los controladores ODBC y el administrador de controladores ODBC. ODBC 3,51 incluye versiones compatibles con ANSI y Unicode de la prueba de ODBC. Los archivos correspondientes son los siguientes:  
