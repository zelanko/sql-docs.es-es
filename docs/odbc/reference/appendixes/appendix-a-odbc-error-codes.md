...
ms.locfileid: "81307526"
---
# <a name="appendix-a-odbc-error-codes"></a>Apéndice A: Códigos de error de ADO
En este tema se describen los valores SQLSTATE para ODBC 3. *x*. Para obtener más información sobre ODBC 3. *x* Valores SQLSTATE, vea [Asignaciones SQLSTATE](../../../odbc/reference/develop-app/sqlstate-mappings.md).  
  
 **SQLGetDiagRec** o **SQLGetDiagField** devuelve valores SQLSTATE definidos por Open Group *Data Management: Structured Query Language (SQL), Versión 2* (marzo de 1995). Los valores SQLSTATE son cadenas que contienen cinco caracteres. En la tabla siguiente se enumeran los valores SQLSTATE que un controlador puede devolver para **SQLGetDiagRec**.  
  
 El valor de cadena de caracteres devuelto para un SQLSTATE consta de un valor de clase de dos caracteres seguido de un valor de subclase de tres caracteres. Un valor de clase de "01" indica una advertencia y va acompañado de un código de retorno de SQL_SUCCESS_WITH_INFO. Los valores de clase distintos de "01", excepto la clase "IM", indican un error y van acompañados de un valor devuelto de SQL_ERROR. La clase "IM" es específica de las advertencias y errores que se derivan de la implementación de ODBC. El valor de subclase "000" en cualquier clase indica que no hay ninguna subclase para ese SQLSTATE. La asignación de valores de clase y subclase se define mediante SQL-92.  
  
> [!NOTE]  
>  Aunque la ejecución correcta de una función normalmente se indica mediante un valor devuelto de SQL_SUCCESS, SQLSTATE 00000 también indica éxito.  
  
|SQLSTATE|Error|Puede ser devuelto de|  
|--------------|-----------|--------------------------|  
|01000|Advertencia general|Todas las funciones ODBC excepto:<br /><br /> **SQLError**<br /><br /> **SQLGetDiagField**<br /><br /> **SQLGetDiagRec**|  
|01001|Conflicto de operación del cursor|**SQLExecDirect**<br /><br /> **SQLExecute**<br /><br /> **SQLParamData**<br /><br /> **SQLSetPos**|  
...
|01S06|Intento de capturar antes de que el conjunto de resultados devolviera el primer conjunto de filas|**SQLExtendedFetch**<br /><br /> **SQLFetchScroll**|  
...
|07005|Declaración preparada no una *especificación de cursor*|**SQLColAttribute**<br /><br /> **SQLDescribeCol**|  
...
|07009|Indice de descriptor no válido|**SQLBindCol**<br /><br /> **SQLBindParameter**<br /><br /> **SQLBulkOperations**<br /><br /> **SQLColAttribute**<br /><br /> **SQLDescribeCol**<br /><br /> **SQLDescribeParam**<br /><br /> **SQLFetch**<br /><br /> **SQLFetchScroll**<br /><br /> **SQLGetData**<br /><br /> **SQLGetDescField**<br /><br /> **SQLGetDescRec**<br /><br /> **SQLParamData**<br /><br /> **SQLSetDescField**<br /><br /> **SQLSetDescRecSQLSetPos**|  
|07S01|Uso no válido del parámetro predeterminado|**SQLExecDirect**<br /><br /> **SQLExecute**<br /><br /> **SQLParamData**<br /><br /> **SQLPutData**|  
|08001|Cliente incapaz de establecer conexión|**SQLBrowseConnect**<br /><br /> **SQLConnect**<br /><br /> **SQLDriverConnect**|  
...
|22002|Variable indicador requerida pero no suministrada|**SQLExecDirect**<br /><br /> **SQLExecute**<br /><br /> **SQLExtendedFetch**<br /><br /> **SQLFetch**<br /><br /> **SQLFetchScroll**<br /><br /> **SQLGetData**<br /><br /> **SQLParamData**|  
|22003|Valor numérico fuera del rango|**SQLBulkOperations**<br /><br /> **SQLExecDirect**<br /><br /> **SQLExecute**<br /><br /> **SQLExtendedFetch**<br /><br /> **SQLFetch**<br /><br /> **SQLFetchScroll**<br /><br /> **SQLGetData**<br /><br /> **SQLGetInfo**<br /><br /> **SQLParamData**<br /><br /> **SQLPutData**<br /><br /> **SQLSetPos**|  
...
|23000|Violación de la restricción de integridad|**SQLBulkOperations**<br /><br /> **SQLExecDirect**<br /><br /> **SQLExecute**<br /><br /> **SQLParamData**<br /><br /> **SQLSetPos**|  
...
|3C000|Nombre del cursor duplicado|**SQLSetCursorName**|  
...
|40002|Violación de la restricción de integridad|**SQLEndTran**|  
|40003|Finalización de la declaración desconocida|**SQLBulkOperations**<br /><br /> **SQLColumnPrivileges**<br /><br /> **SQLColumns**<br /><br /> **SQLExecDirect**<br /><br /> **SQLExecute**<br /><br /> **SQLFetch**<br /><br /> **SQLFetchScroll**<br /><br /> **SQLForeignKeys**<br /><br /> **SQLGetTypeInfo**<br /><br /> **SQLMoreResults**<br /><br /> **SQLPrimaryKeys**<br /><br /> **SQLProcedureColumns**<br /><br /> **SQLProcedures**<br /><br /> **SQLParamData**<br /><br /> **SQLSetPos**<br /><br /> **SQLSpecialColumns**<br /><br /> **SQLStatistics**<br /><br /> **SQLTablePrivileges**<br /><br /> **SQLTables**|  
|42000|Error de sintaxis o violación de acceso|**SQLBulkOperations**<br /><br /> **SQLExecDirect**<br /><br /> **SQLExecute**<br /><br /> **SQLParamData**<br /><br /> **SQLPrepare**<br /><br /> **SQLSetPos**|  
|42S01|La tabla base o la vista ya existen|**SQLExecDirect**<br /><br /> **SQLPrepare**|  
|42S02|Tabla base o vista no encontrada|**SQLExecDirect**<br /><br /> **SQLPrepare**|  
|42S11|El índice ya existe|**SQLExecDirect**<br /><br /> **SQLPrepare**|  
|42S12|Indice no encontrado|**SQLExecDirect**<br /><br /> **SQLPrepare**|  
|42S21|Columna ya existe|**SQLExecDirect**<br /><br /> **SQLPrepare**|  
...
|HY007|La declaración asociada no está preparada|**SQLCopyDesc**<br /><br /> **SQLGetDescField**<br /><br /> **SQLGetDescRec**|  
...
|HY010|Error de secuencia de funciones|**SQLAllocHandle**<br /><br /> **SQLBindCol**<br /><br /> **SQLBindParameter**<br /><br /> **SQLBulkOperations**<br /><br /> **SQLCloseCursor**<br /><br /> **SQLColAttribute**<br /><br /> **SQLColumnPrivileges**<br /><br /> **SQLColumns**<br /><br /> **SQLCopyDesc**<br /><br /> **SQLDescribeCol**<br /><br /> **SQLDescribeParam**<br /><br /> **SQLDisconnect**<br /><br /> **SQLEndTran**<br /><br /> **SQLExecDirect**<br /><br /> **SQLExecute**<br /><br /> **SQLExtendedFetch**<br /><br /> **SQLFetch**<br /><br /> **SQLFetchScroll**<br /><br /> **SQLForeignKeys**<br /><br /> **SQLFreeHandle**<br /><br /> **SQLFreeStmt**<br /><br /> **SQLGetConnectAttr**<br /><br /> **SQLGetCursorName**<br /><br /> **SQLGetData**<br /><br /> **SQLGetDescField**<br /><br /> **SQLGetDescRec**<br /><br /> **SQLGetFunctions**<br /><br /> **SQLGetStmtAttr**<br /><br /> **SQLGetTypeInfo**<br /><br /> **SQLMoreResults**<br /><br /> **SQLNumParams**<br /><br /> **SQLNumResultCols**<br /><br /> **SQLParamData**<br /><br /> **SQLPrepare**<br /><br /> **SQLPrimaryKeys**<br /><br /> **SQLProcedureColumns**<br /><br /> **SQLProcedures**<br /><br /> **SQLPutData**<br /><br /> **SQLRowCount**<br /><br /> **SQLSetConnectAttr**<br /><br /> **SQLSetCursorName**<br /><br /> **SQLSetDescField**<br /><br /> **SQLSetEnvAttr**<br /><br /> **SQLSetDescRec**<br /><br /> **SQLSetPos**<br /><br /> **SQLSetStmtAttr**<br /><br /> **SQLSpecialColumns**<br /><br /> **SQLStatistics**<br /><br /> **SQLTablePrivileges**<br /><br /> **SQLTables**|  
...
|HY014|Límite en el número de asas excedidas|**SQLAllocHandle**|  
|HY015|No hay nombre de cursor disponible|**SQLGetCursorName**|  
...
|HY018|Solicitud de cancelación rechazada por el servidor|**SQLCancel**|  
|HY019|Datos no caracteres y no binarios enviados en partes|**SQLPutData**|  
|HY020|Intento de concatenar un valor nulo|**SQLPutData**|  
|HY021|Información de descriptorina incoherente|**SQLBindParameter**<br /><br /> **SQLCopyDesc**<br /><br /> **SQLGetDescField**<br /><br /> **SQLSetDescField**<br /><br /> **SQLSetDescRec**|  
|HY024|Valor de atributo no válido|**SQLSetConnectAttr**<br /><br /> **SQLSetEnvAttr**<br /><br /> **SQLSetStmtAttr**|  
|HY090|Cadena no válida o longitud de búfer|**SQLBindCol**<br /><br /> **SQLBindParameter**<br /><br /> **SQLBrowseConnect**<br /><br /> **SQLBulkOperations**<br /><br /> **SQLColAttribute**<br /><br /> **SQLColumnPrivileges**<br /><br /> **SQLColumns**<br /><br /> **SQLConnect**<br /><br /> **SQLDataSources**<br /><br /> **SQLDescribeCol**<br /><br /> **SQLDriverConnect**<br /><br /> **SQLDrivers**<br /><br /> **SQLExecDirect**<br /><br /> **SQLExecute**<br /><br /> **SQLFetch**<br /><br /> **SQLFetchScroll**<br /><br /> **SQLForeignKeys**<br /><br /> **SQLGetConnectAttr**<br /><br /> **SQLGetCursorName**<br /><br /> **SQLGetData**<br /><br /> **SQLGetDescField**<br /><br /> **SQLGetInfo**<br /><br /> **SQLGetStmtAttr**<br /><br /> **SQLNativeSql**<br /><br /> **SQLParamData**<br /><br /> **SQLPrepare**<br /><br /> **SQLPrimaryKeys**<br /><br /> **SQLProcedureColumns**<br /><br /> **SQLProcedures**<br /><br /> **SQLPutData**<br /><br /> **SQLSetConnectAttr**<br /><br /> **SQLSetCursorName**<br /><br /> **SQLSetDescField**<br /><br /> **SQLSetDescRec**<br /><br /> **SQLSetEnvAttr**<br /><br /> **SQLSetStmtAttr**<br /><br /> **SQLSetPos**<br /><br /> **SQLSpecialColumns**<br /><br /> **SQLStatistics**<br /><br /> **SQLTablePrivileges**<br /><br /> **SQLTables**|  
|HY091|Identificador de campo descriptor no válido|**SQLColAttribute**<br /><br /> **SQLGetDescField**<br /><br /> **SQLSetDescField**|  
|HY092|Identificador de atributo/opción no válido|**SQLAllocHandle**<br /><br /> **QLBulkOperations**<br /><br /> **SQLCopyDesc**<br /><br /> **SQLDriverConnect**<br /><br /> **SQLEndTran**<br /><br /> **SQLFreeStmt**<br /><br /> **SQLGetConnectAttr**<br /><br /> **SQLGetEnvAttr**<br /><br /> **QLParamData**<br /><br /> **SQLSetConnectAttr**<br /><br /> **SQLSetDescField**<br /><br /> **SQLSetEnvAttr**<br /><br /> **SQLSetPos**<br /><br /> **SQLSetStmtAttr**|  
|HY095|Tipo de función fuera del rango|**SQLGetFunctions**|  
|HY096|Tipo de información no válida|**SQLGetInfo**|  
|HY097|Tipo de columna fuera del rango|**SQLSpecialColumns**|  
|HY098|Tipo de alcance fuera del rango|**SQLSpecialColumns**|  
|HY099|Tipo que acepta valores NULL fuera del rango|**SQLSpecialColumns**|  
|HY100|Tipo de opción de unicidad fuera de rango|**SQLStatistics**|  
|HY101|Tipo de opción de precisión fuera del rango|**SQLStatistics**|  
...
|HY106|Tipo de obtención fuera del rango|**SQLExtendedFetch**<br /><br /> **SQLFetchScroll**|  
|HY107|Valor de fila fuera del rango|**SQLExtendedFetch**<br /><br /> **SQLFetch**<br /><br /> **SQLFetchScroll**<br /><br /> **SQLSetPos**|  
...
|IM004|**SqlAllocHandle** del controlador en SQL_HANDLE_ENV error|**SQLBrowseConnect**<br /><br /> **SQLConnect**<br /><br /> **SQLDriverConnect**|  
|IM005|**SqlAllocHandle** del controlador en SQL_HANDLE_DBC ha fallado|**SQLBrowseConnect**<br /><br /> **SQLConnect**<br /><br /> **SQLDriverConnect**|  
