...
> [!NOTE]  
>  Aunque la ejecución correcta de una función normalmente se indica mediante un valor devuelto de SQL_SUCCESS, el valor de SQLSTATE 00000 también indica éxito.  
  
|SQLSTATE|Error|Pueden devolverse desde|  
|--------------|-----------|--------------------------|  
...
|01S06|Se intentó buscar antes de que el conjunto de resultados devuelve el primer conjunto de filas|**SQLExtendedFetch**<br /><br /> **SQLFetchScroll**|  
...
|22002|Variable de indicador necesaria pero no proporcionado|**SQLExecDirect**<br /><br /> **SQLExecute**<br /><br /> **SQLExtendedFetch**<br /><br /> **SQLFetch**<br /><br /> **SQLFetchScroll**<br /><br /> **SQLGetData**<br /><br /> **SQLParamData**|  
...
|22008|Desbordamiento del campo DateTime|**SQLBulkOperations**<br /><br /> **SQLExecDirect**<br /><br /> **QLParamData**<br /><br /> **SQLPutData**|  
...
|25S01|Estado de transacción|**SQLEndTran**|  
|25S02|Transacción todavía está activa|**SQLEndTran**|  
...
|3D000|Nombre del catálogo no válido|**SQLExecDirect**<br /><br /> **SQLPrepare**<br /><br /> **SQLSetConnectAttr**|  
...
|42S01|Tabla o vista base ya existe.|**SQLExecDirect**<br /><br /> **SQLPrepare**|  
|42S02|No se encuentra la vista o tabla base|**SQLExecDirect**<br /><br /> **SQLPrepare**|  
...
|HY009|Uso no válido del puntero nulo|**SQLAllocHandle**<br /><br /> **SQLBindParameter**<br /><br /> **SQLBulkOperations**<br /><br /> **SQLColumnPrivileges**<br /><br /> **SQLColumns**<br /><br /> **SQLExecDirect**<br /><br /> **SQLForeignKeys**<br /><br /> **SQLGetCursorName**<br /><br /> **SQLGetData**<br /><br /> **SQLGetFunctions**<br /><br /> **SQLNativeSql**<br /><br /> **SQLPrepare**<br /><br /> **SQLPrimaryKeys**<br /><br /> **SQLProcedureColumns**<br /><br /> **SQLProcedures**<br /><br /> **SQLPutData**<br /><br /> **SQLSetConnectAttr**<br /><br /> **SQLSetCursorName**<br /><br /> **SQLSetEnvAttr**<br /><br /> **SQLSetStmtAttr**<br /><br /> **SQLSpecialColumns**<br /><br /> **SQLStatistics**<br /><br /> **SQLTablePrivileges**<br /><br /> **SQLTables**|  
...
|HY018|El servidor rechazada la solicitud de cancelación|**SQLCancel**|  
|HY019|Datos no binarios ni de caracteres que se enviaron por partes|**SQLPutData**|  
...
|IM004|Conductor **SQLAllocHandle** en SQL_HANDLE_ENV error|**SQLBrowseConnect**<br /><br /> **SQLConnect**<br /><br /> **SQLDriverConnect**|  
|IM005|Conductor **SQLAllocHandle** en SQL_HANDLE_DBC error|**SQLBrowseConnect**<br /><br /> **SQLConnect**<br /><br /> **SQLDriverConnect**|  
|IM006|Conductor **SQLSetConnectAttr** error|**SQLBrowseConnect**<br /><br /> **SQLConnect**<br /><br /> **SQLDriverConnect**|  
|IM007|Ningún origen de datos o el controlador especificado; cuadro de diálogo restringido|**SQLDriverConnect**|  
...
|IM010|Nombre de origen de datos es demasiado largo|**SQLBrowseConnect**<br /><br /> **SQLConnect**<br /><br /> **SQLDriverConnect**|  
|IM011|Nombre del controlador es demasiado largo|**SQLBrowseConnect**<br /><br /> **SQLDriverConnect**|  
|IM012|Error de sintaxis de la palabra clave DRIVER|**SQLBrowseConnect**<br /><br /> **SQLDriverConnect**|  
