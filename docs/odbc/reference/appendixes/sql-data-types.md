...
_INTEGER|INTEGER|Valor numérico exacto con precisión de 10 y escala de 0 (firmado: – 2 [31] < = *n* < = 2 [31] – 1; sin signo: 0 < = *n* < = 2 [32] – 1) [3].|  
...
_BIGINT|bigint|Exacto de un valor numérico con una precisión de 19 (si tiene signo) o 20 (si no tiene signo) y una escala de 0 (firmado: – 2 [63] < = *n* < = 2 [63] – 1; sin signo: 0 < = *n* < = 2 [64] – 1) [3], [9].|  
...
_TYPE_UTCDATETIME|UTCDATETIME|Campos de año, mes, día, hora, minuto, segundo, utchour y utcminute. Los campos utchour y utcminute tienen precisión de 1/10 microsegundo.|  
...
_INTERVAL_DAY_TO_HOUR [7]|DÍA del intervalo (*p*) a la hora|Número de días y horas entre dos fechas/horas; *p* es el intervalo de precisión del principio.|  
...
_INTERVAL_MINUTE_TO_SECOND [7]|MINUTOS de intervalo (*p*) al segundo (*q*)|Número de minutos/segundos entre dos fechas/horas; *p* es el intervalo de precisión del principio y *q* es la precisión de segundos del intervalo.|  
