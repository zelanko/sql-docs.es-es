---
description: SQLGetInfo (biblioteca de cursores)
...
>  Esta característica se quitará en una versión futura de Windows. Evite usar esta característica en los nuevos trabajos de desarrollo y planee modificar las aplicaciones que actualmente la utilizan. Microsoft recomienda el uso de la funcionalidad de cursor del controlador.  
 ...
 En este tema se describe el uso de la función **SQLGetInfo** en la biblioteca de cursores. Para obtener información general sobre **SQLGetInfo**, vea [función SQLGetInfo](../../../odbc/reference/syntax/sqlgetinfo-function.md).  
  
 La biblioteca de cursores devuelve valores para los siguientes valores de *InfoType* (&#124; representa una operación OR bit a bit); para todos los demás valores de *InfoType*, llama a **SQLGetInfo** en el controlador.  
...
|SQL_GETDATA_EXTENSIONS|SQL_GD_BLOCK &#124; los valores devueltos por el controlador **Nota:**  cuando los datos se recuperan con **SQLFetchScroll**, **SQLGetData** admite la funcionalidad especificada con las máscaras de SQL_GD_ANY_COLUMN y SQL_GD_BOUND.|  
...
|SQL_STATIC_CURSOR_ATTRIBUTES2|SQL_CA2_READ_ONLY_CONCUR &#124; SQL_CA2_OPT_VALUES_ &#124; DE SIMULTANEIDAD SQL_CA2_SENSITIVITY_UPDATES|  
