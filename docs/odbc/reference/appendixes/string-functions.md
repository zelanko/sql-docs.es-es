...
|**Repita (** _string_exp,_ _recuento_**)** (ODBC 1.0)|Devuelve una cadena de caracteres que se compone de *string_exp* repite *recuento* veces.|  
|**Reemplazar (** _string_exp1_, *string_exp2*, _string_exp3_**)** (ODBC 1.0)|Búsqueda *string_exp1* foroccurrences de *string_exp2*y reemplace con *string_exp3*.|  
|**DERECHA (** _string_exp_, _recuento_**)** (ODBC 1.0)|Devuelve el extremo derecho *recuento* caracteres de *string_exp*.|  
