...
|**SEMANA (** *date_exp* **)** (ODBC 1.0)|Devuelve la semana del año según el campo de la semana en *date_exp* como un valor entero en el intervalo de 1 a 53.|  
|**AÑO (** *date_exp* **)** (ODBC 1.0)|Devuelve el año según el campo año en *date_exp* como un valor entero. El intervalo es depende del origen de datos.|
