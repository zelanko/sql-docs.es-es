...
ms.locfileid: "47628183"
---
# <a name="what-the-driver-does"></a>Lo que hace el controlador
En la tabla siguiente se resume las funciones y atributos de instrucción de una aplicación ODBC 3 *.x* controlador debe implementar para los cursores desplazables y de bloque.  
