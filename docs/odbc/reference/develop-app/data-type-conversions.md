...
Los datos se pueden convertir de un tipo a otro en cuatro veces: cuando los datos se transfieren de una variable de aplicación a otra (C a C), cuando los datos de una variable de aplicación se envían a un parámetro de instrucción (C a SQL), cuando se devuelven los datos de una columna de conjunto de resultados en una variable de aplicación (SQL a C) y cuando se transfieren datos de una columna de origen de datos a otra (SQL a SQL).  
