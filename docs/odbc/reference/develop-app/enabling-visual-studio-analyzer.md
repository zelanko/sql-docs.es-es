...
4.  Haga clic en **Aceptar**.  
 ...
 Visual Studio Analyzer-generación de eventos continúa hasta que **detener el seguimiento del analizador de Visual Studio** está seleccionada.  
  
 Esta sección contiene el siguiente tema.  
  
-   [Eventos generados por el Administrador de controladores ODBC](../../../odbc/reference/develop-app/events-generated-by-the-odbc-driver-manager.md)
