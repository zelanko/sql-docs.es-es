...
|Parámetro<br /><br /> value|Parámetro<br /><br /> Server<br /><br /> tipo de datos|Variable (C)<br /><br /> tipo de datos|Valor en <br /><br /> enlazadas<br /><br /> Variable|Valor en <br /><br /> longitud/indicador<br /><br /> búfer [d]|  
|-------------------------|-----------------------------------------|----------------------------------|-------------------------------------|----------------------------------------------------|  
