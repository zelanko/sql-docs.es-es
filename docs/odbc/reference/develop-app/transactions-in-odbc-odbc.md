...
-   [Compatibilidad con transacciones](../../../odbc/reference/develop-app/transaction-support.md)  
  
-   [Modo de confirmación](../../../odbc/reference/develop-app/commit-mode.md)  
