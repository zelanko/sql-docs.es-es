---
title: "Resumen de funciones DLL de la instalación | Documentos de Microsoft"
ms.custom: 
ms.date: 01/19/2017
...
---
# <a name="setup-dll-function-summary"></a>Resumen de funciones del archivo DLL de instalación
En la tabla siguiente describe las funciones DLL el programa de instalación. Para obtener más información sobre la sintaxis y semántica para cada función, consulte [referencia de API de DLL de instalación](../../../odbc/reference/syntax/setup-dll-api-reference.md).  
