---
title: "Función SQLAllocEnv | Documentos de Microsoft"
ms.custom: 
ms.date: 01/19/2017
...
---
# <a name="sqlallocenv-function"></a>SQLAllocEnv (función)
**Conformidad**  
 Versión introdujo: Cumplimiento de estándares 1.0 de ODBC: en desuso  
  
 **Resumen**  
 En ODBC 3. *x*, ODBC 2. *x* función **SQLAllocEnv** se ha reemplazado por **SQLAllocHandle**. Para obtener más información, consulte [SQLAllocHandle, función](../../../odbc/reference/syntax/sqlallochandle-function.md).  
