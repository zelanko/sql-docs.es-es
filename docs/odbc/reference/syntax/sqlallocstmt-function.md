 ...
 **Resumen**  
 En ODBC 3. *x*, ODBC 2. *x* función **SQLAllocStmt** ha sido reemplazado por **SQLAllocHandle**. Para obtener más información, consulte [función SQLAllocHandle](../../../odbc/reference/syntax/sqlallochandle-function.md).  
