...
|---------------------------|---------|  
|Una función que se ejecuta de forma asincrónica en un identificador de instrucción, cancelar una función en una instrucción que necesita que los datos o cancelar una función que se ejecuta en una instrucción en otro subproceso se está cancelando.|[SQLCancel, función](../../../odbc/reference/syntax/sqlcancel-function.md)|  
