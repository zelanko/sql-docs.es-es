...
|Nombre de columna|columna<br /><br /> número|Tipo de datos|Comentarios|  
|-----------------|-----------------------|---------------|--------------|  
...
|CHAR_OCTET_LENGTH (ODBC 3.0)|16|Entero|Columna de tipo de la longitud máxima en bytes de un carácter o datos binarios. Para todos los demás tipos de datos, esta columna devuelve NULL.|  
