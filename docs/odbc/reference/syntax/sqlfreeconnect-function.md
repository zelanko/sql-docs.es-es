 ...
 **Resumen**  
 En ODBC 3 *.x*, la función ODBC 2.0 **SQLFreeConnect** ha sido reemplazado por **SQLFreeHandle**. Para obtener más información, consulte [SQLFreeHandle](../../../odbc/reference/syntax/sqlfreehandle-function.md).  
