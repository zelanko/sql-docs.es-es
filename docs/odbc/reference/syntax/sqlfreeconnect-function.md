---
title: Función SQLFreeConnect | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
...
ms.locfileid: "32916636"
---
# <a name="sqlfreeconnect-function"></a>SQLFreeConnect (función)
**Conformidad**  
 Versión introdujo: Cumplimiento de estándares 1.0 de ODBC: en desuso  
  
 **Resumen**  
 En ODBC 3 *.x*, la función de ODBC 2.0 **SQLFreeConnect** se ha reemplazado por **SQLFreeHandle**. Para obtener más información, consulte [SQLFreeHandle](../../../odbc/reference/syntax/sqlfreehandle-function.md).  
