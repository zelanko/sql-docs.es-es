---
title: Función SQLFreeEnv (SQLFreeEnv) Microsoft Docs
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
 ...
 **Resumen**  
 En ODBC *3.x*, la función ODBC 2.0 **SQLFreeEnv** se ha reemplazado por **SQLFreeHandle**. Para obtener más información, vea [SQLFreeHandle](../../../odbc/reference/syntax/sqlfreehandle-function.md).  
