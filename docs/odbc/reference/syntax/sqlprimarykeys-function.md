 ...
 *SchemaName*  
 ...
 Si el atributo de instrucción SQL_ATTR_METADATA_ID se establece en SQL_TRUE, *SchemaName* se trata como un identificador y su caso no es significativo. Si se SQL_FALSE, *SchemaName* es un argumento normal; se trata literalmente, y su caso no es significativo.  
 ...
 *TableName*  
 ...
 Si el atributo de instrucción SQL_ATTR_METADATA_ID se establece en SQL_TRUE, *TableName* se trata como un identificador y su caso no es significativo. Si se SQL_FALSE, *TableName* es un argumento normal; se trata literalmente, y su caso no es significativo.  
...
|HY009|Uso no válido de puntero nulo|(DM) El argumento *TableName* era un puntero nulo.<br /><br /> El atributo de instrucción SQL_ATTR_METADATA_ID se estableció en SQL_TRUE, el *CatalogName* argumento era un puntero nulo y **SQLGetInfo** con el tipo de información SQL_CATALOG_NAME devuelve que se admiten los nombres de catálogo.<br /><br /> (DM) el atributo de instrucción SQL_ATTR_METADATA_ID se estableció en SQL_TRUE y el *SchemaName* argumento era un puntero nulo.|  
...
|HY090|Cadena no válida o longitud de búfer|(DM) el valor de uno de los argumentos de longitud de nombre era menor que 0 pero no igual a SQL_NTS, y el argumento name asociado no es un puntero nulo.<br /><br /> El valor de uno de los argumentos de longitud de nombre superó el valor de longitud máxima para el nombre correspondiente.|  
 ...
 **SQLPrimaryKeys** devuelve los resultados como un conjunto de resultados estándar, ordenados por TABLE_CAT, TABLE_SCHEM, TABLE_NAME y KEY_SEQ. Para obtener información sobre cómo se puede usar esta información, vea [Usos de datos de catálogo](../../../odbc/reference/develop-app/uses-of-catalog-data.md).  
