...
|CHAR_OCTET_LENGTH (ODBC 3.0)|17|Entero|Columna de tipo de la longitud máxima en bytes de un carácter o datos binarios. Para todos los demás tipos de datos, esta columna devuelve NULL.|  
