...
|NUM_INPUT_PARAMS (ODBC 2,0)|4|N/D|Reservado para su uso en el futuro: Las aplicaciones no deben basarse en los datos devueltos en estas columnas de resultados.|  
|NUM_OUTPUT_PARAMS (ODBC 2,0)|5|N/D|Reservado para su uso en el futuro: Las aplicaciones no deben basarse en los datos devueltos en estas columnas de resultados.|  
|NUM_RESULT_SETS (ODBC 2,0)|6|N/D|Reservado para su uso en el futuro: Las aplicaciones no deben basarse en los datos devueltos en estas columnas de resultados.|  
