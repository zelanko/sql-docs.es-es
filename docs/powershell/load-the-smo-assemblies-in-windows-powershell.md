...
description: Aprenda a cargar ensamblados de Objeto de administración de SQL Server (SMO) en scripts de Windows PowerShell que no usan el proveedor SQL Server PowerShell.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
