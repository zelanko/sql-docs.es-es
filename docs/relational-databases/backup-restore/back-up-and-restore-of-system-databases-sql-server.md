...
description: SQL Server mantiene las bases de datos del sistema esenciales para el funcionamiento de una instancia del servidor. Varias bases de datos del sistema requieren que se hagan copias de seguridad tras cualquier actualización de importancia.
...
ms.locfileid: "96130553"
---
# <a name="backup--restore-system-databases-sql-server"></a>Copia de seguridad y restauración: bases de datos del sistema (SQL Server)
