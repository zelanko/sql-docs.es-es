...
helpviewer_keywords: 
  ...
  - "hacer copias de seguridad [SQL Server]. base de datos dañada"
  - "copias de seguridad de registro de transacciones [SQL Server], bases de datos dañadas"
...
#### Para hacer una copia del final registro de transacciones  
