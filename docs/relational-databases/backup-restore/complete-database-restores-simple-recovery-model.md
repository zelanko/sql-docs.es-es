...
description: Sepa en qué consiste una restauración de base de datos completa en SQL Server, que restaura todos los datos al momento dado en que la copia de seguridad se hizo.
