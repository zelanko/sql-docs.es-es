...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] El cuadro de diálogo permite especificar la conexión a la información de la cuenta de almacenamiento de Microsoft Azure para recuperar el almacenamiento de archivos de la cuenta de almacenamiento de Microsoft Azure. Después de especificar la información necesaria, haga clic en **Conectar** para establecer la conexión al Almacenamiento de Windows Azure.  
