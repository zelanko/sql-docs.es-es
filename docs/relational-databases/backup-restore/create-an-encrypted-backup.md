...
-   Una cuenta de almacenamiento de Windows y un contenedor. Para obtener más información, vea: [Lección 1: Crear objetos de Azure Storage](/previous-versions/sql/sql-server-2016/jj720557(v=sql.130)).  
