...
description: En este artículo se muestra cómo definir un dispositivo lógico de copia de seguridad para un archivo de disco en SQL Server mediante SQL Server Management Studio o Transact-SQL.
