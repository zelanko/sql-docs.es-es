...
helpviewer_keywords: 
  ...
  - "copias de seguridad diferenciales, acerca de"
...
-   [Información general de las copias de seguridad diferenciales](#Overview)  
  
-   [Copias de seguridad diferencias de bases de datos de solo lectura](#ReadOnlyDbs)  
...
##  <a name="Overview"></a> Información general de las copias de seguridad diferenciales  
 ...
 ![Un mapa de bits diferencial identifica las extensiones modificadas](../../relational-databases/backup-restore/media/bnr-how-diff-backups-work.gif "Un mapa de bits diferencial identifica las extensiones modificadas")  
