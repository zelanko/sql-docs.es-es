...
# <a name="enable-sql-server-managed-backup-to-azure"></a>Habilitación de la copia de seguridad administrada de SQL Server en Azure
 ...
 En este tutorial se usa Azure PowerShell. Antes de iniciar el tutorial, [descargue e instale Azure PowerShell](/powershell/azure/).  
...
Para obtener más información sobre las cuentas de almacenamiento, consulte [Acerca de las cuentas de almacenamiento de Azure](/azure/storage/common/storage-account-create). 
...
Anote la dirección URL del contenedor y la SAS para usarlos al crear una credencial de SQL. Para más información sobre SAS, consulte [Uso de firmas de acceso compartido, parte 1: Descripción del modelo SAS](/azure/storage/common/storage-sas-overview).  
