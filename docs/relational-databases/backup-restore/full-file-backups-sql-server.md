...
description: En SQL Server, puede realizar una copia de seguridad y restaurar un grupo de archivos entero en lugar de especificar cada archivo individualmente.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
