...
description: SQL Server admite la creación de reflejo de conjuntos de medios, lo que aumenta la confiabilidad de las copias de seguridad al reducir el impacto de los errores de funcionamiento de los dispositivos de copia de seguridad.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
