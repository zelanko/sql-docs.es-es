...
ms.topic: "article"
helpviewer_keywords: 
  - "errores de medios [SQL Server]"
  - "CONTINUE_AFTER_ERROR [opción]"
  - "errores [SQL Server], copias de seguridad"
  - "copias de seguridad [SQL Server], errores"
  - "RESTORE VERIFYONLY [instrucción]"
  - "medio de copia de seguridad [SQL Server], administración de errores"
  - "sumas de comprobación de página [SQL Server]"
  - "sumas de comprobación de copia de seguridad [SQL Server]"
  - "realizar copias de seguridad [SQL Server], errores de medios"
  - "instrucción RESTORE, errores de medios"
  - "NO_CHECKSUM [opción]"
...
-   [Comprobaciones de copia de seguridad](#BckChecksums)  
  
-   [Respuesta a errores de suma de comprobación de página durante una operación de copia de seguridad o restauración](#ResponsetoPageChecksumErrors)  
...
1.  Antes de escribir una página en los medios de copia de seguridad, la operación de copia de seguridad comprueba la información en el nivel de página (suma de comprobación de página o detección de página rasgada), si existe. Si no existe, la copia de seguridad no puede comprobar la página. Las páginas no comprobadas se incluyen tal cual y su contenido se agrega a la suma de comprobación de copia de seguridad total.  
    ...
    > [!NOTE]  
    >  Para obtener más información acerca de las sumas de comprobación de página y la detección de página rasgada, vea la opción PAGE_VERIFY de la instrucción ALTER DATABASE. Para obtener más información, vea [Opciones de ALTER DATABASE SET &#40;Transact-SQL&#41;](../Topic/ALTER%20DATABASE%20SET%20Options%20\(Transact-SQL\).md).  
