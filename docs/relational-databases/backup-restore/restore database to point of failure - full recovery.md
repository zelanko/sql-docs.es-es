---
title: "Restaurar una base de datos seg&#250;n el punto de error en el modelo de recuperaci&#243;n completa (Transact-SQL) | Microsoft Docs"
ms.custom: ""
ms.date: "03/13/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "punto de error [SQL Server]"
  - "restaurar bases de datos [SQL Server], punto de error"
  - "restauraciones de bases de datos [SQL Server], punto de error"
...
2.  Restaure una copia de seguridad completa de la base de datos mediante la ejecución de la siguiente instrucción [RESTORE DATABASE](../Topic/RESTORE%20\(Transact-SQL\).md) básica:  
