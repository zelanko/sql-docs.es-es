...
helpviewer_keywords: 
  ...
  - "restauraciones de bases de datos [SQL Server], copias de seguridad completas"
  ...
  - "restaurar bases de datos [SQL Server], copias de seguridad completas"
...
### **A. Restaurar una copia de seguridad completa de la base de datos**    
...
### **B. Restaurar una copia de seguridad de disco anterior en una base de datos existente**    
...
### **C.  Restaurar una copia de seguridad de disco anterior con un nuevo nombre de base de datos donde todavía existe la base de datos original**
...
### **D.  Restaurar copias de seguridad de disco anteriores a un momento dado**
...
### **E.  Restaurar una copia de seguridad desde el servicio de almacenamiento de Microsoft Azure**
#### **Pasos comunes**
...
6.  Haga clic en **Agregar** y se abrirá el cuadro de diálogo **Seleccionar ubicación de archivo de copia de seguridad**.
    ...
    #### **E1.   Restaurar una copia de seguridad seccionada en una base de datos existente cuando existe una firma de acceso compartido**
...
*  
    ...
    #### **E2.   No existe ninguna firma de acceso compartido**
...
#### **F.   Restaurar copia de seguridad local en el almacenamiento de Microsoft Azure (dirección URL)**
