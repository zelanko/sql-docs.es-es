...
> [!NOTE]  
>  Cuando especifica una tarea de restauración mediante [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)], puede generar el script [!INCLUDE[tsql](../../includes/tsql-md.md)] [RESTORE](../Topic/RESTORE%20\(Transact-SQL\).md) correspondiente si hace clic en **Script** y luego selecciona un destino para el script.  
...
## Restaurar a partir de una copia de seguridad cifrada  
...
## Restaurar desde Almacenamiento de Microsoft Azure  
