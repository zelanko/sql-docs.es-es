...
description: Obtenga información sobre cómo restaurar páginas en SQL Server usando SQL Server Management Studio o Transact-SQL. Restaure páginas dañadas sin restaurar la base de datos completa.
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
