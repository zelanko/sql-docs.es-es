...
-   [Restauración desde Azure Storage con SQL Server Management Studio](../../relational-databases/backup-restore/sql-server-backup-to-url.md#RestoreSSMS)  
...
###  <a name="ssnoversion-components"></a>Componentes <a name="sqlserver"> de </a>[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
##  <a name="using-back-up-task-in-sql-server-management-studio"></a><a name="BackupTaskSSMS"></a> Usar la tarea Copia de seguridad en SQL Server Management Studio  
...
##  <a name="sql-server-backup-to-url-using-maintenance-plan-wizard"></a><a name="MaintenanceWiz"></a> Copia de seguridad de SQL Server en una dirección URL mediante el Asistente para planes de mantenimiento  
...
##  <a name="restoring-from-microsoft-azure-storage-using-sql-server-management-studio"></a><a name="RestoreSSMS"></a> Restaurar desde el almacenamiento de Microsoft Azure con SQL Server Management Studio  
