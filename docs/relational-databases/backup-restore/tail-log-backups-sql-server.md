...
description: En SQL Server, una copia del final del registro captura las entradas del registro de las que todavía no se ha hecho una copia de seguridad para evitar la pérdida de datos y mantener intacta la cadena de registros.
ms.custom: ''
ms.date: 08/01/2016
ms.prod: sql
