...
ms.topic: "article"
helpviewer_keywords: 
  - "copia de seguridad [SQL Server], cola del registro"
  - "copias de seguridad del registro de transacciones [SQL Server], copias del final del registro"
  - "NO_TRUNCATE, cláusula"
  - "copias de seguridad [SQL Server], copias de seguridad de registros"
  - "copias del final del registro"
  - "copias de seguridad [SQL Server], copias del final del registro"
