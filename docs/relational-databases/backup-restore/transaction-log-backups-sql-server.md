...
ms.topic: "article"
helpviewer_keywords: 
  - "hacer copia de seguridad [SQL Server], registros de transacciones"
  - "copias de seguridad de registro de transacciones [SQL Server], crear"
  - "copias de seguridad de registros [SQL Server ["
  - "copias de seguridad de registro de transacciones [SQL Server], secuenciar"
