...
ms.topic: "article"
helpviewer_keywords: 
  - "marcas de transacción [SQL Server]"
  - "transacciones marcadas [SQL Server]"
  - "restauración de base de datos [SQL Server], insertar marcas de transacción para"
  - "recuperación [SQL Server], bases de datos relacionadas"
  - "restaurar bases de datos [SQL Server], recuperación de base de datos relacionada"
  - "restauraciones de bases de datos [SQL Server], bases de datos relacionadas"
  - "transacciones marcadas [SQL Server], crear"
  - "BEGIN TRAN...WITH MARK, instrucción"
...
manager: "jhubbard"
---
# Usar transacciones marcadas para recuperar bases de datos relacionadas sistem&#225;ticamente (modelo de recuperaci&#243;n completa)
...
## Escenario habitual para utilizar transacciones marcadas  
...
## Consideraciones para el uso de transacciones marcadas  
...
## Crear las transacciones marcadas  
...
## Forzar que una marca se distribuya a otros servidores  
...
## Recuperar a una transacción marcada  
