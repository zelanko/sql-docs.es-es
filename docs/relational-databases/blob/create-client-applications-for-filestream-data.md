...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Puede usar las API de Win32 para leer y escribir datos en un blob FILESTREAM. Se requieren los pasos siguientes:  
