...
ms.topic: "article"
helpviewer_keywords: 
  - "FILESTREAM [SQL Server], otras características de SQL Server y"
  - "FILESTREAM [SQL Server], limitaciones"
