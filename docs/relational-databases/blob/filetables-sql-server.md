...
description: Explore las ventajas y la funcionalidad de FileTables, la característica de SQL Server que usa una estructura de directorios para almacenar los archivos. Aprenda a trabajar con FileTables.
ms.custom: ''
ms.date: 10/24/2016
ms.prod: sql
