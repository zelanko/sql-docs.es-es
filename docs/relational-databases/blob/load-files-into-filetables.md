...
description: Descubra cómo cargar y migrar archivos en FileTables en SQL Server cuando los archivos se almacenan de varias maneras. Lea acerca de las operaciones de carga masiva.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
