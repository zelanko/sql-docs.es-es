...
description: Explore las tareas administrativas comunes que se pueden usar para administrar FileTables y obtenga información sobre la seguridad, la copia de seguridad y la auditoría de FileTable.
ms.custom: ''
ms.date: 08/23/2017
ms.prod: sql
