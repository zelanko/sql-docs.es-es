...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]
  ...
  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] El almacén remoto de blobs (RBS) es un componente complementario opcional que permite a los administradores de bases de datos almacenar objetos binarios grandes en soluciones de almacenamiento de artículos en lugar de hacerlo directamente en el servidor de base de datos principal.  
