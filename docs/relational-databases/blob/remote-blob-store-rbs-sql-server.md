...
##  <a name="a-namerbsresourcesa-rbs-resources"></a><a name="rbsresources"></a> Recursos de RBS  
...
##  <a name="a-namekeyrotationa-key-rotation-script"></a><a name="Key_rotation"></a> Script de rotación de clave  
