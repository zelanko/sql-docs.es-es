...
description: Una función escalar devuelve un valor único. En SQL Server integración CLR, puede escribir funciones escalares definidas por el usuario en código administrado.
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
ms.reviewer: ''
...
## <a name="see-also"></a>Consulte también  
 ...
 [Información general sobre los atributos personalizados de la integración CLR](../clr-integration/database-objects/clr-integration-custom-attributes-for-clr-routines.md)   
