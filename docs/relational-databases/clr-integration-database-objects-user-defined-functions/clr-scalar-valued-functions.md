...
> [!NOTE]  
>  Visual C++ objetos de base de datos compilados con **/clr: Pure** no [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]se admiten para la ejecución en. Por ejemplo, esos objetos de base de datos incluyen funciones escalares.  
