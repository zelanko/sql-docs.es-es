...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Una función con valores de tabla es una función definida por el usuario que devuelva una tabla.  
