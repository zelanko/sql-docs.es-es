...
### <a name="defining-a-table-valued-function-in-transact-sql"></a>Definir una función con valores de tabla en Transact-SQL  
 La sintaxis para definir una función con valores de tabla CLR es similar de un [!INCLUDE[tsql](../../includes/tsql-md.md)] función con valores de tabla, con la adición de la **nombre externo** cláusula. Por ejemplo:  
