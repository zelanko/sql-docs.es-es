...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]En [!INCLUDE[tsql](../../includes/tsql-md.md)] las instrucciones SELECT, puede invocar common language runtime (CLR) definido por el usuario agregados, sujeta a todas las reglas que se aplican a las funciones de agregado del sistema.  
