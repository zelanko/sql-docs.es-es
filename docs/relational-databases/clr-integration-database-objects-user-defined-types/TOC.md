...
# [Obtener acceso a tipos definidos por el usuario: recuperar datos UDT](accessing-user-defined-types-retrieving-udt-data.md)
# [Obtener acceso a tipos definidos por el usuario: actualizar columnas de UDT con DataAdapters](accessing-user-defined-types-updating-udt-columns-with-dataadapters.md)
...
# [Crear requisitos de tipos definidos por el usuario:](creating-user-defined-types-requirements.md)
