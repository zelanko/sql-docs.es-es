...
-   **UserProvidedCommands**, que muestra cómo proporcionar **InsertCommand**, **UpdateCommand**, y **DeleteCommand** objetos para actualizar el **Punto** UDT en el **puntos** tabla (que no contiene un **timestamp** columna).  
