...
description: Este ejemplo muestra cómo implementar un UDT para usarlo en una base de datos de SQL Server. Implementa el UDT como una estructura.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
ms.reviewer: ''
