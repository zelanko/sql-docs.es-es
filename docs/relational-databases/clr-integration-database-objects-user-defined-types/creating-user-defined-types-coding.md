...
### <a name="example"></a>Ejemplo  
 La propiedad **Microsoft. SqlServer. Server. SqlMethodAttribute. IsMutator** permite marcar un método que permite un cambio en el estado de una instancia de un UDT. 
