...
description: Puede tener acceso a la funcionalidad UDT en SQL Server desde el lenguaje Transact-SQL mediante la sintaxis de consulta normal. Definir tablas y columnas UDT y manipular datos UDT.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
