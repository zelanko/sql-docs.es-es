...
description: SQL Server la programación de CLR no permite un tipo o miembro con algunos valores para la enumeración HostProtectionResource. En este artículo se enumeran los valores no permitidos de System. Core. dll.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
