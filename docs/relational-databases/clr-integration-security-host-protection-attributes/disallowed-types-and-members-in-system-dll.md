...
description: SQL Server la programación de CLR no permite un tipo o miembro con ciertos valores para la enumeración HostProtectionResource. En este artículo se enumeran System.dll valores no permitidos.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
