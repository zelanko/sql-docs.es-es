...
description: La programación CLR de SQL ServerSQL Server no permite un tipo o miembro con determinados valores para la enumeración HostProtectionResource. En este artículo se enumeran los valores no permitidos de System.dll.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
