...
ms.topic: "article"
helpviewer_keywords: 
  - "intercalaciones [SQL Server], base de datos"
  - "intercalaciones de base de datos [SQL Server]"
...
3.  Copie y pegue el siguiente ejemplo en la ventana de consulta y haga clic en **Ejecutar**. En este ejemplo se muestra cómo usar la cláusula [COLLATE](../Topic/COLLATE%20\(Transact-SQL\).md) para especificar un nombre de intercalación. En el ejemplo de crea la base de datos `MyOptionsTest` que utiliza la intercalación `Latin1_General_100_CS_AS_SC` . Después de crear la base de datos, ejecute la instrucción `SELECT` para comprobar la configuración.  
...
3.  Copie y pegue el siguiente ejemplo en la ventana de consulta y haga clic en **Ejecutar**. En este ejemplo se muestra cómo usar la cláusula [COLLATE](../Topic/COLLATE%20\(Transact-SQL\).md) en una instrucción [ALTER DATABASE](../../t-sql/statements/alter-database-transact-sql.md) para cambiar el nombre de la intercalación. Ejecute la instrucción `SELECT` para comprobar el cambio.  
