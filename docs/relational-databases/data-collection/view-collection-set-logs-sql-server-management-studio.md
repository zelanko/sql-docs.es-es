...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Puede ver todos los registros del conjunto de recopilación o registros de conjunto de recopilación individuales de [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)].  
