...
description: Obtenga información sobre cómo el Motor de base de datos de SQL Server implementa la compresión de filas para ayudarle a planear el espacio de almacenamiento que necesita para sus datos.
ms.custom: ''
ms.date: 06/30/2016
ms.prod: sql
