---
title: "Eliminar una aplicaci&#243;n de capa de datos | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  - "Cómo [DAC], eliminar"
  - "aplicación de capa de datos [SQL Server], eliminar"
  - "asistente [DAC], eliminar"
  - "eliminar DAC"
...
### Ejemplo para eliminar la DAC y mantener la base de datos (PowerShell)  
...
### Ejemplo para eliminar la DAC y separar la base de datos (PowerShell)  
...
### Ejemplo para eliminar la DAC y quitar la base de datos (PowerShell)  
