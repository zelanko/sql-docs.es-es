---
title: "Implementar una aplicaci&#243;n de capa de datos | Microsoft Docs"
ms.custom: ""
ms.date: "01/31/2017"
...
helpviewer_keywords: 
  ...
  - "DAC, implementar"
  - "aplicación de capa de datos [SQL Server], implementar"
  - "Cómo [DAC], implementar"
  - "asistente [DAC], implementar"
...
##  <a name="UsingDeployDACWizard"></a> Usar el Asistente Implementar aplicación de capa de datos  
 ...
 **Cancelar:** termina el asistente sin implementar una DAC.  
 ...
 [&#91;Asistente de implementación&#93;](#UsingDeployDACWizard)  
 ...
 **\< Anterior:** vuelve a la página **Actualizar la configuración** para cambiar las selecciones.  
