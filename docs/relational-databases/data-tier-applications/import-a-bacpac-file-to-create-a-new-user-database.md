...
## Utilidad de SQL Server  
 Si importa una DAC en una instancia administrada del motor de base de datos, la DAC importada se incorpora a la Utilidad de SQL Server la próxima vez que el conjunto de recopilación de utilidades se envíe desde la instancia al punto de control de la utilidad. Posteriormente, la DAC aparecerá en el nodo **Aplicaciones de capa de datos implementadas** del **Explorador de Utilidad** de [!INCLUDE[ssManStudio](../../includes/ssmanstudio-md.md)] y se notificará en la página de detalles **Aplicaciones de capa de datos implementadas**.  
...
## Vea también  
[Importar un archivo de BACPAC para crear una nueva Azure SQL Database](https://azure.microsoft.com/en-us/documentation/articles/sql-database-import/)  
