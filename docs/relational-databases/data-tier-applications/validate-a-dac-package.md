...
ms.topic: "article"
helpviewer_keywords: 
  - "aplicación de capa de datos [SQL Server], validar"
  - "aplicación de capa de datos [SQL Server], comparar"
  - "DAC, validar"
  - "DAC, comparar"
  - "aplicación de capa de datos [SQL Server], ver"
  - "DAC, ver"
