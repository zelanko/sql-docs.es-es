...
[Datos de objeto binario grande &#40;Blob&#41;](../relational-databases/blob/binary-large-object-blob-data-sql-server.md)  
[Importar y exportar datos de forma masiva](../relational-databases/import-export/bulk-import-and-export-of-data-sql-server.md)  
[Cursores](../relational-databases/cursors.md)    
[Bases de datos](../relational-databases/databases/databases.md)  
[Puntos de comprobación de base de datos](../relational-databases/logs/database-checkpoints-sql-server.md)  
...
[Datos JSON](../relational-databases/json/json-data-sql-server.md)    
...
[Búsqueda semántica](../relational-databases/search/semantic-search-sql-server.md)  
[Números de secuencia](../relational-databases/sequence-numbers/sequence-numbers.md)  
[Datos espaciales](../relational-databases/spatial/spatial-data-sql-server.md)  
...
[Sinónimos &#40;motor de base de datos&#41;](../relational-databases/synonyms/synonyms-database-engine.md)  
[Tablas](../relational-databases/tables/tables.md)  
[Tablas temporales](../relational-databases/tables/temporal-tables.md)  
[El tipo de registro de transacciones](../relational-databases/logs/the-transaction-log-sql-server.md)  
...
[Datos XML](../relational-databases/xml/xml-data-sql-server.md)  
