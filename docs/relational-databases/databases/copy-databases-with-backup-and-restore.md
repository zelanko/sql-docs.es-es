---
title: "Copiar bases de datos con Copias de seguridad y restauraci&#243;n | Microsoft Docs"
ms.custom: ""
ms.date: "07/15/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "búsqueda de texto completo [SQL Server], copia de seguridad y restauración"
  - "restaurar bases de datos [SQL Server], versiones anteriores de SQL Server"
  - "restauraciones de bases de datos [SQL Server], copiar bases de datos"
  - "restaurar bases de datos [SQL Server], en otra instancia del servidor"
  - "restaurar [SQL Server], en otra instancia de servidor"
  - "realizar copias de seguridad de bases de datos [SQL Server], copiar bases de datos"
  - "copias de seguridad [SQL Server], copiar bases de datos"
...
-   Mueva los archivos de catálogo a una ubicación nueva durante la operación de restauración con la cláusula WITH MOVE de la instrucción RESTORE DATABASE. Para obtener más información, vea [RESTORE &#40;Transact-SQL&#41;](../Topic/RESTORE%20\(Transact-SQL\).md).  
