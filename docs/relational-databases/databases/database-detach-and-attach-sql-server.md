---
title: "Adjuntar y separar bases de datos (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "bases de datos [SQL Server], desasociar"
  - "desasociar base de datos [SQL Server]"
  - "bases de datos [SQL Server], asociar"
  - "quitar bases de datos"
  - "registros de transacciones [SQL Server], desasociar"
  - "bases de datos [SQL Server], quitar"
  - "restaurar [SQL Server], bases de datos adjuntas"
  - "registros de transacciones [SQL Server], asociar"
  - "copias de seguridad diferenciales, después de la desasociación"
  - "mover bases de datos"
  - "adjuntar base de datos [SQL Server]"
...
-   [Cambios en los metadatos al adjuntar una base de datos](#Metadata)  
  
-   [Hacer copias de seguridad y restauración, y adjuntar](#BnR)  
  
-   [Adjuntar una base de datos a otra instancia de servidor](#OtherServerInstance)  
