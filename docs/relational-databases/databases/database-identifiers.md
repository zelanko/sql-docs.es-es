...
dev_langs: 
  - "TSQL"
helpviewer_keywords: 
  - "identificadores normales [SQL Server]"
  - "identificadores [SQL Server]"
  - "nombres [SQL Server], identificadores"
  - "identificadores [SQL Server], acerca de los identificadores"
  - "identificadores de SQL Server"
  - "identificadores de Transact-SQL"
  - "objetos de base de datos [SQL Server], nombres"
...
> [!NOTE]  
>  Algunas reglas de formato de los identificadores normales dependen del nivel de compatibilidad de la base de datos. Este nivel se puede establecer mediante [ALTER DATABASE](../Topic/ALTER%20DATABASE%20Compatibility%20Level%20\(Transact-SQL\).md).  
