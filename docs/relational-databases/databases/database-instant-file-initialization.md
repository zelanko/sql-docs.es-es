...
ms.topic: "article"
helpviewer_keywords: 
  - "inicializar archivos [SQL Server]"
  - "inicialización instantánea de archivos [SQL Server]"
  - "inicialización rápida de archivos (SQL Server)"
  - "inicialización de archivos [SQL Server]"
