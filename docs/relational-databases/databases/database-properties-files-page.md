 ...
 **Tamaño inicial**  
 ...
 Para los archivos de los grupos de archivos con optimización para memoria, este campo no se puede modificar.  
 ...
 **Crecimiento automático**  
 ...
 En el caso de los archivos de los grupos de archivos con optimización para memoria, este campo debe establecerse en **Ilimitado**.  
 ...
 **Nombre de archivo**  
 ...
 Este campo no es válido para los archivos FILESTREAM, lo cual incluye los archivos en grupos de archivos con optimización para memoria.  
