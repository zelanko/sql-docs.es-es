---
title: "Volver a generar bases de datos del sistema | Microsoft Docs"
ms.custom: ""
ms.date: "06/06/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "base de datos maestra [SQL Server], volver a generar"
  - "REBUILDDATABASE, parámetro"
  - "volver a generar bases de datos, maestras"
  - "bases de datos del sistema [SQL Server], volver a generar"
...
3.  En otra ventana de la línea de comandos, separe la base de datos **msdb** ejecutando el siguiente comando, reemplazando *\<servername>* por la instancia de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]: `SQLCMD -E -S<servername> -dmaster -Q"EXEC sp_detach_db msdb"`  
