---
description: Volver a generar bases de datos del sistema
...
##  <a name="rebuild-the-tempdb-database"></a><a name="RebuildTempdb"></a>Regeneración de la base de datos tempdb  
