...
ms.topic: "article"
helpviewer_keywords: 
  - "base de datos independiente, amenazas"
...
## Amenazas relacionadas con usuarios  
...
### Acceder a otras bases de datos mediante la cuenta Invitado  
...
### Crear un usuario que duplica un inicio de sesión  
...
### Incrementar el acceso cambiando el estado de contención de una base de datos  
...
### Ataque por diccionario sin conexión  
...
## Establecer secuencias de escape en una base de datos independiente  
...
## Denegación de servicio mediante AUTO_CLOSE  
