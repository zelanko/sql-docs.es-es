...
ms.topic: "article"
helpviewer_keywords: 
  - "tablas temporales [SQL Server], base de datos tempdb"
  - "base de datos tempdb [SQL Server], acerca de tempdb"
  - "procedimientos almacenados temporales [SQL Server]"
  - "tempdb, base de datos [SQL Server]"
...
|TRUSTWORTHY|OFF|No|  
 ...
 Para obtener una descripción de estas opciones de la base de datos, vea [Opciones de ALTER DATABASE SET &#40;Transact-SQL&#41;](../Topic/ALTER%20DATABASE%20SET%20Options%20\(Transact-SQL\).md).  
