...
### Seleccionar un servidor de origen
...
###  Seleccionar un servidor de destino
...
###  Seleccionar los objetos de servidor 
...
###   Ubicación de los archivos de base de datos de origen
...
### **A.  Mover bases de datos mediante el método de separar y adjuntar a una instancia en un servidor físico diferente.  También se moverá un inicio de sesión y el trabajo del Agente SQL Server.**  
...
### **B.     Copiar bases de datos mediante el método de separar y adjuntar a la misma instancia y establecer una programación periódica.**  
