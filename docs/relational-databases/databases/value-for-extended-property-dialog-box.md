...
ms.locfileid: "68127109"
---
# <a name="value-for-extended-property-dialog-box"></a>Valor para propiedad extendida, cuadro de diálogo
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]
  Use el cuadro de diálogo **Valor para** _\<nombre de propiedad>_ para especificar o ver un valor. Se trata de un cuadro de diálogo común que puede abrirse desde varias ubicaciones.  
