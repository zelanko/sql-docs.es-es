...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]
  Use el cuadro de diálogo **Valor para** _\<nombre de propiedad>_ para escribir o ver un valor. Se trata de un cuadro de diálogo común que puede abrirse desde varias ubicaciones.  
