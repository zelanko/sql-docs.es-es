...
ms.topic: "article"
helpviewer_keywords: 
  - "instantáneas de base de datos [SQL Server], ver"
  - "mostrar instantáneas de base de datos"
  - "ver instantáneas de base de datos"
...
---
# Ver una instant&#225;nea de base de datos (SQL Server)
