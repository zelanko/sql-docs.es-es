---
title: "Niveles de gravedad de error del motor de base de datos | Microsoft Docs"
ms.custom: ""
ms.date: "03/16/2017"
...
helpviewer_keywords: 
  ...
  - "niveles de gravedad [SQL Server]"
  - "recuperar la gravedad del error"
  - "errores [SQL Server], gravedad"
...
## Vea también  
 ...
 [Funciones del sistema &#40;Transact-SQL&#41;](../../t-sql/functions/system-functions-transact-sql.md)   
