...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Esta sección contiene una selección de mensajes de error de [!INCLUDE[ssDE](../../includes/ssde-md.md)] que requieren una explicación más detallada.  
