...
ms.topic: "article"
helpviewer_keywords: 
  - "errores [SQL Server], acerca de los errores"
  - "errores [SQL Server], motor de base de datos"
  - "errores [SQL Server]"
...
```  
 ...
 Para obtener más información, vea [sys.messages &#40;Transact-SQL&#41;](../Topic/sys.messages%20\(Transact-SQL\).md).  
