...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La clase de eventos **Audit Add Login to Server Role** se produce cuando se agrega o quita un inicio de sesión desde un rol fijo de servidor. Esta clase de eventos se usa para los procedimientos almacenados **sp_addsrvrolemember** y **sp_dropsrvrolemember** .  
