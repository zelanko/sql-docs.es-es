...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La clase de eventos **Audit Add Member to DB Role** tiene lugar cuando se agrega o quita un inicio de sesión en un rol de base de datos. Esta clase de eventos se usa con los procedimientos almacenados **sp_addrolemember**, **sp_changegroup**y **sp_droprolemember** .  
