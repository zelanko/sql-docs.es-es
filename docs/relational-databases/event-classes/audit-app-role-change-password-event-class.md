...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La clase de eventos **Audit App Role Change Password** se produce cuando se cambia la contraseña de un rol de aplicación.  
