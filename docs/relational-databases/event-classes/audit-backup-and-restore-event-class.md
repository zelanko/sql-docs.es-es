...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] La clase de eventos **Audit Backup/Restore** se produce cuando se emite un comando BACKUP o RESTORE.  
