...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La clase de eventos **Audit Database Object Management** se genera al ejecutar una instrucción CREATE, ALTER o DROP en objetos de base de datos tales como esquemas.  
