...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La clase de eventos **Audit Database Object Take Ownership** tiene lugar cuando se produce un cambio de propietario de los objetos en el ámbito de una base de datos.  
