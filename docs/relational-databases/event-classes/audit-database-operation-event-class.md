...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La clase de eventos **Audit Database Operation** se produce cuando tienen lugar operaciones de una base de datos; por ejemplo, un punto de comprobación o una notificación de consulta de suscripción.  
