...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La clase de eventos **Audit Database Principal Management** tiene lugar cuando se crean, modifican o quitan entidades de seguridad; por ejemplo, los usuarios, en una base de datos.  
