...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La clase de eventos **Audit Schema Object Management** se produce cuando se crean, modifican o quitan objetos de servidor.  
