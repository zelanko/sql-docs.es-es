...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La clase de eventos **Audit Server Alter Trace** se produce para todas las instrucciones que buscan el permiso ALTER TRACE. Las instrucciones que buscan ALTER TRACE incluyen las utilizadas para crear o configurar un seguimiento, o bien para establecer un filtro en un seguimiento.  
