...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La clase de eventos **Audit Server Object Management** se produce cuando se aplica CREATE, ALTER o DROP para objetos de servidor.  
