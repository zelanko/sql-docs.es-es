...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La clase de eventos **Audit Server Object Take Ownership** se produce cuando se cambia el propietario para objetos del ámbito del servidor.  
