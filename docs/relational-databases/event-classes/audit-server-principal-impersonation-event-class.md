...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La clase de eventos **Audit Server Principal Impersonation** se produce cuando hay una suplantación en el ámbito del servidor, como EXECUTE AS \<*login*>.  
