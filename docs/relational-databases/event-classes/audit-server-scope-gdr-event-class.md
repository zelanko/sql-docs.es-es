...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La clase de eventos **Audit Server Scope GDR** se produce cuando se emite GRANT, REVOKE o DENY para permisos en el ámbito del servidor, como la creación de un inicio de sesión.  
