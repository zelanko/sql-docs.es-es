---
title: "Audit Server Starts and Stops (clase de eventos) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
---
# Audit Server Starts and Stops (clase de eventos)
  La clase de eventos **Audit Server Starts and Stops** se produce cuando el estado del servicio [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] se modifica.  
  
## Columnas de datos de la clase de eventos Audit Server Starts and Stops  
