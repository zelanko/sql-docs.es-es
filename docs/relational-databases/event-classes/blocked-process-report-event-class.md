...
description: La clase de eventos Blocked Process Report indica que una tarea ha estado bloqueada durante un tiempo superior al período de tiempo especificado en SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
