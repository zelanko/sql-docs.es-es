...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] genera un evento Broker:Forwarded Message Dropped cuando Service Broker quita un mensaje que estaba destinado a reenviarse.  
...
|Success|**int**|Tiempo de duración del mensaje. Cuando este valor es mayor o igual que el tiempo de vida, el mensaje se quita.|23|No|  
