...
ms.topic: "article"
helpviewer_keywords: 
  - "clases de eventos [SQL Server], categoría de evento Base de datos"
  - "Base de datos, categoría de eventos [SQL Server]"
  - "clases de eventos de SQL Server, categoría de evento Base de datos"
...
---
# Base de datos (categor&#237;a de eventos)
