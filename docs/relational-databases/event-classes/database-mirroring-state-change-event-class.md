...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La clase de eventos **Database Mirroring State Change** indica cuándo cambia el estado de una base de datos reflejada. Incluya esta clase de eventos en los seguimientos que supervisan las condiciones de bases de datos reflejadas.  
