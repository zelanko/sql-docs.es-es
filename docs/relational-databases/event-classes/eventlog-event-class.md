...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La clase de eventos EventLog indica que se han registrado eventos en el registro de errores de [!INCLUDE[msCoName](../../includes/msconame-md.md)] Windows.  
