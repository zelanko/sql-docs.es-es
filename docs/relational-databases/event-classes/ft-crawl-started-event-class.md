...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La clase de eventos **FT:Crawl Started** indica que se ha iniciado un rastreo de texto completo (llenado). Utilice esta clase de eventos para comprobar si las tareas de trabajo están recogiendo una solicitud de rastreo.  
