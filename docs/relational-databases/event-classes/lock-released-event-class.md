...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La clase de eventos Lock:Released indica que se ha liberado un bloqueo en un recurso, por ejemplo una página.  
