...
description: La clase de eventos Missing Join Predicate indica que se está ejecutando una consulta que no tiene ningún predicado de combinación en SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
