...
|EventSubClass|**nvarchar**|Tipo de subclase de evento que proporciona más información acerca de cada clase de evento. Esta columna puede incluir los valores siguientes:<br /><br /> **Subscription registered**: indica que la suscripción a notificación de consulta se ha registrado correctamente en la base de datos.<br /><br /> **Subscription rewound**: indica que [!INCLUDE[ssDE](../../includes/ssde-md.md)] ha recibido una solicitud de suscripción que coincide exactamente con una suscripción existente. En este caso, [!INCLUDE[ssDE](../../includes/ssde-md.md)] establece el valor del tiempo de espera de la suscripción existente en el especificado en la nueva solicitud de suscripción.<br /><br /> **Subscription fired**: indica que una suscripción de notificación genera un mensaje de notificación.<br /><br /> **Firing failed with broker error**: indica que un mensaje de notificación genera un error debido a un error de [!INCLUDE[ssSB](../../includes/sssb-md.md)].<br /><br /> **Firing failed without broker error**: indica que un mensaje de notificación genera un error, pero no debido a un error de [!INCLUDE[ssSB](../../includes/sssb-md.md)].<br /><br /> **Broker error intercepted**: indica que [!INCLUDE[ssSB](../../includes/sssb-md.md)] ha emitido un error en la conversación que usa la notificación de consulta.<br /><br /> **Subscription deletion attempt**: indica que [!INCLUDE[ssDE](../../includes/ssde-md.md)] ha intentado eliminar una suscripción expirada para liberar recursos.<br /><br /> **Subscription deletion failed**: indica que el intento de eliminar una suscripción expirada ha producido un error. [!INCLUDE[ssDE](../../includes/ssde-md.md)] volverá a programar automáticamente la eliminación de la suscripción para liberar recursos.<br /><br /> **Subscription destroyed**: indica que [!INCLUDE[ssDE](../../includes/ssde-md.md)] ha eliminado correctamente una suscripción expirada.|21|Sí|  
