...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La clase de eventos RPC:Starting indica que se ha iniciado una llamada a procedimiento remoto.  
