...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La clase de eventos Scan:Started tiene lugar cuando se inicia un recorrido de índice o de tabla.  
