...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La clase de eventos Scan:Stopped tiene lugar cuando se detiene el examen de una tabla o índice.  
