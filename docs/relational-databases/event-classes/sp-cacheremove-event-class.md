...
|EventSubClass|**int**|Tipo de la subclase de eventos.<br /><br /> 1=Quitar plan compilado: Se ha quitado de la caché un plan de consulta compilado.<br /><br /> 2=Vaciar caché de procedimientos: Se han quitado todas las entradas de la caché de procedimientos.|21|Sí|  
