...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La clase de eventos SQL:BatchCompleted indica que se ha completado el lote [!INCLUDE[tsql](../../includes/tsql-md.md)].  
