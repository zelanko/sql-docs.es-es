...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La clase de eventos SQL:BatchStarting indica que se está iniciando un lote [!INCLUDE[tsql](../../includes/tsql-md.md)].  
