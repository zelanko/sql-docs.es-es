...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] Utilice la clase de eventos SQLTransaction para supervisar el inicio y el final de las transacciones, especialmente al probar aplicaciones, desencadenadores o procedimientos almacenados.  
