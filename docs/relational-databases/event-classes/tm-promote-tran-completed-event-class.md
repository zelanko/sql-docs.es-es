...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La clase de eventos TM: Promote Tran Completed indica que se ha completado una solicitud PROMOTE TRANSACTION. La solicitud se envía desde el cliente a través de la interfaz de administración de transacciones.  
...
|BinaryData|**imagen**|Símbolo (token) Xact DTC.|2|Sí|  
