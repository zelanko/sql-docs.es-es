...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La clase de eventos TM: Rollback Tran Completed indica que ha finalizado una solicitud ROLLBACK TRANSACTION. La solicitud fue enviada desde el cliente mediante la interfaz de administración de transacciones. En la columna EventSubClass se indica si se iniciará una nueva transacción tras revertir la transacción actual.  
