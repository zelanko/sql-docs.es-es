...
ms.locfileid: "68075932"
---
# <a name="tm-save-tran-completed-event-class"></a>TM: Clase de eventos Save Tran Completed
...
## <a name="tm-save-tran-completed-event-class-data-columns"></a>TM: Columnas de datos de la clase de evento TM: Save Tran Completed  
