...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La clase de eventos Unprepare SQL indica que SqlClient, ODBC, OLE DB o DB-Library ha cancelado (eliminado) la preparación de una o varias instrucciones [!INCLUDE[tsql](../../includes/tsql-md.md)] preparadas.  
