...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] La clase de eventos User Error Message muestra el mensaje de error tal como lo ve el usuario en caso de error o de excepción. El texto del mensaje de error aparece en el campo TextData.  
