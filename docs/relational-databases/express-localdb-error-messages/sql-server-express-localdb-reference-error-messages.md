...
---
# <a name="sql-server-express-localdb-reference---error-messages"></a>Mensajes de Error de SQL Server Express LocalDB referencia:
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Esta sección proporciona información de referencia acerca de los siguientes mensajes de error de SQL Server Express LocalDB:  
