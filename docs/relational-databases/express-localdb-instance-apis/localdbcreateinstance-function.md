---
title: "Función LocalDBCreateInstance | Documentos de Microsoft"
ms.custom: 
ms.date: 03/06/2017
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Crea una nueva instancia de SQL Server Express LocalDB.  
