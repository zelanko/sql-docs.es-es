...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Devuelve la descripción textual adaptada para el error de SQL Server Express LocalDB especificada.  
