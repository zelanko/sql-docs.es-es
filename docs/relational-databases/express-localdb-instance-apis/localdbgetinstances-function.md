...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Devuelve todas las instancias de SQL Server Express LocalDB con la versión concreta.  
