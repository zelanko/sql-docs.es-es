---
title: "Función LocalDBShareInstance | Documentos de Microsoft"
ms.custom: 
ms.date: 03/06/2017
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Comparte la instancia de SQL Server Express LocalDB especificada con otros usuarios del equipo, con el nombre compartido especificado.  
