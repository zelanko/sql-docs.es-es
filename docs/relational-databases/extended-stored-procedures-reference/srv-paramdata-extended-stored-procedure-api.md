...
description: Más información sobre srv_paramdata. srv_paramdata devuelve el valor de un parámetro de llamada a un procedimiento almacenado remoto.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
