...
description: Obtenga información sobre cómo srv_parammaxlen devuelve la longitud máxima de los datos de un parámetro de llamada a un procedimiento almacenado remoto.
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
