...
description: Obtenga información acerca de cómo srv_paramname en la API de procedimiento almacenado extendido devuelve el nombre de un parámetro de llamada a un procedimiento almacenado remoto.
ms.custom: ''
ms.date: 03/03/2017
ms.prod: sql
