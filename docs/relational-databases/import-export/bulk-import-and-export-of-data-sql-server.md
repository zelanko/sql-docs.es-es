...
helpviewer_keywords: 
  ...
  - "datos [SQL Server], exportación masiva e importación en bloque"
  - "transferir datos"
  - "importar datos, (consulte también importación en bloque [SQL Server])"
  - "copiar datos [SQL Server]"
  - "exportación masiva [SQL Server]"
  - "importar datos, importación en bloque"
  - "copiar datos [SQL Server], exportación masiva e importación en bloque"
  - "exportar datos, (consulte también exportación masiva [SQL Server])"
  - "exportación masiva [SQL Server], acerca de la exportación masiva"
  - "importación masiva [SQL Server]"
  - "importar datos"
...
|[Asistente para importación y exportación de SQL Server](https://msdn.microsoft.com/library/ms141209.aspx)|El asistente crea paquetes simples que importan y exportan datos entre muchos formatos de datos conocidos, incluidas bases de datos, hojas de cálculo y archivos de texto.|Sí|Sí|  
