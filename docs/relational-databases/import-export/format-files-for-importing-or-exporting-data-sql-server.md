...
ms.topic: "article"
helpviewer_keywords: 
  - "exportación masiva [SQL Server], archivos de formato"
  - "importación masiva [SQL Server], archivos de formato"
  - "archivos de formato [SQL Server]"
