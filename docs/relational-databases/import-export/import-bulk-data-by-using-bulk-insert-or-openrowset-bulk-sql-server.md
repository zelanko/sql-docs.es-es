---
title: "Importaci&#243;n en bloque de datos mediante las instrucciones BULK INSERT o OPENROWSET(BULK...) (SQL Server) | Microsoft Docs"
ms.custom: ""
ms.date: "07/26/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Instrucción BULK INSERT, importar datos desde un archivo de datos remotos"
  - "importación en bloque [SQL Server], métodos"
  - "exportación masiva [SQL Server], métodos"
  - "función OPENROWSET, BULK INSERT"
  - "importación en bloque [SQL Server], seguridad"
  - "proveedores de conjuntos de filas BULK [SQL Server]"
  - "exportación masiva [SQL Server], instrucción BULK INSERT"
  - "acceso a datos remotos [SQL Server], importación en bloque"
  - "importación en bloque [SQL Server], instrucción BULK INSERT"
  - "operaciones de exportación/importación masiva de Transact-SQL"
