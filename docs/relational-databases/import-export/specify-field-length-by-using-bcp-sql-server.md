...
ms.topic: "article"
helpviewer_keywords: 
  - "formatos nativos de datos [SQL Server]"
  - "longitud de campo predeterminada"
  - "campo, longitud [SQL Server]"
  - "formatos de datos [SQL Server], longitud de campo"
  - "utilidad bcp [SQL Server], longitud de campo"
...
|XML|0|  
 ...
 \*Para obtener más información sobre los tipos de datos **decimal** y **numeric**, vea [Datos decimal y numeric &#40;Transact-SQL&#41;](../../t-sql/data-types/decimal-and-numeric-transact-sql.md).  
