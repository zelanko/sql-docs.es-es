...
ms.topic: "article"
helpviewer_keywords: 
  - "utilidad bcp [SQL Server], tipos de almacenamiento de archivos"
  - "importación de datos, tipos de almacenamiento de archivos"
  - "formatos nativos de datos [SQL Server]"
  - "tipos de almacenamiento en archivo [SQL Server]"
  - "formatos de datos [SQL Server], tipos de almacenamiento de archivos"
