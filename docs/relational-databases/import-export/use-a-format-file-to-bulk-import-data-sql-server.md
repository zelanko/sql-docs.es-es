...
## <a name="before-you-begin"></a>Antes de comenzar<a name="begin"></a>
...
## <a name="using-a-format-file-to-bulk-import-data"></a>Usar un archivo de formato para importar datos de forma masiva<a name="import_data"></a>
