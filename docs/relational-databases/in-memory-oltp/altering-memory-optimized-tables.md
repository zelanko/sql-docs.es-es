...
Las operaciones de un solo subproceso requieren que todo el contenido de la tabla modificada se escriba en el registro. La siguiente es una lista de las operaciones de un solo subproceso:
