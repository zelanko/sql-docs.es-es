...
###  <a name="bkmk_CreateResourcePool"></a> Crear un grupo de recursos de servidor y configurar la memoria  
 ...
 Vea [Prácticas recomendadas: usar OLTP en memoria en un entorno de máquinas virtuales](../Topic/Using%20In-Memory%20OLTP%20in%20a%20VM%20Environment.md) para obtener más información sobre cómo trabajar en un entorno de máquinas virtuales.  
