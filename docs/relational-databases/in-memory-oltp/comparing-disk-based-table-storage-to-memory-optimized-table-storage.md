...
description: Compare el almacenamiento de tablas optimizadas para memoria y basadas en discos en las categorías de DDL, estructura, índices, operación DML y fragmentación de datos.
