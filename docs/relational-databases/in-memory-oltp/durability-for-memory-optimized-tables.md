...
## <a name="populating-data-and-delta-files"></a>Rellenar los archivos delta y de datos  
 ...
 ![Lectura de registros de tablas con optimización para memoria.](../../relational-databases/in-memory-oltp/media/read-logs-hekaton.gif "Lectura de registros de tablas con optimización para memoria.")  
