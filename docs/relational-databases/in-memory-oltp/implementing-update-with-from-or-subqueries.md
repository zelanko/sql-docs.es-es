...
description: Obtenga información sobre qué elementos de sintaxis se admiten en la instrucción UPDATE de Transact-SQL en un módulo T-SQL compilado de forma nativa.
ms.custom: ''
ms.date: 11/17/2016
ms.prod: sql
