...
ms.locfileid: "39565809"
---
# <a name="migrating-to-in-memory-oltp"></a>Migrar a OLTP en memoria
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]

  En los artículos de esta sección de la tabla de contenido se describe cómo migrar los objetos de base de datos para usar OLTP en memoria en una aplicación existente (procesamiento de transacciones en línea).  
...
-   [Asistente de compilación nativa](../../relational-databases/in-memory-oltp/native-compilation-advisor.md)  
  
-   [Cmdlet de PowerShell para la evaluación de la migración](../../relational-databases/in-memory-oltp/powershell-cmdlet-for-migration-evaluation.md)  
...
-   [Migrar columnas calculadas](../../relational-databases/in-memory-oltp/migrating-computed-columns.md)  
  
-   [Migrar desencadenadores](../../relational-databases/in-memory-oltp/migrating-triggers.md)  
  
-   [Consultas entre bases de datos](../../relational-databases/in-memory-oltp/cross-database-queries.md)  
  
-   [Implementar IDENTITY en una tabla con optimización para memoria](../../relational-databases/in-memory-oltp/implementing-identity-in-a-memory-optimized-table.md)  
