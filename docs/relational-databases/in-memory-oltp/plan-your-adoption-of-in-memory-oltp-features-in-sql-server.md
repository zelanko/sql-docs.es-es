---
title: "Planear la adopci&#243;n de caracter&#237;sticas de OLTP en memoria en SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "10/05/2016"
...
### A.3 La tabla debe estar sin conexión para convertirse en una con optimización para memoria
...
Ninguna consulta puede aplicar la [sugerencia de tabla](Table%20Hints%20%28Transact-SQL%29.md) READPAST a ninguna tabla con optimización para memoria.
...
### C.2 DBCC CHECKDB no puede validar tablas con optimización para memoria
...
1. [Realice una copia de seguridad del registro de transacciones](Back%20Up%20a%20Transaction%20Log%20%28SQL Server%29.md).
...
- Un [índice de almacén de columnas](Columnstore%20Indexes%20Guide.md) puede crearse en una tabla basada en disco, incluso como el índice agrupado. Pero en una tabla con optimización para memoria no puede agruparse un índice de almacén de columnas.
...
### E.1 Ninguna expresión CASE en un procedimiento nativo
...
### E.2 Ninguna instrucción MERGE en un procedimiento nativo
...
### E.3 Ninguna combinación en instrucciones UPDATE o DELETE en un procedimiento nativo
...
#### Solución alternativa válida, DELETE...JOIN manual
...
### E.4 Limitaciones del plan de consulta de los procedimientos nativos
