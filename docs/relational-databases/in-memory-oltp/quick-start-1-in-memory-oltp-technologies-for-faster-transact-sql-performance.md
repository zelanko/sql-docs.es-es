---
title: "Inicio r&#225;pido 1: Tecnolog&#237;as OLTP en memoria para acelerar el rendimiento de Transact-SQL | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
manager: "jhubbard"
---
# Inicio r&#225;pido 1: Tecnolog&#237;as OLTP en memoria para acelerar el rendimiento de Transact-SQL
...
- [Guía de índices de almacén de columnas](Columnstore%20Indexes%20Guide.xml)  
  
  
> [AZURE.NOTE] Hay disponible un vídeo de dos minutos sobre las características en memoria en [Azure SQL Database - In-Memory Technologies (Base de datos SQL de Azure: tecnologías en memoria)](http://channel9.msdn.com/Blogs/Windows-Azure/Azure-SQL-Database-In-Memory-Technologies). El vídeo tiene fecha de diciembre de 2015.  


### <a name="columnstore"></a>Almacén de columnas
...
#### <a name="real-time-operational-analytics"></a>Análisis operativos en tiempo real
...
Para exigir de forma confiable este nivel para tablas con optimización para memoria en una transacción entre contenedores, [modifique la configuración de la base de datos](ALTER%20DATABASE%20SET%20Options%20%28Transact-SQL%29.xml) ejecutando el siguiente código T-SQL.  
...
- [Administrar memoria para OLTP en memoria](Managing%20Memory%20for%20In-Memory%20OLTP.xml)  
...
- [Hacer copia de seguridad, restaurar y recuperar tablas con optimización para memoria](Backup,%20Restore,%20and%20Recovery%20of%20Memory-Optimized%20Tables.xml)  
