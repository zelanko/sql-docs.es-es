...
---
# Compatibilidad de Objetos de administraci&#243;n de SQL Server con OLTP en memoria
...
-   Crear una base de datos con un grupo de archivos con optimización para memoria y un archivo con optimización para memoria.  
  
-   Crear una tabla con optimización para memoria perdurable con una clave principal, un índice no clúster y un índice de hash no clúster.  
  
-   Crear columnas e índices.  
  
-   Crear un tipo de tabla con optimización para memoria definido por el usuario.  
