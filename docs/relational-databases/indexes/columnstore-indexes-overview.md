---
title: "Gu&#237;a de &#237;ndices de almac&#233;n de columnas | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "03/07/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "creación de índices, almacén de columnas"
  - "índices [SQL Server], almacén de columnas"
  - "índice de almacén de columnas"
  - "índices de almacén de columnas, descripción"
  - "xVelocity, índices de almacén de columnas"
...
-   Cada sector de columna se comprime junto y se almacena en un medio físico.  
 ...
 ![Índice de almacén de columnas en clúster](../../relational-databases/indexes/media/sql-server-pdw-columnstore-physicalstorage.gif "Índice de almacén de columnas en clúster")  
...
|Crear índices de almacén de columnas de rendimiento para el almacenamiento de datos.|[Índices de almacén de columnas para el almacenamiento de datos](../Topic/Columnstore%20Indexes%20for%20Data%20Warehousing.md)|Se describe cómo usar índices de árbol b en las tablas de almacén de columnas para crear consultas de almacenamiento de datos de rendimiento.|  
|Usar un índice de árbol b para aplicar una restricción de clave principal en un índice de almacén de columnas.|[Índices de almacén de columnas para el almacenamiento de datos](../Topic/Columnstore%20Indexes%20for%20Data%20Warehousing.md)|Se muestra cómo combinar índices de árbol b y de almacén de columnas para aplicar restricciones de clave principal en el índice de almacén de columnas.|  
...
|Cargar datos en un índice de almacén de columnas.|[Carga de datos de índices de almacén de columnas](../Topic/Columnstore%20Indexes%20Data%20Loading.md)||  
