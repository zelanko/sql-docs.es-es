...
helpviewer_keywords: 
  ...
  - "índices de origen [SQL Server]"
  - "índices preexistentes [SQL Server]"
  - "índices de destino [SQL Server]"
  - "índice temporal, asignación [SQL Server]"
  - "asignaciones de índice temporal [SQL Server]"
