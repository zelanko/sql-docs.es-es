...
ms.topic: "article"
helpviewer_keywords: 
  - "índice en línea, espacio de disco"
  ...
  - "índice sin conexión, espacio de disco [SQL Server]"
...
## Cálculos de espacio en disco para una operación de índice clúster en línea  
