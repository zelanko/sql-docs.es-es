...
ms.topic: "article"
helpviewer_keywords: 
  - "columnas calculadas, creación de índices"
  - "creación de índices [SQL Server], columnas calculadas"
  - "columnas imprecisas"
