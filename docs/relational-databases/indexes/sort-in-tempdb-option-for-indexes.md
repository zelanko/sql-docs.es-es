...
helpviewer_keywords: 
  ...
  - "base de datos tempdb [SQL Server], índices"
  - "índices [SQL Server], base de datos tempdb"
  - "creación de índices [SQL Server], base de datos tempdb"
...
## Fases de la generación de un índice  
