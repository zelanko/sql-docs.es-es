...
## <a name="learn-more-about-openjson-and-built-in-json-support-in-sql-server"></a>Más información sobre OPENJSON y la compatibilidad integrada de JSON en SQL Server  
