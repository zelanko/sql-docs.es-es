...
## <a name="option-1---you-control-output-with-for-json-path"></a>Opción 1: controla la salida con FOR JSON PATH
...
## <a name="option-2---select-statement-controls-output-with-for-json-auto"></a>Opción 2: la instrucción SELECT controla la salida con FOR JSON AUTO
