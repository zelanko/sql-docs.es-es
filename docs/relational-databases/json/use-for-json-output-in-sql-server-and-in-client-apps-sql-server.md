---
description: Uso de salidas FOR JSON en SQL Server y en aplicaciones cliente (SQL Server)
title: Uso de salidas FOR JSON en SQL Server y en aplicaciones cliente
ms.date: 06/03/2020
ms.prod: sql
ms.technology: ''
ms.topic: conceptual
