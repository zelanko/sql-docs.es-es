...
##  <a name="QUERY"></a> Extraer un objeto o una matriz de texto JSON mediante la función JSON_QUERY  
 ...
 Observe el siguiente ejemplo de texto JSON, que contiene un elemento complejo.  
...
## Más información sobre la compatibilidad integrada de JSON en SQL Server  
