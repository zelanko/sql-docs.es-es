---
title: "Crear servidores vinculados (motor de base de datos de SQL Server) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "11/20/2015"
...
helpviewer_keywords: 
  - "servidores vinculados [SQL Server], crear"
...
##### Para crear un servidor vinculado a otra instancia de SQL Server utilizando SQL Server Management Studio  
...
5.  Opcionalmente, para ver o especificar opciones de servidor, haga clic en la página **Opciones del servidor**  .  
     ...
     **Tiempo de espera de la conexión**  
     ...
     Si es 0, use el valor de la opción [Tiempo de espera de inicio de sesión remoto](../../database-engine/configure-windows/configure-the-remote-login-timeout-server-configuration-option.md) predeterminado **sp_configure**.  
     ...
     **Tiempo de espera de la consulta**  
     ...
     Si es 0, use el valor de la opción [Tiempo de espera de consulta remota](../../database-engine/configure-windows/configure-the-remote-query-timeout-server-configuration-option.md) predeterminado **sp_configure**.  
