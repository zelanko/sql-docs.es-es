...
helpviewer_keywords: 
  ...
  - "proveedor OLE DB, servidores vinculados"
  - "administración de servidor [SQL Server], servidores vinculados"
  - "servidores vinculados [SQL Server]"
  - "consultas distribuidas [SQL Server], servidores vinculados"
  - "servidores [SQL Server], vinculados"
  - "servidores remotos [SQL Server], servidores vinculados"
  - "servidores vinculados [SQL Server], acerca de los servidores vinculados"
