---
title: "Tarea Copia de seguridad de base de datos (Plan de mantenimiento) | Microsoft Docs"
ms.custom: ""
ms.date: "03/13/2017"
...
helpviewer_keywords: 
  - "Tarea Copia de seguridad de base de datos, cuadro de diálogo"
...
manager: "jhubbard"
---
# Tarea Copia de seguridad de base de datos (Plan de mantenimiento)
 ...
 **Usar seguridad integrada de Windows NT**  
 Se conecta a una instancia del [!INCLUDE[ssDE](../../includes/ssde-md.md)] de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] con la autenticación de Windows.  
