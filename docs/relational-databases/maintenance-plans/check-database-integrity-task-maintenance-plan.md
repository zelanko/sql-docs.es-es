...
description: Use la Tarea Comprobar la integridad de la base de datos para comprobar la asignación e integridad estructural de las tablas de usuario y del sistema, y los índices de una base de datos de SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
