...
description: Obtenga información sobre cómo agregar una tarea de copia de seguridad a un plan de mantenimiento en SQL Server mediante la tarea Copia de seguridad de base de datos.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
