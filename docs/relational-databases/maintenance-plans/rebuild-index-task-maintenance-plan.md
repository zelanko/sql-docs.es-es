...
description: Obtenga información sobre cómo volver a crear los índices de las tablas de la base de datos de SQL Server con un nuevo factor de relleno mediante la tarea Recompilar índice.
ms.custom: ''
ms.date: 07/21/2017
ms.prod: sql
