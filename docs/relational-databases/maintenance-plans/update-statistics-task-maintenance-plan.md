...
description: Aprenda a actualizar información de SQL Server sobre los datos de las tablas y los índices mediante la tarea Actualizar estadísticas.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
