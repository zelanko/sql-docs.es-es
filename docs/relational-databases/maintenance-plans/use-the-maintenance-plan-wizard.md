...
helpviewer_keywords: 
  ...
  - "Asistente para planes de mantenimiento de bases de datos, inicio"
...
## Definir Comprobar la integridad de la base de datos (CHECKDB)  
...
## Definir las tareas Reducir base de datos  
...
2.  En la página **Definir la tarea Volver a generar índice**, seleccione una o varias bases de datos donde va a volver a crear varios índices. Esta tarea usa la instrucción `ALTER INDEX … REBUILD PARTITION`. Para obtener más información, vea [ALTER INDEX &#40;Transact-SQL&#41;](../../t-sql/statements/alter-index-transact-sql.md). Cuando termine, haga clic en **Siguiente**.  
    ...
    > **NOTA:** Las operaciones de índices en línea no están disponibles en todas las ediciones de [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)]. Para obtener más información, vea [Características compatibles con las ediciones de SQL Server 2016](../Topic/Features%20Supported%20by%20the%20Editions%20of%20SQL%20Server%202016.md).  
...
#### Definir la tarea Actualizar estadísticas  
...
#### Definir la tarea Limpieza de historial  
...
#### Definir la tarea Ejecutar trabajo del Agente SQL Server  
...
#### Definir las tareas Copia de seguridad  
...
#### Definir las tareas Limpieza de mantenimiento  
...
#### Seleccionar opciones de informe  
