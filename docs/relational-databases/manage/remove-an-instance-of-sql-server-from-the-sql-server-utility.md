---
title: "Quitar una instancia de SQL Server de la utilidad de SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
## Quitar manualmente una instancia administrada de SQL Server de una Utilidad de SQL Server  
 Este procedimiento quita la instancia de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] de la vista de lista del UCP y detiene la recopilación de datos de la utilidad de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] . No se desinstala a instancia de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .  
