...
description: Familiarícese con la Utilidad de SQL Server. Obtenga información sobre sus características y descubra cómo puede usarla para supervisar un entorno de SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
