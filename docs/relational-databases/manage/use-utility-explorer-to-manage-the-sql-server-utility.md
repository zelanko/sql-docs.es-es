...
PowerShell no tiene ayuda F1, pero incluye un cmdlet **Obtener ayuda** que proporciona información sobre el uso de PowerShell. Para obtener más información sobre el uso de Get-Help, vea [Obtener ayuda de SQL Server PowerShell](../../powershell/sql-server-powershell.md).  
