---
title: SQLConfigDataSource | Documentos de Microsoft
ms.custom: 
ms.date: 03/16/2017
...
[!INCLUDE[SNAC_Deprecated](../../includes/snac-deprecated.md)]
  ...
  El [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] controlador ODBC Native Client admite varios [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]-pares palabra clave-valor específicos para los datos del origen de las cadenas de atributos de configuración.  
...
## <a name="see-also"></a>Vea también  
 [SQLConfigDataSource, función](http://go.microsoft.com/fwlink/?LinkId=59337)   
