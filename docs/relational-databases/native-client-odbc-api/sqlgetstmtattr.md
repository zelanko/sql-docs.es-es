...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
  ...
  El controlador ODBC de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client extiende SQLGetStmtAttr para exponer los atributos de instrucción específicos del controlador.  
...
## <a name="see-also"></a>Vea también  
   de la [función SQLSetStmtAttr](https://go.microsoft.com/fwlink/?LinkId=59370)  
