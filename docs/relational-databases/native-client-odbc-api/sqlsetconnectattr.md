...
```  
 ...
 El valor predeterminado es **ReadWrite**. Para obtener más información acerca de la compatibilidad de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client con [!INCLUDE[ssHADR](../../includes/sshadr-md.md)] AG, consulte [compatibilidad de SQL Server Native Client con la alta disponibilidad y la recuperación ante desastres](../../relational-databases/native-client/features/sql-server-native-client-support-for-high-availability-disaster-recovery.md).  
...
|Value|Descripción|  
|-----------|-----------------|  
|computername|**SQLBrowseConnect** devuelve una lista de instancias de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] en el equipo especificado. No se deben usar barras diagonales inversas dobles (\\\\) para el nombre del servidor (por ejemplo, en lugar de \\\MyServer, se debe usar el servidor).|  
...
```  
 ...
 Para obtener más información acerca de la compatibilidad de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client con [!INCLUDE[ssHADR](../../includes/sshadr-md.md)] AG, consulte [compatibilidad de SQL Server Native Client con la alta disponibilidad y la recuperación ante desastres](../../relational-databases/native-client/features/sql-server-native-client-support-for-high-availability-disaster-recovery.md).  
...
## <a name="sql_copt_ss_oldpwd"></a>SQL_COPT_SS_OLDPWD  
 ...
 Para obtener más información, vea [cambiar las contraseñas mediante programación](../../relational-databases/native-client/features/changing-passwords-programmatically.md).  
...
## <a name="sql_copt_ss_translate"></a>SQL_COPT_SS_TRANSLATE  
 SQL_COPT_SS_TRANSLATE hace que el controlador traduzca los caracteres entre las páginas de códigos del cliente y del servidor a medida que se intercambian datos MBCS. El atributo solo afecta a los datos almacenados en [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]columnas **Char**, **VARCHAR**y **Text** .  
...
## <a name="see-also"></a>Vea también
 ...
 [SET QUOTED_IDENTIFIER &#40;Transact-SQL&#41;](../../t-sql/statements/set-quoted-identifier-transact-sql.md)   
   de la [función SQLPrepare](https://go.microsoft.com/fwlink/?LinkId=59360)  
