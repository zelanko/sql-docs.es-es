...
```  
 ...
 Una aplicación puede utilizar el [bcp_colptr](../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-colptr.md) función siempre que sea necesario cambiar la dirección de la variable de datos originalmente especificada en el **bcp_bind** *pData* parámetro. Una aplicación puede utilizar el [bcp_collen](../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-collen.md) función siempre que sea necesario para cambiar la longitud de los datos originalmente especificada en el **bcp_bind *** cbData* parámetro.  
