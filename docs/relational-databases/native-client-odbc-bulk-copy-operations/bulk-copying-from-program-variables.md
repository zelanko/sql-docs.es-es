...
|Tipo de datos SQL de ODBC|Tipo de datos C de ODBC|bcp_bind parámetro de *tipo*|Tipo de datos de SQL Server|  
|-----------------------|----------------------|--------------------------------|--------------------------|  
