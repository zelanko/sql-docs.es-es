---
title: Asignación de un controlador de conexión ? Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "81307789"
---
# <a name="allocating-a-connection-handle"></a>Asignar un identificador de conexión
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]

  Antes de que la aplicación se pueda conectar a un origen de datos o controlador, debe asignar un identificador de conexión. Esto se hace llamando a **SQLAllocHandle** con el *HandleType* parámetro establecido en SQL_HANDLE_DBC y *InputHandle* apuntando a un identificador de entorno inicializado.  
