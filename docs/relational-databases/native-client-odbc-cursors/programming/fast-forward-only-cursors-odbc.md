...
ms.locfileid: "81298425"
---
# <a name="fast-forward-only-cursors-odbc"></a>Cursores de solo avance rápido (ODBC)
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]

  Cuando se conecta [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]a [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] una instancia de , el controlador ODBC de Native Client admite optimizaciones de rendimiento para cursores de solo avance y solo lectura. Los cursores de solo avance rápido se implementan internamente mediante el controlador y el servidor de un modo muy similar a los conjuntos de resultados predeterminados. Además de presentar un alto rendimiento, los cursores de solo avance rápido también presentan estas características:  
...
3.  Enlazar las columnas de resultados a matrices de *n* + 1 elementos (para estar seguro si *n* + 1 filas son realmente capturados).  
...
5.  Si el estado de retorno es SQL_SUCCESS, llame a **SQLFreeStmt** o **SQLCloseCursor** para cerrar el cursor. Todos los datos de las filas estarán en las variables de programa enlazadas.  
 ...
 Con estos pasos, **SQLExecDirect** o **SQLExecute** envía una solicitud de apertura de cursor con la opción de captura automática habilitada. En esa única solicitud del cliente, el servidor:  
