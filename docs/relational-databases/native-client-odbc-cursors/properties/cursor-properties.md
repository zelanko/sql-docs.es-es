---
description: Propiedades de cursor
...
-   [Nivel de aislamiento de las transacciones de cursores](../../../relational-databases/native-client-odbc-cursors/properties/cursor-transaction-isolation-level.md)  
