---
title: Propiedades de cursor | Documentos de Microsoft
ms.custom: ''
ms.date: 03/03/2017
ms.prod: sql
...
-   [Tamaño del conjunto de filas del cursor](../../../relational-databases/native-client-odbc-cursors/properties/cursor-rowset-size.md)  
...
-   [Nivel de aislamiento de transacción de cursor](../../../relational-databases/native-client-odbc-cursors/properties/cursor-transaction-isolation-level.md)  
