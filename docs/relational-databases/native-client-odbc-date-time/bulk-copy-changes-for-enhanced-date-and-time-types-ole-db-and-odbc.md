...
|tipo de almacenamiento en archivo|Tipo de datos del archivo host|Escriba sqlncli.h para usar con IBCPSession::BCPColFmt|Value|  
|-----------------------|-------------------------|-----------------------------------------------------------|-----------|  
