...
## <a name="in-this-section"></a>En esta sección  
 ...
 [Mejoradas de fecha y hora de comportamiento de tipos con anteriores versiones de SQL Server &#40; ODBC &#41;](../../relational-databases/native-client-odbc-date-time/enhanced-date-and-time-type-behavior-with-previous-sql-server-versions-odbc.md)  
