---
title: Fecha y hora en versiones SQL (ODBC)
ms.custom: ''
ms.date: 12/18/2019
ms.prod: sql
...
## <a name="down-level-client-behavior"></a>Comportamiento del cliente de nivel inferior  
 ...
 Metadatos de instrucción devueltos por SQLDescribeCol, SQLDescribeParam, SQGetDescField y SQLColAttribute devolverán metadatos que son coherentes con el tipo de nivel inferior en todos los aspectos, incluido el nombre de tipo. Un ejemplo de este tipo de nivel inferior es **nvarchar**.  
...
|--------------------------|----------------------------------------------|----------------------|------------------------------------|---------------------------------------|  
|Datetime|Date|SQL_C_TYPE_DATE|Aceptar|OK (1)|  
...
||Time(0)|SQL_C_TYPE_TIME|Aceptar|OK (1)|  
|||SQL_C_TYPE_TIMESTAMP|Los campos de fecha se establecen en la fecha actual.|OK (2)<br /><br /> Fecha omitida. Falla si las fracciones de segundo no son cero. Funciona con [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)].|  
||Time(7)|SQL_C_TIME|Falla: literal de tiempo no válido.|OK (1)|  
|||SQL_C_TYPE_TIMESTAMP|Falla: literal de tiempo no válido.|OK (1)|  
||Fecha y hora2(3)|SQL_C_TYPE_TIMESTAMP|Aceptar|OK (1)|  
||Fecha y hora2(7)|SQL_C_TYPE_TIMESTAMP|Aceptar|El valor se redondeará a la fracción 1/300 de segundo por conversión del cliente.|  
