...
|Tipo de SQL Server 2005|Tipo [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] (o posterior)|Tipo de cliente ODBC|Conversión del resultado (SQL a C)|Conversión de parámetros (C a SQL)|  
|--------------------------|----------------------------------------------|----------------------|------------------------------------|---------------------------------------|  
