---
title: Manejo de errores y mensajes ? Microsoft Docs
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
 ...
 La [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] API nativa original, DB-Library for C, permite a una aplicación instalar funciones de control de errores y de mensajes de devolución de llamada que devuelven errores o mensajes. Algunas instrucciones [!INCLUDE[tsql](../../includes/tsql-md.md)], como PRINT, RAISERROR, DBCC y SET, devuelven sus resultados a la función de controlador de mensajes DB-Library en lugar de a un conjunto de resultados. Sin embargo, la API de ODBC no tiene ninguna capacidad de devolución de llamada semejante. Cuando [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] el controlador ODBC de Native [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Client detecta los mensajes procedentes de , establece el código de retorno ODBC en SQL_SUCCESS_WITH_INFO o SQL_ERROR y devuelve el mensaje como uno o varios registros de diagnóstico. Por lo tanto, una aplicación ODBC debe probar cuidadosamente estos códigos de retorno y llamar a **SQLGetDiagRec** para recuperar datos de mensaje.  
