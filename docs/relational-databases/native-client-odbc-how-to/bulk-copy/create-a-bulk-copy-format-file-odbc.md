...
6.  Llamar [a bcp_colfmt](../../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-colfmt.md) para cada columna para definir sus características en el archivo de datos.  
  
7.  Llame a [bcp_writefmt](../../../relational-databases/native-client-odbc-extensions-bulk-copy-functions/bcp-writefmt.md) para crear un archivo de formato que describa el archivo de datos que se va a crear mediante la operación de copia masiva.  
...
## <a name="example"></a>Ejemplo  
 ...
 Ejecute la [!INCLUDE[tsql](../../../includes/tsql-md.md)]primera lista de códigos ( ) para crear la tabla que usará el ejemplo.  
  
 Compile la segunda lista de código (C++) con odbc32.lib y odbcbcp.lib.  
  
 Ejecute la [!INCLUDE[tsql](../../../includes/tsql-md.md)]tercera lista de códigos ( ) para eliminar la tabla que usó el ejemplo.  
