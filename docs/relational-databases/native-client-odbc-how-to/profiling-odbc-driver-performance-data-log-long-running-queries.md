---
title: Consultas de larga ejecución de registro (ODBC) Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
5.  En el Asistente para configurar DSN de Microsoft SQL Server, vaya a la página con **Guardar consultas de larga ejecución**en el archivo de registro.  
  
6.  Seleccione **Guardar consultas de larga ejecución**en el archivo de registro. En el cuadro, coloque el nombre del archivo donde se deben registrar las consultas de ejecución prolongada. Si lo desea, haga clic en **Examinar** para examinar el sistema de archivos del registro de consultas.  
...
1.  Llame a [SQLSetConnectAttr](../../relational-databases/native-client-odbc-api/sqlsetconnectattr.md) con SQL_COPT_SS_PERF_QUERY_LOG y la ruta de acceso completa y el nombre de archivo del archivo de registro de consulta de ejecución prolongada. Por ejemplo:  
  
    ```  
    C:\\Odbcqry.log  
    ```  
  
2.  Llame a [SQLSetConnectAttr](../../relational-databases/native-client-odbc-api/sqlsetconnectattr.md) con SQL_COPT_SS_PERF_QUERY_INTERVAL y establezca en el intervalo de tiempo de espera, en milisegundos.  
