...
5.  En el Asistente para configurar DSN de Microsoft SQL Server, vaya a la página con estadísticas del controlador ODBC de registro en el archivo de **registro.**  
  
6.  Seleccione **Registrar estadísticas del controlador ODBC**en el archivo de registro . En el cuadro, incluya el nombre del archivo donde se deben registrar las estadísticas. Si lo desea, haga clic en **Examinar** para buscar el registro de estadísticas en el sistema de archivos.  
...
3.  Opcionalmente, llame a [SQLSetConnectAttr](../../relational-databases/native-client-odbc-api/sqlsetconnectattr.md) con SQL_COPT_SS_LOG_NOW y NULL para escribir un registro delimitado por tabulaciones de datos de rendimiento en el archivo de registro de datos de rendimiento. Esto se puede hacer varias veces cuando se ejecuta la aplicación.  
