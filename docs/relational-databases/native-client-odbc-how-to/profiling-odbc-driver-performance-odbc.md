---
title: Temas "Cómo..." de rendimiento de controlador ODBC (ODBC) de generación de perfiles | Documentos de Microsoft
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
-   [Registrar consultas de larga duración &#40;ODBC&#41;](../../relational-databases/native-client-odbc-how-to/profiling-odbc-driver-performance-data-log-long-running-queries.md)  
