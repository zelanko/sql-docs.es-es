---
title: Lotes de declaraciones ? Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "81297995"
---
# <a name="batches-of-statements"></a>Lotes de instrucciones
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]

  Un lote [!INCLUDE[tsql](../../../includes/tsql-md.md)] de instrucciones contiene dos o más instrucciones, separadas por un punto y coma (;), integrada en una sola cadena pasada a **SQLExecDirect** o [SQLPrepare Function](https://go.microsoft.com/fwlink/?LinkId=59360). Por ejemplo:  
...
```  
 ...
 Los lotes pueden ser más eficaces que el envío de instrucciones por separado porque el tráfico de red suele ser reducido. Use [SQLMoreResults](../../../relational-databases/native-client-odbc-api/sqlmoreresults.md) para colocarse en el siguiente conjunto de resultados cuando haya terminado con el conjunto de resultados actual.  
