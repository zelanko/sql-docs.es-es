...
|**timestamp**|Solo se puede insertar manualmente un valor NULL en una columna **timestamp** . Sin embargo, **timestamp**dado que las columnas de marca [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]de tiempo se actualizan automáticamente mediante, se sobrescribe un valor null.|  
