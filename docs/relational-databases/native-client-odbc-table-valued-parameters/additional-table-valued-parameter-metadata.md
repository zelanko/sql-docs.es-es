---
description: Metadatos de parámetros con valores de tabla adicionales
title: Metadatos de parámetros de Table-Valued adicionales | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
