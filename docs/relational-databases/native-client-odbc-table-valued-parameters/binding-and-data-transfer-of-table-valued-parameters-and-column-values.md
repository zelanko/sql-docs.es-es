...
[!INCLUDE[SNAC_Deprecated](../../includes/snac-deprecated.md)]
 ...
 Nota: para los controladores ODBC de Mac y Linux con unixODBC 2.3.1 a 2.3.4, al establecer el nombre TVP a través de SQLSetDescField con el campo de descriptor SQL_CA_SS_TYPE_NAME, unixODBC no convierte automáticamente entre ANSI y Unicode cadenas según exactos función que se llama (SQLSetDescFieldA / SQLSetDescFieldW). Es necesario siempre usar SQLBindParameter o SQLSetDescFieldW con una cadena Unicode (UTF-16) para establecer el nombre TVP.
...
|*DecimalDigits*|SQL_DESC_PRECISION o SQL_DESC_SCALE en IPD.|Sin usar. Debe ser 0.<br /><br /> Si este parámetro será no 0, SQLBindParameter se generarán retorno SQL_ERROR y un registro de diagnóstico con SQLSTATE = HY104 y el mensaje "no válido precisión o escala".|  
