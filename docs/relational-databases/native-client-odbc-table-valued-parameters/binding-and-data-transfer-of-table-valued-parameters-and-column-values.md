...
[!INCLUDE[SNAC_Deprecated](../../includes/snac-deprecated.md)]
 ...
 Nota: para los controladores ODBC de Mac y Linux con unixODBC 2.3.1 a 2.3.4, al establecer el nombre TVP mediante SQLSetDescField con el campo de descriptor SQL_CA_SS_TYPE_NAME, unixODBC no convierte automáticamente entre ANSI y Unicode cadenas según la exacta función llamada (SQLSetDescFieldA / SQLSetDescFieldW). Es necesario siempre usar SQLBindParameter o SQLSetDescFieldW con una cadena Unicode (UTF-16) para establecer el nombre TVP.
