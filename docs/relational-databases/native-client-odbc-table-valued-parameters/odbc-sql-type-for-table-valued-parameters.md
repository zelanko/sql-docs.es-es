---
description: Tipo SQL de ODBC para parámetros con valores de tabla
title: Tipo SQL de ODBC para parámetros de Table-Valued | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
