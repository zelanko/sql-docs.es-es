---
description: Resumen de la API de parámetros con valores de tabla de ODBC
title: Resumen de API de parámetros de Table-Valued ODBC | Microsoft Docs
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
