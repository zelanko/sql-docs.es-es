...
### <a name="a-use-row-streaming-one-row-per-call"></a>A. Usar streaming de filas, una fila por llamada
...
### <a name="b-use-row-streaming-multiple-rows-per-call"></a>B. Usar streaming de filas, varias filas por llamada  
