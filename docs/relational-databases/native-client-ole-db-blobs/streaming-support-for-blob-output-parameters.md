---
description: Compatibilidad de streaming con parámetros de salida de BLOB en SQL Server Native Client
title: Compatibilidad de streaming con parámetros de salida de BLOB (proveedor de OLE DB de Native Client)
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
ms.locfileid: "97439936"
---
# <a name="streaming-support-for-blob-output-parameters-in-sql-server-native-client"></a>Compatibilidad de streaming con parámetros de salida de BLOB en SQL Server Native Client
