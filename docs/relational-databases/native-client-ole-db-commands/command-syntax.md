---
description: Sintaxis de comandos (proveedor de OLE DB de Native Client)
...
ms.locfileid: "97439918"
---
# <a name="sql-server-native-client-command-syntax"></a>Sintaxis del comando SQL Server Native Client
