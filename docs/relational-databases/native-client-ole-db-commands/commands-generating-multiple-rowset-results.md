...
ms.locfileid: "87247051"
---
# <a name="sql-server-native-client-commands-generating-multiple-rowset-results"></a>SQL Server Native Client comandos que generan resultados de varios conjuntos de filas
