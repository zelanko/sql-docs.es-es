---
description: Preparar comandos en SQL Server Native Client
title: Preparar los comandos (proveedor de OLE DB de Native Client)
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "97439886"
---
# <a name="preparing-commands-in-sql-server-native-client"></a>Preparar comandos en SQL Server Native Client
