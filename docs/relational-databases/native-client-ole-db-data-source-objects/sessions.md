...
ms.locfileid: "81297026"
---
# <a name="sessions"></a>Sesiones
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]

  Una [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] sesión de proveedor OLE DB de Native [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Client representa una única conexión a una instancia de .  
  
 El [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] proveedor OLE DB de Native Client requiere que las sesiones delimiten el espacio de transacciones para un origen de datos. Todos los objetos de comando creados a partir de un objeto de sesión concreto participan en la transacción local o distribuida del objeto de sesión.  
 ...
 En el ejemplo siguiente se [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] muestra cómo utilizar el [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] proveedor OLE DB de Native Client para conectarse a una base de datos:  
...
```  
 ...
 La [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] conexión de objetos de sesión de proveedor OLE DB de Native Client a una instancia de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] puede generar una sobrecarga significativa para las aplicaciones que crean y liberan objetos de sesión continuamente. La sobrecarga se puede [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] minimizar administrando los objetos de sesión del proveedor OLE DB de Native Client de forma eficaz. [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Las aplicaciones de proveedor OLE [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] DB de Native Client pueden mantener activa la conexión de un objeto de sesión manteniendo una referencia en al menos una interfaz del objeto.  
