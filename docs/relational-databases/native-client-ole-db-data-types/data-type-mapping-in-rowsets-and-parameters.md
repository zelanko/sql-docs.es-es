...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]
  ...
  En los conjuntos de filas y como valores de parámetro, el proveedor de OLE DB de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client representa [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] datos utilizando los siguientes tipos de datos definidos por el OLE DB que se indican en las funciones **IColumnsInfo:: GetColumnInfo** y **ICommandWithParameters:: GetParameterInfo**.  
...
|**XML**|DBTYPE_XML|  
 ...
 El proveedor de OLE DB de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client admite conversiones de datos solicitadas por el consumidor, tal como se muestra en la ilustración.  
