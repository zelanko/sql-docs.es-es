...
ms.locfileid: "81297029"
---
# <a name="ssvariant-structure"></a>Estructura SSVARIANT
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]

  La estructura **SSVARIANT,** que se define en sqlncli.h, [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] corresponde a un valor DBTYPE_SQLVARIANT en el proveedor OLEDB de Native Client.  
...
-   VT_SS_DATE  
 ...
 Para obtener más información acerca de SSPROP_INIT_DATATYPECOMPATIBILITY, vea Uso de palabras clave de cadena de [conexión con SQL ServerSQL Server Native Client](../../relational-databases/native-client/applications/using-connection-string-keywords-with-sql-server-native-client.md).  
  
 El archivo sqlncli.h contiene macros de acceso de variantes que simplifican la desreferenciación de los tipos de miembro en la estructura **SSVARIANT.** Un ejemplo sería V_SS_DATETIMEOFFSET, que puede utilizarse tal y como se indica a continuación:  
...
|sShortIntVal|DBTYPE_I2|**Corto**|**VT_SS_I2**|Admite el tipo de datos **smallint.** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|  
|lIntVal|DBTYPE_I4|**Largo**|**VT_SS_I4**|Admite el tipo de datos **int.** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|  
...
|fltRealVal|DBTYPE_R4|**Flotador**|**VT_SS_R4**|Admite el tipo de datos **real.** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|  
...
|fBitVal|DBTYPE_BOOL|**VARIANT_BOOL**|**VT_SS_BIT**|Admite el tipo de datos **de bits.** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|  
...
|numNumericVal|DBTYPE_NUMERIC|**DB_NUMERIC**|**VT_SS_NUMERIC**|Admite el tipo de datos **numéricos.** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|  
|dDateVal|DBTYPE_DATE|**DBDATE**|**VT_SS_DATE**|Admite el tipo de datos **de fecha.** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|  
...
|Time2Val|DBTYPE_DBTIME2|**DBTIME2**|**VT_SS_TIME2**|Admite el tipo de datos **de tiempo.** [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]<br /><br /> Incluye los miembros siguientes:<br /><br /> *tTime2Val* (**DBTIME2**)<br /><br /> *bScale* (**BYTE**) Especifica la escala del valor *tTime2Val*.|  
