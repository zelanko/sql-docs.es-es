...
## <a name="down-level-client-behavior"></a>Comportamiento del cliente de nivel inferior  
 ...
 Cuando una aplicación cliente de nivel inferior se ejecuta en un servidor [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] (o posterior) en el que se han realizado cambios de esquema en los tipos de fecha y hora, el comportamiento esperado es el siguiente:  
...
|------------------------|--------------------------|---------------------------------------|--------------------------------------------|-----------------------------------------------|  
|DBTYPE_DBDATE|Fecha y hora|Fecha|Aceptar|Aceptar|  
...
|Fecha y hora|DBTYPE_DBTIMESTAMP|16|23|3|  
...
|Fecha y hora|DBTYPE_DBTIMESTAMP|NULL|NULL|3|  
...
|Fecha y hora|DBTYPE_DBTIMESTAMP|NULL|NULL|Fecha y hora|  
...
|Tipo -><br /><br /> Columna|date|time|smalldatetime|Fecha y hora|datetime2|datetimeoffset|  
|--------------------------|----------|----------|-------------------|--------------|---------------|--------------------|  
|TYPE_NAME|date|time|smalldatetime|Fecha y hora|datetime2|datetimeoffset|  
...
|LOCAL_TYPE_NAME|date|time|smalldatetime|Fecha y hora|datetime2|datetimeoffset|  
...
## <a name="down-level-server-behavior"></a>Comportamiento de un servidor de nivel inferior  
 Cuando se conecta a un servidor de una versión anterior a [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)], cualquier intento de usar los nombres de tipo de servidor nuevos (por ejemplo, con ICommandWithParameters:: SetParameterInfo o ITableDefinition:: CreateTable) producirá DB_E_BADTYPENAME.  
