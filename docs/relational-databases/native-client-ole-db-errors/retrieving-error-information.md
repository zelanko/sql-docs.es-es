---
description: Recuperando información de error (proveedor de OLE DB de Native Client)
title: Recuperando información de error (proveedor de OLE DB de Native Client)
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "88475825"
---
# <a name="retrieving-error-information-native-client-ole-db-provider"></a>Recuperando información de error (proveedor de OLE DB de Native Client)
