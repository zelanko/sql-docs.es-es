...
ms.locfileid: "73769721"
---
# <a name="retrieving-error-information"></a>Recuperar información sobre errores
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]

  En este ejemplo se obtiene información de las diversas interfaces de error expuestas por el proveedor de OLE DB de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client.  
