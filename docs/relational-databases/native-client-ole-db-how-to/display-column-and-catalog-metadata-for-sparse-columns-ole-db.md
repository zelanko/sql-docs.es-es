---
description: SQL Server Native Client Mostrar metadatos de columna y de catálogo para columnas dispersas (OLE DB)
...
ms.locfileid: "88486747"
---
# <a name="sql-server-native-client-display-column-and-catalog-metadata-for-sparse-columns-ole-db"></a>SQL Server Native Client Mostrar metadatos de columna y de catálogo para columnas dispersas (OLE DB)
