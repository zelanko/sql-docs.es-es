---
description: Enumerar SQL Server Native Client OLE DB orígenes de datos (OLE DB)
title: Enumerar orígenes de datos de OLE DB (proveedor de OLE DB de Native Client) | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
