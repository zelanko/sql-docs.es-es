---
description: Recuperación de datos de una columna FILESTREAM mediante ISequentialStream en SQL Server Native Client (OLE DB)
title: FILESTREAM mediante ISequentialStream (OLE DB)
ms.custom: ''
ms.date: 03/07/2017
ms.prod: sql
...
ms.locfileid: "97469406"
---
# <a name="retrieve-data-from-a-filestream-column-using-isequentialstream-in-sql-server-native-client-ole-db"></a>Recuperación de datos de una columna FILESTREAM mediante ISequentialStream en SQL Server Native Client (OLE DB)
