---
description: Recuperar filas mediante marcadores (proveedor de OLE DB de Native Client)
title: Recuperar filas mediante marcadores (proveedor de OLE DB de Native Client)
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
