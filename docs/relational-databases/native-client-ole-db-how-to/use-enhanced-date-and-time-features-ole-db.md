---
description: Usar las características mejoradas de fecha y hora en SQL Server Native Client (OLE DB)
title: Usar las características mejoradas de fecha y hora (proveedor de OLE DB de Native Client)
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
