---
description: Usar parámetros de Table-Valued en SQL Server Native Client (OLE DB)
...
ms.locfileid: "97419824"
---
# <a name="use-table-valued-parameters-in-sql-server-native-client-ole-db"></a>Usar parámetros de Table-Valued en SQL Server Native Client (OLE DB)
