...
## <a name="return-code-values"></a>Valores de código de retorno  
 ...
 E_FAIL  
 Se ha producido un error específico del proveedor; para obtener más información, use la interfaz [ISQLServerErrorInfo](../../connect/oledb/ole-db-interfaces/isqlservererrorinfo-geterrorinfo-ole-db.md?view=sql-server-ver15).  
