---
description: 'IBCPSession:: BCPDone (proveedor de OLE DB de Native Client)'
title: 'IBCPSession:: BCPDone (proveedor de OLE DB de Native Client) | Microsoft Docs'
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "88448412"
---
# <a name="ibcpsessionbcpdone-native-client-ole-db-provider"></a>IBCPSession:: BCPDone (proveedor de OLE DB de Native Client)
