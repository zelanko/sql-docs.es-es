---
description: 'IBCPSession2:: BCPSetBulkMode (proveedor de OLE DB de Native Client)'
title: 'IBCPSession2:: BCPSetBulkMode (proveedor de OLE DB de Native Client) | Microsoft Docs'
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
...
ms.locfileid: "97460358"
---
# <a name="ibcpsession2bcpsetbulkmode-native-client-ole-db-provider"></a>IBCPSession2:: BCPSetBulkMode (proveedor de OLE DB de Native Client)
