---
title: IBCPSession2 (proveedor de OLE DB de Native Client) | Microsoft Docs
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
...
ms.locfileid: "87247714"
---
# <a name="ibcpsession2-native-client-ole-db-provider"></a>IBCPSession2 (proveedor de OLE DB de Native Client)
