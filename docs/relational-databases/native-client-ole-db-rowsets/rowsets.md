---
title: Conjuntos de filas (proveedor de OLE DB de Native Client)
...
ms.locfileid: "97476076"
---
# <a name="rowsets-native-client-ole-db-provider"></a>Conjuntos de filas (proveedor de OLE DB de Native Client)
