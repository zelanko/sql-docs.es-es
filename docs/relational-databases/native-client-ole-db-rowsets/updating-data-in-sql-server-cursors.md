---
description: Actualizar datos en SQL Server cursores en SQL Server Native Client
title: Actualizar datos en cursores (proveedor de OLE DB de Native Client)
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "97476036"
---
# <a name="updating-data-in-sql-server-cursors-in-sql-server-native-client"></a>Actualizar datos en SQL Server cursores en SQL Server Native Client
