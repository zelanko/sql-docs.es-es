---
title: Actualizar datos en SQL Server cursores | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "73788790"
---
# <a name="updating-data-in-sql-server-cursors"></a>Actualizar datos en cursores de SQL Server
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)]

  Al capturar y actualizar los datos a través de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] cursores, una aplicación de consumidor de proveedor de OLE DB de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client está limitada por las mismas consideraciones y restricciones que se aplican a cualquier otra aplicación cliente.  
...
## <a name="immediate-and-delayed-update-modes"></a>Modos de actualización inmediata y retrasada  
 ...
 Cuando se usa **IRowsetUpdate:: Update**, el proveedor [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client OLE DB intenta procesar cada fila indicada. Se produce un error debido a que los valores de estado, longitud o datos no válidos de una fila no se detienen [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] procesamiento de proveedor de OLE DB de cliente nativo. Se pueden modificar todas o ninguna de las demás filas que participan en la actualización. El consumidor debe examinar la matriz *prgRowStatus* devuelta para determinar si se ha producido un error en una fila específica cuando el proveedor de OLE DB de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Native Client devuelve DB_S_ERRORSOCCURRED.  
