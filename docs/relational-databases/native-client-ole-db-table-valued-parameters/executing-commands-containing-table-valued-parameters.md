---
description: Ejecutar SQL Server Native Client comandos que contienen parámetros con valores de tabla
title: Comandos con parámetros con valores de tabla
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
ms.locfileid: "88448317"
---
# <a name="executing-sql-server-native-client-commands-containing-table-valued-parameters"></a>Ejecutar SQL Server Native Client comandos que contienen parámetros con valores de tabla
