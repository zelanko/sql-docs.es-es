---
description: OLE DB compatibilidad con el tipo de parámetro con valores de tabla (proveedor de OLE DB de Native Client)
...
ms.locfileid: "88482606"
---
# <a name="ole-db-table-valued-parameter-type-support-native-client-ole-db-provider"></a>OLE DB compatibilidad con el tipo de parámetro con valores de tabla (proveedor de OLE DB de Native Client)
