---
description: Detección de tipos de parámetros con valores de tabla
title: Detección de tipos de parámetros con valores de tabla (proveedor de OLE DB de Native Client)
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
