---
description: Parámetros con valores de tabla en SQL Server Native Client (OLE DB)
...
ms.locfileid: "88499050"
---
# <a name="table-valued-parameters--in-sql-server-native-client-ole-db"></a>Parámetros con valores de tabla en SQL Server Native Client (OLE DB)
