...
|-----------------|-----------------|  
|SSPROP_COL_COLLATIONNAME|Escriba:  VT_BSTR<br /><br /> R/W: Escritura<br /><br /> Predeterminado: Null<br /><br /> Descripción: Esta propiedad solo se utiliza en **ITableDefinition**. La cadena especificada en esta propiedad se usa al crear una instrucción [CREATE TABLE](../../t-sql/statements/create-table-transact-sql.md).<br /><br /> .|  
