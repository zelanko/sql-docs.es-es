---
title: Native Client, compilar aplicaciones SQL
ms.custom: ''
ms.date: 12/16/2019
ms.prod: sql
ms.reviewer: ''
...
## <a name="in-this-section"></a>En esta sección  
 ...
 [Uso de los archivos de encabezado y biblioteca de SQL Server Native Client](../../../relational-databases/native-client/applications/using-the-sql-server-native-client-header-and-library-files.md)  
 ...
 [Actualización de una aplicación a SQL Server Native Client desde MDAC](../../../relational-databases/native-client/applications/updating-an-application-to-sql-server-native-client-from-mdac.md)  
