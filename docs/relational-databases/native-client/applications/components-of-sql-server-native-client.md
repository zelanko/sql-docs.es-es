...
|sqlncli11.lib|El archivo de biblioteca necesario para llamar directamente a las funciones de la utilidad **BCP** que forman parte del controlador ODBC de [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client.<br /><br /> Nota: Si hace referencia al archivo sqlncli11. lib en el código de programación, tiene que asegurarse de que el archivo sqlncli11. dll se encuentra en la ruta de acceso del sistema y en la ruta de acceso del sistema de los usuarios que usan su aplicación.|  
