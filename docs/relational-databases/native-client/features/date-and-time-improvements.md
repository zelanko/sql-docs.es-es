---
description: SQL Server Native Client mejoras de fecha y hora
...
ms.locfileid: "97463396"
---
# <a name="sql-server-native-client-date-and-time-improvements"></a>SQL Server Native Client mejoras de fecha y hora
