---
description: Detección de metadatos en SQL Server Native Client
...
ms.locfileid: "88498923"
---
# <a name="metadata-discovery-in-sql-server-native-client"></a>Detección de metadatos en SQL Server Native Client
