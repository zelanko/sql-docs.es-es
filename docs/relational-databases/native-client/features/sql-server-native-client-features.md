---
title: Características de SQL ServerSQL Server Native Client ( SQL Server Native Client Features) Microsoft Docs
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
ms.reviewer: ''
...
## <a name="in-this-section"></a>En esta sección  
 ...
 Describe cómo [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client admite el uso de bases de datos reflejadas, que [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] es la capacidad de mantener una copia o reflejo de una base de datos en un servidor en espera.  
 ...
 Describe cómo [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client admite tipos definidos por el usuario (UDT), que amplía el sistema [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] de tipos SQL al permitirle almacenar objetos y estructuras de datos personalizadas en una base de datos.  
 ...
 Describe cómo [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client admite operaciones de copia masiva que permiten la [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] transferencia de grandes cantidades de datos dentro o fuera de una tabla o vista.  
 ...
 Describe [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] la compatibilidad de Native Client con la característica FILESTREAM mejorada.  
...
## <a name="see-also"></a>Consulte también  
 ...
 [Temas de cómo hacerlo de OLE DB](../../../relational-databases/native-client-ole-db-how-to/ole-db-how-to-topics.md)   
