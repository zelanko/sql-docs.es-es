...
ms.locfileid: "97461986"
---
# <a name="using-multiple-active-result-sets-mars-in-sql-server-native-client"></a>Usar conjuntos de resultados activos múltiples (MARS) en SQL Server Native Client
