...
> [!NOTE]  
>  El proveedor de [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client OLE DB no incluye un lector SAX, pero se **puede pasar** con facilidad a objetos Sax y Dom en MSXML.  
...
#### <a name="the-icolumnsrowset-interface"></a>La interfaz IColumnsRowset  
 [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client agrega las siguientes columnas específicas del [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]al conjunto de filas devuelto por el método **IColumnRowset:: GetColumnsRowset** . Estas columnas contienen el nombre de tres partes de una colección de esquemas XML. Para las columnas que no son XML o las columnas XML sin tipo, las tres columnas toman el valor predeterminado NULL.  
...
## <a name="sql-server-native-client-odbc-driver"></a>Controlador ODBC de SQL Server Native Client  
 En el controlador ODBC de [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client, se han realizado varios cambios en varias funciones para admitir el tipo de datos **XML** .  
...
### <a name="sqlcolattribute"></a>SQLColAttribute  
 ...
 El controlador ODBC de [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client SQL_SS_LENGTH_UNLIMITED para las columnas SQL_DESC_DISPLAY_SIZE y SQL_DESC_LENGTH.  
...
### <a name="sqlcolumns"></a>SQLColumns  
 ...
 El controlador ODBC de [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client SQL_SS_LENGTH_UNLIMITED para los valores COLUMN_SIZE y CHAR_OCTET_LENGTH.  
  
### <a name="sqldescribecol"></a>SQLDescribeCol  
 El controlador ODBC de [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client SQL_SS_LENGTH_UNLIMITED cuando no se puede determinar el tamaño de columna en la función [SQLDescribeCol](../../../relational-databases/native-client-odbc-api/sqldescribecol.md) .  
  
### <a name="sqlgettypeinfo"></a>SQLGetTypeInfo  
 El controlador ODBC de [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client notifica SQL_SS_LENGTH_UNLIMITED como COLUMN_SIZE máximo para el tipo de datos **XML** en la función [SQLGetTypeInfo](../../../relational-databases/native-client-odbc-api/sqlgettypeinfo.md) .  
...
### <a name="sqlprocedurecolumns"></a>SQLProcedureColumns  
 ...
 El controlador ODBC de [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] Native Client notifica SQL_SS_LENGTH_UNLIMITED como COLUMN_SIZE máximo del tipo de datos **XML** .  
