...
## <a name="data-source-properties"></a>Propiedades de origen de datos  
 Las siguientes propiedades del conjunto de propiedades **DBPROPSET_SQLSERVERDATASOURCEINFO** permiten a las aplicaciones detectar el método de autenticación.  
