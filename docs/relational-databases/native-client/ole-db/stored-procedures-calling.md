---
description: 'Procedimientos almacenados: llamar a en SQL Server Native Client'
...
ms.locfileid: "97463316"
---
# <a name="stored-procedures---calling-in-sql-server-native-client"></a>Procedimientos almacenados: llamar a en SQL Server Native Client
