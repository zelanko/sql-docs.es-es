...
description: Puede usar el Monitor del sistema para crear una alerta de base de datos de SQL Server que se activará al alcanzar un valor de umbral de un contador del Monitor del sistema.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
