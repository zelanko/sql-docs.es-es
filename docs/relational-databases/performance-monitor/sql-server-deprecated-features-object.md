...
description: Obtenga información sobre el objeto SQLServer:Deprecated Features, que proporciona un contador para supervisar las características designadas como en desuso.
ms.custom: ''
ms.date: 05/03/2016
ms.prod: sql
