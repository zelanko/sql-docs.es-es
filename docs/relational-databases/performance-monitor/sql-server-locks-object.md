...
description: Obtenga información sobre el objeto SQLServer:Locks, que proporciona información acerca de los bloqueos de SQL Server en tipos de recursos individuales.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
