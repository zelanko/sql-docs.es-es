...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] El objeto de rendimiento **SQLServer:LogPool FreePool** proporciona contadores de estadísticas para el grupo libre dentro del grupo de registros.

En la siguiente tabla se describen los objetos de rendimiento **LogPool FreePool** de SQL Server.

|**Contadores de LogPool FreePool de SQL Server**|Description|  
|-------------|-----------------|  
