...
ms.topic: "article"
helpviewer_keywords: 
  - "rendimiento del servidor [SQL Server], objetos para supervisión"
  - "supervisión de base de datos [SQL Server], objetos para supervisión"
  - "gráficos [SQL Server]"
  - "Monitor de sistema [SQL Server], contadores"
  - "contadores [SQL Server], enumerados"
  - "objetos [SQL Server], supervisión de rendimiento"
  - "objetos [SQL Server], Monitor de sistema de Windows"
  - "contadores de rendimiento [SQL Server], sobre los contadores de rendimiento"
  - "Monitor de sistema [SQL Server], objetos"
  - "contadores de rendimiento [SQL Server]"
  - "contadores [SQL Server], sobre los contadores de rendimiento"
  - "ajuste de base de datos [SQL Server], objetos para supervisión"
  - "rendimiento de la base de datos [SQL Server], objetos para supervisión"
  - "SQL Server, objetos"
  - "supervisar rendimiento [SQL Server], objetos para supervisión"
  - "Monitor de sistema de Windows [SQL Server], objetos"
  - "Monitor de sistema de Windows [SQL Server], contadores"
  - "contadores [SQL Server]"
  - "contadores de rendimiento [SQL Server], enumerados"
