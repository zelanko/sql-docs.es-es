...
description: Obtenga información sobre cómo crear una guía de plan mediante SQL Server Management Studio o Transact-SQL. Una guía de plan aplica un plan de consulta fijo, así como sugerencias de consultas, a una consulta.
ms.custom: ''
ms.date: 08/02/2016
ms.prod: sql
ms.reviewer: ''
...
##  <a name="create-a-plan-guide-using-ssms"></a><a name="SSMSProcedure"></a> Creación de una guía de plan mediante SSMS  
...
##  <a name="create-a-plan-guide-using-t-sql"></a><a name="TsqlProcedure"></a> Crear una guía de plan mediante T-SQL  
