...
helpviewer_keywords: 
  ...
  - "presentación del plan de ejecución, personalizar [SQL Server]"
  - "presentación del plan de ejecución, modificar"
  - "zoom personalizado [SQL Server]"
...
### Para mostrar el plan de ejecución estimado de una consulta  
