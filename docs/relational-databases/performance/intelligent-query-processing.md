...
Puede habilitar la compilación diferida de variables de tabla en Azure SQL Database. Para ello, habilite el nivel de compatibilidad 150 para la base de datos a la que se conecta al ejecutar la consulta.
