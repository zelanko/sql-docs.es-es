...
ms.topic: "article"
helpviewer_keywords: 
  - "instancias de SQL Server, supervisar el rendimiento"
  - "supervisar el rendimiento del servidor [SQL Server]"
  - "Motor de base de datos [SQL Server], rendimiento"
  - "supervisar el rendimiento [SQL Server], sobre el rendimiento"
  - "rendimiento de servidor [SQL Server]"
  - "supervisar el rendimiento [SQL Server]"
  - "rendimiento de la base de datos [SQL Server], sobre el rendimiento"
  - "ajustar bases de datos [SQL Server], sobre el rendimiento"
  - "información de estado [SQL Server], supervisión del rendimiento"
  - "supervisión de bases de datos [SQL Server], sobre el rendimiento"
  - "supervisar [SQL Server], rendimiento de consultas"
  - "rendimiento del servidor [SQL Server], sobre el rendimiento"
  - "optimizar bases de datos [SQL Server]"
  - "rendimiento de base de datos [SQL Server]"
  - "supervisar [SQL Server], rendimiento del servidor"
  - "supervisión de base de datos [SQL Server]"
  - "supervisar el rendimiento del servidor [SQL Server], sobre la supervisión del rendimiento del servidor"
