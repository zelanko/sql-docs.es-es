...
description: Obtenga más información sobre el panel de rendimiento de SQL Server Management Studio, que proporciona información rápida sobre SQL Server e Instancia administrada de Azure SQL Database.
ms.custom: ''
ms.date: 12/14/2019
ms.prod: sql
ms.reviewer: ''
