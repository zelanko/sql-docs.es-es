...
ms.topic: "article"
helpviewer_keywords: 
  - "herramientas [SQL Server], supervisar el rendimiento"
  - "supervisar el rendimiento del servidor [SQL Server], herramientas"
  - "supervisar el rendimiento [SQL Server], herramientas"
  - "rendimiento de base de datos [SQL Server], herramientas"
  - "optimizar bases de datos [SQL Server], herramientas"
  - "supervisión de base de datos [SQL Server], herramientas"
  - "rendimiento [SQL Server], herramientas de supervisión"
  - "rendimiento del servidor [SQL Server], herramientas"
