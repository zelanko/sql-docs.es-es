...
description: Obtenga información sobre el Asistente para la optimización de motor de base de datos y cómo se basa en el optimizador de consultas para analizar una carga de trabajo y realizar recomendaciones de optimización en SQL Server.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
