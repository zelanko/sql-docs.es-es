...
description: Obtenga información sobre cómo guardar un grafo de interbloqueo con SQL Server Profiler. Los gráficos de interbloqueo se guardan como archivos XML.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
ms.reviewer: ''
