...
description: Compruebe si la opción AUTO_ CLOSE está establecida en OFF. La opción AUTO_ CLOSE tiene implicaciones en el rendimiento de SQL Server.
ms.custom: ''
ms.date: 03/04/2017
ms.prod: sql
