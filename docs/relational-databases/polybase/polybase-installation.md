...
## Instalación con el Asistente para instalación  
...
|Servicio de movimiento de datos de SQL Server PolyBase|**Opcional**<br /><br /> /PBDMSSVCACCOUNT|Especifica la cuenta del servicio de movimiento de datos. El valor predeterminado es **NT Authority\NETWORK SERVICE**.|  
...
#### Para habilitar las reglas de firewall, siga estos pasos:  
