...
# [Conceptos para desarrolladores](concepts/index.md)
...
#### [Agregar o editar filtro](add-or-edit-filter.md)  
...
## [Lección 2: Creación de una suscripción a la publicación transaccional](lesson-2-creating-a-subscription-to-the-transactional-publication.md)  
