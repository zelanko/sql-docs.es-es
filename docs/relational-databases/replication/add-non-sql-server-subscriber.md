...
---
# Agregar suscriptor que no sea de SQL Server
 ...
 **Tipo de suscriptor que se agregará**  
 Seleccione un suscriptor de Oracle o IBM DB2. Para obtener más información sobre la compatibilidad para estos suscriptores, consulte [suscriptores no SQL Server](../../relational-databases/replication/non-sql/non-sql-server-subscribers.md).  
...
> [!NOTE]  
>  La cadena de conexión y el nombre del origen de datos no se validan por [!INCLUDE[msCoName](../../includes/msconame-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] hasta que el agente de distribución intenta inicializar la suscripción.  
