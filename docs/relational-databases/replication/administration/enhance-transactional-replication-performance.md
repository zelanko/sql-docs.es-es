...
helpviewer_keywords: 
  ...
  - "rendimiento [replicación de SQL Server], replicación transaccional"
  - "diseño de bases de datos [SQL Server], rendimiento de la replicación"
  - "rendimiento [replicación de SQL Server], replicación de instantáneas"
  - "replicación de instantáneas [SQL Server], rendimiento"
  - "suscripciones [replicación de SQL Server], consideraciones de rendimiento"
  - "agentes [replicación de SQL Server], rendimiento"
  - "Agente de distribución, rendimiento"
  - "replicación transaccional, rendimiento"
  - "Agente de registro del LOG, rendimiento"
...
-   Configure el distribuidor en un servidor dedicado.  
     ...
     Puede reducir la carga de procesamiento en el publicador configurando un distribuidor remoto. Para obtener más información, consulte [Configurar distribución](../../../relational-databases/replication/configure-distribution.md).  
...
-   Reparta los artículos entre varias publicaciones.  
     ...
     Si no puede utilizar el **SubscriptionStreams -** parámetro (descrita más adelante en este tema), considere la posibilidad de crear varias publicaciones. Repartir artículos entre dichas publicaciones permite que la replicación aplique en paralelo los cambios a los suscriptores.  
...
-   Ejecute los agentes continuamente en lugar de utilizar programaciones muy frecuentes.  
    ...
    -   [! INCLUIR [ssManStudioFull] (.. / Token/ssManStudioFull_md.md)]: [Specify Synchronization Schedules](../../../relational-databases/replication/specify-synchronization-schedules.md)  
  
## Parámetros del Agente de distribución y del Agente de registro del LOG  
  
-   Para resolver los cuellos de botella accidentales, una sola vez, use la **– MaxCmdsInTran** parámetro para el agente de lector del registro.  
...
-   Use el parámetro **–SubscriptionStreams** en el Agente de distribución.  
     ...
     Se puede especificar un valor para este parámetro de agente con el **@subscriptionstreams** de [sp_addsubscription & #40; Transact-SQL & #41;](../../../relational-databases/system-stored-procedures/sp-addsubscription-transact-sql.md).  
  
-   Aumente el valor de la **- ReadBatchSize** parámetro para el agente de lector del registro.  
  
     El Agente de registro del LOG y el Agente de distribución aceptan tamaños de lotes en las operaciones de lectura y confirmación de transacciones. Los lotes contienen, de forma predeterminada, 500 transacciones. El Agente de lectura del LOG lee el número de transacciones especificado en el registro, estén o no marcadas para la replicación. Cuando se escribe un gran número de transacciones en una base de datos de publicación, pero sólo un pequeño subconjunto de ellas están marcados para la replicación, debe utilizar el **- ReadBatchSize** parámetro para aumentar el tamaño del lote leído del agente de lector de registro. Este parámetro no se aplica a los publicadores de Oracle.  
  
-   Aumente el valor de la **- CommitBatchSize** parámetro para el agente de distribución.  
