...
helpviewer_keywords: 
  ...
  - "agentes [replicación de SQL Server]"
  - "Agente de lectura de cola, acerca del Agente de lectura de cola"
  - "Agente de lectura de cola"
  - "Agente de mezcla, acerca del Agente de mezcla"
  - "Agente de registro del LOG, acerca de Agente de registro del LOG"
  - "replicación [SQL Server], agentes y perfiles"
  - "Agente de registro del LOG"
  - "Agente de distribución, acerca del Agente de Distribución"
  - "agentes [replicación de SQL Server], acerca de agentes"
  - "Agente de mezcla"
  - "Agente de instantáneas, acerca del Agente de instantáneas"
...
## Trabajos de mantenimiento de replicación  
 La replicación incluye varios trabajos de mantenimiento que realizan operaciones de mantenimiento programadas y a petición. Para obtener más información, consulte [administración del agente de replicación](../../../relational-databases/replication/agents/replication-agent-administration.md).  
