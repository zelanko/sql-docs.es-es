...
ms.topic: "article"
helpviewer_keywords: 
  - "agentes [replicación de SQL Server], agente de lectura de cola"
  - "símbolo del sistema [replicación de SQL Server]"
  - "Agente de lectura de cola, referencia de parámetro"
  - "Agente de lectura de cola, ejecutables"
