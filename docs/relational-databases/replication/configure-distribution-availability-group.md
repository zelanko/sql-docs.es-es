...
En SQL Server 2017 CU 6 se introduce la compatibilidad con la base de datos de distribución de replicación en un AG mediante los siguientes mecanismos:
