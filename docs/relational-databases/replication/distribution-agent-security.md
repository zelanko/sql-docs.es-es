...
helpviewer_keywords: 
  - "Seguridad del Agente de distribución, cuadro de diálogo"
...
-   Si el cuadro de diálogo se tiene acceso desde el **Propiedades de suscripción** cuadro de diálogo, especifique el contexto en el que el agente de distribución realiza conexiones haciendo clic en el botón de propiedades (**...**) en el **conexión de suscriptor** o **conexión del distribuidor** fila de ese cuadro de diálogo. Para obtener más información acerca del acceso a la **Propiedades de suscripción** cuadro de diálogo, vea [Ver y modificar propiedades de suscripción de inserción](../../relational-databases/replication/view-and-modify-push-subscription-properties.md) y cómo: [Ver y modificar propiedades de suscripción de extracción](../../relational-databases/replication/view-and-modify-pull-subscription-properties.md).  
 ...
 **Conectar al distribuidor**  
 Para las suscripciones de inserción, siempre se realizan las conexiones al distribuidor suplantando la cuenta especificada en la **cuenta de proceso** cuadro de texto.  
