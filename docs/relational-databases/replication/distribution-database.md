...
description: En SQL Server, en la base de datos de distribución se almacenan metadatos y datos del historial de todos los tipos de replicación, y transacciones de replicación transaccional.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
