...
## Opciones  
 **' \< nombreDeServidor>' actuará como su propio distribuidor; SQL Server creará una base de datos de distribución y registro**  
 ...
 **Agregar**  
 Si el servidor que desea utilizar como distribuidor no aparece, haga clic en **Agregar** para identificar el servidor y agregarlo a la lista.  
