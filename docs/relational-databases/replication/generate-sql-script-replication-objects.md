...
helpviewer_keywords: 
  - "Generar script SQL, cuadro de diálogo"
...
---
# Generar script SQL (Objetos de replicaci&#243;n)
...
## Opciones de Generar script SQL  
...
## Generar Script SQL \< nombreDeObjeto> Opciones  
 **Para crear o habilitar componentes** y **para quitar o deshabilitar los componentes**  
 Especifique si desea que el script incluya comandos para crear o quitar un objeto de replicación. [!INCLUDE[msCoName](../../includes/msconame-md.md)] le recomienda utilizar el cuadro de diálogo para crear un conjunto de scripts para habilitar y deshabilitar componentes.  
  
 **Trabajos de replicación**  
 Esta opción sólo está disponible desde el **Generar Script SQL** cuadro de diálogo.  
