...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Esta sección incluye información sobre el Visor de conflictos de replicación para replicación de mezcla y replicación transaccional, e información sobre el Solucionador interactivo para la replicación de mezcla:  
...
-   [Solucionador interactivo de conflictos de replicación de Microsoft](../../relational-databases/replication/microsoft-replication-interactive-conflict-resolver.md)  
