---
title: "Supervisar la replicaci&#243;n con el Monitor de sistema | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "supervisar rendimiento [replicación de SQL Server], Monitor de sistema"
  - "Monitor de sistema [SQL Server], replicación"
  - "contadores de rendimiento [replicación de SQL Server]"
...
---
# Supervisar la replicaci&#243;n con el Monitor de sistema
  [!INCLUDE[msCoName](../../../includes/msconame-md.md)] Monitor de sistema de Windows permite utilizar gráficos, gráficos e informes para medir la eficacia de su equipo e identificar y solucionar posibles problemas (por ejemplo, uso de recursos desequilibrado, un hardware insuficiente o diseño deficiente de programas) y planear necesidades de hardware adicionales. Para obtener más información, consulte [supervisar el uso de recursos & #40; Monitor de sistema & #41;](../../../relational-databases/performance-monitor/monitor-resource-usage-system-monitor.md).  
