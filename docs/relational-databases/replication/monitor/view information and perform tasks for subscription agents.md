---
title: "Ver informaci&#243;n y realizar tareas para los agentes asociados a una suscripci&#243;n (Monitor de replicaci&#243;n) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
manager: "jhubbard"
---
# Ver informaci&#243;n y realizar tareas para los agentes asociados a una suscripci&#243;n (Monitor de replicaci&#243;n)
...
### Para ver información y realizar tareas para los agentes asociados con una suscripción (pestaña Todas las suscripciones)  
...
2.  Haga clic en la pestaña **Todas las suscripciones** para ver información sobre todas las suscripciones. En esta pestaña, también puede realizar tareas y tener acceso a información más detallada:  
    ...
    -   Para ver información detallada sobre el agente asociado a una suscripción, haga clic en la suscripción y, a continuación, haga clic en **Ver detalles**. La información detallada incluye: historial del agente y mensajes de error, estadísticas de rendimiento de la replicación transaccional y estadísticas de sincronización de los artículos de la replicación de mezcla.  
    ...
    -   Para validar una única suscripción de mezcla, haga clic en la suscripción y, a continuación, haga clic en **Validar suscripción**. Para validar todas las suscripciones a una publicación de mezcla, haga clic en la publicación y, a continuación, haga clic en **Validar todas las suscripciones**; para validar todas las suscripciones para una publicación transaccional, haga clic en la publicación y, a continuación, haga clic en **Validar suscripciones**.  
...
### Para ver información y realizar tareas para los agentes asociados con una suscripción (pestaña Lista de supervisión de suscripciones)  
