---
title: Consideraciones y limitaciones (publicadores de Oracle)
description: Describe las consideraciones de diseño y las limitaciones al configurar un suscriptor de SQL Server con un publicador de Oracle.
