...
ms.topic: "article"
helpviewer_keywords: 
  - "publicar [replicación de SQL Server], publicación de Oracle"
  - "replicación de instantáneas [SQL Server], publicación de Oracle"
  - "publicación de Oracle [replicación de SQL Server]"
  - "replicación transaccional, publicación de Oracle"
  - "publicación de Oracle [replicación de SQL Server], acerca de la publicación de Oracle"
