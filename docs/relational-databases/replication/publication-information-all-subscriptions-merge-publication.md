---
title: 'Todas las suscripciones (combinación: SSMS)'
description: Describe la pestaña "Todas las suscripciones" de la publicación de combinación seleccionada en SQL Server Management Studio (SSMS).
