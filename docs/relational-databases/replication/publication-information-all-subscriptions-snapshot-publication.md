---
title: 'Todas las suscripciones (instantánea: SSMS)'
description: Describe la pestaña "Todas las suscripciones" de una publicación de instantáneas seleccionada en SQL Server Management Studio (SSMS).
