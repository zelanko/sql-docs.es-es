...
---
# Propiedades de la publicaci&#243;n, Seguridad del agente
...
-   Agente de lectura de cola para publicaciones transaccionales que permiten suscripciones de actualización en cola Existe un Agente de lectura de cola para cada base de datos de distribución. Si se cambia la configuración del Agente de lectura de cola, esto afecta a todas las publicaciones transaccionales con suscripciones de actualización en cola que utilizan la misma base de datos de distribución. Para obtener más información acerca de la configuración de seguridad del agente de lectura de cola, consulte [Ver y modificar la configuración de seguridad de replicación](../../relational-databases/replication/security/view-and-modify-replication-security-settings.md).  
 ...
 **Configuración de seguridad** o **Crear Agente**  
 Si se ha creado un trabajo del agente, haga clic en **la configuración de seguridad** para tener acceso a un cuadro de diálogo que le permite cambiar la configuración de seguridad para un agente. Si no se ha creado el trabajo de agente, haga clic en **Crear agente** para crear uno y especifique la configuración de seguridad correspondiente.  
