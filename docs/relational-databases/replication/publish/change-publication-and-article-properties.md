---
title: "Cambiar las propiedades de la publicaci&#243;n y de los art&#237;culos | Microsoft Docs"
ms.custom: ""
ms.date: "03/17/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "modificar propiedades de los artículos"
  - "modificar propiedades de la publicación"
  - "administrar replicación, propiedades"
  - "publicaciones [replicación de SQL Server], cambiar propiedades"
...
|Habilitar o deshabilitar la compatibilidad con no[!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] los suscriptores.|**sp_changepublication**|**is_enabled_for_het_sub**|Nueva instantánea.|  
...
|Descripción|Procedimiento almacenado|Propiedades|Requisitos|  
|-----------------|----------------------|----------------|------------------|  
|Quitar un artículo|**sp_droparticle**|Todos los parámetros|Los artículos se pueden quitar antes de crear las suscripciones. Utilizando procedimientos almacenados es posible quitar una suscripción a un artículo; utilizando [!INCLUDE[ssManStudioFull](../../../includes/ssmanstudiofull-md.md)], es necesario quitar, volver a crear y sincronizar toda la suscripción. Para obtener más información, consulte [Agregar y quitar artículos de publicaciones existentes](../../../relational-databases/replication/publish/add-articles-to-and-drop-articles-from-existing-publications.md).|  
