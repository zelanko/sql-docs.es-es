...
---
# Propiedades del publicador (Publicador, General)
  El **General** página de la **Propiedades del publicador** cuadro de diálogo muestra información de solo lectura en la base de datos de distribución utilizada por el publicador. Para cambiar el distribuidor o la base de datos de distribución de un publicador:  
  
1.  Deshabilite la publicación en el publicador. Para obtener más información, consulte [Deshabilitar la publicación y distribución](../../relational-databases/replication/disable-publishing-and-distribution.md).  
