...
2.  Vuelva a configurar la publicación y la distribución. Para obtener más información, vea [Configurar la publicación y la distribución](../../relational-databases/replication/configure-publishing-and-distribution.md).  
