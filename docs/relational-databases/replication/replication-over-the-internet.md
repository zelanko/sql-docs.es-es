...
-   Una red privada virtual (VPN). Para obtener más información, vea [Publish Data over the Internet Using VPN](../../relational-databases/replication/publish-data-over-the-internet-using-vpn.md) (Publicar datos a través de Internet mediante VPN).  
