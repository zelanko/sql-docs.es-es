...
[!INCLUDE[tsql-appliesto-ss2016-asdb-xxxx-xxx_md](../../includes/tsql-appliesto-ss2016-asdb-xxxx-xxx-md.md)]
  ...
  <a name="includessnoversionincludesssnoversion-mdmd-replication-can-be-configured-to-includesssdsfullincludessssdsfull-mdmd"></a>La replicación de[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] se puede configurar para [!INCLUDE[ssSDSFull](../../includes/sssdsfull-md.md)].  
 -  
 - **Configuraciones admitidas:**  
 -  
 -- [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] puede ser una instancia de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] que se ejecute de manera local o una instancia de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] que se ejecute en una máquina virtual de Azure en la nube. Para más información, consulte [Información general sobre SQL Server en máquinas virtuales de Azure](https://azure.microsoft.com/documentation/articles/virtual-machines-sql-server-infrastructure-services/).  
 -  
 ...
 -  
 -- No se puede colocar la base de datos de distribución y los agentes de replicación en [!INCLUDE[ssSDS](../../includes/sssds-md.md)].  
 -  
 ...
 -  
 --   Copiar lenguaje de definición de esquema de XML  
 -  
 --   Copiar índices XML  
 -  
 --   Copiar permisos  
 ...
 -  
 --   Convertir tipo de secuencia de archivo a tipos de datos MAX  
 -  
