...
ms.topic: "article"
helpviewer_keywords: 
  - "instantáneas [replicación de SQL Server], seguridad"
...
## Entregar instantáneas mediante FTP  
 ...
 Para entregar instantáneas mediante FTP, vea [entregar una instantánea mediante FTP](../../../relational-databases/replication/publish/deliver-a-snapshot-through-ftp.md).  
