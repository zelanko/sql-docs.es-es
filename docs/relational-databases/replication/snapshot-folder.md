...
> [!NOTE]  
>  [!INCLUDE[msCoName](../../includes/msconame-md.md)] recomienda utilizar un recurso de red compartido como ubicación para la carpeta de instantáneas. Rutas de acceso locales (las que empiezan por una letra de unidad como C:\\) no son accesibles a los agentes en otros equipos.  
