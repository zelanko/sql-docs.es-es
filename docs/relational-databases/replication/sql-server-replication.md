...
ms.topic: "article"
helpviewer_keywords: 
  - "replicación [SQL Server], acerca de"
 ...
 **Examinar contenido por área**  
 ![Icono pequeño de carpeta de archivos](../../analysis-services/media/filefolder-small.png "Icono pequeño de carpeta de archivos") [Novedades](../../relational-databases/replication/what-s-new-replication.md)  
  
 ![Icono pequeño de carpeta de archivos](../../analysis-services/media/filefolder-small.png "Icono pequeño de carpeta de archivos") [Compatibilidad con versiones anteriores](../../relational-databases/replication/replication-backward-compatibility.md)  
  
 ![Icono pequeño de carpeta de archivos](../../analysis-services/media/filefolder-small.png "Icono pequeño de carpeta de archivos") [Características y tareas de replicación](../../relational-databases/replication/replication-features-and-tasks.md)  
  
 ![Icono pequeño de carpeta de archivos](../../analysis-services/media/filefolder-small.png "Icono pequeño de carpeta de archivos") [Referencia técnica](../../relational-databases/replication/technical-reference-replication.md)  
