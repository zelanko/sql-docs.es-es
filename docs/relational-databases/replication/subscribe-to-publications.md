...
helpviewer_keywords: 
  ...
  - "suscripciones de extracción [replicación de SQL Server]"
  - "suscripciones [replicación de SQL Server]"
  - "suscripciones de inserción [replicación de SQL Server], acerca de suscripciones de inserción."
  - "suscripción de replicación de mezcla [replicación de SQL Server]"
  - "suscripción de replicación de mezcla [replicación de SQL Server], acerca de la suscripción"
  - "publicaciones [replicación de SQL Server], suscribirse"
  - "suscripciones de inserción [replicación de SQL Server]"
  - "suscripciones de extracción [replicación de SQL Server], acerca de suscripciones de extracción"
...
## Suscriptores que no son de SQL Server  
 Oracle e IBM DB2 pueden suscribirse a publicaciones de instantáneas y transaccionales con suscripciones de inserción. Para obtener más información, consulte [suscriptores no SQL Server](../../relational-databases/replication/non-sql/non-sql-server-subscribers.md).  
