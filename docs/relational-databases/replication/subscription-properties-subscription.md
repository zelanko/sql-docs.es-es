---
title: 'Propiedades de suscripción: &lt;suscripción&gt; | Microsoft Docs'
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
...
ms.locfileid: "32963860"
---
# <a name="subscription-properties---ltsubscriptiongt"></a>Propiedades de la suscripción: &lt;suscripción&gt;
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]
  Esta sección proporciona información sobre el cuadro de diálogo **Propiedades de la suscripción** :  
  
-   [Propiedades de suscripción: suscriptor](../../relational-databases/replication/subscription-properties-subscriber.md) trata sobre las propiedades de suscripción disponibles en el suscriptor (solo suscripciones de extracción).  
