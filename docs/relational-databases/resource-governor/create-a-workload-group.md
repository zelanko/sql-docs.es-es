---
title: "Crear un grupo de cargas de trabajo | Microsoft Docs"
ms.custom: ""
ms.date: "03/17/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Regulador de recursos, creación de grupo de cargas de trabajo"
  - "grupos de cargas de trabajo [SQL Server], crear"
...
-   **Para crear un grupo de cargas de trabajo, use:** [SQL Server Management Studio](#CreRPProp), [Transact-SQL](#CreRPTSQL)  
