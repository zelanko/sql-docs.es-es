...
description: Obtenga información sobre cómo habilitar Resource Governor mediante SQL Server Management Studio o Transact-SQL. Debe tener el permiso CONTROL SERVER.
ms.custom: ''
ms.date: 03/04/2017
ms.prod: sql
ms.reviewer: ''
