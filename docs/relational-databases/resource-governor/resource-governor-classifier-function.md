...
description: El proceso de clasificación del regulador de recursos de SQL Server asigna las sesiones de entrada a un grupo de carga de trabajo según las características de la sesión.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
