...
description: En SQL Server Resource Governor, un grupo de cargas de trabajo actúa como contenedor para las solicitudes de sesión que tienen criterios de clasificación similares.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
ms.reviewer: ''
