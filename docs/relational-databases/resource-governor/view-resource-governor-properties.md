...
description: Obtenga información sobre cómo crear o configurar entidades de Resource Governor mediante la página Propiedades de Resource Governor en SQL Server Management Studio.
ms.custom: ''
ms.date: 07/18/2016
ms.prod: sql
ms.reviewer: ''
