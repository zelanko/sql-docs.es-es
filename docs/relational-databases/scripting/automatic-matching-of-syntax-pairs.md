...
ms.topic: "article"
helpviewer_keywords: 
  - "IntelliSense [SQL Server], resaltado de delimitadores"
  - "IntelliSense [SQL Server], concordancia de pares en la sintaxis"
...
---
# Coincidencia autom&#225;tica de pares en la sintaxis
...
## Coincidencia de delimitadores del Editor de consultas de Database Engine  
...
## Coincidencia de llaves del Editor de consultas XMLA de Analysis Services  
...
## Coincidencia de paréntesis de los editores MDX y DMX  
