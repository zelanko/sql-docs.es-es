...
ms.topic: "article"
helpviewer_keywords: 
  - "Editor de consultas [SQL Server Management Studio], codificación de colores"
  - "codificación de colores [Editor de consultas]"
...
## Colores predeterminados para el código  
