...
## Configurar las opciones del editor  
...
## Tareas de configuración del editor  
...
|Ubicación de las páginas de Ayuda F1 de los cuadros de diálogo de opciones de editores.|[Páginas de Opciones de consulta (Ayuda F1)](../Topic/Query%20Options%20Pages%20F1%20Help.md)|  
