...
ms.topic: "article"
helpviewer_keywords: 
  - "utilidad sqlcmd, conexiones de motor de base de datos"
  - "Canalizaciones con nombre [SQL Server], utilidad sqlcmd"
  - "TCP/IP [SQL Server], protocolos de cliente"
  - "protocolos de red [SQL Server], utilidad sqlcmd"
  - "protocolos [SQL Server], utilidad sqlcmd"
  - "VIA"
