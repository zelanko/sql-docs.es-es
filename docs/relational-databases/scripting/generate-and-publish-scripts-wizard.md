...
helpviewer_keywords: 
  - "bases de datos [SQL Server], publicación"
  - "publicar bases de datos"
  - "scripts [SQL Server], generación"
  - "scripts [SQL Server], publicación"
  - "bases de datos [SQL Server], generación de scripts"
  - "Asistente para publicar bases de datos"
...
## Generar scripts en el Almacenamiento de datos SQL de Azure  
...
### Cómo generar scripts para el Almacenamiento de datos SQL cuando no es la opción de scripting predeterminada  
