...
ms.topic: "article"
helpviewer_keywords: 
  - "Información de parámetros, opción [IntelliSense]"
  - "finalización automática de parámetros de funciones almacenadas [Intellisense]"
  - "referencias de idioma [SQL Server]"
  - "IntelliSense [SQL Server], opción de información de parámetros"
...
#### Para ver la información de parámetros de funciones o procedimientos almacenados del sistema  
...
#### Para iniciar manualmente Información de parámetros  
