...
f1_keywords: 
  - "VS.TextEditor"
helpviewer_keywords: 
  - "Editor de consultas [SQL Server Management Studio]"
  - "Editor de código (SQL Server Management Studio), acerca del Editor de consultas"
  - "Editor de consultas [SQL Server Management Studio], modo de pantalla completa"
  - "Editor de consultas [Motor de base de datos], plantillas"
  - "modo de pantalla completa [SQL Server Management Studio]"
  - "SQL Server Management Studio [SQL Server], plantillas"
  - "escribir scripts"
  - "modificar scripts"
  - "SQL Server Management Studio [SQL Server], Editor de consultas"
  - "Editor de consultas (SQL Server Management Studio), acerca del Editor de consultas"
  - "escribir consultas"
  - "SQL Server Management Studio [SQL Server], editor"
  - "scripts [SQL Server], SQL Server Management Studio"
  - "consultas [SQL Server], SQL Server Management Studio"
 ...
 **Modo SQLCMD**  
 Ejecuta scripts de [!INCLUDE[tsql](../../includes/tsql-md.md)] que incluyen el conjunto de comandos admitidos por la utilidad sqlcmd. Para obtener más información, vea los [Temas de procedimientos sobre sqlcmd](../Topic/sqlcmd%20How-to%20Topics.md).  
...
|Describe cómo ver y usar las características básicas del editor de consultas de MDX.|[Editor de consultas MDX &#40;Analysis Services: datos multidimensionales&#41;](../Topic/MDX%20Query%20Editor%20\(Analysis%20Services%20-%20Multidimensional%20Data\).md)|  
|Describe cómo ver y usar las características básicas del editor de consultas de DMX.|[Editor de consultas DMX &#40;Analysis Services: minería de datos&#41;](../Topic/DMX%20Query%20Editor%20\(Analysis%20Services%20-%20Data%20Mining\).md)|  
