---
title: "Proveedor de PowerShell de SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "PowerShell [SQL Server], proveedor"
  - "PowerShell [SQL Server], proveedor de PowerShell SQL Server"
  - "Proveedores [PowerShell]"
  - "SMO [SQL Server], PowerShell"
  - "PowerShell [SQL Server], SMO"
  - "Objetos de administración de SQL Server, propiedades"
