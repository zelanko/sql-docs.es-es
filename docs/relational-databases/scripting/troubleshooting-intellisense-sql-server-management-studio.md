...
ms.topic: "article"
helpviewer_keywords: 
  - "opciones no disponibles [IntelliSense]"
  - "IntelliSense [SQL Server], solución de problemas"
  - "IntelliSense [SQL Server], opciones no disponibles"
  - "solucionar problemas [IntelliSense]"
...
manager: "jhubbard"
---
# Soluci&#243;n de problemas IntelliSense (SQL Server Management Studio)
