...
dev_langs: 
  - "TSQL"
helpviewer_keywords: 
  - "scripts [SQL Server], utilidad sqlcmd"
  - "variables [SQL Server], scripts"
  - "script, variables [SQL Server]"
  - "utilidad sqlcmd, scripts"
  - "setvar, comando"
...
## Definir variables de scripting mediante el comando setvar  
...
### A. Usar el comando setvar en un script  
