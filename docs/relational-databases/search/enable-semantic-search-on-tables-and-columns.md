...
##  <a name="create-a-semantic-index-when-there-is-an-existing-full-text-index"></a><a name="HowToEnableAlter"></a> Crear un índice semántico cuando hay un índice de texto completo  
