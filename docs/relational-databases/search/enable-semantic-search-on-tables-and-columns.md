...
ms.topic: "article"
helpviewer_keywords: 
  - "búsqueda semántica [SQL Server], habilitar"
...
###  <a name="HowToEnableAlter"></a> Crear un índice semántico cuando hay un índice de texto completo existente  
...
## Determinar qué se puede indizar para la búsqueda semántica  
  
###  <a name="HowToCheckLanguages"></a> Comprobar los idiomas compatibles para la búsqueda semántica  
...
###  <a name="doctypes"></a> Cómo: determinar qué tipos de documento se pueden indizar  
...
##  <a name="IssueNoResults"></a> Problema: la búsqueda en una columna específica nunca devuelve resultados  
