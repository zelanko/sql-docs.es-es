...
###  <a name="example-2-find-the-top-documents-that-contain-a-specific-key-phrase"></a><a name="HowToTopDocuments"></a>Ejemplo 2: Búsqueda de los principales documentos que contienen una determinada frase clave  
