---
title: "Rellenar &#237;ndices de texto completo | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "rellenados de índices [búsqueda de texto completo]"
  - "rellenados incrementales [búsqueda de texto completo]"
  - "rellenados [búsqueda de texto completo]"
  - "búsqueda de texto completo [SQL Server], rellenados"
  - "rastreos [búsqueda de texto completo]"
  - "índice de texto completo, actualizaciones automáticas"
  - "rellenados basados en el seguimiento de cambios [búsqueda de texto completo]"
  - "actualizaciones manuales [búsqueda de texto completo]"
  - "rellenados manuales [búsqueda de texto completo]"
  - "rellenados automáticos [búsqueda de texto completo]"
  - "índices de texto completo [SQL Server], columna clave"
  - "rellenados completos [búsqueda de texto completo]"
  - "índices de texto completo [SQL Server], rellenados"
...
##  <a name="types"></a> Tipos de rellenado  
 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] admite los tipos siguientes de rellenado: completo, automático o manual basado en el seguimiento de cambios, y basado en la marca de tiempo incremental.  
...
> [!NOTE]  
>  Para las tablas que contienen una columna **timestamp**, puede usar los rellenados incrementales.  
...
### E. Modificar un índice de texto completo para usar el seguimiento de cambios automático  
...
#### Para crear o modificar una programación para el rellenado incremental en Management Studio  
