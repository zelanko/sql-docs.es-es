...
### Ejemplo: Creación de un índice de texto completo sin ejecutar un rellenado completo  
...
### Ejemplo: Ejecución de un rellenado completo en una tabla  
...
### Ejecución de un rellenado incremental
