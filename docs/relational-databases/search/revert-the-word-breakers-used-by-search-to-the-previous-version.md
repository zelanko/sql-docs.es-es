...
## <a name="see-also"></a>Consulte también  
 ...
 [Cambios de comportamiento en la búsqueda de texto completo](https://docs.microsoft.com/sql/relational-databases/search/full-text-search?view=sql-server-ver15)
