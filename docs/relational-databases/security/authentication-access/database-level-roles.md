...
helpviewer_keywords: 
  - "db_denydatareader, rol"
  - "usuarios [SQL Server], roles de base de datos"
  - "roles de base de datos [SQL Server]"
  - "db_denydatawriter, rol"
  - "roles [SQL Server], base de datos"
  - "entidades de seguridad [SQL Server], nivel de base de datos"
  - "db_backupoperator, rol"
  - "credenciales [SQL Server], roles"
  - "db_accessadmin, rol"
  - "esquemas [SQL Server], roles"
  - "permisos [SQL Server], roles"
  - "roles de base de datos [SQL Server], enumerados"
  - "db_datareader, rol"
  - "db_ddladmin, rol"
  - "db_datawriter, rol"
  - "db_securityadmin, rol"
  - "db_owner, rol"
  - "roles de base de datos [SQL Server]"
...
## <a name="special-roles-for-includesssdsmdtokensssdsmdmd-and-includesssdwmdtokensssdwmdmd"></a>Roles especiales para [!INCLUDE[ssSDS_md](../../../includes/sssds-md.md)] y [!INCLUDE[ssSDW_md](../../../includes/sssdw-md.md)]
