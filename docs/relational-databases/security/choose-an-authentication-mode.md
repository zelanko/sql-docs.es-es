---
title: "Elegir un modo de autenticaci&#243;n | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "Asistente para la instalación de SQL Server, página Modo de autenticación"
  - "elegir un modo de autenticación"
  - "autenticación [SQL Server], elegir un modo"
  - "Windows, autenticación [SQL Server]"
  - "autenticación de modo mixto"
  - "modo de autenticación mixto"
  - "modo de autenticación SQL"
