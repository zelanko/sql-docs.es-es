---
title: "Develop Applications using Always Encrypted with the .NET Framework Data Provider for SQL Server (Desarrollar aplicaciones mediante Always Encrypted con el proveedor de datos .NET Framework para SQL Server). | Microsoft Docs"
ms.custom: ""
ms.date: "03/04/2017"
...
manager: "jhubbard"
---
# Develop Applications using Always Encrypted with the .NET Framework Data Provider for SQL Server (Desarrollar aplicaciones mediante Always Encrypted con el proveedor de datos .NET Framework para SQL Server).
...
## Habilitar Always Encrypted para consultas de la aplicación
...
## Recuperar y modificar los datos de las columnas cifradas
...
### Ejemplo de la recuperación de datos de texto sin formato
...
### Ejemplo de la recuperación de los datos cifrados
...
### Evitar problemas comunes al consultar columnas cifradas
...
### Errores de conversión de tipos de datos no compatibles
...
### Errores debidos a pasar texto sin formato en lugar de valores cifrados
...
## Trabajar con almacenes de claves maestras de columna
...
### Usar proveedores integrados de almacenamiento de claves maestras de columna
...
### Usar el proveedor de Azure Key Vault
...
### Implementar un proveedor personalizado de almacén de claves maestras de columna
...
### Usar proveedores de almacén de claves maestras de columna para el aprovisionamiento de claves mediante programación
...
## Controlar el impacto en el rendimiento de Always Encrypted
...
### Controlar los ciclos de ida y vuelta para recuperar metadatos para los parámetros de consulta
...
### Almacenamiento en caché de metadatos de consulta
...
### Configurar Always Encrypted en el nivel de consulta
...
### Almacenamiento en memoria caché de claves de cifrado de columnas
...
## Habilitar la protección adicional de un SQL Server comprometido
...
### Configurar rutas de acceso a claves maestras de columna de confianza 
...
## Copiar datos cifrados con SqlBulkCopy
...
|[Clase SqlColumnEncryptionKeyStoreProvider](https://msdn.microsoft.com/library/system.data.sqlclient.sqlcolumnencryptionkeystoreprovider.aspx)|Clase base de los proveedores de almacén de claves.|  4.6
