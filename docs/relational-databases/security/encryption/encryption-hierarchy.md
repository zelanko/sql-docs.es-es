...
description: Obtenga información sobre la infraestructura de cifrado jerárquico y administración de claves de SQL Server. Almacene las claves en un módulo de administración extensible de claves.
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
