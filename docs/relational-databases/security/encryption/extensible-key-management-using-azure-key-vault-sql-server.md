---
title: "Administraci&#243;n extensible de claves con el Almac&#233;n de claves de Azure (SQL Server) | Microsoft Docs"
ms.custom: 
  - "SQL2016_New_Updated"
ms.date: "07/22/2016"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Administración extensible de claves con almacén de claves"
  - "Cifrado de datos transparente, con EKM y almacén de claves"
  - "EKM, con almacén de claves"
  - "TDE, EKM y almacén de claves"
  - "Administración de claves con almacén de claves"
  - "Conector de SQL Server, acerca de"
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx_md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  ...
  El conector de [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] para el Almacén de claves de [!INCLUDE[msCoName](../../../includes/msconame-md.md)] Azure habilita el cifrado de [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] para usar el servicio del Almacén de claves de Azure como si fuera un proveedor de [Administración extensible de claves &#40;EKM&#41;](../../../relational-databases/security/encryption/extensible-key-management-ekm.md) y así proteger sus claves de cifrado de [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)].  
