...
description: Obtenga información sobre la rotación de claves maestras de columna y claves de cifrado de columna de Always Encrypted mediante SQL Server Management Studio.
ms.custom: ''
ms.date: 10/01/2019
ms.prod: sql
ms.reviewer: vanto
