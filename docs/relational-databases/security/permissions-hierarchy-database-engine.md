...
helpviewer_keywords: 
  - "seguridad [SQL Server], denegar acceso"
  - "jerarquías [SQL Server], permisos"
  - "elementos protegibles [SQL Server]"
  - "seguridad [SQL Server], permisos"
  - "permisos [SQL Server], jerarquías"
  - "seguridad [SQL Server], conceder acceso"
