...
ms.topic: "article"
helpviewer_keywords: 
  - "seguridad [SQL Server], certificados y claves asimétricas"
...
|[Identificar el origen de paquetes con firmas digitales](../../integration-services/packages/identify-the-source-of-packages-with-digital-signatures.md)|Muestra información sobre cómo utilizar los certificados para firmar paquetes de software.|  
