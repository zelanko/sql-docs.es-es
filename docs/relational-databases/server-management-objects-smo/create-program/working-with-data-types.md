...
-   Utilice uno de los miembros estáticos de la <xref:Microsoft.SqlServer.Management.Smo.DataType> de la clase, por ejemplo **Int**. De esta forma, se devolverá una instancia de un objeto <xref:Microsoft.SqlServer.Management.Smo.DataType>.  
