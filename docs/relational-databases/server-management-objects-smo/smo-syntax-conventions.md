---
title: Convenciones de sintaxis SMO | Documentos de Microsoft
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)][!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Convenciones tipográficas management Objects (SMO) se basan en los que se usan en [!INCLUDE[msCoName](../../includes/msconame-md.md)] material de referencia de Visual Studio. NET.  
