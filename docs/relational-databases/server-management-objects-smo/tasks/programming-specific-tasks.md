...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Programación de tareas específicas con objetos SMO incluye a temas complejos que solo son necesarios en programas con una función específica, como copia de seguridad, supervisión de estadísticas, replicación, administrar objetos de instancia y establecer las opciones de configuración.  
