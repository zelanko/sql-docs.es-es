...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)] **GeometryCollection** es una colección de cero o más instancias **geometry** o **geography**. Un **GeometryCollection** puede estar vacío.  
