...
ms.topic: "article"
helpviewer_keywords: 
  - "tipo de datos geometry [SQL Server], descripción"
  - "tipo de datos geography [SQL Server], datos espaciales"
  - "datos espaciales planos [SQL Server], tipo de datos geometry"
