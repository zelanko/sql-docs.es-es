 ...
 * Estas columnas de datos se rellenan de forma predeterminada para todos los eventos.  
 ...
 \*\*Para obtener más información sobre la columna de datos **ObjectType**, vea [Columna de evento de seguimiento ObjectType](../../relational-databases/event-classes/objecttype-trace-event-column.md).  
