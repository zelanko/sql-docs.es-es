---
title: "Atributos de elementos de asignación XSD a tablas y columnas (SQLXML 4.0) predeterminados | Documentos de Microsoft"
ms.custom: 
ms.date: 03/17/2017
...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]De forma predeterminada, un elemento de tipo complejo en un XSD había anotado esquema se asigna a la tabla (vista) con el mismo nombre en la base de datos especificada y un elemento o atributo de tipo simple se asigna a la columna con el mismo nombre en la tabla.  
