...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Cuando se especifica una consulta XPath en un esquema XSD, se requiere información de clave en la mayoría de los casos para obtener un anidamiento correcto en el resultado. Especificar el **SQL: Key-campos** anotación es una manera de asegurarse de que se genera la jerarquía correcta.  
