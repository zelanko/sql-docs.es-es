...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Cuando se ejecuta una consulta XPath en un esquema XSD y se especifica el tipo XSD en el **xsd: Type** atributo, XPath utiliza el tipo de datos especificado al procesar la consulta.  
