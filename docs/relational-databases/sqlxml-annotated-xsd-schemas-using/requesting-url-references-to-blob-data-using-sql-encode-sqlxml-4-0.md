...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]En un esquema XSD anotado, cuando un atributo (o elemento) se asigna a una columna BLOB de Microsoft [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], los datos se devuelven en formato codificado en Base 64 en XML.  
