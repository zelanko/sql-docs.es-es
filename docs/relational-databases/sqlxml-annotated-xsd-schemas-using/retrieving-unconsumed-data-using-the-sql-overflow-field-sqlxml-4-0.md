...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Cuando se insertan registros en una base de datos de un documento XML utilizando el [!INCLUDE[tsql](../../includes/tsql-md.md)] función OPENXML, todos los datos no consumidos del documento XML de origen pueden almacenarse en una columna. Cuando se recuperan datos de una base de datos mediante esquemas anotados, puede especificar el **SQL: overflow-campo** atributo para identificar la columna de la tabla en la que se almacenan los datos de desbordamiento. El **SQL: overflow-campo** atributo puede especificarse en  **\<elemento >**.  
