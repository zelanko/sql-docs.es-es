...
description: Vea una lista de anotaciones XSD (SQLXML 4,0) introducidas en SQL Server 2005 (9. x), con una comparación de las anotaciones de XDR introducidas en SQL Server 2000 (8. x).
ms.date: 03/17/2017
ms.prod: sql
...
> [!NOTE]  
>  El atributo **targetNamespace** nativo de XSD reemplaza la anotación del **espacio de nombres de destino** que se presentó en el [!INCLUDE[ssVersion2000](../../includes/ssversion2000-md.md)] esquema de asignación de XDR.  
