---
title: 'SQL: limit-campo y SQL: limit-value (SQLXML 4.0) | Documentos de Microsoft'
ms.custom: 
ms.date: 03/14/2017
...
---
# <a name="annotation-interpretation---sqllimit-field-and-sqllimit-value"></a>Interpretación de anotaciones - SQL: limit-campo y SQL: limit-valor
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Carga masiva XML procesa la **SQL: limit-campo** y **SQL: limit-valor** anotaciones por su definición. Para obtener más información, vea [filtrar valores mediante SQL: limit-campo y SQL: limit-value &#40; SQLXML 4.0 &#41; ](../../../relational-databases/sqlxml-annotated-xsd-schemas-using/filtering-values-using-sql-limit-field-and-sql-limit-value-sqlxml-4-0.md).  
