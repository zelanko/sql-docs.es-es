...
## <a name="in-this-section"></a>En esta sección  
 ...
 [SQL: asignar &#40; SQLXML 4.0 &#41;](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/bulk-load-xml/annotation-interpretation-sql-mapped.md)  
 Describe cómo el **sql: asignado** anotación se interpreta en la carga masiva XML.  
  
 [SQL: limit-campo y SQL: limit-value &#40; SQLXML 4.0 &#41;](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/bulk-load-xml/annotation-interpretation-sql-limit-field-and-sql-limit-value.md)  
