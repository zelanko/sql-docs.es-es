...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Los tipos de datos que se especifican en el esquema de asignación (tipo XSD o XDR y **SQL: DataType**) generalmente se ignoran, excepto en los casos siguientes:  
