---
title: Plantillas de almacenamiento en caché, XSL y esquemas (SQLXML)
description: Vea información sobre el almacenamiento en caché de plantillas, XSL y esquemas en SQLXML 4,0.
ms.date: 03/14/2017
ms.prod: sql
