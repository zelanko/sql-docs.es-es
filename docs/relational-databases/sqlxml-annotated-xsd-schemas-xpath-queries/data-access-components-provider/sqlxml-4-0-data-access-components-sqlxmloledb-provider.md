...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)][!INCLUDE[msCoName](../../../includes/msconame-md.md)] SQLXML 4.0 incluye tres proveedores de datos que pueden insertar datos XML y recuperar datos XML de una base de datos en [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)]:  
