...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Los ejemplos de este tema están compuestos de DiffGram que realizan operaciones de inserción, actualización y eliminación a la base de datos. Antes de usar los ejemplos, tenga en cuenta lo siguiente:  
