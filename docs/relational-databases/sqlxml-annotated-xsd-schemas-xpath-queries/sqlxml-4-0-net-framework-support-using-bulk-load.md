...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Este tema explica cómo puede utilizarse la funcionalidad de carga masiva XML en el entorno. NET. Para obtener información detallada sobre la carga masiva XML, vea [realizar carga masiva de datos XML &#40; SQLXML 4.0 &#41; ](../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/bulk-load-xml/performing-bulk-load-of-xml-data-sqlxml-4-0.md).  
