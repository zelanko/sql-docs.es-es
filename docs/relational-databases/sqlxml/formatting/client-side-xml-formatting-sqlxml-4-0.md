...
[!INCLUDE[appliesto-ss-asdb-xxxx-xxx-md](../../../includes/appliesto-ss-asdb-xxxx-xxx-md.md)]Este tema proporciona información sobre el formato XML del lado cliente. La aplicación de formato en el cliente se refiere a dar formato al XML en nivel intermedio.  
...
> [!NOTE]  
>  Cuando se usa el proveedor SQLXMLOLEDB o clases administradas de SQLXML, puede usar el **ClientSideXml** propiedad para solicitar el formato XML del lado cliente.  
...
## <a name="see-also"></a>Vea también  
 ...
 [PARA las consideraciones de seguridad XML &#40; SQLXML 4.0 &#41;](../../../relational-databases/sqlxml-annotated-xsd-schemas-xpath-queries/security/for-xml-security-considerations-sqlxml-4-0.md)   
