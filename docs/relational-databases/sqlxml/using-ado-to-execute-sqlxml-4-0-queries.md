...
description: Aprenda a ejecutar consultas SQLXML 4,0 en una aplicación basada en COM mediante el uso de extensiones SQLXML para Objetos de datos ActiveX (ADO).
ms.custom: ''
ms.date: 12/15/2019
ms.prod: sql
