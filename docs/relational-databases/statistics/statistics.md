...
#### <a name="autocreatestatistics-option"></a>Opción AUTO_CREATE_STATISTICS  
...
* A partir de [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] y en el nivel de compatibilidad 130, [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] usa un umbral de actualización de estadísticas dinámico y decreciente que se ajusta según el número de filas de la tabla. Esto se calcula como la raíz cuadrada de 1000 multiplicada por la cardinalidad de tabla actual. Con este cambio, las estadísticas en tablas de gran tamaño se actualizarán con más frecuencia. Sin embargo, si una base de datos tiene un nivel de compatibilidad inferior a 130, se aplicará el umbral de [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)].  
...
## <a name="see-also"></a>Vea también  
 ...
 [Control del comportamiento de Autostat (AUTO_UPDATE_STATISTICS) en SQL Server](http://support.microsoft.com/help/2754171) [STATS_DATE &#40;Transact-SQL&#41;](../../t-sql/functions/stats-date-transact-sql.md)   
