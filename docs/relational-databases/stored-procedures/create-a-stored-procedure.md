...
description: Obtenga información sobre cómo crear un procedimiento almacenado de Transact-SQL mediante SQL Server Management Studio y la instrucción CREATE PROCEDURE de Transact-SQL.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
ms.reviewer: ''
