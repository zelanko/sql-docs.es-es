...
description: Obtenga información sobre cómo usar parámetros para intercambiar datos entre funciones y procedimientos almacenados y la aplicación o la herramienta que ha llamado a la función o al procedimiento almacenado.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
