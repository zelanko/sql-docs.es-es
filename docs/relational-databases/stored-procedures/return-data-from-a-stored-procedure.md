...
description: Aprenda a devolver datos de un procedimiento a un programa que realiza una llamada mediante conjuntos de resultados, parámetros de salida y códigos de retorno.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
