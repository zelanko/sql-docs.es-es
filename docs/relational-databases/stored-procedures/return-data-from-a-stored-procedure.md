...
ms.topic: "article"
helpviewer_keywords: 
  - "procedimientos almacenados [SQL Server], devolver datos"
...
## Devolver datos mediante un parámetro de salida  
...
### Usar el tipo de datos de cursor en parámetros OUTPUT  
