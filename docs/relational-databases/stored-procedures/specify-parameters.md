...
description: Obtenga información sobre cómo pasar valores en parámetros y cómo se usa cada uno de los atributos de parámetro durante una llamada a procedimiento.
ms.custom: ''
ms.date: 03/16/2017
ms.prod: sql
