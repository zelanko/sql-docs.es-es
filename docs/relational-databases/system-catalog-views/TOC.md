# [Información general](catalog-views-transact-sql.md)

# [Consultar el catálogo de sistema SQL Server preguntas más frecuentes](querying-the-sql-server-system-catalog-faq.md)  
# [Esquemas - sys.schemas](schemas-catalog-views-sys-schemas.md)  
# [Mensajes (si hay errores) - sys.messages](messages-for-errors-catalog-views-sys-messages.md)  
# [Las propiedades extendidas de - sys.extended_properties](extended-properties-catalog-views-sys-extended-properties.md)  
...
## [Testigo de creación de reflejo: base de datos sys.database_mirroring_witnesses](database-mirroring-witness-catalog-views-sys-database-mirroring-witnesses.md)  

# Aplicaciones de capa de datos
## [Vistas de aplicación de capa de datos - dbo.sysdac_instance](data-tier-application-views-dbo-sysdac-instances.md)  

# [Grupos de disponibilidad](always-on-availability-groups-catalog-views-transact-sql.md)  
...
# [Recopilador de datos](data-collector-views-transact-sql.md)  
...
# [Espacios de datos.](data-spaces-transact-sql.md)  
...
# [Vistas del correo electrónico de base de datos](database-mail-views-transact-sql.md)  
...
# [Bases de datos y archivos](databases-and-files-catalog-views-transact-sql.md)  
...
# [Extremos](endpoints-catalog-views-transact-sql.md)  
...
# [Eventos extendidos](extended-events-catalog-views-transact-sql.md)  
## [Sys.database_event_session_targets (base de datos de SQL Azure)](sys-database-event-session-targets-azure-sql-database.md)  
## [Sys.database_event_session_fields (base de datos de SQL Azure)](sys-database-event-session-fields-azure-sql-database.md)  
## [Sys.database_event_session_events (base de datos de SQL Azure)](sys-database-event-session-events-azure-sql-database.md)  
## [Sys.database_event_session_actions (base de datos de SQL Azure)](sys-database-event-session-actions-azure-sql-database.md)  
## [Sys.database_event_sessions (base de datos de SQL Azure)](sys-database-event-sessions-azure-sql-database.md)  
...
# [Operaciones externas](external-operations-catalog-views-transact-sql.md)  
...
# [FileStream y FileTable](filestream-and-filetable-catalog-views-transact-sql.md)  
...
# [Búsqueda de texto completo y la búsqueda semántica](full-text-search-and-semantic-search-catalog-views-transact-sql.md)  
...
# [Función de partición](partition-function-catalog-views-transact-sql.md)  
...
# [Vistas de administración basada en directivas](policy-based-management-views-transact-sql.md)  
...
# [Almacén de consultas](query-store-catalog-views-transact-sql.md)  
...
# [Seguridad](security-catalog-views-transact-sql.md)  
...
# [Configuración del servidor](server-wide-configuration-catalog-views-transact-sql.md)  
...
# [Datos espaciales](spatial-data-catalog-views.md)  
...
# [Almacenamiento de datos SQL](sql-data-warehouse-and-parallel-data-warehouse-catalog-views.md)  
...
## [Sys.xml_schema_namespaces incluidos](sys-xml-schema-namespaces-transact-sql.md)  
