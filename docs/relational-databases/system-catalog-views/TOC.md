...
## [Testigo de creación de reflejo de la base de datos: sys.database_mirroring_witnesses](database-mirroring-witness-catalog-views-sys-database-mirroring-witnesses.md)  
...
# [Búsqueda de texto completo y búsqueda semántica](full-text-search-and-semantic-search-catalog-views-transact-sql.md)  
...
# [Vistas de la administración basada en directivas](policy-based-management-views-transact-sql.md)  
