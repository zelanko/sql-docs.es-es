---
title: Grupos de disponibilidad AlwaysOn (Transact-SQL) de vistas de catálogo | Documentos de Microsoft
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
---
# <a name="always-on-availability-groups-catalog-views-transact-sql"></a>Vistas de catálogo (Transact-SQL) de grupos de disponibilidad AlwaysOn
...
> [!NOTE]  
>  Para obtener información acerca de las bases de datos de disponibilidad, consulte el **replica_id** y **group_database_id** columnas en [sys.databases (Transact-SQL);](../../relational-databases/system-catalog-views/sys-databases-transact-sql.md).  
...
## <a name="see-also"></a>Vea también  
 ...
 [Supervisar los grupos de disponibilidad (Transact-SQL);](../../database-engine/availability-groups/windows/monitor-availability-groups-transact-sql.md)   
 [Siempre en vistas de administración dinámica de grupos de disponibilidad y funciones (Transact-SQL)](../system-dynamic-management-views/always-on-availability-groups-dynamic-management-views-functions.md)  
