---
title: Vistas del correo electrónico (Transact-SQL) de la base de datos | Documentos de Microsoft
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
ms.locfileid: "33176708"
---
# <a name="database-mail-views-transact-sql"></a>Vistas del Correo electrónico de base de datos (Transact-SQL)
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]

  El Correo electrónico de base de datos tiene las siguientes vistas para visualizar contenido de correo electrónico propio, el estado de los mensajes y cualquier mensaje recibido, como los errores registrados por el Correo electrónico de base de datos. Estas vistas están en el **msdb** base de datos.  
