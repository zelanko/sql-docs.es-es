---
description: Vistas de catálogo de archivos y bases de datos (Transact-SQL)
title: Vistas de catálogo de archivos y bases de datos (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 01/18/2016
ms.prod: sql
...
:::row:::
    ...
    :::column-end:::
    :::column:::
        [sys.database_recovery_status &#40;&#41;de Transact-SQL ](../../relational-databases/system-catalog-views/sys-database-recovery-status-transact-sql.md)
