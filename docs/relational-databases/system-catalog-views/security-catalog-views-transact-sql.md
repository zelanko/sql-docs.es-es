...
## <a name="see-also"></a>Consulte también  
 [Security Center for SQL Server Database Engine y Azure SQL Database](../../relational-databases/security/security-center-for-sql-server-database-engine-and-azure-sql-database.md)   
