...
|xml_collection_id|**int**|Distinto de cero si el tipo de datos de la columna es **xml** y se escribe el código XML. El valor será el Id. de la colección que contiene el espacio de nombres de esquema XML de validación de la columna.<br /><br /> 0 no = ninguna colección de esquemas XML.|  
...
|generated_always_type_desc|**nvarchar(60)**|**Se aplica a**: desde [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] hasta [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].<br /><br /> La descripción de texto del tipo de columna:<br /><br /> NOT_APPLICABLE<br /><br /> AS_ROW_START<br /><br /> AS_ROW_END|  
