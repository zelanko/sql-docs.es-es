---
title: Sys.column_xml_schema_collection_usages (Transact-SQL) | Documentos de Microsoft
ms.custom: ''
ms.date: 06/10/2016
ms.prod: sql
...
|**column_id**|**int**|El identificador de la columna. Es único en el objeto.|  
