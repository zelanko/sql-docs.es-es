...
[!INCLUDE[tsql-appliesto-xxxxxx-asdb-xxxx-xxx-md](../../includes/tsql-appliesto-xxxxxx-asdb-xxxx-xxx-md.md)]
  ...
  Muestra todas las definiciones de sesión de eventos que existen en la base de [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)]datos actual, en.  
  
> [!NOTE]
>  La vista de catálogo similar `sys.server_event_sessions` denominada se aplica [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]solo a.  
