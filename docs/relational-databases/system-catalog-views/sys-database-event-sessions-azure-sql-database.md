---
title: Sys.database_event_sessions (base de datos de SQL Azure) | Documentos de Microsoft
ms.custom: ''
ms.date: 03/14/2017
ms.prod: ''
...
ms.locfileid: "33180751"
---
# <a name="sysdatabaseeventsessions-azure-sql-database"></a>Sys.database_event_sessions (base de datos de SQL Azure)
...
> [!NOTE]  
>  La vista de catálogo similar denominada `sys.server_event_sessions` solo se aplica a [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
  
||  
|-|  
|**Se aplica a**: [!INCLUDE[sqldbesa](../../includes/sqldbesa-md.md)]y para las versiones posteriores.|  
