...
|**size_based_cleanup_mode**|**smallint**|Controla si la limpieza se activará automáticamente cuando la cantidad total de datos se acerque al tamaño máximo:<br /><br /> 0 = OFF - limpieza basada en tamaño no se activará automáticamente.<br /><br /> **1** = AUTO - limpieza basada en tamaño se activará automáticamente cuando se alcanza el tamaño en disco **90 por ciento** de *max_storage_size_mb*. Es el valor de configuración predeterminado.<br /><br />La limpieza según el tamaño quita primero las consultas menos caras y más antiguas. Se detiene cuando aproximadamente **80 por ciento** de *max_storage_size_mb* se alcanza.|  
