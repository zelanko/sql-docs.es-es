...
|**physical_database_name**|**nvarchar(128)**|Por SQL Server, el nombre físico de la base de datos. Por Azure SQL Database, es un identificador común para las bases de datos de un servidor. <br />**Se aplica a**: SQL Server 2019 (15. x) y versiones posteriores, y Azure SQL Database|
