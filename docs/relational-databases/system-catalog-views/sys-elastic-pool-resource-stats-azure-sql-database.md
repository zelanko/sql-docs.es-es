...
[!INCLUDE[tsql-appliesto-xxxxxx-asdb-xxxx-xxx-md](../../includes/tsql-appliesto-xxxxxx-asdb-xxxx-xxx-md.md)]
  ...
  Devuelve las estadísticas de uso de recursos para todos los grupos elásticos de un servidor de SQL Database. Para cada grupo elástico, hay una fila por cada ventana de informes de 15 segundos (cuatro filas por minuto). Esto incluye la CPU, la e/s, el registro, el consumo de almacenamiento y el uso de solicitudes o sesiones simultáneas por parte de todas las bases de datos del grupo. Estos datos se conservan durante 14 días. 
