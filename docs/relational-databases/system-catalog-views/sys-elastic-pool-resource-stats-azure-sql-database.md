...
## <a name="see-also"></a>Consulte también
 ...
 [Creación y administración de un grupo de bases de datos elásticas SQL Database](https://azure.microsoft.com/documentation/articles/sql-database-elastic-pool-portal/)   
