...
Esta vista de catálogo proporciona una lista de los idiomas en la base de datos externos. **R** y **Python** son nombres reservados y no se puede crear ningún lenguaje externo con esos nombres.
