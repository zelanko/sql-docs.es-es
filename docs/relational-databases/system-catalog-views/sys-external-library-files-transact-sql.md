...
Enumera una fila para cada archivo que forma una biblioteca externa.
...
|platform |TINYINT |IDENTIFICADOR de la plataforma host en la que está instalado SQL Server. |
|platform_desc | nvarchar(60) |Nombre de la plataforma host. Los valores válidos son 'WINDOWS', 'LINUX'. |
