...
|**Nombre**|**sysname**|Nombre del índice. **Name** es único solo dentro del objeto.<br /><br /> NULL = Montón|  
...
## <a name="examples"></a>Ejemplos  
 En el ejemplo siguiente se devuelven todos los índices de la tabla `Production.Product` en la base de datos [!INCLUDE[ssSampleDBnormal](../../includes/sssampledbnormal-md.md)].  
