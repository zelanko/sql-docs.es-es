...
|**id_de_índice**|**int**|Id. del índice. **index_id** es único solo dentro del objeto.<br /><br /> 0 = Montón<br /><br /> 1 o 5 = índice agrupado (árbol B, almacén de columnas)<br /><br /> > 1 y <> 5 = índice no clúster|  
