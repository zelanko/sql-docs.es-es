---
title: Broker (Transact-SQL) | Documentos de Microsoft
ms.custom: ''
ms.date: 06/10/2016
ms.prod: sql
...
-   Las páginas que se utilizan en las tablas internas de índices XML, índices espaciales y los índices de texto completo se incluyen en el **index_size** columna. Cuando se especifica una tabla o nombre de vista indizada, las páginas de índices XML, índices espaciales y los índices de texto completo para ese objeto se incluyen en las columnas **reservada** y **index_size**.  
