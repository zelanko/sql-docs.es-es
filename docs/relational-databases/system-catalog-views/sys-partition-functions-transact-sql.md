...
## <a name="see-also"></a>Vea también  
 [Vistas &#40;de catálogo de funciones de partición&#41; de Transact-SQL](../../relational-databases/system-catalog-views/partition-function-catalog-views-transact-sql.md)   
