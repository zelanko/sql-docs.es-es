...
|-----------------|---------------|-----------------|  
|**\<columnas heredadas>**||Hereda columnas de [Sys. data_spaces &#40;&#41;de Transact-SQL ](../../relational-databases/system-catalog-views/sys-data-spaces-transact-sql.md).|  
