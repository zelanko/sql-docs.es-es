...
Muestra información de distribución de las vistas materializadas.  
  
|Nombre de la columna|Tipo de datos|Descripción|  
|-----------------|---------------|-----------------| 
|object_id|**int**|Id. de la vista materializada para que estos se han especificado propiedades.| 
