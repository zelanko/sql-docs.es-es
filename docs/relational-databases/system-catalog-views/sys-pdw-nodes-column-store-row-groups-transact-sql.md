...
|**número_de_partición**|**int**|Identificador de la partición de tabla que contiene el grupo de filas *row_group_id*. Puede usar *número_de_partición* para unir Esta DMV a sys.partitions.|  
...
|**estado**|**tinyint**|Número de identificación asociado con el state_description.<br /><br /> 1 = OPEN<br /><br /> 2 = CLOSED<br /><br /> 3 = COMPRESSED|  
