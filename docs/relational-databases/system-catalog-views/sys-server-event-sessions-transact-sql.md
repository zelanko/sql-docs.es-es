...
|event_retention_mode|**nchar(1)**|Determina cómo se controla la pérdida de eventos. El valor predeterminado es S. No admite valores NULL. Es uno de los siguientes valores:<br /><br /> S. Se asigna a event_retention_mode_desc = ALLOW_SINGLE_EVENT_LOSS<br /><br /> M. Se asigna a event_retention_mode_desc = ALLOW_MULTIPLE_EVENT_LOSS<br /><br /> N. Se asigna a event_retention_mode_desc = NO_EVENT_LOSS|  
