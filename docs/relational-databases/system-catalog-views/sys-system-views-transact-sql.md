...
|**is_date_correlation_view**|**bit**|1 = la vista se creó automáticamente por el sistema para almacenar la información de correlación entre **datetime** columnas. La creación de esta vista se ha habilitado al establecer DATE_CORRELATION_OPTIMIZATION en ON.|  
