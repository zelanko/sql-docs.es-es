...
|-----------------|---------------|-----------------|  
|*\<columnas heredadas >*||Para obtener una lista de las columnas que hereda esta vista, vea [Sys. &#40;Types de&#41;Transact-SQL](../../relational-databases/system-catalog-views/sys-types-transact-sql.md).|  
