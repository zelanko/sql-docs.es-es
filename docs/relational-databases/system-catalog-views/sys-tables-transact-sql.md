...
|is_external|**bit**|**Se aplica a**: [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] y versiones [!INCLUDE[sssdsfull](../../includes/sssdsfull-md.md)]posteriores, [!INCLUDE[sssdwfull](../../includes/sssdwfull-md.md)]y.<br /><br /> Indica que la tabla es una tabla externa.<br /><br /> 0 = la tabla no es una tabla externa.<br /><br /> 1 = la tabla es una tabla externa.| 
...
|is_node|**bit**|**Se aplica a** [!INCLUDE[sssql17-md.md](../../includes/sssql17-md.md)] : [!INCLUDE[sssdsfull](../../includes/sssdsfull-md.md)]y. <br/><br/>1 = se trata de una tabla de nodo de gráfico. <br /><br />0 = no es una tabla de nodo de gráfico. |  
|is_edge|**bit**|**Se aplica a** [!INCLUDE[sssql17-md.md](../../includes/sssql17-md.md)] : [!INCLUDE[sssdsfull](../../includes/sssdsfull-md.md)]y. <br/><br/>1 = esta es una tabla de borde del gráfico. <br /><br />0 = no es una tabla de borde de gráfico. |  
