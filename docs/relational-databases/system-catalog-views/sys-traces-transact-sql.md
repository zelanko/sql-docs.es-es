...
|-----------------|---------------|-----------------|  
|**sesión**|**int**|Id. de seguimiento.|  
|**estatus**|**int**|Estado de la seguimiento:<br /><br /> 0 = detenida<br /><br /> 1 = en ejecución|  
|**camino**|**nvarchar(260)**|Ruta de acceso al archivo de seguimiento. Este valor es NULL se trata de una seguimiento de conjunto de filas.|  
