---
title: Sys. bajo (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/15/2017
ms.prod: sql
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  ...
  Contiene una fila por cada opción de configuración establecida por un usuario. debajo **contiene las** opciones de configuración que se definen antes del inicio más reciente [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]de, además de las opciones de configuración dinámicas establecidas desde entonces.  
...
|**valor**|**int**|Valor de la variable, que el usuario puede modificar. 
  [!INCLUDE[ssDE](../../includes/ssde-md.md)] lo utiliza solo si se ha ejecutado RECONFIGURE.|  
|**configurar**|**int**|Número de la variable de configuración.|  
