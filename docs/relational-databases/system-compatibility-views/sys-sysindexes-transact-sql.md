...
|**primera**|**binary(6)**|Puntero a la primera página o página raíz.<br /><br /> No usado cuando **indid** = 0.<br /><br /> NULL = índice tiene particiones cuando **indid** > 1.<br /><br /> NULL = la tabla tiene particiones cuando **indid** es 0 o 1.|  
