# [Información general](system-dynamic-management-views.md)  
...
# [Búsqueda de texto completo y búsqueda semántica](full-text-and-semantic-search-dynamic-management-views-functions.md)  
...
# [Replicación geográfica (Azure SQL Database)](geo-replication-dynamic-management-views-and-functions-azure-sql-database.md)  
...
# [Tabla con optimización para memoria](memory-optimized-table-dynamic-management-views-transact-sql.md)  
...
# [Relacionado con la seguridad](security-related-dynamic-management-views-and-functions-transact-sql.md)  
...
# [Relacionado con el servidor](server-related-dynamic-management-views-and-functions-transact-sql.md)  
...
# [SQL Data Warehouse y almacenamiento de datos paralelos](sql-and-parallel-data-warehouse-dynamic-management-views.md)  
...
# [Sistema operativo de SQL Server](sql-server-operating-system-related-dynamic-management-views-transact-sql.md)  
...
# [Transacciones](transaction-related-dynamic-management-views-and-functions-transact-sql.md)  
