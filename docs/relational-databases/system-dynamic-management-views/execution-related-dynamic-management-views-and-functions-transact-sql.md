---
title: Vistas de administración dinámica y funciones (Transact-SQL) relacionadas con ejecuciones | Documentos de Microsoft
ms.custom: ''
ms.date: 04/24/2017
ms.prod: sql
ms.reviewer: ''
...
> [!NOTE]  
>  El **sys.dm_exec_query_transformation_stats** vista de administración dinámica se identifica únicamente con fines informativos. No compatible. La compatibilidad con versiones posteriores no está garantizada.  
