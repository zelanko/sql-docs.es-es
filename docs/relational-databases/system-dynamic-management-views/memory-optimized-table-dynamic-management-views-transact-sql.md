...
description: Obtenga información sobre las vistas de administración dinámica de SQL Server y las vistas de catálogo de objetos que se usan con OLTP en memoria en SQL Server.
