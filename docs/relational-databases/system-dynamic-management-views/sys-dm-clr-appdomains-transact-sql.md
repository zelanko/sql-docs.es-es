...
|**estado**|**nvarchar (128)**|Un descriptor para el estado actual de la **AppDomain**. Un AppDomain puede encontrarse en estados diferentes desde la creación a la eliminación. Vea la sección Comentarios de este tema para obtener más información.|  
...
|**valor**|**int**|Valor de la **AppDomain**. Cuanto menor sea el valor, más probable que esto **AppDomain** se descargue bajo presión de memoria. Valor suele depende de cuántas conexiones o lotes que estén usando este **AppDomain**.|  
