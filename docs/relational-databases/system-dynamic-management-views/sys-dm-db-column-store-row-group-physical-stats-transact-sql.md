...
|**número_de_partición**|**int**|Identificador de la partición de tabla que contiene *row_group_id*. Puede utilizar partition_number para unir esta DMV a sys.partitions.|  
...
|**estado**|**tinyint**|Número de identificación asociado *state_description*.<br /><br /> 0 = INVISIBLE<br /><br /> 1 = OPEN<br /><br /> 2 = CLOSED<br /><br /> 3 = COMPRESSED<br /><br /> 4 = MARCADOR DE EXCLUSIÓN<br /><br /> COMPRESSED es el único estado que se aplica a tablas en memoria.|  
...
|**hora_creación**|datetime2|Hora del reloj para cuando se creó este grupo de filas.<br /><br /> NULL: para un índice de almacén de columnas en una tabla en memoria.|  
