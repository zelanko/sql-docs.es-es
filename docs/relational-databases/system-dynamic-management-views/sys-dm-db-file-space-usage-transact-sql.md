...
> [!NOTE]  
>  Para llamar a este [!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)] método [!INCLUDE[ssPDW](../../includes/sspdw-md.md)]desde o, use el nombre **Sys. dm_pdw_nodes_db_file_space_usage**.  
...
|total_page_count|**BIGINT**|**Válido para **: [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] y versiones posteriores.<br /><br /> Número total de páginas del archivo.|  
|allocated_extent_page_count|**BIGINT**|**Válido para **: [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] y versiones posteriores.<br /><br /> Número total de páginas de las extensiones asignadas en el archivo.|  
...
### <a name="determing-the-amount-of-free-space-in-tempdb"></a>Determinar la cantidad de espacio disponible en tempdb  
 La consulta siguiente devuelve el número total de páginas libres y el espacio libre total en megabytes (MB) disponible en todos los archivos de **tempdb**.  
