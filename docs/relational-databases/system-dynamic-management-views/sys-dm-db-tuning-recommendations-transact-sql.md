...
| **es\_ejecutable\_acción** | **bit** | 1 = la recomendación se puede ejecutar en la base de datos a través de [!INCLUDE[tsql_md](../../includes/tsql_md.md)] secuencia de comandos.<br />0 = no se puede ejecutar la recomendación en la base de datos (por ejemplo: recomendación de información única o revertido) |
