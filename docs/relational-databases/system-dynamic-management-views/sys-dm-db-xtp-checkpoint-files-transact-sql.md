...
|checkpoint_file_id|**VOLUMEN**|Identificador del archivo de datos o delta.|  
...
## <a name="use-cases"></a>Casos de uso  
 Puede calcular el almacenamiento utilizado por OLTP en memoria como se indica a continuación:  
