...
En SQL Server 2016, el único lenguaje externo admitido es [!INCLUDE[rsql_productname_md](../../includes/rsql-productname-md.md)]R y las solicitudes de script externo se controlan mediante . En SQL Server 2017, tanto R como Python son lenguajes externos [!INCLUDE[rsql_productname_md](../../includes/rsql-productnamenew-md.md)]admitidos y las solicitudes de script externo se controlan mediante .

Para R, este DMV realiza un seguimiento del número de llamadas R que se realizan en una instancia. Por ejemplo, si se llama a `rxLinMod` y se ejecuta de manera simultánea, el contador aumenta en 1.
...
Para Python, este DMV realiza un seguimiento del número de llamadas de Python que se realizan en una instancia.
...
### <a name="viewing-the-number-of-python-scripts-run-on-the-server"></a>Visualización del número de scripts de Python que se ejecutan en el servidor  
...
## <a name="see-also"></a>Consulte también  
 ...
 [Funciones y vistas de administración dinámica relacionadas con la ejecución &#40;Transact-SQLTransact-SQL&#41;](../../relational-databases/system-dynamic-management-views/execution-related-dynamic-management-views-and-functions-transact-sql.md)  
