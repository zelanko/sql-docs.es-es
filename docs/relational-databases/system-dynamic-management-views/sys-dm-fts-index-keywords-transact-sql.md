...
|-----------------|---------------|-----------------|  
|**palabra clave**|**nvarchar(4000)**|La representación hexadecimal de la palabra clave que se almacenan en el índice de texto completo.<br /><br /> Nota: OxFF representa el carácter especial que indica el final de un archivo o conjunto de datos.|  
