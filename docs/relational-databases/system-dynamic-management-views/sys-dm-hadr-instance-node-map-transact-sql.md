---
title: Sys.dm_hadr_instance_node_map (Transact-SQL) | Documentos de Microsoft
ms.custom: 
ms.date: 06/10/2016
...
|**instance_name**|**nvarchar(256)**|Nombre:*server*/*instancia*, de una instancia del servidor que hospeda una réplica del grupo de disponibilidad.|  
