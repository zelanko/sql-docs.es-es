---
title: Sys.dm_io_cluster_valid_path_names (Transact-SQL) | Documentos de Microsoft
ms.custom: 
ms.date: 06/10/2016
...
|**is_cluster_shared_volume**|**Bits**|Devuelve 1 si la unidad en la que se encuentra esta ruta de acceso es un volumen compartido en clúster; de lo contrario, devuelve 0.|  
