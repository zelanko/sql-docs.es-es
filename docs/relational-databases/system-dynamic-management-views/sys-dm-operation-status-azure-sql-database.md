...
## <a name="remarks"></a>Remarks  
 Para usar esta vista, debe estar conectado a la base de datos **maestra** . Use la vista de `sys.dm_operation_status` de la base de datos **maestra** del servidor de [!INCLUDE[ssSDS](../../includes/sssds-md.md)] para realizar un seguimiento del estado de las operaciones siguientes realizadas en un [!INCLUDE[ssSDS](../../includes/sssds-md.md)]:  
