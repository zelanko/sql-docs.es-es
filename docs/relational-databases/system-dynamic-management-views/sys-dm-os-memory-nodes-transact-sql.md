---
title: Sys.dm_os_memory_nodes (Transact-SQL) | Documentos de Microsoft
ms.custom: 
ms.date: 03/13/2017
...
> [!NOTE]  
>  Para llamar a esta desde [!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)] o [!INCLUDE[ssPDW](../../includes/sspdw-md.md)], use el nombre **sys.dm_pdw_nodes_os_memory_nodes**.  
...
|**target_kb** |**bigint** |**Se aplica a**: [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] a través de [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)], [!INCLUDE[ssSDS_md](../../includes/sssds-md.md)].<br /><br /> Especifica el objetivo de memoria para el nodo de memoria, en KB. |   
