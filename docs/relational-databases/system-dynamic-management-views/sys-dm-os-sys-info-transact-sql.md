...
> **Nota:** Para llamarlo desde [!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)] o [!INCLUDE[ssPDW](../../includes/sspdw-md.md)], utilice el nombre **Sys. dm_pdw_nodes_os_sys_info**.  
  
|Nombre de columna|Tipo de datos|Descripción y notas específicas de la versión |  
|-----------------|---------------|-----------------|  
...
|**sqlserver_start_time_ms_ticks**|**bigint**|Representa el número de **ms_tick** cuando [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] inició por última vez. Comparar a la columna actual ms_ticks. No acepta valores NULL.|  
...
|**process_physical_affinity**|**nvarchar(3072)** |**Se aplica a:** A partir de [!INCLUDE[ssSQL17](../../includes/sssql17-md.md)].<br /><br />Información aún. |
