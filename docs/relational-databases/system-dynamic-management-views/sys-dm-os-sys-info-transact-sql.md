---
title: Sys. DM _ _os_sys_info (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 04/24/2018
ms.prod: sql
...
> **Nota:** Para llamarlo desde [!INCLUDE[ssSDWfull](../../includes/sssdwfull-md.md)] o [!INCLUDE[ssPDW](../../includes/sspdw-md.md)], use el nombre **Sys. DM _ _pdw_nodes_os_sys_info**.  
  
|Nombre de columna|Data type|Descripción y notas específicas de la versión |  
|-----------------|---------------|-----------------|  
...
|**visible_target_kb**|**int**|**Se aplica a**: de [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] a [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].<br /><br /> Es igual que **committed_target_kb**. No acepta valores NULL.|  
...
|**sqlserver_start_time_ms_ticks**|**bigint**|Representa el número de **ms_tick** al [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] último inicio. Comparar a la columna actual ms_ticks. No acepta valores NULL.|  
...
|**virtual_machine_type_desc**|**nvarchar(60)**|**Se aplica a**: de [!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)] a [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].<br /><br /> Describe la columna **virtual_machine_type** . No acepta valores NULL.<br /><br /> NINGUNO = [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] no se está ejecutando en una máquina virtual.<br /><br /> HIPERVISOR = [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] se ejecuta dentro de una máquina virtual hospedada por un sistema operativo que ejecuta el hipervisor (un sistema operativo host que emplea la virtualización asistida por hardware).<br /><br /> OTRO = [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] se ejecuta en una máquina virtual hospedada por un sistema operativo que no emplea Asistente de hardware como Microsoft Virtual PC.|  
|**softnuma_configuration**|**int**|**Se aplica a**: de [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] a [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].<br /><br /> Especifica la forma en que se configuran los nodos NUMA. No acepta valores NULL.<br /><br /> 0 = desactivado indica el valor predeterminado de hardware<br /><br /> 1 = Soft-NUMA automatizado<br /><br /> 2 = Soft-NUMA manual a través del registro|  
|**softnuma_configuration_desc**|**nvarchar(60)**|**Se aplica a**: de [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] a [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].<br /><br /> OFF = la característica Soft-NUMA está desactivada<br /><br /> ON = [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] determina automáticamente los tamaños de nodo NUMA para Soft-NUMA<br /><br /> MANUAL = NUMA de software configurado manualmente|
...
|**cores_per_socket** |**int** | **Se aplica a:** de [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] SP2 a [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].<br /><br />Especifica el número de procesadores por socket disponibles en el sistema. |  
|**numa_node_count** |**int** | **Se aplica a:** de [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)] SP2 a [!INCLUDE[ssCurrent](../../includes/sscurrent-md.md)].<br /><br />Especifica el número de nodos Numa disponibles en el sistema. Esta columna incluye los nodos Numa físicos y los nodos Numa de software. |  
