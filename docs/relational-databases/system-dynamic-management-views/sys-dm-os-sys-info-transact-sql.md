...
|**sqlserver_start_time_ms_ticks**|**BIGINT**|Representa el **** número de ms_tick [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] cuando se inició por última vez. Comparar a la columna actual ms_ticks. No acepta valores NULL.|  
