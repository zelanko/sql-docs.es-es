...
|AM_INDBUILD_ALLOCATION |Solo para uso interno. <br />**Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|AM_SCHEMAMGR_UNSHARED_CACHE |Solo para uso interno. <br />**Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|ASSEMBLY_FILTER_HASHTABLE |Solo para uso interno. <br />**Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|ASYNC_OP_COMPLETION |Solo para uso interno. <br />**Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|ASYNC_OP_CONTEXT_READ |Solo para uso interno. <br />**Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|ASYNC_OP_CONTEXT_WRITE |Solo para uso interno. <br />**Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|ASYNC_SOCKETDUP_IO |Solo para uso interno. <br />**Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|BLOB_METADATA |Solo para uso interno. <br />**Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|BROKER_DISPATCHER |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|BROKER_FORWARDER |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|BROKER_START |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|BROKER_TASK_SHUTDOWN |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
...
|BROKER_TASK_SUBMIT |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
...
|BROKER_TRANSMISSION_OBJECT |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|BROKER_TRANSMISSION_TABLE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|BROKER_TRANSMISSION_WORK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|CHANGE_TRACKING_WAITFORCHANGES |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|CHECK_SCANNER_MUTEX |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|CHECK_TABLES_INITIALIZATION |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|CHECK_TABLES_SINGLE_SCAN |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|CHECK_TABLES_THREAD_BARRIER |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|CMEMPARTITIONED |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
...
|COLUMNSTORE_BUILD_THROTTLE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|COLUMNSTORE_COLUMNDATASET_SESSION_LIST |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|COMMIT_TABLE |Solo para uso interno.| 
|CONNECTION_ENDPOINT_LOCK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|COUNTRECOVERYMGR |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|CREATE_DATINISERVICE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|DBCC_SCALE_OUT_EXPR_CACHE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|DBSEEDING_FLOWCONTROL |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|DBSEEDING_OPERATION |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
...
|DIRECTLOGCONSUMER_LIST |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|DIRTY_PAGE_POLL |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|DIRTY_PAGE_SYNC |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|DIRTY_PAGE_TABLE_LOCK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|DISPATCHER_PRIORITY_QUEUE_SEMAPHORE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|DPT_ENTRY_LOCK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|DROP_DATABASE_TIMER_TASK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
...
|DTCNEW_ENLIST |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|DTCNEW_PREPARE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|DTCNEW_RECOVERY |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|DTCNEW_TM |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|DTCNEW_TRANSACTION_ENLISTMENT |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|DTCPNTSYNC |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|ENABLE_EMPTY_VERSIONING |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|EXTERNAL_RG_UPDATE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|EXTERNAL_SCRIPT_NETWORK_IO |Solo para uso interno. <br /> **Se aplica a**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] hasta el actual.| 
|EXTERNAL_SCRIPT_PREPARE_SERVICE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|EXTERNAL_SCRIPT_SHUTDOWN |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|EXTERNAL_WAIT_ON_LAUNCHER, |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|FABRIC_HADR_TRANSPORT_CONNECTION |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|FABRIC_REPLICA_CONTROLLER_LIST |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|FABRIC_REPLICA_CONTROLLER_STATE_AND_CONFIG |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|FABRIC_REPLICA_PUBLISHER_EVENT_PUBLISH |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|FABRIC_REPLICA_PUBLISHER_SUBSCRIBER_LIST |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|FABRIC_WAIT_FOR_BUILD_REPLICA_EVENT_PROCESSING |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
...
|FEATURE_SWITCHES_UPDATE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|FFT_NSO_DB_KILL_FLAG |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|FFT_NSO_DB_LIST |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|FFT_NSO_FCB |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|FFT_NSO_FCB_FIND |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|FFT_NSO_FCB_PARENT |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|FFT_NSO_FCB_RELEASE_CACHED_ENTRIES |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|FFT_NSO_FCB_STATE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|FFT_NSO_FILEOBJECT |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|FFT_NSO_TABLE_LIST |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|FFT_NTFS_STORE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|FFT_RECOVERY |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|FFT_RSFX_COMM |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|FFT_RSFX_WAIT_FOR_MEMORY |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|FFT_STARTUP_SHUTDOWN |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|FFT_STORE_DB |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|FFT_STORE_ROWSET_LIST |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|FFT_STORE_TABLE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|FILE_VALIDATION_THREADS |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|FILESTREAM_CACHE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|FILESTREAM_CHUNKER |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|FILESTREAM_CHUNKER_INIT |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|FILESTREAM_FCB |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|FILESTREAM_FILE_OBJECT |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|FILESTREAM_WORKITEM_QUEUE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|FILETABLE_SHUTDOWN |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|FOREIGN_REDO |Solo para uso interno. <br /> **Se aplica a**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] hasta el actual.| 
|FORWARDER_TRANSITION |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|FT_MASTER_MERGE_COORDINATOR |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|FT_PROPERTYLIST_CACHE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|GDMA_GET_RESOURCE_OWNER |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|GHOSTCLEANUP_UPDATE_STATS |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] y versiones posteriores.| 
|GHOSTCLEANUPSYNCMGR |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|GLOBAL_QUERY_CANCEL |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] y versiones posteriores.| 
|GLOBAL_QUERY_CLOSE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|GLOBAL_QUERY_CONSUMER |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] y versiones posteriores.| 
|GLOBAL_QUERY_PRODUCER |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] y versiones posteriores.| 
|GLOBAL_TRAN_CREATE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|GLOBAL_TRAN_UCS_SESSION |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|HADR_AR_UNLOAD_COMPLETED |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|HADR_CONNECTIVITY_INFO |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|HADR_DATABASE_WAIT_FOR_RECOVERY |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|HADR_DBSEEDING |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|HADR_DBSEEDING_LIST |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
...
|HADR_FABRIC_CALLBACK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
...
|HADR_FILESTREAM_PREPROC |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|HADR_SEEDING_CANCELLATION |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|HADR_SEEDING_FILE_LIST |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|HADR_SEEDING_LIMIT_BACKUPS |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|HADR_SEEDING_SYNC_COMPLETION |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|HADR_SEEDING_TIMEOUT_TASK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|HADR_SEEDING_WAIT_FOR_COMPLETION |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|HADR_THROTTLE_LOG_RATE_GOVERNOR |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|HADR_THROTTLE_LOG_RATE_LOG_SIZE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] y versiones posteriores.| 
|HADR_THROTTLE_LOG_RATE_SEEDING |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] y versiones posteriores.| 
|HADR_THROTTLE_LOG_RATE_SEND_RECV_QUEUE_SIZE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] y versiones posteriores.| 
...
|HCCO_CACHE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|HK_RESTORE_FILEMAP |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|HKCS_PARALLEL_MIGRATION |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|HKCS_PARALLEL_RECOVERY |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|HTTP_STORAGE_CONNECTION |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|IMPPROV_IOWAIT |Se produce cuando SQL Server espera a que finalice una e/s de carga masiva.| 
|INSTANCE_LOG_RATE_GOVERNOR |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|IO_QUEUE_LIMIT |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|LOG_POOL_SCAN |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|LOG_RATE_GOVERNOR |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|LOGCAPTURE_LOGPOOLTRUNCPOINT |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|LOGMGR_PMM_LOG |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|LOGPOOL_CACHESIZE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|LOGPOOL_CONSUMER |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|LOGPOOL_CONSUMERSET |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|LOGPOOL_FREEPOOLS |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|LOGPOOL_MGRSET |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|LOGPOOL_REPLACEMENTSET |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|LOGPOOLREFCOUNTEDOBJECT_REFDONE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|LOWFAIL_MEMMGR_QUEUE |Tiene lugar mientras se espera que haya memoria disponible para su uso.| 
|MD_AGENT_YIELD |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|MD_LAZYCACHE_RWLOCK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|MEMORY_GRANT_UPDATE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] y versiones posteriores.| 
|METADATA_LAZYCACHE_RWLOCK |Solo para uso interno. <br /> Solo **se aplica a**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] . |  
|MIGRATIONBUFFER |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] y versiones posteriores.| 
...
|NETWORKSXMLMGRLOAD |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|PARALLEL_REDO_DRAIN_WORKER |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|PARALLEL_REDO_FLOW_CONTROL |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|PARALLEL_REDO_LOG_CACHE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|PARALLEL_REDO_TRAN_LIST |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|PARALLEL_REDO_TRAN_TURN |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|PARALLEL_REDO_WORKER_SYNC |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|PARALLEL_REDO_WORKER_WAIT_WORK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|PERFORMANCE_COUNTERS_RWLOCK |Solo para uso interno.| 
|PHYSICAL_SEEDING_DMV |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|POOL_LOG_RATE_GOVERNOR |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|PREEMPTIVE_HTTP_EVENT_WAIT |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|PREEMPTIVE_HTTP_REQUEST |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|PREEMPTIVE_OS_GETFINALFILEPATHBYHANDLE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|PREEMPTIVE_OS_PDH_WMI_INIT |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|PREEMPTIVE_OS_PIPEOPS |Solo para uso interno.| 
|PREEMPTIVE_OS_PROCESSOPS |Solo para uso interno.| 
|PREEMPTIVE_OS_QUERYCONTEXTATTRIBUTES |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|PREEMPTIVE_OS_SQMLAUNCH |Solo para uso interno. <br /> **Se aplica a**: desde [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] hasta [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)]. |  
|PREEMPTIVE_OS_VERIFYSIGNATURE |Solo para uso interno.| 
|PREEMPTIVE_OS_VERIFYTRUST |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|PREEMPTIVE_SP_SERVER_DIAGNOSTICS |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|PREEMPTIVE_XE_CX_FILE_OPEN |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|PREEMPTIVE_XE_CX_HTTP_CALL |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
...
|PRU_ROLLBACK_DEFERRED |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|PWAIT_ALL_COMPONENTS_INITIALIZED |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|PWAIT_COOP_SCAN |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|PWAIT_DIRECTLOGCONSUMER_GETNEXT |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|PWAIT_EVENT_SESSION_INIT_MUTEX |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|PWAIT_FABRIC_REPLICA_CONTROLLER_DATA_LOSS |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|PWAIT_HADR_ACTION_COMPLETED |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|PWAIT_HADR_FAILOVER_COMPLETED |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|PWAIT_HADR_JOIN |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
...
|PWAIT_HADR_SERVER_READY_CONNECTIONS |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|PWAIT_HADRSIM |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|PWAIT_LOG_CONSOLIDATION_IO |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|PWAIT_LOG_CONSOLIDATION_POLL |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
...
|PWAIT_PREEMPTIVE_APP_USAGE_TIMER |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] y versiones posteriores.| 
|PWAIT_PREEMPTIVE_AUDIT_ACCESS_WINDOWSLOG |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|PWAIT_QRY_BPMEMORY |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|PWAIT_REPLICA_ONLINE_INIT_MUTEX |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|PWAIT_RESOURCE_SEMAPHORE_FT_PARALLEL_QUERY_SYNC |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|PWAIT_SBS_FILE_OPERATION |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] y versiones posteriores.| 
|PWAIT_XTP_FSSTORAGE_MAINTENANCE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|PWAIT_XTP_HOST_STORAGE_WAIT |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|QDS_ASYNC_CHECK_CONSISTENCY_TASK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|QDS_ASYNC_PERSIST_TASK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|QDS_ASYNC_PERSIST_TASK_START |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|QDS_ASYNC_QUEUE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|QDS_BCKG_TASK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|QDS_BLOOM_FILTER |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|QDS_CLEANUP_STALE_QUERIES_TASK_MAIN_LOOP_SLEEP |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|QDS_CTXS |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|QDS_DB_DISK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|QDS_DYN_VECTOR |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|QDS_EXCLUSIVE_ACCESS |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|QDS_HOST_INIT |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] y versiones posteriores.| 
|QDS_LOADDB |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|QDS_PERSIST_TASK_MAIN_LOOP_SLEEP |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|QDS_QDS_CAPTURE_INIT |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|QDS_SHUTDOWN_QUEUE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|QDS_STMT |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|QDS_STMT_DISK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|QDS_TASK_SHUTDOWN |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|QDS_TASK_START |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|QE_WARN_LIST_SYNC |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
...
|QRY_PARALLEL_THREAD_MUTEX |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|QRY_PROFILE_LIST_MUTEX |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|QUERY_TASK_ENQUEUE_MUTEX |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|RBIO_WAIT_VLF |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] y versiones posteriores.| 
...
|RECOVERY_MGR_LOCK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|REDO_THREAD_PENDING_WORK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|REDO_THREAD_SYNC |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|REMOTE_BLOCK_IO |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] y versiones posteriores.| 
|REMOTE_DATA_ARCHIVE_MIGRATION_DMV |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|REMOTE_DATA_ARCHIVE_SCHEMA_DMV |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|REMOTE_DATA_ARCHIVE_SCHEMA_TASK_QUEUE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|REPL_TRANFSINFO_ACCESS |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|REPL_TRANHASHTABLE_ACCESS |Solo para uso interno.| 
|REPL_TRANTEXTINFO_ACCESS |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|RESERVED_MEMORY_ALLOCATION_EXT |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|RESMGR_THROTTLED |Tiene lugar cuando entra una nueva solicitud y se acelera basándose en GROUP_MAX_REQUESTS.| 
|RESOURCE_GOVERNOR_IDLE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|RESTORE_FILEHANDLECACHE_ENTRYLOCK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|RESTORE_FILEHANDLECACHE_LOCK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|RG_RECONFIG |Solo para uso interno.| 
|ROWGROUP_OP_STATS |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|ROWGROUP_VERSION |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|RTDATA_LIST |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|SATELLITE_CARGO |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|SATELLITE_SERVICE_SETUP |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|SATELLITE_TASK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|SBS_DISPATCH |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] y versiones posteriores.| 
|SBS_RECEIVE_TRANSPORT |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] y versiones posteriores.| 
|SBS_TRANSPORT |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] y versiones posteriores.| 
|SCAN_CHAR_HASH_ARRAY_INITIALIZATION |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|SECURITY_CNG_PROVIDER_MUTEX |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] y versiones posteriores.| 
|SECURITY_CRYPTO_CONTEXT_MUTEX |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|SECURITY_DBE_STATE_MUTEX |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|SECURITY_KEYRING_RWLOCK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|SECURITY_RULETABLE_MUTEX |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|SEMPLAT_DSI_BUILD |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|SEQUENCE_GENERATION |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|SERVER_RECONFIGURE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|SESSION_WAIT_STATS_CHILDREN |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|SHARED_DELTASTORE_CREATION |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|SLEEP_BUFFERPOOL_HELPLW |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|SLEEP_MASTERDBREADY |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|SLEEP_MASTERMDREADY |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|SLEEP_MASTERUPGRADED |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|SLEEP_MEMORYPOOL_ALLOCATEPAGES |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|SLEEP_MSDBSTARTUP |Tiene lugar cuando Seguimiento de SQL espera a que la base de datos msdb complete su inicio.| 
|SLEEP_RETRY_VIRTUALALLOC |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|SLEEP_WORKSPACE_ALLOCATEPAGE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|SLO_UPDATE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|SMSYNC |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|SNI_CONN_DUP |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
...
|SNI_WRITE_ASYNC |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] y versiones posteriores.| 
...
|SOCKETDUPLICATEQUEUE_CLEANUP |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|SOS_MEMORY_TOPLEVELBLOCKALLOCATOR |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|SP_PREEMPTIVE_SERVER_DIAGNOSTICS_SLEEP |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|SP_SERVER_DIAGNOSTICS_BUFFER_ACCESS |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|SP_SERVER_DIAGNOSTICS_INIT_MUTEX |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|SP_SERVER_DIAGNOSTICS_SLEEP |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|SQLTRACE_FILE_READ_IO_COMPLETION |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|SQLTRACE_FILE_WRITE_IO_COMPLETION |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|SQLTRACE_INCREMENTAL_FLUSH_SLEEP |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|SQLTRACE_LOCK |Solo para uso interno. <br /> Solo **se aplica a**: [!INCLUDE[ssKilimanjaro_md](../../includes/sskilimanjaro-md.md)] . |  
|SQLTRACE_PENDING_BUFFER_WRITERS |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|STARTUP_DEPENDENCY_MANAGER |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|TDS_BANDWIDTH_STATE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|TDS_INIT |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|TDS_PROXY_CONTAINER |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|TEMPORAL_BACKGROUND_PROCEED_CLEANUP |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] y versiones posteriores.| 
|TERMINATE_LISTENER |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|UCS_ENDPOINT_CHANGE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|UCS_MANAGER |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|UCS_MEMORY_NOTIFICATION |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|UCS_SESSION_REGISTRATION |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|UCS_TRANSPORT |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|UCS_TRANSPORT_STREAM_CHANGE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|VDI_CLIENT_COMPLETECOMMAND |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|VDI_CLIENT_GETCOMMAND |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|VDI_CLIENT_OPERATION |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|VDI_CLIENT_OTHER |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|VERSIONING_COMMITTING |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|WAIT_SCRIPTDEPLOYMENT_REQUEST |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|WAIT_SCRIPTDEPLOYMENT_WORKER |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|WAIT_XLOGREAD_SIGNAL |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] y versiones posteriores.| 
|WAIT_XTP_ASYNC_TX_COMPLETION |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|WAIT_XTP_CKPT_AGENT_WAKEUP |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
...
|WAIT_XTP_COMPILE_WAIT |Solo para uso interno. <br /> **Se aplica a**: [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] y versiones posteriores.| 
...
|WAIT_XTP_OFFLINE_CKPT_BEFORE_REDO |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
...
|WAIT_XTP_SERIAL_RECOVERY |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] y versiones posteriores.| 
|WAIT_XTP_SWITCH_TO_INACTIVE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|WAITFOR_PER_QUEUE |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|WINDOW_AGGREGATES_MULTIPASS |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|WINFAB_API_CALL |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|WINFAB_REPLICA_BUILD_OPERATION |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|WINFAB_REPORT_FAULT |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
...
|XDB_CONN_DUP_HASH |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|XDES_HISTORY |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|XDES_OUT_OF_ORDER_LIST |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|XDES_SNAPSHOT |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|XDESTSVERMGR |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|XE_CALLBACK_LIST |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
|XE_CX_FILE_READ |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
...
|XE_FILE_TARGET_TVF |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|XE_LIVE_TARGET_TVF |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL12](../../includes/sssql11-md.md)] y versiones posteriores.| 
...
|XIO_CREDENTIAL_MGR_RWLOCK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|XIO_CREDENTIAL_RWLOCK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|XIO_EDS_MGR_RWLOCK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] y versiones posteriores.| 
|XIO_EDS_RWLOCK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] y versiones posteriores.| 
|XIO_IOSTATS_BLOBLIST_RWLOCK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] y versiones posteriores.| 
|XIO_IOSTATS_FCBLIST_RWLOCK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQLv14_md](../../includes/sssqlv14-md.md)] y versiones posteriores.| 
|XIO_LEASE_RENEW_MGR_RWLOCK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|XTP_HOST_DB_COLLECTION |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|XTP_HOST_LOG_ACTIVITY |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] y versiones posteriores.| 
|XTP_HOST_PARALLEL_RECOVERY |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|XTP_PREEMPTIVE_TASK |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
|XTP_TRUNCATION_LSN |Solo para uso interno. <br /> **Válido para** : [!INCLUDE[ssSQL15_md](../../includes/sssql15-md.md)] y versiones posteriores.| 
