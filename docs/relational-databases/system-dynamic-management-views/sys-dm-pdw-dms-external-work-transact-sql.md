...
|dms_step_index|**int**|Paso actual en el plan DMS.<br /><br /> request_id, step_index y dms_step_index forman la clave para esta vista.|Same as dms___step_index in [sys.dm_pdw_dms_workers &#40;Transact-SQL&#41;](../../relational-databases/system-dynamic-management-views/sys-dm-pdw-dms-workers-transact-sql.md).|  
