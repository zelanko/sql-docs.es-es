---
title: Sys. DM _ _pdw_nodes_exec_query_plan (Transact-SQL) | Microsoft Docs
...
Se aplican los mismos comentarios en [Sys. DM _ _exec_query_plan](https://docs.microsoft.com/sql/relational-databases/system-dynamic-management-views/sys-dm-exec-query-plan-transact-sql?view=sql-server-ver15) .  
