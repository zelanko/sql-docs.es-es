---
title: Sys. DM _ _pdw_nodes_exec_text_query_plan (Transact-SQL) | Microsoft Docs
...
---
# <a name="sysdm_pdw_nodes_exec_text_query_plan--transact-sql"></a>Sys. DM _ _pdw_nodes_exec_text_query_plan (Transact-SQL)
...
|**objectid**|**int**|Identificador del objeto (por ejemplo, procedimiento almacenado o función definida por el usuario) de este plan de consulta. En los lotes ad hoc y preparados, esta columna es **null**.<br /><br /> Esta columna acepta valores NULL.|  
|**number**|**smallint**|Entero de procedimiento almacenado numerado. En los lotes ad hoc y preparados, esta columna es **null**.<br /><br /> Esta columna acepta valores NULL.| 
