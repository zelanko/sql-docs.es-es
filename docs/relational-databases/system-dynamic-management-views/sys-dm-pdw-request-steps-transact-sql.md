...
|-----------------|---------------|-----------------|-----------|  
|request_id|**nvarchar(32)**|request_id y step_index forman la clave para esta vista.<br /><br /> Identificador numérico único asociado a la solicitud.|See request_id in [sys.dm_pdw_exec_requests &#40;Transact-SQL&#41;](../../relational-databases/system-dynamic-management-views/sys-dm-pdw-exec-requests-transact-sql.md).|  
...
|distribution_type|**nvarchar(32)**|Tipo de distribución que se someterán este paso.|'AllNodes', 'AllDistributions', 'AllComputeNodes', 'ComputeNode', 'Distribution', 'SubsetNodes', 'SubsetDistributions', 'Unspecified'|  
