---
title: Sys.dm_xe_database_session_targets (base de datos de SQL Azure) | Documentos de Microsoft
ms.custom: ''
ms.date: 06/10/2016
ms.prod: ''
...
ms.locfileid: "34466021"
---
# <a name="sysdmxedatabasesessiontargets-azure-sql-database"></a>Sys.dm_xe_database_session_targets (base de datos de SQL Azure)
