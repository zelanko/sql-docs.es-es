---
title: Funciones (Transact-SQL) de grupos de disponibilidad AlwaysOn | Documentos de Microsoft
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
...
ms.locfileid: "33223760"
---
# <a name="always-on-availability-groups-functions-transact-sql"></a>Funciones (Transact-SQL) de grupos de disponibilidad AlwaysOn
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]

  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] proporciona las siguientes funciones de grupos de disponibilidad AlwaysOn.  
