 ...
 *column_list*  
 ...
 \*  
 Especifica que todas las columnas que se han registrado para la búsqueda de texto completo se deben usar para buscar el determinado *freetext_string*. A menos que *language_term* se especifica, el idioma de todas las columnas indizadas de texto completo en la tabla debe ser el mismo.  
