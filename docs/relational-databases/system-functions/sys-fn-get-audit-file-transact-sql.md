...
| data_sensitivity_information | nvarchar(4000) | **Se aplica a**: solo Azure SQL dB<br /><br /> Tipos de información y etiquetas de confidencialidad devueltas por la consulta auditada, en función de las columnas clasificadas en la base de datos. Más información sobre [Azure SQL Database la detección y la clasificación de datos](https://docs.microsoft.com/azure/sql-database/sql-database-data-discovery-and-classification) |
