 ...
 *securable*  
 Es el nombre del elemento protegible. Si el elemento protegible es el servidor o una base de datos, este valor debe establecerse en NULL. *elemento protegible* es una expresión escalar de tipo **sysname**. *elemento protegible* puede ser un nombre de varias partes.  
