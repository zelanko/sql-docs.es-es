---
title: Funciones del sistema (Transact-SQL) | Documentos de Microsoft
ms.custom: 
ms.date: 11/02/2016
...
## <a name="in-this-section"></a>En esta sección  
 [Funciones de grupos de disponibilidad AlwaysOn](../../relational-databases/system-functions/always-on-availability-groups-functions-transact-sql.md)  
 ...
 [Las funciones de seguimiento de cambios](../../relational-databases/system-functions/change-tracking-functions-transact-sql.md)  
 [Funciones de recopilador de datos](../../relational-databases/system-functions/data-collector-functions-transact-sql.md)  
