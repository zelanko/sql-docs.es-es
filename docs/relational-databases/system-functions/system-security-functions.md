---
description: Funciones de seguridad del sistema
title: Funciones de seguridad del sistema | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "88427747"
---
# <a name="system-security-functions"></a>Funciones de seguridad del sistema
[!INCLUDE [SQL Server](../../includes/applies-to-version/sqlserver.md)]

  [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] proporciona las siguientes funciones de seguridad del sistema.  
