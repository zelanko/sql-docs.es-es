...
|MODULE_CATALOG|**nvarchar (** 128 **)**|NULL. Reservado para su uso en el futuro:|  
|MODULE_SCHEMA|**nvarchar (** 128 **)**|NULL. Reservado para su uso en el futuro:|  
|MODULE_NAME|**nvarchar (** 128 **)**|NULL. Reservado para su uso en el futuro:|  
|UDT_CATALOG|**nvarchar (** 128 **)**|NULL. Reservado para su uso en el futuro:|  
|UDT_SCHEMA|**nvarchar (** 128 **)**|NULL. Reservado para su uso en el futuro:|  
|UDT_NAME|**nvarchar (** 128 **)**|NULL. Reservado para su uso en el futuro:|  
...
|TYPE_UDT_CATALOG|**nvarchar (** 128 **)**|NULL. Reservado para su uso en el futuro:|  
|TYPE_UDT_SCHEMA|**nvarchar (** 128 **)**|NULL. Reservado para su uso en el futuro:|  
|TYPE_UDT_NAME|**nvarchar (** 128 **)**|NULL. Reservado para su uso en el futuro:|  
...
|MAXIMUM_CARDINALITY|**BIGINT**|NULL. Reservado para su uso en el futuro:|  
|DTD_IDENTIFIER|**nvarchar (** 128 **)**|NULL. Reservado para su uso en el futuro:|  
...
|EXTERNAL_NAME|**nvarchar (** 128 **)**|NULL. Reservado para su uso en el futuro:|  
|EXTERNAL_LANGUAGE|**nvarchar (** 30 **)**|NULL. Reservado para su uso en el futuro:|  
|PARAMETER_STYLE|**nvarchar (** 30 **)**|NULL. Reservado para su uso en el futuro:|  
...
|SQL_PATH|**nvarchar (** 128 **)**|NULL. Reservado para su uso en el futuro:|  
