...
# [Reglas de firewall (Azure SQL Database)](firewall-rules-stored-procedures-azure-sql-database.md)  
...
# [Búsqueda de texto completo y búsqueda semántica](full-text-search-and-semantic-search-stored-procedures-transact-sql.md)  
...
## [Sintaxis de jerarquía de objetos](object-hierarchy-syntax-transact-sql.md)  
...
# [Stretch Database extendido](stretch-database-extended-stored-procedures-transact-sql.md)  
