# [Información general](system-stored-procedures-transact-sql.md)  
# [Índices espaciales](spatial-index-stored-procedures-arguments-and-properties.md)  
...
# Tablas temporales
## [Tabla temporal - sys.sp_cleanup_temporal_history](temporal-table-sys-sp-cleanup-temporal-history.md)  
## [Tabla temporal - sp_xtp_flush_temporal_history](temporal-table-sp-xtp-flush-temporal-history.md)  
# Copia de seguridad de instantánea
## [Copia de seguridad de instantánea: sp_delete_backup_file_snapshot](snapshot-backup-sp-delete-backup-file-snapshot.md)  
## [Copia de seguridad de instantánea: sp_delete_backup](snapshot-backup-sp-delete-backup.md)  
# PolyBase
## [Procedimientos almacenados de PolyBase - sp_polybase_join_group](polybase-stored-procedures-sp-polybase-join-group.md)  
## [Procedimientos almacenados de PolyBase - sp_polybase_leave_group](polybase-stored-procedures-sp-polybase-leave-group.md)  
# FileStream y Filetable
## [FileStream y FileTable - sp_filestream_force_garbage_collection](filestream-and-filetable-sp-filestream-force-garbage-collection.md)  
## [FileStream y FileTable - sp_kill_filestream_non_transacted_handles](filestream-and-filetable-sp-kill-filestream-non-transacted-handles.md)  
...
# [Captura de datos modificados](change-data-capture-stored-procedures-transact-sql.md)  
...
## [Sys.sp_mscdc_capture_job](sys-sp-cdc-scan-transact-sql.md)  
...
## [sp_se](sp-prepexecrpc-transact-sql.md)  
## [sp_unprepare](sp-unprepare-transact-sql.md)  
# [Recopilador de datos](data-collector-stored-procedures-transact-sql.md)  
...
## [sp_syscollector_delete_collection_set se](sp-syscollector-delete-collection-set-transact-sql.md)  
...
## [sp_syscollector_update_collection_set se](sp-syscollector-update-collection-set-transact-sql.md)  
...
# [Motor de base de datos](database-engine-stored-procedures-transact-sql.md)  
...
## [sp_execute_remote (base de datos de SQL Azure)](sp-execute-remote-azure-sql-database.md)  
...
## [enlace del valor predeterminado](sp-unbindefault-transact-sql.md)  
...
# [Correo electrónico de base de datos](database-mail-stored-procedures-transact-sql.md)  
...
# [Plan de mantenimiento de bases de datos](database-maintenance-plan-stored-procedures-transact-sql.md)  
...
# [Consultas distribuidas](distributed-queries-stored-procedures-transact-sql.md)  
...
# [Reglas de Firewall (base de datos SQL Azure)](firewall-rules-stored-procedures-azure-sql-database.md)  
## [sp_set_firewall_rule (base de datos de SQL Azure)](sp-set-firewall-rule-azure-sql-database.md)  
## [sp_set_database_firewall_rule (base de datos de SQL Azure)](sp-set-database-firewall-rule-azure-sql-database.md)  
## [sp_delete_firewall_rule (base de datos de SQL Azure)](sp-delete-firewall-rule-azure-sql-database.md)  
## [sp_delete_database_firewall_rule (base de datos de SQL Azure)](sp-delete-database-firewall-rule-azure-sql-database.md)  
# [Búsqueda de texto completo y la búsqueda semántica](full-text-search-and-semantic-search-stored-procedures-transact-sql.md)  
...
# [Extendidos generales](general-extended-stored-procedures-transact-sql.md)  
...
# [Trasvase de registros](log-shipping-stored-procedures-transact-sql.md)  
...
# [Copia de seguridad administrada](managed-backup-stored-procedures-transact-sql.md)  
...
# [Almacén de administración de datos](management-data-warehouse-stored-procedures-transact-sql.md)  
...
# [Automatización OLE](ole-automation-stored-procedures-transact-sql.md)  
## [Sintaxis de la jerarquía de objetos](object-hierarchy-syntax-transact-sql.md)  
...
# [Administración basada en directivas](policy-based-management-stored-procedures-transact-sql.md)  
...
# [Almacén de consultas](query-store-stored-procedures-transact-sql.md)  
...
# [Seguridad](security-stored-procedures-transact-sql.md)  
...
# [Almacenamiento de datos SQL](sql-data-warehouse-stored-procedures.md)  
...
# [Agente SQL Server](sql-server-agent-stored-procedures-transact-sql.md)  
...
# [Base de datos extendido de Stretch](stretch-database-extended-stored-procedures-transact-sql.md)  
## [Sys.sp_rda_deauthorize_db](sys-sp-rda-deauthorize-db-transact-sql.md)  
## [Sys.sp_rda_set_rpo_duration](sys-sp-rda-get-rpo-duration-transact-sql.md)  
...
# [Replicación](replication-stored-procedures-transact-sql.md)  
...
## [procedimiento sp_helppublication](sp-helppublication-transact-sql.md)  
