---
title: Correo electrónico de base de datos procedimientos almacenados (Transact-SQL) | Documentos de Microsoft
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]
  ...
  [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] admite el sistema siguiente procedimientos almacenados que se usan para realizar operaciones de correo electrónico desde dentro de una instancia de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
