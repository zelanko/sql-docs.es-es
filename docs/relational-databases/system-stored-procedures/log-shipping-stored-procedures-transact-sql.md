---
description: Procedimientos almacenados del trasvase de registros (Transact-SQL)
title: Procedimientos almacenados de trasvase de registros (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
