...
##  <a name="Arguments"></a> Argumentos  
 @enable_backup  
 Habilite o deshabilite [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)] para la base de datos especificada. El @enable_backup es **bit**. Parámetro necesario al configurar [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)] para la primera instancia de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]. Si va a cambiar una configuración de [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)] existente, este parámetro es opcional. En ese caso, los valores de configuración no especificados conservan sus valores existentes.  
...
```  
 ...
 En el ejemplo siguiente se habilita [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)] para la instancia de SQL Server en la que se ejecuta, se establece la Directiva de retención en 30 días, se establece el destino en un contenedor denominado ' ' en una cuenta de almacenamiento denominada ' mystorageaccount '.  
