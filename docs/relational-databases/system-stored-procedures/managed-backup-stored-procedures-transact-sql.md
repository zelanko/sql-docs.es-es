---
title: Administrar copia de seguridad de procedimientos almacenados (Transact-SQL) | Documentos de Microsoft
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "33236420"
---
# <a name="managed-backup-stored-procedures-transact-sql"></a>Procedimientos almacenados copia de seguridad administrados (Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2016-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2016-xxxx-xxxx-xxx-md.md)]

  Los siguientes procedimientos almacenados que pueden usarse para configurar [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)].  
