---
title: Administra los procedimientos almacenados copia de seguridad (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
[!INCLUDE[tsql-appliesto-ss2016-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2016-xxxx-xxxx-xxx-md.md)]
  ...
  Los siguientes procedimientos almacenados se pueden usar para configurar [!INCLUDE[ss_smartbackup](../../includes/ss-smartbackup-md.md)].  
