---
description: Procedimientos almacenados de almacén de administración de datos (Transact-SQL)
title: Procedimientos almacenados del almacén de administración de datos (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/03/2017
ms.prod: sql
...
ms.locfileid: "97440576"
---
# <a name="management-data-warehouse-stored-procedures-transact-sql"></a>Procedimientos almacenados de almacén de administración de datos (Transact-SQL)
[!INCLUDE [sql-asdb-asdbmi-asa-pdw](../../includes/applies-to-version/sql-asdb-asdbmi-asa-pdw.md)]

  El recopilador de datos almacena los datos y la información de tipos de recopilador de datos en el almacén de administración de datos. Los procedimientos almacenados siguientes se utilizan para actualizar los datos y cambiar las tablas en el almacén de administración de datos.  
