---
title: Query Store procedimientos (Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 03/29/2016
ms.prod: sql
...
ms.locfileid: "47794463"
---
# <a name="query-store-stored-procedures-transact-sql"></a>Query Store procedimientos (Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2016-asdb-xxxx-xxx-md](../../includes/tsql-appliesto-ss2016-asdb-xxxx-xxx-md.md)]

  Esta sección contiene los siguientes procedimientos almacenados utilizados para configurar el almacén de consultas.  
