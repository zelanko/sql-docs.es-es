...
## <a name="arguments"></a>Argumentos  
 [  **@name=**] **'***nombre***'**  
 Nombre del grupo de servidores que se va a crear. *nombre* es **sysname**, no tiene ningún valor predeterminado. *nombre* no puede contener comas.  
