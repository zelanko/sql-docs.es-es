...
`[ @server_name = ] 'server_name'` El nombre del servidor que se debe agregar al grupo especificado. *nombre_servidor* es **nvarchar (30)**, no tiene ningún valor predeterminado.  
