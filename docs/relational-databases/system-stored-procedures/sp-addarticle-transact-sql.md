...
`[ @destination_table = ] 'destination_table'`Es el nombre de la tabla de destino (suscripción), si es diferente de *source_table*o el procedimiento almacenado. *destination_table* es de **tipo sysname y su**valor predeterminado es null, lo que significa que *source_table* es igual a *destination_table * *.*  
...
|**vista indizada logbased**|Artículo de vista indizada basado en registro. No es compatible con publicadores de Oracle. En este tipo de artículo, no es necesario que la tabla base se publique por separado.|  
...
|**logbased** predeterminada|Artículo basado en registro.|  
...
|**solo esquema de procedimientos**|Procedimiento con solo esquema. No es compatible con publicadores de Oracle.|  
...
|**ver solo el esquema**|Vista con solo esquema. No es compatible con publicadores de Oracle. Si se utiliza esta opción, también debe publicarse la tabla base.|  
...
`[ @ins_cmd = ] 'ins_cmd'`Es el tipo de comando de replicación utilizado al replicar inserciones para este artículo. *ins_cmd* es de tipo **nvarchar (255)** y puede tener uno de los valores siguientes.  
  
|Valor|Descripción|  
|-----------|-----------------|  
|**NONE**|No se realiza ninguna acción.|  
|**LLAMAR a sp_MSins_**<br /> **_tabla_** de  predeterminada<br /><br /> -o bien-<br /><br /> **LLAMAR a custom_stored_procedure_name**|Llama a un procedimiento almacenado que se ejecutará en el suscriptor. Para utilizar este método de replicación, utilice *schema_option* para especificar la creación automática del procedimiento almacenado o cree el procedimiento almacenado especificado en la base de datos de destino de cada suscriptor del artículo. *custom_stored_procedure* es el nombre de un procedimiento almacenado creado por el usuario. <strong>la*tabla* sp_MSins_</strong> contiene el nombre de la tabla de destino en lugar de la parte *_table* del parámetro. Cuando se especifica *destination_owner* , se antepone al nombre de la tabla de destino. Por ejemplo, para la tabla **ProductCategory** propiedad del esquema **Production** en el suscriptor, el `CALL sp_MSins_ProductionProductCategory`parámetro sería. Para un artículo en una topología de replicación punto a punto, *_table* se anexa con un valor GUID. No se puede especificar *custom_stored_procedure* para los suscriptores de actualización.|  
...
`[ @del_cmd = ] 'del_cmd'`Es el tipo de comando de replicación utilizado al replicar eliminaciones para este artículo. *del_cmd* es de tipo **nvarchar (255)** y puede tener uno de los valores siguientes.  
  
|Valor|Descripción|  
|-----------|-----------------|  
|**NONE**|No se realiza ninguna acción.|  
|**CALLsp_MSdel_**<br /> **_tabla_** de  predeterminada<br /><br /> -o bien-<br /><br /> **LLAMAR a custom_stored_procedure_name**|Llama a un procedimiento almacenado que se ejecutará en el suscriptor. Para utilizar este método de replicación, utilice *schema_option* para especificar la creación automática del procedimiento almacenado o cree el procedimiento almacenado especificado en la base de datos de destino de cada suscriptor del artículo. *custom_stored_procedure* es el nombre de un procedimiento almacenado creado por el usuario. <strong>la*tabla* sp_MSdel_</strong> contiene el nombre de la tabla de destino en lugar de la parte *_table* del parámetro. Cuando se especifica *destination_owner* , se antepone al nombre de la tabla de destino. Por ejemplo, para la tabla **ProductCategory** propiedad del esquema **Production** en el suscriptor, el `CALL sp_MSdel_ProductionProductCategory`parámetro sería. Para un artículo en una topología de replicación punto a punto, *_table* se anexa con un valor GUID. No se puede especificar *custom_stored_procedure* para los suscriptores de actualización.|  
...
`[ @upd_cmd = ] 'upd_cmd'`Es el tipo de comando de replicación utilizado al replicar actualizaciones para este artículo. *upd_cmd* es de tipo **nvarchar (255)** y puede tener uno de los valores siguientes.  
  
|Valor|Descripción|  
|-----------|-----------------|  
|**NONE**|No se realiza ninguna acción.|  
|**LLAMAR a sp_MSupd_**<br /> **_cuadro_**<br /><br /> -o bien-<br /><br /> **LLAMAR a custom_stored_procedure_name**|Llama a un procedimiento almacenado que se ejecutará en el suscriptor. Para utilizar este método de replicación, utilice *schema_option* para especificar la creación automática del procedimiento almacenado o cree el procedimiento almacenado especificado en la base de datos de destino de cada suscriptor del artículo.|  
|**MCALL sp_MSupd_**<br /> **_cuadro_**<br /><br /> -o bien-<br /><br /> **MCALL custom_stored_procedure_name**|Llama a un procedimiento almacenado con parámetros del estilo MCALL. Para utilizar este método de replicación, utilice *schema_option* para especificar la creación automática del procedimiento almacenado o cree el procedimiento almacenado especificado en la base de datos de destino de cada suscriptor del artículo. *custom_stored_procedure* es el nombre de un procedimiento almacenado creado por el usuario. <strong>la*tabla* sp_MSupd_</strong> contiene el nombre de la tabla de destino en lugar de la parte *_table* del parámetro. Cuando se especifica *destination_owner* , se antepone al nombre de la tabla de destino. Por ejemplo, para la tabla **ProductCategory** propiedad del esquema **Production** en el suscriptor, el `MCALL sp_MSupd_ProductionProductCategory`parámetro sería. Para un artículo en una topología de replicación punto a punto, *_table* se anexa con un valor GUID. No se permite especificar un procedimiento almacenado creado por el usuario en suscriptores de actualización.|  
|**ESCALAl sp_MSupd_**<br /> **_tabla_** de  predeterminada<br /><br /> -o bien-<br /><br /> **ESCALAl custom_stored_procedure_name**|Llama a un procedimiento almacenado con parámetros del estilo SCALL. Para utilizar este método de replicación, utilice *schema_option* para especificar la creación automática del procedimiento almacenado o cree el procedimiento almacenado especificado en la base de datos de destino de cada suscriptor del artículo. *custom_stored_procedure* es el nombre de un procedimiento almacenado creado por el usuario. <strong>la*tabla* sp_MSupd_</strong> contiene el nombre de la tabla de destino en lugar de la parte *_table* del parámetro. Cuando se especifica *destination_owner* , se antepone al nombre de la tabla de destino. Por ejemplo, para la tabla **ProductCategory** propiedad del esquema **Production** en el suscriptor, el `SCALL sp_MSupd_ProductionProductCategory`parámetro sería. Para un artículo en una topología de replicación punto a punto, *_table* se anexa con un valor GUID. No se permite especificar un procedimiento almacenado creado por el usuario en suscriptores de actualización.|  
...
|**quitar** predeterminada|Quita la tabla de destino.|  
...
|**0x200000000**|Convierte los tipos de datos de fecha y hora (**Date**, **Time**, **DateTimeOffset**y **datetime2**) introducidos en [!INCLUDE[ssKatmai](../../includes/sskatmai-md.md)] en tipos de datos que se admiten en versiones anteriores de. [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]|  
...
|**0x1000000000**|Convierte los tipos definidos por el usuario (UDT) de Common Language Runtime (CLR) mayores de 8000 bytes a **varbinary (Max)** para que las columnas de tipo UDT se puedan replicar en los suscriptores que [!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)]ejecutan.|  
...
|**0x20000000000**|Replica el atributo SPARSE para las columnas. Para obtener más información sobre este atributo, vea [usar columnas](../../relational-databases/tables/use-sparse-columns.md)dispersas.|  
...
|NULL|La replicación establece automáticamente *schema_option* en un valor predeterminado, cuyo valor depende de otras propiedades de artículo. La tabla "Opciones de esquema predeterminadas" de la sección Notas muestra las opciones de esquema predeterminadas basadas en los tipos de artículo y de replicación.<br /><br /> El valor predeterminado para las[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] publicaciones que no son de es **0x050D3**.|  
  
 No todos los valores de *schema_option* son válidos para todos los tipos de replicación y tipo de artículo. La tabla **Opciones de esquema válidas** de la sección Notas muestra las opciones de esquema válidas que se pueden elegir según la combinación del tipo de artículo y el tipo de replicación.  
...
|La publicación utiliza una copia masiva en modo de carácter para generar la instantánea inicial, que admite suscriptores que no son de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].|No asignado.|  
 ...
 Para admitir suscriptores [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] que no son de, *destination_owner* debe ser null.  
...
`[ @source_owner = ] 'source_owner'`Es el propietario del objeto de origen. *source_owner* es de **tipo sysname y su**valor predeterminado es NULL. *source_owner* debe especificarse para los publicadores de Oracle.  
...
> [!NOTE]  
>  *auto_identity_range* está en desuso y solo se proporciona por motivos de compatibilidad con versiones anteriores. Debe usar *identityrangemanagementoption* para especificar las opciones de administración de intervalos de identidad. Para más información, vea [Replicar columnas de identidad](../../relational-databases/replication/publish/replicate-identity-columns.md).  
 ...
 **1** = se usan las asignaciones de columnas de artículo predeterminadas. Las asignaciones de tipos de datos predeterminadas se pueden mostrar mediante la ejecución de [sp_getdefaultdatatypemapping](../../relational-databases/system-stored-procedures/sp-getdefaultdatatypemapping-transact-sql.md).  
  
 **0** = las asignaciones de columnas de artículo personalizadas están definidas y **sp_addarticle**no llama a [sp_articleview](../../relational-databases/system-stored-procedures/sp-articleview-transact-sql.md) .  
...
-   No se puede especificar un valor de **SQL** para *ins_cmd*, *upd_cmd*y *del_cmd*.  
 ...
 Si *vertical_partition* se establece en **true**, **sp_addarticle** aplaza la creación de la vista hasta que se llama a [sp_articleview](../../relational-databases/system-stored-procedures/sp-articleview-transact-sql.md) (después de agregar el último [sp_articlecolumn](../../relational-databases/system-stored-procedures/sp-articlecolumn-transact-sql.md) ).  
...
|**vista indizada logbased**|**0x30F3**|**0x3071**|  
|**vista indizada cuadro manualboth**|**0x30F3**|**0x3071**|  
...
|**proc exec**|**0x01**|**0x01**|  
|**solo esquema de procedimientos**|**0x01**|**0x01**|  
|**serializable proc exec**|**0x01**|**0x01**|  
|**ver solo el esquema**|**0x01**|**0x01**|  
  
> [!NOTE]
>  Si una publicación está habilitada para la actualización en cola, se agrega un valor de *schema_option* de **0x80** al valor predeterminado que se muestra en la tabla. El valor predeterminado de *schema_option* para una [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] publicación que no es de es **0x050D3**.  
...
|**vista indizada logbased**|Todas las opciones|Todas las opciones pero **0x02**|  
...
|**vista indizada cuadro manualboth**|Todas las opciones|Todas las opciones pero **0x02**|  
...
|**solo esquema de procedimientos**|**0x01**, **0x20**, **0x2000**, **0x400000**, **0x800000**, **0x2000000**, **0x8000000**, **0x10000000**, **0x20000000**, **0x40000000**y **0x80000000**|**0x01**, **0x20**, **0x2000**, **0x400000**, **0x800000**, **0x2000000**, **0x8000000**, **0x10000000**, **0x20000000**, **0x40000000**y **0x80000000**|  
|**ver solo el esquema**|**0x01**, **0x010**, **0x020**, **0x040**, **0x0100**, **0x2000**, **0x40000**, **0x100000**, **0x200000**, **0x400000**, **0x800000**, **0x2000000**, **0x8000000**, **0x40000000**y **0x80000000**|**0x01**, **0x010**, **0x020**, **0x040**, **0x0100**, **0x2000**, **0x40000**, **0x100000**, **0x200000**, **0x400000**, **0x800000**, **0x2000000**, **0x8000000**, **0x40000000**y **0x80000000**|  
|**solo esquema FUNC**|**0x01**, **0x20**, **0x2000**, **0x400000**, **0x800000**, **0x2000000**, **0x8000000**, **0x10000000**, **0x20000000**, **0x40000000**y **0x80000000**|**0x01**, **0x20**, **0x2000**, **0x400000**, **0x800000**, **0x2000000**, **0x8000000**, **0x10000000**, **0x20000000**, **0x40000000**y **0x80000000**|  
|**solo esquema de vista indizada**|**0x01**, **0x010**, **0x020**, **0x040**, **0x0100**, **0x2000**, **0x40000**, **0x100000**, **0x200000**, **0x400000**, **0x800000**, **0x2000000**, **0x8000000**, **0x40000000**y **0x80000000**|**0x01**, **0x010**, **0x020**, **0x040**, **0x0100**, **0x2000**, **0x40000**, **0x100000**, **0x200000**, **0x400000**, **0x800000**, **0x2000000**, **0x8000000**, **0x40000000**y **0x80000000**|  
  
> [!NOTE]
>  En las publicaciones de actualización en cola, los valores de *schema_option* de **0x8000** y **0x80** deben estar habilitados. Los valores de *schema_option* admitidos para [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] las publicaciones que no son de son: **0x01**, **0x02**, **0x10**, **0x40**, **0x80**, **0x1000**, **0x4000** y **0x8000**.  
