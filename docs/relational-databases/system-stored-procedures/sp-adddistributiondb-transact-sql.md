...
## <a name="arguments"></a>Argumentos  
 ...
 Es el nombre de inicio de sesión utilizado al conectarse al distribuidor para crear la base de datos de distribución. Esto es necesario si *security_mode* está establecido en **0**. *inicio de sesión* es **sysname**, su valor predeterminado es null.  
