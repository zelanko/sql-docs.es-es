...
|Valor|Descripción|  
|-----------|-----------------|  
|**tabla** de predeterminada|Tabla con esquema y datos. La replicación supervisa la tabla para determinar los datos que se van a replicar.|  
...
`[ @status = ] 'status'`Es el estado del artículo. *status* es **nvarchar (10)** y su valor predeterminadoes Unsynced. Si está **activo**, se ejecuta el script de procesamiento inicial para publicar la tabla. Sino está sincronizado, el script de procesamiento inicial para publicar la tabla se ejecutará la próxima vez que se ejecute el agente de instantáneas.  
...
|**quitar** predeterminada|Quita la tabla antes de volver a crearla. Necesario para admitir [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssEW](../../includes/ssew-md.md)] suscriptores.|  
...
|**table**|**0x0C034FD1 y publicaciones compatibles**  -  con versiones posteriores con una instantánea en modo nativo.[!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)]<br /><br /> **0x08034FF1 y publicaciones compatibles**  -  con versiones posteriores con una instantánea en modo de carácter.[!INCLUDE[ssVersion2005](../../includes/ssversion2005-md.md)]|  
