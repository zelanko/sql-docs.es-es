...
|**carácter**|Genera la salida de todas las tablas mediante un programa de copia masiva en modo de caracteres. *Para un publicador de Oracle,* **carácter** *sólo es válido para la replicación de instantáneas*.|  
