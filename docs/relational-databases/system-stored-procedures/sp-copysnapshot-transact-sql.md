 ...
 **sp_copysnapshot** se utiliza en todos los tipos de replicación. Los suscriptores [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] que ejecutan la versión 7,0 y versiones anteriores no pueden usar la ubicación de instantáneas alternativa.  
