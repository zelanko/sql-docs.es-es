 ...
 **sp_copysnapshot** se utiliza en todos los tipos de replicación. Los suscriptores que ejecutan [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] versión 7,0 y versiones anteriores no pueden usar la ubicación de instantáneas alternativa.  
