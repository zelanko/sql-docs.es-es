...
ms.locfileid: "43348496"
---
# <a name="spdropalias-transact-sql"></a>sp_dropalias (Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]

  **sp_dropalias** se quitó por [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]. Para conocer la sintaxis, vea [sp_dropalias (Transact-SQL)](sp-dropalias-transact-sql.md) en la documentación anterior.  
