...
`[ @rolename = ] 'role'` Es el rol de aplicación para quitar. *rol* es un **sysname**, no tiene ningún valor predeterminado. *rol* debe existir en la base de datos actual.  
