...
## <a name="arguments"></a>Argumentos  
 [  **@no_checks=**] *no_checks*  
 Indica si se comprobará si existen objetos dependientes antes de quitar el distribuidor. *no_checks* es **bit**, su valor predeterminado es 0.  
