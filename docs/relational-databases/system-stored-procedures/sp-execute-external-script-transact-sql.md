...
El **sp_execute_external_script** procedimiento almacenado ejecuta un script proporcionado como argumento de entrada para el procedimiento, y se usa con [las extensiones](../../language-extensions/language-extensions-overview.md)de [Machine Learning Services](../../advanced-analytics/index.yml) y de lenguaje. 
...
El **sp_execute_external_script** procedimiento almacenado ejecuta un script proporcionado como argumento de entrada para el procedimiento y se usa con [Machine Learning Services](../../advanced-analytics/index.yml) en SQL Server 2017. 
...
El **sp_execute_external_script** procedimiento almacenado ejecuta un script proporcionado como argumento de entrada para el procedimiento y se usa con [R Services](../../advanced-analytics/r/sql-server-r-services.md) en SQL Server 2016.
