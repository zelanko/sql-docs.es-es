...
## <a name="arguments"></a>Argumentos  
 ...
 Es el nombre del catálogo de texto completo. *fulltext_catalog_name* is **sysname**. Si este parámetro se omite o tiene el valor NULL, se presenta información acerca de todos los catálogos de texto completo asociados con la base de datos actual.  
