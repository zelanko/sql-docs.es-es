...
|**Mensaje**|**nvarchar (1024)**|Mensaje del historial de trabajos o pasos.|  
|**run_status**|**int**|Resultado del trabajo o del paso.|  
|**run_date**|**int**|Fecha en que empezó la ejecución del trabajo o del paso.|  
|**tiempo de ejecución**|**int**|Hora en que empezó la ejecución del trabajo o del paso.|  
...
|**servidores**|**nvarchar (30)**|Servidor en el que se ejecuta el paso o el trabajo. Siempre es (**local**).|  
