---
title: sp_help_log_shipping_monitor_primary (Transact-SQL) | Documentos de Microsoft
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
 ...
 **sp_help_log_shipping_monitor_primary** se debe ejecutar desde la **maestro** base de datos en el servidor de supervisión.  
