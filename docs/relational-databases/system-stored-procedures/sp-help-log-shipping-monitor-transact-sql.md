...
|**servidores**|**sysname**|Nombre del servidor primario o secundario en el que reside esta base de datos.|  
...
|**columnas last_backup_file**|**nvarchar (500)**|Nombre del último archivo de copia de seguridad de registros correcto.<br /><br /> NULL = La información no está disponible o no es relevante.|  
