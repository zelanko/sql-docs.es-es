...
`[ @primary_id = ] 'primary_id'` El identificador de la base de datos principal para la configuración de trasvase de registros. *primary_id* es **uniqueidentifier** y no puede ser NULL.  
...
|**backup_compression**|Indica si se usa la configuración de trasvase de registros [compresión de copia de seguridad](../../relational-databases/backup-restore/backup-compression-sql-server.md).<br /><br /> **0** = disabled. No se comprimen nunca las copias de seguridad de registros.<br /><br /> **1** = habilitado. Se comprimen siempre las copias de seguridad de registros.<br /><br /> **2** = use el valor de la [ver o establecer la opción de configuración del servidor de compresión de copia de seguridad predeterminada](../../database-engine/configure-windows/view-or-configure-the-backup-compression-default-server-configuration-option.md). Este es el valor predeterminado.<br /><br /> La compresión de copia de seguridad solo se admite en [!INCLUDE[ssEnterpriseEd10](../../includes/ssenterpriseed10-md.md)] (o una versión posterior). En otras ediciones, el valor es 2 siempre.|  
...
|**threshold_alert_enabled**|Determina si las alertas de umbral de copia de seguridad están habilitadas.<br /><br /> **1** = habilitado.<br /><br /> **0** = disabled.|  
