...
`[ @dbname = ] 'name'` Es el nombre de la base de datos para el que se notifica la información. *nombre* es **sysname**, no tiene ningún valor predeterminado. Si *nombre* no se especifica, **sp_helpdb** informa sobre todas las bases de datos en el **sys.databases** vista de catálogo.  
...
|**compatibility_level**|**tinyint**|Nivel de compatibilidad de base de datos: 60, 65, 70, 80 o 90.|  
