...
|**valor de identityrangemanagementoption**|**int**|Si está habilitado el control de intervalo de identidad automático; donde **1** está habilitada y **0** está deshabilitado.|  
