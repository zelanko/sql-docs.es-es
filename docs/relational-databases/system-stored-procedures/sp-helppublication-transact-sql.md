...
> [!NOTE]  
>  no se debe especificar el publicador al solicitar información de publicación [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] de un publicador.  
...
|queue_type||Especifica el tipo de cola utilizado. Puede ser uno de estos valores:<br /><br /> **MSMQ** = usar [!INCLUDE[msCoName](../../includes/msconame-md.md)] Message Queue Server para almacenar las transacciones.<br /><br /> **SQL** = se [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] usa para almacenar transacciones.<br /><br /> Nota: Se ha interrumpido la compatibilidad con Message Queue Server.|  
...
|publish_to_AD|**bit**|Especifica si la publicación se publica en el [!INCLUDE[msCoName](../../includes/msconame-md.md)] Active Directory???. Un valor de **1** indica que se ha publicado y un valor de **0** indica que no se ha publicado.|  
...
## <a name="permissions"></a>Permisos  
 ...
 Para un publicador [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] que no es de, solo los miembros del rol fijo de servidor sysadmin en el distribuidor o los miembros del rol fijo de base de datos db_owner en la base de datos de distribución o los usuarios de la PAL pueden ejecutar sp_helppublication.  
