...
|**guid de la suscripción**|**binary (16)**|Identificador global de la versión de la suscripción en la publicación.|  
...
|**publication_type**|**int**|Especifica el tipo de replicación de la publicación:<br /><br /> **0** = la replicación transaccional<br /><br /> **1** = replicación de instantáneas<br /><br /> **2** = la replicación de mezcla|  
