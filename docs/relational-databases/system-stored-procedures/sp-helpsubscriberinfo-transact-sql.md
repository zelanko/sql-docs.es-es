---
title: sp_helpsubscriberinfo (Transact-SQL) | Documentos de Microsoft
ms.custom: 
ms.date: 03/14/2017
...
|**contraseña**|**sysname**|Contraseña de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] autenticación.|  
...
|**frequency_interval**|**int**|Valor que se aplica a la frecuencia establecida *frequency_type*.|  
|**frequency_relative_interval**|**int**|Fecha del agente de distribución utilizada por cuando *frequency_type* está establecido en **32** (mensual relativa):<br /><br /> **1** = primero<br /><br /> **2** = segundo<br /><br /> **4** = tercero<br /><br /> **8** = cuarto<br /><br /> **16** = último|  
...
|**frequency_interval2**|**int**|Valor que se aplica a la frecuencia establecida *frequency_type*.|  
