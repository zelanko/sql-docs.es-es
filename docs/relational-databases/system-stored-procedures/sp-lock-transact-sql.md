...
## <a name="arguments"></a>Argumentos  
 ...
 [  **@spid2 =** ] **'***sesión ID2***'**  
 Es otra [!INCLUDE[ssDE](../../includes/ssde-md.md)] número de Id. de sesión de **sys.dm_exec_sessions** que puede tener un bloqueo al mismo tiempo como *sesión ID1* y sobre la que el usuario también desea obtener información. *sesión ID2* es **int** con un valor predeterminado es null.  
