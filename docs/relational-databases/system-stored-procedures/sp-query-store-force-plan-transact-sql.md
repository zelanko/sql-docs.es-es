...
[!INCLUDE[tsql-appliesto-ss2016-asdb-xxxx-xxx-md](../../includes/tsql-appliesto-ss2016-asdb-xxxx-xxx-md.md)]
 ...
 Cuando se fuerza un plan para una consulta determinada, cada vez [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] que encuentra la consulta, intenta forzar el plan en el optimizador. Si se produce un error al forzar el plan, se desencadena un XEvent y se indica al optimizador que optimice de la manera normal.  
