---
title: sp_revoke_publication_access (Transact-SQL) | Documentos de Microsoft
ms.custom: 
ms.date: 03/04/2017
 ...
 **sp_revoke_publication_access** se utiliza en instantáneas, transaccional y de mezcla.  
  
 **sp_revoke_publication_access** se puede llamar varias veces.  
  
## <a name="permissions"></a>Permissions  
 Solo los miembros de la **sysadmin** rol fijo de servidor o el **db_owner** rol fijo de base de datos puede ejecutar **sp_revoke_publication_access**.  
