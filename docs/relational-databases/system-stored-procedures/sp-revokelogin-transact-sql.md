...
`[ @loginame = ] 'login'` Es el nombre del grupo o usuario de Windows. *inicio de sesión* es **sysname**, no tiene ningún valor predeterminado. *inicio de sesión* puede ser cualquier nombre de usuario de Windows existente o un grupo en el formulario *nombre_equipo*\\*usuario o dominio*\\*usuario*.  
