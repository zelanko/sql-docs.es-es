...
## <a name="arguments"></a>Argumentos  
 En la tabla siguiente se muestran los argumentos y las [!INCLUDE[msCoName](../../includes/msconame-md.md)] opciones admitidos en [!INCLUDE[ssSDSfull](../../includes/sssdsfull-md.md)].  
...
## <a name="remarks"></a>Comentarios  
 ...
 Cuando se agrega una configuración de Firewall de nivel de servidor en la que las direcciones IP inicial y `0.0.0.0`final son iguales a, se [!INCLUDE[ssSDS](../../includes/sssds-md.md)] habilita el acceso al servidor desde Azure. Proporcione un valor al parámetro *Name* que le ayude a recordar para qué sirve la configuración de Firewall de nivel de servidor.  
...
## <a name="examples"></a>Ejemplos  
 En el código siguiente se crea una configuración de Firewall de `Allow Azure` nivel de servidor denominada que habilita el acceso desde Azure. Ejecute lo siguiente en la base de datos maestra virtual.  
...
## <a name="see-also"></a>Vea también  
 ...
 [Cómo: Configurar las opciones del firewall (Azure SQL Database)](https://azure.microsoft.com/documentation/articles/sql-database-configure-firewall-settings/)   
