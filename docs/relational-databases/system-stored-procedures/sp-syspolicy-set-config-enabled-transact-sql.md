...
`[ @value = ] value` Determina si está habilitada la administración basada en directivas. *valor* es **sqlvariant**, y puede tener uno de los siguientes valores:  
