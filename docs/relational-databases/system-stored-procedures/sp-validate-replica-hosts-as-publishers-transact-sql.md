...
`[ @redirected_publisher = ] 'redirected_publisher'` El destino de la redirección cuando **sp_redirect_publisher** llamó para el publicador y publicado original par de base de datos. *redirected_publisher* es **sysname**, no tiene ningún valor predeterminado.  
