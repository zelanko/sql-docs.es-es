...
`[ [ @job_type = ] 'job_type' ]` Tipo de trabajo que desea agregar. *job_type* es **nvarchar (20)** con un valor predeterminado de **capturar**. Las entradas válidas son **capturar** y **limpieza**.  
