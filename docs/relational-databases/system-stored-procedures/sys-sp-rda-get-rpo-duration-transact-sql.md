...
## <a name="remarks"></a>Remarks    
 Para cambiar el valor, ejecute [Sys. &#40;SP_RDA_SET_RPO_DURATION Transact-&#41;SQL](../../relational-databases/system-stored-procedures/sys-sp-rda-set-rpo-duration-transact-sql.md).    
