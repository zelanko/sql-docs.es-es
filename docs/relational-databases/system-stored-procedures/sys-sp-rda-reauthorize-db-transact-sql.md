...
description: Obtenga información sobre cómo usar sys. sp_rda_reauthorize_db para restaurar la conexión autenticada entre una base de datos habilitada para Stretch local y una base de datos remota.
ms.custom: ''
ms.date: 06/10/2016
ms.prod: sql
ms.reviewer: ''
