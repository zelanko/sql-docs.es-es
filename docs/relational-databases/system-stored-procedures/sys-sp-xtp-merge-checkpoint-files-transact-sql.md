...
||  
|-|  
|**Tenga en cuenta**: este procedimiento almacenado está en desuso en [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)]. Ya no es necesario y no se puede usar, iniciando [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)].|  
