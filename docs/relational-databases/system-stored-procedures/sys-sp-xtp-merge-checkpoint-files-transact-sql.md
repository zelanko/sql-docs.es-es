...
||  
|-|  
|**Nota**: este procedimiento almacenado está en desuso en [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)]. Ya no es necesario y no se puede utilizar, a partir [!INCLUDE[ssSQL15](../../includes/sssql15-md.md)]de.|  
