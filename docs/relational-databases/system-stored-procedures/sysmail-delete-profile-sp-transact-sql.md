...
## <a name="arguments"></a>Argumentos  
 ...
 Es el nombre del perfil que se va a eliminar. *nombre_perfil* es **sysname**, su valor predeterminado es null. Cualquier *profile_id* o *profile_name* debe especificarse.  
