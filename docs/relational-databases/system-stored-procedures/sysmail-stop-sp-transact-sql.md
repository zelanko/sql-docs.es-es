...
## <a name="remarks"></a>Observaciones  
 ...
 Para iniciar Correo electrónico de base de datos, utilice **sysmail_start_sp**. Tenga en cuenta que **sp_send_dbmail** sigue aceptando [!INCLUDE[ssSB](../../includes/sssb-md.md)] correo cuando se detienen los objetos.  
