...
## <a name="examples"></a>Ejemplos  
 En el ejemplo siguiente se cambia el número de secuencia `Admin-BackupServer` de la cuenta `AdventureWorks Administrator` en el perfil en la base de datos **msdb** . Tras ejecutar este código, el número de secuencia para la cuenta es `3`, lo que indica que se va a probar si las dos primeras cuentas generan un error.  
