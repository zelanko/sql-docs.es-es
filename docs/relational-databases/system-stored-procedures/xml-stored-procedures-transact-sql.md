---
title: XML procedimientos almacenados (Transact-SQL) | Documentos de Microsoft
ms.custom: ''
ms.date: 03/14/2017
ms.prod: sql
...
ms.locfileid: "33252281"
---
# <a name="xml-stored-procedures-transact-sql"></a>Procedimientos almacenados de XML (Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]

  [!INCLUDE[msCoName](../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] admite el sistema siguiente procedimientos almacenados que se utilizan para la administración de texto XML.  
