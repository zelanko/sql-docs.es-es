# [Información general](system-tables-transact-sql.md)  
# [Tablas de eventos extendidos: trace_xe_action_map](extended-events-tables-trace-xe-action-map.md)  
# [Tablas de eventos extendidos: trace_xe_event_map](extended-events-tables-trace-xe-event-map.md)  
# [Tablas de aplicación de capa de datos: sysdac_history_internal](data-tier-application-tables-sysdac-history-internal.md)  
# [Tablas de aplicación de capa de datos: sysdac_instances_internal](data-tier-application-tables-sysdac-instances-internal.md)  
# [Asignación de tablas del sistema a vistas del sistema](mapping-system-tables-to-system-views-transact-sql.md)  
# [Tablas base del sistema](system-base-tables.md)  
# [Copia de seguridad y restauración de tablas](backup-and-restore-tables-transact-sql.md)  
...
# [Tablas de captura de datos modificados](change-data-capture-tables-transact-sql.md)  
...
# [Tablas de replicación](replication-tables-transact-sql.md)  
