...
# [Extended tablas de eventos - trace_xe_action_map](extended-events-tables-trace-xe-action-map.md)  
# [Extended tablas de eventos - trace_xe_event_map](extended-events-tables-trace-xe-event-map.md)  
...
# [Asignar tablas del sistema a vistas del sistema](mapping-system-tables-to-system-views-transact-sql.md)  
