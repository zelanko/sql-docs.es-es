...
ms.locfileid: "39103313"
---
# <a name="ihpublications-transact-sql"></a>IHpublications (Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]

  El **IHpublications** tabla del sistema contiene una fila por cada publicación que no son de SQL Server utilizando el distribuidor actual. Esta tabla se almacena en la base de datos de distribución.  
...
|**enabled_for_internet**|**bit**|Indica si los archivos de sincronización para la publicación se exponen en Internet a través de FTP y otros servicios, donde **1** significa que puede obtenerse desde Internet.|  
...
|**allow_queued_tran**|**bit**|Especifica si se ha habilitado la colocación en cola de los cambios del suscriptor hasta que se puedan aplicar en el publicador. Si **1**, se ponen en cola los cambios del suscriptor. *No se admite para publicadores que no son SQL.*|  
...
|**autogen_sync_procs**|**bit**|Especifica si se ha generado en el publicador un procedimiento almacenado de sincronización para suscripciones de actualización inmediata. **1** significa que se ha generado en el publicador. *No se admite para publicadores que no son SQL.*|  
...
|**options**|**int**|Mapa de bits que especifica las opciones de publicación adicionales, donde los valores de la opción bit a bit son:<br /><br /> **0 x 1** : habilitado para replicación punto a punto.<br /><br /> **0 x 2** -publicar solo cambios locales.<br /><br /> **0 x 4** : habilitado para los suscriptores que no son de SQL Server.|  
