...
ms.locfileid: "47826543"
---
# <a name="logshippingprimarydatabases-transact-sql"></a>log_shipping_primary_databases (Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]

  Almacena un registro para la base de datos principal en una configuración de trasvase de registros. Esta tabla se almacena en el **msdb** base de datos.  
