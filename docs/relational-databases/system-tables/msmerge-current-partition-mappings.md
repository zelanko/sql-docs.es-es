...
|**partition_id**|**int**|El Id. de la partición a la que pertenece la fila. El valor es -1 si el cambio de fila es relevante para todos los suscriptores.|  
