...
|**automáticamente**|**tinyint**|Indica el tipo de artículo solo de esquema, que puede ser uno de los siguientes:<br /><br /> **0x20** = artículo solo de esquema de procedimiento almacenado.<br /><br /> **0x40** = artículo de solo esquema de vista o vista indizada.|  
