...
|**estatus**|**int**|Mapa de bits utilizado para indicar el estado del artículo.|  
|**automáticamente**|**tinyint**|Valor que indica el tipo de artículo de solo esquema:<br /><br /> **32** = procedimiento almacenado.<br /><br /> **64** = vista o vista indizada. <br /><br /> **96** = función de agregado.<br /><br /> **128** = función.|  
