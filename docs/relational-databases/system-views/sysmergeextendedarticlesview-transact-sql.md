---
title: sysmergeextendedarticlesview (Transact-SQL) | Documentos de Microsoft
ms.custom: ''
ms.date: 03/06/2017
ms.prod: sql
...
ms.locfileid: "33012842"
---
# <a name="sysmergeextendedarticlesview-transact-sql"></a>sysmergeextendedarticlesview (Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]

  El **sysmergeextendedarticlesview** expone información sobre artículos de vista. Esta vista se almacena en el publicador de la base de datos de publicación y en el suscriptor de la base de datos de suscripciones.  
  
|Nombre de columna|Tipo de datos|Description|  
|-----------------|---------------|-----------------|  
|**Nombre**|**sysname**|El nombre del artículo.|  
|**Tipo**|**tinyint**|Indica el tipo de artículo, que puede ser uno de los siguientes:<br /><br /> **10** = tabla.<br /><br /> **32** = solamente esquema de procedimiento.<br /><br /> **64** = view schema only o solo el esquema de vista indizada.<br /><br /> **128** = solamente esquema de función.<br /><br /> **160** = solamente esquema de sinónimo.|  
...
|**before_view_objid**|**int**|Id. del objeto de una tabla de vistas. La vista está en una tabla que mantiene un seguimiento de si una fila pertenecía a un suscriptor concreto antes de que se eliminara o actualizara. Se aplica sólo cuando se crea una publicación con *@keep_partition_changes*  =  **true**.|  
...
|**published_in_tran_pub**|**bit**|Indica que un artículo de una publicación de combinación también se publica en una publicación transaccional.<br /><br /> **0** = artículo no está publicado en un artículo transaccional.<br /><br /> **1** = artículo también se publica en un artículo transaccional.|  
