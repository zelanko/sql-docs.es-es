---
title: syspublications (vista del sistema) (Transact-SQL) | Documentos de Microsoft
ms.custom: ''
ms.date: 03/17/2017
ms.prod: sql
...
|**ftp_port**|**int**|El número de puerto del servicio FTP para el distribuidor. Especifica dónde se encuentran el agente de distribución recoger los archivos de instantáneas de publicación.|  
