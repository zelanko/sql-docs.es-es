---
title: "Cambiar el nombre a las tablas (motor de base de datos) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "cambio del nombre de una tabla [SQL Server]"
  - "nombres de tabla [SQL Server]"
  - "tablas [SQL Server], Visual Database Tools"
