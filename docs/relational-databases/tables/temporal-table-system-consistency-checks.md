---
description: Comprobaciones de coherencia del sistema de la tabla temporal
...
### <a name="data-consistency-check"></a>Comprobación de la coherencia de datos
