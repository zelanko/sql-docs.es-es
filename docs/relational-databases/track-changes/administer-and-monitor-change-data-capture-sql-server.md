...
ms.topic: "article"
helpviewer_keywords: 
  - "captura de datos modificados [SQL Server], supervisar"
  - "captura de datos modificados [SQL Server], administrar"
  - "captura de datos modificados [SQL Server], trabajos"
