...
ms.topic: "article"
helpviewer_keywords: 
  - "captura de datos modificados [SQL Server], comparada con el seguimiento de cambios"
  - "captura de datos modificados frente a seguimiento de cambios"
  - "captura de datos modificados [SQL Server], comportamientos de los tipos de datos"
  - "Sync Services for ADO.NET"
  - "seguimiento de cambios [SQL Server], servicios de sincronización para ADO.NET"
  - "seguimiento de cambios [SQL Server]"
  - "captura de datos modificados [SQL Server], seguridad"
...
##  <a name="Tracking"></a> Seguimiento de los cambios  
...
## Vea también  
 ...
 [Vistas de administración dinámica relacionadas con la captura de datos modificados &#40;Transact-SQL&#41;](../Topic/Change%20Data%20Capture%20Related%20Dynamic%20Management%20Views%20\(Transact-SQL\).md)  
