...
ms.topic: "article"
helpviewer_keywords: 
  - "funciones integradas [SQL Server]"
  - "funciones no deterministas"
  - "procedimientos almacenados extendidos [SQL Server], funciones que llaman a"
  - "funciones deterministas"
  - "funciones definidas por el usuario [SQL Server] deterministas"
