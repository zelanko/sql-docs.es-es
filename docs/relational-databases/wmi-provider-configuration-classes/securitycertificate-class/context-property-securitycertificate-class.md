---
description: Propiedad Context (clase SecurityCertificate)
title: Propiedad context (SecurityCertificate)
...
## <a name="property-valuereturn-value"></a>Valor de propiedad y valor devuelto  
 Valor de matriz de **sint32** que especifica el contexto del certificado de seguridad.  
