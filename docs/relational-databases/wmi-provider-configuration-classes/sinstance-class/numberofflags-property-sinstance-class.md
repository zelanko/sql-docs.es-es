---
title: Propiedad NumberOfFlags (clase SInstance) | Documentos de Microsoft
ms.custom: 
ms.date: 03/14/2017
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]Obtiene el número de marcas de la instancia de [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)].  
...
## <a name="property-valuereturn-value"></a>Valor de propiedad/Valor devuelto  
 A **uint32** valor que especifica el número de marcadores para la instancia de [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)].  
