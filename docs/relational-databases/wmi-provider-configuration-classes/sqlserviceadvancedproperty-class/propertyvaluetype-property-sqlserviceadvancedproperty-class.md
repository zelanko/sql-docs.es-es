---
title: Propiedad PropertyValueType (clase SqlServiceAdvancedProperty) | Documentos de Microsoft
ms.custom: 
ms.date: 03/03/2017
...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)]Obtiene el tipo de datos de una propiedad.  
...
## <a name="property-valuereturn-value"></a>Valor de propiedad/Valor devuelto  
 A **uint32** valor que representa el tipo de datos de la propiedad.  
