...
description: Obtenga información sobre la sintaxis básica de la cláusula FOR de XML y cómo se utiliza para determinar la forma del XML resultante de una consulta SQL.
