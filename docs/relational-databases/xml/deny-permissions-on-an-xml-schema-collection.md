...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)] Es posible denegar permisos para crear una colección de esquemas XML nueva o utilizar una existente.  
