...
description: Obtenga información sobre las ventajas de las consultas FOR XML anidadas viendo un ejemplo que compara una consulta FOR XML de un solo nivel con una FOR XML anidada.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
