...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)] FOR XML no admite los tipos de datos definidos por el usuario (UDT) de Common Language Runtime (CLR).  
