...
description: Obtenga información sobre cómo generar elementos XML del mismo nivel mediante una consulta de modo AUTO anidada como alternativa al uso del modo EXPLICIT.
ms.custom: ''
ms.date: 03/04/2017
ms.prod: sql
