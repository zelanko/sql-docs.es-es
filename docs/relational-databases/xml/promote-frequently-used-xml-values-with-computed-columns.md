---
title: "Promover los valores XML usados con frecuencia con columnas calculadas | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
ms.topic: "article"
helpviewer_keywords: 
  - "Propiedades de promoción [SQL Server Compact]"
  - "promoción de propiedades [XML en SQL Server]"
...
---
# Promover los valores XML usados con frecuencia con columnas calculadas
...
### Ejemplo: consultas en una columna calculada basada en métodos de tipo de datos xml  
...
### Ejemplo: buscar instancias XML cuyos autores tengan el mismo nombre  
