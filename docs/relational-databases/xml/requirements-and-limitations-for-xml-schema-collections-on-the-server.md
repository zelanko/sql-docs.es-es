...
ms.topic: "article"
helpviewer_keywords: 
  - "identificadores [colecciones de esquemas XML]"
  - "colecciones de esquemas XML [SQL Server], limitaciones"
  - "grupos de sustitución [XML en SQL Server]"
  - "colecciones de esquema XML [SQL Server], instrucciones"
  - "validación lax"
  - "aspectos de enumeración [XML en SQL Server]"
  - "precisión decimal [XML en SQL Server]"
  - "valores de colecciones de esquemas XML repetidos"
  - "colecciones de esquemas [SQL Server], limitaciones"
  - "zonas horarias [XML en SQL Server]"
  - "decimales de precisión [XML en SQL Server]"
  - "colecciones de esquema [SQL Server], instrucciones"
...
|[Elemento &#60;xsd:redefine&#62;](../../relational-databases/xml/the-xsd-redefine-element.md)|Explica la limitación de utilizar el elemento \<xsd:redefine> y describe una solución alternativa.|  
...
|[Contenido simple y de tipo mixto](../../relational-databases/xml/mixed-type-and-simple-content.md)|Describe la limitación que se produce al restringir un tipo mixto a un contenido simple.|  
