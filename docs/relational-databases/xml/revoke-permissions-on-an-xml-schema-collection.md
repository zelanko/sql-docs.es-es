...
[!INCLUDE[tsql-appliesto-ss2008-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-xxxx-xxxx-xxx-md.md)] Para revocar el permiso para crear una colección de esquemas XML, siga uno de los procedimientos siguientes:  
