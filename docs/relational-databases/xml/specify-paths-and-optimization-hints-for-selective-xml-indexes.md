...
-   En la cláusula **FOR** de una instrucción **CREATE** . Para obtener más información, vea [CREAR ÍNDICE XML SELECTIVO &#40;Transact-SQL&#41;](../../t-sql/statements/create-selective-xml-index-transact-sql.md).  
  
-   En la cláusula **ADD** de una instrucción **ALTER** . Para obtener más información, vea [ALTER INDEX &#40;Selective XML Indexes&#41;](../../t-sql/statements/alter-index-selective-xml-indexes.md).  
...
### Tipos de SQL Server en XML sin tipo  
...
### Indizar rutas de acceso idénticas  
...
### Ventajas de las sugerencias de optimización  
...
### Sugerencias de optimización y tipos de datos  
...
### Sugerencia de optimización SINGLETON  
...
### Sugerencia de optimización DATA TYPE  
 Se aplica a: tipos de datos XQuery  
...
### Sugerencia de optimización MAXLENGTH  
 Se aplica a: tipos de datos XQuery  
