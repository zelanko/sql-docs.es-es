...
ms.topic: "article"
helpviewer_keywords: 
  - "parámetros [XML en SQL Server]"
  - "XML [SQL Server], ADO"
  - "columnas [XML en SQL Server], ADO.NET"
  - "ADO [XML en SQL Server]"
  - "columnas [XML en SQL Server], SQL Server Native Client"
  - "tipo de datos XML [SQL Server], ADO"
  - "SQLNCLI, XML"
  - "tipo de datos XML [SQL Server], SQL Server Native Client"
  - "SQL Server Native Client, XML"
  - "ADO.NET [XML en SQL Server]"
  - "XML [SQL Server], ADO.NET"
  - "columnas [XML en SQL Server], ADO"
  - "tipo de datos XML [SQL Server], ADO.NET"
