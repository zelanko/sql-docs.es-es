---
title: Datos XML (SQL Server)
description: Datos XML (Transact-SQL)
ms.prod: sql
...
## <a name="in-this-section"></a>En esta sección  
 [Tipo de datos XML y columnas &#40;SQL Server&#41;](../../relational-databases/xml/xml-data-type-and-columns-sql-server.md)  
