...
helpviewer_keywords: 
  - "índices, quitar"
  - "eliminar índices"
  - "índices secundarios [XML in SQL Server]"
  - "tipo de datos XML [SQL Server], índices"
  - "quitar índices"
  - "PATH, índice"
  - "DROP_EXISTING, cláusula"
  - "XML [SQL Server], índices"
  - "índices primarios [XML en SQL Server]"
  - "índices [SQL Server], XML"
  - "índices XML [SQL Server], secundarios"
  - "BLOB, índices XML"
  - "deshabilitar índices"
  - "índices XML [SQL Server], modificar"
  - "índices XML [SQL Server]"
  - "índices XML [SQL Server], principales"
  - "modificar índices"
  - "índices XML [SQL Server], quitar"
  - "VALUE, índice"
  - "índices XML [SQL Server], tipo de datos XML"
  - "PROPERTY, índice"
  - "índices XML [SQL Server], crear"
