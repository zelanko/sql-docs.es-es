...
description: 'Hay dos maneras de integrar Reporting Services en las aplicaciones personalizadas: el acceso URL y la API de SOAP de Reporting Services. Cuál usar depende de varios factores.'
ms.date: 10/19/2017
