...
description: Puede tener acceso a la funcionalidad completa del servidor de informes a través de la API SOAP de Reporting Services. Acceda al servicio web en una aplicación Windows escribiendo código que realice llamadas al servicio.
ms.date: 03/14/2017
