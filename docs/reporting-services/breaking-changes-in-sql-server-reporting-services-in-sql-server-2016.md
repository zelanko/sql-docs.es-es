...
description: Obtenga información sobre los cambios en Reporting Services que podrían interrumpir aplicaciones, scripts o funcionalidades que se basen en versiones anteriores de SQL Server.
ms.date: 07/02/2017
