---
title: Registro de cambios de SQL Server Reporting Services (2017 y versiones posteriores) | Microsoft Docs
ms.custom: ''
ms.date: 04/25/2018
...
ms.locfileid: "37968657"
---
# <a name="change-log-for-sql-server-reporting-services"></a>Registro de cambios de SQL Server Reporting Services
...
- *Versión 14.0.600.594, publicada el 9 de enero de 2018*
    - Actualizaciones de seguridad

- *Versión 14.0.600.490, fecha de publicación: 1 de noviembre de 2017* 
    - Correcciones de errores:
        - Problemas resueltos con la actualización de SKU

- *Versión 14.0.600.451, fecha de publicación: 30 de septiembre de 2017* 
    - Versión inicial
