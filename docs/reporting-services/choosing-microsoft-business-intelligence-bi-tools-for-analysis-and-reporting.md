...
description: Obtenga información sobre las cargas de trabajo asignadas para el análisis de datos y la creación de informes, y sobre las herramientas de inteligencia empresarial de Microsoft más adecuadas para esas cargas de trabajo.
author: maggiesMSFT
ms.author: maggies
ms.reviewer: ''
...
|Cargas de trabajo|Usuario|Herramienta de&nbsp;basada en Excel|Herramienta de&nbsp;BI basada en SharePoint|Herramienta de&nbsp;BI basada en Internet para &nbsp;SharePoint|Herramienta de&nbsp;BI basada en Power&nbsp;BI|Herramienta de&nbsp;BI basada en SQL&nbsp;Server|  
|---------------|----------|-|-|--------------|-|-|  
...
|Realizar análisis predictivos de autoservicio||||||[Complementos de minería de datos para Excel](/previous-versions/sql/2014/analysis-services/data-mining-client-for-excel-sql-server-data-mining-add-ins?view=sql-server-2014) |  
