...
description: Aprenda cómo se usa la configuración de información de dispositivo para pasar parámetros de representación a una extensión de representación en Reporting Services.
ms.date: 09/15/2015
