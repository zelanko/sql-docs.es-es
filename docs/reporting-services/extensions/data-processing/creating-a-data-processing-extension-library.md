...
```  
 ...
 En el ejemplo de código siguiente se muestra el comando que se utilizaría para los archivos de [!INCLUDE[msCoName](../../../includes/msconame-md.md)] [!INCLUDE[vbprvb](../../../includes/vbprvb-md.md)] con la extensión .vb.  
