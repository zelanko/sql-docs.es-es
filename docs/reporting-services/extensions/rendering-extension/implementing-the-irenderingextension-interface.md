...
description: Obtenga información sobre cómo implementar la interfaz IRenderingExtension, que transforma los datos del informe en formatos de salida para usarlos en visores, impresoras y otros destinos.
ms.date: 03/16/2017
