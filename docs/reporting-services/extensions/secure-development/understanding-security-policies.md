...
description: Obtenga información sobre las directivas de seguridad de Reporting Services, que especifican permisos para ensamblados, extensiones y expresiones de informe basadas en grupos de código.
ms.date: 03/14/2017
