...
description: Descubra cómo extender los esquemas de autenticación en Reporting Services mediante la autenticación de formularios o la interfaz IAuthenticationExtension2.
ms.date: 03/14/2017
