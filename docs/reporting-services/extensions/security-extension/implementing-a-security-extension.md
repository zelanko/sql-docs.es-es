...
description: Adapte la seguridad personalizada mediante el uso de la plataforma de desarrollo de API de Reporting Services para extender el sistema de seguridad de Reporting Services.
ms.date: 03/14/2017
