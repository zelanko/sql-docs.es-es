...
ms.topic: "article"
helpviewer_keywords: 
  - "HTML [Reporting Services], representación"
  - "configuración de la información de dispositivo [Reporting Services], representación en HTML"
...
> [!IMPORTANT]  
>  La configuración de información de dispositivo que aparece en la siguiente tabla con **(\*)** está en desuso y no se debe usar en nuevas aplicaciones. Para más información, vea [Características obsoletas de SQL Server Reporting Services en SQL Server 2016](../Topic/Deprecated%20Features%20in%20SQL%20Server%20Reporting%20Services%20in%20SQL%20Server%202016.md).  
