...
description: Obtenga información sobre las distintas configuraciones de la información del dispositivo que están disponibles para la representación en formato HTML.
ms.date: 03/16/2017
