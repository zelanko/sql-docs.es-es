...
description: Obtenga información sobre el Visor HTML y la barra de herramientas de informes, y cómo puede ver informes a petición a medida que se solicitan desde el servidor de informes.
ms.date: 03/14/2017
