...
description: Obtenga información sobre los distintos valores de configuración de la información del dispositivo que puede usar para representar en un formato de imagen en Reporting Services.
ms.date: 03/16/2017
