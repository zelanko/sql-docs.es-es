---
title: "Acerca de las reservas y el registro de resrvas de URL (Administrador de configuraci&#243;n de SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "05/18/2016"
...
helpviewer_keywords: 
  ...
  - "Registro del URL"
  - "Servicio de servidor de informes, reservas de direcciones URL"
...
---
# Acerca de las reservas y el registro de resrvas de URL (Administrador de configuraci&#243;n de SSRS)
...
|http://123.45.67.0:80/reportserver|http://123.45.67.0/reportserver|Esta reserva de direcciones URL especifica una dirección IP y es mucho más restrictiva que la que tiene un carácter comodín. Solo las direcciones URL que incluyen la dirección IP se pueden utilizar para conectarse al servidor de informes. Dada esta reserva de direcciones URL, una solicitud para un servidor de informes en http://\<nombreDeEquipo>/reportserver o http://localhost/reportserver produciría un error.|  
...
|-------------------|-----------------|-----------------|----------------------------------------|  
|Instancia predeterminada|servicio web del servidor de informes|http://\<nombreDelServidor>/ReportServer|http://\<nombreDelServidor>:80/reportserver|  
|Instancia predeterminada|Portal web|http://\<nombreDelServidor>/ReportServer|http://\<nombreDelServidor>:80/reportserver|  
|Instancia con nombre|servicio web del servidor de informes|http://\<nombreDelServidor>/reportserver_\<nombreDeInstancia>|http://\<nombreDeServidor>:80/reportserver_\<nombreDeInstancia>|  
|Instancia con nombre|Portal web|http://\<nombreDeServidor>/reports_\<nombreDeInstancia>|http://\<nombreDeServidor>:80/reports_\<nombreDeInstancia>|  
|SQL Server Express|servicio web del servidor de informes|http://\<nombreDeServidor>/reportserver_SQLExpress|http://\<nombreDeServidor>:80/reportserver_SQLExpress|  
|SQL Server Express|Portal web|http://\<nombreDeServidor>/reports_SQLExpress|http://\<nombreDeServidor>:80/reports_SQLExpress|  
...
##  <a name="URLlocalAdmin"></a> Direcciones URL para administración local  
 Puede utilizar http://localhost/reportserver o http://localhost/reports si especificó un carácter comodín seguro o poco seguro para la reserva de direcciones URL.  
