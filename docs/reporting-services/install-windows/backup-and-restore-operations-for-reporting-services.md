...
ms.topic: "article"
helpviewer_keywords: 
  - "bases de datos [Reporting Services], realizar copias de seguridad"
  - "bases de datos [Reporting Services], restaurar"
  - "bases de datos [Reporting Services], mover"
  - "realizar copias de seguridad de bases de datos [Reporting Services]"
  - "mover bases de datos"
  - "restaurar bases de datos [Reporting Services]"
  - "archivos [Reporting Services], restaurar"
  - "archivos [Reporting Services], realizar copias de seguridad"
...
## Realizar copias de seguridad de bases de datos del servidor de informes  
...
## Realizar copias de seguridad de claves de cifrado  
 La primera vez que se configura una instalación de [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] , se recomienda realizar una copia de seguridad de las claves de cifrado. Asimismo, se debería realizar una copia de seguridad de las claves siempre que se cambie la identidad de las cuentas de servicio o se cambie el nombre del equipo. Para obtener más información, vea [Hacer copia de seguridad y restaurar claves de cifrado de Reporting Services](../../reporting-services/install-windows/back-up-and-restore-reporting-services-encryption-keys.md). Para servidores de informes en modo de SharePoint, vea la sección "Administración de claves" de [Administrar una aplicación de servicio de SharePoint para Reporting Services](../../reporting-services/report-server-sharepoint/manage-a-reporting-services-sharepoint-service-application.md).  
...
## Vea también  
 ...
 [Utilidad rskeymgmt &#40;SSRS&#41;](../../reporting-services/tools/rskeymgmt-utility-ssrs.md)   
