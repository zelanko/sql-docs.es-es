...
helpviewer_keywords: 
  ...
  - "conexiones [Reporting Services]"
  - "servidores de informes [Reporting Services], conexiones"
  - "base de datos del servidor de informes"
  - "bases de datos [Reporting Services], conexiones"
  - "seguridad [Reporting Services], conexiones de base de datos"
...
---
# Configurar una conexi&#243;n a la base de datos del servidor de informes (Administrador de configuraci&#243;n de SSRS)
...
### Almacenar información de conexión a la base de datos  
 ...
 No todos los valores se establecen para todos los tipos de conexión. Si configura la conexión con los valores predeterminados (es decir, con las cuentas de servicio para establecer la conexión), \<**LogonUser**>, \<**LogonDomain**> y \<**LogonCred**> estarán vacíos, como sigue:  
...
## Configurar varios servidores de informes para que utilicen la misma base de datos del servidor de informes  
