...
ms.topic: "article"
helpviewer_keywords: 
  - "Servidor de informes de Windows, directorios virtuales"
  - "servidores de informes [Reporting Services], directorios virtuales"
  - "directorios virtuales [Reporting Services]"
  - "Administrador de informes [Reporting Services], directorios virtuales"
...
---
# Configurar las direcciones URL del servidor de informes (Administrador de configuraci&#243;n de SSRS)
...
-   http://\<nombre_equipo>/servidor_informes  
...
## Autenticar las solicitudes de cliente que se envían a la dirección URL de un servidor de informes  
