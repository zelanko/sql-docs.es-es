...
helpviewer_keywords: 
  ...
  - "seguridad [Reporting Services], procesamiento desatendido de informes"
  ...
  - "cuentas [Reporting Services]"
  - "informes [Reporting Services], procesamiento"
...
3.  Escriba el siguiente comando para configurar la cuenta de una instancia de servidor de informes local:  
     ...
     **rsconfig -e -u\<dominio/nombreUsuario> -p\<password>**  
...
## Cómo usar la cuenta de procesamiento de informes en modo desatendido  
...
## Vea también  
 [Administrador de configuración de Reporting Services (Modo nativo de SSRS)](http://msdn.microsoft.com/es-es/379eab68-7f13-4997-8d64-38810240756e)  
