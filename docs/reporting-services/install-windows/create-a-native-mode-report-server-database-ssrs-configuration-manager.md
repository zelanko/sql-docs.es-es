...
ms.topic: "article"
helpviewer_keywords: 
  - "servidores de informes [Reporting Services], bases de datos"
  - "bases de datos [Reporting Services], crear"
...
manager: "erikre"
---
# Crear una base de datos del servidor de informes de modo nativo (Administrador de configuraci&#243;n de SSRS)
