---
title: Actualizar y migrar Reporting Services | Documentos de Microsoft
ms.custom: 
ms.date: 08/17/2017
...
# <a name="upgrade-and-migrate-reporting-services"></a>Actualizar y migrar Reporting Services

[!INCLUDE[ssrs-appliesto](../../includes/ssrs-appliesto.md)] [!INCLUDE[ssrs-appliesto-2016](../../includes/ssrs-appliesto-2016.md)] [!INCLUDE[ssrs-appliesto-not-pbirsi](../../includes/ssrs-appliesto-not-pbirs.md)] [!INCLUDE[ssrs-appliesto-sharepoint-2013-2016i](../../includes/ssrs-appliesto-sharepoint-2013-2016.md)]

  Este tema es una introducción de las opciones de actualización y migración para SQL Server Reporting Services. Hay dos enfoques generales para actualizar una implementación de SQL Server Reporting Services:  
...
> [!TIP]  
>  Para ver la información más reciente sobre los problemas en SQL Server, vea lo siguiente:  
>   
...
##  <a name="bkmk_side_by_side"></a> Instalaciones en paralelo  
 Modo de SQL Server nativo de Reporting Services puede ser instalado en paralelo con un [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] o [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] implementación en modo nativo.  
  
 No hay ninguna compatibilidad para las implementaciones en paralelo de SQL Server Reporting Services en modo de SharePoint y las versiones anteriores de [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] componentes del modo de SharePoint.  
...
##  <a name="bkmk_inplace_upgrade"></a> Actualización en contexto  
 ...
 Al ejecutar [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] el programa de instalación, puede seleccionar la opción para actualizar desde una de las versiones siguientes o puede instalar una nueva instancia de SQL Server Reporting Services que se ejecuta en paralelo las instalaciones existentes:  
...
2.  El programa de instalación comprueba la configuración o las condiciones que impiden la actualización y lee los valores de configuración. Algunos ejemplos pueden ser las extensiones personalizadas que se implementan en el servidor de informes. Si la actualización está bloqueada, debe modificar la instalación para que la actualización ya no está bloqueado o migrar a una nueva instancia de SQL Server Reporting Services. Para obtener más información, vea la documentación del Asesor de actualizaciones.  
...
4.  El programa de instalación crea carpetas nuevas para los archivos de programa de SQL Server Reporting Services. Las carpetas de programas para una [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] instalación incluyen MSRS13.\< *nombre de instancia*>.  
  
5.  El programa de instalación agrega los archivos de programa del servidor de informes de SQL Server Reporting Services, herramientas de configuración y utilidades de línea de comandos que forman parte de la característica de servidor de informes.  
...
6.  El programa de instalación reutiliza la entrada en el Administrador de Control de servicios para el servicio servidor de informes de SQL Server Reporting Services. Esta entrada de servicio incluye la cuenta de servicio de Windows Servidor de informes.  
 ...
 **Migración:** la migración de una versión anterior de una instalación en modo nativo a SQL Server Reporting Services es lo mismo para todas las versiones admitidas enumeradas anteriormente en este tema. Para obtener más información, vea [Migrar una instalación de Reporting Services &#40;modo nativo&#41;](../../reporting-services/install-windows/migrate-a-reporting-services-installation-native-mode.md).  
...
1.  Haga copia de seguridad de las claves de cifrado y las bases de datos del servidor de informes. Para obtener más información, consulte [Backup y Restore Operations for Reporting Services](../../reporting-services/install-windows/backup-and-restore-operations-for-reporting-services.md) y [agregar y quitar claves de cifrado para la implementación de ampliación horizontal &#40; Administrador de configuración de SSRS &#41; ](../../reporting-services/install-windows/add-and-remove-encryption-keys-for-scale-out-deployment.md).  
...
3.  Actualice uno de los servidores de informes para SQL Server Reporting Services.  
...
##  <a name="bkmk_sharePoint_scenarios"></a> Escenarios de actualización y migración en modo de SharePoint  
 Las secciones siguientes describen los problemas y los pasos básicos necesarios para actualizar o migrar desde versiones especificadas de [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] modo de SharePoint para SQL Server Reporting Services [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] el modo de SharePoint.  
...
-   [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] Complemento para productos de SharePoint. Para obtener más información, vea [Instalar o desinstalar el complemento Reporting Services para SharePoint](../../reporting-services/install-windows/install-or-uninstall-the-reporting-services-add-in-for-sharepoint.md).  
 ...
 Para obtener instrucciones detalladas sobre cómo migrar una instalación en modo SharePoint, vea [migrar una instalación de Reporting Services &#40; Modo de SharePoint &#41; ](../../reporting-services/install-windows/migrate-a-reporting-services-installation-sharepoint-mode.md).  
...
### <a name="includesssql14includessssql14-mdmd-to-sql-server-reporting-services"></a>[!INCLUDE[ssSQL14](../../includes/sssql14-md.md)]en SQL Server Reporting Services  
...
### <a name="includesssql11includessssql11-mdmd-to-sql-server-reporting-services"></a>[!INCLUDE[ssSQL11](../../includes/sssql11-md.md)]en SQL Server Reporting Services  
...
### <a name="includesskilimanjaroincludessskilimanjaro-mdmd-to-sql-server-reporting-services"></a>[!INCLUDE[ssKilimanjaro](../../includes/sskilimanjaro-md.md)]en SQL Server Reporting Services  
...
-   Instale la versión de SQL Server Reporting Services de la [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)] complemento para SharePoint en cada web front-end de la granja de servidores. Puede instalar el complemento mediante el Asistente para la instalación de SQL Server Reporting Services o descargando el complemento.  
