...
|Port|80<br /><br /> 443<br /><br /> \<personalizado>|El puerto 80 es el puerto estándar para las solicitudes HTTP de un servidor.<br /><br /> El puerto 443 es el informe estándar para las conexiones TLS.<br /><br /> Puede utilizar cualquier puerto que aún no esté reservado por otra aplicación.|  
