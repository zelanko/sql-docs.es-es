---
description: Sintaxis de reserva de URL (Administrador de configuración del servidor de informes)
...
ms.locfileid: "91934136"
---
# <a name="url-reservation-syntax--report-server-configuration-manager"></a>Sintaxis de reserva de URL (Administrador de configuración del servidor de informes)
