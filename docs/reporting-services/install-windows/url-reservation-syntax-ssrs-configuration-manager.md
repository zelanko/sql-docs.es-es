---
title: "Sintaxis de reserva de direcciones URL (Administrador de configuración de SSRS) | Documentos de Microsoft"
ms.custom: 
ms.date: 05/18/2016
...
## <a name="url-syntax"></a>Sintaxis de las direcciones URL  
 ...
 \<esquema > ://\<nombre de host >:\<puerto > /\<virtualdirectory >  
