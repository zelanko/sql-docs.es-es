...
description: En esta lección, aprenderá a definir un conjunto de datos para el informe de tabla en SQL Server Reporting Services (SSRS).
ms.date: 05/01/2019
