...
6.  En el menú **Formato** , haga clic en **Color de fondo**y, a continuación, haga clic en **Gris claro**y en **Aceptar**.  
    ...
    ![Vista de diseño: tabla básica con total general](../reporting-services/media/rs-basictablesumlinetotaldesign.gif "Vista de diseño: tabla básica con total general")  
...
4.  En el menú **Formato** , haga clic en **Color de fondo**y, a continuación, haga clic en **Azul claro**y en **Aceptar**.  
    ...
    ![Vista de diseño: Total general en la tabla básica](../reporting-services/media/rs-basictablesumgrandtotaldesign.gif "Vista de diseño: Total general en la tabla básica")  
