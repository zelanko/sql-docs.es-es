---
title: "Lección 9: Compilar y ejecutar la aplicación | Documentos de Microsoft"
ms.custom: 
ms.date: 05/18/2016
...
3.  Seleccione un valor de la columna **Nombre** . El informe secundario se muestra con los datos filtrados correspondientes.  
  
4.  Seleccione el icono, **Volver al informe primario**, en la barra de herramientas de **ReportViewer** para navegar de nuevo al informe **Primario** .  
