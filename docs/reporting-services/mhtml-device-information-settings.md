...
description: Obtenga información sobre la configuración de información de dispositivos para representar informes en formato de archivo web (MHTML).
ms.date: 03/16/2017
