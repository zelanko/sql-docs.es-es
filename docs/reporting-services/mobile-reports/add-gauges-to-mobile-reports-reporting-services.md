...
En el [!INCLUDE[PRODUCT_NAME](../../includes/product-name.md)], todos los medidores tienen al menos una propiedad en común: un valor principal, establecido en un campo numérico en una de las tablas de datos del informe para dispositivos móviles.  
...
### Establecer la dirección del valor: valores altos o bajos como mejor opción
