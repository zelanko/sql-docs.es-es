...
>**Nota**: el [!INCLUDE[PRODUCT_NAME](../../includes/ss-mobilereptpub-short.md)] no actualiza automáticamente los datos de Excel. Puede actualizar los datos mediante el comando **Actualizar** del [!INCLUDE[PRODUCT_NAME](../../includes/ss-mobilereptpub-short.md)], pero solo si no se ha movido el archivo.  
