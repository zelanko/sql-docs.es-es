---
title: Actualizar - Reporting Services para los documentos de SQL Server | Documentos de Microsoft
description: "Mostrar fragmentos de contenido actualizado para recientemente modificadas en documentación, Reporting Services para Microsoft SQL Server."
services: na
documentationcenter: 
author: MightyPen
manager: jhubbard
...
---
# Nuevos y actualizados recientemente: Reporting Services para SQL Server
...
- *Intervalo de fechas de las actualizaciones:* &nbsp; **2017-05-17** &nbsp; - a - &nbsp; **2017-06-30**
...
1. [Configurar el portal web](report-server/configure-web-portal.md)
2. [Conceder acceso de usuario a un servidor de informes](security/grant-user-access-to-a-report-server.md)
...
#### Áreas temáticas que disponga de artículos nuevos o actualizados recientemente
<a id="subject-areas-which-do-have-new-or-recently-updated-articles" class="xliff"></a>

- [Nuevos y actualizados (12 + 2): **Analystics avanzada para SQL** documentos](../advanced-analytics/new-updated-advanced-analytics.md)
- [Nuevos y actualizados (1 + 0): **Analysis Services para SQL** documentos](../analysis-services/new-updated-analysis-services.md)
- [Nuevos y actualizados (0 + 2): **conectar con SQL Server** documentos](../connect/new-updated-connect.md)
- [Nuevos y actualizados (3 + 0): **motor de base de datos de SQL** documentos](../database-engine/new-updated-database-engine.md)
- [Nuevos y actualizados (1 + 2): **Integration Services para SQL** documentos](../integration-services/new-updated-integration-services.md)
- [Nuevos y actualizados (2 + 8): **Linux para SQL** documentos](../linux/new-updated-linux.md)
...
- [Nuevos y actualizados (5 + 5): **bases de datos relacionales de SQL** documentos](../relational-databases/new-updated-relational-databases.md)
- [Nuevos y actualizados (2 + 0): **Reporting Services para SQL** documentos](../reporting-services/new-updated-reporting-services.md)
- [Nuevos y actualizados (0 + 4): **Microsoft SQL Server** documentos](../sql-server/new-updated-sql-server.md)
...
#### Áreas temáticas que no disponga de ninguna artículos nuevos o actualizados recientemente
...
- [Nuevos y actualizados (0 + 0): **Transact-SQL** documentos](../t-sql/new-updated-t-sql.md)
