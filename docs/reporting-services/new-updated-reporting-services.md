...
---
# <a name="new-and-recently-updated-reporting-services-for-sql-server"></a>Nuevos y actualizados recientemente: Reporting Services para SQL Server
...
1. [Agregar elemento web Visor de informes a una página de SharePoint](report-server-sharepoint/add-report-viewer-web-part-to-page.md)
2. [Implementar el elemento web Visor de informes en un sitio de SharePoint](report-server-sharepoint/deploy-report-viewer-web-part.md)
