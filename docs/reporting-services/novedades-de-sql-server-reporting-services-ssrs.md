...
helpviewer_keywords: 
  ...
  - "Reporting Services, novedades"
  - "SQL Server Reporting Services, novedades"
  - "SSRS, novedades"
...
Obtenga información sobre las novedades de SQL Server [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]. Abarca las principales áreas de características y se actualiza a medida que se lanzan nuevos elementos.
  ...
  Para más información sobre las novedades en otras áreas de SQL Server, consulte [Novedades de SQL Server vNext](../sql-server/what-s-new-in-sql-server-vnext.md) o [Novedades de SQL Server 2016](../sql-server/what-s-new-in-sql-server-2016.md).
...
-   ¿Tiene una cuenta de Azure?  Si es así, haga clic **[aquí](https://azure.microsoft.com/en-us/marketplace/partners/microsoft/sqlserver2016sp1enterprisewindowsserver2016/)** para poner en marcha una máquina virtual con [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] ya instalado.  
  
 ![nota](../analysis-services/instances/install-windows/media/ssrs-fyi-note.png "nota") Si desea ver las notas de la versión actual, consulte [Versión preliminar técnica de informes de Power BI en SSRS: notas de la versión](../reporting-services/notas-de-la-versión-de-reporting-services.md) o [Notas de la versión de SQL Server 2016](../sql-server/sql-server-2016-release-notes.md).  

## <a name="whats-new-in-the-january-2017-technical-preview-of-power-bi-reports-in-sql-server-reporting-services"></a>Novedades de la versión preliminar técnica de informes de Power BI en SQL Server Reporting Services de enero de 2017

### <a name="reporting-services-has-a-new-setup-experience"></a>Reporting Services ofrece una nueva experiencia de instalación

Reporting Services ahora se puede instalar independientemente del programa de instalación de SQL Server. La experiencia de instalación tiene menos pasos y es más ligera. El programa de instalación instalará los archivos para Reporting Services. Luego puede configurar la base de datos del servidor de informes. Esto requiere acceso a un servidor de Motor de base de datos de SQL Server.

![ssrs-standalone-setup1](../reporting-services/media/ssrs-standalone-setup1.png)

Para más información, consulte [Instalación de la versión preliminar de informes de Power BI en SQL Server Reporting Services de enero de 2017](Install%20the%20January%202017%20Technical%20Preview%20of%20Power%20BI%20reports%20in%20SQL%20Server%20Reporting%20Services.md).

### <a name="host-power-bi-reports-within-the-web-portal"></a>Hospedaje de informes de Power BI dentro del portal web

Ahora puede cargar los archivos de Power BI Desktop en Reporting Services y consultar los informes directamente en el portal web.

![ssrs-powerbi-report-config-render](../reporting-services/media/ssrs-powerbi-report-config-render.png)

Deberá descargar la versión de Power BI Desktop (SQL Server Reporting Services). Actualmente, la versión preliminar solo admite los informes creados en esta versión de Power BI Desktop. Power BI Desktop (SQL Server Reporting Services) puede coexistir con Power BI Desktop para el servicio Power BI. Para descargar Power BI Desktop (SQL Server Reporting Services), vaya al Centro de descarga de Microsoft. 

Actualmente, solo puede crear un informe de Power BI sobre las conexiones dinámicas con Analysis Services (tabular o multidimensional). Tenemos previsto agregar compatibilidad con otros orígenes de datos y con el uso de características de Power Query en una versión preliminar futura.

Para más información, consulte [Informes de Power BI en Reporting Services](../reporting-services/power-bi-reports-in-reporting-services.md).
...
### <a name="reporting-services-includessrswebportal-non-markdowntokenssrswebportal-non-markdownmdmd"></a>Reporting Services [!INCLUDE[ssRSWebPortal-Non-Markdown](../includes/ssrswebportal-non-markdown-md.md)]  
 ...
 #### <a name="custom-branding-for-the-includessrswebportal-non-markdowntokenssrswebportal-non-markdownmdmd"></a>Personalización de marca para el [!INCLUDE[ssRSWebPortal-Non-Markdown](../includes/ssrswebportal-non-markdown-md.md)] 
  ...
  Para más información sobre la personalización de marca, consulte [Personalización de marca del portal web](http://msdn.microsoft.com/es-es/6dac97f7-02a6-4711-81a3-e850a6b40bf1).
 
 #### <a name="key-performance-indicators-kpi-in-the-includessrswebportal-non-markdowntokenssrswebportal-non-markdownmdmd"></a>Indicadores de rendimiento clave (KPI) en el [!INCLUDE[ssRSWebPortal-Non-Markdown](../includes/ssrswebportal-non-markdown-md.md)] 
...
Puede crear KPI directo en el [!INCLUDE[ssRSWebPortal-Non-Markdown](../includes/ssrswebportal-non-markdown-md.md)] que sean contextuales a la carpeta en que se encuentra. Al crear los KPI, puede elegir campos de conjunto de datos y resumir esos valores. También puede seleccionar contenido relacionado para la obtención de detalles.
 ...
 Para más información, vea [Uso de los KPI en Reporting Services](http://msdn.microsoft.com/es-es/a28cf500-6d47-4268-a248-04837e7a09eb)
...
**Gráficos de rectángulos y gráficos de proyección solar:** mejore sus informes con gráficos de rectángulos ![ssrs_treemap_icon](../reporting-services/media/ssrs-treemap-icon.png "ssrs_treemap_icon") y gráficos de proyección solar ![ssrs_sunburst_icon](../reporting-services/media/ssrs-sunburst-icon.png "ssrs_sunburst_icon"), dos formas ideales para mostrar datos jerárquicos. Para obtener más información, consulte [Tree Map and Sunburst Charts in Reporting Services](../reporting-services/report-design/tree-map-and-sunburst-charts-in-reporting-services.md).  
...
**Compatibilidad con ppp elevado:** [!INCLUDE[ssRBnoversion](../includes/ssrbnoversion-md.md)] para [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)] es compatible con el escalado y los dispositivos con valores altos de PPP (puntos por pulgada).  Para obtener más información sobre los valores altos de PPP, consulte los artículos siguientes:  
...
## <a name="see-also"></a>Vea también  
 [Novedades de Analysis Services](http://msdn.microsoft.com/es-es/aa69c299-b8f4-4969-86d8-b3292fe13f08)  
 [Versión preliminar técnica de informes de Power BI en SSRS: notas de la versión](../reporting-services/notas-de-la-versión-de-reporting-services.md)  
 [Notas de la versión de SQL Server 2016](../sql-server/sql-server-2016-release-notes.md)   
 [Compatibilidad con versiones anteriores](http://msdn.microsoft.com/es-es/675b0e0e-cfee-4790-9675-80fc3ea6d30f)   
 [Características de Reporting Services compatibles con las ediciones de SQL Server 2016](http://msdn.microsoft.com/es-es/39f03d2d-6e48-4b34-a9d3-07f86313b937)   
