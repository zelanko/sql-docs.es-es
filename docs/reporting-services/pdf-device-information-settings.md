...
description: Obtenga información sobre la configuración de la información del dispositivo que está disponible para representar informes en formato PDF.
ms.date: 03/16/2018
