...
description: Aprenda a representar un informe basado en una instantánea del historial de informes si proporciona el parámetro rs:Snapshot y establece su valor en un identificador de instantánea válido.
ms.date: 03/01/2017
