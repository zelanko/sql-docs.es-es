...
description: Generador de informes le pide que convierta algunos elementos de informe personalizados, que tienen características no admitidas, al nuevo formato de definición de informe.
ms.date: 08/17/2018
