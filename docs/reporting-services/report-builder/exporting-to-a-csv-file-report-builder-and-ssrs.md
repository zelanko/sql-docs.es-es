---
title: Exportar a un archivo CSV (generador de informes y SSRS) | Documentos de Microsoft
ms.custom: 
ms.date: 03/14/2017
...
-   La cadena delimitadora de registros es el retorno de carro y avance de línea (\<cr >\<lf >).  
