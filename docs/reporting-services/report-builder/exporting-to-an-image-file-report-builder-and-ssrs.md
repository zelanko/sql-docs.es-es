---
title: Exportación de a un archivo de imagen (Generador de informes) | Microsoft Docs
description: En Generador de informes, la extensión de representación en imágenes representa un informe paginado en un mapa de bits o metarchivo. El valor predeterminado es un archivo TIFF visible en varias páginas.
ms.date: 03/07/2017
