---
title: "Cuadro de diálogo secciones (generador de informes) informes | Documentos de Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
# <a name="report-sections-dialog-box-report-builder"></a>Cuadro de diálogo Secciones del informe (Generador de informes)
  Al abrir un informe, el generador de informes comprueba que el informe contiene un único lenguaje RDL (Report Definition)  **\<sección >** elemento. Abrir un informe con varias  **\<sección >** elementos no se admite.  
