---
title: Tipo de conexión de Analysis Services para DMX | Microsoft Docs
description: Obtenga información sobre el tipo de conexión Analysis Services para DMX y aprenda a usar el Diseñador de consultas DMX para crear una consulta DMX mediante elementos gráficos.
ms.date: 03/14/2017
...
## <a name="see-also"></a>Consulte también  
 [Soluciones de minería de datos](/analysis-services/data-mining/data-mining-solutions)   
