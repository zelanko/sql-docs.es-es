...
helpviewer_keywords: 
  ...
  - "Expresiones multidimensionales [Reporting Services]"
  - "Predicción de minería de datos [Reporting Services]"
  - "MDX [Reporting Services], definición de parámetros"
...
4.  En la columna **Parámetro**, haga clic en **\< Escribir parámetro >\>** y, a continuación, escriba el nombre de un parámetro.  
