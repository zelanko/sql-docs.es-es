...
description: Aprenda a usar la interfaz de usuario del diseñador de consultas de Hyperion Essbase para recuperar datos cuando se procesa un informe.
ms.date: 03/01/2017
