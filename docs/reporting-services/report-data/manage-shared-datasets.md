...
## Crear y utilizar conjuntos de datos compartidos  
...
## Administrar los conjuntos de datos compartidos  
...
### Administrar las propiedades de elemento del conjunto de datos compartido  
...
## Ver o cambiar la definición del conjunto de datos compartido  
...
## Controlar el acceso a la definición del conjunto de datos compartido  
...
## Trabajar con las propiedades del conjunto de datos compartido en un servidor de informes  
...
|----------|----------|----------|  
|Agregue un conjunto de datos compartido o cambie las propiedades de definición del conjunto de datos compartido.|Guardar en el Generador de informes.<br /><br /> Implementar en el Diseñador de informes.<br /><br /> Cargar un archivo .rsd en el Administrador de informes.|[Conjuntos de datos incrustados y compartidos de informe &#40;Generador de informes y SSRS&#41;](../../reporting-services/report-data/report-embedded-datasets-and-shared-datasets-report-builder-and-ssrs.md) en la [documentación del Generador de informes](http://go.microsoft.com/fwlink/?LinkId=154494) en msdn.microsoft.com<br /><br /> [Cargar archivo &#40;página del Administrador de informes&#41;](../Topic/Upload%20File%20Page%20\(Report%20Manager\).md)<br /><br /> Si carga un conjunto de datos compartido antes de que se publique el origen de datos compartido del que depende, debe enlazar manualmente el conjunto de datos compartido al origen de datos compartido. Para más información, vea [Página de propiedades generales, conjuntos de datos compartidos &#40;Administrador de informes&#41;](../Topic/General%20Properties%20Page,%20Shared%20Datasets%20\(Report%20Manager\).md).|  
|Cambiar las propiedades de elemento del conjunto de datos compartido.|Administrador de informes|[Página de propiedades generales, conjuntos de datos compartidos &#40;Administrador de informes&#41;](../Topic/General%20Properties%20Page,%20Shared%20Datasets%20\(Report%20Manager\).md)|  
|Especificar propiedades de conjunto de datos compartido adicionales para una instancia del conjunto de datos compartido en un informe.|Diseñador de informes del Generador de informes|[Propiedades del conjunto de datos (cuadro de diálogo), Consulta](../Topic/Dataset%20Properties%20Dialog%20Box,%20Query.md)|  
|Enlazar a un origen de datos compartido diferente para un conjunto de datos compartido.|Administrador de informes|[Selección de origen de datos &#40;página del Administrador de informes&#41;](../Topic/Data%20Source%20Selection%20Page%20\(Report%20Manager\).md)|  
...
|Habilitar el almacenamiento en caché|Administrador de informes|[Almacenar en caché conjuntos de datos compartidos &#40;SSRS&#41;](../../reporting-services/report-server/cache-shared-datasets-ssrs.md)<br /><br /> [Página de almacenamiento en caché, conjuntos de datos compartidos &#40;Administrador de informes&#41;](../Topic/Caching%20Page,%20Shared%20Datasets%20\(Report%20Manager\).md)|  
|Crear o modificar un plan de actualización de la memoria caché|Administrador de informes|[Opciones de actualización de memoria caché &#40;Administrador de informes&#41;](../Topic/Cache%20Refresh%20Options%20\(Report%20Manager\).md)|  
...
## Comparar los conjuntos de datos compartidos con otros elementos del servidor de informes  
