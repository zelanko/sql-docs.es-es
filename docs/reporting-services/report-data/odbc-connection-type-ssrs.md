...
description: Use la información de este artículo sobre el tipo de conexión ODBC para obtener información sobre cómo crear un origen de datos.
ms.date: 03/17/2017
