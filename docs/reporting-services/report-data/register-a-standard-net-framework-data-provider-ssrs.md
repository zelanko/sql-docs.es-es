---
title: "Registrar un proveedor de datos de estándar de .NET Framework (SSRS) | Documentos de Microsoft"
ms.custom: 
ms.date: 03/18/2017
...
4.  Agregue una entrada para el proveedor de datos de [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] .  
    ...
    |**Tipo**|Escriba una lista separada por comas que incluye el espacio de nombres completo de la clase que implementa el <xref:System.Data.IDbConnection> interfaz, seguido del nombre de la [!INCLUDE[dnprdnshort](../../includes/dnprdnshort-md.md)] ensamblado del proveedor de datos (sin incluir la extensión de nombre de archivo .dll).|  
