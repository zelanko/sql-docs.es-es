...
helpviewer_keywords: 
  - "modelos de informe [Reporting Services], consultas"
  - "conjuntos de datos [Reporting Services], crear"
...
|![Deshacer una acción](../../reporting-services/report-data/media/rsqdicon-undo.png "Deshacer una acción")|Deshace la última acción.|  
|![Rehacer una acción](../../reporting-services/report-data/media/rsqdicon-redo.png "Rehacer una acción")|Rehace la última acción.|  
|![Ejecutar la consulta](../../reporting-services/report-data/media/rsqdicon-run.png "Ejecutar la consulta")|Ejecuta la consulta y muestra las filas resultantes en el panel Resultado.|  
|![Gráfico de filtro junto a la columna de filtro seleccionada](../../reporting-services/report-data/media/rsqdicon-filter.png "Gráfico de filtro junto a la columna de filtro seleccionada")|Abre el cuadro de diálogo **Filtrar datos** , que permite especificar los datos que desea filtrar. Puede especificar filtros independientemente de los datos actuales del Área de diseño.|  
...
|![Ejecutar la consulta](../../reporting-services/report-data/media/rsqdicon-run.png "Ejecutar la consulta")|Ejecuta el texto de consulta y muestra el conjunto de filas resultantes en el panel Resultado.|  
