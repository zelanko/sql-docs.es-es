...
description: Aprenda a usar el diseñador de consultas de lista de SharePoint para explorar los metadatos de listas de SharePoint, crear una consulta de forma interactiva y ver sus resultados.
ms.date: 03/14/2017
