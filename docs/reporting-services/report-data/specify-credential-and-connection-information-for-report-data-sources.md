...
ms.topic: "article"
helpviewer_keywords: 
  - "sin credenciales, opción [Reporting Services]"
  - "suplantación [Reporting Services]"
  - "suplantación de usuarios [Reporting Services]"
...
-   Las credenciales del servidor de informes que especifique en el [Inicio de sesión de Reporting Services &#40;cuadro de diálogo del Generador de informes&#41;](../../reporting-services/report-builder/reporting-services-login-dialog-box-report-builder.md).  
...
-   Las credenciales del origen de datos que especifique en la página [Propiedades del origen de datos (cuadro de diálogo), Credenciales &#40;Generador de informes&#41;](../Topic/Data%20Source%20Properties%20Dialog%20Box,%20Credentials%20\(Report%20Builder\).md) de un origen de datos incrustados.  
...
-   Las credenciales del origen de datos que especifique en [Escribir credenciales de origen de datos &#40;cuadro de diálogo del Generador de informes&#41;](../../reporting-services/report-data/enter-data-source-credentials-dialog-box-report-builder.md) al ejecutar una consulta de conjunto de datos, actualizar campos de conjunto de datos o generar una vista previa del informe.  
 ...
 Para más información, vea [Propiedades del origen de datos (cuadro de diálogo), General &#40;Generador de informes&#41;](../Topic/Data%20Source%20Properties%20Dialog%20Box,%20General%20\(Report%20Builder\).md) y [Mostrar la vista previa de informes en el Generador de informes](../../reporting-services/report-builder/previewing-reports-in-report-builder.md).  
...
-   El informe es un subinforme que utiliza las credenciales del informe primario.  
 ...
 En estas condiciones, el servidor de informes se conecta a un origen de datos remoto utilizando una cuenta de ejecución desatendida que debe definirse de antemano. Dado que el servidor de informes no se conecta a un servidor remoto mediante sus credenciales de servicio, debe especificar una cuenta para que el servidor pueda realizar la conexión. Para más información sobre cómo crear la cuenta, vea [Configurar la cuenta de ejecución desatendida &#40;Administrador de configuración de SSRS&#41;](../../reporting-services/install-windows/configure-the-unattended-execution-account-ssrs-configuration-manager.md).  
