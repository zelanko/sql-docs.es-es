---
title: Adición de puntos vacíos a un gráfico (Generador de informes) | Microsoft Docs
description: Especifique puntos vacíos en un gráfico. Para calcular estos puntos en el Generador de informes, se toma el promedio de los puntos de datos anterior y siguiente que contienen un valor.
ms.date: 03/07/2017
