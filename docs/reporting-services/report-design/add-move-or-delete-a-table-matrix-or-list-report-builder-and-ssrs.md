...
description: Organice las regiones de datos de matriz o tabla mediante el Asistente para nueva tabla o el Asistente para nueva matriz en el Generador de informes.
ms.date: 03/01/2017
