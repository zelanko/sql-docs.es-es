...
description: Aprenda a usar gráficos de áreas en el Generador de informes, que muestran una serie como un conjunto de puntos conectados por una línea, con el área situada debajo de la línea totalmente rellenada.
ms.date: 03/03/2017
