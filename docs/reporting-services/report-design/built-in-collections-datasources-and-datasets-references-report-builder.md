---
title: Referencias a las colecciones DataSources y DataSets (Generador de informes) | Microsoft Docs
description: Obtenga información sobre las colecciones de orígenes de datos y conjunto de datos. Descubra cómo hacer que estén disponibles una vez que se publica el informe en un servidor de informes en el Generador de informes.
ms.date: 03/01/2017
