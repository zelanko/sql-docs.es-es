---
title: Referencias a la colección ReportItems (Generador de informes) | Microsoft Docs
description: Descubra la colección ReportItems. Estos cuadros de texto del Generador de informes están en el ámbito actual de un encabezado de página, un pie de página o el cuerpo del informe.
ms.date: 03/01/2017
