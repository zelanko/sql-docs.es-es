...
description: Reemplace un elemento que no sea un contenedor, como un cuadro de texto, una línea o una imagen, en los informes paginados por un elemento de informe nuevo en el Generador de informes.
ms.date: 03/01/2017
