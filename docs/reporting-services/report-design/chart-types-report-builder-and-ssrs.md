...
description: Elija características de gráfico únicas para ayudarle a visualizar el conjunto de datos y a seleccionar un tipo de gráfico adecuado en el Generador de informes.
ms.date: 05/30/2017
