...
description: Use regiones de datos de gráfico para ayudar a los lectores de los informes paginados a comprender grandes volúmenes de datos agregados de un vistazo en el Generador de informes.
ms.date: 03/07/2017
