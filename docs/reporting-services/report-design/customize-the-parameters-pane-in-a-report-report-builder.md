---
title: "Personalizar el panel de parámetros en un informe (generador de informes) | Documentos de Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
1.  En la pestaña **Vista** , seleccione la casilla **Parámetros** para mostrar el panel de parámetros.  
     ...
     ![Panel de parámetros de acceso desde la ficha vista](../../reporting-services/report-design/media/ssrs-customparameter-accessparameterpanedesignmode.png "panel de parámetros de acceso de la pestaña de vista")  
...
2.  Para agregar un parámetro al panel, siga unos de los siguientes procedimientos.  
    ...
    -   Haga clic con el botón derecho en una celda vacía del panel de parámetros y después haga clic en **Agregar parámetro**.  
         ...
         ![Agregar nuevo parámetro del panel de parámetros](../../reporting-services/report-design/media/ssrs-customizeparameter-addnewparameter.png "Agregar nuevo parámetro del panel de parámetros")  
...
4.  Para acceder a las propiedades de un parámetro, siga unos de los siguientes procedimientos.  
    ...
    -   Haga clic con el botón derecho en el parámetro del panel de parámetros y después haga clic en **Propiedades del parámetro**.  
         ...
         ![Acceso a propiedades de parámetro desde el panel de parámetros](../../reporting-services/report-design/media/ssrs-customizeparameter-accessparameterproperties-composite.png "acceso a propiedades de parámetro desde el panel de parámetros")  
...
5.  Para agregar columnas y filas nuevas al panel, o eliminar columnas y filas existentes, haga clic con el botón derecho en cualquier lugar del panel de parámetros y después haga clic en un comando del menú que aparece.  
     ...
     ![Agregar columnas y filas en el panel de parámetros](../../reporting-services/report-design/media/ssrs-customparameter-addcolumnsrows.png "agregar columnas y filas en el panel de parámetros")  
...
6.  Para eliminar un parámetro del panel y del informe, siga uno de los siguientes procedimientos.  
    ...
    -   Haga clic con el botón derecho en el parámetro del panel de parámetros y después haga clic en  **Eliminar**.  
         ...
         ![Eliminar parámetros desde el panel de parámetros](../../reporting-services/report-design/media/ssrs-customparameter-deleteparameter.png "elimina parámetros desde el panel de parámetros")  
