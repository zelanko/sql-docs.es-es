...
description: Controle el contenido, el diseño y la interactividad del informe con expresiones que permiten recuperar, mostrar, filtrar y dar formato a los datos en el Generador de informes.
ms.date: 09/06/2016
