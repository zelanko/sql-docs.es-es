---
title: Formato de texto en un cuadro de texto (Generador de informes) | Microsoft Docs
description: Descubra cómo dar formato al texto de un cuadro de texto y cómo mezclar texto de marcador de posición y texto estático para crear combinaciones de correspondencia o plantillas para texto en el Generador de informes.
ms.date: 03/01/2017
...
## <a name="see-also"></a>Consulte también  
 ...
 [Agregar HTML a un informe &#40;Generador de informes y SSRS&#41;](../../reporting-services/report-design/add-html-into-a-report-report-builder-and-ssrs.md)   
