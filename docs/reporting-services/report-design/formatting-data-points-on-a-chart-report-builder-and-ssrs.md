...
## Agregar información sobre herramientas y acciones de obtención de detalles a los puntos de datos  
...
## Agregar palabras clave para las etiquetas de punto de datos, información sobre herramientas y texto de la leyenda  
...
|#SERIESNAME|Nombre de la serie.|Todos|None|  
|#LABEL|Etiqueta de punto de datos.|Todos|None|  
|#AXISLABEL|Etiqueta de punto de datos de eje.|Forma|`=Fields!MyDataField.Value`|  
|#INDEX|Índice de punto de datos.|Todos|None|  
...
|#LEGENDTEXT|Texto correspondiente al texto del elemento de la leyenda.|Todos|None|  
