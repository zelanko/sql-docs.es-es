---
title: "Aplicar formato a líneas, colores e imágenes (generador de informes y SSRS) | Documentos de Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
## <a name="borders-lines-and-gridlines"></a>Bordes, líneas y líneas de cuadrícula  
 ...
 Además de los marcos de borde estándar, también puede aplicar a los gráficos marcos de borde adicionales. Para obtener más información, vea [Agregar un marco de borde a un gráfico &#40;Generador de informes y SSRS&#41;](../../reporting-services/report-design/add-a-border-frame-to-a-chart-report-builder-and-ssrs.md).  
  
 También puede agregar un borde al propio informe. Para obtener más información, vea [Agregar un borde a un informe &#40;Generador de informes y SSRS&#41;](../../reporting-services/report-design/add-a-border-to-a-report-report-builder-and-ssrs.md).  
...
## <a name="applying-background-colors"></a>Aplicar colores de fondo  
 ...
 Cuando use el gráfico, también podrá especificar degradados y estilos de trama para los colores de fondo. Para obtener más información, vea [Aplicar formato a un gráfico &#40;Generador de informes y SSRS&#41;](../../reporting-services/report-design/formatting-a-chart-report-builder-and-ssrs.md).  
