---
title: Aplicación de formato a las escalas de un medidor (Generador de informes) | Microsoft Docs
description: Obtenga información sobre los números de intervalo de escala del medidor comprendidos entre un mínimo y un máximo de un informe paginado en el Generador de informes.
ms.date: 03/01/2017
