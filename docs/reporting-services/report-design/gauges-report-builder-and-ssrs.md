...
> [!NOTE]  
>  Puede publicar medidores por separado de un informe como elementos de informe. Obtenga más información sobre [Elementos de informe](../../reporting-services/report-design/report-parts-report-builder-and-ssrs.md).  
...
### Agregar campos en un solo valor  
 ...
 Para obtener más información sobre las expresiones de agregado, vea [Referencia a las funciones de agregado &#40;Generador de informes y SSRS&#41;](../../reporting-services/report-design/aggregate-functions-reference-report-builder-and-ssrs.md).  
...
-   [Establecer un intervalo de ajuste en un medidor (Generador de informes y SSRS)](http://msdn.microsoft.com/es-es/0ece7297-6e2f-47fb-835d-b9e9cce53fe2)  
  
-   [Especificar una imagen como puntero en un medidor (Generador de informes y SSRS)](http://msdn.microsoft.com/es-es/9d73b3c3-a068-4868-a2be-0cd261b6e92b)  
