...
description: Muestre grupos de filas y columnas para una región de datos Tablix seleccionada actualmente. Obtenga información sobre el panel de agrupación en el Generador de informes.
ms.date: 08/17/2018
