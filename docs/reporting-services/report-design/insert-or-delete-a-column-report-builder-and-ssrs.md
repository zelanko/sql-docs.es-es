...
description: Agregue o elimine columnas en una región de datos Tablix de un informe paginado. En el Generador de informes, la región de datos Tablix puede ser una tabla, una matriz o una lista.
ms.date: 03/01/2017
