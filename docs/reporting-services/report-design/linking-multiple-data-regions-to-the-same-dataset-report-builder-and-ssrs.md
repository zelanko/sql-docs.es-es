...
description: Descubra cómo agregar varias regiones de datos a un informe paginado de para proporcionar otras vistas de los datos a partir del mismo conjunto de datos de informe en el Generador de informes.
ms.date: 05/30/2017
