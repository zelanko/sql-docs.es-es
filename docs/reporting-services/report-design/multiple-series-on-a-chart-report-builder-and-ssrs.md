---
title: Representación de varias series en un gráfico (Generador de informes) | Microsoft Docs
description: Obtenga información sobre cómo usar varias series en un gráfico al mostrar dos series de datos relacionadas, como precio y volumen, o ingresos e impuestos, en el Generador de informes.
ms.date: 03/07/2017
