---
title: "Agregar función (generador de informes y SSRS) | Documentos de Microsoft"
ms.custom: 
ms.date: 03/14/2017
...
---
# <a name="report-builder-functions---aggregate-function"></a>Funciones del generador de informes - función de agregado
