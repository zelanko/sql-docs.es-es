---
title: "Función Count (generador de informes y SSRS) | Documentos de Microsoft"
ms.custom: 
ms.date: 03/07/2017
...
---
# <a name="report-builder-functions---count-function"></a>Notificar a las funciones del generador - Count (función)
