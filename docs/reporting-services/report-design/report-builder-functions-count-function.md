...
description: Obtenga información sobre la función Count, que devuelve un recuento de valores no NULL especificados por una expresión, que se evalúa en el contexto de un ámbito especificado.
ms.date: 03/07/2017
