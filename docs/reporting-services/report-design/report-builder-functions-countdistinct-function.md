...
description: Obtenga un recuento de todos los valores no NULL distintos especificados por una expresión en el contexto de un ámbito concreto.
ms.date: 03/07/2017
