...
description: Obtenga información sobre la función CountRows, que devuelve el número de filas de un ámbito especificado, incluidas las que tienen valores NULL.
ms.date: 03/07/2017
