...
description: Use la función First para devolver el primer valor del ámbito dado de la expresión especificada en el Generador de informes.
ms.date: 03/07/2017
