---
title: "Función First (generador de informes y SSRS) | Documentos de Microsoft"
ms.custom: 
ms.date: 03/07/2017
...
---
# <a name="report-builder-functions---first-function"></a>-Las funciones del generador de informes en primer lugar la función
