---
title: Función InScope (Generador de informes) | Microsoft Docs
description: La función InScope indica si la instancia actual de un elemento se encuentra en el ámbito especificado del Generador de informes.
ms.date: 03/08/2017
