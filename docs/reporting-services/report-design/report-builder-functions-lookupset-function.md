...
description: Obtenga información sobre la función LookupSet, que devuelve el conjunto de valores coincidentes para un nombre especificado de un conjunto de datos que contiene pares de nombre o valor.
ms.date: 03/07/2017
