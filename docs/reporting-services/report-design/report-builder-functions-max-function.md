---
title: Función Max (Generador de informes) | Microsoft Docs
description: Obtenga información sobre la función Max, que devuelve el valor máximo de todos los valores numéricos no NULL especificados por la expresión en el Generador de informes.
ms.date: 03/07/2017
