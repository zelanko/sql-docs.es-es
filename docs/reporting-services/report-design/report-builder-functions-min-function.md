---
title: "Función Min (generador de informes y SSRS) | Documentos de Microsoft"
ms.custom: 
ms.date: 03/07/2017
...
---
# <a name="report-builder-functions---min-function"></a>Funciones del generador de informes - Min (función)
