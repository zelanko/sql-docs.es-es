---
title: Función Min (Generador de informes) | Microsoft Docs
description: Obtenga información sobre la función Min, que devuelve el valor mínimo de todos los valores numéricos no NULL especificados por una expresión en el Generador de informes.
ms.date: 03/07/2017
