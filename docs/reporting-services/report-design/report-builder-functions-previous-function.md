...
description: La función Previous del Generador de informes devuelve el valor o el valor agregado especificado para la instancia anterior de un elemento.
ms.date: 03/07/2017
