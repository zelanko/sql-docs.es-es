---
title: "Función StDev (generador de informes y SSRS) | Documentos de Microsoft"
ms.custom: 
ms.date: 03/07/2017
...
---
# <a name="report-builder-functions---stdev-function"></a>Notificar a las funciones del generador - StDev, función
