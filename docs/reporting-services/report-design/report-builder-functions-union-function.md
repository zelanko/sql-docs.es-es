---
title: Función Union (Generador de informes) | Microsoft Docs
description: Obtenga información sobre esta función que devuelve la unión de todos los valores numéricos no NULL especificados por una expresión.
ms.date: 03/07/2017
