---
title: Función VarP (Generador de informes) | Microsoft Docs
description: La función VarP del Generador de informes devuelve la varianza de población de todos los valores numéricos no NULL especificados por la expresión.
ms.date: 03/07/2017
