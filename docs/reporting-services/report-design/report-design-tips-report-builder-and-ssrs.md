---
title: Sugerencias para el diseño de informes (Generador de informes) | Microsoft Docs
description: Identifique métodos de diseño visual para mejorar la presentación de los datos en el Generador de informes. Personalice los informes con gráficos, barras de datos, indicadores, minigráficos, tablas y mapas.
ms.date: 03/01/2017
