...
description: Descubra formas de usar el tamaño, además del color, la dirección y la forma, para maximizar el impacto visual de los indicadores en el Generador de informes.
ms.date: 03/01/2017
