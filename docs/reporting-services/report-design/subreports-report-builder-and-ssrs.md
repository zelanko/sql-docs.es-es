...
description: Muestre un informe dentro de otro. Muestre y almacene los dos informes en la misma carpeta de servidor en el Generador de informes.
ms.date: 03/07/2017
