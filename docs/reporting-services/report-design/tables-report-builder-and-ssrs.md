...
### Agregar totales para datos detallados  
 ...
 ![Vista previa con una tabla y fila de totales](../../reporting-services/report-design/media/rs-basictabledetailstotalpreview.gif "Vista previa con una tabla y fila de totales")  
  
 Para más información, vea [Agregar un total a un grupo o a una región de datos Tablix &#40;Generador de informes y SSRS&#41;](../../reporting-services/report-design/add-a-total-to-a-group-or-tablix-data-region-report-builder-and-ssrs.md).  
...
##  <a name="AddingRowGroups"></a> Agregar grupos de filas a una tabla  
 ...
 ![Tabla agrupada por fecha y después por pedido](../../reporting-services/media/rs-basictablegroupspreview.gif "Tabla agrupada por fecha y después por pedido")  
...
##  <a name="RemovingHidingRows"></a> Quitar u ocultar filas de detalles  
 ...
 ![Vista Diseño, tabla con dos grupos, sin detalles](../../reporting-services/report-design/media/rs-basictablegroupsdrilldownnodetailsdesign.gif "Vista Diseño, tabla con dos grupos, sin detalles")  
...
>  Compruebe que, después de quitar una fila de detalles, la expresión de cada celda especifica una expresión de agregado donde corresponda. Si es necesario, edite la expresión para especificar las funciones de agregado que se requieran.  
 ...
 ![Vista previa, tabla con grupos pero sin filas de detalle](../../reporting-services/report-design/media/rs-basictablegroupsnodetailspreview.gif "Vista previa, tabla con grupos pero sin filas de detalle")  
 ...
 Para más información, vea [Agregar una acción de expandir y contraer a un elemento &#40;Generador de informes y SSRS&#41;](../../reporting-services/report-design/add-an-expand-or-collapse-action-to-an-item-report-builder-and-ssrs.md).  
