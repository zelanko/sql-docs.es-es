...
description: Muestre datos detallados o datos agrupados mediante uno o varios campos, o bien escriba una expresión propia en un informe paginado en el Generador de informes.
ms.date: 03/07/2017
...
##  <a name="adding-row-groups-to-a-table"></a><a name="AddingRowGroups"></a> Agregar grupos de filas a una tabla  
 ...
 ![Tabla agrupada por fecha y después por pedido](../../reporting-services/media/rs-basictablegroupspreview.png "Tabla agrupada por fecha y después por pedido")  
