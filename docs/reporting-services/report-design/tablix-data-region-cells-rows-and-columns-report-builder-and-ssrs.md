---
title: "Celdas de la región de datos Tablix, filas y columnas (generador de informes) y SSRS | Documentos de Microsoft"
ms.custom: 
ms.date: 03/07/2017
...
|![Dos corchetes que se muestran los grupos anidados en paralelo](../../reporting-services/report-design/media/rs-icontablix-nestedgroupnodetails.gif "dos corchetes que se muestran los grupos anidados en paralelo")|Un grupo exterior y un grupo interno; ningún grupo de detalles|  
|![2 corchetes y 3 líneas apiladas para anidados y detalles](../../reporting-services/report-design/media/rs-icontablix-nestedgroupwithdetails.gif "2 corchetes y 3 líneas apiladas para anidados y detalles")|Un grupo exterior, un grupo interno y el grupo de detalles secundario|  
|![Un grupo exterior con fila de pie de página, un grupo interno](../../reporting-services/report-design/media/rs-icontablix-nestedgroupwithparentfooter.gif "un grupo exterior con fila de pie de página, un grupo interno")|Un grupo exterior con una fila de pie para los totales y un grupo interno|  
...
|![primarios encabezado y pie de página y también grupo secundario](../../reporting-services/report-design/media/rs-icontablix-nestedgroupwithparentheaderandfooter.gif "primarios encabezado y pie de página y también grupo secundario")|Un grupo exterior con un encabezado para las etiquetas y un pie para los totales, y un grupo interno; ningún grupo de detalles|  
...
-   Indicadores de grupo que muestran todas las pertenencias a los grupos para una celda seleccionada.  
 ...
 ![Tabla con detalles y grupos de filas anidados](../../reporting-services/report-design/media/rs-tablixrowgroupvisualcues.gif "tabla con detalles y grupos de filas anidados")  
