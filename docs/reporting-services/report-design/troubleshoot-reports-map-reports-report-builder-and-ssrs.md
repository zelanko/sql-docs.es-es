...
## Cuando establezco un desplazamiento para un elemento de mapa individual, se mueve un grupo de elementos de mapa  
...
## Una capa, que utiliza datos espaciales de un archivo de forma ESRI, siempre tiene datos insertados.  
...
## Cambié el nombre de un origen de datos o conjunto de datos por un nombre descriptivo y ahora no aparece ningún dato en el mapa.  
...
## No puedo establecer el centro y la vista en un elemento de mapa incrustado.  
...
## Establecí el centro y la vista de un mapa en un informe. Cuando vuelvo a abrir el informe, ¿por qué la vista del mapa no es la misma?  
...
## Aparece un error de expresión sobre el ámbito del conjunto de datos al establecer una etiqueta o Información sobre herramientas en una expresión.  
...
## Vea también  
 ...
 [Solucionar problemas del Generador de informes](http://msdn.microsoft.com/es-es/3806fc48-56f8-44d1-a3c1-df8c33cce0a3)  
