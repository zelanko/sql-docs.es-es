...
description: Con SQL Server Reporting Services, puede integrar el entorno de creación de informes con un producto de SharePoint para usar la colaboración que proporcionan los sitios de SharePoint.
ms.date: 08/17/2018
