---
title: "Habilitar y deshabilitar el espacio seguro para RDL | Microsoft Docs"
ms.custom: ""
ms.date: "03/20/2017"
...
|**AllowNew**|Atributo booleano de **Allow** que controla si se permite que las nuevas instancias del tipo se creen en expresiones RDL o en un elemento **\<Class>** de RDL.<br /><br /> Nota: Cuando se habilita **RDLSandboxing** , no se pueden crear nuevas matrices en expresiones RDL, independientemente de la configuración de **AllowNew**.|  
...
-   Agregar la nueva clase a la lista de permitidos.  
 ...
 Para agregar palabras clave de tipo de [!INCLUDE[vbprvb](../../includes/vbprvb-md.md)] .NET Framework a la lista de permitidos, agregue el tipo CLR correspondiente a la lista de permitidos. Por ejemplo, para usar la palabra clave **Integer** de [!INCLUDE[vbprvb](../../includes/vbprvb-md.md)] .NET Framework, agregue el siguiente fragmento XML al elemento **\<RDLSandboxing>**:  
