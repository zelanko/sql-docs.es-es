...
description: Al crear una aplicación de servicio en el modo de SharePoint de SQL Server Reporting Services, el servicio está disponible y se genera la base de datos de aplicación del servicio.
ms.date: 09/25/2017
