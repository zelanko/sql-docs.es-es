...
description: Obtenga información sobre las características de colección de sitios de SharePoint que proporciona el modo de SharePoint de Reporting Services.
ms.date: 09/25/2017
