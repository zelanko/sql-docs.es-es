...
description: El servicio web del servidor de informes usa SOAP sobre HTTP y actúa como interfaz de comunicaciones entre los clientes y el servidor de informes. Use WSDL para llamar al servicio.
ms.date: 03/14/2017
