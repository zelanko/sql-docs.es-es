...
3. Haga clic en **Nueva instantánea**. Se crea una nueva instantánea en la columna **Cuando se ejecuta** .  
    > [!NOTE]
    > Para habilitar la creación de instantáneas, el administrador debe configurar el historial de informe **permitir que el historial se cree manualmente**. Para obtener más información, vea [Limitar el historial de informe &#40;Administrador de informes&#41;](../reports/limit-report-history-report-manager.md).
...
1. En el portal web, desplácese hasta el elemento que desea ver el historial de y haga clic en él.  
  
2. En el menú desplegable, seleccione **Administrar**.  
  
3. Seleccione el **instantáneas del historial** ficha.  
  
4. En el **instantáneas del historial** página, seleccione el **nueva instantánea del historial**. Una nueva instantánea, se crea y aparece a continuación con la fecha y hora actuales en el **creado** columna.  
  
    > [!NOTE]
    > Para habilitar la creación de instantáneas, el administrador debe configurar el historial de informe **permitir que el historial se cree manualmente**. Para obtener más información, consulte [limitar el historial de informe (portal web)](../../reporting-services/reports/limit-report-history-report-manager.md).

## <a name="to-add-snapshots-via-a-schedule-to-report-history"></a>Para agregar instantáneas a través de una programación para el historial de informes
...
4. En el **instantáneas del historial** página, seleccione el **programación y configuración** botón.  
  
5. En el **programación** , seleccione una o ambas de las opciones siguientes si al menos una opción no está ya seleccionada:
    - **Crear instantáneas del historial según una programación**.  
    - **Permitir que los usuarios puedan crear manualmente instantáneas**.  
  
6. En el **avanzadas** sección, seleccione **conserve todas las instantáneas de historial**.  
  
7. Opcionalmente, seleccione la casilla de verificación **guardar las instantáneas de caché en el historial de informes también**.  
...
2. En el portal web, desplácese hasta el elemento que desea ver el historial de y haga clic en él.  
  
3. En el menú desplegable, seleccione **Administrar**.  
  
4. Seleccione el **instantáneas del historial** ficha.  
  
5. En el **instantáneas del historial** página, seleccione el **programación y configuración** botón.  
  
6. En el **programación** , seleccione una o ambas de las opciones siguientes si al menos una opción no está ya seleccionada:
    - **Crear instantáneas del historial según una programación**.  
    - **Permitir que los usuarios puedan crear manualmente instantáneas**.  
  
7. En el **avanzadas** sección, seleccione **conserve todas las instantáneas de historial**.  
  
8. Opcionalmente, seleccione la casilla de verificación **guardar las instantáneas de caché en el historial de informes también**.  
