...
description: Obtenga información sobre los eventos que hacen que un dominio de aplicación se recicle para las aplicaciones de Reporting Services a fin de solucionar problemas.
ms.date: 03/20/2017
