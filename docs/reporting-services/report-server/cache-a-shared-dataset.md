...
description: Aprenda a programar la expiración de un conjunto de datos compartido en el Administrador de informes. El almacenamiento en caché de conjuntos de datos mejora el rendimiento.
ms.date: 03/01/2017
