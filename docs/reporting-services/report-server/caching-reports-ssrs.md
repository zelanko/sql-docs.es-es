...
helpviewer_keywords: 
  ...
  - "procesamiento de informes [Reporting Services], almacenar en caché"
  - "instancias almacenadas en caché [Reporting Services]"
  - "actualizar la caché"
  - "informes almacenados en caché [Reporting Services]"
  - "cargar previamente la memoria caché"
  - "informes almacenados en caché no válidos [Reporting Services]"
  - "rendimiento [Reporting Services]"
  - "expiración [Reporting Services]"
  - "instantáneas [Reporting Services], almacenar en caché"
...
## Vea también  
 ...
 [Opciones de actualización de memoria caché &#40;Administrador de informes&#41;](../Topic/Cache%20Refresh%20Options%20\(Report%20Manager\).md)  
