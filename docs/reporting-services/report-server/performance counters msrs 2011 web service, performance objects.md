---
title: "Contadores de rendimiento para los objetos de rendimiento de MSRS 2011 Web Service y MSRS 2011 Windows Service (modo nativo) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "Servicio web del servidor de informes, contadores de rendimiento"
  - "rendimiento (objeto de Reporting Services)"
  - "objeto de rendimiento del servicio web RS"
...
manager: "erikre"
---
# Contadores de rendimiento para los objetos de rendimiento de MSRS 2011 Web Service y MSRS 2011 Windows Service (modo nativo)
...
|**Aciertos de caché por segundo**|Número de solicitudes por segundo para informes en memoria caché. Las solicitudes son para informes que se vuelven a representar, no de solicitudes para informes procesados directamente desde la memoria caché. (Consulte **Total de aciertos de caché** más adelante en este tema).|  
...
##  <a name="bkmk_powershell"></a> Usar cmdlets de PowerShell para devolver listas  
 ![Contenido relacionado con PowerShell](../../analysis-services/instances/install-windows/media/rs-powershellicon.png "Contenido relacionado con PowerShell")El siguiente script de Windows PowerShell devuelve los conjuntos de contadores en los que CounterSetName comienza con “msr”:  
