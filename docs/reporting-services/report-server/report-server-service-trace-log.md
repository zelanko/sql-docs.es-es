...
ms.topic: "article"
helpviewer_keywords: 
  - "registros [Reporting Services], seguimiento"
  - "seguimientos [Reporting Services]"
  - "información del sistema [Reporting Services]"
  - "versiones [Reporting Services]"
