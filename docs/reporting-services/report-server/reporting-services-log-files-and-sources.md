...
ms.topic: "article"
helpviewer_keywords: 
  - "solución de problemas [Reporting Services], archivos de registro"
  - "registros [Reporting Services]"
  - "registros [Reporting Services], acerca de los archivos de registro"
  - "servidores de informes [Reporting Services], archivos de registro"
  - "Archivos de inicio de sesión"
  - "archivos [Reporting Services], registros"
