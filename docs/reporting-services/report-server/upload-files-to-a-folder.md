...
description: Obtenga información sobre lo que ocurre cuando se cargan diferentes tipos de archivo desde el sistema de archivos y se almacenan como elementos administrados en una base de datos del servidor de informes en Reporting Services.
ms.date: 06/17/2019
