...
|Tema|Descripción|  
|-----------|-----------------|  
|[Funcionalidad de SQL Server Reporting Services no incluida en SQL Server 2016](discontinued-functionality-to-sql-server-reporting-services-in-sql-server.md)|Describe características que existían en versiones anteriores de [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] pero que se han quitado en versiones posteriores.|  
