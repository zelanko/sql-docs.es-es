...
description: Obtenga información sobre los conceptos de SQL Server Reporting Services (SSRS), como la programación de informes, roles y permisos, y las suscripciones y entrega de informes.
ms.date: 10/25/2016
