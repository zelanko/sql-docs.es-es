---
title: "Documentación para desarrolladores de Reporting Services | Documentos de Microsoft"
ms.custom: 
ms.date: 03/17/2017
...
## <a name="in-this-section"></a>En esta sección  
 ...
 La arquitectura modular de [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] se ha diseñado para permitir ampliaciones. Hay una API de código administrado que permite desarrollar, instalar y administrar con facilidad las extensiones que usan numerosos componentes de [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]. Puede crear ensamblados mediante el [!INCLUDE[msCoName](../includes/msconame-md.md)] [!INCLUDE[dnprdnshort](../includes/dnprdnshort-md.md)] y agregar nuevas [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)] funcionalidad de representación, seguridad, entrega y procesamiento de datos para satisfacer las necesidades empresariales en constante evolución.  
