...
helpviewer_keywords: 
  ...
  - "SSRS"
  - "informes [Reporting Services], acerca de los informes"
  - "Reporting Services"
...
# Reporting Services (SSRS)
  Cree, implemente y administre informes móviles y paginados de forma local con la gama de servicios y herramientas listos para usar que ofrece SQL Server Reporting Services (SSRS). 
...
* **Un portal web moderno** que puede ver en cualquier explorador moderno. En este portal nuevo, puede organizar y mostrar informes móviles y paginados, además de KPI nuevos. También puede almacenar libros de Excel e informes de Power BI Desktop en el portal. 
...
* [Novedades de Reporting Services](../reporting-services/novedades-de-sql-server-reporting-services-ssrs.md)
...
El portal web todavía incluye la jerarquía de carpetas tradicional, para que pueda organizar el contenido. El contenido está organizado por tipos: informes móviles, KPI, informes paginados, informes de Power BI Desktop, libros de Excel, conjuntos de datos compartidos y orígenes de datos compartidos que se usarán como bloques de creación de informes; además, puede almacenarlos y gestionarlos aquí de forma segura.
...
Más información sobre el [portal web de Reporting Services](../reporting-services/web-portal-ssrs-native-mode.md).
...
## <a name="includessrsnoversiontokenssrsnoversionmdmd-programming-features"></a>Características de programación de [!INCLUDE[ssRSnoversion](../includes/ssrsnoversion-md.md)]  
...
## <a name="browse-content-by-area"></a>Examinar contenido por área  
* [Compatibilidad con versiones anteriores](../reporting-services/compatibilidad-con-versiones-anteriores-reporting-services.md) 
...
* [El portal web](../reporting-services/web-portal-ssrs-native-mode.md)
* [Informes de Reporting Services &#40;SSRS&#41;](../reporting-services/reports/reporting-services-reports-ssrs.md)  
* [Datos de informe &#40;SSRS&#41;](../reporting-services/report-data/report-data-ssrs.md)  
* [Generador de informes en SQL Server 2016](../reporting-services/report-builder/report-builder-in-sql-server-2016.md)  
* [Publicador de informes móviles de SQL Server](../reporting-services/mobile-reports/create-mobile-reports-with-sql-server-mobile-report-publisher.md)  
* [KPI en Reporting Services](../reporting-services/working-with-kpis-in-reporting-services.md)
