...
ms.topic: "article"
helpviewer_keywords: 
  - "Diseñador de informes [Reporting Services], realizar vista previa de informes"
  - "obtener una vista previa de informes[Reporting Services]"
  - "vistas preliminares"
  - "servidores de pruebas [Reporting Services]"
...
-   Hacer clic en el botón **Iniciar** de la barra de herramientas estándar de [!INCLUDE[vsprvs](../../includes/vsprvs-md.md)] ![ssrs_ssdt_startdebug](../../reporting-services/reports/media/ssrs-ssdt-startdebug.png "ssrs_ssdt_startdebug").  
...
## Publicar en un servidor de pruebas  
