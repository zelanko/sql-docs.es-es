...
description: Aprenda a usar las características de implementación de SQL Server Data Tools (SSDT) para publicar los informes en un servidor de informes.
ms.date: 06/01/2016
