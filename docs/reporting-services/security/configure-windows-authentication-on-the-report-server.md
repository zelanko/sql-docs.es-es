...
4.  Péguela para sobrescribir las entradas existentes de \<**Authentication**>.  
...
##  <a name="proxyfirewallRSWindowsNegotiate"></a> Resolver los errores de autenticación Kerberos al conectarse a un servidor de informes  
...
-   Los valores debajo de \<Explicit> contendrán los SPN configurados en Active Directory para la cuenta de servicio de [!INCLUDE[ssRSnoversion](../../includes/ssrsnoversion-md.md)].  
