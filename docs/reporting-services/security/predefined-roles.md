...
ms.topic: "article"
helpviewer_keywords: 
  - "seguridad [Reporting Services], valores predeterminados"
  - "seguridad predeterminada"
  - "seguridad basada en roles [Reporting Services], valores predeterminados"
...
## Cómo usar los roles predefinidos  
...
3.  Cuando esté preparado para asignar cuentas de usuario y de grupo a roles concretos, use el Administrador de informes. Para obtener más información, vea [Conceder a un usuario acceso a un servidor de informes &#40;Administrador de informes&#41;](../../reporting-services/security/grant-user-access-to-a-report-server-report-manager.md).  
...
### Personalizar el rol Administrador de contenido  
...
### Personalizar el rol Explorador  
...
### Personalizar el rol Generador de informes  
...
### Personalizar el rol Mis informes  
