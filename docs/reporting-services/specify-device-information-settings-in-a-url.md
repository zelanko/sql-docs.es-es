...
description: Aprenda a especificar la configuración de la información del dispositivo en una dirección URL, en concreto con el elemento DeviceInfo de XML.
ms.date: 03/16/2017
