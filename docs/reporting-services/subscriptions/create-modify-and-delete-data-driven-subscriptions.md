---
title: "C&#243;mo crear, modificar y eliminar suscripciones controladas por datos | Microsoft Docs"
ms.custom: ""
ms.date: "03/01/2017"
...
helpviewer_keywords: 
  ...
  - "consultas [Reporting Services], suscripciones controladas por datos"
...
3.  Seleccione la suscripción que desea modificar. El siguiente icono indica que se trata de una suscripción controlada por datos: ![Icono de suscripción controlada por datos](../../reporting-services/subscriptions/media/hlp-16subscriptiondd.png "Icono de suscripción controlada por datos")  
...
-   **Requisitos de informes** El informe debe utilizar credenciales almacenadas o ninguna credencial para recuperar datos en tiempo de ejecución. No es posible suscribirse a un informe que utilice credenciales suplantadas o delegadas para conectarse a un origen de datos externo; las credenciales del usuario que crea la suscripción o es propietario de ella no estarán disponibles cuando se procese la suscripción. Las credenciales almacenadas pueden ser una cuenta de Windows o una cuenta de usuario de base de datos. Para más información, consulte [Specify Credential and Connection Information for Report Data Sources](../../reporting-services/report-data/specify-credential-and-connection-information-for-report-data-sources.md).  
...
## Vea también  
 ...
 [Suscripciones &#40;página del Administrador de informes&#41;](../Topic/Subscriptions%20Page%20\(Report%20Manager\).md)   
 [Mis suscripciones &#40;página del Administrador de informes&#41;](../Topic/My%20Subscriptions%20Page%20\(Report%20Manager\).md)  
