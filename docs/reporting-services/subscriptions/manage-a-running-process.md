...
description: Aprenda a administrar un proceso en ejecución, como el trabajo de un usuario o del sistema. Puede ver un trabajo, cancelarlo o administrarlo mediante programación.
ms.date: 03/20/2017
