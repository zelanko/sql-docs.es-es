...
ms.topic: "article"
helpviewer_keywords: 
  - "suscripciones [Reporting Services], inactivas"
  - "suscripciones [Reporting Services], estado"
  - "supervisión [Reporting Services], suscripciones"
  - "información de estado [Reporting Services]"
  - "suscripciones inactivas [Reporting Services]"
...
|Realizado: \<*número*> procesados de un total de \<*número*>; \<*número*> errores.|Muestra el estado de la ejecución de una suscripción controlada por datos; este mensaje procede del Procesador de entrega y programación.|  
...
|El archivo \<*nombre de archivo*> se ha escrito en \<ruta de acceso>.|Indica que se ha realizado correctamente la entrega a la ubicación del recurso compartido de archivos; este mensaje procede de la extensión de entrega a recursos compartidos de archivos.|  
...
|Error al conectar con la carpeta de destino, \<ruta>. Compruebe si existe la carpeta de destino o el recurso compartido.|Indica que no se puede encontrar la carpeta que ha especificado; este mensaje procede de la extensión de entrega a recursos compartidos de archivos.|  
|No se ha podido escribir el archivo \<nombreDeArchivo> en \<ruta>. Nuevo intento.|Indica que no se ha podido actualizar el archivo con una versión más reciente; este mensaje procede de la extensión de entrega a recursos compartidos de archivos.|  
