...
description: En este artículo, aprenderá a pausar y reanudar una programación compartida que está en uso pero que no está en curso. Puede pausar y reanudar en modo nativo o en modo de SharePoint.
ms.date: 03/14/2017
