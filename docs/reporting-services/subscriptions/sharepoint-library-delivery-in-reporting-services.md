...
ms.topic: "article"
helpviewer_keywords: 
  - "integración de SharePoint [Reporting Services], entrega de informes"
  - "entregar informes [Reporting Services]"
  - "suscripciones [Reporting Services], entrega de la biblioteca de SharePoint"
