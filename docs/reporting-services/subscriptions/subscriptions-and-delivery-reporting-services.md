...
description: En este artículo, obtendrá información sobre las suscripciones de Reporting Services, que entregan un informe en un momento específico o como respuesta a un evento.
ms.date: 03/14/2017
