...
# <a name="technical-reference-ssrs"></a>Referencia técnica (SSRS)
 ...
 ![Icono de carpeta de archivos pequeños](../analysis-services/media/filefolder-small.png "Small File Folder Icon") **utilidades del símbolo del sistema del servidor de informes**  
 ...
 ![Icono de carpeta de archivos pequeños](../analysis-services/media/filefolder-small.png "Small File Folder Icon") **biblioteca de clases de proveedor WMI de servicios de informes**  
