---
title: "Referencia técnica (SSRS) | Documentos de Microsoft"
ms.custom: 
ms.date: 05/30/2017
...
# <a name="technical-reference-ssrs"></a>Referencia técnica (SSRS)
  ...
  Encuentre las herramientas y documentación de referencia de PowerShell para usar o administrar SQL Server Reporting Services.  
 ...
 ![Icono de carpeta de archivos pequeños](../analysis-services/media/filefolder-small.png "archivo pequeño icono de carpeta") **utilidades del símbolo del sistema del servidor de informes**  
 ...
 ![Icono de carpeta de archivos pequeños](../analysis-services/media/filefolder-small.png "archivo pequeño icono de carpeta") **biblioteca de clases de proveedor WMI de servicios de informes**  
 [Informes de referencia de biblioteca de proveedores WMI de servicios &#40; SSRS &#41;](../reporting-services/wmi-provider-library-reference/reporting-services-wmi-provider-library-reference-ssrs.md)  
