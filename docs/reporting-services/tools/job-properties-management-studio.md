...
description: Obtenga información sobre la página Propiedades del trabajo de SQL Server Management Studio, donde puede ver información sobre los trabajos en el servidor de informes.
ms.date: 03/01/2017
