...
-   [Propiedades del servidor (página General)](../../reporting-services/tools/server-properties-general-page.md)  
...
## Vea también  
 ...
 [Introducción a SQL Server Management Studio](../../ssms/use-sql-server-management-studio.md)  
