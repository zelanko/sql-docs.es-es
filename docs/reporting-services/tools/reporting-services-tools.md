...
helpviewer_keywords: 
  - "SSRS, herramientas"
  - "Reporting Services, herramientas"
  - "componentes [Reporting Services]"
  - "componentes [Reporting Services], acerca de componentes"
  - "Reporting Services, componentes"
  - "SSRS, componentes"
  - "informes [Reporting Services], herramientas"
  - "SQL Server Reporting Services, componentes"
  - "SQL Server Reporting Services, herramientas"
...
|Diseñador de informes|Use esta herramienta para diseñar informes. Incluye las características siguientes:<br /><br /> Implementar en un servidor de informes en modo SharePoint o modo nativo.<br /><br /> Se hospeda en [!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)]<br /><br /> Panel Datos de informe para organizar los datos usados en el informe<br /><br /> Vistas con pestañas Diseño y Vista previa para el diseño de informe interactivo<br /><br /> Diseñadores de consultas asociados con los tipos de origen de datos en [RSReportDesigner Configuration File](../../reporting-services/report-server/rsreportdesigner-configuration-file.md)para ayudar a especificar qué datos se deben recuperar de los orígenes de datos<br /><br /> Editor de expresiones con IntelliSense para generar expresiones de [!INCLUDE[vbprvb](../../includes/vbprvb-md.md)] que personalizan el contenido y el aspecto del informe<br /><br /> Admite elementos de informe personalizados y diseñadores de consultas personalizados<br /><br /> <br /><br /> Para más información, vea [Reporting Services en SQL Server Data Tools &#40;SSDT&#41;](../../reporting-services/tools/reporting-services-in-sql-server-data-tools-ssdt.md).|[!INCLUDE[ssBIDevStudioFull](../../includes/ssbidevstudiofull-md.md)]|  
