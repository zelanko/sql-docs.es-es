...
description: Obtenga información sobre la utilidad rskeymgmt que administra la clave simétrica que protege los datos confidenciales del servidor de informes frente al acceso no autorizado.
ms.date: 03/20/2017
