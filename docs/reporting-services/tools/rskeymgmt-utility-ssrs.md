---
title: "rskeymgmt (utilidad) (SSRS) | Microsoft Docs"
ms.custom: ""
ms.date: "03/20/2017"
...
helpviewer_keywords: 
  ...
  - "unirse a instancias del servidor de informes [SQL Server]"
  - "implementaciones escaladas del servidor de informes [Reporting Services]"
  - "criptografía [Reporting Services]"
  - "servidor de informes, varias instancias"
  - "utilidades del símbolo del sistema [Reporting Services]"
  - "servidores de informes [Reporting Services], implementaciones de escala horizontal"
