...
description: Obtenga información sobre las herramientas, tecnologías y estrategias para automatizar las tareas rutinarias de instalación, implementación y administración de un servidor de informes.
ms.date: 05/30/2017
