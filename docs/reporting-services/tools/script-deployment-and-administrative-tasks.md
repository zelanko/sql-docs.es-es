---
title: "Script de implementación y las tareas administrativas | Documentos de Microsoft"
ms.custom: 
ms.date: 05/30/2017
...
2.  Use la <xref:ReportService2010.ReportingService2010.GetItemDefinition%2A> y <xref:ReportService2010.ReportingService2010.GetProperties%2A> métodos para recuperar la definición de informe y las propiedades del informe.  
  
3.  Establezca la dirección URL para que señale al servidor de destino.  
  
4.  Use <xref:ReportService2010.ReportingService2010.CreateCatalogItem%2A> método, pasando las propiedades devueltas de <xref:ReportService2010.ReportingService2010.GetProperties%2A> y la definición de informe devueltos por <xref:ReportService2010.ReportingService2010.GetItemDefinition%2A>.  
