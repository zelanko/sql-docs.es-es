...
description: Obtenga información sobre la utilidad RS.exe que se puede usar para administrar mediante programación un servidor de informes mediante scripts escritos con Microsoft Visual Basic.
ms.date: 03/14/2017
