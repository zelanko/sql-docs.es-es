...
description: Obtenga información sobre cómo usar las opciones de la página Ejecución de propiedades de servidor para establecer un valor de tiempo de espera para la ejecución de informes.
ms.date: 03/01/2017
