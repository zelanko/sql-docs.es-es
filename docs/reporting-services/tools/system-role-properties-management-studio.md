...
description: Obtenga información sobre las opciones de la página Roles del sistema, donde puede ver las definiciones de roles del sistema actualmente definidas para el servidor de informes.
ms.date: 03/14/2017
