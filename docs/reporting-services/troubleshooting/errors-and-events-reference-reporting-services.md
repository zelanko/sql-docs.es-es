...
|111|Error|Registro|Servidor de informes<br /><br /> portal web|*\<Source>* no puede crear el registro de seguimiento. Para obtener más información, consulte [Report Server Service Trace Log](../../reporting-services/report-server/report-server-service-trace-log.md).|  
...
|119|Error|Activación|Servidor de informes<br /><br /> Procesador de entrega y programación|*\<Source>* no ha obtenido acceso al contenido de la base de datos del servidor de informes.|  
...
|130|Error|Administración|Servidor de informes<br /><br /> Procesador de entrega y programación|*\<Source>* no encuentra el archivo de configuración. El servidor de informes requiere archivos de configuración.|  
