...
helpviewer_keywords: 
  ...
  - "Reporting Services, errores y eventos"
  - "solución de problemas [Reporting Services], errores"
  - "eventos [Reporting Services]"
...
|119|Error|Activación|Servidor de informes<br /><br /> Procesador de entrega y programación|*\<Origen>* no puede acceder al contenido de la base de datos del servidor de informes.|  
...
|124|Información|Activación|Servidor de informes|Se ha inicializado el servicio Servidor de informes. Para más información, vea [Inicializar un servidor de informes &#40;Administrador de configuración de SSRS&#41;](../../reporting-services/install-windows/initialize-a-report-server-ssrs-configuration-manager.md).|  
