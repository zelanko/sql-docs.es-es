---
title: Referencia de errores y eventos (Reporting Services) | Documentos de Microsoft
ms.custom: 
ms.date: 03/18/2017
...
|111|Error|Registro|Servidor de informes<br /><br /> Administrador de informes|*\<Origen >* no se puede crear el registro de seguimiento. Para obtener más información, consulte [Report Server Service Trace Log](../../reporting-services/report-server/report-server-service-trace-log.md).|  
