...
|109|Información|Administración|Servidor de informes<br /><br /> portal web|Se ha modificado un archivo de configuración. Para más información, consulte [Reporting Services Configuration Files](../../reporting-services/report-server/reporting-services-configuration-files.md).|  
