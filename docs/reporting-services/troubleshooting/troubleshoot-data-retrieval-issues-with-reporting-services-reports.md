...
> [!NOTE]  
>Se recomienda no agregar información de inicio de sesión, como contraseñas, a la cadena de conexión. El Diseñador de informes proporciona una página **Credenciales** en los cuadros de diálogo [Propiedades del origen de datos](Data%20Source%20Properties%20Dialog%20Box,%20General%20(Report%20Builder).xml) o [Propiedades del origen de datos compartidos](Shared%20Data%20Source%20Properties%20Dialog%20Box,%20Credentials.xml) que puede utilizar para escribir las credenciales. Estas credenciales se almacenan de forma segura en el equipo en el que se crea el informe.  
