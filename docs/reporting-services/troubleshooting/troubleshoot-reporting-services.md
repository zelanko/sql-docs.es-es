---
title: Solucionar problemas de Reporting Services | Documentos de Microsoft
ms.custom: 
ms.date: 05/25/2016
...
![Icono pequeño de carpeta de archivo](../../reporting-services/troubleshooting/media/filefolder-small.png)**solución de problemas de Reporting Services**   
...
+  [Solución de problemas de conexión de base de datos y servidor con Reporting Services](https://msdn.microsoft.com/library/mt650905.aspx)  

 ![Icono de carpeta de archivos pequeños](../../reporting-services/troubleshooting/media/filefolder-small.png)**referencia de errores y eventos**   
