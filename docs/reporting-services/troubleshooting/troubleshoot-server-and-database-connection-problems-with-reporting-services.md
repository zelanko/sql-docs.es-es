...
---
# Soluci&#243;n de problemas de conexi&#243;n de base de datos y servidor con Reporting Services
...
### Error al establecer una conexión al servidor.  
...
### No se puede establecer una conexión. Asegúrese de que el servidor se está ejecutando.  
...
## El servidor de informes no puede abrir una conexión a la base de datos del servidor de informes. (rsReportServerDatabaseUnavailable).  
