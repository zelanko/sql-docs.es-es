...
1.  [Crear un informe de matriz y un conjunto de datos en el Asistente para tabla o matriz](#Setup)  
  
2.  [Organizar datos y elegir el diseño en el asistente](#CompleteWizard)  
...
4.  [Cambiar el tipo de datos predeterminado y otras propiedades de un parámetro de informe](#ChangeDefaultProperties)  
    ...
    2.  [Especificar valores disponibles para mostrar en una lista](#AvailableValues)  
  
    3.  [Especificar un valor predeterminado](#DefaultValues)  
  
    4.  [Buscar un par Nombre/Valor](#NameValue)  
...
10. Pegue la siguiente consulta en el panel vacío en la parte superior:  
    ...
    Esta consulta combina los resultados de varias instrucciones SELECT de [!INCLUDE[tsql](../includes/tsql-md.md)] dentro de una expresión de tabla común para especificar los valores que están basados en datos de ventas simplificados de cámaras de la base de datos de ejemplo Contoso. Las subcategorías son cámaras digitales, cámaras réflex digitales de una sola lente (SLR), cámaras de vídeo y accesorios.  
...
6.  Haga clic en **Ejecutar** para obtener la vista previa del informe. El visor de informes muestra **¿Identificador del almacén?** para *@StoreID*.  
...
6.  Cambie el **signo igual** (=) por **IN** en la cláusula **WHERE** de [!INCLUDE[tsql](../includes/tsql-md.md)] en la última línea de la consulta:  
...
*  [Función Lookup](../reporting-services/report-design/lookup-function-report-builder-and-ssrs.md)   
