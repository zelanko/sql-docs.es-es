...
ms.topic: "article"
helpviewer_keywords: 
  - "acceso URL [Reporting Services]"
  - "enlaces [Reporting Services], acceso URL"
  - "acceso URL [Reporting Services], acerca del acceso URL"
  - "parámetros [Reporting Services], acceso URL"
  - "servidores de informes [Reporting Services], acceso URL"
  - "hipervínculos [Reporting Services]"
