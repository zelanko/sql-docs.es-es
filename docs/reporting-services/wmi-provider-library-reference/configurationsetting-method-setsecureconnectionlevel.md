...
## <a name="remarks"></a>Observaciones  
 Cuando se realiza una llamada, la propiedad SecureConnectionLevel del servidor de informes se establece en el valor especificado. Un valor 0 indica que TLS está desactivado. Un valor mayor o igual que 1 indica que TLS está activado.  
