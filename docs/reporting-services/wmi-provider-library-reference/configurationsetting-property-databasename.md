---
title: Propiedad DatabaseName (WMI MSReportServer_ConfigurationSetting) | Documentos de Microsoft
ms.custom: 
ms.date: 03/14/2017
...
---
# <a name="configurationsetting-property---databasename"></a>Propiedad ConfigurationSetting - DatabaseName
