---
title: Propiedad SMTPServer (MSReportServer_ConfigurationSetting WMI) | Documentos de Microsoft
ms.custom: 
ms.date: 03/01/2017
...
## <a name="property-values"></a>Valores de propiedad  
 Objeto **String** de solo lectura que contiene el valor de la propiedad **SMTPServer** del archivo RSReportServer.config.  
