---
title: Propiedad Version (MSReportServer_ConfigurationSetting de WMI) | Documentos de Microsoft
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="configurationsetting-property---version"></a>Propiedad ConfigurationSetting - versión
