---
title: Propiedad EditionID (WMI MSReportServer_Instance) | Documentos de Microsoft
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="msreportserverinstance-properties---editionid"></a>Propiedades de MSReportServer_Instance - EditionID
