---
title: Propiedad EditionName (MSReportServer_Instance WMI) | Documentos de Microsoft
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="msreportserverinstance-properties---editionname"></a>Propiedades de MSReportServer_Instance - EditionName
