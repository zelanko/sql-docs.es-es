---
title: Propiedad Version (MSReportServer_Instance WMI) | Documentos de Microsoft
ms.custom: 
ms.date: 03/01/2017
...
---
# <a name="msreportserverinstance-properties---version"></a>Propiedades de MSReportServer_Instance - versión
