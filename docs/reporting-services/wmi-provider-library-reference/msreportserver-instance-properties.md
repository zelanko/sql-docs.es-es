---
title: Propiedades de MSReportServer_Instance | Documentos de Microsoft
ms.custom: 
ms.date: 03/01/2017
...
# <a name="msreportserverinstance-properties"></a>Propiedades de MSReportServer_Instance
  La clase MSReportServer_Instance proporciona la información básica requerida para que un cliente se conecte a un servidor de informes instalado.  
  
## <a name="public-properties"></a>Propiedades públicas  
  
|||  
|-|-|  
|[Propiedad EditionID &#40; MSReportServer_Instance de WMI &#41;](../../reporting-services/wmi-provider-library-reference/msreportserver-instance-properties-editionid.md)|Devuelve la edición del servidor de informes.|  
