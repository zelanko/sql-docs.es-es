---
title: "Uso de conjuntos de datos compartidos (portal web) | Microsoft Docs"
ms.custom: ""
ms.date: "12/09/2016"
...
manager: "erikre"
---
# Uso de conjuntos de datos compartidos (portal web)
...
- [Creación de un conjunto de datos compartido](#create)  
  
- [Administración de un conjunto de datos compartido existente](#manage)  
  
- [Propiedades](#properties)  
  
- [Almacenamiento en memoria caché](#caching)  
...
> [!NOTE] Si no ve el conjunto de datos compartido en la carpeta, asegúrese de que está viendo conjuntos de datos. Puede seleccionar **Ver** en la barra de menús de la esquina superior derecha del portal web. Asegúrese de que la casilla **Conjuntos de datos** está activada.  
...
> [!NOTE] La memoria caché no se actualiza al establecer una expiración. Sin un plan de actualización de caché, los datos se actualizarán con la siguiente ejecución del conjunto de datos.  
