...
Para controlar si se van a crear instantáneas para un informe, seleccione el botón de **puntos suspensivos (...)** de un informe, elija **Administrar** y **Almacenamiento en caché** o **Instantáneas del historial**.  
