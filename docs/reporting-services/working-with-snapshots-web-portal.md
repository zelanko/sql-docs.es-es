...
description: Cree una instantánea de caché para ejecutar más rápido propiedades de ejecución específicas. También puede trabajar con instantáneas de historial para capturar diferentes momentos.
ms.date: 07/02/2017
