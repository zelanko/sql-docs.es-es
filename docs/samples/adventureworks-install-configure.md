...
- [SQL Server](https://www.microsoft.com/en-us/evalcenter/evaluate-sql-server-2016) o [base de datos SQL Azure](https://azure.microsoft.com/services/sql-database/). Para obtener la versión completa del ejemplo, utilice SQL Server Evaluation, Developer o Enterprise Edition.
...
- [Zip de Scripts de AdventureWorks OLTP](https://github.com/Microsoft/sql-server-samples/releases/download/adventureworks/AdventureWorkDW-oltp-install-script.zip)
- [Zip de Scripts de AdventureWorks DW](https://github.com/Microsoft/sql-server-samples/releases/download/adventureworks/AdventureWorkDW-data-warehouse-install-script.zip)
