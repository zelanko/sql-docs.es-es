---
title: Crear y personalizar métodos abreviados de teclado en las SQL Operations Studio (preview) | Documentos de Microsoft
description: Obtenga información acerca de cómo crear y personalizar métodos abreviados de teclado en las SQL Operations Studio (preview).
ms.custom: tools|sos
ms.date: 11/15/2017
