...
1. [Crear y utilizar fragmentos de código para crear rápidamente scripts de Transact-SQL (T-SQL) en[!INCLUDE[name-sos](../includes/name-sos-short.md)]](code-snippets.md)
2. [Paneles en[!INCLUDE[name-sos](../includes/name-sos-short.md)]](dashboards.md)
3. [Descargue e instale[!INCLUDE[name-sos](../includes/name-sos.md)]](download.md)
4. [Conectar [!INCLUDE[name-sos](../includes/name-sos-short.md)] a SQL Server mediante la autenticación de Windows - Kerberos](enable-kerberos.md)
5. [[!INCLUDE[name-sos](../includes/name-sos.md)]PREGUNTAS MÁS FRECUENTES](faq.md)
6. [Administrar servidores y bases de datos con los widgets de una visión general de[!INCLUDE[name-sos](../includes/name-sos-short.md)]](insight-widgets.md)
7. [Terminal integrado](integrated-terminal.md)
8. [Métodos abreviados de teclado[!INCLUDE[name-sos](../includes/name-sos.md)]](keyboard-shortcuts.md)
9. [Inicio rápido: Usar [!INCLUDE[name-sos](../includes/name-sos-short.md)] para conectarse y consultar la base de datos SQL de Azure](quickstart-sql-database.md)
10. [Inicio rápido: Usar [!INCLUDE[name-sos](../includes/name-sos-short.md)] para conectarse y consultar los datos en el almacén de datos de SQL Azure](quickstart-sql-dw.md)
11. [Inicio rápido: Conectarse y consultar mediante SQL Server[!INCLUDE[name-sos](../includes/name-sos-short.md)]](quickstart-sql-server.md)
12. [Grupos de servidores en[!INCLUDE[name-sos](../includes/name-sos-short.md)]](server-groups.md)
13. [Configuración de área de trabajo y de usuario](settings.md)
14. [Uso de control de código fuente en[!INCLUDE[name-sos](../includes/name-sos-short.md)]](source-control.md)
15. [Copia de seguridad y restauración con[!INCLUDE[name-sos](../includes/name-sos-short.md)]](tutorial-backup-restore-sql-server.md)
16. [Tutorial: Crear un widget de información personalizada](tutorial-build-custom-insight-sql-server.md)
17. [Tutorial: Agregar la *cinco consultas más lentas* widget de ejemplo en el panel de la base de datos](tutorial-qds-sql-server.md)
18. [Tutorial: Usar el editor de Transact-SQL para crear objetos de base de datos-[!INCLUDE[name-sos](../includes/name-sos-short.md)]](tutorial-sql-editor.md)
19. [Tutorial: Habilitar la tabla espacio uso muestra una visión general widget mediante[!INCLUDE[name-sos](../includes/name-sos-short.md)]](tutorial-table-space-sql-server.md)
20. [Habilitar o deshabilitar la recopilación de datos de uso para[!INCLUDE[name-sos](../includes/name-sos-short.md)]](usage-data-collection.md)
21. [¿Qué es [!INCLUDE[name-sos](../includes/name-sos.md)]?](what-is.md)
