...
description: "Este tutorial rápido muestra cómo utilizar las SQL Operations Studio (versión preliminar) para conectarse a una base de datos SQL y ejecutar una consulta"
ms.custom: tools|sos
ms.date: 03/08/2018
