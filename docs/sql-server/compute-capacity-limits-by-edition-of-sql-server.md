...
>   
> - Una máquina virtual se asigna a uno o varios procesadores virtuales.  
> - Uno o más procesadores virtuales se asignan exactamente a una máquina virtual.  
> - Cero o un procesador virtual se asigna a cero o más procesadores lógicos. Cuando el procesador virtual para la asignación lógica del procesador es: 
...
> - Un socket se asigna a cero o más núcleos. Cuando el socket para la asignación de núcleo es:  
...
> - Un núcleo se asigna a uno o dos procesadores lógicos. Cuando el núcleo para la asignación lógica del procesador es:  
