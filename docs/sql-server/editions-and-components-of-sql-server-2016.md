...
helpviewer_keywords: 
  ...
  - "Ediciones de 32 y 64 bits [SQL Server]"
  - "componentes predeterminados"
  - "Workgroup Edition [SQL Server]"
  - "servidores de Internet [SQL Server]"
  - "instalar SQL Server, componentes"
  - "programa de instalación [SQL Server], componentes"
  - "SQL Server, ediciones"
  - "SQL Server, componentes"
  - "aplicaciones cliente/servidor [SQL Server]"
  - "ediciones [SQL Server]"
  - "versiones [SQL Server]"
  - "programa de instalación {SQL Server], ediciones"
  - "Asistente para la instalación de SQL Server"
  - "componentes [SQL Server]"
  - "Standard Edition [SQL Server]"
  - "edición de 64 bits [SQL Server]"
  - "IIS [SQL Server]"
  - "instalar SQL Server, ediciones"
  - "ediciones [SQL Server], acerca de las opciones de las ediciones"
  - "programa de instalación [SQL Server]"
...
> Para obtener más información sobre las características admitidas por las diferentes ediciones de SQL Server 2016, consulte [Características compatibles con las ediciones de SQL Server 2016](../sql-server/características-compatibles-con-las-ediciones-de-sql-server-2016.md).
...
## <a name="includesscurrenttokensscurrentmdmd-editions"></a>Ediciones de [!INCLUDE[ssCurrent](../includes/sscurrent-md.md)]  
...
## <a name="using-includessnoversiontokenssnoversionmdmd-with-an-internet-server"></a>Usar [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] con un servidor de Internet  
...
## <a name="using-includessnoversiontokenssnoversionmdmd-with-clientserver-applications"></a>Usar [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] con aplicaciones cliente/servidor  
