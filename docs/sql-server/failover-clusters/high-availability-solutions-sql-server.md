...
ms.topic: "article"
helpviewer_keywords: 
  - "alta disponibilidad [SQL Server], soluciones"
  - "Motor de base de datos [SQL Server], disponibilidad"
  - "disponibilidad de base de datos [SQL Server]"
  - "disponibilidad [SQL Server]"
  - "disponibilidad de servidor [SQL Server]"
