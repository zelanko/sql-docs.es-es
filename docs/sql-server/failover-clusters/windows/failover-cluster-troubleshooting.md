...
ms.topic: "article"
helpviewer_keywords: 
  - "solución de problemas, clústeres de conmutación por error"
  - "clústeres de conmutación por error, solución de problemas"
 ...
 **Problema 2:** las cuentas de servicio de [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] no son idénticas en todos los nodos de clúster o el nodo no reinicia un servicio de [!INCLUDE[ssNoVersion](../../../includes/ssnoversion-md.md)] que se ha migrado desde un nodo con error.  
