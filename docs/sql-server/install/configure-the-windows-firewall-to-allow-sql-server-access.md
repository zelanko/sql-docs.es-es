...
|Instancia predeterminada con punto de conexión HTTP |Puerto TCP 443|Se utiliza para una conexión HTTPS a través de una dirección URL. HTTPS es una conexión HTTP que utiliza SSL (Capa de sockets seguros).|  
...
1. En **Tipo de regla**, seleccione **Programa**. Seleccione **Siguiente**.
...
1. En Perfil, incluya los tres perfiles. Seleccione **Siguiente**.
