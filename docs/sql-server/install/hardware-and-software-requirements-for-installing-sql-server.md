...
# <a name="hardware-and-software-requirements-for-installing-sql-server"></a>Requisitos de hardware y software para instalar SQL Server
 ...
 > Para el contenido relacionado con las versiones anteriores de SQL Server, vea [requisitos de Hardware y Software para instalar SQL Server 2014](https://msdn.microsoft.com/library/ms143506(v=sql.120).aspx). 
...
-   [Requisitos de hardware y software](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server.md#hwswr)  
  
-   [Requisitos de procesador, memoria y sistema operativo](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server.md#pmosr)  
  
-   [Compatibilidad entre idiomas](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server.md#CrossLanguageSupport)  
  
-   [Requisitos de espacio en disco duro](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server.md#HardDiskSpace)  
  
-   [Tipos de almacenamiento para los archivos de datos](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server.md#StorageTypes)  
  
-   [Instalación de SQL Server en un controlador de dominio](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server.md#DC_support)  
...
-   [Ediciones principales de SQL Server 2016](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server.md#TOP_Principal)  
  
-   [Ediciones de amplio uso de SQL Server 2016](../../sql-server/install/hardware-and-software-requirements-for-installing-sql-server.md#TOP_Breadth)  
