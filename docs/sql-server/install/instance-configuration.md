...
description: Especifique si quiere crear una instancia predeterminada o una instancia con nombre de SQL Server mediante Configuración de instancia en el Asistente para la instalación de SQL Server.
ms.custom: ''
ms.date: 08/16/2019
ms.prod: sql
ms.reviewer: ''
