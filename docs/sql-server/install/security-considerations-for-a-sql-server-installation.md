...
description: En este artículo se describen algunos procedimientos recomendados de seguridad que debe tener en cuenta antes y después de instalar SQL Server.
ms.custom: ''
ms.date: 08/23/2017
ms.prod: sql
ms.reviewer: ''
