---
title: "Consideraciones de seguridad para una instalaci&#243;n de SQL Server | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
helpviewer_keywords: 
  ...
  - "bloques de mensajes de servidor [SQL Server]"
  - "deshabilitar protocolos"
  - "seguridad [SQL Server], instalaciones"
  - "protocolos [SQL Server], deshabilitar"
  - "NetBIOS [SQL Server]"
  - "servicios [SQL Server], seguridad"
  - "SMB [SQL Server]"
  - "aislar servicios [SQL Server]"
  - "Programa de instalación [SQL Server], seguridad"
  - "privilegios de instalación de SQL Server limitados"
  - "NTFS [SQL Server]"
  - "seguridad física [SQL Server]"
  - "seguridad del sistema de archivos [SQL Server]"
...
## Antes de instalar [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
...
###  <a name="physical_security"></a> Mejorar la seguridad física  
...
###  <a name="firewalls"></a> Usar firewalls  
...
###  <a name="isolated_services"></a> Aislar servicios  
...
###  <a name="sa_with_least_privileges"></a> Configurar un sistema de archivos seguro  
...
###  <a name="disabled_protocols"></a> Deshabilitar NetBIOS y Bloque de mensajes de servidor  
...
## Durante o después de la instalación de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]  
