...
description: En este artículo se describe cómo desinstalar Reporting Services, que no quita el contenido que ha creado ni la configuración que ha modificado.
ms.custom: ''
ms.date: 03/01/2017
ms.prod: sql
ms.reviewer: ''
