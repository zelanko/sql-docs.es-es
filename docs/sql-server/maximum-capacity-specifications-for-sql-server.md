...
helpviewer_keywords: 
  - "objetos [SQL Server]"
  - "especificaciones de capacidad de número [SQL Server]"
  - "tamaño [SQL Server], especificaciones de capacidad"
  - "número de objetos"
  - "especificaciones de capacidad [SQL Server]"
  - "especificaciones de capacidad máxima [SQL Server]"
  - "tamaño [SQL Server]"
  - "especificaciones de capacidad de replicación [SQL Server]"
  - "objetos [SQL Server], especificaciones de capacidad"
  - "Motor de base de datos [SQL Server], especificaciones de capacidad"
...
|Columnas por instrucción INSERT||4096||  
...
|Referencias de tabla de claves externas por tabla||Saliente = 253. Entrante = 10 000.|Para ver las restricciones, vea [Create Foreign Key Relationships](../relational-databases/tables/crear-relaciones-de-clave-externa.md).|  
