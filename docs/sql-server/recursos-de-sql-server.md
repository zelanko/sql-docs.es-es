...
ms.topic: "article"
helpviewer_keywords: 
  - "Infraestructura de SQL Server como servicio"
  - "Arquitectura híbrida de SQL Server"
  - "SQL Server IAAS"
...
##  <a name="a-namecommunitya-connect-with-the-sql-community"></a><a name="community"></a> Conectar con la comunidad de SQL  
...
-   [Blog del equipo SSAS y PowerPivot](http://blogs.msdn.com/powerpivot/default.aspx)  
