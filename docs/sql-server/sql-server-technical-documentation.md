---
title: "Documentación técnica de SQL Server 2016 | Microsoft Docs"
ms.date: 03/24/2017
...
Para las notas de la versión más reciente, consulte [Notas de la versión de SQL Server vNext](../sql-server/sql-server-vnext-release-notes.md)

Para la información más reciente sobre las novedades, consulte [Novedades de SQL Server vNext](../sql-server/what-s-new-in-sql-server-vnext.md)
...
+ [Introducción a SQL Server 2016](https://www.microsoft.com/en-us/server-cloud/products/sql-server/default.aspx?WT.srch=1&WT.mc_id=SEM_%5B_uniqid%5D&utm_source=Bing&utm_medium=CPC&utm_term=SQL%20Server%202016&utm_campaign=Data_Management)  
