...
ms.topic: "article"
helpviewer_keywords: 
  - "Stretch Database, hacer copia de seguridad"
  - "copias de seguridad (Stretch Database)"
...
---
# Copia de seguridad de bases de datos habilitadas para Stretch (Stretch Database)
...
## Realizar una copia de seguridad de los datos de SQL Server  
...
## Realizar copias de seguridad de los datos de Azure remotos   
  
Microsoft Azure realiza automáticamente una copia de seguridad de los datos remotos que Stretch Database ha migrado de SQL Server a Azure.    
### Azure reduce el riesgo de pérdida de datos con la copia de seguridad automática  
...
### Azure reduce el riesgo de pérdida de datos con la redundancia geográfica  
...
> [!NOTE] Si aumenta la cantidad de datos que Stretch Database conserva temporalmente en la tabla de almacenamiento provisional, aumenta la cantidad de espacio necesario en SQL Server.
