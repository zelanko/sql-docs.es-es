...
Vínculos a temas individuales:
 ...
 - [Motor de Analysis Services (SSAS)](../analysis-services/what-s-new-in-analysis-services.md)  
  
 - [Motor de base de datos](../database-engine/configure-windows/what-s-new-in-sql-server-2016-database-engine.md)
