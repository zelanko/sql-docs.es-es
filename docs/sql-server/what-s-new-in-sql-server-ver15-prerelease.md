---
title: Archivo de anuncios de SQL Server 2019 CTP | Microsoft Docs
ms.date: 08/21/2019
ms.prod: sql
ms.reviewer: ''
...
ms.locfileid: "69653784"
---
# <a name="sql-server-2019-ctp-announcement-archive"></a>Archivo de anuncios de SQL Server 2019 CTP

[!INCLUDE[tsql-appliesto-ss-xxxx-xxxx-xxx-md](../includes/tsql-appliesto-ss-xxxx-xxxx-xxx-md.md)]

En este artículo se proporciona un archivo de anuncios de características de versiones de [!INCLUDE[sql-server-2019](../includes/sssqlv15-md.md)] (CTP). Se proporciona con fines históricos, pero no se aplica a las versiones preliminares actuales ni de producción de [!INCLUDE[sql-server-2019](../includes/sssqlv15-md.md)].

Este artículo se quitará cuando [!INCLUDE[sql-server-2019](../includes/sssqlv15-md.md)] pase a fase de producción.

Para obtener la información actual, vea [Novedades de SQL Server 2019](what-s-new-in-sql-server-ver15.md).
...
| Nueva característica o actualización | Detalles |
|:---|:---|
| Cambios del comando `mssqlctl` | Los comandos `mssqlctl cluster` se llaman ahora `mssqlctl bdc`. Para más información, consulte la referencia de [`mssqlctl`](../big-data-cluster/reference-azdata.md). |
...
| Cambios en el uso del comando de la herramienta **mssqlctl**. | Para obtener más información, vea los [problemas conocidos con mssqlctl](../big-data-cluster/release-notes-big-data-cluster.md ). |
...
#### <a name="new-query_post_execution_plan_profile-extended-event-ctp-24"></a>Nuevo evento extendido query_post_execution_plan_profile (CTP 2.4)
...
#### <a name="new-dmf-sysdm_exec_query_plan_stats-ctp-24"></a>Nueva DMF sys.dm_exec_query_plan_stats (CTP 2.4) 
...
#### <a name="new-options-added-to-sp_estimate_data_compression_savings-ctp-20"></a>Nuevas opciones agregadas a sp_estimate_data_compression_savings (CTP 2.0)
...
#### <a name="new-sysdm_db_page_info-system-function-returns-page-information-ctp-20"></a>Nueva función del sistema sys.dm_db_page_info que devuelve información de la página (CTP 2.0)
...
#### <a name="online-attach-ctp32"></a>Adjunto en línea (CTP 3.2)

CTP 3.2 presenta la capacidad de adjuntar un modelo tabular como una operación en línea. Adjunto en línea se puede usar para la sincronización de réplicas de solo lectura en entornos locales de escalado horizontal de consultas. Para realizar una operación de adjuntar en línea, use la opción **AllowOverwrite** del comando XMLA Attach. 
