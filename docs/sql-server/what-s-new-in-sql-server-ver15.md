...
|Nueva característica o actualización | Detalles | |PolyBase |Los nombres de las columnas de la tabla externa ahora se usan para consultar orígenes de datos de ODBC, SQL Server, Oracle, Teradata y MongoDB. | | &nbsp; | &nbsp; |
