...
description: Obtenga información sobre los métodos de autenticación de Azure Active Directory que SQL Server Data Tools (SSDT) proporciona para Azure SQL Database y Azure SQL Data Warehouse.
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
