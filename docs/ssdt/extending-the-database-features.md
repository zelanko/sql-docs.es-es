---
title: Extensión de las características de base de datos
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
...
ms.locfileid: "75241658"
---
# <a name="extending-the-database-features"></a>Extensión de las características de base de datos

Puede crear extensiones de características que le permiten ampliar características como pruebas unitarias y análisis de código de base de datos. Para obtener más información, vea los temas siguientes:  
...
-   [Cómo: instalar y administrar las extensiones de características](../ssdt/how-to-install-and-manage-feature-extensions.md)  
