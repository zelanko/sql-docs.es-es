...
-   Alias para nombres de columna.  
  
-   Restricciones para mostrar las columnas.  
  
-   Criterio de ordenación de columnas.  
  
Puede también hacer clic con el botón secundario en una fila del cuadro de diálogo **Filtrar y ordenar** y seleccionar una operación para realizar en una fila.  
