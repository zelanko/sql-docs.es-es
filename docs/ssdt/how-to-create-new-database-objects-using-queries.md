...
description: Familiarícese con el Editor de Transact-SQL. Vea cómo abrir este editor y ver ejemplos que muestran cómo se usa para crear una tabla, función o vista.
ms.prod: sql
ms.technology: ssdt
ms.topic: conceptual
