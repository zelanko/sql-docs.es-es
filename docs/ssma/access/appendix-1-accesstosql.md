...
|2|-v/variable|Sin |variablevaluefile|Nombre de archivo XML válido. Si se utilizan variables en el archivo de script, debe especificarse este archivo.|  
