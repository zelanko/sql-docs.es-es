...
Después de instala SSMA, puede usar SSMA para migrar bases de datos de Access a [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] o base de datos de SQL Azure. Ayuda para familiarizarse con la interfaz de usuario SSMA antes de empezar. El siguiente diagrama muestra la interfaz de usuario de SSMA. Esto incluye los exploradores de metadatos, metadatos, las barras de herramientas, panel de salida y panel de lista de error:  
...
Para iniciar una migración, cree un nuevo proyecto y, a continuación, agregar las bases de datos de acceso al explorador de metadatos de acceso. Se pueden, a continuación, haga clic en objetos en el Explorador de metadatos de acceso para realizar tareas como la exportación de un inventario de los objetos de base de datos de Access a [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] o base de datos de SQL Azure, crear informes que evalúa las conversiones a [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] o base de datos de SQL Azure y convertir los esquemas de acceso a [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] o esquemas de base de datos de SQL Azure. También puede realizar estas tareas mediante los menús y barras de herramientas.  
...
Debe conectarse a la base de datos de SQL Azure si ha seleccionado la base de datos de SQL Azure de la migración a la lista desplegable en el cuadro de diálogo nuevo proyecto. Después de una conexión correcta, aparecerá una jerarquía de las bases de datos de la base de datos de SQL Azure en el Explorador de metadatos de base de datos de SQL Azure. Después de convertir los esquemas de acceso a los esquemas de base de datos de SQL Azure, puede seleccionar los esquemas convertidos en el Explorador de metadatos de base de datos de SQL Azure y, a continuación, cargar los esquemas en [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)].  
...
Para obtener más información sobre estas tareas y cómo realizarlas, vea las secciones siguientes:  
...
SSMA contiene dos exploradores de metadatos para examinar y realizar acciones en Access y [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] o las bases de datos de la base de datos de SQL Azure.  
  
#### <a name="access-metadata-explorer"></a>Obtener acceso al explorador de metadatos  
Explorador de metadatos de acceso muestra información acerca de las bases de datos de Access que se han agregado al proyecto. Cuando se agrega una base de datos de Access, SSMA recupera metadatos acerca de esa base de datos. Se trata de los metadatos que están disponibles en el Explorador de metadatos de acceso.  
  
Mediante el Explorador de metadatos de acceso, puede realizar las siguientes tareas:  
  
-   Examinar las tablas en cada base de datos de Access.  
  
-   Seleccionar objetos para la conversión y, a continuación, convertir los objetos a [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] sintaxis. Para obtener más información, consulte [convertir objetos de base de datos de Access](http://msdn.microsoft.com/en-us/e0ef67bf-80a6-4e6c-a82d-5d46e0623c6c).  
  
-   Seleccionar objetos para la migración de datos y, a continuación, migrar los datos de dichos objetos a [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)]. Para obtener más información, consulte [migrar datos de Access a SQL Server](http://msdn.microsoft.com/en-us/f3b18af7-1af0-499d-a00d-a0af94895625).  
...
Puede usar el Explorador de metadatos para seleccionar convertir objetos de base de datos de Access y, a continuación, cargar (synchronize) esos objetos en la instancia de [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] o base de datos de SQL Azure.  
  
Para obtener más información, consulte [cargar objetos de base de datos para convertir a SQL Server](http://msdn.microsoft.com/en-us/4e854eee-b10c-4f0b-9d9e-d92416e6f2ba).  
  
### <a name="metadata"></a>Metadatos  
A la derecha de cada explorador de metadatos son las pestañas que describen el objeto seleccionado. Por ejemplo, si selecciona una tabla en el Explorador de metadatos de acceso, cuatro fichas aparecerán: **tabla**, **asignación de tipos, propiedades**, y **datos**. Si selecciona una tabla en [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] el Explorador de metadatos, aparecerán tres fichas: **tabla**, **SQL**, y **datos**.  
  
Mayoría de los valores de metadatos es de solo lectura. Sin embargo, puede modificar los metadatos siguientes:  
  
-   En el Explorador de metadatos de acceso, puede modificar las asignaciones de tipos. Debe realizar estos cambios antes de crear informes o convertir esquemas.  
  
-   En [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] el Explorador de metadatos, puede modificar las propiedades de tabla e índice en el **tabla** ficha. Debe realizar estos cambios antes de cargar los esquemas en [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)]. Para obtener más información, consulte [convertir objetos de base de datos de Access](http://msdn.microsoft.com/en-us/e0ef67bf-80a6-4e6c-a82d-5d46e0623c6c).  
...
|Botón|Función|  
|----------|------------|  
|**Convertir, cargar y migrar**|Convierte las bases de datos de Access, carga los objetos convertidos en [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] o base de datos de SQL Azure, y migra los datos en [!INCLUDE[ssNoVersion](../../includes/ssnoversion_md.md)] o base de datos de SQL de Azure en un solo paso.|  
