...
- La [!INCLUDE[msCoName](../../includes/msconame_md.md)] versión .NET Framework 4.7.2 o una versión posterior. La .NET Framework está disponible en [Microsoft .net guía](https://docs.microsoft.com/dotnet/framework/).
