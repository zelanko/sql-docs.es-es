...
|Mostrar el cuadro de diálogo Asistente de buscar las bases de datos.|ALT + F + F|  
...
|Actualizar desde la base de datos access.|ALT+T+R|  
...
|Mostrar el cuadro de diálogo Asistente de buscar las bases de datos.|ALT + T + F|  
...
|PARA ELLO|PRESIONE|  
|--------------|---------|  
|Mostrar acerca de SSMA para el cuadro de diálogo acceso.|ALT + H + A|  
