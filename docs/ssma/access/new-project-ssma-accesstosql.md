---
description: Nuevo proyecto (SSMA) (AccessToSQL)
title: Nuevo proyecto (SSMA) (AccessToSQL) | Microsoft Docs
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
> [!IMPORTANT]  
> Un nuevo proyecto de tipo ' SQL Azure ' requiere, SQL Server Native Client (SNAC) versión 10,5 o posterior, para vincular las tablas de Access a Azure SQL Database.   
