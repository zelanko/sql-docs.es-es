---
description: Trabajar con la consola de SSMA para Access (AccessToSQL)
...
[Introducción con SSMA para la consola de acceso](getting-started-with-ssma-for-access-console-accesstosql.md)  
