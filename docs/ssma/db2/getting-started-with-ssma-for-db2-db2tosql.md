...
[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Migration Assistant (SSMA) para DB2 permite convertir rápidamente esquemas de base de datos [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] DB2 en esquemas, cargar los esquemas [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] resultantes en y migrar datos [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]de DB2 a.  
...
Para iniciar una migración, primero debe crear un nuevo proyecto. A continuación, se conecta a una base de datos DB2. Después de una conexión correcta, los esquemas DB2 aparecerán en el explorador de metadatos DB2. Después, puede hacer clic con el botón derecho en objetos en el explorador de metadatos DB2 para realizar tareas como crear informes [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]que evalúen las conversiones en. También puede realizar estas tareas mediante las barras de herramientas y los menús.  
  
También debe conectarse a una instancia de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]. Después de una conexión correcta, aparecerá una [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] jerarquía de bases de datos en [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] el explorador de metadatos. Después de convertir los esquemas DB2 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] en esquemas, seleccione los esquemas convertidos en el explorador de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] metadatos y, a [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]continuación, sincronice los esquemas con.  
  
Después de sincronizar los esquemas [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]convertidos con, puede volver al explorador de metadatos DB2 y migrar datos de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] esquemas DB2 a bases de datos de.  
...
SSMA contiene dos exploradores de metadatos para examinar y realizar acciones en [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] DB2 y bases de datos.  
...
-   Seleccione tablas para la migración de datos y, a continuación, migre los datos de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]esas tablas a. Para obtener más información, vea [migrar bases de datos DB2 a SQL Server &#40;DB2ToSQL&#41;](../../ssma/db2/migrating-db2-databases-to-sql-server-db2tosql.md).  
...
Puede usar [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] el explorador de metadatos para seleccionar objetos de base de datos DB2 convertidos y, a continuación [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], sincronizar esos objetos con la instancia de.  
...
La barra de herramientas del proyecto contiene botones para trabajar con proyectos, conectarse a DB2 y [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]conectarse a. Estos botones se asemejan a los comandos del menú **archivo** .  
...
|**Migrar datos**|Migra datos de la base de datos DB2 [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]a. Antes de ejecutar este comando, debe convertir los esquemas DB2 en [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] esquemas y, a continuación, cargar los objetos [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]en.<br /><br />Este comando está deshabilitado a menos que se seleccionen objetos en el explorador de metadatos DB2.|  
...
|**Vista**|Contiene el comando **sincronizar exploradores de metadatos** . Que sincroniza los objetos entre el explorador de metadatos [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] DB2 y el explorador de metadatos. También contiene comandos para mostrar y ocultar los paneles de **salida** y **lista de errores** y los **diseños** de opciones para administrar los diseños.|  
