...
La página migración del cuadro de diálogo **configuración del proyecto** contiene opciones que personalizan el modo en que SSMA migra [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]los datos de DB2 a.  
