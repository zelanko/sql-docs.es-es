...
5.  Repita los pasos 1 a 3 para las páginas de la migración, la sincronización, cargar objetos del sistema, interfaz gráfica de usuario y asignación de tipo.  
    ...
    -   Para obtener información acerca de la configuración del objeto de sistema, consulte [configuración del proyecto&#40;objetos del sistema de carga&#41; &#40;DB2ToSQL&#41;](../../ssma/db2/project-settings-loading-system-objects-db2tosql.md).  
