...
4.  **SqlStatementConversionSample.xml:** en este ejemplo permite al usuario generar la correspondiente `t-sql` secuencia de comandos de la base de datos de origen `sql` comando proporcionado como entrada.  
