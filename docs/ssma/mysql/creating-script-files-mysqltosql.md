...
7.  **Detener la operación:** Durante la operación intermedio, si el usuario desea detener la operación, a continuación, **'Ctrl + C'** se puede usar la tecla de acceso rápido. SSMA para MySQL consola esperará a que se complete la operación y finaliza la ejecución de la consola.  
...
Por ejemplo, una migración de datos típica de una tabla específica en una base de datos MySQL sigue la jerarquía de: Base de datos -&gt; tabla.  
