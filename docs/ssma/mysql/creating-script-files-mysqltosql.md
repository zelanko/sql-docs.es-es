...
7.  **Operación de detención:** durante la operación intermedia, si el usuario desea detener la operación, a continuación, **'Ctrl + C'** se puede utilizar la tecla de acceso rápido. SSMA para la consola de MySQL esperará a que finalice la operación y finaliza la ejecución de la consola.  
...
Por ejemplo, una migración típica de datos de una tabla específica en una base de datos de MySQL sigue la jerarquía de: base de datos -&gt; tabla.  
  
Cuando todos los comandos en el archivo de script se ejecuta correctamente, la aplicación de consola SSMA sale y devuelve el control al usuario. El contenido de un archivo de script es más o menos estático con información sobre las variable contenidas en una [archivos de valores de Variable](http://msdn.microsoft.com/en-us/1dc56a7b-8e3a-4576-ad4f-47050bf7e28a) o, en una sección independiente dentro del archivo de script para los valores de las variables.  
