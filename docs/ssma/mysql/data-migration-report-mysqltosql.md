---
title: Informe de migración de datos (MySQLToSQL) | Documentos de Microsoft
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
ms.locfileid: "34776001"
---
# <a name="data-migration-report--mysqltosql"></a>Informe de migración de datos (MySQLToSQL)
