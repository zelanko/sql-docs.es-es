...
1.  Copie SSMA para el paquete de extensiones de MySQL. *n*.Install.exe, donde *n* es el número de compilación, en el equipo que ejecuta [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] .  
  
2.  Haga doble clic en SSMA para el paquete de extensiones de MySQL. *n*.Install.exe.  
