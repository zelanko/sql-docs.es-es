...
Si desea actualizar a una versión posterior de SSMA para MySQL, primero debe desinstalar el cliente y el paquete de extensiones de servidor y, a continuación, instalar la versión más reciente.  
