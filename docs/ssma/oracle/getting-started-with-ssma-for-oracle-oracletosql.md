...
ms.locfileid: "68264450"
---
# <a name="getting-started-with-ssma-for-oracle-oracletosql"></a>Introducción a SSMA para Oracle (OracleToSQL)
[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Migration Assistant (SSMA) para Oracle le permite convertir rápidamente esquemas de base de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] datos de Oracle en esquemas, cargar los [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] esquemas resultantes en y migrar datos de Oracle a [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)].  
...
Para usar SSMA, primero debe instalar el programa cliente de SSMA en un equipo que pueda tener acceso a la base de datos de origen de Oracle [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]y a la instancia de destino de. A continuación, debe instalar un paquete de extensión y al menos uno de los proveedores de Oracle [!INCLUDE[vstecado](../../includes/vstecado_md.md)](OLE DB o) en el equipo [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]que ejecuta. Estos componentes admiten la migración de datos y la emulación de las funciones del sistema de Oracle. Para obtener instrucciones de instalación, consulte [instalar SSMA para Oracle &#40;OracleToSQL&#41;](../../ssma/oracle/installing-ssma-for-oracle-oracletosql.md).  
...
Para iniciar una migración, primero debe crear un nuevo proyecto. A continuación, se conecta a una base de datos de Oracle. Después de una conexión correcta, los esquemas de Oracle aparecerán en el explorador de metadatos de Oracle. Después, puede hacer clic con el botón derecho en objetos en el explorador de metadatos de Oracle para realizar tareas como crear [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]informes que evalúen las conversiones en. También puede realizar estas tareas mediante las barras de herramientas y los menús.  
  
También debe conectarse a una instancia de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]. Después de una conexión correcta, aparecerá una [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] jerarquía de bases de datos en [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] el explorador de metadatos. Después de convertir los esquemas de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Oracle en esquemas, seleccione los esquemas [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] convertidos en el explorador de metadatos y, [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]a continuación, sincronice los esquemas con.  
  
Después de sincronizar los esquemas [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]convertidos con, puede volver al explorador de metadatos de Oracle y migrar datos [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] de esquemas de Oracle a bases de datos de.  
...
SSMA contiene dos exploradores de metadatos para examinar y realizar acciones en [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] Oracle y en bases de datos.  
...
-   Seleccione tablas para la migración de datos y, a continuación, migre los datos de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]esas tablas a. Para obtener más información, vea [migrar datos de Oracle a SQL Server &#40;OracleToSQL&#41;](../../ssma/oracle/migrating-oracle-data-into-sql-server-oracletosql.md).  
  
#### <a name="sql-server-metadata-explorer"></a>SQL Server explorador de metadatos  
[!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]El explorador de metadatos muestra información sobre [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]una instancia de. Cuando se conecta a una instancia de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)], SSMA recupera los metadatos sobre esa instancia y los almacena en el archivo de proyecto.  
  
Puede utilizar [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] el explorador de metadatos para seleccionar objetos de base de datos de Oracle convertidos y, a [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]continuación, sincronizar esos objetos con la instancia de.  
...
La barra de herramientas del proyecto contiene botones para trabajar con proyectos, conectarse a Oracle y [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]conectarse a. Estos botones se asemejan a los comandos del menú **archivo** .  
...
|**Migrar datos**|Migra datos de la base de datos de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]Oracle a. Antes de ejecutar este comando, debe convertir los esquemas de Oracle en [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] esquemas y, a continuación, cargar los [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)]objetos en.<br /><br />Este comando está deshabilitado a menos que se seleccionen objetos en el explorador de metadatos de Oracle.|  
...
|**Vista**|Contiene el comando **sincronizar exploradores de metadatos** . Que sincroniza los objetos entre el explorador de metadatos [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] de Oracle y el explorador de metadatos. También contiene comandos para mostrar y ocultar los paneles de **salida** y **lista de errores** y los **diseños** de opciones para administrar los diseños.|  
