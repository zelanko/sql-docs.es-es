---
title: Comandos de menú y otras teclas de método abreviado (SQL de Oracle) | Documentos de Microsoft
ms.prod: sql
ms.custom: ''
ms.date: 01/19/2017
ms.reviewer: ''
...
ms.locfileid: "34777611"
---
# <a name="menu-commands-and-other-shortcut-keysoracle-to-sql"></a>Comandos de menú y otras teclas de método abreviado (Oracle To SQL)
En las siguientes secciones se describen los métodos abreviados de teclado para tener acceso a comandos de menú y otras teclas de método abreviado que se utiliza en varios cuadros de diálogo de SSMA para la aplicación de Oracle.  
...
|Mostrar el conectar o volver a conectar al cuadro de diálogo de Oracle.|ALT + F + T|  
...
|Actualización de base de datos de Oracle.|ALT+T+R|  
...
|Obtener acceso a submenú de copia de seguridad de administración de Oracle.|ALT + S + B|  
|Pantalla Agregar tablas a la copia de seguridad para el cuadro de diálogo de Oracle.|ALT + S + B + B|  
|Mostrar tablas de restauración de copia de seguridad para el cuadro de diálogo de Oracle.|ALT + S + B + R|  
