...
En este artículo se describe SQL Server Migration Assistant (SSMA) para el mensaje de error de Oracle al `UPDATE` convertir la instrucción PL/SQL de Oracle en una asignación de grupo de columnas.
