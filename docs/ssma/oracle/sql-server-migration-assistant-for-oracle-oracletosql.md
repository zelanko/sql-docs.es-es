...
|Sección|Descripción|  
|-----------|---------------|  
|[Novedades de SSMA para Oracle](http://msdn.microsoft.com/f305ebb6-7393-4a43-abb3-6332b739d690)|Novedades de esta versión de SSMA para Oracle|  
...
|[Introducción a SSMA para Oracle ayuda](http://go.microsoft.com/fwlink/?LinkID=708538&clcid=0x409)|Proporciona información sobre cómo obtener asistencia adicional.|  
