...
5.  Repita los pasos 1 a 3 para las páginas de la migración, la sincronización, cargar objetos del sistema, interfaz gráfica de usuario y asignación de tipo.  
    ...
    -   Para obtener información acerca de la configuración del objeto de sistema, consulte [configuración del proyecto&#40;objetos del sistema de carga&#41; &#40;OracleToSQL&#41;](../../ssma/oracle/project-settings-loading-system-objects-oracletosql.md).  
...
Además de definir la configuración predeterminada del proyecto que se aplican a todos los nuevos proyectos SSMA, puede personalizar la configuración para cada proyecto. Para obtener más información, consulte [establecer las opciones del proyecto &#40;OracleToSQL&#41;](../../ssma/oracle/setting-project-options-oracletosql.md).  
