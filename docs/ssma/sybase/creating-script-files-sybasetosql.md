...
7.  **Operación de detención:** durante la operación intermedio, si el usuario desea detener la operación, a continuación, **'Ctrl + C'** se puede usar la tecla de acceso rápido. SSMA para Sybase consola esperará a que se complete la operación y finaliza la ejecución de la consola.  
