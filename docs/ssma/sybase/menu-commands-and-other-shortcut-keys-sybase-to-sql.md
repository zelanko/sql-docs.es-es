---
title: Comandos de menú y otras teclas de método abreviado (Sybase a SQL) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
ms.reviewer: ''
...
ms.locfileid: "34779351"
---
# <a name="menu-commands-and-other-shortcut-keys-sybase-to-sql"></a>Comandos de menú y otras teclas de método abreviado (Sybase a SQL)
En las siguientes secciones se describen los métodos abreviados de teclado para tener acceso a comandos de menú y otras teclas de método abreviado que se utiliza en varios cuadros de diálogo de SSMA para Sybase aplicación.  
...
|Mostrar el conectar o volver a conectar al cuadro de diálogo de Sybase.|ALT + F + T|  
...
|Actualización de base de datos de Sybase.|ALT+T+R|  
...
Para acceder a menú de evaluador, utiliza el método abreviado de teclado es ALT + S. En la tabla siguiente describe el teclado accesos directos que se usan para tener acceso a elementos de menú en el menú de la herramienta de comprobación.  
...
|Mostrar el repositorio de cuadro de diálogo de resultados de pruebas.|ALT + S + R|  
|Obtener acceso a submenú de copia de seguridad de administración de Sybase.|ALT + S + B|  
|Pantalla Agregar tablas a la copia de seguridad para el cuadro de diálogo de Sybase.|ALT + S + B + B|  
|Mostrar tablas de restauración de copia de seguridad para el cuadro de diálogo de Sybase.|ALT + S + B + R|  
|Mostrar administrar contenido de copia de seguridad para el cuadro de diálogo de Sybase.|ALT + S + B + C|  
|Submenú de administración de copia de seguridad de acceso a SQL Server.|ALT+S+M|  
|Pantalla Agregar tablas a la copia de seguridad para el cuadro de diálogo de SQL Server.|ALT + S + M + B|  
|Mostrar tablas de restauración de copia de seguridad para el cuadro de diálogo de SQL Server.|ALT + S + M + R|  
...
|PARA ELLO|PRESIONE|  
|--------------|---------|  
|Mostrar acerca de SSMA para Sybase cuadro de diálogo.|ALT + H + A|  
