...
|Actualizar desde la base de datos Sybase.|ALT+T+R|  
...
|Submenú de administración de copia de seguridad de acceso a Sybase.|ALT + S + B|  
|Pantalla Agregar tablas a la copia de seguridad de diálogo de Sybase.|ALT + S + B + B|  
|Para mostrar las tablas de restauración de copia de seguridad para el cuadro de diálogo de Sybase.|ALT + S + B + R|  
