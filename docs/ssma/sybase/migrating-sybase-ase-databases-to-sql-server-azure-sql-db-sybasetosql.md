...
4.  [Asignar los esquemas de base de datos de SAP ASE a SQL Server / esquemas de base de datos de Azure SQL Database](https://msdn.microsoft.com/2c927003-c49d-4fe1-8e3e-5b2899166268).  
...
6.  [Convertir esquemas de base de datos de SAP ASE en SQL Server / esquemas de base de datos de SQL Azure](https://msdn.microsoft.com/509cb65d-2f54-427a-83d7-37919cc4e3e3).  
  
7.  [Cargar los objetos de base de datos convertida en SQL Server / Azure SQL Database](https://msdn.microsoft.com/4c59256f-99a8-4351-9559-a455813dbd06).  
...
8.  [Migrar datos a SQL Server / Azure SQL Database](https://msdn.microsoft.com/54a39f5e-9250-4387-a3ae-eae47c799811).  
