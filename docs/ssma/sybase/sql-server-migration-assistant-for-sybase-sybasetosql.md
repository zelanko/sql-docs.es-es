...
|[Trabajar con SSMA para la consola de Sybase](working-with-ssma-for-sybase-console-sybasetosql.md)|Contiene documentación sobre la aplicación de consola SSMA.|  
