---
title: Trabajar con los archivos de comandos de consola de ejemplo (SybaseToSQL) | Documentos de Microsoft
ms.custom: ''
ms.date: 01/19/2017
ms.prod: sql
ms.reviewer: ''
...
-   **ServersConnectionFileSample.xml:**  
    ...
    -   Para obtener más información sobre cómo conectarse al servidor de origen y de destino, vea [crear los archivos de conexión de servidor &#40;SybaseToSQL&#41;](../../ssma/sybase/creating-the-server-connection-files-sybasetosql.md).  
...
-   **VariableValueFileSample.xml:**  
    ...
    Para obtener más información sobre el archivo de valores de variables, consulte [crear archivos de valores Variable &#40;SybaseToSQL&#41;](../../ssma/sybase/creating-variable-value-files-sybasetosql.md).  
...
-   **AssessmentReportGenerationSample.xml:**  
    ...
    Para obtener más información sobre la generación de informes, consulte [generar informes &#40;SybaseToSQL&#41;](../../ssma/sybase/generating-reports-sybasetosql.md).  
...
[Crear archivos de valor de la Variable &#40;SybaseToSQL&#41;](../../ssma/sybase/creating-variable-value-files-sybasetosql.md)  
