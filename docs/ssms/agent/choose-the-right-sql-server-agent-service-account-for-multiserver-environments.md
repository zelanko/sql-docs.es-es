---
description: Elegir la cuenta correcta del servicio del Agente SQL Server para entornos multiservidor
title: Elección de la cuenta del servicio de agente para entornos multiservidor
ms.prod: sql
