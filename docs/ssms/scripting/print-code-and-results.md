...
description: Obtenga información sobre cómo especificar el uso de colores del texto al imprimir. Los colores pueden diferir de los que se usan para la presentación. Obtenga información sobre cómo controlar si los números de línea aparecen en la lista.
ms.prod: sql
ms.technology: ssms
ms.topic: conceptual
helpviewer_keywords:
