...
- Se ha corregido un problema en el que el SPID en la IU de SSMS podría quedar obsoleto y no sincronizarse. https://connect.microsoft.com/SQLServer/feedback/details/1898875
...
- Estadísticas de consultas activas: se ha corregido un problema que hacía que solo se mostrase la primera consulta de un lote. [Elemento de conexión] (http://connect.microsoft.com/SQLServer/feedback/details/3114221)  
...
- La Configuración de Always Encrypted para una base de datos existente con varios esquemas no funciona. [Elemento de conexión] (http://connect.microsoft.com/SQLServer/feedback/details/3109591)
- El Asistente para columnas cifradas de Always Encrypted produce un error debido a la base de datos que contiene vistas que hacen referencia a vistas del sistema. [Elemento de conexión] (http://connect.microsoft.com/SQLServer/feedback/details/3111925)
...
* Los usuarios pueden implementar paquetes SSIS que contienen el Administrador de conexiones OData que se conectan a un recurso de Microsoft Dynamics AX/CRM Online en el catálogo de SSIS. Para obtener más información, vea [Administrador de conexiones OData](/sql-docs/docs/integration-services/connection-manager/odata-connection-manager).
...
* Nuevas plantillas de eventos extendidos que coinciden con la funcionalidad de las plantillas de SQL Server Profiler [(Microsoft Connect, n.º 2543925).](/sql-docs/docs/tools/sql-server-profiler/sql-server-profiler-templates).
...
---
## <a name="ssms-july-2016"></a>SSMS de julio de 2016 
...
* Nuevo cuadro de diálogo de copia de seguridad en la dirección URL para admitir la creación de credenciales de Almacenamiento de Azure para copias de seguridad de la base de datos de SQL Server 2016. Este cuadro de diálogo proporciona una experiencia más sencilla para almacenar las copias de seguridad de la base de datos en una cuenta de Azure Storage.
