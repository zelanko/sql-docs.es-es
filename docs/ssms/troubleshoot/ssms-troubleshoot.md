...
## <a name="get-full-memory-dump-of-sql-server-management-studio-ssms-when-it-hangs-or-crashes"></a>Obtención del volcado de memoria de SQL Server Management Studio (SSMS) cuando se bloquea
