...
---
# <a name="lesson-1-6---select-the-keyboard-shortcut-scheme"></a>Lección 1.6: Seleccionar el esquema de métodos abreviados de teclado
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] En lugar de la combinación de teclado estándar de [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)], puede configurar [!INCLUDE[ssManStudioFull](../../includes/ssmanstudiofull-md.md)] para usar un esquema de teclado compatible con [!INCLUDE[vs_dev10_long](../../includes/vs-dev10-long-md.md)].  
...
[Establecer las opciones de inicio](../../tools/sql-server-management-studio/lesson-1-7-set-the-startup-options.md)  
