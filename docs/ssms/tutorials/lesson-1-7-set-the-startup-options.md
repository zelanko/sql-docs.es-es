...
---
# <a name="lesson-1-7---set-the-startup-options"></a>Lección 1.7: Establecer las opciones de inicio
...
[Restaurar la configuración predeterminada de SQL Server Management Studio](../../tools/sql-server-management-studio/lesson-1-8-restore-the-default-sql-server-management-studio-configuration.md)  
