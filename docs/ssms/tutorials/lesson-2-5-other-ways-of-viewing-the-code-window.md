...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] La ventana Código se puede configurar para mostrar varias ventanas de código de diversas formas.  
...
[Incluir una tabla en un script](../../tools/sql-server-management-studio/lesson-2-6-script-a-table.md)  
