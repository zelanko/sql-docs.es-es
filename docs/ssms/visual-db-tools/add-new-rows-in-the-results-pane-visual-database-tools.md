---
description: Agregar nuevas filas en el panel Resultados (Visual Database Tools)
title: Agregar filas nuevas en el panel de resultados
ms.prod: sql
