...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] Puede agregar rápidamente a un diagrama de base de datos todas las tablas que están relacionadas con una tabla seleccionada.  
