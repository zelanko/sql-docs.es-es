...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] Puede crear alias para nombres de columna con el fin de facilitar el trabajo con nombres de columna, cálculos y valores de resumen. Por ejemplo, puede crear un alias de columna para:  
