...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] Los alias facilitan el trabajo con nombres de tabla. El uso de alias es útil cuando:  
