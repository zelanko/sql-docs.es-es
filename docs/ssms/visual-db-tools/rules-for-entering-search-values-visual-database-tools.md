...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] En este tema se tratan las convenciones que se deben usar para especificar los siguientes tipos de valores literales en una condición de búsqueda:  
