...
[!INCLUDE[appliesto-ss-asdb-asdw-pdw-md](../../includes/appliesto-ss-asdb-asdw-pdw-md.md)] Guarde la consulta si quiere trabajar con ella más adelante. Observe que, al ejecutar la consulta, no se guardan los cambios.  
