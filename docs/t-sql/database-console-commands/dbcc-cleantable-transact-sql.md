...
[!INCLUDE[tsql-appliesto-ss2008-asdb-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-asdb-xxxx-xxx-md.md)] Recupera el espacio de columnas de longitud variable quitadas de tablas o vistas indexadas.
