...
[!INCLUDE[tsql-appliesto-ss2008-asdb-xxxx-xxx-md](../../includes/tsql-appliesto-ss2008-asdb-xxxx-xxx-md.md)]Recupera el espacio de las columnas de longitud variable quitadas en tablas o vistas indizadas.
