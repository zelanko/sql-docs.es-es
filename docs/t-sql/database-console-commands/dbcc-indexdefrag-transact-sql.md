---
title: DBCC INDEXDEFRAG (Transact-SQL) | Documentos de Microsoft
ms.custom: 
ms.date: 07/16/2017
...
El siguiente ejemplo desfragmentan todas las particiones de la `PK_Product`_`ProductID` de índice en el `Production.Product` tabla el `AdventureWorks` base de datos.
