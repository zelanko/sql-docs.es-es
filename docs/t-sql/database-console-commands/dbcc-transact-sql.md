...
- [DBCC CLONEDATABASE](../../t-sql/database-console-commands/dbcc-clonedatabase-transact-sql.md) <br /><br /> **Se aplica a**: [!INCLUDE[ssSQL14](../../includes/sssql14-md.md)] SP2 y versiones posteriores
