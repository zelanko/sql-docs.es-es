---
title: "Funciones analíticas (Transact-SQL) | Documentos de Microsoft"
ms.custom: 
ms.date: 07/24/2017
...
SQL Server admite las funciones analíticas siguientes. Las funciones analíticas calculan un valor agregado basándose en un grupo de filas. Sin embargo, a diferencia de las funciones de agregado, pueden devolver varias filas para cada grupo. Puede usar funciones analíticas para calcular medias móviles, totales acumulados, porcentajes o resultados de N valores superiores dentro de un grupo.
  
|||  
|-|-|  
|[CUME_DIST &#40; Transact-SQL &#41;](../../t-sql/functions/cume-dist-transact-sql.md)|[RESPONSABLE de &#40; Transact-SQL &#41;](../../t-sql/functions/lead-transact-sql.md)|  
