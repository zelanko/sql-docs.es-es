...
En los siguientes ejemplos se cambia el tipo de datos de entrada por otros dos tipos de datos con distintos niveles de precisión.
```sql  
...
> [!TIP]
> Al final de este tema encontrará numerosos [ejemplos](#BKMK_examples).  
