---
title: ENCRYPTBYCERT (Transact-SQL) | Documentos de Microsoft
ms.custom: 
ms.date: 03/06/2017
 ...
 **@cleartext**  
 Una variable de tipo **nvarchar**, **char**, **varchar**, **binario**, **varbinary**, o **nchar** que contiene los datos que se cifrará con la clave pública del certificado.  
