...
### <a name="d-eomonth-with-explicit-datetime-type"></a>D. EOMONTH con un tipo datetime explícito  
...
### <a name="e-eomonth-with-string-parameter-and-implicit-conversion"></a>E. EOMONTH con parámetro de cadena y conversión implícita  
...
### <a name="f-eomonth-with-and-without-the-monthtoadd-parameter"></a>F. EOMONTH con y sin el parámetro month_to_add  
