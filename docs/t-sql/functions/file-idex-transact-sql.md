...
### <a name="b-retrieving-the-file-id-when-the-file-name-is-not-known"></a>B. Recuperar el Id. de archivo cuando se desconoce el nombre del archivo  
 El siguiente ejemplo devuelve el Id. de archivo del archivo de registro de `AdventureWorks` seleccionando el nombre del archivo lógico de la vista de catálogo `sys.database`_`files` en la que el tipo de archivo es igual a `1` (registro).  
...
### <a name="c-retrieving-the-file-id-of-a-full-text-catalog-file"></a>C. Recuperar el Id. de archivo de un archivo de catálogo de texto completo  
 El siguiente ejemplo devuelve el Id. de archivo de un archivo de texto completo seleccionando el nombre del archivo lógico de la vista de catálogo `sys.database`_`files` en la que el tipo de archivo es igual a `4` (texto completo). En este ejemplo se devuelve NULL si no existe ningún catálogo de texto completo.  
