...
## <a name="examples"></a>Ejemplos  
 En el siguiente ejemplo se devuelven los nombres de archivo de `file_ID 1` y `file_ID` de la base de datos [!INCLUDE[ssSampleDBnormal](../../includes/sssampledbnormal-md.md)].  
