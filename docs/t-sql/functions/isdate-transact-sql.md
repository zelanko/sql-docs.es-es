 ...
 *expression* Es una cadena de caracteres o una [expresión](../../t-sql/language-elements/expressions-transact-sql.md) que se puede convertir en una cadena de caracteres. La expresión debe tener menos de 4.000 caracteres. No se permiten tipos de datos de fecha y hora, excepto datetime y smalldatetime, como argumento para ISDATE.
