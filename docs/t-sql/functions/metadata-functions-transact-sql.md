...
|[APPLOCK_TEST](../../t-sql/functions/applock-test-transact-sql.md)|[VALOR SIGUIENTE PARA](../../t-sql/functions/next-value-for-transact-sql.md)|  
...
|[FULLTEXTSERVICEPROPERTY](../../t-sql/functions/fulltextserviceproperty-transact-sql.md)|[VERSIÓN](../../t-sql/functions/version-transact-sql-metadata-functions.md)|  
