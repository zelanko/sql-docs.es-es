---
title: Funciones de seguridad (Transact-SQL) | Documentos de Microsoft
ms.custom: 
ms.date: 03/15/2017
...
[!INCLUDE[tsql-appliesto-ss2012-xxxx-xxxx-xxx-md](../../includes/tsql-appliesto-ss2012-xxxx-xxxx-xxx-md.md)]
  ...
  Las siguientes funciones devuelven información útil para la administración de la seguridad. Funciones adicionales que aparecen en [funciones de cifrado &#40; Transact-SQL &#41; ](../../t-sql/functions/cryptographic-functions-transact-sql.md).  
...
|[PERMISOS &#40; Transact-SQL &#41;](../../t-sql/functions/permissions-transact-sql.md)||  
  
 Para obtener información sobre la pertenencia a grupos de Windows, vea [xp_logininfo &#40; Transact-SQL &#41; ](../../relational-databases/system-stored-procedures/xp-logininfo-transact-sql.md) y [xp_enumgroups &#40; Transact-SQL &#41; ](../../relational-databases/system-stored-procedures/xp-enumgroups-transact-sql.md).  
...
## <a name="see-also"></a>Vea también  
 ...
 [Instrucciones de seguridad](http://msdn.microsoft.com/library/aebe2ec7-31bc-4697-a493-dcfcd0903a7b)  
