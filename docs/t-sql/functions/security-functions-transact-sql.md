---
description: Funciones de seguridad (Transact-SQL)
...
## <a name="see-also"></a>Vea también  
 ...
 [Instrucciones de seguridad](../statements/permissions-grant-deny-revoke-azure-sql-data-warehouse-parallel-data-warehouse.md)  
