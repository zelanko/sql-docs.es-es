...
|IsBigDataCluster| Introducido en [!INCLUDE[ssSQL2019](../../includes/sssqlv15-md.md)] a partir de CU4.<br /><br />Devuelve 1 si la instancia es un clúster de macrodatos de SQL Server; en caso contrario, devuelve 0.|  
...
|IsLocalDB|**Válido para** : [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] y versiones posteriores.<br /><br /> El servidor es una instancia de [!INCLUDE[ssExpress](../../includes/ssexpress-md.md)] LocalDB.<br /><br /> NULL = La entrada no es válida, es un error o no es aplicable.|  
