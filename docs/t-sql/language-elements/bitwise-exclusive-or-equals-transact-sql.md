---
title: ^ = (Igual a OR exclusivo bit a bit) (Transact-SQL) | Documentos de Microsoft
ms.custom: 
ms.date: 01/10/2017
...
---
# <a name="-bitwise-exclusive-or-equals-transact-sql"></a>^= (OR exclusivo bit a bit igual) (Transact-SQL)
