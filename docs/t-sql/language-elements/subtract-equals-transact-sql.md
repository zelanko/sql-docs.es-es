---
title: "-= (Asignación y sustracción) (Transact-SQL) | Documentos de Microsoft"
ms.custom: 
ms.date: 03/06/2017
...
---
# <a name="--subtraction-assignment-transact-sql"></a>-= (Asignación y sustracción) (Transact-SQL)
[!INCLUDE[tsql-appliesto-ss2008-all_md](../../includes/tsql-appliesto-ss2008-all-md.md)]

  Resta dos números y establece un valor como resultado de la operación. Por ejemplo, si una variable @x es igual a 35, a continuación, @x -= 2 toma el valor original de @x, resta 2 y establece @x en el nuevo valor (33).  
...
## <a name="remarks"></a>Comentarios  
 Para obtener más información, vea [-&#40; Resta &#41; &#40; Transact-SQL &#41; ](../../t-sql/language-elements/subtract-transact-sql.md).  
