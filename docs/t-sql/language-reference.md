...
- [SQL Operations Studio (versión preliminar)](https://docs.microsoft.com/sql/sql-operations-studio/download).  
...
Para obtener ayuda en línea, consulte el [foro de MSDN para Transact-SQL](http://social.msdn.microsoft.com/Forums/en-US/home?forum=transactsql).  
