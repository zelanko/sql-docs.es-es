---
description: 'Tutorial de T-SQL: Eliminación de objetos de base de datos'
...
ms.locfileid: "88467537"
---
# <a name="lesson-3-delete-database-objects"></a>Lección 3: Eliminación de objetos de base de datos
