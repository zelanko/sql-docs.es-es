...
*WITH_RECOMMENDATIONS* (Versión preliminar)

Devuelva el plan de consulta con recomendaciones para optimizar el rendimiento de la instrucción SQL.  
...
**Salida de ejemplo para EXPLAIN WITH_RECOMMENDATIONS**  
