...
## <a name="permissions"></a>Permisos
 ...
 Requiere el permiso **SHOWPLAN** y el permiso para ejecutar *SQL_statement*. Vea [Permisos: GRANT, DENY, REVOKE &#40;Azure Synapse Analytics, Almacenamiento de datos en paralelo&#41;](../../t-sql/statements/permissions-grant-deny-revoke-azure-sql-data-warehouse-parallel-data-warehouse.md).  
