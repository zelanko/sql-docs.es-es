---
description: 'SELECT: Cláusula ORDER BY (Transact-SQL)'
...
###  <a name="specifying-a-conditional-order"></a><a name="Case"></a> Especificar un orden condicional  
