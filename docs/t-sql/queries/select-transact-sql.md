...
```  
 ...
 Este ejemplo devuelve solo las filas de `DimEmployee` que tengan un valor de `EndDate` que no sea NULL y un valor de `MaritalStatus` de 'M' (que corresponde a casado).  
