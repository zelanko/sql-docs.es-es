...
|-|-|  
|Término|Definición|  
|*tolerance*|Es un valor de tipo **float**. *tolerancia* es la tolerancia como entrada para el algoritmo de Douglas-Peucker. *tolerancia* debe ser un número positivo.|  
