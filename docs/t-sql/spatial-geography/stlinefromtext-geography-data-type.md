---
title: STLineFromText (tipo de datos geography) | Documentos de Microsoft
ms.custom: 
ms.date: 07/30/2017
 ...
 *linestring_tagged_text*  
 Es la representación WKT de la **geographyLineString** instancia que se va a devolver. *linestring_tagged_text* es un **nvarchar (max)** expresión.  
  
 *SRID*  
 Es un **int** expresión que representa el espaciales identificador de referencia (SRID) de la **geographyLineString** instancia que se va a devolver.  
