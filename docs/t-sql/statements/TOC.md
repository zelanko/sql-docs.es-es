# [Información general](statements.md)

# ADD

## [CLASIFICACIÓN DE SENSIBILIDAD](add-sensitivity-classification-transact-sql.md)
...
## [DATABASE (Almacenamiento de datos paralelos)](alter-database-parallel-data-warehouse.md)  
## [DATABASE AUDIT SPECIFICATION](alter-database-audit-specification-transact-sql.md)
## [Nivel de compatibilidad de DATABASE](alter-database-transact-sql-compatibility-level.md)  
## [Creación de reflejo de la base de datos DATABASE](alter-database-transact-sql-database-mirroring.md)  
## [DATABASE ENCRYPTION KEY](alter-database-encryption-key-transact-sql.md)
## [Opciones File y Filegroup de DATABASE](alter-database-transact-sql-file-and-filegroup-options.md)  
...
## [Opciones SET de DATABASE](alter-database-transact-sql-set-options.md)  
...
## [INDEX (índices XML selectivos)](alter-index-selective-xml-indexes.md)  
...
## [BACKUP DATABASE (Almacenamiento de datos paralelos)](backup-database-parallel-data-warehouse.md)  
...
## [Instrucciones RESTORE](restore-statements-for-restoring-recovering-and-managing-backups-transact-sql.md)  
## [RESTORE DATABASE (Almacenamiento de datos paralelos)](restore-database-parallel-data-warehouse.md)
...
## [DATABASE (Almacenamiento de datos paralelos)](create-database-parallel-data-warehouse.md)  
...
## [REMOTE TABLE AS SELECT (Almacenamiento de datos paralelos)](create-remote-table-as-select-parallel-data-warehouse.md)  
...
## [TABLE IDENTITY (propiedad)](create-table-transact-sql-identity-property.md)
...
## [XML INDEX (índices XML selectivos)](create-xml-index-selective-xml-indexes.md)  
## [XML SCHEMA COLLECTION](create-xml-schema-collection-transact-sql.md)  

# Intercalaciones
## [Cláusula COLLATE](collations.md)  
## [Nombre de intercalación de SQL Server](sql-server-collation-name-transact-sql.md)  
## [Nombre de intercalación de Windows](windows-collation-name-transact-sql.md)  
## [Prioridad de intercalación](collation-precedence-transact-sql.md)  
...
## [INDEX (índices XML selectivos)](drop-index-selective-xml-indexes.md)  
...
## [CLASIFICACIÓN DE SENSIBILIDAD](drop-sensitivity-classification-transact-sql.md)
...
## [Permisos de ensamblado DENY](deny-assembly-permissions-transact-sql.md)  
## [Permisos de clave asimétrica DENY](deny-asymmetric-key-permissions-transact-sql.md)  
## [Permisos de grupos de disponibilidad DENY](deny-availability-group-permissions-transact-sql.md)  
## [Permisos de certificado DENY](deny-certificate-permissions-transact-sql.md)  
## [Permisos de base de datos DENY](deny-database-permissions-transact-sql.md)  
## [Permisos de entidad de seguridad de base de datos DENY](deny-database-principal-permissions-transact-sql.md)  
## [Credencial de ámbito de base de datos DENY](deny-database-scoped-credential-transact-sql.md)  
## [Permisos de punto de conexión DENY](deny-endpoint-permissions-transact-sql.md)  
## [Permisos de texto completo DENY](deny-full-text-permissions-transact-sql.md)  
## [Permisos de objeto DENY](deny-object-permissions-transact-sql.md)  
## [Permisos de esquema DENY](deny-schema-permissions-transact-sql.md)  
## [Permisos de lista de propiedades de búsqueda DENY](deny-search-property-list-permissions-transact-sql.md)  
## [Permisos de servidor DENY](deny-server-permissions-transact-sql.md)  
## [Permisos de entidad de seguridad de servidor DENY](deny-server-principal-permissions-transact-sql.md)  
## [Permisos de Service Broker DENY](deny-service-broker-permissions-transact-sql.md)  
## [Permisos de clave simétrica DENY](deny-symmetric-key-permissions-transact-sql.md)  
## [Permisos de objeto de sistema DENY](deny-system-object-permissions-transact-sql.md)  
## [Permisos de tipo DENY](deny-type-permissions-transact-sql.md)  
## [Permisos de colección de esquemas XML DENY](deny-xml-schema-collection-permissions-transact-sql.md)  
## [EXECUTE AS](execute-as-transact-sql.md)  
## [Cláusula EXECUTE AS](execute-as-clause-transact-sql.md)  
## [GRANT](grant-transact-sql.md)  
## [Permisos de ensamblado GRANT](grant-assembly-permissions-transact-sql.md)  
## [Permisos de clave asimétrica GRANT](grant-asymmetric-key-permissions-transact-sql.md)  
## [Permisos de grupos de disponibilidad GRANT](grant-availability-group-permissions-transact-sql.md)  
## [Permisos de certificado GRANT](grant-certificate-permissions-transact-sql.md)  
## [Permisos de base de datos GRANT](grant-database-permissions-transact-sql.md)  
## [Permisos de entidad de seguridad de base de datos GRANT](grant-database-principal-permissions-transact-sql.md)  
## [Credencial de ámbito de base de datos GRANT](grant-database-scoped-credential-transact-sql.md)  
## [Permisos de punto de conexión GRANT](grant-endpoint-permissions-transact-sql.md)  
## [Permisos de texto completo GRANT](grant-full-text-permissions-transact-sql.md)  
## [Permisos de objeto GRANT](grant-object-permissions-transact-sql.md)  
## [Permisos de esquema GRANT](grant-schema-permissions-transact-sql.md)  
## [Permisos de lista de propiedades de búsqueda GRANT](grant-search-property-list-permissions-transact-sql.md)  
## [Permisos de servidor GRANT](grant-server-permissions-transact-sql.md)  
## [Permisos de entidad de seguridad de servidor GRANT](grant-server-principal-permissions-transact-sql.md)  
## [Permisos de Service Broker GRANT](grant-service-broker-permissions-transact-sql.md)  
## [Permisos de clave simétrica GRANT](grant-symmetric-key-permissions-transact-sql.md)  
## [Permisos de objeto de sistema GRANT](grant-system-object-permissions-transact-sql.md)  
## [Permisos de tipo GRANT](grant-type-permissions-transact-sql.md)  
## [Permisos de colección de esquemas XML GRANT](grant-xml-schema-collection-permissions-transact-sql.md)  
## [OPEN MASTER KEY](open-master-key-transact-sql.md)  
## [OPEN SYMMETRIC KEY](open-symmetric-key-transact-sql.md)  
## [Permisos: GRANT, DENY, REVOKE (Azure SQL Data Warehouse, Almacenamiento de datos paralelos)](permissions-grant-deny-revoke-azure-sql-data-warehouse-parallel-data-warehouse.md)  
## [REVERT](revert-transact-sql.md)  
## [REVOKE](revoke-transact-sql.md)  
## [Permisos de ensamblado REVOKE](revoke-assembly-permissions-transact-sql.md)  
## [Permisos de clave asimétrica REVOKE](revoke-asymmetric-key-permissions-transact-sql.md)  
## [Permisos de grupos de disponibilidad REVOKE](revoke-availability-group-permissions-transact-sql.md)  
## [Permisos de certificado REVOKE](revoke-certificate-permissions-transact-sql.md)  
## [Permisos de base de datos REVOKE](revoke-database-permissions-transact-sql.md)  
## [Permisos de entidad de seguridad de base de datos REVOKE](revoke-database-principal-permissions-transact-sql.md)  
## [Credencial de ámbito de base de datos REVOKE](revoke-database-scoped-credential-transact-sql.md)  
## [Permisos de punto de conexión REVOKE](revoke-endpoint-permissions-transact-sql.md)  
## [Permisos de texto completo REVOKE](revoke-full-text-permissions-transact-sql.md)  
## [Permisos de objeto REVOKE](revoke-object-permissions-transact-sql.md)  
## [Permisos de esquema REVOKE](revoke-schema-permissions-transact-sql.md)  
## [Permisos de lista de propiedades de búsqueda REVOKE](revoke-search-property-list-permissions-transact-sql.md)  
## [Permisos de servidor REVOKE](revoke-server-permissions-transact-sql.md)  
## [Permisos de entidad de seguridad de servidor REVOKE](revoke-server-principal-permissions-transact-sql.md)  
## [Permisos de Service Broker REVOKE](revoke-service-broker-permissions-transact-sql.md)  
## [Permisos de clave simétrica REVOKE](revoke-symmetric-key-permissions-transact-sql.md)  
## [Permisos de objeto de sistema REVOKE](revoke-system-object-permissions-transact-sql.md)  
## [Permisos de tipo REVOKE](revoke-type-permissions-transact-sql.md)  
## [Permisos de colección de esquemas XML REVOKE](revoke-xml-schema-collection-permissions-transact-sql.md)  
...
# SET
## [Información general](set-statements-transact-sql.md)
