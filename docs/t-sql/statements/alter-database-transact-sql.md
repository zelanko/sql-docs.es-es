...
MODIFY (SERVICE_OBJECTIVE = \<service-objective>) Especifica el nivel de rendimiento. En el ejemplo siguiente se cambia el objetivo de servicio de una base de datos Premium a `P6`:
