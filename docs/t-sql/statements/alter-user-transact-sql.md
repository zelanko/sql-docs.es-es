...
> Esta opción solo está disponible para los usuarios contenidos.
 ...
 DEFAULT_LANGUAGE **=** _{ NONE | \<lcid> | \<nombre de lenguaje> | \<alias de lenguaje> }_ **Se aplica a**: [!INCLUDE[ssSQL11](../../includes/sssql11-md.md)] y posterior.
