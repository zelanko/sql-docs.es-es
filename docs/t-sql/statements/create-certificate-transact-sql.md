...
## <a name="remarks"></a>Observaciones  
 Un certificado es una base de datos asegurable que sigue el estándar X.509 y admite los campos V1 de X.509. CREATE CERTIFICATE puede cargar un certificado desde un archivo o ensamblado. Esta instrucción también puede generar un par de claves y crear un certificado con firma personal.  
