...
### <a name="f-create-an-ordered-clustered-columnstore-index"></a>F. Creación de un índice ordenado de almacén de columnas agrupado

Creación de un índice ordenado de almacén de columnas agrupado en SHIPDATE.
