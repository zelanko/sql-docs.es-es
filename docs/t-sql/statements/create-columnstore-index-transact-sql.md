...
Vaya a escenarios:  
-   [Índices de almacén de columnas para análisis operativos en tiempo real](https://msdn.microsoft.com/library/dn817827.aspx)  
-   [Índices de almacén de columnas para el almacenamiento de datos de](https://msdn.microsoft.com/library/dn913734.aspx)  
  
Aprende más:  
-   [Guía de índices de almacén de columnas](https://msdn.microsoft.com/library/gg492088.aspx)  
-   [Resumen de características de los índices de almacén de columnas](https://msdn.microsoft.com/library/dn934994.aspx)  
