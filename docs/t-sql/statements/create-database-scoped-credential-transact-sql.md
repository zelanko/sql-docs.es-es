...
## <a name="remarks"></a>Notas  
 ...
 A continuación recopilamos algunas aplicaciones de credenciales con ámbito de base de datos:  
...
[Cree una aplicación AAD](https://docs.microsoft.com/en-us/azure/data-lake-store/data-lake-store-authenticate-using-active-directory) y documente su client_id, OAuth_2.0_Token_EndPoint y la clave antes de intentar crear una credencial con ámbito de base de datos.
