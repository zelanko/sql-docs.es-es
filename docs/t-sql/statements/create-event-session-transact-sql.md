...
En SQL Server, se requiere el permiso `ALTER ANY EVENT SESSION`. En SQL Database, se requiere el permiso `ALTER ANY DATABASE EVENT SESSION` en la base de datos.
