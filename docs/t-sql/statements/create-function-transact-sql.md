...
### <a name="e-displaying-the-definition-of-tsql-user-defined-functions"></a>E. Mostrar la definición de funciones definidas por el usuario de [!INCLUDE[tsql](../../includes/tsql-md.md)]  
