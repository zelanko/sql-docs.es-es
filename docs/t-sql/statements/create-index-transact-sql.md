...
### <a name="p-add-a-column-to-an-index"></a>P. Agregar una columna a un índice  
 En el ejemplo siguiente se crea el índice IX_FF con dos columnas de la tabla dbo. Tabla FactFinance.  La instrucción siguiente muestra cómo volver a generar dicho índice con el mismo nombre y una columna más.  
