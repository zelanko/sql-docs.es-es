...
## <a name="permissions"></a>Permisos  
 El usuario debe tener el permiso ALTER en la tabla o vista, o ser un miembro del rol fijo de servidor sysadmin o de los roles fijos de base de datos db_owner y db_ddladmin.  
