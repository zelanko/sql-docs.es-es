...
-   Establecer *valor* en 0 evita la ejecución de consultas con operaciones SORT y HASH MATCH en grupos de cargas de trabajo definidos por el usuario.  
...
### <a name="1-shows-how-to-create-a-workload-group-named-newreports"></a>1. Cómo crear un grupo de cargas de trabajo denominado newReports    
