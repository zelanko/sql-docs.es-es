---
description: DENY (permisos de certificado de Transact-SQL)
title: DENY (permisos de certificado de Transact-SQL) | Microsoft Docs
ms.custom: ''
ms.date: 06/10/2016
ms.prod: sql
 ...
 *permission*  
 Especifica un permiso que se puede denegar en un certificado. Se muestra a continuación.  
  
 ON CERTIFICATE **::** _certificate_name_  
 Especifica el certificado en el que se va a denegar el permiso. Es preciso utilizar el calificador de ámbito "::".  
...
## <a name="permissions"></a>Permisos  
 Requiere el permiso CONTROL en el certificado. Si se utiliza la cláusula AS, la entidad de seguridad especificada debe ser propietaria del certificado.  
