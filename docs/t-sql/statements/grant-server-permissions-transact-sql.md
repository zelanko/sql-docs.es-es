---
title: Permisos de servidor GRANT (Transact-SQL) | Documentos de Microsoft
ms.custom: 
ms.date: 08/10/2017
 ...
 *permiso*  
 ...
 PARA \<grantee_principal > especifica la entidad a la que se va a conceder el permiso.  
  
 AS \<grantor_principal > especifica la entidad de seguridad de la que la entidad de seguridad para ejecutar esta consulta deriva su derecho a conceder el permiso.  
