...
:::row:::
    ...
    :::column-end:::
    :::column:::
        [Instancia administrada de SQL](restore-statements-transact-sql.md?view=azuresqldb-mi-current&preserve-view=true)
    :::column-end:::
    :::column:::
...
:::row:::
    ...
    :::column-end:::
    :::column:::
        [Instancia administrada de SQL](restore-statements-transact-sql.md?view=azuresqldb-mi-current)
    :::column-end:::
    :::column:::
