---
title: REVOCAR permisos de esquema (Transact-SQL) | Documentos de Microsoft
ms.custom: 
ms.date: 06/10/2016
...
>  Si la entidad de seguridad dispone del permiso especificado sin la opción GRANT, se revocará el permiso.  
 ...
 Especifica el esquema en el que se va a revocar el permiso. El calificador de ámbito **::** es necesario.  
