...
description: Obtenga información sobre cómo crear un alias en el Administrador de configuración de SQL Server para poder usar un nombre alternativo al conectarse a una instancia de SQL Server.
