---
title: Propiedades de Analysis Server (pestaña Avanzadas)
description: Obtenga información sobre las opciones de la pestaña Opciones avanzadas del cuadro de diálogo Propiedades de Analysis Server, como el directorio de volcado y el id. de la instancia.
