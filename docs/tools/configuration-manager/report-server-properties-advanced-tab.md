---
title: Propiedades de Servidor de informes (pestaña Avanzadas)
description: Obtenga información sobre las opciones de la pestaña Opciones avanzadas del cuadro de diálogo Propiedades del servidor de informes, como el directorio de volcado y el id. de la instancia.
