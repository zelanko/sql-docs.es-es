...
description: Aprenda a usar SQL Server Browser, un servicio que escucha solicitudes de recursos de SQL Server y proporciona información sobre las instancias de SQL Server instaladas.
