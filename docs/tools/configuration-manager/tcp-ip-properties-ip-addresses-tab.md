...
ms.topic: "article"
helpviewer_keywords: 
  - "puertos [SQL Server], escuchar en"
  - "escuchar [SQL Server], en puertos"
...
## Puertos estáticos frente a Puertos dinámicos  
...
## Agregar o quitar direcciones IP  
...
## Temas adicionales en los libros en pantalla  
