...
-   [!INCLUDE[ssSQL15](../../includes/sssqlv14-md.md)]  Actualización acumulativa 1 y versiones posterior. Consulte - [actualizaciones acumulativas de SQL Server 2017](http://aka.ms/sql2017cu).
