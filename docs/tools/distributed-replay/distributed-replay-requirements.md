...
-   [!INCLUDE[ssSQL15](../../includes/sssqlv14-md.md)]   Actualización acumulada 1 y posteriores. Consulte [Actualizaciones acumulativas de SQL Server 2017](https://aka.ms/sql2017cu).
