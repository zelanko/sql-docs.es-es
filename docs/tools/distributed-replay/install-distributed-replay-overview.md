---
title: "Instalar Distributed Replay: información general | Documentos de Microsoft"
ms.custom: 
ms.date: 03/01/2017
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Use los temas siguientes para instalar la característica Distributed Replay.  
...
|[Modificar las cuentas de servicios de cliente y controlador](../../tools/distributed-replay/modify-the-controller-and-client-services-accounts.md)|Tema de procedimientos para saber cómo iniciar y detener los servicios de cliente y controlador de Distributed Replay, y modificar las cuentas de servicio.|  
