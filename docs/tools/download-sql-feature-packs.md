...
description: En este artículo se proporciona una breve explicación de las distintas descargas y paquetes independientes que Microsoft proporciona para agregar valor para SQL Server.
ms.prod: sql
...
En este artículo se proporciona una breve explicación de las distintas descargas y paquetes independientes que Microsoft proporciona para agregar valor para SQL Server.
...
## <a name="command-line-programming-and-t-sql"></a>Línea de comandos, programación y T-SQL
...
| [Integration Services Feature Pack para el SQL Server más reciente](https://www.microsoft.com/download/details.aspx?id=100303) | Estos paquetes independientes proporcionan un valor adicional para el Integration Services de Microsoft SQL Server más reciente. |
