...
ms.topic: "article"
helpviewer_keywords: 
  - "estructuras de diseño físico [SQL Server]"
  - "utilidades del símbolo del sistema [SQL Server], dta"
  - "dta, utilidad"
  - "optimización de bases de datos [SQL Server]Asistente para la optimización de motor de base de datos"
  - "cargas de trabajo [SQL Server], análisis"
  - "utilidad dta, acerca de la utilidad dta"
  - "rendimiento [SQL Server], Asistente para la optimización de motor de base de datos"
  - "Asistente para la optimización de motor de base de datos [SQL Server], símbolo del sistema"
...
|Valor|Descripción|  
|-----------|-----------------|  
|NONE|Ninguna estructura existente|  
