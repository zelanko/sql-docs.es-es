...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)] Especifica el grupo de archivos de una configuración especificada por el usuario en el que se va a crear el índice.  
