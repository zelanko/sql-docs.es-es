...
helpviewer_keywords: 
  ...
  - "Asistente para la optimización de motor de base de datos [SQL Server], iniciar"
...
![Ventana predeterminada del Asistente para la optimización del motor de base de datos](../../tools/dta/media/defaultdtagui.gif "Ventana predeterminada del Asistente para la optimización del motor de base de datos")  
...
[Configurar las opciones de herramienta y el diseño](../../tools/dta/setting-tool-options-and-layout.md)  
