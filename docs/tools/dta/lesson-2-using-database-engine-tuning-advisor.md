---
title: 'Lección 2: Uso de la base de datos de motor de Asistente para la optimización | Documentos de Microsoft'
ms.custom: ''
ms.date: 03/01/2017
...
[Optimizar una carga de trabajo](../../tools/dta/lesson-1-1-tuning-a-workload.md)  
