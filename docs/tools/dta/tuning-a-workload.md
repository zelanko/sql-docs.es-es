...
applies_to: 
  - "SQL Server 2016"
helpviewer_keywords: 
  - "cargas de trabajo [SQL Server], optimización"
...
2.  Inicie el Asistente para la optimización de motor de base de datos. Consulte [Iniciar el Asistente para la optimización de motor de base de datos](../../tools/dta/launching-database-engine-tuning-advisor.md).  
...
[Ver recomendaciones de optimización](../../tools/dta/viewing-tuning-recommendations.md)  
