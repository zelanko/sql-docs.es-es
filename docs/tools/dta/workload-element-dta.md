...
description: En la utilidad DTA, el elemento Workload especifica la carga de trabajo que se va a utilizar para una sesión de optimización. En este artículo se describe ese elemento.
ms.prod: sql
