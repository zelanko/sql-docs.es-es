...
- ¿Desea administrar una instancia de SQL Server o la base de datos, en un editor ligera en Windows, Linux o Mac? Seleccionar [[!INCLUDE[name-sos](../includes/name-sos.md)]](../sql-operations-studio/download.md)
