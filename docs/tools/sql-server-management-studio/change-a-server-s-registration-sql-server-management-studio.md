...
ms.topic: "article"
helpviewer_keywords: 
  - "modificar información de conexión de servidor registrado"
  - "Servidores registrados [SQL Server], cambios de información de conexión"
...
---
# Cambiar el registro de un servidor (SQL Server Management Studio)
...
#### Para cambiar el registro de un servidor  
