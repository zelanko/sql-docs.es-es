...
## Cerrar y ocultar componentes  
  
#### Para practicar la forma de cerrar, ocultar y volver a abrir ventanas de componentes  
...
#### Para practicar la forma de mover componentes  
...
#### Para acoplar y desacoplar componentes  
...
[Mostrar la ventana Consulta](../../tools/sql-server-management-studio/display-the-query-window.md)  
