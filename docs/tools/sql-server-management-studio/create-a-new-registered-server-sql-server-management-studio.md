...
helpviewer_keywords: 
  - "Servidores registrados [SQL Server], crear servidores registrados"
...
---
# Crear un servidor registrado (SQL Server Management Studio)
...
#### Para registrar automáticamente las instancias de servidor locales  
...
#### Para crear un servidor registrado  
