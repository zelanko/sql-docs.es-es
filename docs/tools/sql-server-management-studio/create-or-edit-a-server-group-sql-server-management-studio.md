...
helpviewer_keywords: 
  - "Servidores registrados [SQL Server], grupos de servidores"
  - "servidores, grupos [SQL Server]"
  - "grupos [SQL Server], servidor"
...
---
# Crear o editar un grupo de servidores (SQL Server Management Studio)
...
#### Para crear un grupo de servidores en Servidores registrados  
