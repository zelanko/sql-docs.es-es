...
helpviewer_keywords: 
  - "conexiones [SQL Server], servidores registrados"
  - "registrar servidores"
  - "servidores [SQL Server], registrar"
  - "administración de servidor [SQL Server], registrar servidores"
  - "registro de servidor [SQL Server]"
