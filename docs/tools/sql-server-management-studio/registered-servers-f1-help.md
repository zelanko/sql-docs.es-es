...
ms.topic: "reference"
helpviewer_keywords: 
  - "SQL Server Management Studio [SQL Server], Ayuda"
  - "servidores registrados [SQL Server], ayuda"
  - "ayuda de SQL Server Management Studio [SQL Server], servidores registrados"
...
---
# Servidores registrados (Ayuda F1)
 ...
 ## Nuevo o Editar el registro de servidores (pestaña General) de Reporting Services 
 ...
 **Prueba**  
 ...
 ## Nuevo o Editar el registro de servidores (pestaña General) de Analysis Services - Datos multidimensionales
 ...
 **Prueba**  
 ...
 ## Nuevo o Editar el registro de servidor (pestaña General) de SSIS 
