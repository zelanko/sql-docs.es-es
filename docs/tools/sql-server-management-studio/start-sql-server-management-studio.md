...
#### Para mostrar la ventana Servidores registrados  
...
[Conectar con el Explorador de objetos y Servidores registrados](../../tools/sql-server-management-studio/connect-with-registered-servers-and-object-explorer.md)  
