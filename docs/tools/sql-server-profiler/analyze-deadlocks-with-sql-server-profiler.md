...
ms.topic: "article"
helpviewer_keywords: 
  - "nodos de proceso [SQL Server Profiler]"
  - "Profiler [SQL Server Profiler], interbloqueos"
  - "interbloqueos [SQL Server], identificar causa"
  - "nodos de recursos [SQL Server Profiler]"
  - "gráficos [SQL Server Profiler]"
  - "SQL Server Profiler, interbloqueos"
  - "eventos [SQL Server], interbloqueos"
  - "bordes [SQL Server Profiler]"
...
---
# Analizar interbloqueos con SQL Server Profiler
