---
title: Cerrar una ventana de seguimiento (SQL Server Profiler) | Documentos de Microsoft
ms.custom: 
ms.date: 03/01/2017
...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Este tema describe cómo cerrar la ventana de seguimiento para seguimientos que están en ejecución o de seguimientos guardados están viendo utilizando [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)].  
