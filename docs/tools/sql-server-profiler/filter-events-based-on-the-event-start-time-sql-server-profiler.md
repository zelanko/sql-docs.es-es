...
ms.topic: "article"
helpviewer_keywords: 
  - "eventos, horas de inicio [SQL Server]"
...
---
# Filtrar eventos bas&#225;ndose en la hora de inicio del evento (SQL Server Profiler)
...
### Para filtrar un evento en función de la hora de inicio del evento  
