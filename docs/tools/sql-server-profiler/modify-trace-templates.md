...
helpviewer_keywords: 
  ...
  - "modificar plantillas de seguimiento"
 ...
 **Para modificar una plantilla de seguimiento**  
 ...
 [Usar SQL Server Profiler](../../tools/sql-server-profiler/modify-a-trace-template-sql-server-profiler.md)  
 ...
 **Para agregar o quitar eventos de una plantilla de seguimiento o de un archivo de seguimiento**  
 ...
 [Usar SQL Server Profiler](../../tools/sql-server-profiler/specify-events-and-data-columns-for-a-trace-file-sql-server-profiler.md)  
  
 [Usar Transact-SQL](../../relational-databases/system-stored-procedures/sp-trace-setevent-transact-sql.md)  
