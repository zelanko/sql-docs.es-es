...
ms.topic: "article"
helpviewer_keywords: 
  - "generador de perfiles [SQL Server Profiler], permisos"
  - "seguimientos [SQL Server], reproducir"
  - "reproducir seguimientos"
  - "SQL Server Profiler, permisos"
  - "seguridad [SQL Server], SQL Server Profiler"
...
6.  Se comprueba la existencia de un usuario Invitado en la base de datos de destino y, en función del resultado, tiene lugar una de las siguientes acciones:  
 ...
 ![Permisos de reproducción de seguimiento de SQL Server Profiler](../../tools/sql-server-profiler/media/replaytracedecisiontree.gif "Permisos de reproducción de seguimiento de SQL Server Profiler")  
