...
ms.topic: "article"
helpviewer_keywords: 
  - "SQL Server Profiler, reproducir seguimientos"
  - "ejecutar hasta el cursor, opción"
  - "alternar punto de interrupción, opción"
  - "seguimientos [SQL Server], reproducir"
  - "reproducir seguimientos"
  - "motor de reproducción [SQL Server Profiler]"
  - "eventos [SQL Server], reproducir seguimientos"
  - "Profiler [SQL Server Profiler], reproducir seguimientos"
