---
title: "SQL Server Profiler (Ayuda F1) | Microsoft Docs"
ms.custom: ""
ms.date: "03/13/2017"
...
helpviewer_keywords: 
  - "Profiler [SQL Server Profiler], ayuda"
  - "SQL Server Profiler, ayuda"
  - "Propiedades de seguimiento, cuadro de diálogo"
  - "Propiedades de la plantilla de seguimiento, cuadro de diálogo"
  - "Propiedades de archivos de seguimiento, cuadro de diálogo"
  - "Límite de contadores de rendimiento, cuadro de diálogo"
  - "Opciones generales, cuadro de diálogo"
  - "Seleccionar tabla de carga, cuadro de diálogo"
  - "Tabla de destino, cuadro de diálogo"
  - "Configuración de reproducción, cuadro de diálogo"
...
# SQL Server Profiler (Ayuda F1)
 ...
 La siguiente sección contiene temas de ayuda contextual del [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)]. Puede consultar estos temas desde la interfaz de usuario presionando la tecla F1 o haciendo clic en **Ayuda** en los cuadros de diálogo.  
  
 ## Propiedades de seguimiento (General)
 ...
 **Habilitar hora de detención de seguimiento**  
 Establece la fecha y la hora de finalización y de cierre del seguimiento. Utilice la pestaña **Selección de eventos** del cuadro de diálogo **Propiedades de seguimiento** para ver o especificar columnas de datos y eventos de seguimiento.  
  
 ## Propiedades de seguimiento (pestaña Selección de eventos)
...
## Propiedades de la plantilla de seguimiento (pestaña General)
...
## Editar Propiedades de la plantilla de seguimiento (pestaña General)
 ...
 **Usar como plantilla predeterminada para tipo de servidor seleccionado**  
 ...
 ## Propiedades de la plantilla de seguimiento (pestaña Selección de eventos)
 ...
 **Organizar columnas**  
 ...
 ## Propiedades del archivo de seguimiento (pestaña General) 
 ...
 **Modificado**  
 ...
 ## Propiedades del archivo de seguimiento (pestaña Selección de eventos)
 ...
 **Organizar columnas**  
 ...
 ## Propiedades de la tabla de seguimiento (pestaña Selección de eventos)
 ...
 **Organizar columnas**  
 Después de seleccionar la columna **Eventos** y la columna de datos de las que se va a realizar un seguimiento, haga clic en **Organizar columnas** para que la cuadrícula reordene la columna en la ventana de resultados del seguimiento.  
  ...
  ## Límite de contadores de rendimiento (SQL Server Profiler)
...
### Para seleccionar los objetos y contadores de rendimiento que deben correlacionarse con un seguimiento  
...
2.  Seleccione los contadores que desea correlacionar con el archivo de seguimiento del [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)] .  
 ...
 ## SQL Server Profiler (página Opciones generales de Herramientas/Opciones)
...
> **NOTA:** Si activa o desactiva esta casilla se cambia el formato de presentación de las columnas de hora como **Hora de inicio** y **Hora de finalización**. Pero no cambia los parámetros del valor **DateTime** dentro de los eventos de lenguaje o las llamadas a procedimientos remotos (RPC).  
...
### Opciones de sustitución incremental de archivos  
 ...
 **Intervalo de sondeo del monitor de estado predeterminado (seg.)**  
 ...
 ## SQL Server Profiler (Tabla de origen/Asistente para la optimización de motor de base de datos/Seleccionar tabla de carga de trabajo)
...
#### Opciones  
 **SQL Server**  
 Especifica la instancia de SQL Server conectada actualmente. Este campo se llena automáticamente y no puede actualizarse.  
 ...
 **Table**  
 ...
 ## SQL Server Profiler (Tabla de destino)
 ...
 **Tabla**  
 ...
 ## Analizador SQL Server (Configuración de reproducción/página Opciones básicas de reproducción)
 ...
 **Mostrar los resultados de la reproducción**  
 ...
 ## SQL Server Profiler (Configuración de reproducción/página Opciones avanzadas de reproducción)
 ...
 **Intervalo de espera del monitor de procesos bloqueados (seg.)**  
 ...
 ## Buscar (cuadro de diálogo de SQL Server Profiler)
 ...
 **Buscar anterior**  
 ...
 ## SQL Server Profiler (Organizar columnas)
...
> **NOTA:** Para las columnas de tipo de datos de cadena, los criterios de filtro aparecerán como un valor de cadena LIKE o NOT LIKE.  
