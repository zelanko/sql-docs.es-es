...
ms.topic: "article"
helpviewer_keywords: 
  - "plantillas predeterminadas de SQL Server Profiler"
  - "plantillas [SQL Server], SQL Server Profiler"
  - "Profiler [SQL Server Profiler], plantillas"
  - "plantillas de seguimiento [SQL Server]"
  - "plantillas predefinidas [SQL Server Profiler]"
  - "SQL Server Profiler, plantillas"
