...
[!INCLUDE[appliesto-ss-xxxx-xxxx-xxx-md](../../includes/appliesto-ss-xxxx-xxxx-xxx-md.md)]Este tema describe cómo iniciar seguimientos automáticamente después de conectarse a una instancia de [!INCLUDE[ssNoVersion](../../includes/ssnoversion-md.md)] utilizando [!INCLUDE[ssSqlProfiler](../../includes/sssqlprofiler-md.md)].  
