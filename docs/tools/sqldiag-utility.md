...
ms.topic: "article"
helpviewer_keywords: 
  - "utilidades del símbolo del sistema [SQL Server], SQLdiag"
  - "detener la recopilación de diagnóstico"
  - "almacenar información de diagnóstico"
  - "rendimiento [SQL Server], recopilación de diagnóstico"
  - "registros de diagnóstico [SQL Server]"
  - "scripts [SQL Server], recopilación de diagnóstico"
  - "registros [SQL Server], recopilación de diagnóstico"
  - "iniciar la recopilación de diagnóstico"
  - "instancia en clúster de SQL Server"
  - "supervisar el rendimiento [SQL Server], recopilación de diagnóstico"
  - "seguridad [SQL Server], recopilación de diagnóstico"
  - "SQLDIAG, servicio"
  - "espacio [SQL Server], recopilación de diagnóstico"
  - "SQLdiag , utilidad"
  - "espacio en disco [SQL Server], recopilación de diagnóstico"
  - "archivos de configuración [SQL Server]"
  - "recopilación automática de diagnóstico"
  - "clústeres [SQL Server], recopilación de diagnóstico"
...
## Requisitos de seguridad  
 A menos que **SQLdiag** se ejecute en modo genérico (especificando el argumento de la línea de comandos **/G**), el usuario que ejecuta **SQLdiag** debe ser miembro del grupo **Administradores** de Windows y del rol fijo de servidor **sysadmin** de [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)]. De forma predeterminada, **SQLdiag** conecta con [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] mediante la autenticación de Windows, pero también admite la autenticación de [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] .  
...
## Recopilar datos de diagnóstico de instancias de SQL Server en clúster  
