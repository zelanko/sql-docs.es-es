---
title: "sqllogship (aplicaci&#243;n) | Microsoft Docs"
ms.custom: ""
ms.date: "03/14/2017"
...
# sqllogship (aplicaci&#243;n)
 ...
 ![Icono de vínculo a temas](../database-engine/configure-windows/media/topic-link.png "Icono de vínculo a temas") Para las convenciones de sintaxis, vea [Referencia de la utilidad del símbolo del sistema &#40;motor de base de datos&#41;](../tools/command-prompt-utility-reference-database-engine.md).  
 ...
 **–logintimeout** *timeout_value*  
 Especifica la cantidad de tiempo asignado al intento de iniciar sesión en la instancia del servidor antes de que se agote el tiempo de espera del intento. El valor predeterminado es 15 segundos. El valor de *timeout_value* es de tipo **int***.*  
  
 **-querytimeout** *timeout_value*  
 Especifica la cantidad de tiempo asignado para iniciar la operación especificada antes de que se agote el tiempo de espera. El valor predeterminado es sin tiempo de espera. El valor de *timeout_value* es de tipo **int***.*  
...
|**-restore**|Requiere acceso de lectura/escritura al directorio de copia.|Requiere los mismos permisos que la instrucción RESTORE. Para obtener más información, vea [RESTORE &#40;Transact-SQL&#41;](../Topic/RESTORE%20\(Transact-SQL\).md).|  
