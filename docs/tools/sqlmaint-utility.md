...
ms.topic: "article"
helpviewer_keywords: 
  - "planes de mantenimiento de bases de datos [SQL Server]"
  - "sqlmaint, utilidad"
  - "mantenimiento de bases de datos [SQL Server]"
  - "copias de seguridad [SQL Server], utilidad sqlmaint"
  - "utilidades del símbolo del sistema [SQL Server], sqlmaint"
  - "planes de mantenimiento [SQL Server], símbolo del sistema"
  - "copia de seguridad [SQL Server], utilidad sqlmaint"
