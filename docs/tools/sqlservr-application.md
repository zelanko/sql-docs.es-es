...
ms.topic: "article"
helpviewer_keywords: 
  - "utilidades del símbolo del sistema [SQL Server], sqlservr"
  - "símbolo del sistema [SQL Server], pausar o reanudar una instancia de SQL Server"
  - "iniciar una instancia de SQL Server"
  - "símbolo del sistema [SQL Server], continuar una instancia de SQL Server"
  - "sqlservr, utilidad"
  - "pausar una instancia de SQL Server"
  - "detener una instancia de SQL Server"
  - "reanudar SQL Server"
  - "símbolo del sistema [SQL Server], detener una instancia de SQL Server"
  - "símbolo del sistema [SQL Server], iniciar una instancia de SQL Server"
  - "continuar una instancia de SQL Server"
 ...
 **-T** *trace#*  
 Indica que se debe iniciar una instancia de [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] con una marca de seguimiento específica (*trace#*) vigente. Las marcas de seguimiento se utilizan para iniciar el servidor con un comportamiento distinto del habitual. Para obtener más información, vea [Marcas de seguimiento &#40;Transact-SQL&#41;](../Topic/Trace%20Flags%20\(Transact-SQL\).md).  
  
> [!IMPORTANT]  
>  Cuando especifique una marca de seguimiento, use **-T** para pasar el número de la marca de seguimiento. [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)] acepta una t minúscula (**-t**), pero **-t** establece otras marcas de seguimiento internas que necesitan los ingenieros de soporte técnico de [!INCLUDE[ssNoVersion](../includes/ssnoversion-md.md)].  
