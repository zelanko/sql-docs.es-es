...
ms.topic: "article"
helpviewer_keywords: 
  - "Service Broker, informes de tiempo de ejecución"
  - "Service Broker, utilidades del símbolo del sistema"
  - "solución de problemas [Service Broker], conversaciones"
  - "solución de problemas [Service Broker], configuraciones"
  - "utilidades del símbolo del sistema [Service Broker]"
  - "Service Broker, solución de problemas"
  - "Service Broker, informes de configuración"
  - "Service Broker, herramientas"
  - "solución de problemas [Service Broker], tiempo de ejecución"
  - "conversaciones [Service Broker], solución de problemas"
  - "solución de problemas [Service Broker], utilidad ssbdiagnose"
  - "herramientas [Service Broker], ssbdiagnose"
  - "Service Broker, utilidad ssbdiagnose"
  - "ssbdiagnose"
