---
title: Actualizar - XQuery para documentos de SQL Server | Documentos de Microsoft
description: Mostrar fragmentos de contenido actualizado para recientemente modificadas en documentación, XQuery para Microsoft SQL Server.
manager: craigg
author: MightyPen
ms.author: genemi
ms.topic: article
...
ms.locfileid: "32739307"
---
# <a name="new-and-recently-updated-xquery-for-sql-server"></a>Nuevos y actualizados recientemente: XQuery para SQL Server
...
- *Área de asunto:* &nbsp; **XQuery para SQL Server**.
