...
> [!NOTE]  
>  Esta implementación no admite la `local` prefijo como se describe en la especificación de XQuery en https://www.w3.org/2004/07/xquery-local-functions.  
